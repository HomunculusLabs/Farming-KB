...
This page provides a comprehensive overview of plant structure and function, from the
cellular level up to whole-organism systems.
...
- **Nucleus**: Contains genetic material (DNA) organized into chromosomes. Gene
  expression is regulated by transcription factors responding to hormonal and
...
- **Endoplasmic reticulum (ER)**: Rough ER synthesizes proteins for secretion or
  membrane insertion. Smooth ER synthesizes lipids and participates in
...
- **Chloroplasts**: The organelle where photosynthesis occurs, containing stacks
  ...
  stroma for the Calvin cycle. Chloroplasts have their own circular DNA and
  ribosomes, reflecting their origin as free-living cyanobacteria engulfed by
  a eukaryotic host ~1.5 billion years ago.
...
## Meristems: The Engines of Growth

Unlike animals, plants grow continuously from specialized regions of undifferentiated,
actively dividing cells called **meristems**. Meristematic cells are small, with thin
walls, dense cytoplasm, and large nuclei—optimized for rapid division.
...
The SAM is organized into zones:

- **Central zone**: Slowly dividing stem cells maintaining the meristem.
- **Peripheral zone**: Rapidly dividing cells giving rise to leaf and stem primordia.
- **Rib zone**: Produces stem core (pith) cells.

The CLAVATA/WUSCHEL feedback loop maintains stable meristem size—CLAVATA limits
stem cell proliferation while WUSCHEL promotes it. The **root apical meristem
(RAM)** drives root elongation and produces the root cap, which is continuously
shed and replaced as the root pushes through soil. Root cap cells secrete mucilage
(polysaccharide gel) that lubricates passage and supports beneficial microbes.

### Lateral Meristems

**Lateral meristems** drive secondary growth (thickening) in woody plants:

- **Vascular cambium**: Produces secondary xylem (wood) inward and secondary
  phloem (inner bark) outward. Can remain active for centuries.
- **Cork cambium**: Produces periderm (outer bark) of dead, suberin-filled cork
  cells providing protection and insulation.
