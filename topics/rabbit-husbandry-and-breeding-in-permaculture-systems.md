...
- **Manure production:** Rabbit manure is a "cold" manure, meaning it can be applied directly to gardens without composting (though composting improves ph-and-nutrient-availability-garden-soils). It is approximately 2.4% nitrogen, 1.4% phosphorus, and 0.6% potassium — richer than poultry manure in nitrogen.
...
- **Heat generation:** A colony of rabbits produces body heat that can be harvested in greenhouse or root-cellar-design-and-construction designs through coleman-soil-heat-mass-passive-thermal-storage integration.
...
A rabbit tractor is a floorless, moveable enclosure (similar to a [[chicken-tractor-systems]]) that allows rabbits to graze on fresh pasture. Key design elements:
