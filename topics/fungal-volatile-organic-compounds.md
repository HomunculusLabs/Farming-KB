---
title: Fungal Volatile Organic Compounds
tags:
  - mycology
  - fungal-ecology
  - chemical-ecology
...
Fungal volatile organic compounds (FVOCs) are low-molecular-weight organic molecules (typically below 300 Da) emitted by fungi that can vaporize at ambient temperatures and travel through air and soil pore spaces. Unlike primary metabolites essential for growth, most FVOCs are secondary metabolites produced during normal metabolic processes, stress responses, or as signaling molecules. Over 300 distinct FVOCs have been identified across fungal taxa, including alcohols, aldehydes, ketones, esters, terpenes, aromatic compounds, and sulfur-containing molecules. These compounds function as a chemical language that fungi use to communicate with other fungi, bacteria, plants, and insects, mediating ecological interactions that range from mutualistic to antagonistic.

## Chemical Diversity of FVOCs

### Alcohols and Ketones

Ethanol, isopropanol, and 2-methyl-1-butanol are among the most commonly emitted fungal alcohols, produced primarily through glycolysis and amino acid catabolism. 3-Methyl-1-butanol (isoamyl alcohol) and 2-phenylethanol are produced by many yeast species and some filamentous fungi. Ketones such as 2-nonanone, 2-heptanone, and 3-octanone are particularly associated with *Trichoderma* species and contribute to their biocontrol properties. These smaller molecules are highly diffusible and serve as short-range signals in soil microenvironments.

### Terpenes and Sesquiterpenes

Fungi produce a remarkable diversity of terpenoid volatiles, including monoterpenes (α-pinene, β-pinene, limonene), sesquiterpenes (nerolidol, germacrene D), and diterpenes. Many of these are synthesized via the mevalonate pathway. *Trichoderma* species emit a characteristic blend of 6-pentyl-α-pyrone (6-PP), a lactone with strong antifungal and plant-growth-promoting properties, along with various sesquiterpenes. Endophytic fungi isolated from medicinal plants frequently produce terpenoid volatiles identical or similar to host plant compounds, suggesting horizontal gene transfer or convergent evolution.

### Aromatic Compounds

Aromatic FVOCs include benzaldehyde, benzyl alcohol, styrene, toluene, and phenylethyl alcohol. These are often derived from the shikimate pathway or phenylalanine metabolism. Benzaldehyde, produced by several *Penicillium* and *Aspergillus* species, has significant antimicrobial activity. Styrene production is particularly notable in certain *Penicillium* species and can serve as a biomarker for indoor mold contamination.

### Sulfur-Containing Compounds

Dimethyl sulfide (DMS), dimethyl disulfide (DMDS), dimethyl trisulfide (DMTS), and methanethiol are produced by fungi from methionine catabolism. These sulfur volatiles are highly potent even at nanomolar concentrations and contribute to the characteristic "earthy" or "mushroomy" odor of soil and decaying organic matter. DMDS produced by *Trichoderma viride* has documented nematicidal activity, making it relevant for biological pest control.

### Nitrogen-Containing Compounds

Fungi emit various nitrogenous volatiles including ammonia, indole, 2-methylpropanal, and trimethylamine. These compounds often signal nitrogen status and can influence bacterial community composition in the mycosphere. Indole production by fungi is particularly interesting because it overlaps with a major bacterial signaling molecule, potentially creating cross-kingdom communication channels.

## Biosynthesis Pathways

### Primary Metabolism-Derived FVOCs

Many FVOCs are byproducts of primary metabolic pathways. Glycolysis yields ethanol and acetone; the Ehrlich pathway converts amino acids to fusel alcohols and their corresponding aldehydes and acids. Leucine, isoleucine, and valine catabolism produces 3-methyl-1-butanol, 2-methyl-1-butanol, and isobutanol respectively. The fatty acid oxidation pathway generates a series of alkanes, alkenes, and methyl ketones with chain lengths of C7–C12.

### Secondary Metabolism-Derived FVOCs

Terpenoid FVOCs are synthesized by terpene synthases and cytochrome P450 enzymes from farnesyl pyrophosphate (FPP) and geranylgeranyl pyrophosphate (GGPP) precursors. Polyketide-derived volatiles include 6-PP and various aromatic lactones. Non-ribosomal peptide synthesis can also yield volatile products, particularly nitrogen-containing compounds. The ecological significance of a given FVOC often correlates with its biosynthetic origin—primary metabolite derivatives tend to function as metabolic signals, while secondary metabolite derivatives are more often involved in defense and interspecies interactions.
...
The fungal mycosphere—the zone of soil immediately influenced by fungal hyphae and exudates—harbors distinct bacterial communities shaped in part by FVOCs. Volatile signals from *Fusarium oxysporum* attract migratory bacteria of the genus *Collimonas*, which feed on living fungal hyphae (mycophagy). This represents a remarkable case of a predator being attracted to its prey's chemical signature.
...
Endophytic fungi such as *Serendipita indica* (formerly *Piriformospora indica*) emit volatiles that promote root hair formation and branching, effectively expanding the root surface area for nutrient uptake. These effects are concentration-dependent; low concentrations stimulate growth while high concentrations can be phytotoxic.
...
FVOC-producing fungi have applications in flavor and fragrance industries. *Ceratocystis fimbriata* and *Trichoderma viride* produce fruity ester volatiles (ethyl acetate, isoamyl acetate) used in food flavoring. The fungal production of these "natural" flavors is preferred by consumers over synthetic alternatives in clean-label food products.

Fungal volatiles are also relevant to biofuel production, where ethanol, butanol, and isoprene emitted by fermenting fungi represent both products and, when uncontrolled, economic losses through evaporation in large-scale fermenters.
...
GC-MS remains the gold standard for FVOC identification and quantification. Coupling with olfactory detection ports (GC-MS-O) allows simultaneous chemical and sensory analysis, correlating specific compounds with perceptible odors. Comprehensive two-dimensional GC (GC×GC-TOF-MS) provides enhanced separation of complex volatile mixtures, revealing compounds that co-elute in conventional GC.

### Proton Transfer Reaction-Mass Spectrometry (PTR-MS)

PTR-MS enables real-time, online monitoring of FVOCs without sample preparation. This technique is particularly valuable for studying dynamic volatile emission patterns—how fungal volatile profiles change over time or in response to environmental perturbations. Selected ion flow drift tube mass spectrometry (SIFT-MS) offers similar real-time capability with additional selectivity.

### Electronic Noses

Cross-reactive sensor arrays ("electronic noses") provide rapid, low-cost FVOC screening suitable for field applications. While they lack the specificity of GC-MS, pattern recognition algorithms (principal component analysis, linear discriminant analysis, machine learning classifiers) can identify volatile fingerprints associated with specific fungal species or physiological states.

## FVOCs in the Context of Climate Change

Climate change is expected to alter FVOC production and dynamics in several ways. Rising temperatures may shift fungal community composition toward thermotolerant species with different volatile profiles. Increased atmospheric CO₂ concentrations have been shown to alter fungal secondary metabolism in some species, potentially changing both the quantity and composition of emitted volatiles. More frequent drought events may increase the air-filled porosity of soils, extending the effective diffusion distance of FVOCs and potentially intensifying fungal-fungal and fungal-plant volatile signaling.

FVOCs also play an underappreciated role in atmospheric chemistry. Certain fungal terpenes react with hydroxyl radicals and ozone, contributing to secondary organic aerosol formation. Global estimates suggest that fungal VOCs constitute approximately 5–10% of total biogenic VOC emissions, a significant contribution that is not yet well-integrated into atmospheric chemistry models.

## Future Directions

Key research frontiers include:

- **Structural elucidation of FVOC receptors**: Identifying the molecular targets of fungal volatiles in plants, bacteria, and other fungi remains a major challenge. Progress in receptor identification would enable rational design of volatile-based biocontrol and growth promotion strategies.

- **Synthetic microbial communities**: Engineering defined consortia of FVOC-producing and FVOC-responding microorganisms for predictable outcomes in agriculture, bioremediation, and industrial fermentation.

- **CRISPR-based engineering of volatile pathways**: Targeted modification of fungal volatile biosynthesis genes to enhance production of beneficial compounds or eliminate undesirable emissions.

- **Field-scale volatile ecology**: Most FVOC research has been conducted in laboratory microcosms; scaling up to field conditions requires accounting for wind dispersion, soil adsorption, and atmospheric chemistry.

- **FVOC-mediated fungal networking**: The extent to which FVOCs contribute to information transfer within mycorrhizal networks and larger soil fungal communities is only beginning to be understood.
