...
subtitle: Plant-derived sprays, ecological design, and biological controls in
---
...
sources:
  ...
  - ~/wiki/concepts/hamilton-geoffhamilton-nick-organic-gardening-organic-pest-control.md
  - ~/wiki/concepts/insectary-plants-for-pest-control.md
  - ~/wiki/concepts/cotter-natural-pest-control-disease-management.md
  - ~/wiki/concepts/cervantes-neem-oil-organic-pest-control.md
  - ~/wiki/concepts/jadam-natural-pest-control-methods.md
  - ~/wiki/concepts/mollison-designers-trap-crops-biological-pest-control.md
  - ~/wiki/concepts/knf-pest-control-and-soap-water.md
  - ~/wiki/concepts/jadam-pest-control-recipes.md
  - ~/wiki/concepts/permaculture-neem-tree.md
  - ~/wiki/concepts/hamilton-beneficial-insects-and-biological-pest-control.md
  - ~/wiki/concepts/mollison-designers-neem-tree-as-natural-insecticide.md
  - ~/wiki/concepts/diatomaceous-earth-cannabis.md
  - ~/wiki/concepts/cervantes-pyrethrum-pyrethroid-insecticides.md
  - ~/wiki/concepts/neem-oil-cannabis.md
  - ~/wiki/concepts/jeavons-natural-pest-control.md
  - ~/wiki/concepts/coleman-beneficial-insects-and-ecological-pest-control.md
  - ~/wiki/concepts/jadam-herbal-pest-control.md
related_concepts:
...
Cho, Han Kyu. Korean Natural Farming Handbook. Korean Natural Farming material
summarized in Cho concept pages on natural pest control, aromatic insect
...
insects, companion planting, and biological control.

Mollison, Bill. Permaculture: A Designers' Manual. Permaculture material
summarized in concept pages on neem, trap crops, insectary plants, biological
control, and integrated pest management design.

Jeavons, John. How to Grow More Vegetables. Biointensive pest management
material summarized in the concept page on natural pest control, compost, crop
rotation, and companion planting.

Coleman, Eliot. The Winter Harvest Handbook. Ecological greenhouse pest
management material summarized in the concept page on beneficial insects and
ecological pest control.

Cotter, Tradd. Organic Mushroom Farming and Mycoremediation. Mushroom pest and
[[plant-disease-management-solomon]] material summarized in the concept page on sanitation,
fungus gnats, Bti, sticky traps, and non-synthetic controls.
