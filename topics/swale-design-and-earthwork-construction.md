...
distribution, soil building, and fertility generation. This makes earthworks
one of the highest-leverage interventions available to land designers.
...
In degraded landscapes rain runs off rapidly, carrying topsoil and
contributing to flooding downstream. Earthworks restore the natural
...
slight grade, typically between 0.5 and 2 percent slope, to move water
from one area to another. They are used to redirect water away from
buildings, roads, or erosion-prone areas toward storage or planting zones.

Infiltration swales are shallow, wide channels filled with gravel or coarse
organic material, designed for maximum infiltration in a small area. They
are commonly used in urban settings or along building foundations where
space is limited. Net and pan swales form interconnected networks across
slopes in arid and semi-arid regions, capturing every possible drop of
rainfall through many small, linked basins. Though labour-intensive, they
are extremely effective for desert restoration.

Berm and basin swales, sometimes called boomerang swales, are
crescent-shaped features on gentle slopes typically used around individual
trees or planting areas. The berm sits on the downhill side and the basin
on the uphill side, creating a micro-catchment that directs water to plant
roots. These are simple to construct with hand tools and are ideal for
home gardens and orchards where large-scale earthworks are impractical.
