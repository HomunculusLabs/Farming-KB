...
In Vietnamese cuisine, rau răm is an indispensable fresh herb served alongside *bánh mì*, *bún chả*, *phở*, and spring rolls. It is also the signature herb in **bún riêu** (crab tomato noodle soup) and is used as a wrapping herb for grilled meats. The fresh leaves are typically added at the table by diners, not cooked into dishes, preserving their volatile aroma.

In Malaysian and Singaporean cuisine, daun kesom is the defining herb in **laksa** (spicy noodle soup), particularly the Penang asam laksa variant. It is also used in *nasi ulam* (herbal rice salad) and as a garnish for grilled fish. The leaves are sometimes blended into chutneys and sambals.

In traditional Vietnamese medicine, rau răm is considered cooling and is used to treat **indigestion, bloating, and stomachache**. A decoction of fresh leaves is taken for fever and diarrhea. Externally, crushed leaves are applied as a poultice to reduce swelling, insect bites, and minor wounds. In folk practice, the herb is believed to reduce male libido when consumed in large quantities — a reputation that appears in Vietnamese folklore but lacks pharmacological substantiation.
