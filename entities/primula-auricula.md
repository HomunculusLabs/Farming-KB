...
The specific epithet *auricula* refers to the leaf shape, which resembles a bear's ear (*auricula ursi* in Latin). The name was recorded by Leonhart Fuchs in 1542 and has remained in continuous use since the Renaissance.

The leaves are mildly toxic if ingested in quantity, containing saponins and primulagenin glycosides. Grazing animals generally avoid the plant, which contributes to its persistence in open alpine pastures.

## Taxonomy and Morphology

**Primula auricula** (L.) L. was described by Linnaeus in 1753 in *Species Plantarum*. It belongs to Primula section Auricula (subgenus Auriculastrum), containing approximately 20 species across European mountain ranges.

The plant forms a basal rosette of leathery, evergreen leaves 5 to 15 cm long. Leaf blades are obovate to spatulate with a broadly crenate margin, typically covered in a white mealy farina on the upper surface.

Flowering stems (scapes) are 10 to 25 cm tall, bearing umbels of 4 to 15 flowers. Individual flowers are 15 to 25 mm in diameter with a cylindrical corolla tube 8 to 15 mm long.

Petals are bright yellow in wild forms, though cultivated varieties show extraordinary color range. Show auriculas feature a dark basal zone (the "paste"), a white "tube" zone, and a colored petal limb in purple, red, pink, or blue.
...
Dried leaves and roots of **Primula auricula** have a history in European folk medicine. Alpine communities prepared leaf infusions as an expectorant for respiratory complaints and as a mild analgesic.
