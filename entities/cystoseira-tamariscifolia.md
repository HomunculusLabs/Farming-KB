---
title: "Cystoseira tamariscifolia"
type: species
tags:
  - phaeophyta
  - marine-algae
...
- **Kingdom:** Chromista (or Ochrophyta)
- **Phylum:** Phaeophyta
- **Class:** Phaeophyceae
- **Order:** Fucales
- **Family:** Sargassaceae
- **Genus:** *Cystoseira* C. Agardh, 1820
- **Species:** *C. tamariscifolia* (Hudson) Papenfuss, 1950

**Basionym:** *Fucus tamariscifolius* Hudson, 1762.

**Synonyms:** *Fucus tamariscifolius* var. *compressus* Turner; *Cystoseira tamariscifolia* var. *stricta* (Sauvageau) Giaccone.

The genus *Cystoseira* contains approximately 40 species, most of which are endemic to the Mediterranean. The taxonomy has undergone revision with molecular phylogenetics, but *C. tamariscifolia* remains well-defined morphologically.

### Morphology

The thallus is perennial, erect, and reaches 20–60 cm in height. It is attached to rock by a conical holdfast and supported by a distinct, semi-woody basal axis.

Primary branches arise from the axis and bear numerous lateral branchlets with crowded, spatulate to linear-lanceolate leaves. The branching pattern gives the thallus a bushy, feathery appearance.

Receptacles (reproductive structures) are borne on terminal branchlets, cylindrical to slightly inflated, and 5–20 mm long. They contain conceptacles with oogamous reproduction typical of Fucales.
...
Its Atlantic range extends from the British Isles south to Morocco and the Canary Islands. In the Mediterranean, it is widely distributed but has experienced significant decline in the northern basin.
...
Like many fucoid algae, *Cystoseira tamariscifolia* produces a range of bioactive secondary metabolites with ecological and pharmaceutical significance.
...
Other metabolites include meroditerpenoids with cytotoxic activity against several cancer cell lines. The specific profile varies geographically and seasonally.
...
The species plays an important role in coastal carbon cycling. Primary production by *Cystoseira* canopies contributes significantly to organic carbon export to deeper waters and sediments.
