...
The IMO system is based on several key principles of Korean Natural Farming:

1. **Locality**: Microorganisms native to the farm environment are already adapted to local soil conditions, climate, and plant species, making them more effective than commercially produced microbial inoculants
2. **Diversity**: A broad spectrum of microbial life supports more resilient soil ecosystems than single-strain inoculants
3. **Self-sufficiency**: Farmers can produce their own microbial inputs at minimal cost using locally available materials
4. **Synergy**: The combination of bacteria, fungi, and actinomycetes creates complementary metabolic activities that benefit plant growth

The concept challenges the conventional agricultural approach of importing standardized microbial products by emphasizing that the most effective biological inputs are those that already exist in the local environment.

## IMO Collection and Production

The standard KNF protocol for producing IMO involves four progressive stages:

### Stage 1: Collection
Microorganisms are collected from a clean, undisturbed natural area near the farm — typically a forest edge, bamboo grove, or fallow field. A wooden box (approximately 30 × 30 × 10 cm) is filled about two-thirds with cooked rice (not salted), covered with breathable paper, and buried in leaf litter or under grass in the selected location for 5–7 days. During this time, the rice becomes colonized by a diverse community of local microorganisms, visible as white fungal mycelium and various colored bacterial colonies.

### Stage 2: Initial Cultivation
The colonized rice is transferred to a container and mixed with an equal weight of brown sugar (approximately 1:1 ratio). The sugar acts as a food source and preservative. The mixture is allowed to ferment for 5–7 days in a dark location at room temperature, producing a liquid extract rich in diverse microorganisms and their metabolic byproducts.

### Stage 3: Expansion
The Stage 2 extract is diluted and mixed with a larger volume of cooked rice or wheat bran, then allowed to ferment for 5–7 days to expand the microbial population. This produces a moist, sweet-smelling material with high microbial density.

### Stage 4: Final Production
The Stage 3 material is mixed with additional organic substrates — typically rice bran, wheat bran, or fine soil — at approximately 1:10 ratio, and allowed to mature for 5–7 days. The final product is a granular material that can be stored, broadcast onto fields, or incorporated into compost piles.
...
IMO is applied in Korean Natural Farming in several ways:

- **Soil amendment**: Broadcast at 100–200 kg per hectare before planting or during the growing season to build soil microbial populations
