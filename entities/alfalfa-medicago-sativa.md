...
updated: 2026-04-28
sources:
  - "Rodale Institute. Cover Crop Research Database"
  - "USDA NRCS Plant Guide: Medicago sativa"
...
- **Genus:** *Medicago*
- **Species:** *M. sativa*
- **Common names:** Alfalfa (English), Lucerne (British/Commonwealth), Mu-su (Chinese), Yonje (Korean)
- **Synonyms:** *Medicago sativa* subsp. *sativa*, *Medicago varia*

## Botanical Description

### Growth Habit
Alfalfa grows 60–100 cm tall at maturity. It is an herbaceous perennial with an erect to semi-erect growth habit. Multiple stems arise from a woody crown located at or slightly below the soil surface. The crown is the primary overwintering structure and the source of regrowth after cutting or grazing.

### Leaves and Stems
Leaves are trifoliate, with three elliptical leaflets per leaf. Leaflets are 10–30 mm long, serrated at the distal margin, and borne on a slender petiole. Stems are branched, angular, and can become somewhat woody at the base with age.

### Flowers and Reproduction
Flowers are borne in axillary racemes, typically 10–30 flowers per cluster. Individual flowers are small (8–12 mm), papilionaceous (pea-like), and range in color from purple to blue, occasionally showing rare white or yellow variants. Alfalfa is primarily cross-pollinated by bees (honeybees, alkali bees, leafcutter bees). Flowers exhibit tripping mechanism — force applied by a pollinator releases the reproductive structures.

### Roots
The defining feature: a deep, branching taproot that can extend 3–5 meters in the first year and reach 15+ meters under favorable conditions. Lateral roots spread 60–90 cm. Nitrogen-fixing root nodules form in symbiosis with *Rhizobium meliloti* (syn. *Sinorhizobium meliloti*).

### Fruit and Seed
The fruit is a spiral-shaped pod, 2–3 turns, characteristic of the *Medicago* genus. Each pod contains 2–6 small kidney-shaped seeds. Seed color ranges from yellow to brown. Approximately 200,000–400,000 seeds per kilogram.

## Nutritional Profile
Alfalfa hay is valued for its high protein and mineral content. Values below are per 100 g of dried alfalfa forage.

| Nutrient | Amount per 100 g (dried) | Notes |
|---|---|---|
| Crude Protein | 15–22 g | Varies by cutting stage |
| Crude Fiber | 22–30 g | Increases with maturity |
| Calcium | 1,200–2,000 mg | Very high for a forage |
| Phosphorus | 200–350 mg | Ca:P ratio ~6:1 |
| Potassium | 1,500–3,000 mg | Key electrolyte source |
| Magnesium | 200–400 mg | Supports enzyme function |
| Iron | 30–50 mg | Higher than most forages |
| Zinc | 15–30 mg | Essential trace mineral |
| Vitamin A (as carotene) | 100–300 mg/kg | Degrades with storage |
| Vitamin D | Moderate | Increases with sun-curing |
| Vitamin E | 80–150 mg/kg | Antioxidant, reduces with heat |
| Vitamin K | High | Essential for clotting |
| B Vitamins | Present | B1, B2, B6, folate |
| Phytoestrogens | Present | Coumestrol, formononetin |
...
Alfalfa has a long history in traditional herbal medicine across multiple cultures. Key uses include:
- **Arthritis and joint pain:** Anti-inflammatory properties attributed to phytoestrogens and flavonoids.
- **Cholesterol management:** Saponins and fiber components may help reduce LDL cholesterol.
