...
- **Genus:** Podophyllum
- **Species:** P. peltatum L. (1753)
- **Common names:** Mayapple, American mandrake, wild mandrake, devil's apple, hog apple, ground lemon, raccoon berry

The genus name refers to the foot-like appearance of the leaves (Greek *pous* = foot, *phyllon* = leaf). The specific epithet *peltatum* refers to the peltate (umbrella-like) leaf attachment, where the petiole joins the center of the leaf blade.

**Growth habit:** Perennial herb, 30–45 cm tall. Emerging from a long, creeping rhizome (horizontal underground stem) that grows just below the soil surface. Plants spread vegetatively through rhizome fragmentation, forming extensive colonies that may cover many square meters.

**Leaves:** Single large peltate leaf on immature (sterile) plants; two leaves subtending a single flower on mature (fertile) plants. Leaf blades 20–40 cm across, deeply lobed into 5–9 pointed segments, pale green, glabrous above, slightly hairy beneath.

**Flowers:** Single, nodding, waxy white, 2.5–4 cm diameter, with 6–9 petals. Arises from the axil between the two leaves on fertile stems. Blooms April–June.

**Fruit:** Ovoid berry, 2.5–5 cm long, initially green, ripening to yellow or pale orange in August–September. Flesh edible when fully ripe; seeds toxic.

**Rhizome:** Thick, fleshy, creeping, orange-brown, containing the highest concentrations of podophyllotoxin.

## Distribution and Habitat

*P. peltatum* is native to **eastern [[hamilton-composting-and-organic-matter-management]] content.
...
Elevation range is from sea level to approximately 1,500 meters. The species is hardy to USDA zones 3–8.
...
- **Podophyllotoxin:** 0.3–1.0% dry weight — the primary bioactive lignan
...
- **Quercetin and [[blesching-cannabis-lung-cancer]], testicular cancer, lymphomas, and Kaposi's sarcoma.
...
Podophyllum Peltatum finds practical application in multiple design contexts.
...
Podophyllum Peltatum has been recognized across multiple knowledge traditions.
...
Successful integration of podophyllum peltatum into broader
