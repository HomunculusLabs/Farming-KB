...
by warm, wet conditions following dry periods.
## Chemistry and Bioactive Compounds
- **Calvacin**: Cytotoxic protein isolated from C. gigantea spores,
  exhibiting antitumor activity against sarcoma 180 in mouse models.
  First characterized by Bottner and co-workers in the 1960s.
- **Calvatianic acid**: Fatty acid derivative with reported antimicrobial
  properties
- **Beta-glucans**: Polysaccharides with immunomodulatory activity,
  consistent with many Agaricaceae members
- **Ergosterol**: Predominant sterol; precursor to vitamin D₂ upon UV
  exposure
- **Various proteins and peptides**: Including protease inhibitors and
  lectins with potential biological activity
## Edibility and Culinary Use
Calvatia gigantea is widely regarded as one of the best edible wild mushrooms
when harvested at the correct stage:
- **Edible stage**: Gleba must be pure white, firm, and marshmallow-like
- **Preparation**: Sliced and pan-fried like steaks, breaded and deep-fried,
  used in soups, or dried and powdered as a seasoning
- **Nutrition**: Low in calories, moderate protein, good source of potassium,
  phosphorus, and B vitamins
- **Storage**: Refrigerates several days sliced; freezes well long-term
**Critical warning**: Specimens with any yellowish, greenish, or brown gleba
must be avoided. Always slice puffballs vertically to confirm the absence of
gill structures — confusion with immature Amanita species is the most
dangerous misidentification risk.
## Similar Species
| Species | Distinguishing Features |
|---------|------------------------|
| Calvatia cyathiformis | Smaller, purple-brown gleba at maturity |
| Calvatia booniana | Western North America, larger surface scales |
| Bovista plumbea | Much smaller (2–5 cm), greyish outer skin |
| Scleroderma citrinum | Hard rind, dark gleba early; toxic |
...
- **Chinese medicine**: Dried fruiting bodies used in tonics for immune
  strengthening (limited documentation)
- **Wart removal**: Spore powder applied to warts was widespread folk remedy
## Conservation Status
Not globally threatened, but populations have declined in intensively
agricultural regions due to habitat loss and pesticide use. Benefits from
