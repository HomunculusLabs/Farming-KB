...
- Many *Glomus* species cannot be identified with fewer than 40–50 spores in good condition
- Spore volume calculations for *G. caledonium* are used as a reference point in importance value (IV) rankings for community ecology studies

## Relevance to Cultivation and Mycology

*Glomus caledonium* is relevant to mycological research because:

- Serves as a benchmark species for comparing spore biovolume across AM fungal communities
- Illustrates the challenges of *Glomus* taxonomy, where species boundaries are defined primarily by spore wall characteristics requiring high-quality specimens
...
- The page title is Glomus caledonium.
...
- Existing wikilink already present on this page: [[glomus-mosseae]].
