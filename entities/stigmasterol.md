...
Stigmasterol (C₂₉H₄₈O) is an unsaturated phytosterol with a molecular weight of 412.7 g/mol. Its structure differs from that of β-sitosterol by the presence of a trans double bond between C-22 and C-23 in the side chain, and from cholesterol by the addition of a methyl group at C-24 and an ethyl group at C-24, along with the C-22 double bond. This characteristic C-22(23) unsaturation makes stigmasterol an ideal starting material for brassinosteroid synthesis, as the double bond can be selectively hydroxylated to produce the 22S,23S-diol configuration found in active brassinosteroids.
...
- Participate in plant responses to abiotic stress, particularly cold and salt stress.

### Defense

Phytosterols including stigmasterol contribute to plant defense by maintaining membrane integrity under pathogen attack and by serving as precursors to defense-related steroid compounds.
