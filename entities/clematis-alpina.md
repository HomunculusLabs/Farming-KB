...
Clematis alpina, the alpine clematis, is a deciduous climbing vine in the family Ranunculaceae. It is native to montane and subalpine regions of central and southern Europe, extending from the Pyrenees to the Carpathians. The species typically reaches 2–4 m in height, climbing by means of twining leaf petioles.
...
Flowers are solitary, pendulous, and campanulate, 3–5 cm across. Each flower has four petal-like sepals in shades of blue-violet. True petals are absent, replaced by prominent staminodes (sterile stamen-like structures) in the center.

Staminodes are spatulate, 1–2 cm long, and typically a lighter shade than the sepals. They create a double-layered effect that distinguishes Atragene-type clematis from other groups.
...
The species grows at elevations of 600–2,400 m, inhabiting rocky slopes, scrub, open coniferous woodlands, and forest margins. It prefers cool, moist conditions with well-drained, calcareous to neutral soils.

In alpine environments, it scrambles through low shrubs and over rocks, often forming extensive patches on stable scree slopes. The species benefits from the shelter of larger shrubs that provide support for climbing.

The species is protected in several European countries where it occurs at the edge of its range. In Germany and Austria, wild collection is restricted.

Populations in the Julian Alps and Dolomites are particularly robust, with individual plants sometimes covering 10+ square meters of rock face.

## Cultivation

Clematis alpina is widely cultivated as an ornamental climber for walls, fences, trellises, and rock gardens. It is hardy in USDA zones 4–9 and RHS hardiness rating H7.

### Cultural Requirements

The species prefers a position with its roots in shade and its top growth in sun or partial shade. This "warm feet, cool head" requirement is typical of most clematis.
...
Popular cultivars include 'Pamela Jackman' (deep blue), 'Frances Rivis' (large mid-blue), 'Ruby' (pink-red), and 'White Swan' (white). The 'Constance' cultivar produces deeper pink, semi-double flowers.

Clematis alpina is notably resistant to clematis wilt (caused by the fungus Phoma clematidina), which afflicts many large-flowered hybrids. This disease resistance makes it a reliable choice for low-maintenance gardens.

The species has received the RHS Award of Garden Merit, confirming its garden worthiness and reliability across UK growing conditions.
