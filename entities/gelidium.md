...
phylogenetics has revealed that Gelidiales is one of the most basal orders
within the Rhodophyta, and the genus itself contains significant cryptic
diversity requiring taxonomic revision.

Thalli are erect, cartilaginous, and range from 2 to 30 cm in height. The
fronds are repeatedly pinnately or irregularly branched, forming dense
tufts or cushion-like mats attached to substrate by a small discoid holdfast.

The branching pattern is an important diagnostic character: species may be
pinnate, bipinnate, or irregularly divided. Branch axes are cylindrical to
compressed, and the consistency is firm and slightly wiry when fresh.

Color ranges from purplish-red to dark red-brown. Under strong illumination,
thalli may bleach to yellowish or orange. The surface texture is smooth to
slightly rough depending on species.

Reproductive structures include **tetrasporangia** borne in swollen branch
apices, **spermatangia** in surface cavities, and **cystocarps** that are
sessile or shortly stalked. These features are critical for species-level
identification in this morphologically conservative genus.
