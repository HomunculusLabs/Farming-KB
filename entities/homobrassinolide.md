...
22S,23S-homobrassinolide is relatively stable when stored as a dry powder at low temperatures (−20°C) protected from light and moisture. In solution, it degrades over time, particularly at neutral to alkaline pH and elevated temperatures. For experimental use, stock solutions are typically prepared in ethanol or dimethyl sulfoxide and stored at −20°C, with working solutions prepared fresh for each application. The compound's stability characteristics are consistent with those of other brassinosteroid lactones, which are generally more stable than the corresponding free alcohols.
...
- [[psilocybin]] — primary psychoactive alkaloid whose production may be influenced by brassinosteroids
