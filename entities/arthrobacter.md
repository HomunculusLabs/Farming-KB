...
type: entity
tags: [bacteria, composting, thermophilic, soil-food-web, genus]
---
...
Arthrobacter species are aerobic, non-spore-forming bacteria known for their remarkable metabolic versatility and resistance to environmental stress. The name derives from their distinctive rod-to-coccus morphological cycle, where cells transition between rod-shaped and spherical forms depending on growth conditions.
...
- **Stress tolerance:** These bacteria can survive desiccation, nutrient starvation, and extreme temperatures far better than many other soil bacteria. Their ability to form resting stages (without true endospores) allows them to persist in harsh compost environments.

- **Nitrogen cycling:** Arthrobacter participates in nitrogen transformations in soil and compost, contributing to the conversion of organic nitrogen into plant-available forms.

- **Soil habitat:** Beyond compost, Arthrobacter is one of the most abundant bacterial genera in agricultural and forest soils, often comprising a significant proportion of culturable soil bacteria.

## Role in the Composting Process

In the composting cycle described by Lowenfels and Lewis, the process moves through three temperature phases:

1. **Mesophilic phase** (68-104F / 20-40C): Initial colonization by moderate-temperature organisms
2. **Thermophilic phase** (104-150F / 40-65C): Arthrobacter becomes active alongside Pseudomonas spp. and actinomycetes. Complex carbohydrates are fully broken down, proteins decompose, and hemicelluloses are decayed. The high temperatures also kill pathogens.
3. **Maturation phase** (cooling): Mesophilic organisms return

Arthrobacter's primary contribution occurs during phase 2, where its heat tolerance and metabolic capabilities allow it to continue decomposition when other organisms cannot survive.

## Relevance to Cultivation and Mycology

- **Compost quality:** The activity of Arthrobacter during thermophilic composting directly influences the quality and maturity of finished compost. Effective thermophilic decomposition ensures pathogen destruction and complete breakdown of complex organic matter.
...
- **Temperature range:** Active from moderate temperatures through thermophilic range (up to approximately 65C)
- **Oxygen requirement:** Strictly aerobic; requires well-aerated compost piles
- **Moisture:** Requires adequate moisture but not saturation
- **pH:** Tolerant of a wide pH range, generally preferring neutral to slightly alkaline conditions
