...
sources:
  ...
  - "https://pubchem.ncbi.nlm.nih.gov/compound/16047459"
---
...
| CAS number | 77819-28-6 |
| Molecular formula | C16H22N2O2 |
| Molecular weight | 274.36 g/mol |
| SMILES | CCN(CC)CCC1=CNC2=C1C(=CC=C2)OC(=O)C |
| InChIKey | Pending verification |
| Appearance | White to off-white crystalline powder |
| Solubility | Soluble in ethanol, DMSO, chloroform; poorly soluble in water |
| Storage | Stable at room temperature; store desiccated, protected from light |
| Melting point | Not extensively documented in literature |

4-AcO-DET is structurally analogous to 4-AcO-DMT, with the key difference being the diethyl substitution on the terminal amine (two ethyl groups) versus the dimethyl substitution (two methyl groups) in 4-AcO-DMT. This N,N-diethyl substitution pattern is characteristic of the "DET" (diethyltryptamine) subfamily, which includes DET itself and its hydroxylated derivative 4-HO-DET.
...
|-------|-----------|-------|--------|--------|-------|
| Oral | 5 mg | 10–15 mg | 15–25 mg | 25–40 mg | 40+ mg |

## Effects
### Subjective Experience
- **Visual effects:** Enhanced color saturation, geometric patterning, flowing form constants, and moderate visual distortion — generally less intense than 4-AcO-DMT at equivalent doses
- **Cognitive effects:** Altered thought patterns, creative ideation, enhanced introspection, and philosophical or existential contemplation
- **Emotional effects:** Euphoria, emotional openness, and enhanced appreciation of music and art; anxiety possible at higher doses
- **Somatic effects:** Mild body load, tingling sensations, pupil dilation, increased heart rate, and mild nausea during onset
- **Comparison to related compounds:** Described as gentler and less visually intense than 4-AcO-DMT, with a warmer, more "grounded" quality; the diethyl substitution produces a smoother headspace compared to dimethyl analogs
- **Dose-response curve:** Effects scale predictably with dose; the transition from light to common to strong ranges is gradual rather than abrupt, contributing to a manageable experience profile
- **Time structure:** Come-up (20–45 min), peak (1–3 hours), gradual comedown (1–2 hours), afterglow (1–2 hours of residual openness and relaxation)
- **Unique character:** Users consistently report a "warmer" and less "electric" quality compared to 4-AcO-DMT, attributed to the diethyl substitution's effect on receptor binding kinetics
- **Auditory effects:** Enhanced music appreciation, subtle auditory distortion, and increased perceived depth of sound are commonly reported
- **Synesthesia:** Rare but reported at strong doses, typically manifesting as color-sound associations or enhanced cross-modal perception

### Pharmacological Comparison

| Compound | Substitution | Relative Potency | Character |
|----------|-------------|-----------------|-----------|
| 4-AcO-DET | N,N-diethyl, 4-OAc | Moderate | Warm, grounded, less visual |
| 4-HO-DET | N,N-diethyl, 4-OH | Moderate | Similar profile, faster onset |
| 4-AcO-DMT | N,N-dimethyl, 4-OAc | Higher | More visual, more intense |
| 4-AcO-MET | N,N-ethyl-methyl, 4-OAc | Moderate-High | Between DET and DMT profiles |
| DET | N,N-diethyl, unsubstituted | Lower | Shorter, simpler tryptamine |
| Psilocin (4-HO-DMT) | N,N-dimethyl, 4-OH | Higher | Benchmark psychedelic tryptamine |

## Synthesis
The synthesis of 4-AcO-DET follows the general pathway for 4-acetylated tryptamines. The Shulgin TIHKAL entry describes a route starting from 4-hydroxyindole, which undergoes reductive amination with diethylamine followed by acetylation of the 4-hydroxy position using acetic anhydride. The synthetic chemistry is well-established and mirrors that of other 4-acetoxytryptamines. Synthesis of controlled substances is illegal without appropriate authorization in virtually all jurisdictions.
...
- **United Kingdom:** Class A under the Psychoactive Substances Act amendments and Misuse of Drugs Act
...
- **Germany:** Controlled under the NpSG (New Psychoactive Substances Act) or BtMG
...
- **Pregnancy:** No safety data available; contraindicated during pregnancy and breastfeeding due to unknown developmental effects of serotonergic compounds
...
- **Comparative pharmacology:** Enables systematic comparison of diethyl vs. dimethyl substitution effects across multiple 4-substituted tryptamine scaffolds
- **Prodrug validation:** Supports the broader prodrug hypothesis for psychedelic tryptamines, informing drug design for therapeutic psychedelic candidates
...
- Integration practices and psychological support recommended, especially at common-to-strong doses
- Trip sitting recommended for doses above the common range
