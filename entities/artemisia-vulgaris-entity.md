...
Inflorescences are paniculate, composed of numerous small capitula (3–4 mm diameter) arranged in erect, leafy racemes. Each capitulum contains 5–12 ray florets and 10–30 disc florets. Flowers are reddish-brown to yellowish, blooming from July to October. Involucral bracts are oblong, green with scarious margins, covered with silky hairs. The inflorescence often has a "rusty" appearance due to flower and bract coloration.

### Rhizome System
Extensive network of creeping, woody rhizomes 5–15 mm in diameter,
growing horizontally 5–20 cm below the soil surface. Rhizomes are
yellowish-white internally with dark brown exterior, producing numerous
adventitious buds that give rise to new shoots. This rhizomatous growth
is the primary mechanism of colonization and makes the species difficult
to eradicate once established. A single mature plant can produce rhizome
networks extending 3–5 m in all directions within 2–3 growing seasons.

## Distribution and Habitat
- **Native range:** Europe, temperate Asia, North Africa. Naturalized across North and South America, Oceania, and parts of Africa.
- **Altitude:** Sea level to 2,000+ m in mountainous regions.
...
- **Companion planting:** Deters cabbage moth caterpillars when interplanted with brassicas. Attracts predatory insects (ladybugs, lacewings, ground beetles).
- **Soil stabilization:** Extensive rhizome network prevents erosion on banks, slopes, and waterway margins during heavy rainfall events.
- **Mulch source:** High biomass production provides abundant carbon-rich mulch material. Leaves decompose relatively quickly, adding organic matter and trace minerals.
- **Dye plant:** Yields yellow to olive-green dyes from leaves and stems. The dye is substantive (no mordant needed) and lightfast.
- **Pitfall:** Rhizomatous spread requires root barriers in cultivated settings. Allelopathic leaf litter may inhibit seed germination of some species.

## Similar Species
| Species | Distinguishing Features |
|---------|------------------------|
| A. absinthium (wormwood) | More silvery foliage, more bitter, higher thujone |
| A. annua (sweet wormwood) | Finer leaves, annual, source of artemisinin |
| A. dracunculus (tarragon) | Smooth narrow leaves, anise-like flavor |
| A. princeps (Japanese mugwort) | Softer leaves, less aggressive, culinary |

## Conservation Status
- **IUCN status:** Least Concern (extremely widespread).
- **Population trend:** Stable to expanding in most regions due to
  disturbance-tolerant and rhizomatous growth habits.
- **Genetic diversity:** High across native range; some differentiation
  between European and Asian populations.
- **Harvesting considerations:** Wild harvesting should avoid collecting
  from contaminated sites (roadsides, industrial areas) due to the
  plant's ability to accumulate heavy metals from soil.

## Field Identification Tips
- Look for tall (1–2 m), erect stems with a purplish tinge at the base.
- Leaves are dark green above, silvery-white below, deeply divided.
- The aromatic scent when leaves are crushed is distinctive — bitter,
  slightly sage-like, with a camphor undertone.
- Flower heads are small, reddish-brown, in erect spikes with a rusty
  appearance from a distance.
- Commonly found along roadsides, field margins, and waste ground.
- Flowering period (July–October) aids identification when other
