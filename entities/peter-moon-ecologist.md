...
When evaluating a permaculture system, apply Moon's three lenses:
1. **Richness count:** How many species are present? Target a baseline of 30-50+ useful species in a Zone 1-2 system.
2. **Diversity assessment:** Are resources (light, water, nutrients) distributed among many species, or dominated by a few aggressive ones? Prune or manage dominants.
3. **Evenness check:** Does each species contribute meaningfully to total biomass and yield, or are many species present but insignificant? Improve conditions for underperforming species or replace them with better-adapted alternatives.

## Relationship to Modern Biodiversity Science

Moon's 1985 framework anticipated developments in biodiversity-ecosystem function research that would become a major focus of ecology in the 1990s and 2000s. The finding that species-rich plant communities have higher evapotranspiration (and thus greater energy use) connects directly to modern research showing that biodiversity increases ecosystem productivity, stability, and resilience. For the permaculture designer, this provides scientific backing for the intuitive practice of packing as many functional species as possible into designed ecosystems.

## Key Contributions
- Advanced understanding of ecological systems
- Influenced environmental science methodology
