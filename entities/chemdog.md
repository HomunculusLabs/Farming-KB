...
Chemdog delivers a fast-hitting, powerfully cerebral high that transitions into deep physical relaxation:

- **Onset**: Rapid (within minutes); initial head rush with euphoria, creative energy, and heightened sensory
  perception.
- **Peak**: Intense cerebral stimulation — users report vivid visual enhancements, racing thoughts, and sometimes
  mild dissociation or "melting" sensations.
- **Come-down**: Heavy body stone that can be profoundly couch-locking; sedation increases with continued use.
- **Duration**: 2–3 hours for the cerebral phase; physical relaxation can persist for 4+ hours.

Due to its potency, Chemdog is best suited for experienced consumers. High doses can provoke anxiety, paranoia, or
...
Chemdog is renowned for its high THC content, consistently testing between 18–28% THC in modern commercial samples,
with some phenotype selections exceeding 30%. CBD content is typically very low (<0.1%), which contributes to the
intensity of its psychoactive effects — without CBD's moderating influence, the full THC-driven experience is
unbuffered. CBG (cannabigerol) is occasionally present at 0.5–1.0%, and trace amounts of THCV have been detected
in certain phenotypes, which may contribute to the strain's energetic initial onset. The THC:CBD ratio of 200:1
or higher makes this a strain best avoided by users sensitive to THC or prone to anxiety.

## Phenotype Variations

The original four Chemdog phenotypes remain the genetic source for most modern Chemdog-derived cultivars:

- **Chemdog '91** — The most potent and sought-after phenotype; intense diesel aroma, highest THC, longest-lasting
  effects. The direct parent of Sour Diesel.
- **Chemdog '91 B** — Similar to '91 but with a slightly sweeter aroma profile and marginally more balanced high.
- **Chem Sis** — Shorter, bushier growth habit; more indica-dominant effects with heavier body stone; floral,
  less acrid aroma. Used as a parent in several modern crosses.
- **Chemdawg D** — The most widely distributed phenotype; large yields, vigorous growth; diesel-dominant aroma.
  Parent of many "Chemdawg" named strains sold commercially.
...
- **Chemdawg 91** — Direct Chemdog phenotype
- **Chem Sis** — Direct Chemdog phenotype
- **GSC (Girl Scout Cookies)** — OG Kush × Durban Poison (OG Kush carries Chemdog lineage)
