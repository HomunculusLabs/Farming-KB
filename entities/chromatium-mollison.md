...
- Anaerobic photosynthetic bacterium that thrives in the sulphide-rich bottom layers of sewage lagoons
- Uses hydrogen sulphide (H2S) as electron donor for photosynthesis instead of water
- Produces elemental sulphur as a by-product, which deposits as granules inside or outside the cell
- Contributes the pink to reddish-purple colouration observed in anaerobic sewage ponds
- Strictly anaerobic in the photic zone — requires both light and sulphide
...
1. **Sulphide oxidation**: Converts toxic hydrogen sulphide to less harmful elemental sulphur
2. **Heavy metal precipitation**: The sulphur produced binds with dissolved metals (copper, lead, zinc, cadmium) forming insoluble sulphides
3. **Carbon fixation**: Assimilates dissolved carbon compounds into bacterial biomass
