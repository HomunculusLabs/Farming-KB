...
sources:
  ...
  - https://www.mushroomexpert.com/cortinarius_rubellus.html
...
Basidiomycota → Agaricomycetes → Agaricales → **Cortinariaceae → *Cortinarius → *C. rubellus***

Historically confused with and frequently cited as *Cortinarius speciosissimus*
in European mycological literature; molecular studies have clarified that the two
names refer to distinct species, with *C. rubellus* being the more widespread and
...
- **Stem:** 5–12 cm × 0.5–1.5 cm, cylindrical, slightly bulbous at base; pale
  ...
  Cortina remnants form a transient ring zone.
- **Flesh:** Pale yellowish in cap, reddish-orange in stem base; mild or slightly
  radish-like odor and taste — importantly, not notably bitter or acrid, which
  contributes to the danger as it does not warn of toxicity.
- **Spores:** Rust-brown print; broadly ellipsoid, 8.5–11 × 5.5–7 µm, finely
  roughened (echinulate).
- **Chemical reactions:** Flesh turns reddish with KOH; no significant color
  change with other reagents.
...
The deadly nature of *C. rubellus* results from the bicyclic dipeptide orellanine
(3,3',4,4'-tetrahydroxy-2,2'-bipyridine-1,1'-dioxide), a potent nephrotoxin.
