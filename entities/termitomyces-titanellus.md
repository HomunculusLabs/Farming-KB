...
- **Genus:** Termitomyces
- **Species:** T. titanellus (R. Heim) R. Heim

The species was originally described by Roger Heim in the mid-20th century during his extensive mycological surveys of Africa. It is closely related to other large African Termitomyces species, particularly *T. titanicus*, from which it is distinguished by smaller basidiospores and a more robust stipe structure.

Some authorities have treated *T. titanellus* as a variety of *T. clypeatus*, but molecular phylogenetic studies support its status as a distinct species within the genus.
...
The pileus is convex to plano-convex, reaching 80-200 mm in diameter, with a smooth to slightly wrinkled surface. The cap color ranges from pale buff to greyish-brown, often darker at the disc and paler toward the margin.

The lamellae are free to subdecurrent, crowded, and white when young, becoming pinkish-buff with age. Basidiospores are ellipsoid, smooth, hyaline, measuring 6.5-8.5 × 4.5-6.0 μm.

The stipe is central, clavate to bulbous at the base, and notably robust. A characteristic feature of the genus is the abrupt swelling at the stipe base, which in *T. titanellus* connects to the termite comb via a pseudorhiza-like structure.

The context is white, firm, and thick, with a mild to slightly nutty odor and pleasant taste. The overall appearance is similar to a very large *Agaricus* species, though the association with termite mounds is diagnostic.

## Distribution and Habitat

*Termitomyces titanellus* is distributed across sub-Saharan Africa, from West Africa through Central and East Africa. It has been recorded from countries including Nigeria, Cameroon, Democratic Republic of Congo, Tanzania, Zambia, and Zimbabwe.

The species is found exclusively in association with mounds of *Macrotermes* termites, typically *M. bellicosus* and *M. natalensis*. The fungus grows on the fungus comb — a complex structure built by termites from partially digested plant material that is inoculated with *Termitomyces* mycelium.

Fruiting occurs during the warm rainy season, typically between November and March in southern Africa. Mushrooms emerge from the mound surface or from the soil immediately surrounding the mound, often in clusters.
...
In recent years, there has been growing interest in semi-cultivation techniques for *Termitomyces* species. Researchers have explored methods for establishing fungal gardens from termite comb material in controlled environments, though large-scale cultivation has not yet been achieved commercially.

## Ecology and Symbiosis

The relationship between *Termitomyces* species and fungus-growing termites represents one of the oldest and most refined examples of insect-fungus mutualism. The termite comb provides a controlled growth substrate, while the fungus decomposes lignocellulose that the termites cannot digest alone.
