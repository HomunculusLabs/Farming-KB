...
- **Category**: Technique / Social design strategy
- **Domain**: Permaculture — Community and social organisation (Chapter 14)
- **Scale**: Regional (7,000–40,000 people optimal)
- **Origin**: Developed in part from bioregionalism movement and indigenous territorial models

## Key Facts

- A bioregional association assesses the natural, technical, service, and financial resources of a region and identifies where resources (water, soil, money, talent) are leaking out.
...
The bioregional resource index includes:
- **A**: Food and food support systems (plants, animals, IPM, processing, markets, support functions)
- **B**: Shelter and buildings (materials, energy systems, waste recycling)
- **C**: Livelihoods and support systems (community finance, skills, manufacturing)
- **D**: Information, media, communications, research
- **E**: Community and security
- **F**: Social life
- **G**: Health services
- **H**: Future trends and potential threats
- **I**: Transport services
- **J**: Appendices (maps, publications)
