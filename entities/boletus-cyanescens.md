...
Boletus cyanescens (also known as [[gyroporus-cyanescens]] in modern taxonomy) is a bolete mushroom notable for its dramatic color-changing property. When the flesh is bruised or cut, the entire mushroom turns a vivid blue throughout — described by Julius A. Palmer as "the most beautiful blue." This striking color change is caused by the oxidation of variegatic acid and [[lsd-structure-activity-relationships-related-compounds]]. Despite its alarming blue coloration, Palmer emphasized that this species is esculent (edible), and he used it as a key example to debunk the widespread folk belief that color-changing in mushrooms indicates toxicity.
...
- **Order:** Boletales
- **Family:** Gyroporaceae
- **Genus:** Gyroporus (formerly classified in Boletus)
- **Species:** G. cyanescens (Bull.) Quél.
...
- Found in deciduous and mixed forests, particularly under oaks and beeches, in [[guzman-psilocybin-mushrooms-north-america]] and Europe.
- The [[field-guide-psilocybin-bluing-reaction-identification]] is similar to (but mechanistically different from) the bluing seen in [[psilocybin]]-containing mushrooms, where the blue color results from oxidation of [[psilocin]].
...
- Modern taxonomic revision places this species in Gyroporus rather than Boletus.
## Historical Context
...
The study and understanding of boletus cyanescens connects to broader themes in
