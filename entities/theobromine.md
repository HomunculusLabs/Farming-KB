...
**Theobromine** (3,7-dimethylxanthine) is a bitter alkaloid of the xanthine family found primarily in cacao beans (*[[caffeine]] and theophylline, sharing the purine-derived xanthine core with differing patterns of methyl substitution.
...
It appears as a white, crystalline powder with a slightly bitter taste and a melting point of approximately 357 °C ([[vegetable-storage-conditions-by-temperature-and-humidity]] and resistant to thermal degradation at typical food processing temperatures.
...
The pharmacokinetic profile features [[mushroom-cancer-clinical-trials-overview]] showing systolic BP decreases of 2–5 mmHg with regular cocoa consumption.
...
Clinical studies have demonstrated antitussive effects superior to [[camellia-sinensis]]), kola nuts, and guarana berries, though these contain predominantly caffeine with only trace theobromine.

## Overview

Theobromine represents an important element within sustainable
...
Several defining characteristics distinguish theobromine
...
The ecological relationships involving theobromine extend
...
Theobromine finds practical application in multiple design contexts.
...
opportunities for theobromine. Climate adaptation
...
theobromine and its applications. Active investigation
areas include ecological interactions and optimization.
Published findings contribute to an evolving evidence base.

## Historical Context

Theobromine has been recognized across multiple knowledge traditions.
...
Successful integration of theobromine into broader
