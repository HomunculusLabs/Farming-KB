...
- **Role**: Academic researcher, professor, mycologist
- **Institution**: Cardiff School of Biosciences, Cardiff University, UK
- **Research areas**: Fungal ecology, wood decomposition, mycelial networks, basidiomycete biology
- **Career span**: Active from the 1980s to present
- **Recognition**: Member of the Order of the British Empire (MBE) for services to mycology

## Key Facts

### Academic Background
- Based at Cardiff University, Cardiff, Wales, UK (Cardiff School of Biosciences, Main Building, Park Place, Cardiff CF10 3TL)
- Long-standing affiliation with the British Mycological Society
- Key figure in the British Mycological Society Symposium series that produced "Fungi in the Environment"

### Research Contributions

#### Wood Decomposition Ecology
- Pioneered experimental approaches to studying fungal communities in decaying wood
- Documented competitive interactions between wood-decay basidiomycete species
- Established frameworks for understanding succession in fungal communities during wood decomposition
...
#### Imaging and Methodology
- Collaborated on advanced imaging techniques including radiolabel tracking and confocal microscopy of mycelial systems
- Co-developed approaches for real-time visualization of nutrient movement in fungal networks
- Contributed to mathematical modeling of mycelial form and function alongside collaborators like Fordyce Davidson and Mark Fricker

### Major Publications and Works
- Contributor to "Fungi in the Environment" (2007) — two chapters
- Author of numerous highly-cited papers on fungal ecology and wood decomposition
- Co-author with T. Hefin Jones on mycelial responses to heterogeneous environments
- Frequent collaborator with Sarah C. Watkinson, Mark D. Fricker, and Daniel P. Bebber at the University of Oxford
...
- Wood-decay fungi and decomposition ecology
- Mycelial cord networks and nutrient translocation
- Basidiomycete biology
- British Mycological Society
- Forest ecosystem ecology
- Fungal competitive interactions
- Cardiff University mycology research group

## Source Reference

Contributor to "Fungi in the Environment" (Gadd, Watkinson & Dyer, 2007), Cambridge University Press. Affiliation: Cardiff School of Biosciences, Cardiff University, Main Building, Park Place, Cardiff CF10 3TL, UK. Co-author of Chapter 1 (Imaging nutrient dynamics) and Chapter 6 (Mycelial responses in heterogeneous environments).
