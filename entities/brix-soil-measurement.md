...
Brix is a measurement of dissolved solids in plant sap, primarily sugars, expressed as a percentage on a refractometer scale. In the context of soil health and [[compost]] tea application, brix readings are used as an indicator of plant nutritional status and the effectiveness of biological soil management. [[elaine-ingham]] discusses brix extensively in relation to compost tea impacts on plant health, raising important caveats about its interpretation.

## Classification

- **Category**: Plant health indicator / refractometric measurement
- **Measures**: Total dissolved solids (primarily sugars, but also minerals, amino acids, proteins)
- **Tool**: Refractometer (0-32 Brix scale typical for plants)
- **Units**: Degrees Brix (°Bx), equivalent to grams sucrose per 100g solution

## Key Facts

1. **Protein vs Sugar Indicator**: Ingham's testing showed that vegetables, grapes, and strawberries grown with healthy soil foodwebs contain 3 to 10 times more protein than conventionally grown plants. Brix measures sugar content, not protein directly, but higher brix in biologically-managed systems may reflect overall improved nutrition.
...
For mushroom growers managing substrates and fruiting environments, brix principles apply to understanding how mycelial organisms interact with their food sources. Complete nutrient cycling by beneficial organisms prevents accumulation of intermediate metabolites that attract competitors.

### Practical Testing Protocol
1. Measure brix in all test plots before any application
2. Apply treatments (good tea, poor tea, water, nutrients)
3. Measure brix immediately after and at intervals through the day
4. Check leaf surfaces to confirm tea coverage
5. Document differential responses over time

### Caveats
- Brix measures total dissolved solids, not just sugar
- Plant species, time of day, and weather affect readings
- Higher brix does not always mean healthier plants
- Protein testing may be a more meaningful metric than brix alone
- Anecdotal evidence is abundant but replicated scientific studies on brix and compost tea are limited

## Source Reference

Elaine Ingham, PhD — *The Field Guide I for [[actively-aerated-compost-tea]]*. Sections on Brix (entries 35-37, 11/26/02, 11/27/02, 11/29/02).
