...
positioning the furan and pyrone double bonds for photochemical cycloaddition.

## Pharmacology: DNA Crosslinking

The pharmacological action of psoralen depends on two sequential steps:

1. **Intercalation:** In the dark, psoralen inserts between DNA base pairs,
   preferentially at 5'-TpA sites, with the furan ring oriented toward the
   minor groove
2. **Photoactivation:** UVA absorption (λmax ≈ 330 nm) excites the molecule,
   generating a reactive triplet state. Two sequential [2+2] cycloaddition
   reactions form covalent cyclobutane bridges:
   - Monoadduct: Psoralen linked to a single thymine via furan or pyrone end
   - Crosslink: Second cycloaddition links both ends to thymines on opposite
     DNA strands (interstrand crosslink)
