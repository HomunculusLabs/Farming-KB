...
The biosynthesis of psilocybin in *P. hermescii* follows the conserved tryptamine-derived pathway shared across psilocybin-producing fungi.
L-tryptophan is first decarboxylated to tryptamine by the enzyme PsiD (aromatic L-amino acid decarboxylase).

Tryptamine is then sequentially methylated by PsiM (an indolethylamine N-methyltransferase) through an N-methyltryptamine intermediate to yield N,N-dimethyltryptamine (DMT).
A subsequent 4-hydroxylation step, catalyzed by PsiK (a cytochrome P450 monooxygenase), converts DMT to psilocin (4-hydroxy-DMT).
...
Field collection and isolation of pure cultures from fresh specimens would be a necessary first step for any future domestication effort.
