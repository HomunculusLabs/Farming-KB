...
- **Chemical type**: Polysaccharide (structural carbohydrate)
...
- Chitin was first isolated in 1811 by Henri Braconnot from mushroom fruiting bodies
- In compost tea systems, chitin is added as a food source to stimulate chitinolytic (chitin-degrading) microorganisms
- Bacteria and fungi that produce chitinase enzymes can degrade chitin, and many of these same organisms are antagonistic to plant pathogenic fungi
- Crab shell waste and shrimp shell meal are common chitin-rich amendments used in AACT ([[actively-aerated-compost-tea]]) brewing
- When chitinolytic organisms are stimulated, they can suppress fungal pathogens whose cell walls contain chitin, creating a natural disease suppression mechanism
- Chitin amendments can also affect nematode populations by promoting organisms that parasitize or repel plant-parasitic nematodes
- Elaine Ingham identifies chitin as an important ingredient consideration for compost tea formulations targeting fungal pathogen suppression
- Ingham's guide lists crab waste granulated as a specific AACT ingredient that provides chitin
- Chitin degradation releases nitrogen, making it a slow-release nitrogen source in addition to its biological effects
- The chitin signaling pathway in plants is similar to pathogen-associated molecular pattern (PAMP) recognition, triggering defense responses

## Relevance to Cultivation and Mycology

Chitin is central to fungal biology — it forms the structural scaffold of fungal cell walls alongside beta-glucans and glycoproteins.
