...
3. Seed pioneer species into mounds: castor oil bean, Prosopis, thorny legumes, followed by tamarind, Vitex, Sapium, or palms
4. For crop production, plant sisal, cotton, tobacco, daikon radish, or other adapted crops directly into mound material
5. Use termites for mulch processing by placing woody material near active colonies in coffee, tea, or banana plantations
6. Monitor which crops are left alone on mounds versus which benefit from termite association
...
4. Understory develops beneath pioneer shrubs
5. Forest trees establish (tamarind, Vitex, Sapium, palms)
...
- Niche gardening techniques
- Harris (1971) — ecological research
- Bill Mollison
