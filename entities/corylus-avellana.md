...
**Corylus avellana** L. (common hazel) is a deciduous shrub or small tree
in the family Betulaceae, native to Europe and western Asia. It is the
primary commercial source of hazelnuts (filberts), one of the world's
...
- **Kingdom:** Plantae; **Order:** Fagales
- **Family:** Betulaceae; **Genus:** Corylus; **Species:** *C. avellana* L.
- **Synonyms:** *Corylus tubulosa* W.D.J. Koch

Common hazel is a multi-stemmed deciduous shrub 3–8 m tall, though
cultivated varieties are often trained as single-trunk trees. Bark is
smooth, grey-brown, peeling in thin flakes with age.

Leaves are alternate, broadly ovate, 6–12 cm long and 5–9 cm wide,
with a doubly serrate margin and a rounded to cordate base. The
upper surface is dark green and slightly rough; the lower surface
is paler with tufted hairs in vein axils.

Hazels are monoecious. Male flowers are pendulous catkins 4–8 cm
long, forming in autumn and releasing pollen in late winter (January–
March) before leaf emergence. Female flowers are small, red, bud-like
structures with exposed crimson stigmas.

The fruit is a rounded nut 1.2–2 cm in diameter, enclosed in a green,
leafy involucre (husk) that extends beyond the nut. Nuts ripen in
August–September.
...
pollen-shedding types. Key cultivars include 'Barcelona,' 'Tonda
di Giffoni,' 'Tonda Gentile delle Langhe,' 'Jefferson,' and
'Yamhill.'

Harvest occurs when nuts fall naturally or are mechanically shaken
from trees. Average yields range from 1.5–3.5 t/ha of in-shell nuts.
Trees begin bearing at 3–5 years and remain productive for 50+ years.
