...
**Fontinalis antipyretica** is a large, aquatic moss in the family Fontinalaceae, commonly known as the willow moss, greater water moss, or antifever fontinalis. It is one of the most widespread and recognizable aquatic bryophytes in the Northern Hemisphere.

The species grows entirely submerged in flowing or standing water, forming dense, dark green to brownish-green mats that drape over rocks, submerged wood, and tree roots.
...
**Classification:** Plantae → Bryophyta → Bryopsida → Hypnales → Fontinalaceae → Fontinalis → F. antipyretica Hedw. (1801).

**Authority:** Hedwig published the species in 1801 in his *Species Muscorum Frondosorum*. The genus *Fontinalis* contains approximately 40 species worldwide.

The species is highly variable in morphology, and several infraspecific taxa have been described. The most commonly recognized variety is var. *antipyretica* (the typical form), with var. *gigantea* (Sull.) Sull. being more robust with larger leaves.

**Stems** are prostrate to ascending, irregularly branched, and can reach 20–40 cm in length. Stems are densely covered with overlapping leaves, giving the plants a feathery, willow-like appearance.

**Leaves** are ovate to lanceolate, 2–4 mm long, with a short, double costa (midrib) extending 1/3 to 2/3 the leaf length. Leaf margins are entire and often recurved at the tip.

Leaves are arranged in three-ranked spiral pattern, but in the typical variety they appear almost complanate (flattened in one plane), giving frond-like shoots that resemble small fern fronds.

Leaf cells are elongate, smooth, and thin-walled. The laminal cells are 30–60 μm long, with shorter cells at the leaf base and alar region.

**Rhizoids** are sparse, arising primarily from the stem undersurface. Attachment to substrate is relatively weak compared to terrestrial mosses.

**Capsules** are rarely produced. When present, they are ovoid, 1.5–2.5 mm long, on a short seta, with a conical operculum. Spores are 12–18 μm, finely papillose.

Vegetative reproduction is the primary mode of propagation. Fragmentation of stems easily produces new colonies — even small stem segments can regenerate.
...
It attaches to a variety of submerged substrates including rocks, boulders, submerged wood, tree roots, and occasionally artificial structures such as bridge pilings and dock surfaces.

Optimal conditions include water temperatures of 5–20 °C, moderate current velocity (10–50 cm/s), neutral to slightly acidic pH (6.0–7.5), and moderate calcium concentrations.

The species can tolerate significant shading and is often found under tree canopies in forested streams. It is less common in exposed, high-light conditions.

It typically occurs at elevations below 1000 m but has been recorded at higher altitudes in mountain streams.
