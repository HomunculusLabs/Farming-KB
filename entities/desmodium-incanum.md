...
aliases:
  ...
  - Hedysarum incanum
sources:
  - Schultze-Kraft, R. et al. (2018). "Desmodium incanum: A versatile tropical forage legume." Tropical Grasslands, 6(3), 150–162.
...
Desmodium incanum is a perennial tropical and subtropical legume in the family Fabaceae, subfamily Faboideae. Native to the Americas, it has naturalized across tropical regions worldwide and is valued as a drought-tolerant pasture legume, ground cover, and soil-improving cover crop.

The species is closely related to D. uncinatum (silverleaf desmodium), which is the primary Desmodium species used in push-pull agricultural technology in East Africa. D. incanum shares many of the same beneficial traits but is more adapted to grazing pressure and lower-fertility soils.
...
Kingdom: Plantae → Clade: Tracheophytes → Clade: Angiosperms → Clade: Eudicots → Clade: Rosids → Order: Fabales → Family: Fabaceae → Subfamily: Faboideae → Tribe: Desmodieae → **Genus: *Desmodium* → Species: *D. incanum***.

Authority: DC. (1825). Synonyms include *Desmodium canum* (J.F.Gmel.) Schinz & Thell., *Hedysarum incanum* Sw.

The genus *Desmodium* contains approximately 300 species of tropical and subtropical legumes distributed across the Americas, Africa, Asia, and Australia.

## Morphology

D. incanum is a prostrate to ascending perennial herb growing 30–90 cm tall. Stems are slender, green to reddish-brown, and densely covered with fine spreading hairs (pubescent), giving the foliage a grayish-green appearance.

Leaves are trifoliolate with petioles 1–3 cm long. Leaflets are ovate to elliptic, 1.5–4 cm long and 1–2.5 cm wide, with a notched tip (emarginate). The upper leaflet surface is sparsely hairy while the lower surface is densely pubescent.

Inflorescences are axillary racemes 5–15 cm long bearing pink to purplish flowers 5–8 mm long. Flowers are papilionaceous, typical of the Faboideae subfamily, with a standard, two wings, and a keel.

The fruit is a flattened loment (segmented pod) 2–5 cm long, breaking into 4–8 one-seeded segments at maturity. Each segment is covered with hooked hairs that facilitate animal dispersal. Seeds are reniform, approximately 2 mm long, dark brown to black.
...
The species tolerates moderately acidic soils (pH 4.5–6.5) and low soil fertility, performing well on sandy and lateritic soils where more demanding legumes fail. It is moderately drought-tolerant once established.
...
Some Desmodium species produce allelopathic compounds that inhibit germination of competing plant species. This allelopathic potential has implications for both weed suppression in pastures and potential negative effects on crop seedlings in intercropping systems.
...
The species persists well under grazing and can form the dominant legume component in mixed pastures with signal grass (*Brachiaria decumbens*), guinea grass (*Megathyrsus maximus*), or pangola grass (*Digitaria eriantha*).

## Ecological Interactions

D. incanum provides nectar and pollen resources for native bees, butterflies, and other pollinators throughout its extended flowering period. The flowers are particularly attractive to small native bee species.
