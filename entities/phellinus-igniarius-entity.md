...
- **Genus:** Phellinus (sensu lato; some authorities place it in Fuscoporia)
- **Species:** P. igniarius (L.) Quél. (1886)
- **Basionym:** Boletus igniarius L. (1753)
- **Synonyms:** Polyporus igniarius (L.) Fr., Fomes igniarius (L.) Kickx
- **Common names:** Willow bracket, fire sponge, false tinder conk

Taxonomic complexity surrounds P. igniarius and related species (P. pomaceus,
P. tremulae). Molecular phylogenetics reveals it likely encompasses a species
complex. The Chinese medicine name *Sanghuang* historically refers to
multiple Phellinus/Fuscoporia species on mulberry and other hardwoods.
...
| Feature | Description |
|---------|-------------|
| **Cap** | Hoof-shaped to semicircular, 5–25 cm across, 3–10 cm thick |
...
| Feature | Description |
|---------|-------------|
| **Spores** | Subglobose to broadly ellipsoid, 4.5–6.5 × 4–5.5 µm, smooth, hyaline |
| **Basidia** | Clavate, 4-sterigmate, 10–15 × 5–7 µm |
| **Setae** | Abundant, subulate, dark brown, 15–25 × 4–7 µm |
| **Hyphal system** | Dimitic: generative hyphae with simple septa + skeletal hyphae |
| **Skeletal hyphae** | Thick-walled, unbranched, 2.5–4.5 µm diameter, golden-brown |
...
- **Habitat:** Riparian zones, wet woodlands, mixed forests. Also along
