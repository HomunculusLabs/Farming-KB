...
- **Category**: Laboratory reagent / Chromatography adsorbent
...
- Florisil is a fine powder that can be a respiratory irritant; handle with appropriate ventilation or respiratory protection.
- Used in conjunction with organic solvents (hexane, chloroform, methanol), which carry their own significant health and fire hazards.
- Activated Florisil can adsorb moisture exothermically; store in sealed containers.
- Dispose of spent Florisil contaminated with solvent residues according to local hazardous waste regulations.
