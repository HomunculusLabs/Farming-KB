...
- **Drug class**: Ergot alkaloid; ergopeptine (peptide ergot alkaloid)
...
In 1917, Arthur Stoll began investigating ergot alkaloids at Sandoz
...
- **5-HT₁B/₁D serotonin receptors** — basis of antimigraine activity through
  cranial vasoconstriction
- **α-adrenergic receptors** — peripheral vasoconstriction
- **Dopamine receptors** — contributing to nausea
- **Uterine smooth muscle** — stimulating contractions
...
medicinally by midwives for difficult childbirth due to its uterotonic and
vasoconstrictive properties.

## Medical Applications

### Migraine Treatment
Ergotamine was the standard antimigraine drug for decades, constricting dilated
cranial blood vessels. It has been largely superseded by triptan drugs
(sumatriptan and related compounds) targeting the same receptors more
selectively.

### Obstetrics
Valuable for managing postpartum hemorrhage, though now contraindicated in
active labor due to the risk of tetanic uterine contractions.

### Modern Derivatives
Ergotamine opened the field of ergot alkaloid pharmacology, yielding:
- **Ergometrine** — water-soluble ergot alkaloid for obstetrics
- **Bromocriptine** — dopamine agonist for Parkinson's disease
- **Cabergoline** — dopamine agonist for prolactin disorders
- **LSD-25** — semisynthetic hallucinogen from lysergic acid
