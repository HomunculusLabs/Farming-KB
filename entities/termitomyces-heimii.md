...
- **Stipe**: 5–15 cm long, 0.5–2 cm thick, central, cylindrical, white to pale
  brown, with a membranous annulus (ring) that often disappears with age.
- **Flesh**: White, thick, firm, with a pleasant nutty or mild farinaceous odor
  and taste.
- **Spore print**: White to pale pinkish. **Spores**: Broadly ellipsoid, 7–9 ×
...
- **Pseudo-stipe**: The elongated subterranean extension distinguishes
  *Termitomyces* from all other agaric genera. It connects the above-ground
  fruiting body to the fungus comb within the termite nest.

## Distribution and Habitat

Tropical Africa (West, Central, and East Africa from Senegal to Mozambique) and
South and Southeast Asia (India, Sri Lanka, Thailand, Malaysia, Indonesia).
...
mushroom appears suddenly, often overnight, and has a short shelf life of 1–2 days
before deterioration, which limits commercial distribution.

## Termite Symbiosis

The mutualism between *Termitomyces* and fungus-growing termites is one of the
best-studied examples of insect-fungus mutualism:

- **Termite cultivation**: Worker termites collect plant material (grass, wood,
...
- **Nutrient exchange**: *Termitomyces* decomposes lignocellulose in the plant
  ...
  25–30°C, high humidity) and provide fresh substrate.
- **Co-evolution**: Each termite species typically cultivates a single
  *Termitomyces* strain, maintained clonally through vertical transmission
  (termites carry spores when founding new colonies). Genetic analyses show
  congruent phylogenies between termite and fungal lineages.
- **Competitor suppression**: Termites weed out competing fungi (particularly
  *Xylaria* species) from the comb, ensuring monoculture of their cultivated
  *Termitomyces* partner.

## Nutritional and Medicinal Value

*T. heimii* is nutritionally dense: protein content 22–35% dry weight (comparable
to meat), high in essential amino acids (particularly lysine and leucine), and
rich in minerals (potassium, phosphorus, iron, zinc). Preliminary studies indicate:
...
In many African communities, *Termitomyces* mushrooms are among the most valued
wild foods. They are harvested during the early rains in a culturally significant
gathering activity, often involving entire families. In West Africa, they feature
