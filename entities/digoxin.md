...
of the most frequently prescribed oral cardiac medications worldwide.

## Chemical Identity

- **IUPAC name:** (3β,5β,12β)-3-[(O-2,6-Dideoxy-β-D-ribo-hexopyranosyl-
  (1→3)-O-2,6-dideoxy-β-D-ribo-hexopyranosyl-(1→3)-β-D-
  glucopyranosyl)oxy]-12,14-dihydroxycard-20(22)-enolide
...
through solvent extraction (ethanol/chloroform), followed by chromatographic
...
**Indications (current):**
- Rate control in atrial fibrillation (adjunctive to beta-blockers)
- Symptom improvement in HFrEF (NYHA class II–IV) when symptoms persist
  despite ACE inhibitors, beta-blockers, and diuretics

**Dosing and monitoring:**
- Typical maintenance dose: 0.125–0.25 mg/day orally
- Therapeutic serum concentration: 0.8–2.0 ng/mL
- Serum levels > 2.0 ng/mL associated with increased toxicity
...
**The DIG trial (1997):** Landmark study of 6,800 patients showed digoxin reduced
...
xanthopsia — yellow-tinged vision), blurred vision, fatigue

**Cardiac toxicity (most dangerous):**
- Premature ventricular contractions (PVCs), including bigeminy
- AV block (first-degree progressing to third-degree)
- Atrial tachycardia with AV block (PAT with block — pathognomonic)
- Ventricular tachycardia and fibrillation

**Treatment of toxicity:**
- Discontinue digoxin immediately
- Correct hypokalemia (potassium supplementation if K+ < 4.0 mmol/L)
- **Digoxin-specific antibody fragments (Digifab):** for life-threatening
