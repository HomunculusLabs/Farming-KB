...
*Lipomyces* is a genus of ascomycetous yeasts isolated exclusively from soils. The genus is distinguished by its strong lipolytic activity and its ability to accumulate large quantities of intracellular lipids (oleaginous yeasts), making it one of the most promising genera for microbial lipid production and biodiesel research. *Lipomyces* species are among the few yeasts that are truly soil specialists, rarely if ever isolated from other substrates.
...
- Molecular phylogenetics (rDNA analysis) has clarified the placement of Lipomycetaceae within the Saccharomycetales.
...
- The page title is Lipomyces.
- Its recorded source is unknown-biodiversity-of-fungi.md.
- Existing tags on the page are [yeast, ascomycete, soil-isolate, oleaginous, lipid-production].
...
- Existing wikilink already present on this page: [[biodiesel-production]].
...
- Angerbauer, C. et al. (2008). Lipid production by oleaginous yeasts
