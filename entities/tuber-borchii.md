...
Classified within Ascomycota → Pezizomycetes → Pezizales → **Tuberaceae → *Tuber → *T. borchii***. First described by Carlo Vittadini in 1831.

The fruiting body (ascocarp) is a subglobose to irregular tuber, typically 1–5 cm in diameter, though specimens up to 8 cm are occasionally found.

The peridium (outer skin) is smooth to finely verrucose, pale cream to ochre-yellow, sometimes developing reddish-brown tones with age. It is thinner and more delicate than that of *T. melanosporum*.

Gleba (inner flesh) is firm when fresh, whitish to pale brown with numerous fine, whitish veins that turn darker with maturity. The aroma is distinctive — pungent, garlicky, and slightly marine — markedly different from the musky sweetness of *T. magnatum*.

Spores are ellipsoid to fusiform, 18–28 × 12–20 µm, ornamented with an alveolate-reticulate mesh. Asci contain 1–4 (typically 2–3) spores.
...
The main challenge in bianchetto cultivation is competition from other ectomycorrhizal fungi (*Tuber maculatum*, *Scleroderma* spp.) that can colonize host roots and displace the target fungus over time.

## Chemistry and Flavor

The aroma profile of *T. borchii* is dominated by volatile sulfur compounds including dimethyl sulfide, dimethyl disulfide, and 2,4-dithiapentane, which give it a characteristic alliaceous (garlic-like) quality.

Additional contributors include 3-methylbutanal (malty), methional (potato-like), and various C8 alcohols and aldehydes that provide earthy, fungal base notes.

The flavor is less complex than *T. magnatum* but more pungent and persistent. It is best used raw, shaved over warm dishes where the volatile aromatics are released.

Nutritionally, bianchetto truffles are low in calories but contain modest amounts of protein, fiber, and minerals (potassium, phosphorus, magnesium). They are not a significant source of vitamins.
...
- [[tuber-macrosporum]]
 ...
 [[tuber-melanosporum]] · [[tuber-aestivum]] · [[tuber-magnatum]] · [[cantharellus-cibarius-entity]] · [[boletus-edulis-entity]] · [[morchella-esculenta]] · [[pisolithus-arhizus]] · [[scleroderma-citrinum]] · [[laccaria-laccata]] · [[suillus-granulatus]]
