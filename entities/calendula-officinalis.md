...
Calendula officinalis grows 30–60 cm (12–24 inches) tall with a bushy, branching habit. Stems are angular, slightly pubescent, green to dark green. Leaves are oblong-lanceolate, 5–15 cm long, slightly hairy, and arranged alternately with a sticky surface.

### Flower Structure

The flower heads (capitula) are typically 4–7 cm in diameter, with two types of florets:
- **Ray florets**: 15–30 fertile, ligulate florets forming the outer ring. Colors range from pale yellow to deep orange, with many cultivated varieties showing bicolored, double, or crested forms.
- **Disk florets**: Numerous tubular florets forming the central disk, yellow to orange-brown.
The involucre consists of 2–3 rows of pubescent, linear-lanceolate bracts.
...
The medicinal properties of C. officinalis are attributed to bioactive secondary metabolites concentrated primarily in the flower heads:
...
- **Lutein**: Primary carotenoid; antioxidant, eye health
- **β-Carotene**: Provitamin A; antioxidant, immune support
- **Zeaxanthin**: Carotenoid with ocular protective effects
...
- **Diaper dermatitis**: Efficacy comparable to conventional treatments in clinical trials
...
Calendula extracts demonstrate broad-spectrum antimicrobial properties, with strongest activity against Gram-positive organisms (particularly *S. aureus*). Antifungal activity against *C. albicans* and *A. niger* has been documented, along with preliminary antiviral activity against HSV-1 and HIV in vitro.
...
Calendula is a highly valued companion plant in permaculture and organic gardening:
...
- **Dynamic accumulator**: Accumulates potassium, phosphorus, and trace minerals from deep soil layers
