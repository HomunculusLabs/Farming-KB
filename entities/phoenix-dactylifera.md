...
Phoenix dactylifera L. was described by Carl Linnaeus in 1753. The species epithet derives from the Greek "daktulos" meaning finger, referring to the elongated fruit shape.

The date palm is a solitary, pinnate-leaved palm reaching 15–25 meters in height with a slender trunk 30–40 cm in diameter. The trunk is marked by prominent leaf scars in a diamond pattern and is covered with persistent leaf bases in young palms.

Leaves are 3–6 meters long with approximately 150 pinnately arranged leaflets on each side. Leaflets are 15–60 cm long, stiff, and grayish-green with spines at the base of the petiole.

The species is dioecious, with separate male and female trees. Inflorescences are borne among the leaves, enclosed in a spathe that splits open at anthesis to reveal branching flower spikes.

Fruit is a one-seeded berry (drupe) 3–7 cm long and 2–3 cm wide, ranging from bright yellow to deep amber-brown at maturity. The flesh is thick, sweet, and sticky, surrounding a single hard seed.

## Distribution and Habitat

Phoenix dactylifera is native to the region spanning Mesopotamia to the Indus Valley. Wild populations are thought to have originated in what is now southern Iraq, where naturalized stands still occur.

The palm thrives in hot, arid climates with summer temperatures exceeding 40°C and requires less than 300 mm of annual rainfall when irrigated. It tolerates saline soils and alkaline conditions that exclude most other fruit crops.
...
Fruit is harvested at one of four ripening stages: kimri (unripe, green), khalal (full-size, yellow or red), rutab (ripe, soft), and tamr (fully ripe, dried). Each stage has distinct culinary uses and market value.

Major commercial cultivars include Deglet Noor (semi-dry, from Algeria and Tunisia), Medjool (soft, large, from Morocco), and Barhi (sweet, early-ripening, from Iraq). Over 2,000 named cultivars exist globally, adapted to diverse regional preferences and growing conditions.

Post-harvest handling varies by intended market, with fresh soft dates requiring cold chain management at 0–2°C while dried dates can be stored at ambient temperatures for months. Date syrup (dibs), date paste, and date vinegar are common processed products.

## Nutritional Value

Fresh dates provide approximately 282 kcal per 100 g, primarily from carbohydrates (75 g, mostly glucose and fructose). Dried dates are more calorie-dense at 277 kcal per 100 g with reduced moisture content.
...
Date palm cultivation originated in Mesopotamia around 4000 BCE, making it among the earliest domesticated fruit crops. Dates were a critical food source for ancient Sumerian, Babylonian, and Egyptian civilizations.
