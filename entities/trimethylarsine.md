...
Modern mechanistic work has refined the pathway, but the historical model remains a useful reference point.
## Formation by Biomethylation
In biological systems, trimethylarsine can be reached through sequential methylation of inorganic arsenic.
A simplified sequence starts with arsenate or arsenite.
Reduction steps interconvert arsenic oxidation states.
