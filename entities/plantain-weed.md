---
title: Plantain (Lawn Weed Indicator)
source: lowenfels-teaming-with-microbes.md
type: entity
---

# Plantain (Lawn Weed Indicator)
...
- **Common lawn species:**
  ...
  - *P. lanceolata* (narrowleaf/buckhorn plantain)
- **Growth habit:** Perennial, low-growing rosette
- **Indicator status:** Excessive soil nitrates
...
- Not to be confused with the banana-like fruit also called "plantain" (*Musa* spp.)

## Relevance to Cultivation and Mycology

Plantain as a biological indicator demonstrates the soil food web approach to weed management:

- **Weeds as soil diagnostics:** Rather than treating weeds as enemies, they are read as signals of specific soil conditions
- **Nitrate-fungal relationship:** Fungi immobilize nitrates in their biomass and produce ammonium, shifting the nitrogen form away from what nitrate-loving weeds prefer
- **Root cause vs. symptom:** Herbicides kill the plantain but don't address the excess nitrates — new weeds simply return
- **Compost tea formulation:** Using fungal foods (kelp, humic acids, rock dust) in compost tea specifically targets the nitrate reduction that suppresses plantain
- **Holistic lawn care:** The same fungal tea applications that suppress plantain also build soil structure, improve drainage, and support grass health
