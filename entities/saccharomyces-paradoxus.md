...
**Saccharomyces paradoxus** is a wild yeast species and the closest known relative of the domesticated *Saccharomyces cerevisiae*. Unlike its well-studied cousin, *S. paradoxus* exists primarily in natural environments rather than in human-associated fermentation processes. It serves as an important model organism for understanding yeast ecology, population genetics, speciation, and the evolutionary consequences of domestication. The species has been a particular focus of multilocus sequence typing (MLST) and population genomics studies that have illuminated patterns of yeast biogeography and reproductive isolation.
...
The species was originally described by Emil Christian Hansen and refined by various taxonomists over the years. It belongs to the *Saccharomyces sensu stricto* complex, a group of closely related species that can occasionally hybridize but maintain distinct biological and genetic identities. *S. paradoxus* is considered the wild progenitor population from which *S. cerevisiae* was ultimately derived through domestication.
...
- **North American:** Strains from eastern North America and the Pacific Northwest
- **European:** Strains from across Europe, including the United Kingdom, Scandinavia, and continental Europe
- **Far Eastern:** Strains from Japan, China, and other parts of East Asia
