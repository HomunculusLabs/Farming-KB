...
free water on leaf surfaces for infection — they can germinate and colonize
tissue in relatively dry conditions with high humidity.
...
- **Class**: Leotiomycetes
- **Order**: Erysiphales
- **Common genera**: *Podosphaera*, *Erysiphe*, *Sphaerotheca*, *Uncinula*,
  *Blumeria*, *Microsphaera*
...
2. **Antibiotic production**: Beneficial microbes in AACT produce antibiotic
   compounds that inhibit mildew germination and growth.
3. **Physical barrier**: Biofilm formation by compost tea organisms creates a
   physical barrier preventing mildew establishment.
4. **Nutrient competition**: Foliar microbes consume exudates that pathogens
   would use as a food source.
...
- *Ampelomyces quisqualis* — a hyperparasitic fungus that attacks powdery
  mildew mycelium and conidia.
- *Trichoderma* species — compete with and antagonize powdery mildew on
  foliar surfaces.

## Management Notes

- Maintain adequate beneficial fungal populations on leaf surfaces through
  regular AACT applications.
- Ensure proper aeration during [[compost-tea-brewing]] to promote aerobic
  beneficial organisms.
- Monitor leaf surfaces microscopically to confirm adequate fungal coverage.
- Avoid excess nitrogen fertilization, which produces succulent tissue more
