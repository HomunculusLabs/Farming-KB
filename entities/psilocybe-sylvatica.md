...
- **Genus:** *Psilocybe*
- **Species:** *P. sylvatica* (Singer & A.H. Sm.) Singer & A.H. Sm. (1958)

The species has been placed in various sections within *Psilocybe* over time.
Most modern treatments align it with Section *Psilocybe* (the bluing
psilocybin-containing clade).

Some mycologists have suggested *P. sylvatica* may be conspecific with or
closely related to *P. medullosa*, though molecular data remain limited.

### Morphology

**Cap:** 5–20 mm diameter, convex to broadly convex, expanding to plane
with age. Surface hygrophanous — dark chestnut-brown when moist, fading to
pale ochraceous or straw-colored as it dries. Margin translucent-striate
when moist, sometimes with remnants of a partial veil.

**Gills:** Adnate to adnexed, close to subdistant, grayish at first,
darkening to purplish-brown with spore maturity. Edges slightly fringed.

**Stipe:** 30–60 mm long, 1–2 mm thick, equal to slightly enlarged at the
...
- ***P. medullosa***: Very similar morphology; some authorities consider
  ...
  coniferous wood.
- ***P. pelliculosa***: Found in the Pacific Northwest on conifer debris.
  Cap is more prominently translucent-striate and often has a separable
  gelatinous pellicle.
- ***P. strictipes***: Wider distribution across NA and Europe;
  grows on dung-enriched grasslands rather than wood.
