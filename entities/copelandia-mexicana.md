...
the presence of cheilocystidia that are pleurocystidia-like
in morphology (lageniform with swollen apices). C. mexicana
was originally described from specimens collected in Mexico,
and it represents one of the more moderately potent species
within the genus. Like all Copelandia species, it is
coprophilous, growing on herbivore dung in tropical and
subtropical regions. The species is of particular
...
- **Family:** Strophariaceae (some treatments place
  Panaeolus/Copelandia in Panaeolaceae or Bolbitiaceae)
- **Genus:** Copelandia Bres. (sometimes treated as
  Panaeolus subg. Copelandia)
- **Species:** C. mexicana
- **Authority:** Originally described from Mexican
  specimens by Singer or Guzmán
- **Synonyms:** Panaeolus mexicanus (under alternative
  generic placement)
- **Type locality:** Mexico
- **Notes:** The distinction between Copelandia and
  Panaeolus is based on microscopic features, primarily
  the morphology of cheilocystidia. Copelandia species
  have distinctive lageniform cheilocystidia with
  swollen, capitate apices, while Panaeolus sensu
  stricto has different cystidial morphology
## Description
### Cap
- Size: 15–35 mm diameter
- Shape: Hemispherical to convex when young, becoming
  broadly convex to nearly plane with age; often with a
  small umbo
- Surface: Smooth to slightly viscid when moist;
  hygrophanous, fading from dark brown to pale greyish
  or straw-colored as it dries
...
- Context: Thin, whitish, bruising blue or blue-green
  where damaged
### Gills
- Attachment: Adnexed to adnate
- Spacing: Moderately close to close
- Color: Dark grey to black, with a mottled appearance
  due to mixed mature and immature spores
- Edge: Whitish, often with conspicuous cheilocystidia
  visible as a white fringe under magnification
### Stem (Stipe)
- Length: 40–90 mm
- Thickness: 2–4 mm
- Structure: Hollow, equal or slightly thickened at the
  base, fragile
- Surface: Smooth to finely pruinose near the apex,
  pale greyish to whitish
- Color: Whitish to pale grey, staining blue prominently
  where handled or damaged
- Ring: Absent or evanescent; may leave a faint annular
  zone on the upper stem
