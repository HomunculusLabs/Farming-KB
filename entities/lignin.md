...
- **Category**: Plant secondary compound / structural polymer
- **Chemical class**: Cross-linked phenolic polymer derived from monolignols (coniferyl, sinapyl, and p-coumaryl alcohols)
- **Abundance**: Second most abundant natural polymer after cellulose, comprising 17–58% of plant litter depending on species
...
- Cellulose becomes unavailable for microbial use when the cellulose:lignin ratio drops below 0.5, effectively trapping accessible carbon within a lignin matrix.

## Fungal Degradation of Lignin

Only certain fungi—primarily white-rot basidiomycetes—produce the enzyme systems necessary to degrade lignin. The key [[fungal-enzyme-systems]] include:

- **[[lignin-peroxidase]]**: Oxidizes the phenolic and non-phenolic structures of lignin
- **[[manganese-peroxidase]]**: Generates reactive manganese species that attack lignin
...
- Lignin:N ratios can guide composting and substrate preparation, with lower ratios favoring faster colonization
- The transition from sugar fungi to basidiomycetes during substrate decomposition mirrors natural succession and can inform inoculation timing

## Key References

- Sinsabaugh and Liptak (1997) — Fungal enzyme systems for lignin degradation
- Melillo et al. (1982) — C:N and lignin:N ratios as decomposition predictors
- Vanlauwe et al. (1997) — Combined lignin + polyphenol:N ratio regression analysis
- Linkins et al. (1984) — Cellulose:lignin ratio threshold for microbial use
- Swift et al. (1979) — Succession model from sugar fungi to basidiomycetes

## Relationship to Other Plant Compounds

Lignin co-occurs with cellulose (16-63% of plant residues) and hemicellulose in plant cell walls, forming a complex matrix. The proportions vary by plant type:
- Lower plants: 16-35% cellulose, 7-36% lignin
- Herbaceous plants: 20-37% cellulose, 3-30% lignin
- Angiosperm leaves: 6-22% cellulose, 9-42% lignin
- Coniferous needles: 20-31% cellulose, 20-58% lignin
- Wood: 36-63% cellulose, 17-35% lignin

The progressive increase in lignin content during ecosystem succession from herbaceous to forest vegetation drives parallel changes in the dominant fungal decomposer communities.
...
- Below these thresholds, inorganic nutrients are released to soil solution (net mineralization)
- High-lignin resources maintain C:nutrient ratios above these thresholds for longer periods
