...
- **Genus:** Inonotus
- **Species:** I. dryadeus (Pers.) Murrill
- **Synonyms:** Boletus dryadeus Pers., Polyporus dryadeus (Pers.) Fr., Fomes dryadeus (Pers.) Quéél., Pseudoinonotus dryadeus (Pers.) Bondartseva & S. Herrera

Basidiocarps are perennial, sessile or with a short lateral stipe, measuring 10–50 cm broad and 5–15 cm thick.

Upper surface is grey-brown to dark brown, zonate, with a hard, crusty texture. Margin is rounded and cream-colored.

Pore surface is brown, with 3–5 circular to angular pores per mm. Tubes are stratified, each layer 3–8 mm deep.

Context is tough and corky, darkening to reddish-brown with KOH. A distinctive feature is the amber-colored guttation droplets exuded from the pore surface on fresh specimens.

Basidiospores are subglobose to broadly ellipsoid, 6–9 × 5–7 µm, thick-walled, and golden-brown in Melzer's reagent.

Hyphal system is dimitic, with generative hyphae bearing clamp connections and skeletal hyphae. Setal hyphae are present in the hymenium.

## Distribution and Habitat

Widely distributed across temperate Europe and the Mediterranean basin.

Found from the British Isles and France eastward to Hungary and Romania, southward to the Iberian Peninsula, Italy, Greece, and Turkey.
...
## Pathology and Wood Decay

**Inonotus dryadeus** is one of the most significant root-rot pathogens of mature oaks in Europe.

Infection occurs through root contact or wounds near the base of the tree. The fungus colonizes the heartwood, causing a selective white rot that preferentially degrades lignin while leaving cellulose relatively intact.

Decayed wood becomes lighter in color, soft, and stringy, eventually reducing to a fibrous or spongy mass.

Infected trees may show canopy thinning, premature autumn leaf coloration, reduced shoot extension, and eventual branch dieback. Structural failure at the root collar is a significant hazard in parkland and urban settings.

The fungus can persist for decades within the root system of a living host, making eradication impractical once established.

Risk assessment in arboriculture involves visual inspection for basidiocarps, probing for soft wood at the root collar, and resistograph or sonic tomography testing.
