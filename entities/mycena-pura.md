...
Within the genus, *M. pura* is classified in the section Purae, characterized by its distinctly colored caps (ranging from lilac and purple to pink and rose) and the presence of specific types of cheilocystidia. Some authorities have proposed splitting *M. pura* into several distinct species based on color variation and chemical profiles, with some forms containing psilocybin and others not. This taxonomic complexity reflects the broader challenge of species delimitation within the genus Mycena, where many species are morphologically similar and molecular data has revealed extensive cryptic diversity.
...
- [[psilocybin]] — psychoactive compound present in trace amounts
