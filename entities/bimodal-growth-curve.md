---
title: Bimodal Growth Curve of Grasses
...
The bimodal growth curve is a characteristic pattern of cool-humid climate grasslands where above-ground biomass production shows two distinct peaks separated by two deficit periods. Mollison illustrates this pattern (Figure 12.18, derived from pasture yields in southeast Australia) as fundamental to understanding why pastures fail to provide year-round feed and how tree forage and stored fodder can bridge the gaps.

## Classification

- **Category**: Ecological concept — seasonal pasture production dynamics
- **Climate type**: Mesothermal (cool humid) climates
- **Data source**: Pasture yields from southeast Australia
- **Pattern type**: Bimodal (two-peaked) growth distribution

## Key Facts

- Cool-humid grasslands produce two growth peaks per year
...
Understanding the bimodal growth curve is essential for designing year-round forage systems:
...
The bimodal curve drives the permaculture recommendation to always combine herbaceous and woody forage species:

- **Spring peak**: Grasses and clovers produce maximum growth
- **Summer trough**: Tree forage (tagasaste, willow, poplar) produces leaf
- **Autumn secondary peak**: Grasses produce second growth flush
- **Winter trough**: Stored hay, silage, and evergreen browse carry stock

Without understanding this pattern, farmers are caught with "an absence of green feed in summer and winter" that forces either supplementary grain feeding or stock reduction.
...
Statistical methods for identifying bimodality include mixture models and kernel density estimation.
Longitudinal tracking reveals whether bimodal patterns are persistent or transitional.
Comparative analysis across species and environments identifies common growth strategies.
