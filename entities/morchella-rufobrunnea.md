...
- **Family:** Morchellaceae → **Genus:** Morchella → **Species:** M. rufobrunnea
- **Author:** (Clowez) Kuo, Methven & Dewsbury (2012)
- **Synonyms:** Morchella septimelata (Clowez, 2012), Morchella importuna sensu auct.
- **Clade:** Elata clade (black morels); resolved within the Rufobrunnea clade based on multilocus ITS, RPB1, RPB2, and EF1-α sequencing

## Morphology

### Fruiting Body

- **Cap (apothecium):** Conical to broadly conical, 3-12 cm tall and 2-5 cm wide at the base; elongated in mature specimens
- **Pits (alveoli):** Irregularly shaped, vertically elongated, arranged in irregular rows; shallow relative to the ridges
- **Ridges:** Thin, primary ridges run longitudinally with frequent cross-connections; dark brown to nearly black when young
- **Color when young:** Pale tan to grayish-brown overall; at maturity dark brown to reddish-brown with distinctly pinkish bruising on ridges when handled
- **Stipe (stem):** Equal to slightly enlarged at base, 2-5 cm long and 1-2.5 cm thick; whitish to cream-colored, hollow interior
- **Flesh:** Thin, fragile, whitish; waxy texture; odor mildly pleasant and mealy; taste mild and nutty

### Microscopic Features

- **Ascospores:** Ellipsoidal, smooth, hyaline, 20-26 × 13-16 µm
- **Asci:** Operculate, cylindrical, 8-spored, 250-300 µm long
- **Paraphyses:** Filamentous, septate, slightly enlarged at tips
- **Stipe hairs:** Present near base; cylindrical, septate, hyaline to pale brown
...
- **Flavor:** Deep, earthy, nutty, and umami-rich; considered one of the finest wild mushrooms
- **Preparation:** Must be cooked thoroughly; never eaten raw due to trace hydrazine compounds
- **Nutrition:** Protein 25-35% dry weight; rich in potassium, phosphorus, iron, copper, thiamine, riboflavin, and niacin
- **Drying:** Exceptional shelf stability when dehydrated; dried morels reconstitute well and concentrate in flavor
...
- **Strain M1:** Widely cultivated in Sichuan Province; high-yielding with
...
- **Wild-type California:** Original collection from the Bay Area;
  sporadic fruiting in mulched landscapes; not commercially cultivated

## Foraging and Identification

- **Look-alike risk:** Low; the combination of honeycomb-pitted cap with
  pinkish-red bruising on the ridges is diagnostic for *M. rufobrunnea*
- **Key identification features:** Bruise the ridges with a finger — a
  pink to reddish-brown color change within 30 seconds confirms the
  species; other morels do not bruise significantly
- **False morel confusion:** *Gyromitra esculenta* (false morel) has a
  brain-like, wrinkled cap rather than honeycomb pits and lacks the
  hollow chambered interior; *Verpa bohemica* has a wrinkled thimble
  cap attached only at the top of the stipe
- **Collection notes:** Cut at the base with a knife rather than pulling;
  brush off debris but do not wash until ready to use; store in paper
  bags (not plastic) in the refrigerator for up to 7 days
- **Drying method:** Thread on string or use a dehydrator at 40-50°C
  until completely crisp; properly dried morels reconstitute in warm
  water for 20-30 minutes

## Similar Species

| Species | Distinguishing Feature | Bruising |
|---------|----------------------|----------|
| M. rufobrunnea | Pinkish-red bruising, landscaped habitats | Pink to red |
| M. elata | Black ridges, conifer forests | None |
| M. esculenta | Yellowish pits, hardwood forests | None |
| M. importuna | Urban/landscaped, narrower pits | Minimal |
| M. sextelata | Mountainous, post-fire specialist | Variable |
