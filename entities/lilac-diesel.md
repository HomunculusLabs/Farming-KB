...
The exact breeding details are proprietary to Ethos Genetics, but the strain is broadly classified as roughly 70% sativa / 30% indica based on observed growth patterns and effects.

## Appearance

Buds are medium to large, with an elongated and somewhat airy structure typical of sativa-dominant hybrids. The calyxes are dense but not rock-hard, displaying a range of colors from forest green to deep purple and violet.
...
Lilac Diesel has moderate difficulty, suitable for growers with some experience. The sativa-dominant genetics produce taller plants with appreciable stretch during the first three weeks of flowering, requiring adequate vertical space.
