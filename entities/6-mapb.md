...
**SMILES:** CCC(N)C1=CC2=C(C=C1)OC=C2.

**CAS number:** 1526239-89-2 (estimated; authoritative registration varies).

6-MAPB is the 6-position regioisomer of 5-APB, differing in the placement of
the aminopropyl side chain on the benzofuran ring. Both compounds are
...
encountered as a hydrochloride salt (white crystalline powder).

## Pharmacology

6-MAPB acts as a triple monoamine releaser and reuptake inhibitor, with the
strongest effects on the serotonin system.

Its primary mechanism involves binding to and reversing the direction of the
serotonin transporter (SERT), causing massive serotonin release into the
synaptic cleft. It also inhibits serotonin reuptake, amplifying and prolonging
the effect.

Moderate activity at the dopamine transporter (DAT) and norepinephrine
transporter (NET) contributes to stimulant and prosocial effects. The ratio of
...
Onset occurs within 30–60 minutes after oral administration. Peak effects are
reached at 1.5–2.5 hours, with total duration of 4–6 hours. The after-effects
and comedown period may extend an additional 2–4 hours.

The subjective effect profile includes pronounced euphoria, increased empathy
and emotional openness, enhanced tactile sensation, and mild visual
distortions. Users frequently describe the experience as comparable to MDMA,
with some reporting slightly less "magic" and more stimulant character.

Common side effects include tachycardia, hypertension, hyperthermia, jaw
clenching, nystagmus, pupil dilation, and appetite suppression. Nausea is
more commonly reported during onset compared to MDMA.

Post-acute effects include fatigue, low mood, anxiety, and reduced cognitive
function lasting 1–7 days after use. Serotonin depletion is the presumed
mechanism, similar to the MDMA comedown syndrome.

## Dosage

Oral dosage ranges (hydrochloride salt, based on user self-reports):
...
Anlage II), and most EU member states following the EMCDDA risk assessment in
2014. China controls it under its NPS scheduling framework.

## Harm Reduction

Harm reduction practices specific to 6-MAPB include: reagent testing to verify
identity and detect adulterants (Marquis reagent produces a yellow-to-brown
color shift); avoiding redosing; maintaining hydration without overhydration
