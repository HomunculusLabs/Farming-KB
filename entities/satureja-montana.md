...
*S. montana* is drought-tolerant and frost-hardy, surviving temperatures to approximately −15°C once established.

## Cultivation

Winter savory is easily propagated from seed, softwood cuttings, or division of established clumps in spring.
...
The essential oil of *Satureja montana* is dominated by phenolic monoterpenes, which account for its antimicrobial potency.

**Principal constituents of the essential oil:**

- **Carvacrol:** 30–55%, the dominant phenolic compound.
- **Thymol:** 10–30%, contributes to antiseptic properties.
- **p-Cymene:** 5–15%, a precursor in the biosynthetic pathway to carvacrol.
- **γ-Terpinene:** 3–8%, minor monoterpene hydrocarbon.
- **Linalool, Borneol:** Trace to 3%, contributing to aroma complexity.

Chemical composition varies significantly with geography, harvest stage, and extraction method.
