...
Cannabimovone (CBM) is a rare phytocannabinoid first isolated from Cannabis sativa by Krejčí and colleagues in 1975. It is classified as a cannabinoid-1,8-ene derivative with a rearranged carbon skeleton that distinguishes it from the more common classical cannabinoid framework.

The compound was originally isolated from Czechoslovakian fiber hemp varieties and has since been detected in trace amounts in various chemotype populations. Its name derives from the Latin *cannabi-* (cannabis) and *-movone* reflecting its unique structural rearrangement relative to cannabinol (CBN).

Cannabimovone remains one of the least-studied phytocannabinoids. Its pharmacological profile is largely uncharacterized due to limited availability from natural sources and the absence of commercial synthetic routes.

## Chemical Properties

Molecular formula: C₂₁H₂₈O₃. Molecular weight: 328.45 g/mol.

The structure features a characteristic rearranged cannabinoid skeleton with a 1,8-diene system and a ketone functionality at the C-9 position. Unlike classical cannabinoids (THC, CBD, CBN), cannabimovone lacks the typical pyran or monoterpenoid ring closure.

The compound exists as a crystalline solid under standard conditions. It is lipophilic and soluble in organic solvents including ethanol, methanol, chloroform, and hexane, but insoluble in water.

The UV-Vis absorption spectrum shows maxima consistent with the conjugated diene system, useful for HPLC-UV detection. It can be differentiated from CBN and other oxidized cannabinoids by retention time in reverse-phase chromatography.

## Biosynthetic Origin

Cannabimovone is believed to arise through oxidative rearrangement of cannabinolic acid (CBNA) or similar CBN-precursor molecules during plant senescence or post-harvest curing.
...
Detection and quantification of cannabimovone requires specialized analytical techniques due to its extremely low concentration in plant material.

HPLC-UV detection is possible but has limited sensitivity at natural concentrations. LC-MS/MS with multiple reaction monitoring (MRM) provides the most reliable identification and quantification.

The compound has been detected using GC-MS after derivatization, though the high temperatures of GC injection may cause thermal decomposition of the rearranged skeleton. LC-based methods are preferred for accurate identification.

Analytical reference standards are not commercially available as of 2026, limiting routine testing. Most published detections have used semi-preparative HPLC isolation followed by NMR confirmation.

## Occurrence and Cultivar Distribution

Cannabimovone has been primarily detected in fiber hemp (low-THC Cannabis sativa) populations from Eastern Europe, particularly Czechoslovakian and Hungarian landrace varieties.
