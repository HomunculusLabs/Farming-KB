...
- **Parent 1**: Girl Scout Cookies (Durban Poison × OG Kush)
- **Parent 2**: Pink Panties (selected phenotype, lineage not publicly
  disclosed; suspected Cherry Pie or similar purple-leaning line)

The genetic ratio is approximately **85% indica / 15% sativa**, though
phenotypic variation is common. Some cuttings express more sativa-leaning
growth patterns, particularly the so-called "Sherbet" phenotypes vs. the
"Sherbert" phenotypes.
...
- **Myrcene**: earthy, sedative, enhances the indica-dominant body
  relaxation.
- **Linalool** (secondary): floral, anxiolytic, complements the
  calming effects.
