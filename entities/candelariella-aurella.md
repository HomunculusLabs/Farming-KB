...
**Candelariella aurella** (Hoffm.) Zahlbr., commonly known as the **yellow shield lichen**, is a small crustose lichen in the family Candelariellaceae.

It forms bright yellow, areolate to subsquamulose crusts on calcareous and nutrient-enriched substrates.

The species is one of the most commonly encountered urban lichens, frequently found on concrete, mortar, and limestone surfaces.

It is widely distributed across Europe and North America and serves as an indicator of moderately enriched conditions.

## Taxonomy and Morphology

*Candelariella aurella* was first described by Johann Hedwig and later recombined by Alexander Zahlbruckner.

The genus *Candelariella* was historically placed within Lecanoraceae but was elevated to its own family, Candelariellaceae, based on molecular phylogenetic studies.

The thallus is crustose, forming bright yellow to greenish-yellow patches up to several centimeters in diameter.

The surface is areolate to squamulose, with individual areoles or squamules typically 0.2–0.8 mm across.

Squamules may overlap slightly and are loosely attached to the substrate.

The upper surface is smooth to slightly roughened and lacks a distinct cortex in many populations.

Apothecia are common, lecanorine, and measure 0.3–0.8 mm in diameter.

The apothecial disc is yellow to orange-yellow with a prominent thalline margin matching the thallus color.

Spores are simple, ellipsoid to bacillar, colorless, and measure 8–14 × 3–5 μm.

Asci are 8-spored and of the *Candelariella*-type with a thin amyloid ring structure.

Pycnidia produce bacillar conidia approximately 3–5 × 1 μm in size.

The photobiont is a trebouxia-like green alga, providing photosynthate to the mycobiont.
...
Optimal conditions include well-lit, dry to moderately moist surfaces with neutral to alkaline pH.
...
It is sensitive to strong acidification but can survive in areas with moderate sulfur dioxide levels.

The lichen supports a small community of associated microorganisms including bacteria and yeasts within its thallus.
