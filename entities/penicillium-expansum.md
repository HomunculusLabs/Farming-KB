...
**Also known as:** Blue mold of apples
...
### Morphology
- Colonies grow rapidly, producing characteristic blue-green
  sporulation zones
- Conidiophores are smooth-walled, typically 200 to 400
  micrometers long, with terverticillate or quaterverticillate
  branching patterns
- Phialides are ampulliform to cylindrical, borne on metulae
- Conidia are smooth, ellipsoidal, approximately 3.0 to 4.0 by
  2.5 to 3.0 micrometers
- Colony texture is velvety to floccose, with occasional
  exudate droplets
- Growth is inhibited by propionic acid and other common
  food preservatives

### Ecology and Habitat
- Primarily a post-harvest pathogen of pome fruits (apples,
  pears, quince)
- Also infects stone fruits, citrus, berries, and some
  vegetables
...
- Primary producer of patulin, a polyketide mycotoxin with
  genotoxic and immunotoxic properties
- Patulin contamination of apple juice and cider is regulated
  internationally (maximum 50 micrograms per liter in many
  jurisdictions)
- Also produces citrinin, chaetoglobosins, and other secondary
  metabolites
- Patulin biosynthesis involves a polyketide synthase (PKS)
  pathway encoded by a 15-gene cluster
- Processing (fermentation, clarification) reduces but does
  not eliminate patulin in apple products

### Mycoparasitic Interactions
- P. expansum induces vacuolation in hyphae of Aspergillus
  niger when grown in dual culture (Park and Robinson 1964;
  Robinson and Park 1965)
