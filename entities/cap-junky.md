...
The aroma is immediately recognizable and extremely persistent — a single open
jar can fill a room. The flavor largely mirrors the aroma, delivering a sharp,
diesel-dominant inhale with a smoother cookie-dough exhale.

## Terpene and Cannabinoid Profile

### Dominant Terpenes

- **Limonene** (~1.2–1.8%) — contributes citrus brightness and mood elevation
- **Caryophyllene** (~0.9–1.4%) — peppery, spicy; CB2 receptor agonist
- **Myrcene** (~0.7–1.1%) — earthy, sedative base; enhances THC permeability
- **Minor terpenes:** Humulene, linalool, bisabolol, and trace pinene
...
opportunities for cap junky. [[jeavons-climate-adaptation-growing-seasons]]
