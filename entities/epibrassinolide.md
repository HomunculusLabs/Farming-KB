...
updated: 2026-04-28
sources:
  - /Users/t3rpz/wiki/raw/papers/gartz-growth-promoting-effect-of-brassinosteroid-psilocybe-cubensis.md
---
...
Epibrassinolide (C28H48O6) features a characteristic 5α-ergostane skeleton
with hydroxyl groups at positions C-2, C-3, C-22, and C-23, along with a
lactone moiety at C-24. Its molecular weight is 480.7 g/mol. The compound
is soluble in organic solvents including methanol, ethanol, and acetone, but
poorly soluble in water.

It is the [(22R,23R,24S)-2α,3α,22,23-tetrahydroxy-24-methyl-B-homo-7-oxa-5α-
cholestan-6-one] stereoisomer. The lactone B-ring (7-oxa-6-one system) is
essential for high biological activity and distinguishes the most potent
brassinosteroids from their biosynthetic precursors such as castasterone.

The compound is relatively stable under neutral and acidic conditions but can
be hydrolyzed under strongly basic conditions, which opens the lactone ring
to form the corresponding seco-acid. It is light-sensitive and should be
stored in amber vials at low temperatures. Commercial preparations use
ethanol or methanol as the solvent carrier, formulated for dilution to
working concentrations of 0.01–1.0 mg/L.
...
normal plant growth and reproduction. As the most active brassinosteroid,
...
brassinosteroid biosynthesis exhibit severe dwarfism, dark green curled
leaves, reduced fertility, and delayed senescence, confirming
brassinosteroids as essential hormones.
...
**Dose-response relationship**: Optimal stimulation occurred at intermediate
concentrations, with higher concentrations showing diminishing returns or
slight inhibition. This biphasic response is characteristic of hormone-like
...
quality), fruits (better size uniformity and sugar content), ornamental
plants (enhanced flowering, longer vase life), and stress protection.

## Pharmacology and Safety

Pharmacokinetic studies show rapid uptake and distribution through both
foliar and root application, with detectable effects within hours. The
compound is metabolized through hydroxylation, glucose conjugation, and
degradation. Half-life ranges from hours to days. Toxicity
is very low: the acute oral LD50 in rats exceeds 2000 mg/kg, classifying it
as practically non-toxic to mammals, aquatic organisms, and beneficial
insects.

## Synthesis

Total synthesis has been achieved through multi-step approaches from
commercial sterol starting materials. Challenges include installing correct
stereochemistry at four chiral centers and constructing the sensitive lactone
ring. Commercial production relies on extraction from plant sources
(especially bee-collected pollen) supplemented by semi-synthetic modification
of more abundant brassinosteroid precursors.
