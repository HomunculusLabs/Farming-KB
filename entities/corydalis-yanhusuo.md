...
sources:
  ...
  - https://pubmed.ncbi.nlm.nih.gov/?term=corydalis+yanhusuo+tetrahydropalmatine
  - https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5568814/
...
### Distribution
- **Native:** Northern China (Zhejiang, Jiangsu, Anhui, Hubei provinces)
- **Cultivation:** Widely cultivated in eastern China, particularly Zhejiang Province (traditional production center)
- **Habitat:** Forest margins, grassy slopes, valleys, cultivated fields; 200–1500 m elevation
- **Climate:** Temperate, cold winters, moderate rainfall
...
- **Channel affinity:** Liver, Gallbladder, Spleen, Heart
- **Primary functions:**
  - Invigorate blood and move Qi
  - Alleviate pain (all types)
  - Regulate menstruation
  - Promote digestion and relieve epigastric pain

### TCM Indications
- Chest and hypochondriac pain (rib-side pain)
- Abdominal pain (including dysmenorrhea)
- Traumatic injury pain
- Headache and migraine
- Arthralgia (joint pain)
- Epigastric pain and ulcers
- Post-operative pain

### Traditional Combinations
- **Yan Hu Suo + Bai Shao (white peony root):** For menstrual cramps
- **Yan Hu Suo + Chuan Xiong (Szechuan lovage root):** For headache
- **Yan Hu Suo + Dan Shen (salvia root):** For chest pain (angina-like)
- **Yan Hu Suo + Mu Xiang (costus root):** For abdominal pain
- **Yan Hu Suo + Ru Xiang (frankincense) + Mo Yao (myrrh):** For traumatic injury

## Chemical Composition

The tuber contains over 30 isoquinoline alkaloids, classified into several structural types:

### Protopine Alkaloids
- **dl-Tetrahydropalmatine (dl-THP)**: 0.05–0.12% — the primary bioactive compound
- **l-Tetrahydropalmatine** (l-THP): The levorotatory isomer, more pharmacologically active
- **d-Tetrahydropalmatine** (d-THP): The dextrorotatory isomer
- **Corydaline**: ~0.02% — analgesic, anti-ulcer
