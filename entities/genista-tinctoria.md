...
The plant thrives in full sun and is tolerant of poor, nutrient-deficient soils. Its nitrogen-fixing root nodules, formed in symbiosis with rhizobia bacteria, allow it to colonize nutrient-poor substrates that other species find challenging.

It occurs at elevations from sea level to approximately 1,500 meters in its southern European range. In northern regions, it is restricted to lowland sites with adequate summer warmth.
...
Dyer's greenweed has limited value as forage. The green stems and leaves contain quinolizidine alkaloids, primarily cytisine, which make the plant unpalatable and potentially toxic to livestock in large quantities.

However, in mixed pastures where animals can selectively graze, it is generally avoided and does not cause significant poisoning. The nitrogen-fixing capability contributes to soil fertility in marginal grasslands.
