...
**Classification:** Fungi → Ascomycota → Pezizomycotina → Xylariomycetidae → Xylariales → **Xylariaceae → *Poronia → *P. punctata***
...
Pestalotin and related isocoumarin derivatives have also been detected. These compounds exhibit phytotoxic activity and may play a role in competitive interactions with other dung fungi.

Recent metabolomic studies have identified additional minor metabolites including poronimide and punctatin, though their biological activities remain largely uncharacterized. The unique chemical profile of *P. punctata* supports its phylogenetic distinctiveness within Xylariaceae.

## Conservation Status

*P. punctata* is classified as **Near Threatened** on the IUCN European Red List of Fungi. National red-list assessments include: Endangered (UK, Netherlands, Germany), Vulnerable (Switzerland, Denmark), and Rare (France, Poland).

The primary drivers of decline are habitat loss (conversion of pasture to arable land), removal of large herbivores from grazing systems, and veterinary drug contamination of dung. Conservation efforts focus on maintaining extensive grazing regimes and reducing antihelminthic use in areas with known populations.

The species is used as an indicator of high-quality grassland fungi assemblages. Its presence signals a diverse and intact coprophilous fungal community, including rare species of Peziza and other ascomycetes.
