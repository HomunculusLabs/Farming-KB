...
prevents mycelial cells from rupturing due to ice crystal formation during the freezing
process. Without this protectant, freezing damages and kills [[mycelium]] by allowing sharp
ice crystals to puncture cell membranes.

The technique allows cultivators to maintain backup culture libraries almost indefinitely,
preserving the genetic integrity of valuable strains at their lowest possible generation
number. Because freezing halts all cell division, it prevents the genetic drift and strain
senescence that inevitably occur when cultures are maintained on agar or grain through
continuous subculturing.

This storage method is considered the gold standard for professional culture collections
...
glycerol. The glycerol must be sterilized separately before use.

Critical safety note: [[liquid-culture]] must be pre-chilled in the refrigerator or on ice
before glycerol addition. Adding glycerol to warm or room-temperature culture can damage
or kill the mycelium of sensitive species.

Method 1 uses colonized agar cubes or grain submerged in a 5 percent glycerol solution in
test tubes. The caps are kept loose during initial freezing to allow for ice expansion,
then tightened and sealed with Parafilm once frozen solid. Tubes are placed in plastic
ziplock bags for long-term freezer storage.

Method 2, preferred by professional laboratories, involves making a slurry from colonized
agar and sterilized water, transferring it to a weak nutrient broth, and agitating on a
magnetic stirrer for 1 to 3 days to allow mycelial recovery from blender damage. The
...
Repeat the viability test after two months and every consecutive month thereafter to gauge
...
valuable wild isolates and production strains without genetic degradation. Combined with
disciplined generation tracking, cryopreservation ensures the lowest-generation, most
vigorous form of each culture is always available.

The technique is particularly important for rare wild isolates and for maintaining backup
cultures at multiple physical locations to protect against loss from equipment failure,
