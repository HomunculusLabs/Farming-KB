...
B. graminis has been studied using serial analysis of gene expression
(SAGE), providing quantitative expression data for thousands of genes,
identification of genes specifically upregulated during infection, and
comparative data with other pathogenic fungi revealing both conserved
and species-specific infection programs.
