...
**Arthrospira platensis**, commonly known as **Spirulina**, is a filamentous
cyanobacterium (blue-green microalga) consumed as a food for centuries. It
thrives in alkaline, warm-water lakes and is now cultivated worldwide as a
nutritional supplement and whole food. Spirulina is one of the most
nutrient-dense organisms on Earth, containing 60-70% protein by dry weight,
along with essential amino acids, vitamins, minerals, and the pigment
phycocyanin.

Historical use dates back to the Aztecs, who harvested it from Lake Texcoco
as *tecuitlatl*. The Kanembu people of Chad have also traditionally harvested
Arthrospira from Lake Kossorom, drying it into cakes called *dihe*. Modern
commercial cultivation began in the 1970s.
...
latter being the dominant photosynthetic pigment.

## Chemical Composition

### Macronutrients

- **Protein**: 55-70% of dry weight, containing all essential amino acids
- **Carbohydrates**: 15-25%, primarily glycogen and rhamnose
- **Lipids**: 5-8%, including gamma-linolenic acid (GLA, omega-6)

### Micronutrients

- **Vitamins**: B1, B2, B3, B6, B9 (folate), E, K. Note: B12 present as
  pseudo-B12, not bioavailable to humans.
- **Minerals**: Iron, calcium, magnesium, zinc, manganese, chromium,
