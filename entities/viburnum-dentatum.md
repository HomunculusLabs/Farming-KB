...
**Classification:** Kingdom Plantae → Order Dipsacales → Family Adoxaceae → Genus *Viburnum* → Species *V. dentatum* L.

**Authority:** Carl Linnaeus, *Species Plantarum* (1753).

**Growth form:** Deciduous, multi-stemmed, rounded shrub typically 1.5–3 m tall and wide. In optimal conditions it can reach 4.5 m. Density and form vary with light exposure.

**Bark:** Grayish-brown, relatively smooth on young stems, becoming rough and fissured with age. Young twigs are greenish-brown and notably straight.

**Leaves:** Opposite, simple, broadly ovate to elliptic, 3–10 cm long and 2–6 cm wide. Margins are coarsely toothed (dentate), giving the species its epithet. Dark glossy green above, lighter below.
...
Arrowwood viburnum is widespread in eastern North America from southern New Brunswick and Maine through the Appalachian Mountains to northern Florida. It extends west to eastern Iowa, eastern Kansas, and central Texas.

The species is absent from the Gulf Coastal Plain and most of the lower Mississippi Valley. Several closely related taxa were historically segregated as varieties but are now often treated as part of a variable species complex.
...
Arrowwood is among the most important wildlife food shrubs in eastern deciduous forests. The fruits are consumed by numerous bird species including cedar waxwings, northern flickers, gray catbirds, American robins, eastern bluebirds, and ruffed grouse.
...
Arrowwood contributes to riparian buffer stability with its fibrous root system and tolerance of periodically saturated soils.

The fruits are relatively low in lipids but high in carbohydrates, making them an important energy source for migratory birds during fall stopovers.

## Cultivation

Arrowwood viburnum is one of the most adaptable and low-maintenance native shrubs available for landscaping. It is hardy to USDA Zone 2 and thrives in full sun to partial shade.

Propagation is primarily from seed, which requires 3–5 months of warm stratification followed by 3 months of cold stratification for optimal germination. Softwood cuttings under intermittent mist root readily.

The species transplants easily and establishes quickly. It responds well to renewal pruning and can be maintained as a formal hedge or left in its natural rounded form.

Space requirements in the landscape are approximately 1.8–3 m between plants for hedgerows and 2.5–4 m for specimen plantings.

Several named cultivars are widely available including 'Chicago Lustre' (glossy foliage, upright), 'Blue Muffin' (compact, prolific fruiting), 'Christom' (Autumn Jazz, red fall color), and 'Ralph Senior' (Synnestvedt, heavy fruit set).
