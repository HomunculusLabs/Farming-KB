...
**Tetrahydroharmine** (THH) is a β-carboline alkaloid and the primary reduced form of harmine, found in significant concentrations in **Banisteriopsis caapi** and other Malpighiaceae used in traditional Amazonian psychoactive brews. Its IUPAC name is 1-methyl-2,3,4,9-tetrahydro-1H-pyrido[3,4-b]indole.
...
Unlike harmine and harmaline, which are reversible inhibitors of **monoamine oxidase A (MAO-A)**, tetrahydroharmine is a relatively weak MAO inhibitor. Its pharmacological significance lies instead in **serotonin reuptake inhibition** and possible direct agonist activity at serotonin receptors.
...
- **Weak MAO-A inhibition**: Unlike harmine (IC₅₀ ~0.05 µM for MAO-A) and harmaline (IC₅₀ ~0.08 µM), THH shows only minimal MAO-A inhibitory activity. It is not considered a significant contributor to the MAO inhibition that enables oral DMT activity in ayahuasca.
...
Chemical synthesis of tetrahydroharmine typically proceeds via the **Pictet-Spengler reaction** of tryptamine with acetaldehyde, yielding tetrahydro-β-carboline (norharman), followed by N-methylation using methyl iodide or formaldehyde-formic acid reductive methylation (Eschweiler-Clarke conditions).
...
In the biosynthetic pathway within *Banisteriopsis caapi*, THH is formed by enzymatic reduction of harmine. The enzyme responsible has not been fully characterized but is believed to be a member of the short-chain dehydrogenase/reductase (SDR) family. The pathway proceeds: tryptophan → tryptamine → harmine → tetrahydroharmine.
...
In practice, THH is primarily encountered as a component of ayahuasca preparations rather than as an isolated substance. Its commercial availability as a research chemical is limited compared to harmine and harmaline. Regulatory attention has focused almost exclusively on DMT rather than the β-carboline alkaloids in the ayahuasca context.

## Pharmacokinetics

The pharmacokinetic profile of tetrahydroharmine has been studied primarily in the context of ayahuasca administration, where THH is consumed alongside harmine, harmaline, and DMT. Isolated pharmacokinetic data for THH alone are limited.
...
Metabolism occurs primarily through hepatic **CYP2D6**-mediated oxidation and subsequent glucuronidation. Individuals with genetic CYP2D6 polymorphisms (poor vs. extensive metabolizers) may experience different THH exposure levels, contributing to inter-individual variability in ayahuasca responses.

The elimination half-life of THH is estimated at approximately **7–10 hours** based on pharmacokinetic modeling of ayahuasca alkaloid profiles. This is somewhat longer than harmine (~4 hours) and harmaline (~6 hours), suggesting that THH may contribute to the extended subjective effects observed after ayahuasca consumption.

## Related Compounds

Tetrahydroharmine belongs to the β-carboline alkaloid family, which includes both fully aromatic and partially reduced members:
...
The structural reduction of the pyridine ring is the key distinction between THH and harmine. This single chemical modification converts a potent MAO-A inhibitor (harmine) into a compound with minimal MAO inhibition but significant serotonin reuptake inhibition (THH), illustrating the pharmacological sensitivity of the β-carboline scaffold to subtle structural changes.
