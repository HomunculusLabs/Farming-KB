...
| Compound | % (dried root) | Activity |
|----------|---------------|----------|
| Berberine | 2.5–6.0% | Antimicrobial, antidiabetic |
| Hydrastine | 1.5–4.0% | Vasoconstrictor, uterine stimulant |
| Canadine | 0.5–1.0% | Smooth muscle relaxant |

### Minor Constituents

- Trace alkaloids: berberastine, hydrastinine, canaline
- Phenolic acids (chlorogenic, caffeic) and flavonoids (luteolin, quercetin)

## Pharmacology and Medicinal Uses

### Berberine (Primary Active)

- **Antimicrobial:** Active against *S. aureus*, *E. coli*, *C. albicans*, *G. lamblia*; disrupts cell membranes
