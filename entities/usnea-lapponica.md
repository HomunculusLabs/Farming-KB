...
The species is named after the Sámi homeland of Lapland, reflecting its abundance in northern Fennoscandian birch and conifer forests.

It is distinguished from other Usnea species by its combination of inflated branches, blackened holdfast, and specific chemistry including thamnolic acid.

## Taxonomy and Morphology

Usnea lapponica Vainio belongs to the Parmeliaceae within the order Lecanorales.

The thallus is fruticose, erect to pendulous, 5–15 cm long, attached by a distinct blackened holdfast at the base.

Branches are cylindrical, 0.8–1.5 mm in diameter, with a characteristic series of swollen or inflated segments along their length.

The inflations are irregularly spaced and give the branches a beaded or moniliform appearance that is diagnostic for the species.

Surface colour is grey-green to pale green when dry, becoming brighter green when moistened.

The cortex is thin and smooth, and the medulla is dense with a well-developed central axis.

Soralia are common, arising as erumpent pustules that develop into irregular sorediate patches on branch surfaces, particularly near inflations.

Apothecia are rare, lateral, small, with a reddish-brown disc.

The chemistry is distinctive: the medulla contains thamnolic acid as the primary substance, often accompanied by usnic acid in the cortex.

Spot tests show K+ yellow turning deep red (thamnolic acid reaction) on the medulla, C−, and P+ red.
...
Usnea lapponica has a circumpolar distribution across the subarctic and boreal zones of the Northern Hemisphere.

It is particularly abundant in Fennoscandia, where it dominates the epiphytic lichen flora of northern birch forests and montane conifer woodlands.
...
Vegetative reproduction via soredia is the primary dispersal mechanism, as apothecia are produced only infrequently in most populations.
