---
title: Jergón sacha (Dracontium loretense)
...
- **Scientific name**: *Dracontium loretense* (syn. *D. longipes*)
...
- The plant's mottled leaf pattern resembles the skin of the jergón snake (*Bothrops atrox*, the fer-de-lance), giving it its name.
- It is one of the most important anti-snakebite remedies in Amazonian traditional medicine.
- In Vision 27, a jergón snake is depicted coiled in the jergón sacha plant, illustrating the signature relationship.
- The plant is used both internally (as a decoction or tincture) and externally (as a poultice) for snakebite treatment.
- Beyond snakebite, jergón sacha is used for wounds, infections, and as a general anti-inflammatory.
- The plant is also employed in ayahuasca contexts as a protective agent.
- Its use follows the broader Amazonian principle that plants growing near dangerous animals often carry the antidote to that animal's venom.
