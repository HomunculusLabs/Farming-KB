...
### Active Compounds
- **EA6 and EA6-PII:** Beta-glucan-protein complexes from fruiting
  body with antitumour activity
- **Proflamin:** Basic simple protein with marked tumour cell
  inhibitory activity; purified to crystalline state; clinical
  trials in progress (Zhang et al., 1999)
- **Beta-glycoprotein-Proflamin:** Antitumour glycoprotein from
  cultured mycelium
- **Beta-glucans:** Immunomodulatory polysaccharides

### Pharmacological Properties
- Inhibits growth of cancers in multiple xenograph models
- Antitumour via direct cytotoxic effect (Proflamin)
- Immunomodulation via beta-glucan-protein complexes
- Used in traditional Chinese medicine for liver diseases and
  gastric ulcers
- Useful in combination therapy with other chemotherapy agents
