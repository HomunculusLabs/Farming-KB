...
Elevational range extends from sea level to approximately 1500 meters in tropical mountains. It is most abundant in the understory of mature forest stands where light levels are moderate and humidity remains consistently high.

## Ecology and Symbiosis

The tripartite association between the fungal partner, a green algal photobiont, and *Nostoc* cyanobacteria makes *S. limbata* ecologically significant. Nitrogen fixed by the cyanobacterial cephalodia becomes available to the surrounding ecosystem through leaching and decomposition.
...
*Sticta limbata* produces a range of secondary metabolites including stictic acid, constictic acid, and related triterpenoids. These compounds serve anti-herbivore and antimicrobial functions and contribute to the lichen's durability in humid environments.

The cyanobacterial cephalodia contain unique nitrogenous compounds not found in the green-algal portions of the thallus. This chemical differentiation reflects the distinct metabolic roles of the two photobiont partners.

Chloroatranorin and atranorin are present in the cortex, providing UV screening. The combined chemistry profile is useful for species identification, as different *Sticta* species produce distinct depsidone patterns.

## Traditional and Medicinal Uses

*Sticta limbata* has a history of use in traditional medicine across its range. In Mapuche communities of southern Chile, *Sticta* species (known locally as "palo de quina") have been used as respiratory remedies for treating coughs, bronchitis, and asthma.

In New Zealand, *Sticta* species were among the lichens used in Māori traditional medicine for wound healing and respiratory complaints. The lichen was prepared as infusions or poultices, leveraging its antimicrobial secondary metabolites.

European herbal traditions attributed expectorant and demulcent properties to lungwort lichens including *Sticta*. Though these uses predate modern pharmacological understanding, research has confirmed antimicrobial and anti-inflammatory activities in several *Sticta* metabolites.
