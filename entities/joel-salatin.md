...
- **The Omnivore's Dilemma** (Michael Pollan, 2006): Polyface Farms
  ...
  industrial food. This single exposure was transformative for
  Salatin's visibility.
- **Food, Inc.** (2008): Featured in the documentary as a voice of
  alternative agriculture, drawing millions of viewers.
- **Fresh** (2009): Central figure in this documentary about
  sustainable farming.
- **American Meat** (2013): Profiled as a model for the future of
  livestock farming.
- Numerous TEDx talks and conference keynotes have reached millions
  online.

## Criticism and Controversies

Salatin's model and advocacy have drawn criticism from several
perspectives:

- **Scalability**: Critics argue that his labor-intensive, direct-
  marketing model cannot feed global populations at current demand
  levels. Salatin counters that the question should be whether
  industrial agriculture is sustainable, not whether alternatives
  scale to billions.
- **Regulatory stance**: His libertarian opposition to food safety
  regulations has been criticized as potentially dangerous. He argues
  that local accountability is more effective than centralized
  inspection.
- **Climate change**: Some critics note his skepticism of certain
  climate science, though his farming practices sequester significant
  carbon.
- **Animal welfare**: While praised by many animal welfare advocates,
  some argue that any animal slaughter is ethically problematic,
  regardless of conditions.

## Relevance to the Wiki

Joel Salatin is one of the most influential figures in modern
regenerative agriculture. His practical demonstrations at Polyface
Farms provide empirical evidence that closed-loop, pasture-based systems
can be both ecologically regenerative and economically viable. His
writing has been instrumental in bridging the gap between permaculture
theory and commercial-scale farming practice. The Polyface model has
been adapted by thousands of farmers worldwide, making Salatin a key
reference for anyone studying sustainable food systems, rotational
grazing, or regenerative agriculture.
