...
Usnea subfloridana Stirton belongs to the Parmeliaceae within the order Lecanorales.

The thallus is fruticose, erect to pendulous, 5–20 cm long, attached to the substrate by a holdfast at the base.

Branching is repeatedly dichotomous, with the main axis remaining clearly distinguishable throughout.

Branches are cylindrical, 0.5–1.5 mm in diameter, with a smooth to slightly wrinkled surface.

A dense covering of white to greyish fibrils gives the branches a fuzzy appearance, especially near branch tips.

The internal anatomy shows a well-developed central axis (medullary strand) that is elastic and persists when the cortex is torn — a diagnostic character of the genus Usnea.

The cortex is thin and the medulla is lax to compact depending on the branch position.

Soralia are common, arising as erumpent pustules that develop into irregular sorediate patches on branch surfaces.

Apothecia are infrequent, lateral, 2–5 mm diameter, with a concave to convex reddish-brown disc.

Chemically, the species contains usnic acid in the cortex and fumarprotocetraric acid in the medulla.

Some European populations additionally contain small amounts of protocetraric acid and stictic acid as accessory metabolites.

The species name "subfloridana" indicates its similarity to the closely related U. floridana, from which it differs in branch diameter and soralia morphology.

U. subfloridana is part of the U. barbata species complex, a group of morphologically similar taxa that are best distinguished by chemical and anatomical characters.

Spot tests show K− or K+ pale yellow on the medulla (fumarprotocetraric acid), C−, and P+ orange to red.
