...
- **Category:** Microscopy reagent / Mounting medium
- **Components:** Polyvinyl alcohol (binder), lactic acid (clearing agent), glycerol (plasticizer/humectant), water (solvent)
- **Alternative names:** Polyvinyl-alcohol-lactic acid-glycerol mountant
...
- Roots stained with trypan blue, chlorazol black E, or acid fuchsin can be permanently mounted in PVLG-based media to voucher mycorrhizal structures.
...
Standard PVLG recipe (see also Appendix II of source text):
- Dissolve polyvinyl alcohol in water with gentle heating
...
- The page title is PVLG.
- Its recorded source is unknown-biodiversity-of-fungi.md.
- Existing tags on the page are [reagent, microscopy, mycology, mountant].
