...
**Classification:** Basidiomycota → Agaricomycetes → Polyporales → Polyporaceae → *Trametes* → *T. gibbosa*.

The species was originally described by Persoon in 1801 and has been placed in several genera including *Bjerkandera* and *Coriolopsis* before its current placement in *Trametes*.
