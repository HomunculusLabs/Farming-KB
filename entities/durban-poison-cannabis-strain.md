...
First brought to the United States in the late 1970s by cannabis enthusiast Ed Rosenthal, Durban Poison has since been stabilized and refined while retaining the core characteristics of its African landrace ancestry. It remains one of the few strains widely recognized as a true or near-true landrace variety in commercial markets.
...
As a landrace, Durban Poison represents a population adapted to its specific environment over centuries of natural and human selection. Unlike most commercial strains, which are hybridized crosses of multiple lineages, landrace strains offer genetic purity and a stable, consistent expression of traits.
...
- **Flowering time:** 8–9 weeks indoors; late October to November in the Southern Hemisphere outdoors
...
Durban Poison is distinguished by an exceptionally rich terpene profile dominated by terpinolene, a less common monoterpene that contributes sweet, fruity, and slightly floral aromas. This is unusual among cannabis strains, where myrcene, limonene, and β-caryophyllene typically dominate.

**Primary terpenes:**
- **Terpinolene (up to 1.5%):** Sweet, piney, floral, and slightly herbal. Contributes to the strain's complex aroma and is associated with uplifting, creative effects in anecdotal reports.
- **Myrcene (0.5–1.0%):** Earthy, musky. Present in lower concentrations than typical for cannabis, contributing to the strain's less sedative profile.
- **Ocimene (0.3–0.8%):** Sweet, woody, herbaceous. Adds complexity to the bouquet.
- **Limonene (0.2–0.5%):** Citrus notes. Moderate levels contribute mood-elevating properties.
- **Caryophyllene (0.2–0.4%):** Peppery, spicy. Adds depth to the flavor profile.
...
- May amplify sensory perception (visual, auditory)
- Long duration — effects typically persist 3–4 hours

**Reported medical applications:**
- **Daytime fatigue:** Used as a functional stimulant for managing chronic fatigue and low energy
- **Depression:** Mood-elevating properties may provide temporary relief from depressive symptoms
- **ADHD:** Some patients report improved focus and task completion, though clinical evidence is lacking
- **Appetite management:** The THCV content may suppress appetite, distinguishing it from most cannabis strains that stimulate it
- **Nausea:** Antiemetic properties of THC provide relief
- **Migraine:** Some users report abortive effects when taken at migraine onset

## Cultivation Notes

Durban Poison is considered moderately challenging to cultivate due to its vigorous stretching during flowering:

- Performs best in warm, Mediterranean-like climates with long growing seasons
- Requires significant vertical space indoors — topping or LST (low-stress training) recommended early in flowering
- Resistant to mold and mildew compared to many modern hybrids, likely due to its landrace genetics
- Prefers moderate nutrient levels; overfeeding can reduce terpene production
- Harvest timing is critical — the terpinolene profile peaks at approximately day 63 of flowering, after which the profile shifts toward more sedative compounds
- The strain transitions rapidly during the final two weeks, with calyxes swelling and trichome production accelerating
...
## Comparison to Other Landrace Sativas

| Strain | Origin | THC Range | Primary Terpene | Flowering Time |
|---|---|---|---|---|
...
- [[jack-herer-entity]] — another iconic sativa-dominant strain with similar energizing effects
