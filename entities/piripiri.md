...
Piripiri (Cyperus sp.) is a group of sedge plants used extensively in Amazonian vegetalismo for a wide range of medicinal and magical purposes. Multiple varieties exist, each with specific applications. The most dramatic use involves the caballo piripiri (horse piripiri), which when ingested confers great physical strength. Piripiri is also used by Shipibo shamans as an additive to ayahuasca and as a standalone healing plant.

## Classification

- **Domain**: Amazonian vegetalismo / ethnobotany
- **Category**: Medicinal plant, magical plant
- **Scientific name**: Cyperus sp.
- **Family**: Cyperaceae
- **Habitat**: Amazon basin, wet areas
