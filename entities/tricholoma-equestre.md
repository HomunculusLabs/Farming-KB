...
- **Genus:** Tricholoma
- **Species:** T. equestre (L.) P. Kumm. (1871)

### Synonyms

- *Agaricus equestris* L. (1753) — original basionym
- *Gyrophila equestris* (L.) Quél. (1886)
- *Tricholoma flavovirens* (Pers.) S. Lundell (1942) — widely used synonym; some authorities still consider this the valid name
- *Tricholoma auratum* (Paulet) Gillet (1874) — sometimes applied to forms with more vivid yellow cap

### Nomenclatural Note

The name T. flavovirens is still commonly encountered in field guides and mycological literature. Some European mycologists maintain T. flavovirens and T. equestre as distinct taxa, with T. flavovirens referring to a more intensely yellow-capped form found under pine. Molecular studies have not conclusively resolved whether they represent one variable species or a species complex.

## Morphology

### Macroscopic Features

- **Cap:** 4–12 cm diameter, broadly convex to plano-convex, sometimes with a low umbo; surface smooth, viscid when wet, hygrophanous; color yellow-green to golden-yellow, sometimes olive-tinged at the disc; margin inrolled when young, often irregular in age.
- **Gills:** Adnexed to sinuate, crowded, narrow; color white to pale yellow, sometimes staining yellowish in age; edges often slightly fibrillose.
...
- **Cheilocystidia:** Variable — clavate to cylindrical, sometimes forked or branched, thin-walled, 20–40 × 4–8 µm.
- **Pileipellis:** Cutis of repent cylindrical hyphae 3–6 µm wide with intracellular yellowish pigments. No gelatinous layer.
...
The discovery of T. equestre's toxicity represents a landmark case in medical mycology. The key findings emerged from clinical investigations led by Dr. Régis Bedry in Bordeaux, France.

- **First documented outbreak:** 12 cases of unexplained rhabdomyolysis admitted to intensive care in southwestern France between 1992 and 2000, all with recent history of consuming T. equestre. One patient died.
- **Mechanism:** Consumption causes delayed-onset rhabdomyolysis — breakdown of skeletal muscle fibers releasing myoglobin into the bloodstream. The specific toxic compound(s) remain unidentified despite extensive investigation. Proposed candidates include unusual fatty acid derivatives, saponins, or cyclopropyl amino acid metabolites.
- **Dose dependency:** Toxicity appears to be dose-dependent. Patients reported consuming large quantities (typically 500 g or more fresh weight per meal) on repeated consecutive days. This pattern was common in regions where T. equestre was traditionally eaten in abundance during peak season.
- **Onset of symptoms:** Delayed 24–72 hours after consumption. Initial symptoms include muscle weakness, fatigue, and myalgia, particularly in the proximal muscles (thighs, shoulders).
- **Clinical progression:** Severe cases develop acute renal failure secondary to myoglobinuria, elevated CK (up to 200,000 U/L; normal <200), dark urine, nausea, and vomiting.
- **Fatal cases:** At least one confirmed fatality (1992, Landes, France). Additional suspected deaths may have been misattributed.
