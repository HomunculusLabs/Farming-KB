...
### Oceania
- **Australia:** Reported from eastern and southeastern Australia, growing on dead wood in forests and gardens.
- **New Zealand:** Documented from North and South Islands.
...
- **Substrate:** Saprotrophic on dead wood — primarily hardwood (oak, beech, eucalyptus, Nothofagus in southern Chile) but also on conifer wood
- **Habitat:** Forests, woodlands, gardens with mature trees, riverbanks, and parks
- **Growth pattern:** Usually grows in clusters (caespitose) on logs, stumps, and fallen branches
- **Season:** Autumn (March-May in Southern Hemisphere; September-November in Northern Hemisphere)
- **Climate preference:** Temperate to subtropical; tolerant of oceanic climates
...
|---|---|---|
| Psilocybin | 0.04-0.12% | Variable between specimens |
| Psilocin | 0.01-0.04% | Less stable than psilocybin |
| Bis-noryangonin | Present | Unique to Gymnopilus; MAO inhibitor |
| Baeocystin | Trace | Variable |
...
- Gartz noted that the combination of psilocybin + bis-noryangonin may produce effects that differ qualitatively from species lacking the MAOI component
...
Several Gymnopilus species resemble G. purpuratus but may differ in psychoactive content:

| Species | Key Differences | Psychoactive? |
|---|---|---|
| G. spectabilis (Big laughing gym) | Larger (cap to 20cm), North American/Asian distribution, brighter orange | Yes (psilocybin + bis-noryangonin) |
| G. junonius | Very large, East Asian/North American, more yellow | Unconfirmed |
| G. luteofolius | Purplish gills, smaller, grows on wood chips | Yes (psilocybin) |
| G. viridans | Greenish tones, grows on conifer wood | Unconfirmed |
| G. penetrans | Smaller, grows on conifer wood | No |

**Warning:** The Gymnopilus genus contains many species that are NOT psychoactive, and some may be toxic. The rusty-brown spore print and growth on dead wood are characteristic of the genus, but species-level identification requires microscopy. Not all Gymnopilus species have been chemically analyzed.
