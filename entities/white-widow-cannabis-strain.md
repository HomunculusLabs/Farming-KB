...
sources:
  ...
  - https://www.wikileaf.com/strain/white-widow/
  - https://www.allbud.com/marijuana-strains/hybrid/white-widow
  - https://en.wikipedia.org/wiki/White_Widow
  - https://www.growweedeasy.com/white-widow
  - https://www.greenhouse-seeds.nl/white-widow-feminised
...
White Widow is a carefully crafted cross between two landrace strains from different hemispheres:

| Parent | Type | Origin | Contribution |
|--------|------|--------|--------------|
| Brazilian Sativa | Pure sativa | Brazil | Cerebral energy, tall growth, branching structure |
| Indian Indica | Pure indica | Kerala, India | Resin production, compact buds, body effects |
...
White Widow's sensory profile is pungent, earthy, and layered:

- **Aroma:** Fresh pine and woody notes dominate, underpinned by damp earthiness and a subtle floral sweetness. When ground, a sharp peppery skunk character emerges.
- **Flavor:** On inhalation, smooth pine and earthy tones are most apparent. The exhale reveals a peppery, slightly hash-like spice with hints of citrus and floral sweetness on the finish.
- **Smoke:** Generally thick and smooth, though expansive in the lungs; can provoke coughing in novice consumers due to resin density.

## Cannabinoid Profile

| Compound | Typical Range | Notes |
|----------|---------------|-------|
| THC | 18–25% | Potency varies by phenotype and grow conditions |
| CBD | <0.1–0.2% | Very low; not a CBD-rich strain |
| CBG | Trace | Minor amounts present |
| THCV | Trace | Negligible |

Modern selections have pushed some cuts to 23–25% THC, while original 1990s specimens tested closer to 15–18%.

## Effects & Experience

White Widow provides a well-rounded, balanced experience that bridges cerebral stimulation and physical relaxation:
...
White Widow has a long history of therapeutic use:

- **Pain Management:** Effective for chronic pain, migraines, muscle spasms, and neuropathic discomfort.
- **Stress & Anxiety:** The uplifting cerebral effects can alleviate stress, mild anxiety, and depressive symptoms.
- **Insomnia:** At higher doses, the sedating body effects promote sleep onset and improve sleep quality.
- **Appetite Stimulation:** Induces appetite, beneficial for patients dealing with appetite loss due to illness or treatment.
- **PTSD & Mood Disorders:** Some patients report relief from trauma-related symptoms and mood instability.

## Cultivation

White Widow is widely regarded as an excellent strain for growers of all experience levels:

| Parameter | Details |
|-----------|---------|
| **Difficulty** | Easy to moderate; very forgiving for beginners |
| **Indoor Flowering Time** | 8–9 weeks (56–63 days) |
| **Outdoor Harvest** | Late September to mid-October (Northern Hemisphere) |
| **Indoor Yield** | 400–500 g/m² |
| **Outdoor Yield** | 500–600 g/plant |
| **Preferred Climate** | Temperate to warm; 18–26°C optimal; handles cool nights well |
| **Plant Height (Indoor)** | 80–140 cm |
| **Plant Height (Outdoor)** | 150–200 cm |
| **Resistance** | Good resistance to mold and pests; moderate humidity tolerance |
...
- Excellent candidate for hash and extract production due to abundant resin.
...
White Widow has an extensive trophy cabinet spanning decades:

- **1995 High Times Cannabis Cup** — 1st Place, Bio Category (Green House Seeds)
- Multiple High Times Cannabis Cup placements throughout the late 1990s and 2000s.
- Consistently featured in Leafly's "Top 10 Strains of All Time" lists and widely considered one of the most recognized strains in cannabis history.
...
1. Green House Seeds. "White Widow Feminised." greenhouse-seeds.nl.
2. Shantibaba / Mr. Nice Seedbank. Breeding history and strain documentation.
