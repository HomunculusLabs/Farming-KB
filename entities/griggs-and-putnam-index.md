...
- **Category:** Wind assessment methodology / Bioclimatic indicator
...
- The index rates tree deformation on a scale of 0 (no effect, no deformation of branches) to 7 (tree reduced to a creeping, shrub-like layer of prostrate growth).
- Intermediate stages include brushing (1), slight flagging (2), moderate flagging (3), strong flagging (4), partial throw (trunk bent to leeward but vertical near ground, 5), and complete throw (trunk quite bent to leeward, 6).
- The scale matches deformation values to average annual wind speeds with approximately 17% accuracy.
...
| Index | Wind Speed (m/sec) | Effect Description |
|-------|-------------------|-------------------|
| 0 | Less than 3.3 | No deformation |
| 1 | 3.3-4.2 | Brushing: branches bent away from wind |
| 2 | 4.3-5.1 | Slight flagging: small branches bent, tree asymmetric |
| 3 | 5.2-6.2 | Moderate flagging: larger branches bent |
| 4 | 6.3-7.5 | Strong flagging: all branches swept to leeward |
| 5 | 7.6-8.5 | Partial throw: trunk bent but vertical near ground |
