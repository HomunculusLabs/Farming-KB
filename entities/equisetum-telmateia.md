...
The central hollow stem cavity is wide, and silica deposits in the epidermis give the stems a rough, abrasive texture.

**Roots** arise from tuberous rhizomes that can penetrate deep into the soil (up to 1 m). Rhizome systems are extensive and can spread several meters from the parent plant.

**Spores** are green, spherical, 40–60 μm diameter, with four strap-like elaters that coil and uncoil in response to humidity, aiding dispersal.
