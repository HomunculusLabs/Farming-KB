...
its [[metzner-ayahuasca-therapeutic-potential]].

## Chemical Properties

- **IUPAC name**: (1S,2R,5S,7R,8R)-2,6,6,8-tetramethyltricyclo[5.3.1.0¹,⁵]undecan-8-ol
- **Molecular formula**: C₁₅H₂₆O
- **Molecular weight**: 222.37 g/mol
- **Structure**: Bicyclic sesquiterpene with a hydroxyl group; eudesmane skeleton
  (decalin ring system fused with a cyclopentane ring bearing an -OH substituent).
- **Appearance**: Colorless to pale yellow viscous liquid at room temperature.
...
chemovars and may contribute to:

- The woody, earthy, and pine-like aromatic notes in certain strains.
- Anti-inflammatory effects that complement the analgesic properties of THC and
  CBD.
- Potential synergistic anticancer activity when combined with cannabinoids,
