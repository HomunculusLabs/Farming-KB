...
**Classification:** Plantae → Tracheophyta → Magnoliopsida → Proteales → Platanaceae → *Platanus orientalis* L.
...
Flowers are borne in dense, spherical heads approximately 1–2 cm in diameter. Male and female flowers are separate but on the same tree (monoecious). The male flower heads are borne on long peduncles, while female heads are shorter-stalked.

The fruit is a compact aggregate of achenes, 2–3 cm in diameter, borne on long pendulous stalks that can reach 10 cm in length. Each achene is small, dry, and single-seeded. Fruiting heads disintegrate over winter, releasing seeds gradually.

Autumn foliage color is generally yellow to golden-brown, though the display is less dramatic than many other temperate hardwoods. Leaf fall occurs from November to December in Mediterranean climates.

## Distribution and Habitat

The native range of *Platanus orientalis* extends from the eastern Mediterranean through Turkey, Iran, and into the western Himalayas. It is particularly associated with riparian corridors and alluvial plains.

In southeastern Europe, it occurs naturally along river valleys in Greece, the Balkans, and Italy. Isolated populations persist in regions with reliable water sources.

The species is strongly dependent on water, typically growing along riverbanks, stream margins, and in moist valleys. It thrives in deep, fertile, alluvial soils but tolerates a range of substrates given adequate moisture.
...
The Oriental plane has been cultivated as an ornamental shade tree since antiquity. It was planted along roadsides, in market squares, and near temples throughout the classical world.

It remains a popular urban tree in Mediterranean and Middle Eastern cities. Its broad canopy provides dense shade, and its tolerance of pollution and pruning makes it suitable for street planting.

The wood is moderately hard and fine-grained, though it can be difficult to work due to interlocked grain. It has been used for furniture, veneer, carving, and cooperage. Historical uses include wagon construction and agricultural implements.

In traditional medicine, various parts of the tree have been used. The bark has been applied as an astringent and febrifuge in Middle Eastern herbal practice. Leaf preparations have been used topically for skin complaints.

Propagation is typically by seed, though cultivars are often grafted onto seedling rootstock. Softwood cuttings can also be successful under mist. The tree grows rapidly when young and can live for several centuries.

The species tolerates atmospheric pollution and root compaction better than many temperate hardwoods, contributing to its popularity as an urban tree. However, its large ultimate size and aggressive root system can cause infrastructure conflicts in restricted spaces.

Several named cultivars exist, including 'Digitata' (deeply cut leaves) and 'Minaret' (narrow, columnar form). These selections offer alternatives for smaller gardens and confined urban settings.

## Ecology

*Platanus orientalis* plays an important ecological role in riparian ecosystems across its range. Its extensive root system helps stabilize stream banks and reduce erosion along waterways.
