...
Reserpine irreversibly inhibits the vesicular monoamine transporter 2 (VMAT2):

- **VMAT2 inhibition** — blocks transport of serotonin, dopamine, norepinephrine, and epinephrine into synaptic vesicles, leaving monoamines vulnerable to degradation by mitochondrial MAO
...
- **Absorption:** Well absorbed orally (30–50% bioavailability). Peak plasma levels in 2–4 hours.
- **Half-life:** 33 hours (elimination); pharmacological effects persist far longer due to VMAT2 irreversibility
- **Volume of distribution:** Very large (extensive tissue binding)
- **Metabolism:** Hepatic via ester hydrolysis and O-demethylation; primarily to methyl reserpate and other inactive metabolites
- **Excretion:** Primarily fecal (via biliary excretion); small renal fraction

## Effects

### Therapeutic Effects

- Reduction of systolic and diastolic blood pressure (through peripheral catecholamine depletion)
- Antipsychotic and sedative effects (through central monoamine depletion)
- Calming and tranquilizing effects at low doses

### Adverse Effects

- Severe depression and suicidal ideation (most significant limitation)
- Parkinsonism and extrapyramidal symptoms
- Nasal congestion, gastrointestinal distress, and diarrhea
- Weight gain and increased appetite
- Orthostatic hypotension and bradycardia
- Impotence and galactorrhea (due to prolactin elevation)

The high incidence of depression led to reserpine being largely replaced by newer antipsychotics and antihypertensives with better safety profiles.

## Dose Ranges

- **0.05–0.1 mg/day** — low-dose antihypertensive (historical use)
- **0.25–0.5 mg/day** — moderate-dose antihypertensive; increased risk of depression
- **2–6 mg/day** — antipsychotic doses (historical use in psychiatric hospitals)
- **>5 mg/day** — high risk of severe depression, parkinsonism, and suicidal ideation
