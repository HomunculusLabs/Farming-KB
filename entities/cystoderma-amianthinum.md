...
Cystoderma amianthinum, commonly known as the saffron parasol or earthy parasol, is a small agaricoid mushroom in the family Agaricaceae.

It is recognized by its distinctive granular-squamulose cap surface, which gives it a characteristic frosted or mealy appearance.

The species is widely distributed across the Northern Hemisphere, fruiting in coniferous and mixed forests on decaying plant material.

First described by August Johann Georg Karl Batsch in 1789, it has a long taxonomic history with several synonymizations.

Although technically edible, its small size and unremarkable flavor mean it is rarely collected for the table.
...
- **Family:** Agaricaceae
- **Genus:** Cystoderma
- **Species:** C. amianthinum (Batsch) Fayod
...
The genus Cystoderma is characterized by the presence of sphaerocysts (inflated cells) in the pileipellis, which give the cap its granular texture.

## Morphology

The cap is 2–5 cm in diameter, broadly convex to plano-convex, sometimes with a low umbo, not hygrophanous.

Surface is covered with fine, granular to mealy squamules over a pale yellow to ochraceous background, more densely scaled toward the center.
...
Above the annulus the stipe is smooth and white; below the annulus it bears the same granular scales as the cap surface.

Flesh is thin, white, with a mild to slightly farinaceous odor and a mild taste, though some descriptions note a faintly bitter aftertaste.
