...
|---|---|---|
| Harlequin | Sativa-dominant | High CBD (8–15%), clear-headed |
...
- **Stability:** Moderately stable; phenotype variation in CBD:THC
  ratio is common (ranges from 1:2 to 2:1 depending on cut)
...
- **Trichome coverage:** Heavy; trichomes appear cloudy to amber at
  peak maturity
- **Pistils:** Abundant, bright orange, creating strong visual
  contrast against dark foliage

## Aroma and Flavor

- **Primary notes:** Earthy, woody, spicy
- **Secondary notes:** Sweet tropical fruit, citrus, pepper
- **Tertiary notes:** Skunky undertone, floral hints
- **Smoke character:** Smooth, expanding; slightly harsh at high
  temperatures due to myrcene and caryophyllene content

## Terpene Profile

- **Myrcene:** 0.5–1.0% (dominant; contributes sedative body effects)
- **Caryophyllene:** 0.3–0.7% (peppery, anti-inflammatory via CB2)
- **Limonene:** 0.2–0.5% (citrus, mood elevation)
- **Linalool:** 0.1–0.3% (floral, anxiolytic)
- **Pinene:** 0.1–0.2% (pine, bronchodilator)
