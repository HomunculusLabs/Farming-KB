...
- **SMILES:** CC(=O)OC1=CNC2=C1C=C(C=C2)CCN(C)C
- **Chemical class:** Substituted tryptamine; acetylated psilocin analog
- **Appearance:** White to off-white crystalline powder; also encountered as an off-white to tan powder of variable purity depending on source

## Chemical Structure and Properties

4-AcO-DMT is structurally related to several important tryptamine compounds:

- **Psilocybin (4-PO-DMT):** The phosphate ester of psilocin; 4-AcO-DMT replaces the phosphate group with an acetyl group
- **Psilocin (4-HO-DMT):** The dephosphorylated, deacetylated active metabolite of both psilocybin and 4-AcO-DMT
- **The relationship mirrors that between aspirin (acetylsalicylic acid) and salicylic acid — the acetyl group serves as a lipophilic prodrug moiety that enhances bioavailability and is cleaved in vivo**

### Structural Comparison

| Compound | 4-Position Substituent | Function |
|---|---|---|
| Psilocybin | -OPO₃H₂ (phosphate) | Natural prodrug of psilocin |
| 4-AcO-DMT | -OCOCH₃ (acetyl) | Synthetic prodrug of psilocin |
| Psilocin | -OH (hydroxyl) | Active metabolite |
| DMT | -H (no substituent) | Non-4-substituted tryptamine |
...
- **Elimination:** Renal excretion of metabolites; elimination half-life of psilocin is approximately 2–3 hours
- **Detection:** Detectable in urine for 24–48 hours; psilocin is the primary analyte targeted in forensic drug screening

## Subjective Effects and Dosage

The subjective effects of 4-AcO-DMT are reported by users as virtually indistinguishable from those of psilocybin mushrooms, with some users describing subtle differences in character:

### Common Dosage Ranges (Oral, dried powder)

| Dose Level | 4-AcO-DMT (mg) | Equivalent Psilocybin (mg) |
|---|---|---|
| Threshold | 2–5 | 3–8 |
| Light | 5–10 | 8–15 |
...
- **Cognitive:** Altered thought patterns; philosophical and spiritual insights; enhanced creativity and divergent thinking; ego dissolution at higher doses; increased emotional sensitivity and introspection
...
- **1960s:** First synthesized by Albert Hofmann at Sandoz Pharmaceuticals during the same research program that produced psilocybin; part of systematic investigation of tryptamine structure-activity relationships
...
- **United States:** Not explicitly scheduled at the federal level under the Controlled Substances Act; however, the Federal Analog Act may apply, as it is structurally similar to psilocybin (a Schedule I substance). Some states have explicitly scheduled 4-AcO-DMT
...
4-AcO-DMT is generally considered to have a favorable safety profile, consistent with other classic psychedelics:
...
- **Drug interactions:** Dangerous interactions with MAO inhibitors (potentiation of serotonin effects, risk of serotonin syndrome); SSRIs may attenuate effects; contraindicated with lithium
