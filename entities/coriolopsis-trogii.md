...
sources:
  ...
  - Núñez, M. & Ryvarden, L. (2001). "East Asian Polypores." Synopsis Fungorum 14.
...
Antioxidant activity of C. trogii extracts has been confirmed by DPPH and ABTS radical scavenging assays. Methanol extracts show the highest activity, attributed to the total phenolic content of the fruiting body.

Preliminary immunomodulatory studies suggest that polysaccharide fractions from C. trogii stimulate macrophage activity and enhance lymphocyte proliferation. These findings warrant further investigation for therapeutic potential.
...
For mycelial culture maintenance, the fungus grows well on malt yeast agar at 28°C with moderate light exposure. It can be stored long-term on sterile hardwood chips or in distilled water at 4°C.

## Edibility

C. trogii is not considered edible. The tough, corky consistency of the basidiocarp makes it unpalatable. No toxic compounds have been specifically identified, but it should not be consumed due to insufficient toxicity data and potential similarity to toxic polypores.
