...
The species is the most widely grown lupin crop globally, with Australia dominating production at over 700,000 hectares annually. Western Australia accounts for approximately 80% of world lupin production.
...
Pods are small (2-3 cm), flattened, and hairy, containing 4-6 seeds. Seeds are small (4-6 mm), kidney-shaped, and vary in color from mottled grey-brown to black depending on cultivar.
...
Crop duration is 140-160 days from sowing to maturity. Modern cultivars are non-shattering, a key domestication trait selected from natural mutations in the wild gene pool.

Average grain yields range from 1.0-2.5 tonnes per hectare, with experimental yields exceeding 4 tonnes per hectare under optimal management. Yield is highly variable depending on seasonal rainfall and disease pressure.
