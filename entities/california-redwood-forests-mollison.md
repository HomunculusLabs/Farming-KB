---
title: California Redwood Forests
source: bill-mollison-permaculture-a-designers-manual
type: entity
tags: [forest-ecosystem, california, fog-condensation, sequoia]
---
...
- **Dominant species**: *Sequoia sempervirens* (Coast Redwood)
...
Redwood forests maintain themselves through a positive feedback cycle:

1. **Cold ocean currents** generate advection fogs along the coast
2. **Tall redwood canopies** intercept fog at great height, increasing the volume of moist air captured
3. **Laminate leaf surfaces** provide condensation sites for fog droplets
4. **Fog drip** waters the forest floor, supplementing winter rainfall
5. **Deep root systems** access groundwater sustained by drip
...
1. **Fog harvesting**: Any coastal or montane site with regular fog can use tall evergreen trees as passive water harvesters
2. **Height matters**: Taller trees are more effective condensers — preserving mature trees is more valuable than planting seedlings
3. **Irreversibility**: Once fog-dependent forests are removed, the feedback loop may be impossible to restart without enormous intervention
4. **Analogous systems**: The same principles apply to laurel forests (Canary Islands), cloud forests (Tropics), and moss forests (Tasmania, Chile, Scandinavia)
...
- Tasmania rainforests
- Chilean temperate rainforests
- Hawaiian cloud forests (Lanai, Maui)
