...
OHN is applied at key growth stages when plants are most vulnerable or when reproductive growth should be stimulated:

| Application | Dilution Rate | Timing |
|-------------|--------------|--------|
| Foliar spray | 1:500 to 1:1000 | During flowering and fruiting |
| Soil drench | 1:500 to 1:1000 | Before flowering stage |
| Seed treatment | 1:500 | Before planting |
| Transplant shock prevention | 1:500 | At transplanting |
| Stress recovery | 1:500 | After drought, hail, or pest damage |
| Pest prevention | 1:250 to 1:500 | At first sign of pest pressure |

OHN is typically applied in the late afternoon to maximize absorption and minimize potential phytotoxicity from sunlight interaction with the alcohol and oil components.
