...
- Vitamin E
- Iron (up to 15 mg/100 g dried), calcium, zinc, magnesium, potassium, copper, manganese
- Significant selenium content — important for populations in selenium-deficient regions

### Bioactive Compounds
- **Macaenes and macamides** — unique polyunsaturated fatty acid derivatives (alkamides), considered the primary bioactive constituents responsible for adaptogenic and fertility effects
- **Glucosinolates** — including glucotropaeolin and m-methoxybenzyl glucosinolate; breakdown products include benzyl isothiocyanate (antimicrobial)
- **Sterols** — β-sitosterol, campesterol, stigmasterol
- **Alkaloids** — macaridine, maca alkaloid (lepidiline)
- **Polyphenols** — catechins, procyanidins
- **Benzyl isothiocyanate** — antimicrobial, but also potentially goitrogenic at high doses

## Traditional Uses

### Food
In the Andes, maca is consumed as a staple food, not merely a supplement:
- Boiled and eaten as a vegetable (fresh hypocotyls)
- Dried and ground into flour (*harina de maca*) for baking, porridge, and beverages
- Fermented into a mildly alcoholic beverage (*maca chicha*)
- Made into sweet preserves (*marmelada de maca*) mixed with honey
...
The most extensively studied area. Multiple randomized controlled trials (RCTs) and systematic reviews have found:
- Increased sperm count, motility, and normal morphology after 12 weeks of supplementation (3 g/day)
- Improved subjective sexual desire (libido) after 6 weeks
- Black maca appears most effective for sperm parameters; red maca may be more effective for prostate health
...
### Energy and Mood
- Small trials show improvements in self-reported energy and mood scores
- Some evidence for reduced anxiety and depression scores after 6 weeks
- Mechanisms are unclear but may involve adaptogenic effects on the HPA axis

### Bone Health
- Animal studies (ovariectomized rats) suggest maca may protect against bone loss, particularly with the red variety
- Human data are lacking

### Cognitive Function
- Limited animal evidence suggests maca may improve memory and learning, possibly via antioxidant mechanisms

## Permaculture Applications

Maca has several properties that make it interesting for permaculture design:

### High-Altitude and Marginal Land Crop
- One of the few food crops productive above 4,000 m
- Tolerates poor, rocky soils, frost, intense UV, and wind
- Could fill a niche in high-altitude food forest systems

### Companion Planting Potential
- As a Brassicaceae member, maca can serve as a trap crop or indicator plant for cabbage moth and flea beetles
- Its deep taproot can break compacted subsoil layers
- The leafy rosette provides ground cover, reducing erosion in the puna

### Nutrient Cycling
- Maca hypocotyls accumulate minerals from deep soil layers, making these nutrients available when the plant is harvested and the residues decompose
- The crop is traditionally intercropped with native tubers (oca, ulluco, mashua) in a polyculture system

### Challenges
- Day-length sensitivity limits cultivation outside the tropics/subtropics
- Long growing season (8–10 months) requires planning
- Self-seeding can become weedy in cool highland environments

## Safety and Precautions

- **Generally recognized as safe (GRAS)** for food use
- Goitrogenic potential: maca contains glucosinolates that can interfere with thyroid function at very high doses, particularly in individuals with pre-existing thyroid conditions. Cooking deactivates most goitrogens.
- The high selenium content is generally beneficial but could be a concern with excessive supplementation.
