...
- Edible and considered safe when fresh and properly identified; one of the safest ink cap species
- Fruits in repeated crops from the same substrate throughout the season, making it a reliable foraging target
- Often found around old stumps, decaying wood, and buried roots in both urban and rural settings
- Cap surface covered with glistening, mica-like granules that wash off with rain or handling
- Gills undergo auto-digestion (deliquescence), turning from white to black ink from the edges inward
- Small stature, typically 2-5 cm cap diameter
- Can be confused with other Coprinus species; careful identification is essential
- Should only be consumed when young and fresh, before gills begin to darken significantly
- Does not contain coprine (unlike C. atramentarius), so alcohol consumption is not contraindicated

## Historical Context

Julius A. Palmer initially condemned Coprinus micaceus as non-esculent in his Popular Science Monthly article (1877), an error he later corrected in his book About Mushrooms (1894). He acknowledged it as one of the safest fungi available, noting its importance for mycologists to recognize due to its reliable, repeated fruiting cycles.

Palmer experienced unpleasant symptoms after consuming a stew containing C. micaceus, which he later attributed to contamination from decomposing Coprinus deliquescens specimens mixed into the dish rather than any inherent toxicity of C. micaceus itself. He considered the initial condemnation his "most notable error" in the article.
...
This entry provides reference information about coprinus micaceus and its significance in its respective field.

## See Also

- [[coprinus-comatus]] — the maned mushroom / shaggy ink cap
- [[coprinus-atramentaria]] — common ink cap, contains coprine
- [[coprinus-deliquescens]] — another inky cap species discussed by Palmer
- [[marasmius-oreades]] — another reliable edible found in repeated crops
