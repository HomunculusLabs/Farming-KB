...
Elevation range extends from near sea level to approximately 600 meters in the Appalachian foothills.

The species is frequently found on limestone-derived soils and is considered calcicole in portions of its range, particularly in the Ozark and Ouachita regions.

Fire suppression in the eastern United States has reduced the extent of open prairie habitat favored by the species, though it persists in power line rights-of-way and other maintained open areas.

## Cultivation

Coreopsis lanceolata is one of the easiest native wildflowers to cultivate, thriving in USDA hardiness zones 4 through 9. It requires minimal irrigation once established and performs well in poor, sandy soils where many perennials struggle.

Plants should be spaced 25 to 30 centimeters apart. Deadheading spent flowers extends the bloom period significantly and prevents excessive self-seeding. Propagation is by seed (no stratification required) or division of clumps in early spring.
