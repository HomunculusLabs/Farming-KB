...
- **Location:** Viola, Wisconsin (New Forest Farm, Richland County)
- **Education:** Studied permaculture with Bill Mollison; agricultural background in conventional farming before conversion
- **Occupation:** Farmer, consultant, author, founder of Restoration Agriculture Development (RAD)
- **Organization:** Restoration Agriculture Development LLC — consulting firm designing and installing large-scale perennial crop systems
- **Farm founded:** New Forest Farm, 1994, on 106 acres
- **Website:** restorationag.com (Restoration Agriculture Development)
...
### New Forest Farm Design
- **Total acreage:** 106 acres (43 hectares); ~90 acres in active perennial polyculture production
...
- **Conversion timeline:** 1994–present; canopy closure beginning 2010s; full production expected by 2040s

### Staple Crop Focus
- Chestnuts as primary carbohydrate staple (30%+ of farm calories by design); chestnut flour replaces wheat flour
- Hazelnuts as primary fat/protein source; nutritionally comparable to soybeans
- Apples, cider apples, and other fruits as secondary crops
- Pastured livestock as protein and fertility integration layer
- Demonstrates that staple-calorie production is achievable in perennial systems (contrary to permaculture criticism)

### Grazing Integration
- Multi-species rotational grazing: cattle, sheep, pigs, chickens, turkeys
- Pigs used for site preparation (rooting behavior clears ground for tree planting)
- Chickens follow cattle through paddocks — dung beetle larvae and fly larvae provide protein
- Grazing replaces mowing, fertilization, and pest management in orchard alleys
- Stocking density managed to maintain groundcover while cycling nutrients through manure

## Published Works

### Restoration Agriculture (2013)
- Primary text; subtitled "Real-World Permaculture for Farmers"
- Documents 15+ years of New Forest Farm conversion
- Presents the oak savanna model and design methodology
- Includes crop selection tables, spacing calculations, and economic projections
- Written in accessible, farmer-friendly language; avoids permaculture jargon where possible
- Target audience: conventional farmers considering transition; permaculture practitioners seeking scale
- Sales: One of the best-selling permaculture-related books globally

### Water for Any Farm (2018)
- Focuses on water management in restoration agriculture systems
- Keyline design principles applied to perennial crop systems
- Swale construction, contour planting, and passive water harvesting
- Case studies from RAD consulting installations across North America

### The Restoration Agriculture Development Handbook (2021)
- Technical manual for designing and installing restoration agriculture systems
- Includes species selection matrices, planting plans, and establishment protocols
- Economic modeling and enterprise budgets for perennial crop systems

## Influence and Legacy

### Impact on Permaculture and Agriculture
...
- **Yield comparisons:** Critics note that total caloric yield per acre of chestnuts + hazelnuts remains lower than corn/soybean rotations; Shepard counters with total system yield (including livestock) and ecosystem service value
...
- **Bill Mollison:** Permaculture co-founder; Shepard studied under Mollison and applies permaculture design to farm-scale systems
- **David Holmgren:** Permaculture co-founder; more focused on homestead/suburban scale; Shepard complements with farm-scale application
- **Sepp Holzer:** Austrian permaculture farmer; similar scale but different biome (alpine); Shepard's work is the North American temperate equivalent
