...
- **Chemical type**: Carboxylic acid anhydride
- **Molecular formula**: C₄H₆O₃
- **Molecular weight**: 102.09 g/mol
- **Boiling point**: 140°C
- **CAS number**: 108-24-7
- **Appearance**: Colorless liquid with strong acetic acid odor

## Key Facts

- Converts THC to THC acetate by acetylation of the phenolic hydroxyl group, yielding a compound with approximately double the potency.
- Produces a 25% increase in weight after adding the acetate structure to the THC molecule.
