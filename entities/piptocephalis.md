...
- **Genus:** *Piptocephalis*
- **Notable species:** *P. virginiana*, *P. xenophila*, *P. crucigera*, *P. freseniana*

## Key Facts

- *Piptocephalis* species are obligate biotrophic parasites that grow exclusively on Mucorales sensu lato; the exception is *P. xenophila*, which can also grow on *Penicillium* and *Chaetomium* species.
- Haustoria are enucleate (lacking nuclei) and delimited from the host cytoplasm by a very thin layer of electron-transparent wall material.
- Host morphology is only minimally affected — slight increase in branching and decrease in marginal hyphal density — but overall host growth can be inhibited.
- Some *Piptocephalis* species stimulate growth of certain host species, suggesting possible mutualistic interactions in some pairings.
- *P. virginiana* requires a host in which linolenic acid concentration exceeds a threshold, along with other unspecified nutrients, explaining its host specificity.
- Axenic growth is extremely limited; *P. virginiana* could not be maintained on malt extract–yeast extract medium.
- Trehalase activity in parasite sporelings increases during infection, indicating exploitation of host trehalose reserves as a carbon source.
- Best development occurs on media with organic nitrogen sources and low sugar concentrations.
...
- The page title is Piptocephalis.
- Its recorded source is unknown-biodiversity-of-fungi.md.
- Existing tags on the page are [zygomycete, obligate-mycoparasite, biotroph, haustorial, mucorales-parasite].
