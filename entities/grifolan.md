...
- Anion-exchange chromatography for final purification

Yield varies from 2-8% of dried fruiting body weight depending on extraction parameters.

## Mechanism of Action

### Immune Cell Activation

Grifolan activates multiple components of innate immunity:

- Macrophages: enhances phagocytic activity, increases nitric oxide (NO) production, and upregulates TNF-alpha, IL-1 beta, and IL-6 secretion via NF-kB and MAPK pathway activation
- Natural Killer (NK) cells: augments cytotoxicity against tumor cells through enhanced IFN-gamma production
- Dendritic cells: promotes maturation and antigen presentation capability
- Complement system: activates the alternative complement pathway through C3 convertase

### Receptor Recognition

Grifolan is recognized by pattern recognition receptors on immune cells:
- Dectin-1 (beta-glucan receptor) on macrophages and dendritic cells
- Complement receptor 3 (CR3) on neutrophils and NK cells
- Toll-like receptor 2 (TLR2) synergistically with Dectin-1

### Anti-tumor Activity

Grifolan does not directly kill tumor cells. Instead, its anti-tumor effects are mediated through:
- Enhanced tumor surveillance by activated macrophages and NK cells
- Promotion of Th1-type immune responses
- Inhibition of tumor angiogenesis through downregulation of VEGF
- Induction of apoptosis in tumor cells via immune-mediated mechanisms

## Preclinical Studies

### Sarcoma 180 Model

In the standard Sarcoma 180 mouse model, grifolan administered intraperitoneally at 10-20 mg/kg for 10 consecutive days produced tumor inhibition rates of 70-90%. Oral administration was less effective but still showed significant anti-tumor activity at higher doses (50-100 mg/kg).

The anti-tumor effect was abolished in mice pretreated with cyclophosphamide (immunosuppressed), confirming the immune-mediated mechanism of action.

### Other Tumor Models

Grifolan demonstrated activity against:
- Meth A fibrosarcoma
- MM-46 mammary carcinoma
...
Grifolan has been investigated in veterinary medicine for canine immune support during cancer treatment, equine respiratory health and enhanced vaccine response, aquaculture disease resistance in farmed fish and shrimp, and improved immune response in commercial poultry operations.
