...
**Companion planting guilds** are intentionally designed polycultural plant communities where multiple species are grown together in mutually beneficial relationships. The guild concept, central to permaculture design, mimics natural plant communities and forest edge ecosystems to create self-sustaining, low-maintenance food production systems. Unlike conventional monoculture, guild design leverages the ecological niches, root depths, nutrient requirements, and biological interactions of diverse plants to create a resilient whole that exceeds the sum of its parts.

## Origins and Theory

### The Forest Edge Model

Guild design draws from observation of natural forest ecosystems, particularly the **forest edge** (ecotone) where woodland meets meadow. This transition zone is typically the most biodiverse and productive area in a landscape because it receives both full sun and partial shade, has access to multiple soil layers, and benefits from the microclimate created by the tree canopy overhead.

In permaculture, the classic guild is modeled on the **apple tree guild** or **fruit tree understory**, where a central productive tree is surrounded by a community of supporting plants that fulfill specific ecological functions.

### The Seven Guild Functions

A well-designed guild addresses seven key ecological functions:
...
7. **Habitat plants** — Species providing shelter, nesting sites, and food for beneficial organisms (birds, amphibians, predatory insects, pollinators)

## Classic Guild Designs

### The Three Sisters

The most famous companion planting guild, developed by indigenous peoples of the Americas over thousands of years:

- **Corn** (*Zea mays*) — Provides vertical support; heavy nitrogen feeder; captures sunlight
- **Beans** (*Phaseolus vulgaris*) — Nitrogen fixer (via *Rhizobium* spp.); climbs corn stalks; adds protein to the diet
- **Squash** (*Cucurbita spp.*) — Large leaves shade soil, suppress weeds, retain moisture; prickly vines deter mammal pests; edible fruit

This guild exemplifies **spatial complementarity** (different above-ground heights and root depths) and **nutrient complementarity** (beans fix nitrogen consumed by corn, squash's large leaves shade the soil surface). Archaeological evidence shows this polyculture was practiced for at least 5,000 years in Mesoamerica and was the foundation of agriculture across much of the Americas.

### The Apple Tree Guild

The archetypal permaculture guild, modeled by Bill Mollison and expanded by Toby Hemenway:
