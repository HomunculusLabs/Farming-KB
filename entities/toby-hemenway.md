...
1. **Connect elements**: Every output of one element should be an input to another
2. **Stack functions**: Every element should serve multiple purposes (a pond stores water, grows food, creates habitat, moderates temperature)
3. **Use biological resources**: Plants, animals, and microbes before machines and chemicals
4. **Accelerate succession**: Start with fast-growing pioneer species to prepare conditions for long-term food forest plants
5. **Edge effect**: Maximise boundaries between different systems for increased diversity

### The Permaculture City (2015)
Extended his approach to urban environments: community gardens, urban food forests, neighbourhood-scale water management, and the role of cities in sustainable culture.

## Influence
Hemenway bridged the gap between academic permaculture ([[permaculture-design-methods]]) and practical home gardening. His work directly influenced the [[food-forest-design]] movement in North America and helped shift permaculture from a rural Australian concept to a globally accessible design system.
...
Toby Hemenway represents an important element within sustainable
...
Several defining characteristics distinguish toby hemenway
...
The ecological relationships involving toby extend
...
Toby Hemenway finds practical application in multiple design contexts.
...
opportunities for toby hemenway. Climate adaptation
...
toby hemenway and its applications. Active investigation
areas include ecological interactions and optimization.
Published findings contribute to an evolving evidence base.

## Historical Context

Toby Hemenway has been recognized across multiple knowledge traditions.
...
Successful integration of toby hemenway into broader
