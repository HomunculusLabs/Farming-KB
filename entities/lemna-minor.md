...
- **Genus:** Lemna
- **Species:** L. minor L.
- **Synonyms:** Lemna gibba auct. non L.; Lemna vulgaris auct.

The genus name derives from the Greek *lemnē*, referring to a water plant growing in stagnant pools. The specific epithet *minor* means "lesser," distinguishing it from larger congeners.

**Frond morphology:** Individual fronds (thalli) are oval to obvate, 3–8 mm long and 2–5 mm wide. Each frond is flat, slightly concave on the upper surface, with a single central root extending 1–4 cm into the water column. Fronds occur singly or in connected pairs to groups of three (mother + 2 daughter fronds).

**Reproduction:** Primarily vegetative through budding from two lateral pockets on the frond margin. Each frond produces daughter fronds that separate after reaching approximately one-third of the mother's size. Sexual reproduction via tiny flowers is rare in the wild and occurs under stress conditions.
...
L. minor has a circumpolar distribution across temperate and subtropical regions of all continents except Antarctica. It is absent from extreme deserts and permanently frozen regions but ubiquitous in ponds, lakes, ditches, marshes, and slow-moving streams.

**Optimal growth conditions:**

- Water temperature: 20–30°C
- pH: 5.0–7.5
- Nutrients: Thrives in eutrophic waters with elevated nitrogen and phosphorus
- Light: Full sun to partial shade; growth rate proportional to light intensity up to saturation

Salinity tolerance is limited to EC levels below 2 dS/m, restricting growth to freshwater systems. Duckweed cannot tolerate brackish conditions, unlike some other floating aquatic macrophytes.
...
Duckweed fronds are nutritionally remarkable for their protein content relative to other plant feeds.
