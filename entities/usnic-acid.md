...
antifungal, antiviral, antiherbivore, and allelopathic properties. Usnic acid
plays a central role in the chemical ecology of lichens, serving as a universal
defensive compound against herbivory, microbial attack, and competition from
other organisms.

## Chemical Classification

- **Compound Class:** Dibenzofuran derivative
...
- Lawrey (1989) confirmed that usnic acid, along with vulpinic acid and stictic
  ...
  megaterium*, *B. subtilis*, and *Staphylococcus aureus*.
- Usnic acid is one of several defensive chemicals produced by lichens avoided
  by herbivores (e.g., the slug *Pallifera varia* avoids lichens containing
  usnic acid, including *Flavoparmelia baltimorensis* and *Xanthoparmelia
  cumberlandia*).
- The compound appears to serve a universal defensive role: active against
  herbivory, microbial attack, and as an allelopathic agent that suppresses
  the growth of competing plants, mosses, bacteria, and fungi.
- Usnic acid is found at particularly high concentrations in lichens of the
  genus *Cladonia*, which have been shown to inhibit seed germination of
  multiple plant species and reduce the growth of both saprotrophic and
  ectomycorrhizal fungi.
- Among lichen compounds tested for allelopathic activity, usnic acid showed
  62% germination of *Funaria* spores vs. controls, making it one of the more
  potent inhibitors tested (Lawrey, 1986).
...
- Brown and Mikola (1974) showed that *Cladonia* lichens reduced the growth
  ...
  abies*) seedlings, though birch (*Betula verrucosa*) was less affected.
- The compound contributes to the formation of "lichen mats" that resist
...
- The compound is of interest in pharmaceutical research for its antibacterial,
  antifungal, antiviral, and potential anticancer properties, though
  hepatotoxicity concerns have limited some applications.

## Sources

- Lawrey, J. D. (1986). Biological role of lichen substances. *The Bryologist*,
  89(2):111-122.
- Lawrey, J. D. (1989). Lichen secondary compounds as anti-herbivore defenses.
- Brown, R. T., Mikola, P. (1974). Influence of fruticose soil lichens upon
