...
- **Frequency:** Uncommon to locally common; less abundant than A. muscaria
...
### Symptom Profile
Raw ingestion causes a biphasic syndrome:
- **Deliriant phase (30–90 min):** Nausea, vomiting, agitation,
  confusion, ataxia, visual/auditory hallucinations, possible seizures
- **Sedative phase (2–4 hr):** Deep sleep with vivid dreams
  (muscimol-dominant); historically the desired effect

### Traditional Use
In Siberian traditions, mushrooms were dried or parboiled to convert
ibotenic acid to muscimol. The well-documented practice of consuming
the urine of intoxicated persons reflects muscimol's renal excretion
largely unchanged, providing a recycled dose with reduced toxicity.

## Comparison with Related Species
| Feature | A. regalis | A. muscaria | A. pantherina |
|---------|-----------|-------------|---------------|
| Cap color | Dark brown | Red to orange | Brown to tan |
| Warts | Thick, persistent | Thin, washable | Pyramidal, patchy |
| Volva rings | 3–5 rows | 2–3 rows | Single fringed collar |
| Odor | Mild radish | Mild | Strong radish |
| Alkaloid level | Higher | Moderate | Moderate-High |
