...
The primary pharmacologically active constituents include:

- **Parthenolide:** A sesquiterpene lactone, considered the principal active
  compound. Content ranges from 0.2% to 1.0% in dried leaf material, depending
  on cultivar and growing conditions. Parthenolide inhibits serotonin release
  from platelets and may modulate inflammatory pathways via NF-κB inhibition.
- **Flavonoids:** Including apigenin, luteolin, chrysoeriol, and their
  glycosides. These contribute antioxidant and anti-inflammatory activity.
...
opportunities for tanacetum parthenium. [[jeavons-climate-adaptation-growing-seasons]]
