...
**Classification:** Basidiomycota → Agaricomycetes → Boletales → Boletaceae → *Leccinum* → *L. aurantiacum*.

**Authority:** Originally described as *Boletus aurantiacus* by Bulliard in 1789, transferred to *Leccinum* by Gray in 1821. The species epithet refers to the orange cap coloration.

**Cap:** Convex when young, becoming broadly convex to nearly flat with age, 5–20 cm in diameter. The surface is smooth, dry to slightly tacky, and ranges from bright orange-red when fresh to brownish-orange or rust-brown in maturity. The cap cuticle does not peel easily.

**Pore surface:** White when young, aging to pale gray-olive or buff. Tubes are adnate to slightly decurrent, 8–20 mm deep. Pores are circular, 1–3 per mm. The pore surface and flesh do not stain blue when bruised — a key diagnostic feature distinguishing it from some *Boletus* species.

**Stipe:** 8–20 cm tall, 1.5–4 cm thick, clavate to cylindrical. Surface is white at the apex, covered with small dark brown to black scabers (tufts of hyphae) that darken with age. The base is often slightly bulbous. Flesh is firm and white, sometimes with a faint pinkish flush in the cap.

**Spores:** Fusiform to cylindrical, smooth, thin-walled, 14–20 × 4.5–6 µm. Spore print olive-brown.
...
The mushroom is commonly sliced and sautéed in butter, used in cream sauces, soups, and stews, or preserved by drying or pickling. Dried specimens rehydrate well and retain good flavor. Some foragers report that specimens from aspen hosts are superior in taste to those from birch.
