...
**Classification:** Kingdom Plantate → Clade Angiosperms → Clade Eudicots → Clade Asterids → Order Boraginales → Family Boraginaceae → Genus Mertensia → Species M. maritima.

The genus Mertensia contains approximately 45 species, mostly native to North America and Asia. Mertensia maritima is one of the most widespread species, with a circumpolar distribution.

The species is morphologically variable across its extensive range. Several subspecies have been described, including subsp. maritima (Eurasia) and subsp. tenella (North America).

The plant has a prostrate to ascending growth habit with succulent, glaucous blue-green stems. Leaves are ovate to obovate, fleshy, 1–4 cm long, and covered with a waxy bloom.

Flowers are borne in loose terminal cymes, each 8–12 mm long, tubular-campanulate, and pink in bud turning blue at anthesis. The calyx is deeply five-lobed and covered in fine hairs.
