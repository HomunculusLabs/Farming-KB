...
The IUPAC name is 3-[2-[methyl(propyl)amino]ethyl]-1H-indol-4-ol.

Molecular formula: **C14H20N2O**.

Molecular weight: **232.32 g/mol**.

The structure consists of an indole ring system with a hydroxyl group at the 4-position and an *N*-methyl-*N*-propyl substitution on the terminal amine of the ethylamine side chain.
...
Activity at other serotonin receptor subtypes (5-HT1A, 5-HT2C) likely contributes to its overall subjective profile.
...
As with all novel psychoactive substances, users are advised to start at the lowest effective dose.

## Synthesis

Synthesis follows established routes for 4-hydroxytryptamines, typically starting from 4-acetoxyindole or protected indole precursors.

The *N*-alkylation step introduces the methyl and propyl groups onto the terminal amine of tryptamine.

The final deprotection step removes any protecting groups from the 4-hydroxy position.

Detailed synthetic procedures are documented in TIHKAL and related chemical literature.

The compound is typically crystallized as the fumarate salt for improved stability and accurate dosing.
...
**4-HO-DMT** (psilocin) is the natural parent compound, differing by an *N*,*N*-dimethyl substitution.

**4-HO-MET** (metocin) replaces the propyl group with ethyl, producing shorter duration.

**4-HO-MiPT** (miprocin) uses an isopropyl group, offering a slightly different receptor profile.

**4-AcO-MPT** is the acetylated prodrug, metabolized to 4-HO-MPT in vivo.

**5-MeO-MPT** moves the substitution to the 5-position, producing distinct effects.
