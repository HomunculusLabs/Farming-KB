...
- **Category**: Person — Anthropologist / Ethnologist
- **Nationality**: French (born in Brussels, Belgium)
- **Field**: Structural anthropology, ethnology, mythology
- **Key work referenced**: *Structural Anthropology* (1958; English translation Doubleday Anchor, 1967)
- **Academic positions**: Chair of Social Anthropology, Collège de France (1959–1982); Lab of Social Anthropology, École Pratique des Hautes Études

## Biography

Claude Lévi-Strauss was born on November 28, 1908, in Brussels, Belgium, to French-Jewish parents. He studied law and philosophy at the Sorbonne and was deeply influenced by the geographer Marcel Mauss and the linguist Roman Jakobson, whose structural linguistics would become the model for his own approach to anthropology. During World War II, he fled Vichy France for New York, where he met Jakobson and developed the core ideas of structural anthropology. His major works include *The Elementary Structures of Kinship* (1949), *Tristes Tropiques* (1955), *Structural Anthropology* (1958), and the four-volume *Mythologiques* series (1964–1971). He died on October 30, 2009, in Paris, at the age of 100.
...
Lévi-Strauss's structural analysis of shamanic practice provides a theoretical framework for understanding the therapeutic function of psilocybin mushrooms in indigenous contexts that goes beyond simple pharmacological determinism. His work underscores that the effectiveness of psychedelic plants is not merely chemical but deeply entangled with linguistic, symbolic, and social structures. This insight has proven foundational for modern psychedelic therapy research, which increasingly recognizes that *set* (psychological state), *setting* (social and physical environment), and the therapeutic narrative framework are as important as the pharmacological agent itself.

## Sources

- Lévi-Strauss, Claude. "The Effectiveness of Symbols." In *Structural Anthropology*. Translated by Claire Jacobson and Brooke Grundfest Schoepf. New York: Doubleday Anchor, 1967, pp. 186–205.
