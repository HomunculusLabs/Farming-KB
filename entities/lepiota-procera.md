...
L. procera is a nutritious food source:

- **Protein:** Approximately 20-25% dry weight
- **Vitamins:** Rich in B vitamins, particularly niacin (B3) and riboflavin (B2)
- **Minerals:** Good source of potassium, phosphorus, and selenium
- **Fiber:** Contains dietary fiber from both the cap and stem
- **Low calorie:** Approximately 25-30 calories per 100 grams fresh weight
- **Antioxidants:** Contains ergothioneine and other antioxidant compounds
- **Vitamin D:** When exposed to UV light (like many mushrooms), can produce significant amounts of vitamin D2

## Comparison of Large Grassland Mushrooms

Several large mushroom species share grassland habitats and are commonly foraged:

| Species | Cap Size | Ring | Spore Print | Edibility | Best Use |
|---------|----------|------|-------------|-----------|----------|
