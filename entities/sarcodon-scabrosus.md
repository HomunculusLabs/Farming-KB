---
title: "Sarcodon scabrosus (Bitter Hedgehog)"
created: 2026-04-28
type: species
tags:
  - fungi
...
| Family | Bankeraceae |
| Genus | *Sarcodon* |
| Species | *S. scabrosus* (Fr.) P. Karst. |

The species was originally described as *Hydnum scabrosum* by Elias Fries in 1821, then transferred to *Sarcodon* by Petter Karsten in 1881. Some authorities have treated *S. scabrosus* as part of a species complex including *S. imbricatus* sensu lato, but molecular phylogenetics supports them as distinct taxa. The genus *Sarcodon* contains approximately 30 described species, many of which are ectomycorrhizal associates of conifers.

## Macroscopic Description

- **Cap**: 5–15 cm diameter, convex becoming depressed with age; surface dark brown to blackish-brown, covered with coarse erect to recurved scales (squamules) that expose paler flesh between them; margin incurved, sometimes wavy in mature specimens
...
- **Basidiospores**: Broadly ellipsoid to subglobose, 5.5–7.5 × 4.5–6 µm; ornamented with low, blunt tubercles connected by fine ridges forming an incomplete reticulum; brown in Melzer's reagent
