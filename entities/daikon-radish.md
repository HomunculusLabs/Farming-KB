...
- **Common names:** Daikon, white radish, Japanese radish, Oriental radish, mooli

## Key Facts

- **Deep taproot:** The daikon radish produces a thick, fleshy taproot that can penetrate 30–60 cm or more into compacted soil, effectively performing the same function as a mechanical chisel plough but without energy inputs or soil disturbance.
...
Mollison notes that Fukuoka achieved the same results as mechanical pellet seeding by pressing seed-clay mixes through a coarse sieve onto a dust-filled pan. The daikon radish represents the simplest entry point into this biological toolkit — requiring no specialised equipment or knowledge of tree establishment.

## Cultivation as Cover Crop

- **Seeding rate:** Broadcast at 5–10 kg/ha for soil conditioning purposes.
- **Planting time:** Late summer to early autumn for winter kill; spring for biomass production.
- **Growth period:** 60–90 days to full root development.
- **Termination:** Winter kill in temperate zones, mowing, or rolling in warmer climates.
- **Succession:** Plant target crop directly into decomposing root channels the following season.

## Mechanism of Action

The daikon performs soil conditioning through several simultaneous mechanisms:

1. **Physical displacement:** The growing root pushes soil particles aside, creating macropores.
