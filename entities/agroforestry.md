...
Trees, shrubs, and grasses are planted along waterways to protect water quality while producing harvestable products.

- **Functions:** Nitrate filtration, bank stabilization, sediment trapping, temperature regulation (shading streams)
- **Products:** Timber, fruit, nuts, bioenergy, ornamental plant material
- **Design:** Multi-zone approach — close-mowed grass zone near water, shrub zone, tree zone at field edge
...
- **Establishment:** Higher initial costs than monoculture ($2,000–$8,000/ha depending on system)
- **Management complexity:** Requires knowledge of multiple production systems
- **Delayed returns:** Trees may take 5–15+ years to produce marketable timber or full fruit/nut yields
- **Competition:** Trees may compete with crops for water and nutrients during establishment (can be managed through root pruning, species selection, and spacing)

### Returns

- **Diversified income:** Multiple product streams reduce economic risk
- **Long-term productivity:** Unlike monocultures, agroforestry systems can maintain productivity for decades to centuries
- **Premium markets:** Many agroforestry products (shade-grown coffee, forest-grown mushrooms) command premium prices
- **Ecosystem service payments:** Carbon credits, water quality credits, and conservation payments can supplement farm income
- **Labor distribution:** Work is spread throughout the year rather than concentrated in brief planting/harvest windows

## Global Implementation

### Scale

Approximately **1.0 billion hectares** of land globally are under some form of agroforestry practice, though many of these are traditional/de facto systems rather than formally designed agroforestry. The FAO estimates that an additional **630 million hectares** of degraded land are technically suitable for agroforestry restoration.

### Notable Programs

- **ICRAF (World Agroforestry Centre):** Based in Nairobi, Kenya; the leading global research institution for agroforestry
- **USDA National Agroforestry Center:** Promotes agroforestry adoption across the United States
- **European Agroforestry Federation (EURAF):** Advocates for agroforestry-inclusive EU Common Agricultural Policy
- **Project Drawdown:** Ranks agroforestry among the top 20 climate solutions globally
