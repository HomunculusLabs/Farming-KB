---
title: Osmotic Shock (Microbiology)
...
using sugars (molasses, honey) and salt-based amendments in compost tea.

## Classification

- **Field**: Microbiology / Cell Biology
- **Concept**: Osmotic stress on microbial cells
- **Mechanism**: Rapid water movement across semi-permeable cell membranes
  due to solute concentration gradients

## Key Facts

- Occurs when microorganisms encounter a sudden change in their external
  solute environment — either a dramatic increase (hypertonic) or decrease
  (hypotonic) in dissolved substances.
- In hypertonic conditions, water rushes out of cells, causing plasmolysis
  (cell shrinkage and potential death).
- In hypotonic conditions, water rushes into cells, potentially causing
  lysis (cell bursting).
- Many bacteria have osmoregulatory mechanisms, but rapid changes can
  overwhelm these defenses.
- Concentrated sugar solutions (honey, molasses) create hypertonic conditions
  that kill microorganisms through osmotic shock — this is why honey has been
  used as a wound treatment for millennia.
- Salt (NaCl) at high concentrations similarly kills organisms through osmotic
  effects.
...
Elaine Ingham discusses osmotic shock in the context of AACT ingredient
management:
...
- Osmotic shock is a natural mechanism of pathogen suppression that can be
  harnessed in compost tea systems.
- Beneficial organisms that are well-adapted to the tea brewing environment
  have better osmoregulatory capacity than stressed or dying pathogens.
...
- Monitor compost tea organism populations microscopically to confirm that
  food additions are supporting rather than killing beneficial organisms.
- Use unsulfured molasses — sulfured molasses contains compounds that can
