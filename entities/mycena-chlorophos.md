...
| Feature | Description |
|---|---|
| Spore shape | Ellipsoid to pip-shaped, smooth, inamyloid |
| Spore size | 7-10 x 4-5.5 µm |
| Spore wall | Thin, smooth, non-dextrinoid |
| Basidia | Clavate, 4-spored, 16-24 x 6-8 µm |
| Cheilocystidia | Cylindrical to ventricose, sometimes branched |
| Pleurocystidia | Absent or rare |
| Pileipellis | Cutis of cylindrical hyphae, 2-4 µm wide |
...
- Subtropical forests of southern Japan (Ryukyu Islands, Yakushima)
...
The species is saprotrophic, colonizing decaying twigs, leaf litter,
rotting wood, and occasionally decaying palm fronds. It fruits during the
rainy season at high humidity and warm temperatures (22-30°C). Fruitings
are often gregarious with dozens to hundreds of small fruiting bodies
appearing simultaneously. Luminescence is most visible during the first
1-2 days after expansion and fades as the mushroom matures.

## Bioluminescence Biology

The primary ecological hypothesis is that bioluminescence attracts
spore-dispersing insects at night. Studies confirm nocturnal insects are
preferentially attracted to luminous fruiting bodies compared to
non-luminous controls. Additional hypotheses include:

- **Antioxidant defense:** The luciferase reaction consumes reactive
  oxygen species, potentially protecting fungal tissues
- **Warning aposematism:** The glow may signal unpalatability to
  nocturnal herbivores
- **Circadian regulation:** Peak light emission occurs during the night
  phase even under constant darkness, regulated by endogenous clocks

The conserved caffeic acid cycle involves conversion of caffeic acid to
hispidin, oxidized by hispidin-3-hydroxylase to form the luciferin
precursor. This pathway is entirely fungal-specific and distinct from
bioluminescence systems of bacteria, dinoflagellates, cnidarians, and
fireflies.

## Cultivation and Research

M. chlorophos has been cultivated in laboratory settings using defined
...
Research applications include fungal circadian biology, the caffeic acid
bioluminescence pathway, insect-fungal interactions, luciferase reporter
gene biotechnology, and environmental monitoring.
...
| [[armillaria-mellea-entity]] | Massive rhizomorph networks; terrestrial |
