...
## Phytochemistry
Like other members of the Amaryllidaceae, *Pancratium trianthum* contains
Amaryllidaceae alkaloids — a structurally diverse class of
...
specifically has been less thoroughly characterized than that of some
related species, and further phytochemical investigation is warranted.
...
All parts of *Pancratium trianthum* are toxic, with the bulb containing
...
- **Anticancer activity** — pancratistatin and related phenanthridone
  alkaloids show selective cytotoxicity against cancer cell lines while
  sparing normal cells; pancratistatin has demonstrated activity against
  breast, colon, prostate, and pancreatic cancer cell lines in vitro
- **Antiviral activity** — several Amaryllidaceae alkaloids demonstrate
  activity against viruses including herpes simplex virus, influenza virus,
  human cytomegalovirus, and HIV
- **Acetylcholinesterase inhibition** — galanthamine, an alkaloid found
  across the Amaryllidaceae, is an approved prescription drug (Razadyne,
  Reminyl) for symptomatic treatment of Alzheimer's disease; it enhances
  cholinergic neurotransmission by reversibly inhibiting acetylcholinesterase
- **Anti-inflammatory and immunomodulatory activity** — crinine-type
  alkaloids show anti-inflammatory effects through inhibition of
  pro-inflammatory cytokines and signaling pathways
