...
- **Spore print:** White | **Spores:** Globose, smooth, 5–7 µm, amyloid
- **Ecological role:** Saprotrophic (brown rot of conifer heartwood)
...
- **Basionym:** Hydnum abietis Weinm. (1836) | **Authority:** (Weinm.) Sacc. (1888)

### Distinguishing from Congeners

| Feature | H. abietis | H. coralloides | H. erinaceus |
|---------|-----------|---------------|-------------|
| Substrate | Conifers (fir, hemlock, spruce) | Hardwoods (oak, beech) | Hardwoods (oak, walnut) |
| Branching | Multiple branches from base | Multiple branches from base | Single unbranched clump |
| Rarity | Uncommon to rare | Common | Common |
...
- **Hericenones** (aromatic compounds): Fruiting bodies; C–H detected via
...
- **Other:** Ergosterol (vitamin D₂), phenolics (antioxidant), fatty acids,
  glutamic acid (umami)
...
- **Neuroprotective:** Erinacines/hericenones cross blood-brain barrier;
  stimulate NGF synthesis in hippocampus
- **Cognitive support:** Investigated for Alzheimer's, Parkinson's,
  age-related decline (preclinical; limited trials on this species)
- **Anti-inflammatory:** Reduces TNF-α, IL-6; modulates NF-κB pathway
- **Antioxidant:** Phenolics scavenge free radicals (DPPH/ABTS confirmed)
- **Gastroprotective:** Traditional use for ulcers; shared mechanism with H. erinaceus
- **Safety:** No known toxicity; GRAS for related Hericium species

## Habitat & Ecology

- **Range:** Pacific Northwest (Alaska to California, west of Cascades);
...
- **Challenges:** Slower growth; narrow substrate specificity;
  inconsistent fruiting on artificial media
...
- **Research interest:** Alternative erinacine source for nutraceuticals;
  conservation concern due to old-growth dependency
- **Legal status:** No restrictions on foraging, cultivation, or sale in US/Canada
