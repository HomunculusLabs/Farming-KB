...
- **Flavonoids:** quercetin, kaempferol, luteolin, and their glycosides
- **Saponins:** bellericosides A and B
- **Other:** β-sitosterol, ellagitannins, and lignans

### Pharmacological Activities

**Anti-inflammatory:** Ellagitannins (chebulagic and chebulinic acid) inhibit NF-κB and COX-2 pathways in vitro.
...
**Hepatoprotective:** Pretreatment with fruit extract reduces CCl₄-induced hepatic damage in rodents, normalizing ALT and AST levels.

**Gastroprotective:** Reduces gastric acid secretion and protects mucosal lining in pylorus-ligation and ethanol-induced ulcer models.

## Traditional and Modern Uses

In **Ayurveda**, the dried fruit (bibhitaki) is classified as kapha-pitta hara (reducing kapha and pitta doshas). It is a key ingredient in Triphala, the most widely used Ayurvedic polyherbal formulation.
