...
First described by William Roxburgh and formalized by Henry Thomas Colebrooke in 1807. Closely related to [[Boswellia sacra]] (Arabian frankincense) and [[Boswellia carterii]] (Somali frankincense).

## Etymology and Common Names

- **Boswellia** — Honors Johann Boswell (1711–1780), Scottish botanist; his brother John translated botanical works.
- **serrata** — Latin *serratus* ("saw-toothed"), referring to the serrated leaflet margins.
- **Salai Guggul** — Hindi/Urdu commercial name; "Salai" = the tree, "Guggul" = resinous exudate.
...
|--------|------------------|
| South Asia | India (Rajasthan, MP, AP, Gujarat, Maharashtra, Karnataka), Pakistan |
...
|-----------|-------------------|--------------------|
| Joint pain, arthritis | Vatashamak (Vata-pacifying) | Amavata, Sandhivata |
| Respiratory disorders | Kapha-Vata hara | Shwasa (asthma), Kasa (cough) |
...
The oleogum resin contains 30–60% triterpenic acids; the boswellic acids are most pharmacologically significant:

| Compound | Abbreviation | Concentration | Key Activity |
|----------|-------------|---------------|-------------|
| 3-O-acetyl-11-keto-β-boswellic acid | AKBA | 2–8% | Potent 5-LOX inhibitor |
| 11-keto-β-boswellic acid | KBA | 3–10% | 5-LOX and elastase inhibition |
| β-boswellic acid | β-BA | 5–15% | Anti-inflammatory, cytotoxic |
| 3-O-acetyl-β-boswellic acid | Ac-β-BA | 3–12% | NF-κB pathway modulation |

AKBA is the most bioactive boswellic acid due to dual C-3 acetyl and C-11 keto substitutions, enhancing 5-LOX binding affinity.

### Essential Oil Composition

The volatile fraction (5–10% of resin) is dominated by monoterpenes:

| Constituent | Approx. % | Notes |
|------------|-----------|-------|
| α-Thujene | 20–40% | Characteristic marker |
| α-Pinene | 15–35% | Major component |
...
Boswellic acids inhibit IκB kinase (IKK), preventing NF-κB nuclear translocation and downregulating TNF-α, IL-1β, IL-6, COX-2, and MMP-9 — complementary to 5-LOX inhibition.

### Clinical Evidence Summary

| Condition | Study Type | Finding | Quality |
|-----------|-----------|---------|---------|
| Osteoarthritis (knee) | RCT (n=75) | Significant pain reduction vs. placebo at 90 days | Moderate |
| Rheumatoid arthritis | RCT (n=30) | Reduced swelling and morning stiffness | Moderate |
