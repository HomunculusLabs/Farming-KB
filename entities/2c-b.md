...
2C-B acts primarily as a serotonergic psychedelic with additional activity at other receptor systems:

- **5-HT₂A receptor**: Primary site of psychedelic action. 2C-B is a partial agonist at 5-HT₂A with high affinity (Kᵢ ≈ 0.6–2.5 nM in various assays). Activation of cortical 5-HT₂A receptors on layer V pyramidal neurons is the canonical mechanism for psychedelic visual and cognitive effects.
- **5-HT₂C receptor**: Moderate affinity agonist, contributing to anxiogenic and stimulant-like effects. 5-HT₂C activation is associated with the mild anxiety, restlessness, and body load some users experience.
- **5-HT₁A receptor**: Weak partial agonist activity, potentially contributing to anxiolytic and mood-stabilizing effects that some users report.
- **α₁-adrenergic receptor**: Moderate affinity antagonist/partial agonist, responsible for vasoconstriction, pupil dilation, and the characteristic body load.
- **TAAR1**: Trace amine-associated receptor 1 agonist, contributing to mild stimulant effects.
...
- **Serotonin syndrome**: Theoretical risk when combined with other serotonergic substances (SSRIs, MAOIs, MDMA, tryptamines). Exercise extreme caution with combinations.
- **Neurotoxicity**: No evidence of neurotoxicity at recreational doses in animal models. No persistent serotonergic deficit observed (unlike MDMA).
- **Psychological risk**: As with all psychedelics, risk of precipitating psychotic episodes in predisposed individuals, anxiety reactions, and HPPD (Hallucinogen Persisting Perception Disorder) at very low incidence.
- **Pregnancy**: No human safety data; contraindicated during pregnancy.
...
- **2C-E**: Ethyl analogue, more introspective, longer duration
- **2C-P**: Propyl analogue, much longer duration (10–16 hours)
