...
Hericenones belong to the **cyathane class** of sesquiterpenoids, a group defined by their characteristic 5/6/7-fused tricyclic carbon skeleton. The cyathane scaffold is biosynthesized via the mevalonate pathway from farnesyl pyrophosphate (FPP), followed by cyclization and extensive oxidative tailoring by cytochrome P450 enzymes.

The hericenone series includes at least nine major congeners designated **hericenones A through J**, each differing in oxidation state, side-chain modifications, and stereochemistry. Hericenones C, D, E, F, G, and H are the most abundant in fruiting bodies and have received the most pharmacological attention.

## Chemical Properties

- **Class:** Cyathane-type sesquiterpenoids
- **Core skeleton:** Tricyclo[6.3.1.0²,⁷]dodecane (cyathane)
