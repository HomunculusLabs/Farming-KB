...
The root contains a complex mixture of quassinoids, alkaloids, and other compounds:

**Quassinoids (primary bioactives):** Eurycomanone (C20H24O9, MW 408.4) is the most significant and widely used marker compound. Other quassinoids include 14,15β-dihydroxyklaineanone, eurycomalactone, eurycomanone, eurycomanol, laurycolactone A and B, and 6α-hydroxyeurycomalactone. Quassinoids are bitter-tasting compounds characteristic of the Simaroubaceae family.

**Canthine-6-one alkaloids:** 9-methoxycanthin-6-one, β-carboline-1-carboxylic acid, and 14,15β-dihydroxy-9-methoxycanthin-6-one.

**Other constituents:** Squalene derivatives (eurylene), tirucallane-type triterpenes, β-carboline alkaloids, and stigmasterol-type phytosterols. The root contains approximately 0.5-2.0% total quassinoids, with eurycomanone content ranging from 0.1-1.6% depending on source, age, and processing.

Standardized extracts are typically calibrated to 1-2% eurycomanone or 22-26% total protein content (indicative of peptide fractions). Hot water extraction is the traditional and most studied method.
