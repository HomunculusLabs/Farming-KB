...
*Aristolochia clematitis* L. was described by Linnaeus in 1753.

The genus name *Aristolochia* derives from Greek *aristos* (best) and *locheia* (childbirth), reflecting its ancient use in obstetrics.

The specific epithet *clematitis* refers to its vine-like, climbing habit.

Growth form is a twining herbaceous perennial vine reaching 30–100 cm in height.

Stems are slender, angular, and climb by twining around supports or trail along the ground.
