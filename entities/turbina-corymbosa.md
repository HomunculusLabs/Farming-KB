...
Turbina corymbosa is a large woody vine that climbs by twining around
supporting vegetation. In cultivation and in its native habitat, it
can form extensive lianas reaching considerable length into the forest
canopy. The stems are cylindrical, slightly woody at the base, and
covered with a smooth to finely pubescent bark.

Leaves are broadly heart-shaped (cordate), 2 to 3.5 in (5 to 9 cm)
long and 1 to 1.75 in (2.5 to 4.5 cm) wide. The leaf blade is entire
or slightly undulate at the margins, with a prominent basal sinus.
The upper surface is smooth and dark green, while the lower surface
is paler. Petioles are slender, 1 to 2.5 in (2.5 to 6 cm) long.

The inflorescence consists of many-flowered cymes borne on short
peduncles. Each flower is subtended by small, ovate bracts. The
calyx is composed of five sepals, broadly ovate and slightly unequal.

The corolla is bell-shaped (campanulate), 0.75 to 1.5 in (2 to 4 cm)
long, white with conspicuous greenish stripes on the exterior. The
five petals are fused into a funnel, and the flower opens in the
morning, closing by afternoon. Stamens are five, inserted near the
base of the corolla tube, with filaments of unequal length.

The fruit is a dry, indehiscent, ellipsoidal capsule enclosed by
persistent and enlarged sepals. Each fruit bears a single hard,
roundish seed approximately 0.25 in (5 to 6 mm) in diameter. The seed
surface is smooth, brown to dark brown, and highly durable, which
likely contributes to its longevity and its role in ritual contexts.

## Distribution and Habitat

Turbina corymbosa is native to the tropical zones of the Americas,
with its primary distribution centered on Mexico and Cuba. It occurs
in tropical and subtropical forests, often climbing along forest edges,
