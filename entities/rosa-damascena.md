...
Kingdom: Plantae — Order: Rosales — Family: Rosaceae — Genus: Rosa — Species: R. damascena Mill.

The species was first formally described by Philip Miller in 1768, though the plant had been cultivated for centuries prior. Its hybrid origin complicates taxonomic classification.

**Growth habit.** R. damascena forms an upright, multi-stemmed shrub reaching 1.5–2.5 meters in height and spread.

Stems are armed with abundant prickles (thorns), which are stout, curved, and paired at the nodes. The bark is smooth and green on young growth, becoming grey-brown with age.

**Leaves** are pinnately compound with 5–7 leaflets per leaf. Leaflets are oval, 2–5 cm long, serrated along the margins, and glabrous to slightly pubescent beneath.
...
Yields average 3,000–4,000 kg of fresh flowers per hectare, producing approximately 1 kg of rose oil (0.03% yield by weight).

Propagation is through softwood cuttings, hardwood cuttings, or suckers. Own-root plants are preferred in commercial production to avoid graft incompatibility.
