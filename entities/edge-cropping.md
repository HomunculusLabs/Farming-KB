...
Mollison identifies six possible interaction outcomes when two systems share a boundary:
1. No effect on either (0,0)
2. One benefits at the other's expense (+,-)
3. Both benefit (+,+)
4. Both decrease (-,-)
5. One benefits, other unaffected (+,0)
6. One decreases, other unaffected (-,0)

For incompatible pairs showing (-,-) interactions, an intervening compatible component can be placed between them to nullify the conflict.

## Source Reference

Bill Mollison, *Permaculture: A Designer's Manual*, Chapter 4 — Edge Cropping (pp. 91-93), Figure 4.10.
