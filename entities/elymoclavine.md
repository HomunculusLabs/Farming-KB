...
- **IUPAC name:** (8R)-9,10-didehydro-6-methyl-8-[(1S,2S)-1-
  hydroxypropan-2-yl]ergoline
- **CAS number:** 3131-44-6
- **Appearance:** White to off-white crystalline powder
- **Solubility:** Soluble in ethanol, methanol, chloroform; sparingly
  soluble in water
...
The compound is optically active with a specific rotation of [α]D =
+130° (chloroform). It forms salts with common acids; the hydrochloride
salt is the most commonly encountered form in laboratory settings.
...
receptors and affinity for α₂-adrenergic receptors. These contribute
to its mild sympatholytic and anxiolytic effects at sub-psychedelic
doses.

The compound displays uterotonic activity similar to other ergot
alkaloids, stimulating smooth muscle contraction in the uterus. This
property was historically exploited in obstetric medicine before the
development of more specific ergot derivatives such as methylergometrine.
