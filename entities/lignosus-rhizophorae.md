...
**Classification:** Basidiomycota → Agaricomycetes → Polyporales → Polyporaceae → **Lignosus** → **L. rhizophorae**.

Authority: (Murrill) Ryvarden.

The basidiocarp is pileate, with a fan-shaped to semicircular cap measuring 20–60 mm in diameter.

The upper surface is buff to pale brown, with a finely tomentose to glabrous texture that becomes zonate with age.

The pore surface is white to cream, with circular to angular pores numbering 4–6 per mm.

The context is corky and white, with a distinctly tuberculate stipe base that connects to the underground sclerotium.

Basidiospores are cylindrical to allantoid, hyaline, smooth, and measure 6–8 × 2–3 μm.

The sclerotium is the most distinctive feature, forming a hard, irregularly spherical mass 15–50 mm in diameter.

Sclerotia are dark brown to black externally and white-cream internally, with a dense, starchy consistency.
...
Fruiting occurs during the wet season, typically from October to March, when humidity exceeds 85%.

The underground sclerotium allows survival during dry periods and may persist for several years in the soil.

## Bioactive Compounds and Pharmacology

The sclerotium of L. rhizophorae contains significant quantities of (1→3)-β-D-glucans and (1→3)(1→6)-β-D-glucans, which are the primary immunomodulatory constituents.

Protein-bound polysaccharides isolated from the sclerotium have demonstrated macrophage activation and stimulation of pro-inflammatory cytokine production in vitro.
...
The species also contains ergosterol, ergothioneine, and phenolic acids (gallic, protocatechuic) that contribute to its overall bioactivity profile.
...
opportunities for lignosus rhizophorae. [[jeavons-climate-adaptation-growing-seasons]]
