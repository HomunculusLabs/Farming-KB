...
**Cryptoporus volvatus** (Peck) Shear, commonly known as the **veiled polypore** or **Pacific veiled polypore**, is a distinctive wood-decay fungus in the family Polyporaceae. It is most notable for the membranous veil that completely covers its pore surface — a feature unique among North American polypores.

The species is primarily a saprotroph on recently killed or dying conifers, especially pines killed by bark beetles. Its closed pore surface is an adaptation that helps retain moisture, allowing the fungus to fruit in dry conditions.

## Taxonomy and Morphology

**Classification:** Kingdom Fungi → Phylum Basidiomycota → Class Agaricomycetes → Order Polyporales → Family Polyporaceae → Genus *Cryptoporus* → Species *C. volvatus*.

**Synonyms:** *Polyporus volvatus* Peck (1875, original basionym), *Fomes volvatus* (Peck) Cooke (1885), *Cryptoporus volvatus* (Peck) Shear (1902).

The genus *Cryptoporus* is monotypic — *C. volvatus* is its sole species.

**Cap:** Convex to kidney-shaped, 2–10 cm broad, 1–3 cm thick. Surface is whitish to cream when young, aging to buff or pale tan. The margin is rounded and inrolled.

The cap surface is smooth or slightly velvety, sometimes with radial wrinkles near the attachment point. It feels firm and corky when fresh, becoming harder and more brittle as it dries.
...
Fruiting occurs singly or in small clusters on standing dead trunks, fallen logs, and large branches. The fruiting season is primarily late spring through autumn.
...
The relationship with bark beetles is semi-mutualistic. Beetles vector the fungus to new hosts, and the fungus may help create favorable conditions by weakening tree defenses during the initial attack phase.

## Bioactive Compounds

Research on *Cryptoporus volvatus* has identified several bioactive metabolites. Polysaccharides extracted from the fruiting body have demonstrated immunomodulatory properties in vitro, including stimulation of macrophage activity and cytokine production.
...
*Cryptoporus volvatus* is not considered edible. The flesh is tough and corky, and the enclosed pore surface gives it an unappealing texture. There are no documented cases of toxicity, but it is simply not palatable.

The species is occasionally confused with young specimens of *Ganoderma* species or other pore fungi, but the distinctive veil makes identification straightforward once the feature is recognized.
