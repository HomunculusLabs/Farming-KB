...
The Egyptian mystery schools gave birth to the Rosicrucians, Freemasons, Knights Templar, and other orders. These later societies perpetuated the initiatory systems, although in degraded form — replacing the actual pyramid with a room, and the sarcophagus with a simple coffin.
