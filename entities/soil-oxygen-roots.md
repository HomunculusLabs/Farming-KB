---
title: Soil Oxygen and Root Respiration
...
Soil oxygen is a critical and often overlooked requirement for plant growth. Plant roots are living tissues that must respire (breathe) continuously, consuming oxygen and producing carbon dioxide. Unlike leaves, roots cannot photosynthesize and cannot produce their own oxygen. They depend entirely on air spaces in the soil for their oxygen supply. Since oxygen cannot travel from leaves to roots through the plant, root oxygen must come from the surrounding soil atmosphere.
...
- **Root respiration:** Roots are living tissue that must breathe oxygen to survive; they cannot photosynthesize
- **No internal oxygen transport:** Oxygen produced by leaf photosynthesis cannot travel down to the roots
- **Root CO2 output:** Like other carbon-burning organisms, roots breathe out carbon dioxide as waste
- **Soil structure dependence:** Soil particles have spaces between them that hold both air and water; the ratio determines oxygen availability
- **[[clay-soil]] problem:** Clay soils contain little air due to tiny, closely packed particles
- **Tilth connection:** Good soil structure (tilth) maintains adequate pore space for both air and water
- **Compaction impact:** Soil compaction eliminates air spaces, suffocating roots
- **Organic matter role:** Creates and maintains soil pore spaces, improving both aeration and water retention
- **Photosynthesis vs. respiration:** During daytime, leaves produce sugar and release oxygen. At night, the entire plant must respire, consuming oxygen.

## The Oxygen Paradox

| Time | Leaves | Roots |
|---|---|---|
| Day | Produce O2 via photosynthesis | Consume O2 via respiration |
| Night | Consume O2 via respiration | Consume O2 via respiration |

Roots never produce oxygen. They always consume it.
