...
Isoproscaline has seen limited recreational use compared to more widely known phenethylamines. It remains primarily a research chemical with few formal pharmacological studies beyond Shulgin's original self-experimentation and qualitative reports.

## Chemical Properties

**IUPAC name:** 2-(3,5-dimethoxy-4-isopropoxyphenyl)ethan-1-amine.

**Molecular formula:** C₁₃H₂₁NO₃.

**Molecular weight:** 239.31 g/mol.

**Structure:** Phenethylamine backbone with methoxy substituents at positions 3 and 5 of the aromatic ring, and an isopropoxy group at position 4. This substitution pattern places it in the dimethoxyalkoxyphenethylamine (DOX/2C-X) structural class.

The isopropoxy side chain (O–CH(CH₃)₂) at the 4-position is larger and more sterically hindered than the ethoxy group of proscaline or the methoxy group of mescaline. This increased steric bulk is generally associated with higher potency and longer duration among phenethylamine psychedelics.

The compound exists as a free base or as a crystalline hydrochloride salt. The hydrochloride salt is stable at room temperature and soluble in water and ethanol.
