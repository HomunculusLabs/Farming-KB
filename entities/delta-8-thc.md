...
- **Analgesic**: Moderate pain-relieving properties through CB1/CB2 pathway modulation
- **Neuroprotection**: In vitro studies suggest antioxidant and neuroprotective properties
- **Anti-inflammatory**: CB2 receptor engagement mediates anti-inflammatory responses

## Production and Synthesis

### Natural Extraction

Natural Δ⁸-THC is present in cannabis at concentrations too low (typically < 0.1%) for economical extraction. Selective breeding has produced cultivars with slightly elevated Δ⁸-THC levels, but natural sourcing remains impractical for commercial production.
...
- [[tetrahydrocannabinol-thc]] — Delta-9-THC, the primary psychoactive cannabinoid
