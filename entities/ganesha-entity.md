---
title: GANESHA (2,5-Dimethoxy-3,4-dimethylamphetamine)
created: 2026-04-16
updated: 2026-04-16
type: entity
tags: [psychedelics]
...
- DOM: 3-10 mg, 8-12 h -- more potent, shorter, more stimulating

- 2C-G (phenethylamine homologue): 20-35 mg, 18-30 h -- nearly identical potency

- 2C-G-5 (benzonorbornane): 10-16 mg, 32-48 h -- more potent, much longer

- DOI: 1.5-3 mg, 12-24 h -- far more potent, different substitution

- DOB: 1-3 mg, 18-30 h -- far more potent, bromine at 4-position

The relationship between GANESHA and 2C-G is the most pharmacologically significant comparison, as these two compounds demonstrate that the alpha-methyl group of the amphetamine chain provides no potency advantage in this particular substitution pattern.

## Harm Reduction and Safety Considerations

- The 18-24 hour duration requires significant advance planning

- The "rolling +++" quality suggests the experience intensifies over time; do not assume a stable plateau

- The back spasm reported at 32 mg indicates potential musculoskeletal effects; users with back conditions should be cautious

- The long duration increases risk of sleep deprivation and associated cognitive impairment

- Re-dosing is strongly discouraged

- The tranquil character of the experience could potentially mask physical distress; regular self-checks for comfort and wellbeing are advisable

- Food and hydration should be planned for the full duration
