...
Golden Teacher mushrooms are medium to large in size relative to other *P. cubensis* strains.
The cap (pileus) is 25–80 mm in diameter, broadly convex to plane at maturity, with a pronounced central umbo in young specimens that may flatten or become slightly depressed with age.
The cap surface is smooth and golden-brown to caramel-brown when fresh, often with a slight metallic sheen when viewed in direct light, becoming lighter straw-yellow as the mushroom dries.
The cap margin is typically even and may retain fragments of the partial veil in young specimens, forming a characteristic appendiculate margin.

The gills are adnate to adnexed, close to subdistant, and grayish-white when young, darkening progressively to dark purplish-brown to nearly black as the spores mature.
The stipe (stem) is 60–150 mm long and 5–12 mm thick, solid, fleshy, and white to pale cream in color, often bruising bluish where handled or damaged.
The bluing reaction is moderate in intensity compared to more potent strains and typically develops within 30–60 seconds of tissue disturbance.
...
Golden Teacher is classified as a moderate-potency *P. cubensis* strain.
Typical tryptamine content ranges from 0.5–0.9% psilocybin and 0.1–0.3% psilocin by dry weight, with baeocystin and norbaeocystin present in trace amounts.
These concentrations place Golden Teacher firmly in the mid-range of *P. cubensis* potency — significantly less potent than woodloving species like *P. azurescens* or *P. cyanescens*, but comparable to or slightly above the average for *P. cubensis* as a species.
Potency can vary considerably depending on growing conditions, substrate composition, harvest timing, and post-harvest handling.
...
Golden Teacher performs well on a variety of grain substrates, with rye grain and brown rice flour being the most commonly recommended for first-time cultivators.
The strain shows a preference for substrates with moderate to high nitrogen content, which supports robust mycelial growth and larger fruit body development.
Supplementation of bulk substrates with gypsum (calcium sulfate) at 5–10% by volume has been reported to improve yield consistency and reduce the incidence of overlay and stromata formation.
The optimal pH range for colonization and fruiting is 6.0–7.0, with the strain showing reduced vigor at pH values below 5.5.

The strain's fruiting requirements are typical for *P. cubensis*: temperatures of 22–25°C, relative humidity above 90%, adequate fresh air exchange to maintain CO₂ levels below 800 ppm, and indirect light in the 6500K (daylight) spectrum for 12 hours per day.
Golden Teacher is somewhat less sensitive to temperature fluctuations than some other strains, and has been successfully fruited at ambient temperatures ranging from 18–28°C, though yields are reduced at the extremes of this range.

## Spore Characteristics and Storage

Golden Teacher spores are viable for 12–18 months when stored under refrigeration (2–4°C) in a dark, dry environment, with gradual loss of germination rate over time.
For long-term preservation, spore syringes can be frozen at -20°C in a glycerol solution, which extends viability to several years.
