...
*Geosiphon pyriforme* is a unique fungal species in the phylum Zygomycota that does not form mycorrhizal associations with plants, but instead engages in a mutualistic symbiosis with photosynthetic *Nostoc* cyanobacteria. The fungus serves as the physical host for the cyanobacteria, representing an unusual reversal of the typical mycorrhizal relationship. Phylogenetic analyses of 18S ribosomal DNA sequences have revealed that *G. pyriforme* is more closely related to certain arbuscular mycorrhizal (AM) fungi than to other zygomycetes.
...
- The page title is Geosiphon pyriforme.
...
- Existing wikilink already present on this page: [[geosiphon-pyriforme-endosymbiosis]].
