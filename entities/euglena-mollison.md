...
- One of four universal sewage lagoon algae, alongside Chlamydomonas, Chlorella, and Scenedesmus
- Possesses both plant-like (photosynthetic) and animal-like (motile) characteristics
- Contains chloroplasts for photosynthesis but can also feed heterotrophically
- Moves using a single flagellum, allowing it to position itself optimally in the water column
- Fixes carbon through photosynthesis, releasing oxygen that supports aerobic bacteria in treatment ponds
...
1. **Anaerobic ponds**: Few Euglena present; dominated by sulphur-loving bacteria
...
Euglena and related phytoplankton have several applications in cultivation and permaculture:

- **Wastewater treatment**: Essential component of biological sewage treatment lagoons
- **Algal protein production**: Can be harvested and processed as high-protein animal feed
- **Biogas systems**: Algal biomass contributes to methane production in anaerobic digesters
- **Water quality monitoring**: Presence and abundance indicate nutrient levels in water bodies
