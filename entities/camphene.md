...
Camphene has been used historically in traditional medicine systems and continues to be investigated for modern pharmaceutical and nutraceutical applications. Its chemical structure features a bicyclo[2.2.1]heptane ring system, distinguishing it from the more common monocyclic monoterpenes like limonene and terpinolene.
...
- **CAS number:** 79-92-5
- **IUPAC name:** 2,2-dimethyl-3-methylidenetricyclo[2.2.1.0²,⁶]heptane
- **Structure:** Bicyclic monoterpene (bicyclo[2.2.1]heptane skeleton); structural isomer of α-pinene
- **Physical state:** Colorless crystalline solid at room temperature; melts to a colorless liquid
- **Melting point:** 48–51°C
- **Boiling point:** 159–161°C
- **Density:** 0.842 g/cm³ (at 54°C, liquid state)
- **Solubility:** Insoluble in water; soluble in ethanol, ether, and fixed oils
- **Optical activity:** Chiral molecule; (+)-camphene and (−)-camphene enantiomers exist in nature

Camphene is structurally related to α-pinene, differing in the position of the exocyclic double bond. This subtle structural difference results in distinct olfactory properties and pharmacological profiles. Camphene is more stable than many other monoterpenes against oxidation, contributing to the shelf stability of essential oils that contain it.
...
Camphene exhibits several pharmacological properties supported by preclinical evidence, though clinical studies in humans remain limited.

**Antioxidant activity:** Camphene demonstrates significant free radical scavenging activity in DPPH and ABTS assays. It reduces lipid peroxidation in cell membranes and protects against oxidative stress-induced cellular damage. The antioxidant mechanism involves direct radical neutralization and upregulation of endogenous antioxidant enzyme systems (SOD, catalase, GPx).

**Cardiovascular effects:** Camphene has been shown to reduce plasma cholesterol and triglyceride levels in animal models of hyperlipidemia. The proposed mechanism involves inhibition of cholesterol biosynthesis at the HMG-CoA reductase step, similar to statin drugs but through a different binding site. This lipid-lowering activity is considered one of camphene's most promising pharmacological properties.

**Anti-inflammatory activity:** Suppresses pro-inflammatory mediator production including TNF-α, IL-6, and prostaglandin E₂ in LPS-stimulated macrophage models. Topical application reduces carrageenan-induced paw edema in rodents.

**Antimicrobial effects:** Exhibits moderate antibacterial activity against Gram-positive bacteria and antifungal activity against Candida species. The mechanism involves disruption of microbial cell membrane integrity.

**Analgesic properties:** Produces antinociceptive effects in thermal and chemical pain models in rodents, partially mediated through interaction with TRP ion channels (TRPV1, TRPA1, TRPM8).
...
Camphene serves as a precursor in organic synthesis and has several industrial applications.

It is used in the production of synthetic camphor, flavor additives, and fragrance compounds. In perfumery, camphene contributes pine and forest notes to conifer-themed compositions and fougère fragrances.
