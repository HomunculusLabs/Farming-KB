...
- **Category:** Place — Historical wetland / Land reclamation zone
- **Location:** Lazio region, central Italy, between the Alban Hills and the sea
...
- The Pontine Marshes had been a malarial wasteland since Roman antiquity; multiple attempts to drain them over 2,000 years had largely failed.
- Mussolini's reclamation project in the 1930s combined massive engineering works (canals, pumps, dikes) with extensive eucalyptus plantings to biologically pump water from the saturated soils.
- A single large evergreen tree such as *Eucalyptus globulus* may pump out 3,600-4,500 liters of water per day through transpiration.
- At approximately 60 eucalyptus trees per hectare, many tens of thousands of liters of water per hectare per day were returned to the atmosphere.
- The reclamation converted the marshes into productive agricultural land and established new towns (Latina, Sabaudia, Aprilia, Pomezia, Pontinia).
...
- **Biological drainage engineering:** Mollison uses this example to show that trees can replace pumps for moving water, a core permaculture principle — using biological solutions instead of mechanical ones wherever possible.
- **Wetland-to-agriculture conversion:** While ecologically destructive by modern standards, the project demonstrates the scale at which tree-based water management can transform landscapes, relevant for smaller-scale permaculture water management.
- **Eucalyptus as water pump:** The species' extraordinary transpiration rate makes it useful for sites where biological drainage is needed (waterlogged soils, high water tables), but also dangerous near water features that should be conserved.
...
- Caprotti, F. "Mussolini's Battle for Grain." *Journal of Historical Geography*.
- Davis, J. "Land Reclamation in the Pontine Marshes." *Geographical Review*.
