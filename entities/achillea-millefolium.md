...
Yarrow has one of the longest recorded histories of medicinal use among European herbs, dating to Achilles of Greek mythology (who reputedly used it to treat soldiers' wounds). Key pharmacological actions include:

- **Hemostatic:** Promotes blood clotting; traditionally applied to wounds and nosebleeds
- **Anti-inflammatory:** Contains sesquiterpene lactones and flavonoids (apigenin, luteolin)
- **Antispasmodic:** Relieves menstrual cramps and gastrointestinal spasms
- **Diaphoretic:** Induces sweating in fevers; traditional cold/flu remedy
- **Bitter tonic:** Stimulates digestion via bitter principles (achilleine)
...
- **Copper (Cu):** Notably high copper content in leaf tissue
...
- **Insectary plant:** Flat flower heads provide landing platforms for predatory insects (syrphid flies, lacewings, ladybird beetles, parasitic wasps) that control aphids and other pests
- **Compost activator:** Yarrow leaves added to compost piles speed decomposition and add minerals
- **Companion planting:** Reported to enhance essential oil production in neighboring aromatic herbs
- **Ground cover / erosion control:** Dense clumps stabilize soil on slopes and in orchard understories
...
- Major nectar and pollen source for butterflies, native bees, and beneficial insects
