...
Several subspecies are recognized: *subsp. incanus* (typical), *subsp. creticus* (eastern Mediterranean), *subsp. corsicus* (Corsica), and *var. canescens*. The epithet *incanus* (Latin: "grey") refers to the dense grey-white indumentum on leaves and stems. The taxonomy is complex and some authorities treat certain subspecies as separate species. The genus *Cistus* contains approximately 20 species, all native to the Mediterranean region.

## Botanical Description

*Cistus incanus* is an evergreen shrub reaching 0.5–1.5 m in height, occasionally 2 m, with an erect to spreading habit and numerous branches arising from a woody base. The plant is notably resinous, producing the aromatic substance **ladanum** (labdanum).

### Leaves
Opposite, 2–5 cm long and 0.8–2 cm wide, lanceolate to elliptic-lanceolate. The upper surface is dark green with rough stellate hairs (scaly trichomes); the lower surface is densely grey-white tomentose, giving the plant its characteristic silvery appearance. Leaves are leathery (coriaceous), an adaptation to the hot, dry Mediterranean climate. Leaf margins are entire or slightly revolute.

### Flowers
Showy, 4–7 cm in diameter, arranged in terminal clusters of 2–8 from April to June. Each flower has five pink to purplish-pink petals that are crumpled in bud and expand fully in sunlight, often with a darker spot at the claw. Numerous yellow-orange stamens create a striking contrast with the pink petals.
...
- **Mycorrhizal host:** Supports truffle-producing fungi (*Tuber* spp.)
- **Soil stabilization:** Prevents erosion on steep, rocky slopes
...
Several other *Cistus* species are notable for their own properties:

- ***Cistus ladanifer*** — Rockrose, the primary commercial source of labdanum resin. Larger flowers with distinctive dark red spots at the petal base. Native to the western Mediterranean.
- ***Cistus salvifolius*** — Sage-leaved rockrose, with leaves resembling those of sage. More cold-tolerant than *C. incanus* and found at higher elevations. Used similarly in folk medicine.
- ***Cistus creticus*** — Cretan rockrose, closely related to *C. incanus* and sometimes considered conspecific. Also shows high polyphenol content and antiviral activity.
- ***Cistus monspeliensis*** — Montpellier cistus, a smaller species with narrow leaves. Highly flammable and considered a fire hazard in some regions.
- ***Cistus parviflorus*** — Small-flowered rockrose, the most cold-hardy species in the genus, surviving in USDA zone 7.
