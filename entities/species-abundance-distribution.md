...
- Rank-abundance plots (Whittaker plots) are the standard graphical representation

## Relevance to Cultivation and Mycology

Species-abundance distributions are fundamental for understanding fungal community structure in cultivation. They can characterize substrate microbial ecology, revealing whether communities are dominated by few species (suggesting instability) or are diverse and balanced (suggesting mature communities). Zak (1988, 1992) found geometric/log-series models described rhizoplane fungal assemblages, while Lussenhop (1981) showed lognormal distributions characterized forest soil fungal communities. These patterns help cultivators understand ecological status of substrates and growing environments.
