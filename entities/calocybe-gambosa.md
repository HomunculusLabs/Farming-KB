...
| Feature | Description |
|---------|-------------|
| Spores | Elliptical, smooth, 5–7 × 3.5–5 µm |
| Basidia | Clavate, 4-spored, 22–28 × 5–7 µm |
| Cheilocystidia | Variable, cylindrical to ventricose |
| Pleurocystidia | Absent |
| Hyphal system | Monomitic, clamp connections absent |

## Distribution and Habitat

- **Range:** Widespread across Europe, North Africa (Morocco, Algeria),
  western Asia (Turkey, Caucasus).
- **Habitat:** Unimproved grasslands, permanent pastures, meadows,
  old lawns, churchyards, road verges.
...
| Component | Value (per 100 g fresh) | Significance |
|-----------|------------------------|-------------|
| Protein | 2.5–3.5 g | Good fungal protein source |
| Carbohydrates | 3–5 g | Chitin and glycogen |
