...
Buds are medium-sized with a dense, rounded structure typical of indica-dominant genetics. The calyx-to-leaf ratio is high, with minimal visible foliage even before trimming.

Coloration is predominantly deep forest green with occasional purple highlights, particularly when exposed to cooler nighttime temperatures during late flowering. Pistils are sparse but vivid orange-amber.

Trichome coverage is exceptional, giving buds a thick, frosty appearance. The resin is notably sticky and viscous, a trait inherited from the Han Solo Burger lineage. Under magnification, trichome heads are large and bulbous, indicating high terpene content.

## Aroma and Flavor

Donny Burger's aroma is immediately distinctive — a pungent blend of savory cheese, grilled onions, and diesel fuel, underlaid with earthy and slightly sweet notes. The GMO-influenced savory character is the dominant aromatic signature.

On the exhale, the flavor reveals additional complexity: garlicky umami, sour citrus, and a lingering peppery finish. The smoke is thick and expansive, with a lingering aftertaste that matches the aroma.

The strain is not for consumers who prefer sweet or fruity profiles. Its bold, savory character is reminiscent of pungent cheeses and grilled meats, making it one of the more unusual terpene expressions in modern cannabis.

**Dominant terpenes:**
- **Caryophyllene** (~1.0–1.5%) — peppery, woody, anti-inflammatory
- **Limonene** (~0.5–0.9%) — citrus, mood elevation
- **Myrcene** (~0.8–1.2%) — earthy, sedative
- **Humulene** (~0.4–0.7%) — woody, hop-like
- **Pinene** (trace) — pine, bronchodilator

## Cannabinoid Profile and Effects

**THC content:** 22–30% (lab-verified). **CBD content:** Below 0.1%, negligible. Some phenotypes may also contain trace amounts of CBG.

The onset begins with a mild cerebral uplift that is quickly overtaken by heavy, wave-like body relaxation. Users report a warm, numbing sensation spreading from the head downward, accompanied by a sense of physical heaviness.
...
Donny Burger is considered moderately difficult to cultivate, best suited to experienced growers comfortable with nutrient-intensive, high-THC genetics.

**Flowering time:** 8–9 weeks indoors. **Yield:** Moderate (350–450 g/m² indoors). Plants exhibit moderate stretch during early flowering.
