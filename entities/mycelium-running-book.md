...
type: entity
tags: [book, mycology, paul-stamets, cultivation, remediation]
---
...
- **Type**: Book
- **Author**: Paul Stamets
- **Publisher**: Ten Speed Press (Berkeley/Toronto)
- **Publication date**: October 15, 2005
- **ISBN**: 1580085792
- **Subject**: Mycology, ecological restoration, mushroom cultivation

## Key Facts

- Subtitle: "How Mushrooms Can Help Save the World"
- Devotes a full chapter to "mycoforestry" — matching native fungi to native tree species for forest restoration.
- Introduces the concept of inoculating wood chips from chainsaws and chippers by mixing spores into the bar oil.
...
*Mycelium Running* is one of the most influential books in modern mycology, directly inspiring practical cultivation approaches including:
- Using wood chips as mushroom substrate for forest restoration
- Matching fungal species to native tree species
- Inoculating logging debris with fungal spores
- Using myceliated substrates for erosion control
- Integrating mushroom cultivation with forestry operations

The book bridges the gap between ecological theory and practical cultivation, providing cultivators with techniques that serve both production and ecological restoration goals.
...
Ongoing research continues to expand understanding of Mycelium Running Book.
