...
- **Order:** Boletales
- **Family:** Boletaceae
- **Genus:** Boletus / Xerocomus
- **Species:** B. subtomentosus
- **Authority:** L.

## Morphology

- **Cap:** 5-15 cm diameter, convex to flat; surface dry and velvety-tomentose; olive-brown to yellowish-brown, sometimes cracking with age
- **Pore surface:** Yellow, becoming olivaceous with age; bruises blue-green when pressed
...
- Cap is olive-brown with a distinctive velvety/tomentose texture (hence the specific epithet "subtomentosus")
- Pore surface is yellow; may bruise blue-green when pressed or cut
- Mycorrhizal with both hardwood and coniferous trees, especially oaks and pines
- Generally considered edible but of variable quality; best when young and firm
- Shows a marked acid reaction under litmus paper testing when waterlogged
- When heavily charged with water from dew or rain, the spongy substance undergoes acidulous fermentation
- During fermentation, the mushroom exhibits brilliant blue coloration when pressed, cut, or broken
- Specimens in this fermented state can cause gastrointestinal illness despite being the same species that is safe when fresh and firm
- Only young specimens with substance too solid to admit of fermentation should ever be eaten

## Historical Context

Julius A. Palmer identified B. subtomentosus (his "sud-tomentosus," called the "olive-red Boletus" in Peck's catalogue) as the specific boletus responsible for cases of illness. He had personally eaten "some bushels" of the plant safely, but became ill from specimens plucked from the very same matrix (growing location) when they had become waterlogged and fermented.

Palmer demonstrated the chemical change using litmus paper, showing the mushroom developed a marked acid reaction when saturated with water. This was one of the first documented cases showing that an esculent (edible) species could become harmful through chemical decomposition rather than inherent toxicity — a crucial distinction for foragers. Three cases of illness from this cause were brought to Palmer's attention almost simultaneously, though none resulted in anything more serious than purging and vomiting.
...
This entry provides reference information about boletus subtomentosus and its significance in its respective field.
