...
More than seven hundred named species have been described, and estimates of total diversity are substantially higher.
Members of the genus are best known for producing the earthy odor molecule geosmin and a large share of medically important antibiotics.
...
Streptomycetes are used as hosts for natural product discovery and heterologous expression of biosynthetic gene clusters.
Their secretion capacity and high-GC genomes make them useful but technically different from *Escherichia coli* or yeast systems.
Genome mining often reveals silent or cryptic clusters that do not express under standard laboratory conditions.
Researchers activate these clusters by changing culture conditions, manipulating regulators, co-culturing microbes, or cloning clusters into engineered hosts.
The genus is therefore central to antibiotic discovery, chemical ecology, and synthetic biology.
Industrial work must manage slow growth, morphological differentiation, and strain instability compared with simpler bacterial production hosts.
