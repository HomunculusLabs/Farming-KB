...
Eugenol is classified as a minor terpenoid in cannabis, generally found at trace levels ranging from 0.01% to 0.1% of the essential oil fraction in select strains. Its presence contributes a subtle spicy, warm, and slightly woody aroma that complements the broader terpene bouquet.

Within the entourage effect framework, eugenol's TRPV1 receptor agonism and anti-inflammatory
activity may synergistically enhance the therapeutic profile of cannabinoid-dominant formulations,
particularly those targeting pain and inflammation.

Strains with detectable eugenol are often described as having a "peppery" or "herbal-spice"
character. While not a dominant contributor to the cannabis aroma, eugenol's pharmacological
activity at low concentrations aligns with the broader principle that minor cannabinoids and
terpenes meaningfully modulate overall therapeutic outcomes.

Analytical detection of eugenol in cannabis is typically performed via gas chromatography-mass
spectrometry (GC-MS), where it is identifiable by its characteristic mass fragment pattern
and retention index. Its presence, even at trace levels, can serve as a chemotaxonomic marker
for certain cultivar groupings.

## Pharmacology

Eugenol exerts its biological effects through multiple molecular targets:
...
Eugenol is rapidly absorbed following oral, topical, or inhalation administration. It undergoes extensive hepatic metabolism, primarily through demethylation (O-demethylation to yield catechol derivatives) and allylic hydroxylation. The primary metabolic pathway involves cytochrome P450 enzymes, particularly CYP2E1 and CYP1A2. Metabolites are conjugated with glucuronic acid or sulfate and eliminated via renal excretion.

The plasma half-life is relatively short, typically 1–2 hours, reflecting efficient first-pass metabolism. Topical application allows for localized effects with minimal systemic absorption. Bioavailability varies by route of administration, with oral bioavailability reduced substantially by first-pass hepatic clearance.
