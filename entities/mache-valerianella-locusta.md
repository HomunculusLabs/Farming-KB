---
title: Mache (Valerianella locusta)
source: eliot-coleman-winter-harvest-handbook.md
type: entity
tags: [species, vegetable, cold-hardy, winter-crop, valerianaceae, salad-green]
---
...
Mache is among the most cold-tolerant of all salad greens:
- Survives temperatures well below freezing when protected from wind
- Continues slow growth even during the shortest winter days (below 10 hours)
- Flavor and texture improve with cold exposure; leaves become sweeter and more tender
- Harvestable throughout the entire winter in both cold houses and cool houses
- In Coleman's system, shows continuous harvest from October through May
...
|-----------|---------------|
| Cold House | October through May (continuous) |
| Cool House | October through May (continuous) |

Mache is one of the few crops showing uninterrupted harvest availability across the entire winter in both cold and cool houses.

## Culinary Qualities

- **Flavor**: Nutty, slightly sweet, mild
- **Texture**: Tender, buttery leaves
- **Use**: Typically served as a salad green, often as the base or sole ingredient
- **Quality Peak**: Fall, winter, and spring; heat stress in summer degrades quality
- **Market Value**: Commands premium prices as a specialty salad green
- **Pairing**: Combines well with claytonia and minutina in winter salad mixes

## Growing Requirements

- **Light**: Very low; far lower requirements than warm-season crops
- **Temperature**: Prefers cool to cold; ideal 45-65F (7-18C)
...
- **Mache**: French common name
- **Corn salad**: English name (historically grew as a weed in corn fields)
...
| Fact | Detail |
|------|--------|
| Common Names | Mache, corn salad, lamb's lettuce, field salad |
| Scientific Name | Valerianella locusta |
| Family | Caprifoliaceae |
| Cold Tolerance | Below 10F (-12C) under protection |
| Winter Production | Continuous Oct-May in Zone 5 |
| Market Category | Premium specialty salad green |
| Height | 2-4 inches |
