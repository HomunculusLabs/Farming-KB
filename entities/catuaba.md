...
The primary species used for catuaba bark is **Trichilia catigua** A. Juss. (family Meliaceae). This evergreen tree reaches 6–10 meters in height in primary and secondary Amazonian forests.

The bark is greyish-brown, rough, and fissured, with a characteristic bitter taste. The inner bark layer is reddish and contains the highest concentration of bioactive alkaloids.

Leaves are pinnately compound, with 5–9 leaflets per leaf. The tree produces small, fragrant white flowers in panicles, followed by capsular fruits.

A secondary source, **Anemopaegma arvense** (Bignoniaceae), is a woody vine rather than a tree. Its bark is darker and contains a different phytochemical profile dominated by flavonoids rather than indole alkaloids.
