...
- **Genus:** Houttuynia (monotypic — single species in the genus)
- **Species:** H. cordata
- **Authority:** Thunb.
- **Synonyms:** Polypara cochinchinensis Lour.
- **Common names:** Fish mint, chameleon plant, heartleaf, dokudami
  (Japanese), yu xing cao (Chinese, "fish-smell herb"), giap
  (Vietnamese), eoseongcho (Korean)
- **Etymology:** The genus name honors the Dutch naturalist Martin
  Houttuyn (1720-1798). "Cordata" refers to the heart-shaped
  (cordate) leaves. "Fish mint" derives from the distinctive
  fishy aroma released when the leaves are crushed.
