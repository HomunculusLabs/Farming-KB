...
- Choose healthy, young mushrooms with desired characteristics
- Select specimens free from visible contamination, insect damage, or disease
- Prefer mushrooms at the button or early expansion stage
- Clean the exterior surface with alcohol (70% ethanol)

### Excision Technique
1. Work in a sterile environment (laminar flow hood or glove box)
2. Flame-sterilize all instruments (scalpel, forceps, needles)
3. Tear or cut the mushroom open to expose clean interior tissue
4. Excise a small piece (5-10mm) of interior tissue, typically from the junction of cap and stem where growth is most vigorous
5. Transfer the tissue piece to the center of a prepared PDA plate
6. Seal the plate and label with date, species, and source information

### Incubation
- Incubate inoculated plates at appropriate temperature (typically 24-28°C depending on species)
- Mycelium should begin growing from the tissue within 3-7 days
- Full colonization of the plate typically takes 7-14 days
- Monitor daily for contamination (green, black, or pink colonies indicate mold contamination)

### Subculture (PDA to PDA Transfer)
- Once mycelium has colonized the plate, transfer small sections to fresh PDA plates
- This process is called subculturing and serves to:
  - Expand the culture stock
  - Maintain mycelial vigor
  - Create backup cultures
  - Prepare cultures for the next stage (grain spawn inoculation)

## Key Facts

- Tissue culture is an asexual (clonal) reproduction method — offspring are genetically identical to the parent
- The technique avoids the variability inherent in spore-based propagation
- Tissue culture is the standard commercial method for maintaining mushroom strains
- Multiple subcultures from a single tissue sample can produce hundreds of culture plates
- The technique requires basic sterile laboratory skills but is achievable by trained individuals regardless of physical ability
- Proper technique significantly reduces the risk of contamination
