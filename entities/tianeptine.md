...
**Also known as:** Stablon, Coaxil, Tianeurax

## Overview

Tianeptine is an atypical tricyclic compound developed by the French
...
dose, versus the standard 12.5 mg), it produces opioid-like euphoria and
sedation. Multiple countries have rescheduled or banned it in response to
...
- Metabolism: Hepatic (beta-oxidation, N-glucuronidation)
- Excretion: Renal

The short half-life necessitates three daily doses of 12.5 mg each for
therapeutic use. This frequent dosing schedule contributes to abuse
patterns, as users escalate frequency to maintain opioid effects.
