...
- **Category:** Atmospheric physics / Meteorological phenomenon
...
- Originally described by Ekman for compression fronts created over ocean waves, the same spiral pattern forms when wind flows over hedgerows, forest edges, and bluffs on land.
- Wind streaming over a hedgerow or forest edge describes a spiral section that is repeated 5-8 times downwind, creating a series of atmospheric compression fronts parallel to the windbreak.
- These compression fronts can result in a ranked series of clouds, often very regular in their rows, visible downwind of tree lines.
- The spirals are not perfectly aligned ahead but are deflected by drag and the Coriolis force, causing the wind direction after a hedgerow to shift 5-15 degrees off the previous course.
- This directional shift means that ranks of hedgerows placed to take advantage of the effect would eventually bring the wind around in a great ground spiral.
...
- **Rainfall engineering:** The phenomenon provides a mechanistic basis for how tree plantings can demonstrably increase local rainfall, supporting the design of rain-generating landscapes.
- **Multiple hedgerow design:** Because each windbreak creates spiral patterns that repeat 5-8 times downwind, designers can calculate optimal spacing between parallel hedgerows to create overlapping or reinforcing compression zones.
...
- Wade, John E., and Wendell Hewson (1979). *Trees as Indicators of Wind Power Potential*. Oregon State University.
