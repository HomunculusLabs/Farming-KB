...
updated: 2026-05-02
type: entity
tags: [species, fungus, ascomycete, mycoparasite, edible, lobster-mushroom]
sources: ["Schweinitz 1822", "Tulasne & Tulasne 1865", "Rogerson & Samuels 1989", "Põldmaa 2011"]
...
**Category:** Mycoparasitic ascomycete, edible (as the transformed "lobster mushroom")

**Family:** Hypocreaceae

**Also known as:** Lobster mushroom (referring to the parasitized host complex, not the parasite alone)
...
The genus Hypomyces contains approximately 50 species, many of which are mycoparasites of mushroom-forming fungi. H. lactifluorum is the most economically and culinarily significant member of the genus. Related species include H. chrysospermus (parasitizes boletes), H. luteovirens (turns Russula green), and H. hyalinus (parasitizes Amanita species).
...
- **Gills:** Completely obliterated and replaced by the parasite's tissue; reduced to blunt ridges or smooth surface

- **Flesh:** Firm, dense, whitish to pale orange interior; significantly firmer than the original host tissue

- **Odor:** Mild, pleasant, sometimes slightly fruity or with a distinctive seafood-like quality

- **Taste:** Mild, nutty, with a distinctive seafood/lobster-like flavor that is unique among edible mushrooms

**Microscopic features of H. lactifluorum:**

- **Perithecia:** Numerous, flask-shaped (pyriform to subglobose), 200-350 x 150-250 micrometers, embedded in the orange subiculum; each has a small ostiole (pore) through which ascospores are released

- **Asci:** Cylindrical to clavate, 8-spored, unitunicate, approximately 100-160 x 7-10 micrometers

- **Ascospores:** Ellipsoid to fusiform (spindle-shaped), 22-35 x 5-8 micrometers; hyaline when young, becoming pale yellow-brown at maturity; typically developing 1-3 septa at maturity; walls smooth to slightly roughened

- **Subiculum/hyphal mantle:** Composed of densely interwoven hyphae (2-5 micrometers wide) containing orange-pigmented granules
