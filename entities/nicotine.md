...
- **α4β2** — high affinity, mediates reinforcement and dependence; the
  most abundant subtype in the brain
- **α7** — moderate affinity, involved in attention, memory, and
  neuroprotection; calcium-permeable
- **α3β4** — ganglionic subtype, mediates cardiovascular and
  gastrointestinal effects
- **α1β1δγ/ε** — neuromuscular subtype, responsible for muscle contraction
