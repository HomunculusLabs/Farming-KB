...
The species was originally described by Christiaan Hendrik Persoon in 1800. The genus name Tremella derives from the Latin "tremere" (to tremble), referring to the gelatinous, jelly-like consistency of the fruiting body. The specific epithet "mesenterica" refers to the mesentery, which the convoluted, folded fruiting body is said to resemble.
...
- **Basidia:** Globose to subglobose, with longitudinal septa dividing them into four cells. Each cell produces a sterigma bearing a basidiospore.

The bright yellow-orange color and brain-like morphology make T. mesenterica one of the most visually distinctive fungi in temperate forests. However, it can be confused with the superficially similar [[tremella-aurantia]], which is a parasite of [[trametes-versicolor]] and may be found growing directly on its host.
...
The species is parasitic on other fungi, primarily saprotrophic crust fungi in the genus Peniophora (family Peniophoraceae). T. mesenterica typically fruits on dead wood of broadleaf trees, especially:
...
T. mesenterica extracts have demonstrated significant antioxidant activity:

- Strong DPPH and ABTS radical scavenging activity
- Effective reducing power in standard assays
- Inhibition of lipid peroxidation in model systems
- Protection against oxidative stress-induced cellular damage in vitro
- The antioxidant capacity is attributed to the combined effects of phenolic compounds, carotenoids, and polysaccharides
...
- Potential for use in topical formulations for skin hydration

### Anti-Inflammatory Effects

Preliminary studies have suggested anti-inflammatory properties:

- Reduction of pro-inflammatory cytokine release in activated macrophages
- Inhibition of nitric oxide (NO) production in LPS-stimulated cells
- Potential neuroprotective effects through suppression of neuroinflammation
...
- Occasionally consumed in soups in regions where it is abundant
- Used as an indicator species for suitable mushroom foraging conditions by experienced foragers
...
- The parasitic nature of the species requires co-culture with its host fungus (Peniophora spp.) for reliable fruiting

## Safety Profile

T. mesenterica is generally considered safe and edible, though it is not widely consumed. No significant toxicity has been reported. The gelatinous texture and mild flavor make it acceptable in soups when properly prepared. As with all wild mushrooms, accurate identification is important to avoid confusion with other species.
