...
- **Undersizing:** Trench too shallow/narrow for design storm → overflow and erosion
- **Wrong contour:** Trench not level → water concentrates at low point → failure
- **No overflow spillway:** Extreme rainfall breaches berm, creates gullies
- **Uncompacted berm:** Collapses under saturation, washes sediment into trench
- **Berm not planted:** Bare berm erodes rapidly; roots essential for stability
