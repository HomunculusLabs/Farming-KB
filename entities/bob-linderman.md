...
type: entity
tags: [person, mycology, mycorrhizae, VAM, researcher]
---
...
- **Specialty**: Mycorrhizal fungi ecology and plant-fungal interactions
- **Collaborators**: Jim Trappe, Elaine Ingham
- **Domain**: VAM, endomycorrhizal, and ectomycorrhizal fungal dynamics
...
Linderman's contributions to the mycorrhizal knowledge base helped establish the practical guidelines used by Soil Foodweb Inc. for assessing root health. The colonization thresholds that guide cultivation decisions — such as applying mycorrhizal inoculum when colonization falls below 10-15%, or adding compost and humic acids when colonization is between 15-40% — were informed by the collective expertise of researchers including Linderman. For cultivators managing soil biology, the ability to assess mycorrhizal colonization and take corrective action rests on the foundational research performed by scientists in Linderman's network.

## Source Context

Ingham mentions Linderman alongside Jim Trappe when discussing the expertise available for mycorrhizal questions: "To be able to talk with Bob Linderman, or Jim Trappe, when information was needed on VAM, endos, or ectos has been very helpful."
## Biography
