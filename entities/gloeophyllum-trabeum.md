...
*Gloeophyllum trabeum* is designated as a standard test organism in multiple international standards:

- **AWPA E10:** American Wood Protection Association standard for evaluating wood preservatives in soil block tests
- **EN 113:** European Standard for testing the effectiveness of wood preservatives against basidiomycete decay fungi
- **EN 84:** European Standard for preconditioning of wood samples prior to biological testing
- **JIS K 1571:** Japanese Industrial Standard for antifungal performance of wood preservatives

Its selection as a reference organism reflects its aggressive decay capabilities, broad host range, and consistent growth under laboratory conditions. Wood preservatives must demonstrate efficacy against *G. trabeum* to receive regulatory approval.

## Biotechnology Applications

Research on *G. trabeum* has implications for several biotechnology fields:
