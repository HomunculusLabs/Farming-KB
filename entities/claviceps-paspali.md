---
title: "Claviceps paspali"
created: 2026-04-28
type: species
tags: [fungi, clavicipitaceae, ergot-fungi, alkaloid-producing, grass-pathogen, clavine-alkaloids, mycology, veterinary-toxicology]
date: 2026-04-28
updated: 2026-04-28
sources:
...
- **Genus:** *Claviceps*
- **Species:** *C. paspali* (Stevens & J.G. Hall) Langdon, 1954
- **Synonyms:** *Sphacelia paspali* Stevens & J.G. Hall (anamorph)
The species epithet derives from its primary host genus *Paspalum*. The teleomorph (sexual stage) was described from specimens collected on *Paspalum dilatatum* in Australia. The anamorphic (asexual) *Sphacelia* stage is the form first observed infecting grass florets during the early phase of disease development.
Phylogenetic analyses using ITS, β-tubulin, and RPB1 sequence data place *C. paspali* in a distinct clade separate from *C. purpurea* and *C. fusiformis*, reflecting both host specialization and alkaloid pathway divergence. Molecular clock estimates suggest divergence of the *C. paspali* lineage from other *Claviceps* species during the Miocene, coinciding with the radiation of tropical grasses. Multilocus phylogenetic studies have consistently recovered *C. paspali* as sister to a clade containing *C. maximensis* and other tropical *Claviceps* species associated with wild grasses, rather than the cereal-infecting clade that includes *C. purpurea* and *C. purpurea* var. *spartinae*.
## Description and Morphology
*C. paspali* follows the typical *Claviceps* life cycle with three major morphological stages:
1. **Sphacelial (honeydew) stage:** Infected florets exude a sugary, sticky fluid (honeydew)
   containing numerous conidia (1–2 × 5–10 µm). The honeydew serves as the primary means
   of secondary spread via insects and rain splash. This stage typically lasts 7–14 days
   after initial infection.
2. **Sclerotial stage:** Following honeydew production, the fungus replaces the host ovary
   with a hard, dark purple to black sclerotium (ergot body). *C. paspali* sclerotia are
   elongated, cylindrical to slightly curved, typically 5–15 mm long, and protrude
   conspicuously from the grass spikelet. Internally, sclerotia have a white to pale
   purple medulla surrounded by a dark rind.
3. **Perithecial (sexual) stage:** After a dormancy period of several weeks to months,
...
Warm, humid conditions favor infection. Outbreaks in livestock are most common in late summer and early autumn when sclerotia mature and fall to ground level in pastures. Infection rates can exceed 30% of spikelets in severely affected fields during favorable seasons.
## Chemistry and Active Compounds
*C. paspali* is notable for producing clavine alkaloids rather than the peptide ergot alkaloids characteristic of *C. purpurea*. The clavines are ergoline derivatives that serve as biosynthetic precursors to lysergic acid-type alkaloids in some *Claviceps* species but remain as end-products in *C. paspali*. The indole-diterpenoid clavines (paspaline-type) are structurally distinct from the simpler tetracyclic clavines found in other species.
### Major Alkaloids
| Alkaloid | Class | Formula | MW | Notes |
|---|---|---|---|---|
...
| Sclerotium color | Dark purple-black | Dark violet-black | Dark brown-black | Dark grey-purple |
| Major alkaloids | Paspaline, paspalinine | Ergotamine, ergocristine | Fumigaclavines | Ergosine |
| Alkaloid class | Indole-diterpenoid | Peptide ergot | Clavines | Peptide ergot |
| Toxicity syndrome | Paspalum staggers | Ergotism (gangrenous) | Tremorgenic | Ergotism |
| Human health impact | Minimal | Major historical | Minimal | Regional |
| Veterinary impact | Significant | Significant | Regional | Regional |
- *C. purpurea* is the most commonly confused species but differs in host range (cereals vs. *Paspalum*), alkaloid profile (peptide ergot alkaloids vs. clavines), and clinical syndrome (ergotism with gangrene vs. paspalum staggers with tremor).
- *C. fusiformis* on pearl millet produces simpler clavines (fumigaclavine A and B) and causes a similar but distinct tremorgenic syndrome.
...
## Historical Context
*C. paspali* was first recognized as a distinct pathogen in the early 20th century, with the sphacelial stage initially described by Stevens and Hall from collections on *Paspalum dilatatum* in Australia. The connection between sclerotia on *Paspalum* grasses and livestock tremors ("paspalum staggers") was independently documented by veterinary pathologists in the southeastern United States, eastern Australia, and South America during the 1930s–1950s.
Langdon formally transferred the species to *Claviceps* in 1954, establishing its current taxonomic placement. Chemical investigation of *C. paspali* alkaloids intensified in the 1960s–1980s, with research groups in Australia, Japan, and the United States isolating and characterizing the tremorgenic clavines. Australian researchers at CSIRO were particularly active in this effort, publishing extensively on the isolation and structural elucidation of paspaline-type alkaloids. Japanese groups contributed important work on the biosynthetic relationships between clavine and ergotamine-type alkaloids using *C. paspali* as a model system.
The discovery that *C. paspali* produced indole-diterpenoid clavines rather than peptide ergot alkaloids was significant in understanding the chemical diversity within the genus *Claviceps*. This finding helped establish the concept that different *Claviceps* species have evolved distinct alkaloid biosynthetic pathways, likely as a result of co-evolution with their respective grass hosts. More recently, genomics and transcriptomics studies have begun to reveal the gene clusters responsible for paspaline-type alkaloid biosynthesis, opening new avenues for metabolic engineering and synthetic biology applications.
Unlike the dramatic ergotism epidemics caused by *C. purpurea* on cereal crops — which killed hundreds of thousands in the Middle Ages — *C. paspali* has primarily been a veterinary concern rather than a human health threat. Nevertheless, the pharmacological properties of its alkaloids have sustained scientific interest, particularly in receptor pharmacology and natural products drug discovery.
## Legal Status
*C. paspali* itself is not a scheduled or controlled organism in most jurisdictions. The fungus is not listed under the UN Convention on Psychotropic Substances, the US Controlled Substances Act, or equivalent national legislation in major countries. It does not appear on any internationally recognized lists of biological weapons agents, plant pathogens of quarantine significance, or organisms of dual-use concern.
