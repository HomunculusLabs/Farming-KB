...
DMT is a simple indole ethylamine consisting of the [[indole]] ring system with a two-carbon ethylamine chain bearing two N-methyl groups. This N,N-dimethyl substitution pattern is shared with numerous other psychoactive tryptamines ([[5-meo-dmt-compound-profile]], [[psilocin]], [[lsd-lysergic-acid-diethylamide-experience-guide]]). The freebase form is volatile and can be vaporized and inhaled; salt forms are water-soluble and suitable for oral or intravenous administration.
...
### Plants
DMT is found in over 50 plant species across multiple families:

- **Leguminosae (Fabaceae):** [[entheogen-jurema-mimosa-hostilis-ethnobotany]] (root bark, ~0.5-1%), Anadenanthera peregrina (seeds, with 5-MeO-DMT and [[bufotenin-entity-tihkal]]), Anadenanthera colubrina
- **Malpighiaceae:** Banisteriopsis caapi (trace amounts; the primary MAO-inhibiting β-carbolines are harmine, harmaline, tetrahydroharmine)
- **Rubiaceae:** Psychotria viridis (DMT-rich chacruna leaf, ~0.1-0.6%), Psychotria carthaginensis
- **Euphorbiaceae:** Various species
- **Poaceae:** Phalaris species (grass reed canary grass)

### Animals
DMT has been detected in:
- Mammalian brain tissue (rat, human) at low nanomolar concentrations
- Human cerebrospinal fluid and urine
- Amphibian skin secretions (alongside [[bufotenin-entity-tihkal]])
- The pineal gland of rodents (though human pineal DMT levels remain debated)

### In the Human Body
Endogenous DMT biosynthesis proceeds from [[tryptophan]] via [[tryptamine-consciousness-theory]]:

1. [[tryptophan]] → [[tryptamine-consciousness-theory]] (aromatic L-amino acid decarboxylase, AADC)
2. [[tryptamine-consciousness-theory]] → N-methyltryptamine (NMT) (indolethylamine N-methyltransferase, INMT)
3. NMT → DMT (INMT, second methylation)

INMT is expressed in the cerebral cortex, pineal gland, choroid plexus, and peripheral tissues including the lungs and thyroid. The functional role of endogenous DMT remains speculative but may involve:

- Regulation of sigma-1 receptor-mediated neuroprotection
- Modulation of immune function via the peripheral nervous system
- A proposed role in near-death experiences and REM dream imagery (Strassman hypothesis)

## Traditional and Cultural Use

DMT has been used for millennia in indigenous contexts:

- **Ayahuasca:** Amazonian brew combining DMT-containing plants (Psychotria viridis, Diplopterys cabrerana) with β-carboline-rich Banisteriopsis caapi bark. The β-carbolines inhibit MAO-A, rendering oral DMT psychoactive. Used in healing ceremonies by over 70 indigenous Amazonian groups.
- **Vilca and Cebil:** Snuff preparations from Anadenanthera seeds, used by indigenous peoples of the Orinoco basin, Caribbean, and southern Andes for divination and communal rituals
- **Yopo:** Amazonian snuff from Anadenanthera peregrina seeds, blown into the nostrils through tubes
- **Epená:** Snuff used by the Yanomami and other Amazonian peoples
...
DMT can be synthesized by several routes, the most common being the reductive amination of [[tryptamine-consciousness-theory]] with formaldehyde and a reducing agent (sodium borohydride, sodium cyanoborohydride, or sodium triacetoxyborohydride):

[[tryptamine-consciousness-theory]] + 2 CH₂O + 2[H] → DMT + 2 H₂O

Extraction from plant material (notably [[entheogen-jurema-mimosa-hostilis-ethnobotany]] root bark) is the predominant method for non-laboratory preparation. Common extraction techniques use a basified aqueous extraction followed by non-polar solvent defatting and a final acid-base extraction to isolate DMT freebase.
