...
Key distinguishing features of A. sylvicola:

- **Woodland habitat** — unlike most other edible Agaricus species which prefer open grasslands
- **Almond/anise-like odor** — pleasant and distinctive, similar to A. arvensis and A. subrufescens
- **Smooth white cap** — lacking the scales or roughness of some other species
- **Slender build** — more delicate in appearance than A. arvensis or A. campestris
- **Pink to brown gills** — typical of the genus

### Warnings

As with all Agaricus species, careful identification is essential:
