---
title: Honeydew-Fungal Interactions
source: john-dighton-fungi-in-ecosystem-processes.md
type: entity
tags: [ecology, phylloplane, canopy-process, nutrient-cycling, aphid]
---
...
- **Type:** Ecological interaction / process
- **Setting:** Plant canopy (phylloplane and phyllosphere)
- **Key organisms:** Aphids (Hemiptera: Aphididae), phylloplane fungi, epiphytic bacteria
- **Scale:** Individual leaf to forest canopy

## Key Facts

### Honeydew Production

Aphids produce honeydew as a byproduct of phloem sap feeding:

1. **Mechanism:** Aphids must process large volumes of phloem sap to obtain sufficient nitrogen, excreting excess sugar as honeydew (Dixon, 1973)
2. **Composition:** Primarily sugars (sucrose, fructose, glucose, melezitose) with small amounts of amino acids and minerals
3. **Volume:** Can be produced in very large quantities; significant deposits accumulate on leaves below feeding colonies
4. **Timing:** Continuous production during active feeding periods
...
Honeydew-mediated microbial growth affects canopy nutrient dynamics:
...
The altered phylloplane fungal community has implications for plant pathology:

- Increased saprotrophic fungal biomass may compete with pathogenic species for resources and space
- Changes in community composition can either facilitate or inhibit pathogen establishment
- Honeydew deposits create favorable microenvironments (high humidity, nutrients) that some pathogens exploit

## Relevance to Cultivation and Mycology

### Phylloplane Ecology in Cultivation
...
### Nutrient Management in Forest Systems
...
- Stadler, B., Muller, T. (1996). Aphid honeydew and its effect on the phyllosphere microflora. European Journal of Forest Pathology.
- Stadler, B., Muller, T. (2000). Effects of aphid honeydew on the phyllosphere. Agricultural and Forest Entomology.
- Stadler, B., Michalzik, B. (1999). The effects of aphid honeydew on canopy processes in Norway spruce. Ecology.
