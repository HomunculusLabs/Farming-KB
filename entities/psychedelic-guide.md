...
- The guide must never be bored, talkative, or intellectualizing during sessions lasting up to twelve hours
...
Leary identifies fear as the greatest problem:

- "Almost every negative [[lsd]] reaction has been caused by fear on the part of the guide which has augmented the transient fear of the subject"
- "When the guide acts to protect himself, he communicates his concern to the subject"
- The guide must maintain "passive sensitivity and intuitively relaxed" state for several hours
- This is described as "a difficult assignment for most Westerners"

## Relevance to Cultivation and Mycology

The psychedelic guide role is directly relevant to cultivation and mycology:

- Modern [[psilocybin-mushroom]] cultivators often serve as guides for others experiencing their cultivated products
- The guide framework informs the "set and setting" approach central to safe psilocybin use
- Modern clinical trials with psilocybin (Johns Hopkins, NYU, Imperial College) use trained guides based on principles Leary articulated
- The guide role has evolved into the "psychedelic facilitator" profession emerging in legalized psilocybin markets (Oregon, Colorado)
- Understanding proper guiding techniques is essential for anyone cultivating [[psilocybin-mushrooms]] for therapeutic or ceremonial use

## Sources

- Leary, T. "The Psychedelic Experience" — Section 6: The Psychedelic Guide
- Modern clinical protocols from Johns Hopkins, NYU, and Imperial College psilocybin research programs
## Historical Context
