...
**Cap (pileus):** 1.5–5 cm diameter, conic to convex-campanulate, expanding to broadly convex or plano-convex with age. Surface smooth, sub-viscid when moist, hygrophanous — dark chestnut brown to reddish brown when fresh, fading to ochraceous tan or straw yellow as it dries. Margin often with a slight appendiculate veil remnant in young specimens. The cap surface often develops greenish-blue bruising where handled or injured.

**Gills (lamellae):** Adnexed to adnate, subdistant, with 2–3 tiers of lamellulae (short gills). Color pale grey to brownish-grey at first, darkening to purple-brown or nearly black with spore maturity. Gill edges whitish and fringed.
...
**Spores:** Ellipsoidal to sub-amygdaliform (almond-shaped), thick-walled, 7.5–10 × 5–6.5 µm, with a distinct germ pore. Basidia 4-spored, clavate, 16–22 µm long. Cheilocystidia ventricose to lageniform, 18–30 × 6–10 µm. Pleurocystidia absent or rare.

**Chemical reactions:** Odor farinaceous (mealy, like damp flour). Taste farinaceous. KOH reaction on cap surface: no significant color change.

## Distribution and Habitat

*Psilocybe huautla* is endemic to the subtropical highlands of southern Mexico, specifically the Sierra Mazateca in Oaxaca state at elevations of 1,200–1,800 meters. It has been documented in cloud forest and pine-oak forest margins, pastures, and along trails through disturbed montane habitats.
...
*Psilocybe huautla* contains the following indole alkaloids:
...
*Psilocybe huautla* — along with several other Mexican Psilocybe species — has been used ceremonially by the Mazatec people for centuries, possibly millennia. The mushrooms are employed in *veladas* (night ceremonies) conducted by curanderos and curanderas (healers) for purposes including:

- **Divination** and diagnosis of illness
- **Healing** of physical, emotional, and spiritual ailments
- **Communion** with sacred entities and ancestors
...
- Fruiting temperature: 16–22°C (cooler than *P. cubensis*)
- Humidity: 90–95% for pinning, 85–90% for fruit body development
- Light: Ambient indirect light; the species is not as light-responsive as some tropical Psilocybe species

**Isolation and preservation:** Wild specimens can be cloned to agar media (MEA, PDA, or dung agar) for isolation. Spore prints are typically dark purple-brown and store well in desiccated conditions at 4°C. Long-term preservation is achieved through spore syringes, slant cultures, or liquid nitrogen storage.

## Pharmacology and Effects

The psychoactive effects of *P. huautla* are mediated by psilocybin's action as a partial agonist at serotonin 5-HT₂A receptors, with additional activity at 5-HT₁A, 5-HT₂C, and other serotonergic receptor subtypes. The experience typically includes:

- **Onset:** 20–60 minutes after ingestion
- **Peak effects:** 2–4 hours
- **Duration:** 4–7 hours total
- **Comedown:** Gradual return to baseline over 2–3 hours

The subjective experience profile of *P. huautla* is characterized by Mazatec practitioners as gentle, contemplative, and spiritually inclined — less overwhelmingly visual than tropical species, with greater emphasis on emotional depth, auditory enhancement, and a sense of sacred presence. This character may partially reflect set-and-setting factors of traditional ceremonial use, though it is also attributed to the species' particular alkaloid profile and the possible contribution of minor, uncharacterized tryptamine constituents.
