...
- **Family**: Clariidae
- **Genus**: *Clarias*
- **Key species mentioned**: *Clarias macrocephalus*, *Clarias batrachus*
...
### Role in Tropical Aquaculture
- Stocked in weedy, stagnant tropical ponds with other air-breathers (*Ophiocephalus*, *Heteropneustes*, *Notopterus*, *Anabas*)
- Polyculture of air-breathing species can yield up to 2,400 kg protein/ha/year even in derelict swampy ponds
- Used in Thailand and Malaysia rice paddies as weed controllers
- *C. macrocephalus* and *C. batrachus* clear weedy paddies while producing protein

### Environmental Tolerance
- **Oxygen**: Survives below 1 ppm; tolerates fully anaerobic conditions
...
- Demonstrates the [[permaculture]] principle of using biological resources -- the fish physiological adaptation replaces energy-intensive aeration
- Waste organic matter from [[mushroom-substrate-preparation]] could feed *Clarias* in integrated systems
- The model of using adapted organisms for difficult conditions parallels the selection of mushroom species for specific substrate and environmental conditions

## References
- Mollison, B. (1988). *Permaculture: A Designers' Manual*. [[tagari-publications]]. Chapter 13.
- Augusthy (1979), cited in Mollison for air-breathing fish adaptations.
