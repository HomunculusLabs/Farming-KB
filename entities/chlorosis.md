...
type: entity
tags: [plant-pathology, nutrient-deficiency, diagnosis, permaculture]
---
...
- **Category**: Plant pathology / Physiological disorder
...
1. **Diagnostic key**: Mollison presents a comprehensive diagnostic key (Table 8.7) linking chlorosis patterns to specific mineral deficiencies, allowing gardeners to identify problems without laboratory equipment.
2. **Seasonal variation**: Chlorosis symptoms change through the growing season as mobile nutrients (N, P, K) are translocated within the plant while immobile nutrients (Ca, B, Mn) accumulate in older tissue.
3. **Interveinal chlorosis on calcareous soils**: Common on coral atolls and desert soils, typically indicating iron deficiency due to high pH locking up available iron.
