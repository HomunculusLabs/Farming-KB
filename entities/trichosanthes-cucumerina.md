...
In Sri Lanka, snake gourd is a common ingredient in mallung — a dish of stir-fried greens with grated coconut and spices. In the Philippines, it is used in ginisang upo-style preparations with tomatoes and onions.

In Ayurvedic medicine, the fruit is used as a cooling, laxative, and expectorant remedy. The root is traditionally employed for treating diabetes, skin diseases, and respiratory ailments.

Leaf extracts show antimicrobial activity against Gram-positive bacteria. Phytochemical studies have identified triterpenoid saponins (trichosanthin), flavonoids (quercetin, kaempferol), carotenoids, and phenolic acids.
