...
**Sesbania grandiflora** (L.) Pers., commonly known as agati, vegetable hummingbird, or hummingbird tree, is a fast-growing, nitrogen-fixing leguminous tree native to South and Southeast Asia. It belongs to the family Fabaceae, subfamily Faboideae, and is among the most versatile multipurpose tree legumes in tropical agriculture.
...
**Classification:** Plantae → Tracheophyta → Magnoliopsida → Fabales → Fabaceae → Faboideae → Sesbanieae → Sesbania → S. grandiflora (L.) Pers. The genus Sesbania contains approximately 60 species distributed across tropical and subtropical regions worldwide.
...
In rice-fallow systems, S. grandiflora is relay-cropped to provide green manure biomass of 8–12 t fresh weight per hectare. The species is also planted as a living fence around home gardens and field boundaries. Leaf biomass application as mulch has been shown to increase rice yields by 15–25% in field trials across Southeast Asia.
