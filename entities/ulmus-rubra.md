...
**Habit:** Medium-sized deciduous tree, typically 15-25 m tall with a trunk diameter of 30-60 cm. In favorable conditions, it may reach 30 m. Crown is broadly vase-shaped when open-grown, more columnar in forest settings.

**Bark:** Outer bark is grayish-brown to reddish-brown, deeply fissured with irregular ridges. The characteristic inner bark is thick, soft, and mucilaginous, with alternating layers of reddish and whitish tissue. When moistened, the inner bark produces a prominent gelatinous slime.

This mucilaginous inner bark is the primary diagnostic feature distinguishing U. rubra from other North American elms. The inner bark has a distinctively fibrous texture and a faint, pleasant odor.

**Leaves:** Alternate, simple, 10-20 cm long, 5-10 cm wide. Obovate to oblong-elliptic, doubly serrate margin, rough-scabrous above, paler and pubescent beneath. Base is strongly asymmetric (oblique), typical of elms. Petiole 5-10 mm, pubescent.

**Flowers:** Perfect, apetalous, borne in dense clusters of 15-30 on short pedicels in early spring (February-April) before leaves emerge. Calyx reddish, 4-7 mm long, deeply lobed. Stamens 7-9, exserted, with reddish anthers. Wind-pollinated.

**Fruit:** Samara, 12-18 mm long including the wing, broadly oval, papery. Wing margins are ciliate (hairy). Seeds are centrally located in the samara body. Fruits mature in late spring (April-May).

**Roots:** Extensive lateral root system with a moderately deep taproot. Roots are relatively shallow compared to other elms, making the species somewhat susceptible to windthrow on exposed sites.
...
The defining constituent of U. rubra inner bark is its mucilage content, which comprises 20-40% of the dried bark by weight. The mucilage is a complex polysaccharide composed primarily of:

- **Galactorhamnan:** A rhamnogalacturonan polymer with alternating rhamnose and galacturonic acid residues. This is the principal viscous component.
- **Starch:** Present in moderate quantities, contributing to the nutritive value.
- **Pectins and hemicelluloses:** Additional polysaccharides contributing to gel formation.

When mixed with water, the mucilage swells to form a viscous, soothing gel that coats and protects mucosal surfaces. This physical demulcent action is the basis for most of its medicinal applications.
