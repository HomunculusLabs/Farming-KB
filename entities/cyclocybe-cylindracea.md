...
- **Cap:** 3–10 cm diameter, convex to plano-convex, dry, pale brown to
  yellowish-brown, often hygrophanous. Surface smooth, occasionally fibrillose.
- **Gills:** Adnexed to sinuate, initially white-gray, darkening brown with
  spore maturity. Crowded.
...
- **Cheilocystidia:** Ventricose to clavate, thin-walled, 18–30 × 8–14 µm.
- **Pleurocystidia:** Similar to cheilocystidia, occasional.
- **Pileipellis:** Cutis of repent cylindrical hyphae, 3–6 µm wide.
- **Clamp connections:** Present at all septa.
...
- Protein: 2.5–3.5 g
- Carbohydrates: 4.0–6.0 g
- Fat: 0.3–0.6 g
- Fiber: 1.5–2.5 g
- Key minerals: Potassium (350 mg), Phosphorus (110 mg), Selenium (10 µg)
- B vitamins: Thiamine, riboflavin, niacin present in moderate amounts.

### Bioactive Compounds

- **Cylindrocyclophane A:** A unique cyclophane-type compound with reported
  antitumor activity against murine leukemia cell lines.
- **β-glucans:** Water-soluble polysaccharides demonstrating immunomodulatory
  activity, including macrophage activation and NK cell enhancement in vitro.
- **Agrocybenine:** A bioactive alkaloid isolated from fruiting bodies.
- **Ergosterol:** Present at 0.5–0.8% dry weight, with provitamin D2 activity.
- **Phenolic compounds:** Including p-coumaric acid and ferulic acid, contributing
  to antioxidant capacity.

### Pharmacological Activities

- **Immunomodulation:** Polysaccharide fractions stimulate splenocyte
  proliferation and increase serum cytokine levels (IL-2, TNF-α) in murine
  models. Effects are dose-dependent and primarily mediated through TLR4
  receptor activation.
- **Antitumor:** Methanolic extracts show cytotoxicity against HeLa and HepG2
  cell lines with IC₅₀ values in the range of 50–200 µg/mL. In vivo studies
  demonstrate tumor growth inhibition in sarcoma-180 bearing mice.
- **Antioxidant:** Scavenging activity against DPPH and hydroxyl radicals.
  Total phenolic content correlates with antioxidant capacity.
- **Anti-inflammatory:** Extracts inhibit NO production in LPS-stimulated
  RAW 264.7 macrophages, comparable to indomethacin at equivalent concentrations.

## Culinary Use

Cyclocybe cylindracea is highly regarded in Chinese and Japanese cuisine. Caps
