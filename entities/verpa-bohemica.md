...
sources:
  ...
  - "Weber, N.S. & Smith, A.H. (1985). A Field Guide to Southern Mushrooms. University of Michigan Press."
...
It is one of the earliest spring-fruiting edible mushrooms, often appearing 2–4 weeks before true morels (*Morchella* spp.), leading to frequent misidentification by foragers.
...
- **Family:** Discinaceae
- **Genus:** *Verpa* Sw.
- **Species:** *V. bohemica* (Krombh.) J. Schröt.

**Authority:** Originally described as *Peziza bohemica* by Julius Vincenz von Krombholz in 1834.

Transferred to *Verpa* by Joseph Schröter in 1893.

The genus name *Verpa* is from the Latin for "rod" or "staff," referring to the stipe.

**Synonyms:** *Morchella bohemica* (Krombh.) Čern., *Ptychoverpa bohemica* (Krombh.) Boud.

The species was historically confused with true morels and was occasionally placed in *Morchella* before molecular phylogenetics confirmed its placement in *Verpa*.

Molecular studies place *Verpa* in the Discinaceae, closely related to *Discina* and *Helvella*, but distinct from *Morchella* (Morchellaceae).

## Morphology

**Cap (apothecium):** 2–4 cm broad and 2–4 cm tall, thimble-shaped to conical, attached to the stipe only at the apex.

The cap surface is wrinkled to longitudinally ridged (not pitted as in true morels), with irregular, anastomosing folds.

Color ranges from yellowish-brown to reddish-brown or dark brown, with paler ridges.

The cap margin is free-hanging and often rolled inward, creating a distinct gap between cap and stipe.

**Stipe:** 6–12 cm tall, 1–2.5 cm thick, cylindrical, whitish to pale cream, hollow or partially stuffed with cottony fibers.

The stipe is smooth to finely mealy, sometimes with a slight bulb at the base.

Unlike *Morchella*, the stipe is not attached to the cap along its length.

**Flesh:** Thin, fragile, and brittle. Cap flesh is 1–2 mm thick, waxy when fresh. Stipe flesh is whitish and chambered.

**Spores:** Ellipsoid to fusoid, 22–32 × 12–16 µm, smooth, hyaline, containing two large oil guttules.

Spores are large relative to *Morchella* species and are a key diagnostic feature.

Asci are operculate, 8-spored, measuring 300–350 × 16–20 µm.

Paraphyses are cylindrical, septate, with slightly clavate tips 4–6 µm wide.
