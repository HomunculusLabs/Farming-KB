...
The species is susceptible to clematis wilt (*Phoma clematidina*), which causes sudden stem collapse. Planting deeply (5–8 cm below the soil surface) allows recovery from buds buried below ground.

Propagation is by semi-ripe cuttings in summer or by layering in spring. [[green-cannabis-grow-bible-cloning-and-seed-propagation]] is possible but slow, requiring 6–12 months of cold stratification and yielding variable offspring.

Container cultivation works well if pots are large (30+ cm diameter) and soil is kept consistently moist. The species is popular in Japanese-style courtyard gardens where its nodding flowers can be viewed at eye level.

The cultivar 'Sieboldii' is the most commonly grown form, featuring a striking contrast between white sepals and a dark purple-black central boss. 'Plena' is a double-flowered selection with layered petaloid structures replacing the staminodes.
