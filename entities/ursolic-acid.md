...
Ursolic acid (3β-hydroxy-urs-12-en-28-oic acid) is a pentacyclic triterpenoid carboxylic acid found abundantly in the epidermal wax coatings of fruits, leaves, and bark of numerous plant species across diverse botanical families. Named for its original isolation from bearberry (Arctostaphylos uva-ursi; *Ursa* = bear in Latin), it is one of the most ubiquitous and extensively studied triterpenoids in phytochemistry and pharmacology. Ursolic acid and its isomer oleanolic acid are among the most prevalent bioactive triterpenoids in the human diet. Over the past three decades, ursolic acid has emerged as a compound of intense research interest due to its remarkably broad pharmacological profile — encompassing anti-inflammatory, anticancer, hepatoprotective, cardioprotective, neuroprotective, antidiabetic, and anti-obesity activities. It is a key active constituent in many traditional herbal medicines and is increasingly recognized for its role in the health benefits of fruit-rich diets, Mediterranean herbal traditions, and adaptogenic botanical preparations.

## Chemical Profile

- **IUPAC name**: 3β-Hydroxyurs-12-en-28-oic acid
- **Molecular formula**: C₃₀H₄₈O₃
- **Molecular weight**: 456.70 g/mol
- **CAS number**: 77-52-1
- **SMILES**: CC1(CCC2(CCC3(C)C(=CCC4C5(C)CC(O)C(O)CC5CCC34C)C2C1C)C(=O)O)C
- **Appearance**: White to off-white crystalline powder
- **Melting point**: 283–285 °C
- **Solubility**: Practically insoluble in water (<1 mg/L); soluble in ethanol, methanol, DMSO, chloroform
- **LogP**: ~7.2 (extremely lipophilic)
- **pKa**: ~4.8 (carboxylic acid)
- **Optical rotation**: [α]D²⁰ = +60° (in chloroform)
...
Ursolic acid modulates a remarkable array of molecular targets, which underlies its diverse pharmacological activities:
...
**Hepatoprotective**:
- Protects hepatocytes from CCl₄, acetaminophen, and alcohol-induced injury
- Reduces serum ALT, AST, and MDA in hepatic damage models
- Enhances hepatic glutathione and SOD/catalase activity
- Ameliorates NAFLD by reducing hepatic lipid accumulation

**Antidiabetic and metabolic**:
- Enhances insulin sensitivity via AMPK activation and GLUT4 translocation
...
**Neuroprotective**:
- Reduces neuronal apoptosis in Alzheimer's (Aβ), Parkinson's (MPTP), and ischemia models
- Inhibits AChE and BChE; reduces neuroinflammation via microglial NF-κB suppression
- Enhances BDNF expression

**Antimicrobial**:
- Active against Gram-positive bacteria (S. aureus, B. subtilis) with MICs of 8–64 μg/mL
- Antifungal activity against Candida and dermatophytes
- Antiviral: inhibits HIV-1 protease; activity against HSV-1, influenza, dengue in vitro

**Bone health**:
- Stimulates osteoblast differentiation via BMP-2/Smad signaling
- Inhibits osteoclast formation and bone resorption
- Prevents bone loss in ovariectomized rat models

## Pharmacokinetics and Bioavailability

The primary limitation of ursolic acid as a therapeutic agent is its poor aqueous solubility and low oral bioavailability:
- **Oral bioavailability**: Estimated at <5% in rats; low and variable in humans
- **Absorption**: Passive diffusion across intestinal epithelium, limited by crystallinity and lipophilicity
- **Metabolism**: Hepatic Phase I (hydroxylation, CYP450) and Phase II (glucuronidation, sulfation)
- **Elimination**: Primarily biliary/fecal; minimal renal excretion; half-life 2–4 hours (rat)

**Formulation strategies**: Nanoparticle encapsulation (PLGA, liposomes), cyclodextrin inclusion complexes, phytosome formulations, SMEDDS, and structural derivatives with improved solubility.
...
- **Acute oral LD₅₀** (mouse): >5,000 mg/kg (non-toxic)
...
| Property | Value |
|---|---|
| Chemical class | Pentacyclic triterpenoid (ursane) |
| Molecular weight | 456.70 g/mol |
| Key dietary sources | Apple peel, rosemary, holy basil, oregano |
| Water solubility | Practically insoluble |
| Oral bioavailability | <5% |
| Signature activity | NF-κB / PI3K-Akt-mTOR inhibition |
| Supplement dose | 150–500 mg/day |
