...
- **Roots:** Extensive lateral root system with nitrogen-fixing nodules; root bark is thick, reddish, and rich in tryptamine alkaloids
...
The root bark is the primary plant part harvested for its psychoactive alkaloids:

| Compound | Concentration (root bark, dry weight) | Notes |
|----------|--------------------------------------|-------|
| N,N-DMT | 0.5–1.1% | Primary psychoactive compound |
| N-Methyltryptamine (NMT) | 0.05–0.2% | Minor contribution |
| β-Carboline trace alkaloids | Trace | Not pharmacologically significant in isolation |

The inner root bark (cambium layer) contains the highest alkaloid concentrations. Stem bark contains only trace amounts and is not used for psychoactive purposes.

### Non-Psychoactive Compounds

- **Tannins:** Proanthocyanidins and flavonoid tannins (concentrated in stem bark)
- **Saponins:** Triterpenoid saponins with hemolytic activity
- **Flavonoids:** Including kaempferol and quercetin derivatives
- **Phenolic acids:** Caffeic, ferulic, and gallic acids
- **Mucilaginous polysaccharides:** Contributing to wound-healing properties of the bark
...
- **Historical accounts:** 18th-century Portuguese chroniclers documented the use of jurema among indigenous peoples of Pernambuco, describing its effects as producing visions and spiritual experiences

### Mexican Traditional Medicine (Tepezcohuite)
...
## Ecological and Permaculture Value

### Nitrogen Fixation

As a legume, M. tenuiflora forms symbiotic associations with rhizobia bacteria (Bradyrhizobium spp.) in root nodules, fixing atmospheric nitrogen at rates estimated at 15–40 kg N/ha/year. This makes it valuable for:

- **Soil restoration:** Revegetating degraded and eroded land in semi-arid regions
- **Agroforestry systems:** Used as a nitrogen-fixing component in tropical and subtropical food forests
- **Silvopastoral systems:** Provides shade and forage for livestock while improving soil fertility

### Caatinga Ecosystem Role

In its native Caatinga biome, jurema is a keystone species providing:

- Shade and microclimate modification for understory plants
- Forage for goats, cattle, and wildlife (leaves and pods)
- Nectar and pollen for pollinators during flowering events
- Soil stabilization on steep, eroded slopes

### Coppicing and Regrowth

M. tenuiflora coppices vigorously and can be harvested repeatedly for root bark, firewood, or charcoal. Sustainable harvesting practices include:

- Harvesting from lateral roots rather than the taproot
- Rotating harvest areas and allowing 2–3 year recovery periods
