...
type: entity
tags: [technology, energy, waste-management, permaculture, anaerobic]
---
...
3. **Liquid effluent** → field application as liquid fertilizer
...
- Feedstock must have appropriate carbon-to-nitrogen ratio (typically 20:1 to 30:1)
- Requires consistent feeding regime for stable gas production
- Must be located to leverage gravity flow of inputs and outputs
- Gas storage needed to buffer intermittent production against variable demand
- Safety considerations: methane is flammable and explosive; hydrogen sulfide is toxic
