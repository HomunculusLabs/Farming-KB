...
**Trifolium pratense** L. (red clover) is a short-lived perennial legume in
...
Prefers well-drained loam or clay-loam soils, pH 6.0–7.0, with
moderate to high fertility. Tolerates cold to -30°C. Optimal growth
at 15–25°C with 600–1,200 mm annual rainfall.
...
cut, taller, slightly longer-lived). Notable cultivars: 'Kenland,'
'Arlington,' 'Freedom!'

## Bioactive Compounds

Red clover is one of the richest dietary sources of isoflavones:

- **Daidzein**: Major isoflavone; metabolized to equol by gut flora.
- **Genistein**: Tyrosine kinase inhibitor with anticancer properties.
- **Formononetin**: Most abundant isoflavone in many cultivars.
- **Biochanin A**: Antioxidant and anti-inflammatory sesquiterpene.
- **Glycitein**: Minor isoflavone with weaker estrogenic activity.

Total isoflavone content: 0.5–2.5% dry weight, varying with cultivar,
growing conditions, and harvest stage. Flowers and upper leaves have
highest concentrations. Additional constituents include coumarins,
flavonols (quercetin, kaempferol), saponins, and vitamins A, B, C, E.

## Pharmacology and Medicinal Uses

Red clover has a long European folk medicine history as an expectorant,
diuretic, and "blood purifier." Contemporary research focuses on:

- **Menopausal symptoms**: Multiple trials show modest reduction in hot
  flashes and improved bone mineral density, though results are mixed
  compared to hormone replacement therapy.
- **Cardiovascular health**: Isoflavones improve arterial compliance
  and lipid profiles in controlled studies.
- **Skin health**: Traditional topical use for eczema and psoriasis.
- **Antioxidant activity**: Scavenges free radicals and inhibits LDL
  oxidation in vitro.

## Ecological Role

Red clover provides high-quality nectar and pollen for honeybees and
bumblebees. It is a major honey plant, yielding light amber honey with
mild flavor. As a legume, it enriches soil nitrogen, improves organic
matter and soil structure, and serves as a break crop in rotations to
reduce cereal disease pressure and weed seed banks.

## Permaculture Applications

In temperate permaculture designs, red clover serves multiple functions:

- **Nitrogen fixation**: 100–200 kg N/ha/year for companion plants.
...
Effective companions include orchard grass, chicory, plantain, and
white clover.
