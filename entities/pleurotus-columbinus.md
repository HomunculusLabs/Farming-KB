...
- **Cap:** 5–15 cm diameter, convex when young, becoming funnel-shaped with age. Distinctively blue-grey when young, fading to steel-grey or brownish with maturity. Surface smooth, slightly tacky when moist.
- **Gills:** Decurrent (running down the stem), white to pale grey, close, with cross-veins (anastomosing) between gill lamellae — a characteristic feature of the genus.
- **Stem:** 2–8 cm long, 1–3 cm thick, lateral to eccentric, white, solid, short or sometimes nearly absent.
- **Flesh:** White, firm, thick. Mild mushroomy aroma with a slightly sweet, anise-like undertone.
- **Spore Print:** White to pale lilac-grey.
- **Spores:** Cylindrical to ellipsoid, 8–12 × 3–4 µm, smooth, hyaline.

### Microscopic Features
The presence of monomitic hyphal system with clamp connections distinguishes *Pleurotus* species from many other white-spored genera. Cheilocystidia are thin-walled and ventricose.

## Distribution and Habitat

*P. columbinus* is native to temperate and subtropical hardwood forests of Europe, North America, and parts of Asia. It is a **primary wood decomposer**, colonizing dead or dying hardwoods — especially oaks (*Quercus* spp.), beech (*Fagus* spp.), birch (*Betula* spp.), and maple (*Acer* spp.).

In the wild, it fruits in overlapping shelf-like clusters on standing dead trees, fallen logs, and stumps, typically from autumn through spring in temperate zones. It prefers cool to moderate temperatures (10–20°C) and high humidity (85–95%).

## Cultivation

### Substrates
Blue Oyster mushrooms are exceptionally versatile and will fruit on a wide range of lignocellulosic substrates:
- **Hardwood sawdust** (oak, beech, alder, maple) — the gold standard for commercial cultivation
...
| Parameter | Range |
|-----------|-------|
| Spawn run temperature | 20–28°C |
| Fruiting temperature | 10–18°C (optimally 12–15°C) |
| Humidity | 85–95% RH |
| Light | Indirect, 500–1000 lux |
| Fresh air exchange (FAE) | High — requires good ventilation |
| pH | 5.5–7.0 |
