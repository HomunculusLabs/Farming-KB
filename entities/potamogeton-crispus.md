...
**Classification:** Plantae → Tracheophyta → Magnoliopsida → Alismatales → Potamogetonaceae → Potamogeton → P. crispus L. (1753).

**Authority:** Linnaeus published the species in 1753 in *Species Plantarum*. The genus *Potamogeton* contains approximately 90 species worldwide.

The specific epithet *crispus* (Latin for "curled" or "crisped") refers to the characteristic wavy leaf margins.

The species is known to hybridize with several congeners, most commonly *P. perfoliatus* (producing the hybrid *P. × cooperi*) and *P. lucens*.

**Stems** are slender, cylindrical, 30–100 cm long, and moderately branched. Stems are green to reddish-brown, especially near the tips.

**Submerged leaves** are sessile (no petiole), broadly lanceolate to oblong, 30–80 mm long and 8–20 mm wide. Leaf margins are strongly crisped and undulate, the diagnostic feature of the species.

Leaf venation is prominent, with 3–5 main veins and fine lateral veins creating a reticulate pattern. The midrib is conspicuous.

Leaf bases are clasping (amplexicaul), wrapping around the stem. A conspicuous stipular sheath (ochrea) 10–20 mm long encircles the stem at each node.

**Floating leaves** are occasionally produced in late spring to early summer. They are smaller than submerged leaves (15–30 × 8–15 mm), with flat (non-crisped) margins and shorter petioles.

**Fruit** are drupaceous achenes, 3–4 mm long, with a distinct dorsal keel and a short beak. Fruits ripen in May–June, earlier than most Potamogeton species.
...
The species tolerates a wide range of conditions: depths from 0.5 to 7 m, temperatures from 5 to 30 °C, and moderate turbidity. It is less tolerant of fast-flowing water than *P. perfoliatus*.

It grows on a variety of substrates including clay, silt, sand, and gravel. Nutrient-enriched sediments promote vigorous growth.

A distinctive phenological pattern characterizes the species: it grows primarily in autumn through early summer, reaching peak biomass in May–June. It then declines rapidly as water temperatures exceed 20 °C, dying back by mid-summer and persisting only as dormant turions.

## Ecology and Invasive Status
