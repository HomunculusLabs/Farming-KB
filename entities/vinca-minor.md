...
In European traditional medicine, periwinkle has been used for centuries to treat headaches, dizziness, and memory impairment. Its reputation as a brain tonic is substantiated by modern pharmacological research into its alkaloid constituents.
...
Roots form at stem nodes where they contact soil, enabling rapid vegetative spread. This rooting habit makes it both an effective groundcover and an invasive species in favorable conditions.

Leaves are opposite, evergreen, ovate to elliptic, 1–3 cm long and 0.5–1.5 cm wide.

They are glossy dark green above, paler beneath, with entire margins. A distinctive pale midvein runs the length of each leaf.

Flowers are solitary, axillary, and funnel-shaped, 2–2.5 cm in diameter. The corolla is typically blue-violet with a white throat, though white-flowered cultivars exist. Flowering occurs primarily in spring (April–May), with sporadic blooms continuing through summer.

The fruit is a pair of slender follicles 2–3 cm long. Each follicle contains 3–8 seeds with an elaiosome that attracts ants for myrmecochorous dispersal.
...
*V. minor* produces a diverse array of indole alkaloids derived from the strictosidine biosynthetic pathway. Over 70 alkaloids have been isolated from aerial and root tissues, with the highest concentrations found in the leaves.

Vincamine (C₂₁H₂₆N₂O₃) is the most pharmacologically significant alkaloid, comprising 0.1–0.5% of dry leaf weight.

It is a monomeric indole alkaloid with vasodilatory and nootropic properties. The compound was first isolated in 1953 by Hungarian researchers from *V. minor* leaf extracts.
...
Vincamine acts primarily as a selective vasodilator of cerebral blood vessels.

It functions as a phosphodiesterase inhibitor, increasing intracellular cAMP levels in vascular smooth muscle, leading to relaxation and improved blood flow. This mechanism is shared with other xanthine-derived vasodilators but vincamine shows greater cerebrovascular selectivity.
...
Vincamine also exhibits mild antihypertensive activity and has been investigated for tinnitus and retinal vascular disorders. Its effects on cerebral microcirculation may also benefit patients with chronic cerebral hypoperfusion.
