...
sources:
  ...
  - https://www.allbud.com/marijuana-strains/indica/zkittlez
...
The precise male parent has been the subject of some debate within the cannabis community.
Terp Hogz has described it as a proprietary sativa selection, while some accounts identify it as the strain LSD (a Skunk #1 × Mazar hybrid) or a Grapefruit-dominant selection.
The genetic uncertainty of the male parent has not prevented Zkittlez from becoming a foundational breeding stock in its own right, with dozens of award-winning offspring strains descending from it.
Key descendants include **Runtz** (Zkittlez × Gelato), **OGZ** (Zkittlez × OG Eddy Lepp), **Rainbow Belts** (Zkittlez × Moonbow), and **Cherry Zkittlez** (Zkittlez × Cherry Pie).

## Appearance and Morphology

Zkittlez plants are medium to tall in height, reaching 100–150 cm indoors and potentially 200+ cm outdoors in favorable conditions.
The growth structure is moderately branching with strong lateral development, producing dense, conical flower clusters that are visually striking.
Calyxes are large, chunky, and tightly packed, with a distinctive olive-green to dark-purple coloration that can shift dramatically depending on temperature during the late flowering phase.
Cooler nighttime temperatures (below 15°C) during weeks 5–8 of flowering trigger anthocyanin production, producing vibrant purple, magenta, and deep violet hues throughout the buds.
Trichome coverage is exceptionally heavy, giving the flowers a frosty, crystalline appearance with a predominantly white to amber trichome profile at maturity.
The pistils are long, thin, and orange to rust-colored, weaving through the dense calyx structure in moderate abundance.
Leaf structure is typical of indica-dominant varieties — broad-fingered, dark green leaves that may also display purple pigmentation.
...
- Dry eyes — common
- Mild anxiety or paranoia at higher doses (uncommon due to relatively moderate THC levels)
- Drowsiness and lethargy — may impair cognitive function
- Increased appetite

## Cultivation

Zkittlez is considered a moderately difficult strain to cultivate, requiring attention to training and environmental control:
...
- **Recommended training**: Low-stress training (LST), scrogging, and defoliation to manage canopy height and maximize light penetration
- **Nutrient requirements**: Moderate to heavy feeder during vegetative growth; reduced nitrogen during flowering to prevent nutrient burn and promote terpene production
- **Optimal temperature**: 20–28°C during day, 15–20°C during night (cooler nights enhance purple coloration and terpene development)
- **Pest resistance**: Moderate; susceptible to spider mites, powdery mildew in high-humidity environments
- **Suitable for**: Indoor, outdoor, and greenhouse cultivation

## Awards and Recognition

Zkittlez has won or placed in numerous major cannabis competitions, establishing it as one of the most decorated modern cannabis strains:

- **1st Place — Indica**, 2016 Emerald Cup (Northern California)
- **1st Place — People's Choice**, 2016 Emerald Cup
- **Best Hybrid**, multiple regional California cannabis competitions (2017–2019)
- Featured in High Times "Top 10 Strains of the Year" (2018)
- Parent strain of Runtz, which won Leafly Strain of the Year (2020)
...
1. Terp Hogz / 3rd Gen Family. (2016). Zkittlez strain information and breeding records. Emerald Cup competition entry.
2. Leafly Staff. (2022). "Zkittlez: A Complete Strain Review." *Leafly*.
3. ElSohly, M.A., et al. (2016). "Changes in cannabis potency over the last two decades." *Biological Psychiatry*, 79(7), 613–619.
...
5. Mudge, E.M., et al. (2019). "Cannabis chemovar phenotype by LC-MS." *Planta Medica*, 85(4), 345–355.
