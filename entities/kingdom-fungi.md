...
Kingdom Fungi is one of the major kingdoms of eukaryotic organisms, comprising an estimated 1.5 million species (Hawksworth 1991), of which only 74,000–120,000 have been formally described. Fungi are heterotrophic, primarily filamentous organisms with cell walls that reproduce both sexually and asexually via spores. Molecular phylogenetic studies have established that Kingdom Fungi is a monophyletic group more closely related to animals than to plants.

## Classification

- **Domain**: Eukaryota
- **Kingdom**: Fungi
- **Related kingdoms**: Animalia (sister group), Straminipila, Protista (containing former fungal groups)
- **Estimated species**: ~1.5 million (only ~5% described)
...
- Heterotrophic organisms (cannot photosynthesize)
- Most have filamentous bodies (hyphae) enclosed by cell walls (chitin-based)
- Nonmotile (with exceptions in flagellated spores of chytrids)
- Reproduce sexually and asexually by spores
- Permeate virtually all terrestrial and many aquatic environments

### Phylogenetic Relationships

- Kingdom Fungi is monophyletic—supported by molecular evidence (Barr 1992; Bruns et al. 1993; Baldauf et al. 2000)
- Fungi are more closely related to animals than plants, possibly sharing a choanoflagellate-like ancestor
- "Fungi" historically included polyphyletic assemblages—morphologies are convergent from independent eukaryotic lineages
- True Fungi are distinct from fungus-like organisms in Kingdom Straminipila (oomycetes, hyphochytrids) and Kingdom Protista (slime molds)
...
- Lichen formation—symbiotic relationships with algae and cyanobacteria
- Food sources—cultivated and collected species (mushrooms, truffles)
- Industrial uses—brewing, baking, fermentation, pharmaceuticals (antibiotics), biotechnology

### Diversity Scale

- At least 74,000–120,000 species formally described
- Estimated 1.5 million species total (Hawksworth 1991); evidence suggests this may be too low
- At most only ~5% of fungal species are known to science
- In temperate areas, approximately 6× as many fungi as native plants in a given site
- A single site (~200 hectares) studied for 25+ years by multiple specialists may yield 2,500–3,000 species

### Survey and Inventory Challenges
