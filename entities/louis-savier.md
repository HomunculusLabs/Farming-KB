...
type: entity
tags: [person, market-gardener, french, intensive-cultivation, maraicher]
---
...
Savier's garden embodied the highest standards of the French intensive tradition:

- **Size**: 2.5 acres (consistent with the classic Parisian model of 1-2 acres)
- **Enclosure**: Surrounded by a 6-foot-high south-facing wall, providing a warm microclimate
- **Layout**: Organized with tidy, closely spaced rows; ranks of cold frames and hotbeds
- **Soil**: Dark chocolate-colored, reflecting decades of intensive composting with horse manure and straw
- **Crop Quality**: Described by Coleman as "glowing with health" on his first visit

The garden was surrounded not by other farms (as would have been true in the 19th century) but by suburban houses, illustrating the urbanization pressure that eventually displaced the maraichers.

## Techniques Observed

Savier employed the full suite of traditional French intensive techniques:

1. **Cold frames and hotbeds** for season extension and winter production
2. **Intensive interplanting** with multiple crops on the same ground sequentially and simultaneously
3. **Horse manure hotbeds** for generating bottom heat in winter production
4. **Glass cloches** for individual plant protection and forced early production
5. **Compost-based fertility** using composted horse manure as the sole soil amendment
6. **Straw mat insulation** over glass covers during cold nights
...
| Fact | Detail |
|------|--------|
| Location | Banvilliers, 9 miles south of Paris |
| Garden Size | 2.5 acres |
| Period Active | Through retirement in 1996 |
| Tradition | [[french-intensive-market-gardening]] (maraichage) |
| Key Visitor | Eliot Coleman (first visit 1974, four visits total) |
| Fertility System | Composted horse manure and straw |
| Wall Enclosure | 6-foot south-facing stone wall |
| Influence | Catalyzed Coleman's winter-harvest system |
