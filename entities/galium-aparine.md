...
**Classification:** Magnoliopsida → Gentianales → Rubiaceae → Rubioideae →
*Galium* → *G. aparine* L.

**Authority:** Carl Linnaeus, Species Plantarum (1753).

The plant is an annual, growing 0.5–1.5 m long with a weak, scrambling stem
that climbs over neighboring vegetation using its hooked hairs. Stems are
square in cross-section, slender, and green to reddish-green.

Leaves are arranged in whorls of 6–8 at each node, lanceolate to oblanceolate,
1–3 cm long and 2–5 mm wide, with recurved margins. The upper surface is
rough with hooked hairs; the lower surface is slightly hairy along the midrib.

Flowers are small (2–3 mm diameter), white to greenish-white, borne in axillary
cymes of 1–3 flowers. Each flower has 4 petals, 4 stamens, and a 2-lobed
ovary. Flowering occurs from May to October in temperate regions.
