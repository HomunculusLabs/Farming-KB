...
- Traditional use for respiratory conditions aligns with demonstrated anti-inflammatory activity in bronchial tissue models.
...
| Chlorinated compounds | Various chlorinated orsellinates | Antibacterial |
...
- **Cultivation attempts:** Mycelial cultures can be maintained on agar and grain, but inducing fruiting body formation under artificial conditions has proven exceptionally challenging. The species appears to require the complex environment of living, old-growth trees over many years to form conks.
...
Agarikon occupies a unique position at the intersection of mycology, medicine, and conservation:

- It is the oldest mushroom with a continuous recorded medicinal tradition in Western civilization, with over 2,000 years of documented use.
- Its rarity has made it a symbol of old-growth forest conservation and the hidden biodiversity at risk from logging.
- The DARPA BioShield research brought agarikon into modern biodefense discussions, highlighting the untapped pharmacological potential of rare fungi.

## Distribution and Threats

Agarikon has a disjunct distribution reflecting the fragmentation of old-growth temperate rainforests:

### North American Populations
- Pacific Northwest: Washington, Oregon, northern California, British Columbia
- Found primarily in the remaining old-growth stands of the Cascade Range, Coast Range, and Olympic Peninsula
- Rarely found on trees younger than 200 years; prefers specimens 400+ years old
- Populations in the Cascade Range and coastal forests are the most genetically diverse and biologically significant

### European Populations
- Alps (Austria, Switzerland, Italy, France, Germany)
- Carpathian Mountains (Romania, Slovakia, Poland)
- Scandinavian Peninsula (Norway, Sweden, Finland)
- Scottish Highlands (very rare, possibly extirpated)
- European populations are severely fragmented and many are non-viable without intervention
...
Given agarikon's rarity, most mycologists and conservation organizations recommend against any collection of wild specimens:

- **Do not harvest** wild agarikon fruiting bodies for any purpose.
- **Document and report** sightings to local mycological societies, forest services, or conservation organizations.
- **Photograph only** — take GPS coordinates and submit to citizen science platforms (iNaturalist, MushroomObserver).
- **Support old-growth forest conservation** through advocacy and donations to land trusts.
- **Obtain lab-cultured material** from reputable suppliers (e.g., Fungi Perfecti) for research or personal cultivation attempts.

## Research Directions

Active areas of agarikon research include:

- **Antiviral drug development:** Isolation and characterization of specific antiviral compounds for pharmaceutical development. The lanostanoid triterpenoids are of particular interest.
- **Genomic sequencing:** Multiple strains have been sequenced to understand genetic diversity and population structure across the species' range.
- **Metabolomic profiling:** Comprehensive analysis of bioactive compounds across different geographic populations and host tree species.
