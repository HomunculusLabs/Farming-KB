...
The species was first described by the Swedish botanist Carl Linnaeus in 1753 in his *Species Plantarum*, one of the earliest formal descriptions of a slime mold. The specific epithet *septica* refers to the septate (partitioned) nature of the capillitium threads within the spore-bearing structures.

## Life Cycle

*Fuligo septica* exhibits the complex life cycle characteristic of plasmodial slime molds, alternating between mobile, multinucleate feeding stages and stationary reproductive stages:

### Plasmodial Stage (Vegetative Phase)

The plasmodium is the most conspicuous and recognizable phase of *F. septica*. Key characteristics:

- **Appearance**: A bright yellow to pale orange, irregularly shaped, foam-like mass that creeps slowly over surfaces. The color is due to **yellow carotenoid pigments** (primarily β-carotene and related compounds)
...
Spores germinate under moist conditions, releasing biflagellate **swarm cells** (in water) or amoeboid cells (on surfaces). These haploid cells undergo multiple rounds of mitotic division, then fuse in pairs to form diploid **zygotes** that develop into new plasmodia, completing the cycle.
...
- **Living plants**: Occasionally climbs up the stems of living herbaceous plants and low shrubs (especially garden plants, roses, and ornamentals), which alarms gardeners but causes no harm to the plant
- **Bark**: Sometimes observed on the bark of living trees

### Environmental Conditions

Optimal conditions for plasmodial growth include:

- **Moisture**: High humidity or consistently wet substrate; the plasmodium desiccates rapidly in dry conditions
