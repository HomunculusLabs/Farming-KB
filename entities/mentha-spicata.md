...
sources:
  ...
  - "Burt, S. (2004). Essential oils: their antibacterial properties. Int J Aromather, 14(1), 46-59."
...
- **Life form:** Herbaceous perennial, 30–100 cm tall
- **Habit:** Upright to ascending, branching, forming dense clonal colonies via vigorous rhizomatous spread
- **Lifespan:** Indefinite (perennial); individual stems are annual but the rhizome network persists for many years
- **Spread rate:** Aggressive — a single planting can spread 0.5–1.5 m per year in favorable conditions, making it potentially invasive in unmanaged settings

### Leaves

- **Arrangement:** Opposite, decussate
- **Shape:** Lanceolate to ovate-lanceolate, 3–9 cm long × 1–3 cm wide, sharply serrate margin, acuminate apex, cuneate to subcordate base
- **Texture:** Pubescent on the lower surface (especially along veins), glabrous to sparsely pubescent above
- **Color:** Medium to dark green, paler beneath; leaf venation prominent
- **Aroma:** Characteristic sweet mint scent released upon bruising; distinctly different from peppermint due to the absence of strong menthol cooling

### Flowers

- **Inflorescence:** Spikes (verticillasters) in the axils of the upper leaves, 3–7 cm long, cylindrical to slightly tapered
- **Flowers:** Small, zygomorphic, 2.5–3.5 mm long
- **Calyx:** Tubular, 5-toothed, approximately 2 mm long, sparsely pubescent
- **Corolla:** Pink to lilac, rarely white, 2-lipped (upper lip notched, lower lip with 3 lobes), 3–4 mm long
- **Stamens:** 4 (2 long, 2 short — didynamous), included or slightly exserted
- **Blooming period:** Mid-summer to early autumn (July–September in the Northern Hemisphere)
- **Pollination:** Entomophilous — attractive to bees, butterflies, hoverflies, and other pollinators; ranked as an excellent honey plant in some regions

### Roots and Rhizomes

- **Root system:** Extensive fibrous root system with thick, creeping rhizomes that run 5–20 cm below the soil surface
- **Rhizome characteristics:** White to pale green, fleshy, 2–5 mm diameter, with nodes producing both roots and upward-growing shoots; capable of vegetative propagation from fragments as small as 2 cm

## Chemical Composition

### Essential Oil

The essential oil of spearmint is steam-distilled from the aerial parts (primarily leaves) and is one of the most commercially significant mint oils globally:

| Component | % of Essential Oil | Notes |
|-----------|-------------------|-------|
| (−)-Carvone | 50–70% | Primary flavor compound; sweet, caraway-like aroma |
| Limonene | 8–15% | Citrus notes; synergistic with carvone |
| Dihydrocarvone | 3–10% | Milder, earthy nuance |
| Dihydrocarveol | 1–5% | Warm, herbaceous undertone |
| 1,8-Cineole (Eucalyptol) | 1–4% | Cooling, camphoraceous note |
| Menthone | 0.5–2% | Mild mint character |
| Menthyl acetate | 0.1–1% | Fruity nuance |
| Piperitone | Trace | Peppery note |

**Key distinction from peppermint:** Spearmint contains less than 1% menthol (compared to 30–50% in peppermint), which accounts for its milder, sweeter flavor profile without the intense cooling sensation characteristic of peppermint. The carvone-dominant profile makes spearmint the preferred mint for culinary applications where a gentle, non-overpowering mint flavor is desired.

### Other Constituents

- **Flavonoids:** Luteolin, apigenin, rutin, hesperidin — contribute to antioxidant activity
- **Phenolic acids:** Rosmarinic acid, caffeic acid — anti-inflammatory and antioxidant properties
- **Tannins:** Moderate levels (3–5% dry weight) — astringent properties
- **Vitamins:** Vitamin A, vitamin C, vitamin K (particularly when consumed fresh)
...
Spearmint has been used medicinally for millennia across multiple cultures:

- **Ancient Greece and Rome:** Used as a digestive aid, breath freshener, and strewing herb. Pliny the Elder described its use for relieving stomach complaints and stimulating appetite.
- **Traditional Arabic medicine:** Employed for gastrointestinal disorders, particularly bloating, flatulence, and indigestion.
- **Traditional Chinese Medicine (TCM):** Used to dispel wind-cold, promote sweating, and soothe sore throat.
- **European folk medicine:** Infusions consumed for headaches, hiccups, nausea, and menstrual cramps; applied externally as a poultice for skin inflammations and insect bites.
...
- **British:** Traditional accompaniment to roast lamb (mint sauce); flavoring for peas, potatoes, and new vegetables
- **Beverages:** Primary flavoring for mint julep (Kentucky bourbon cocktail), mojito (Cuban rum cocktail), mint tea (Moroccan and Middle Eastern traditions), and commercial mint-flavored beverages
- **Confectionery:** Widespread use in chewing gum, breath mints, candies, and toothpaste — spearmint is the dominant mint flavor in the global confectionery industry due to consumer preference for its milder profile over peppermint
- **Preservation:** Fresh leaves can be frozen, dried, or infused in oil, vinegar, or honey for extended use
