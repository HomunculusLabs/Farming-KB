...
- **Flowers:** Small (6–9 mm diameter), white, with four petals in a typical crucifer (cross-shaped) pattern. Borne in terminal racemes. Blooms May through October in temperate regions.
...
**Cancer prevention:** PEITC has been extensively studied for chemopreventive properties. Mechanisms include modulation of Phase I/Phase II detoxification enzymes, induction of apoptosis via caspase-3 and mitochondrial pathways, inhibition of histone deacetylase (HDAC) activity, and anti-angiogenic effects through suppression of HIF-1α and VEGF signaling. A landmark clinical trial (Gill et al., 2007, *British Journal of Cancer*) demonstrated that a single serving (85 g) of watercress reduced lymphocyte DNA damage by 22.9% and increased blood antioxidant levels within hours of consumption.
...
- **Water quality:** Requires clean, flowing or gently moving water, pH 6.0–7.5. Bioaccumulator of heavy metals and waterborne pathogens — water quality is critical. Wild harvesting from contaminated sources should be avoided.
- **Temperature:** Optimal 15–20°C; tolerates light frost. Growth slows above 25°C.
- **Light:** Full sun to partial shade; 6–8 hours preferred.
- **Substrate:** Roots in gravel, sand, or sandy loam in shallow water (2–15 cm depth). Also grown hydroponically in recirculating aquaponic systems.
- **Propagation:** Primarily by stem cuttings (root within days in water). Also by seed (surface-sown on saturated soil, germination in 7–14 days at 15–20°C).
- **Harvest:** Year-round in mild climates; cut 5–10 cm above base for regrowth. Successional harvesting every 3–4 weeks. Annual yields of 2–4 kg/m².
...
- **Fascioliasis risk:** Wild watercress from grazing land may harbor liver fluke (*Fasciola hepatica*). Only harvest from clean, monitored sources or cook thoroughly.
- **Vitamin K interaction:** Extremely high vitamin K content can interfere with warfarin (Coumadin) and other anticoagulant medications. Patients on blood thinners should consult healthcare providers before regular consumption.
- **Goitrogenic potential:** Like all Brassicaceae, watercress contains goitrogenic compounds that may interfere with thyroid function when consumed in very large quantities, particularly raw. Cooking reduces goitrogenic activity.
