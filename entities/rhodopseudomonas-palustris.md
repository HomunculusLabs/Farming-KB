...
1. **Photoautotrophic growth**: Using light as an energy source and carbon dioxide as a carbon source, with hydrogen gas or reduced sulfur compounds as electron donors.
2. **Photoheterotrophic growth**: Using light as an energy source and organic compounds as both carbon and electron sources. This is the mode most commonly employed in natural environments and in agricultural applications.
...
Rhodopseudomonas palustris should be evaluated in relation to climate, soil or substrate
