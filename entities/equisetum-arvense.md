...
created: 2026-04-28
type: species
tags: [herbal-plant, medicinal, silica, fern-ally, equisetaceae, permaculture, accumulator]
date: 2026-04-28
updated: 2026-04-28
sources:
...
- **Kingdom:** Plantae
- **Division:** Polypodiopsida (ferns and fern allies)
- **Class:** Equisetopsida
- **Order:** Equisetales
- **Family:** Equisetaceae
- **Genus:** Equisetum
- **Species:** E. arvense
Equisetum is the only living genus within Equisetales.
Despite common usage of the term, horsetails are fern allies rather than true ferns; they reproduce via spores rather than seeds and lack true leaves.
The genus name derives from the Latin equus (horse) and seta (bristle), referring to the plant's coarse, brush-like appearance.
## Morphology
Equisetum arvense produces two distinct types of annual shoots from a perennial underground rhizome system.
...
- Provides early-season habitat and food for invertebrates; spore cones are consumed by some bird species.
- Can become aggressively invasive in cultivated beds due to rhizomatous spread; containment strategies (root barriers, dedicated beds) are recommended.
## Cautions & Toxicity
**Thiaminase activity:** raw horsetail contains thiaminase, an enzyme that destroys thiamine (vitamin B1) in the body.
- Prolonged consumption of raw horsetail can lead to thiamine deficiency, particularly in individuals with marginal B1 status.
- Drying, boiling, or preparing as a decoction effectively inactivates thiaminase.
- Commercial herbal preparations use dried material and are considered safe at recommended doses.
**Equine toxicity:** Equisetum species are toxic to horses and livestock if consumed in quantity.
- Symptoms of horsetail poisoning in horses include weakness, ataxia, weight loss, and in severe cases, death.
- Hay contaminated with horsetail is a common route of exposure; contaminated feed should be discarded.
- Toxicity in horses is attributed to both thiaminase-induced thiamine deficiency and alkaloid content.
**Contraindications:**
- Not recommended during pregnancy or breastfeeding due to insufficient safety data.
- Avoid in individuals with thiamine deficiency or alcohol dependence (which impairs thiamine absorption).
