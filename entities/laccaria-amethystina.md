...
- **Cap:** 1–4 cm, convex to broadly convex, often with a slight umbo; surface
  dry, smooth or finely scurfy. Color vivid amethyst-purple when fresh and moist,
  fading to grayish-brown or buff with age or in dry conditions. This extreme
  color variability is the basis for the common name.
- **Gills:** Thick, widely spaced, adnate to slightly decurrent; same color as
  cap or slightly paler, purple to lilac fading with age. Distinctively waxy and
  thick-spaced compared to most agarics.
- **Stem:** 3–8 cm × 0.2–0.6 cm, equal or slightly tapered at base, fibrous,
  tough and flexible. Purple when young, fading to brownish. No ring.
- **Flesh:** Thin, watery, purplish when fresh; mild taste, no distinctive odor.
- **Spores:** White print; broadly ellipsoid, 7–10 × 6–8 µm, prominently spiny
  (echinulate) with spines up to 1 µm long. The spiny spores are diagnostic for
  the genus *Laccaria*.

## Distribution and Habitat

Highly generalist ectomycorrhizal associate found with conifers (pine, spruce, fir,
hemlock) and hardwoods (oak, beech, birch, eucalyptus). One of the most widely
distributed *Laccaria* species across Europe, Asia, North America, and Australasia.
Inhabits forest floors in mixed and coniferous woodlands, heathland edges, and
disturbed sites including plantations and reclaimed land. Fruits from July to
November in temperate regions, often in scattered groups or troops. Tolerant of
acidic soils and commonly found in pine plantations on nutrient-poor substrates.

## Ecological and Permaculture Significance
...
Edible but insubstantial — the thin flesh and small size make it poor as a
culinary mushroom on its own. It is occasionally collected in mixed mushroom
baskets in Eastern Europe and France, where it adds color to dishes. The
edibility is well-established, with no toxicity concerns. However, its small
size, watery texture, and bland flavor limit culinary interest. Foragers should
exercise caution with color-faded specimens, as the loss of purple coloration
can make it superficially resemble other small woodland mushrooms.

## Similar Species

- ***Laccaria laccata* (deceiver):** Very similar in structure but typically
  orange-buff to tan rather than purple. Spores are similarly spiny. The common
  name "deceiver" is shared between these species for the same reason.
- ***Laccaria bicolor* (two-toned deceiver):** Larger, with a distinctly
  bicolored stem (purple base, paler upper stem). More common in North America.
- ***Cortinarius* spp. (webcaps):** Some small purple *Cortinarius* species
  could be confused, but *Cortinarius* has a cobwebby veil (cortina) at
  maturity and rusty-brown spore print. Several *Cortinarius* species are
  dangerously toxic.
- ***Mycena pura* (lilac bonnet):** Similar size and coloration but with
