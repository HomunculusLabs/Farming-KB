...
- **Growth in fairy rings** on lawns and grasslands
- **Widely spaced (distant) gills** — a key feature separating it from toxic lookalikes
- **Tough, wiry stem** — unlike the more fragile stems of similar-looking species
- **Small size** — caps rarely exceed 5 cm
- **White spore print**
- **Tan to buff cap** with a paler margin

### Warnings

- **Clitocybe dealbata** (Ivory Funnel) can grow in similar grassy habitats and contains dangerous levels of muscarine. It has crowded (close) gills, unlike the widely spaced gills of M. oreades.
- **Clitocybe rivulosa** — another toxic grassland species with close gills
- **Panaeolus species** — grow on dung-enriched grasslands; some are psychoactive
- Always check gill spacing carefully: distant gills = likely safe; crowded gills = exercise caution.

## Culinary Value

M. oreades is considered an excellent edible despite its small size:

- **Flavor:** Rich, nutty, and concentrated. Often described as superior to larger, more common mushroom species.
