...
Phenolic compounds, including hispidin analogs, contribute to significant antioxidant capacity measured by DPPH and ABTS radical scavenging assays.

Triterpenoids and sterols from the fungal tissue show moderate cytotoxic activity against select cancer cell lines in vitro, though clinical relevance has not been established.

A lanostane-type triterpenoid, capitastin, was first isolated from *C. capitata* collected in São Paulo state.

The species also produces laccase and other lignin-modifying enzymes relevant to bioremediation and biopulping applications.

## Ethnobotanical and Medicinal Uses

In parts of the Brazilian Amazon, *C. capitata* is used in folk medicine as a topical application for skin infections and wounds, prepared as a hot-water decoction of dried basidiocarp tissue.
