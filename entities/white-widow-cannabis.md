...
| Parameter | Details |
|-----------|---------|
| Plant type | Indica-dominant hybrid, photoperiod-dependent |
| Height | 80–140 cm indoors; 150–200 cm outdoors |
| Structure | Branching, medium density; somewhat open structure allowing good light penetration |
| Leaf shape | Broad-fingered indica leaves with some sativa elongation |
| Flowering time | 8–9 weeks (56–63 days) |
| Yield | 400–500 g/m² indoors; 500–600 g/plant outdoors |
| Harvest month (outdoor) | Late September to mid-October (Northern Hemisphere) |
...
White Widow is considered an excellent **beginner-friendly strain** due to its vigor, disease resistance, and consistent performance. It responds well to both SOG (Sea of Green) and ScrOG (Screen of Green) training methods. The plants exhibit moderate stretch during the first two weeks of flowering before settling into bud production. Trichome density increases dramatically in the final two weeks, giving the mature buds their signature white appearance.

## Cannabinoid Profile

Modern White Widow selections typically express the following cannabinoid profile:

| Cannabinoid | Typical Range |
|-------------|---------------|
| **THC** | 18–25% (some selections up to 28%) |
| **CBD** | 0.1–1.0% |
| **CBG** | 0.3–0.8% |
| **CBC** | 0.1–0.3% |
| **THCV** | Trace amounts |

The original 1990s White Widow tested at approximately 12–15% THC. Modern seed bank selections have been bred for significantly higher potency, consistent with the overall trend of increasing cannabis THC content documented in research. The THC:CBD ratio is typically >20:1, placing this firmly in the high-THC, low-CBD category.

## Terpene Profile

White Widow's aroma and flavor are driven by a distinctive terpene combination:

| Terpene | Typical % | Aroma Contribution |
|---------|-----------|-------------------|
| **Myrcene** | 0.4–0.8% | Earthy, musky, herbal base note; sedative properties |
| **Pinene (α+β)** | 0.2–0.5% | Pine, fresh forest; mental clarity, bronchodilator |
| **Caryophyllene** | 0.1–0.3% | Peppery, spicy; anti-inflammatory, CB2 receptor agonist |
| **Limonene** | 0.1–0.2% | Citrus, lemon; mood elevation, anxiolytic |
| **Humulene** | 0.05–0.15% | Woody, earthy; appetite suppressant |
| **Linalool** | Trace | Floral, lavender; calming, anxiolytic |

The overall aroma is **earthy and pungent** with pine undertones and a subtle woody, floral quality. When combusted, the flavor is smooth with a slightly spicy, peppery finish. The aroma intensifies significantly as buds cure, with well-cured White Widow developing a richer, more complex scent profile.

## Effects Profile

The effects reflect White Widow's balanced indica-sativa heritage:

- **Onset**: Rapid (5–10 minutes); initial cerebral rush from sativa genetics
- **Head effects**: Euphoric, uplifting, creative energy; enhanced sociability and conversation; mild visual sharpening; cerebral stimulation without racing thoughts
- **Body effects**: Gradual physical relaxation that deepens over 30–60 minutes; mild body warmth; muscle tension relief without heavy sedation at moderate doses
- **Duration**: 2–3 hours depending on dose and individual tolerance
- **Medical applications**: Stress relief, mild anxiety reduction, depression management, fatigue, mild pain relief, appetite stimulation

At higher doses, the indica influence becomes more pronounced, potentially leading to couch-lock and drowsiness. The balanced nature makes White Widow suitable for both daytime and evening use at moderate doses. Novice consumers should approach with caution due to high THC content.
...
- **Pop culture**: Referenced in music, film, and television; name recognition among cannabis consumers worldwide rivals that of OG Kush or Sour Diesel
- **1995 High Times Cannabis Cup winner**: The competition victory that established its global reputation
- **Standard of quality**: The name "White Widow" has become shorthand for high-quality, resinous cannabis in many markets

## Cultivation Notes

- **Indoor**: Performs well in soil, coco coir, and hydroponic systems; pH 6.0–6.8 (soil), 5.5–6.1 (hydro); EC 1.2–1.8 during flowering
- **Outdoor**: Prefers warm, Mediterranean to temperate climates; relatively mold-resistant for a resin-heavy strain
- **Nutrients**: Moderate feeder; benefits from increased phosphorus and potassium during weeks 4–7 of flowering to support trichome production
- **Training**: LST (low stress training) and topping recommended to control height and promote even canopy; responds well to defoliation in weeks 3–4 of flowering
- **Pest resistance**: Good general resistance; monitor for spider mites in indoor environments
- **Harvest indicator**: 70–80% cloudy trichomes with 10–20% amber for balanced effects; earlier harvest (more clear/cloudy) preserves cerebral energy
