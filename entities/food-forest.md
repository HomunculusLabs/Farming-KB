...
A food forest (also known as a forest garden) is a perennial polyculture system designed to mimic the structure, function, and biodiversity of a natural forest ecosystem while producing food, fiber, medicine, and other useful products for human use. Rooted in the principles of permaculture and agroforestry, food forests organize edible and functional plants into a multi-layered vertical architecture — from canopy trees to ground covers and root crops — creating a self-sustaining, low-maintenance agricultural system that increases in productivity and resilience over time. The concept draws on millennia of traditional agroforestry practices from tropical and temperate regions worldwide, formalized in the West by Robert Hart and further developed by Dave Jacke, Eric Toensmeier, and Martin Crawford.
...
- **Robert Hart (1913–2000):** British pioneer who established one of the first modern temperate food forests at Wenlock Edge, Shropshire, England, in the 1980s. Hart articulated the concept of a seven-layer forest garden adapted from tropical agroforestry models. His 1996 book *Forest Gardening* introduced the concept to a wide audience
- **Ken Fern:** Founder of Plants for a Future; compiled one of the most comprehensive databases of edible and useful perennials suitable for temperate food forests
- **Dave Jacke & Eric Toensmeier:** Authors of *Edible Forest Gardens* (2005), the definitive two-volume reference on temperate food forest design, ecology, and practice
- **Martin Crawford:** Director of the Agroforestry Research Trust (UK); author of *Creating a Forest Garden* (2010); established and manages a 2-acre forest garden in Devon, England
...
- Climbing and scrambling plants that ascend into the canopy
- Species: Kiwi (*Actinidia* spp.), grapes (*Vitis* spp.), hardy passionfruit (*Passiflora incarnata*), hops (*Humulus lupulus*), climbing beans, akebia, schisandra (*Schisandra chinensis*), honeysuckle
- Function: Vertical food production on "unused" aerial space, shade regulation, wind filtering
...
- **Pest confusers:** Aromatic plants that mask crop scents from pests (alliums, mint family, marigolds)
- **Pollinator attractors:** Nectar and pollen-rich flowers (lavender, borage, echinacea)
- **Mulch producers:** Plants that generate abundant biomass for sheet mulching (comfrey, nasturtium, cardoon)
- **Root exudate contributors:** Plants whose root exudates feed beneficial soil microorganisms
...
- **Minimal export:** Harvesting practices that return organic matter to the system (e.g., composting on-site)

## Design Process

### Site Assessment

1. **Climate analysis:** Hardiness zone, frost dates, precipitation patterns, prevailing winds, microclimates
2. **Soil evaluation:** Soil type, depth, drainage, pH, existing fertility, contamination history
3. **Water resources:** Surface water, groundwater, rainfall capture potential, irrigation needs
4. **Sun and shade patterns:** Seasonal sun angles, existing shade from buildings or trees, slope orientation
5. **Access and infrastructure:** Pathways, water lines, existing structures, zones of use
