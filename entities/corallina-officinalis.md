...
**Corallina officinalis** L., commonly known as the **common coral weed**, is a species of calcified red alga (Rhodophyta) in the family Corallinaceae. It is one of the most widespread and ecologically important intertidal seaweeds in temperate and cold waters worldwide.
...
**Corallina officinalis** was described by Carl Linnaeus and is the type species of genus *Corallina* in the family Corallinaceae, order Corallinales. The genus contains approximately 30 species of articulated coralline algae distributed globally.

The thallus is erect, dichotomously branched, and articulated, consisting of alternating calcified segments (intergenicula) separated by flexible uncalcified joints (genicula). Fronds typically reach 2-12 cm in height, forming dense tufts or mats on rocky substrates.

Calcified intergenicula are composed of magnesium calcite deposited within the cell walls, giving the alga its hard, brittle texture and distinctive coloration. The degree of calcification varies seasonally and with environmental conditions, with higher calcification rates in warmer, well-lit conditions.

Genicula are composed of elongated, thin-walled cells that provide flexibility to the otherwise rigid frond structure. This articulation allows the alga to withstand wave action without breaking, a critical adaptation for survival in the intertidal zone.
...
Color ranges from pale pink to deep purple-red, with branch tips often appearing lighter due to lower calcification. When dry (at low tide), the fronds bleach to a grayish-white color but regain their pink coloration when rehydrated by the returning tide.
...
The species is remarkably tolerant of desiccation for a marine alga, surviving several hours of aerial exposure during each tidal cycle. Desiccation tolerance is mediated by the thick calcified cell walls, which reduce water loss, and by the flexible genicula that allow fronds to collapse and minimize surface exposure.

Optimal growth occurs at temperatures of 10-18 degrees C and salinities of 25-35 ppt. The species is relatively tolerant of reduced salinity and can survive in estuaries with seasonal freshwater influence, though growth rates decline significantly below 20 ppt.

In the intertidal zone, *C. officinalis* typically occupies the mid-eulittoral zone, forming a distinct band below barnacles and above kelp species. This zonation pattern is consistent across geographically separated shorelines and reflects the species' specific tolerance of desiccation and wave exposure.

The alga colonizes a wide range of hard substrates including granite, basalt, limestone, concrete, and mollusc shells. It is also found growing epiphytically on other seaweeds and as an epizoic on the shells of barnacles and limpets.

## Ecology and Calcium Carbonate Deposition

*Corallina officinalis* is a significant contributor to **calcium carbonate deposition** in marine coastal environments. The species precipitates magnesium calcite within its cell walls at rates that can reach several hundred grams per square meter per year in productive stands.

Annual calcium carbonate production by coralline algae in temperate reef systems can exceed that of scleractinian corals, making these algae the dominant calcifiers in many higher-latitude marine environments. This contribution is often underappreciated in global carbon budget models.

This biogenic calcification plays an important role in the global carbon cycle. During calcification, the alga releases CO2, contributing to local acidification of the surrounding seawater. The net carbon budget of coralline algae depends on the balance between calcification and photosynthetic CO2 uptake.

The dense frond mats create complex three-dimensional habitat structure that supports diverse communities of invertebrates. The spaces between fronds provide refuge for small crustaceans, polychaete worms, gastropods, and juvenile fish, making coralline turfs among the most biodiverse intertidal microhabitats.
