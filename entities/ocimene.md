...
forms) and **β-ocimene** (cis and trans forms). The trans-β-ocimene
isomer is the most commonly occurring in nature and the predominant
...
- **Cannabis** (*Cannabis sativa*): Present in the trichome
  resin, especially in strains with sweet or tropical aroma
  profiles such as Strawberry Cough, Golden Goat, and Space
  Queen.

## Pharmacology and Effects

Ocimene has demonstrated several biological activities in
preclinical research:

**Anti-inflammatory:** Studies in vitro have shown that
ocimene can inhibit inflammatory mediators, including
COX-2 expression and TNF-α production in activated
macrophages.

**Antifungal:** Ocimene exhibits antifungal activity against
several plant pathogens, including *Botrytis cinerea* and
*Fusarium* species, suggesting a role in plant defense.

**Antiviral:** Preliminary research indicates activity against
herpes simplex virus (HSV-1) in cell culture models, though
clinical data is lacking.

**Anticonvulsant:** In animal models, ocimene has shown
anticonvulsant properties, potentially through interaction
with GABAergic neurotransmission pathways.

**Decongestant:** Ocimene has been traditionally used in
...
Cannabis strains with notable ocimene content include
Strawberry Cough, Golden Goat, Space Queen, and some
