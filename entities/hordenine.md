...
Hordenine exists as a free base at physiological pH (pKa ~9.3) and is
readily absorbed due to moderate lipophilicity (logP ~1.3).

## Pharmacology

**Receptor activity:**
- **Indirect adrenergic agonist:** Hordenine does not directly bind
  adrenergic receptors. Instead, it acts as a substrate for the
  norepinephrine transporter (NET), triggering norepinephrine release
  via reverse transport. This mechanism produces sympathomimetic effects
...
- **MAO-B inhibition:** Reversibly inhibits monoamine oxidase B with
  ...
  by MAO-A.
- **Trace amine-associated receptor (TAAR1) agonism:** Hordenine activates
  TAAR1 at micromolar concentrations, contributing to modulatory effects
  on dopaminergic and serotonergic neurotransmission.

**Pharmacokinetics:** Orally bioavailable, peak plasma in 30–60 min.
Half-life ~2–3 hours. Metabolized by N-demethylation to N-methyltyramine
and tyramine, with subsequent oxidative deamination by MAO.
...
contains the highest concentrations as germination activates the pathway.
