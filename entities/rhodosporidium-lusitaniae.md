---
title: Rhodosporidium lusitaniae
...
- **Species:** *R. lusitaniae*
- **Anamorph:** *Rhodotorula lusitaniae*

## Key Facts

- *R. lusitaniae* can be isolated from forest soil using media whose sole carbon source consists of lignin-related phenolic compounds — a highly selective enrichment strategy.
- As a basidiomycetous yeast, it possesses a teliospore-based sexual cycle, distinguishing it from the more commonly encountered ascomycetous yeasts.
- The species demonstrates the metabolic diversity of basidiomycetous yeasts, which extends beyond simple sugar fermentation to complex aromatic compound degradation.
- Its ability to degrade phenolic compounds suggests potential roles in forest soil organic matter turnover and nutrient cycling.
- The discovery of basidiomycetous life cycles in yeasts (beginning with Banno 1967) revolutionized yeast taxonomy, and *Rhodosporidium* species were among the key taxa in this paradigm shift.
- Like other *Rhodosporidium* species, *R. lusitaniae* produces carotenoid pigments, giving colonies a pinkish to orange-red coloration.

## Relevance to Cultivation and Mycology

*Rhodosporidium lusitaniae* is relevant to forest ecology and bioremediation research. Its lignin-degrading capability suggests potential applications in:
...
- The page title is Rhodosporidium lusitaniae.
- Its recorded source is unknown-biodiversity-of-fungi.md.
- Existing tags on the page are [yeast, basidiomycete, lignin-degrader, forest-soil, bioremediation].
...
## Local cross-checks
- Existing wikilink already present on this page: [[decomposition]].
...
- Fell, J.W. et al. (1969, 1973). Basidiomycetous yeast life cycles
