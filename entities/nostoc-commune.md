...
**Nostoc commune** is a species of filamentous cyanobacteria (blue-green algae) in the family Nostocaceae. It is one of the most widely distributed and ecologically important terrestrial cyanobacteria on Earth.
...
- **Family:** Nostocaceae
- **Genus:** *Nostoc*
- **Species:** *N. commune* Vaucher ex Bornet & Flahault

The species was first described by Jean Pierre Étienne Vaucher in 1803. The current taxonomic concept follows the revision by Bornet and Flahault (1886–1888). Molecular phylogenetics has revealed significant cryptic diversity within what was traditionally considered *N. commune*.

**Morphological features:**

The thallus consists of macroscopic, gelatinous colonies ranging from 1–20 cm in diameter when hydrated. When dry, colonies shrink to thin, brittle, dark brown to black crusts.

Each colony contains a complex network of intertwined filaments (trichomes) embedded in a thick extracellular polysaccharide matrix. This matrix constitutes up to 80% of the colony's dry weight and provides remarkable desiccation tolerance.

Trichomes are uniseriate (single file of cells), 4–6 μm in diameter, with spherical or barrel-shaped vegetative cells. Heterocysts (nitrogen-fixing cells) are intercalary, slightly larger, and barrel-shaped.

Akinetes (resting spores) are not commonly produced. Reproduction occurs primarily through fragmentation of colonies and hormogonia (motile filament segments) that disperse to colonize new substrates.

The gelatinous matrix is composed primarily of a complex sulfated heteropolysaccharide called nostocan, which has documented water-retention and UV-protective properties.
...
*Nostoc commune* is consumed as food in several Asian cultures. In China, dried colonies are sold as *di pi* (地皮) or *ge zao er* (葛仙米藻) and rehydrated for use in soups, stir-fries, and salads.

The texture when cooked is soft and gelatinous, similar to sea vegetables. The flavor is mild and slightly earthy, absorbing the flavors of accompanying ingredients. It is commonly paired with eggs, garlic, and soy sauce in Chinese home cooking.
