...
- **Sodium channels**: Local anesthetic properties via voltage-gated sodium
  channel blockade
The rapid antidepressant mechanism is believed to involve activation of
mTOR signaling, increased synaptogenesis in the prefrontal cortex, and
restoration of glutamate homeostasis — effects that distinguish it from
conventional monoamine-based antidepressants.
## Dose-Response Effects
| Dose Range (IV/IM) | Effects |
|--------------------|---------|
| 0.1–0.5 mg/kg | Sub-anesthetic; mild dissociation, mood elevation |
| 0.5–1.0 mg/kg | Moderate dissociation, analgesia, psychedelic experiences |
| 1.0–2.0 mg/kg | Deep dissociation, anesthesia induction |
...
because it preserves respiratory drive and airway reflexes — unlike most other
general anesthetics. It is widely used in pediatric anesthesia, burn wound
