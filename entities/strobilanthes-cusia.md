...
S. cusia is distinct from true indigo (*Indigofera tinctoria*, Fabaceae) but
produces the same blue dye compound, indican, through an independent
biosynthetic pathway. It is the preferred indigo source in Chinese and
Japanese traditional dyeing practices.

## Taxonomy and Morphology

**Strobilanthes cusia** (Nees) Kuntze was originally described as *Goldfussia
...
in modern Chinese clinical practice. It is a principal ingredient in
formulations used for preventing and treating colds, influenza, and viral
pharyngitis.
