...
*Campanula uncinata* is a perennial herbaceous bellflower native to the mountains of the Balkan Peninsula. The specific epithet refers to the small hooked bracts that distinguish this species from its close relatives within the genus.
...
- **Stem leaves** are linear to narrowly lanceolate, sessile, and progressively reduced upward.
- **Flowering stems** are slender, ascending to erect, 20–40 cm tall, glabrous to sparsely pilose.
- **Bracts** at the base of the pedicels are small, recurved, and hook-tipped (uncinate), the key diagnostic character.
- **Calyx lobes** are linear-lanceolate, 3–5 mm long, spreading to slightly reflexed at anthesis.
- **Corolla** is campanulate, 1.5–2.2 cm long, pale to medium blue, occasionally white.
- **Capsule** is erect to nodding, ovoid, dehiscing by three small basal pores.

The chromosome number is 2n = 68, a hexaploid count that distinguishes it from the diploid *Campanula rotundifolia* sensu stricto (2n = 34).

Flowering occurs from June through August, with peak bloom in July at higher elevations. The species is self-compatible but predominantly outcrossing, as is typical of the *C. rotundifolia* group.

## Distribution and Habitat

*Campanula uncinata* is endemic to the mountains of central and southern Greece, with confirmed records from the Pindus range, Mount Olympus, and the Peloponnese. Isolated populations are reported from southern Albania.

The species occurs in montane to subalpine grasslands, rocky meadows, and open screes between 1,200 and 2,200 meters elevation. It grows on both calcareous and siliceous substrates but shows a preference for well-drained, stony ground with moderate moisture.

Populations are scattered and often locally abundant in favorable sites. The species is not considered threatened at present, though climate-driven habitat shifts could affect higher-elevation populations.
