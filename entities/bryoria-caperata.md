...
*Bryoria caperata* (L.) Brodo & D. Hawksw. belongs to the order Lecanorales, family Parmeliaceae, and is placed within *Bryoria* section *Caperatae*. The epithet *caperata* refers to the wrinkled or puckered surface of the branches.

Thalli are fruticose, pendulous, and range from 5 to 15 cm in length. Branching is dichotomous to subdichotomous, with the main branches reaching 0.3–0.6 mm in diameter. The surface color is dark brown to olive-brown, often appearing nearly black when dry.
...
*Peltigera* and *Nephroma* species are frequently found in the same forest stands but occupy different microhabitats — the foliose cyanolichens prefer more shaded and humid bases of trunks, while *B. caperata* occupies the better-lit mid-canopy.
...
The medulla of *Bryoria caperata* consistently contains fumarprotocetraric acid, which can be detected by a Pd spot test (yellow to orange reaction). This compound serves anti-herbivore and UV-protective functions.

Protocetraric acid may also be present in smaller quantities. The absence of norstictic and stictic acids distinguishes *B. caperata* from several morphologically similar taxa within the genus. TLC (thin-layer chromatography) is typically required for reliable chemical identification.

Some *Bryoria* species contain vulpinic acid and are toxic to mammals, but *B. caperata* has not been documented as toxic. It is not considered edible due to its tough texture and bitter taste.
