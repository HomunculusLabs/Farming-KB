...
The primary bioactive constituents include β-(1→3)(1→6)-D-glucan polysaccharides, which are concentrated in the fruiting body and mycelium. These heterogeneous polysaccharides have molecular weights ranging from 100 to over 1,000 kDa and exhibit significant immunomodulatory activity.

Triterpenoids isolated from S. linteus include inotodiol, trametenolic acid, and several lanostane-type compounds. Hispolon, a phenolic compound, has demonstrated notable antitumor activity in vitro, particularly against melanoma and breast cancer cell lines. The species also produces polyphenols, flavonoids, and ergosterol.

The distinct dark pigmentation of the context is attributable to melanin and related quinone pigments, which themselves exhibit antioxidant and radioprotective properties.

Recent studies have identified additional compounds including interfungins A and B, which are styrylpyrone-type metabolites with antibacterial properties. Proteoglycans isolated from the mycelial culture have shown anti-angiogenic effects in tumor models, suggesting a multi-target mechanism of action.

## Pharmacology

Extracts of S. linteus have shown immunostimulatory effects through activation of macrophages, dendritic cells, and natural killer cells. The polysaccharide fraction (commonly designated as PL or PLP) stimulates cytokine production including TNF-α, IL-1β, IL-6, and IFN-γ.
...
Sanghuang has been used in Chinese medicine for over 2,000 years, first recorded in the Shennong Ben Cao Jing. It was traditionally prescribed to treat hemorrhages, menstrual disorders, diarrhea, and general weakness. In Korean traditional medicine, the closely related Phellinus species (now Sanghuangporus) have been used as a folk remedy for stomach ailments and cancer.

The name "sanghuang" literally translates to "mulberry yellow," reflecting its common association with mulberry trees and the yellow-brown color of the pore surface. The scarcity and medicinal reputation of wild sanghuang have made it one of the most expensive mushrooms in Asian markets, with wild specimens selling for thousands of dollars per kilogram.
