...
## Nutrient Concentrations in Fungal Fruit Bodies

Data from Clinton et al. (1999) for Nothofagus forest:

| Element | Forest floor mushrooms | Forest floor substrate | Deadwood mushrooms | Deadwood substrate |
|---------|----------------------|----------------------|-------------------|-------------------|
| N (mg/kg) | 35 | 8.7 | 31 | 1.5 |
| P (mg/kg) | 4 | 1.0 | 5 | 0.2 |
| K (mg/kg) | 22 | 3.5 | 19 | 0.1 |
| Mg (mg/kg) | 0.8 | 0.1 | 1.6 | 0.4 |
| Ca (mg/kg) | 0.5 | 7.0 | 2.6 | 2.9 |
| C:N ratio | 13 | - | 19 | - |

Calcium is the only element more concentrated in substrate than in fungal fruit bodies on the forest floor.
...
A notable finding from Clinton et al. (1999) is that calcium is the only element more concentrated in forest floor substrate than in fungal fruit bodies:
- Forest floor mushrooms: 0.5 mg/kg Ca vs. 7.0 mg/kg in substrate (14x higher in substrate)
...
The timing of fungal fruit body production in Nothofagus forests has important implications for ecosystem nutrient dynamics:
- Spring and fall fruit body abundance may coincide with periods of high root growth and nutrient demand by trees
- Decomposition of fruit bodies is faster than surrounding forest floor material
- This creates localized pulses of nutrient release at potentially critical times for tree growth
- The correlation between fruit body production timing and tree nutrient demand has yet to be confirmed by observation
- If confirmed, this would represent an important ecosystem-level synchronization mechanism
