...
sources:
  ...
  - https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3212290/
  - https://pubmed.ncbi.nlm.nih.gov/?term=eschscholzia+californica+alkaloids
---

# Eschscholzia californica

**Eschscholzia californica**, commonly known as the **California poppy**, **golden poppy**, or **cup of gold**, is a flowering plant in the family [[papaver-somniferum|Papaveraceae]], native to the western United States and Mexico. It is the official state flower of California (designated 1903) and is widely cultivated as an ornamental annual or perennial. The species has a rich history of indigenous use and is the subject of modern pharmacological research into its sedative, anxiolytic, and mild analgesic properties. Unlike its relative the opium poppy, *E. californica* contains no morphine or codeine, though it produces a distinct profile of isoquinoline alkaloids.
...
*E. californica* contains a characteristic profile of isoquinoline alkaloids common to the Papaveraceae, though it lacks the opiate alkaloids found in [[papaver-somniferum]]:

| Compound | Class | Notes |
|----------|-------|-------|
| **Protopine** | Isoquinoline alkaloid | Major constituent; spasmolytic and mild analgesic |
| **Allocryptopine** | Isoquinoline alkaloid | Related to protopine; contributes to sedative effects |
| **Californidine** | Quaternary benzylisoquinoline | Characteristic species alkaloid; named after the plant |
| **Eschscholtzine** | Benzylisoquinoline | Precursor/related to californidine |
| **Berberine** | Protoberberine alkaloid | Antimicrobial, anti-inflammatory; concentrated in roots |
| **Chelerythrine** | Benzophenanthridine alkaloid | Minor; protein kinase C inhibitor |
| **Flavonoids** | Polyphenols | Quercetin, isorhamnetin, kaempferol derivatives; antioxidant activity |

Total alkaloid content is highest in aerial parts collected during flowering. Root material contains higher berberine concentrations.

## Traditional and Modern Uses

### Indigenous Use

Indigenous peoples of California — including the Tongva (Gabrielino), Cahuilla, Costanoan, Luiseño, and Pomo — traditionally used the plant as a sedative (decoctions to promote sleep and calmness), analgesic (topical poultices for toothache and headache), colic remedy (infusions for children), wound treatment (poultices for sores), and cosmetic (petal sap as hair tonic).
...
No large-scale clinical trials have demonstrated efficacy for psychiatric disorders in humans. Preclinical studies suggest anxiolytic-like effects in elevated plus maze models, sedative-hypnotic effects via potentiation of sleep duration, mild antinociceptive activity in pain models, and antispasmodic effects on smooth muscle.
