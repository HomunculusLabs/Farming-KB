...
The species epithet "cochlearifolia" means "spoon-leaved," referring to the concave, spoon-like shape of the small rounded leaves. It was first described by Lamarck in 1785.
...
- Genus: Campanula
- Section: Campanula
- Species: C. cochlearifolia

**Morphology:**

Campanula cochlearifolia forms low, creeping mats 2–5 cm tall. The stems are thread-like, rooting at the nodes as they spread across rock surfaces and scree.

The root system is fibrous and shallow, adapted to growing in thin layers of soil accumulated in rock crevices. Roots often penetrate only 2–5 cm into the substrate.

Leaves are small, rounded to kidney-shaped, 3–8 mm in diameter, with crenate margins. Basal leaves are borne on slender petioles, while stem leaves are smaller and nearly sessile.

The leaves are bright green, slightly fleshy, and semi-evergreen in mild winters. In severe alpine winters, the foliage may die back partially but regrows quickly in spring.

The flowers are solitary, nodding, bell-shaped, 10–15 mm long, and a clear sky-blue to lavender-blue. Each flower is borne on a slender, wiry stem that rises just above the foliage mat.

The corolla is divided into five small, rounded lobes. The calyx lobes are narrow and sharply pointed, about one-third the length of the corolla.

Occasional white-flowered plants occur in the wild and are sometimes cultivated as var. alba. These are found at low frequency in most populations but can be selected for horticultural use.

Flowering stems carry one flower each, but a single plant produces many flowering stems sequentially. In ideal conditions, a single mat may bear 50–100 open flowers simultaneously.

The fruit is a small, nodding capsule containing minute brown seeds. Seeds are dispersed by wind and by water washing over the rock surfaces where the plant grows.

## Distribution and Habitat

Campanula cochlearifolia is endemic to the mountains of central and southern Europe. Its range centers on the Alps, extending to the Pyrenees, Apennines, Jura, and Carpathians.
...
Campanula cochlearifolia is a popular alpine plant for rock gardens, troughs, and crevice gardens. It is relatively easy to grow compared to many alpines, provided its basic requirements are met.
