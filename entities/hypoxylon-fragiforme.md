...
- **Habitat:** Temperate deciduous and mixed forests, particularly old-growth beech stands with abundant coarse woody debris.
...
In some European beech forests, H. fragiforme accounts for a substantial proportion of fungal fruiting body biomass on coarse woody debris. Long-term monitoring plots in Germany and Switzerland have documented its consistent presence across decades, suggesting a stable ecological role rather than opportunistic colonization.

## Chemistry and Bioactive Compounds

H. fragiforme produces a range of biologically active secondary metabolites:
...
- **Mellein:** A dihydroisocoumarin with antifungal activity
- **Daldinone derivatives:** Quinoid metabolites with antibacterial properties
...
| Species | Primary Host | Stromata Color | Key Differentiator |
|---------|-------------|---------------|-------------------|
| H. fragiforme | Beech | Brick-red (mature) | Strawberry-shaped, beech specialist |
| H. fuscum | Birch | Dark brown | Smaller, brown ostioles |
| H. rubiginosum | Oak | Rust-red to orange | Often more pulvinate |
| H. deustum | Various hardwoods | Gray to black | Larger, less regular shape |
| H. cohaerens | Oak, beech | Purple-gray | Confluent stromata masses |
| H. rutilum | Beech, hornbeam | Orange-brown | More conical, smaller stromata |

Field identification is most reliable when both substrate (beech) and stroma maturity are considered together. Fresh material with the characteristic strawberry-like red granular surface is unlikely to be confused with any other Hypoxylon species.
