...
- **Genus:** Monotropa
- **Species:** M. uniflora L.

The genus *Monotropa* contains only two species: *M. uniflora* (Indian pipe) and *M. hypopitys* (pinesap), both of which are non-photosynthetic mycoheterotrophs.
The family placement of *Monotropa* has been revised several times. Historically, the genus was placed in its own family, Monotropaceae, but molecular phylogenetic studies using DNA sequence data from multiple chloroplast and nuclear genes have conclusively demonstrated that *Monotropa* and its relatives belong within the Ericaceae as the subfamily Monotropoideae.
...
The species was formally described by Carl Linnaeus in *Species Plantarum* (1753), based on specimens collected from temperate forests of Europe and eastern North America.
...
The mycoheterotrophic relationship of *M. uniflora* involves a complex, tripartite nutrient exchange pathway.
...
Molecular studies using stable isotope analysis have confirmed that *M. uniflora* derives its carbon exclusively from this pathway, and that the plant is highly specific in its fungal associations — it will only form a functional mycorrhizal relationship with certain species of Russulaceae and Boletaceae.
...
The plant is sensitive to forest disturbance, logging, and changes in soil chemistry that may disrupt the fungal network, and its presence is often taken as an indicator of a healthy, intact forest ecosystem with mature mycorrhizal networks.
...
In North America, the species ranges from Newfoundland and Labrador westward across Canada to British Columbia and Alaska, and southward through the eastern and western United States to California, Arizona, New Mexico, and the mountains of Mexico, as well as through Central America to Colombia.
...
The plant grows in moist, shaded, mature forests with well-developed ectomycorrhizal networks.
...
The plant is ephemeral, with the above-ground flowering stem visible for only 1–3 weeks before withering.
...
- [[russula-mycorrhizal-fungi]]
- [[forest-floor-ecology]]
- [[ectomycorrhizal-networks]]
- [[ghost-plant-ethnobotany]]
