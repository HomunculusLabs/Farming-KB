...
**Domain:** Eukaryota — **Division:** Chlorophyta — **Class:** Trebouxiophyceae — **Order:** Chlorellales — **Family:** Chlorellaceae — **Genus:** *Chlorella* — **Species:** *C. vulgaris*

Cells are spherical, ranging from 2–10 μm in diameter. A single cup-shaped chloroplast occupies most of the cell volume, giving the characteristic bright green color.

The cell wall is composed of a rigid multilayered structure rich in glucosamine, mannose, and galactose. This wall is notably resistant to digestion, which has driven commercial interest in cell-wall disruption technologies for nutritional applications.

Reproduction occurs exclusively through asexual autospore formation. Each mature cell produces 2–16 autospores within the maternal cell wall before rupture.

## Biochemical Composition

Dried *C. vulgaris* biomass typically contains 50–60% protein by dry weight, making it one of the most protein-dense organisms known. The amino acid profile is considered complete, with adequate levels of all essential amino acids except methionine.

Lipid content ranges from 5–40% of dry weight depending on cultivation conditions. Under nitrogen starvation, lipid fraction increases substantially, with elevated levels of oleic acid (C18:1), linoleic acid (C18:2), and alpha-linolenic acid (C18:3n-3).

Carbohydrates constitute 10–25% of dry biomass, primarily as starch and cellulose-like structural polysaccharides. The species also accumulates carotenoids including lutein, violaxanthin, and beta-carotene.

Notable micronutrients include vitamins B1, B2, B6, B12, C, and E. The B12 content has been debated — some studies suggest it may derive from associated bacteria rather than intrinsic synthesis.
...
**Human nutrition:** *C. vulgaris* is marketed as a dietary supplement (chlorella tablets, powder, extract). Claims include immune support, detoxification, and cholesterol reduction, though clinical evidence remains limited.

**Animal feed:** Dried biomass serves as a protein-rich feed ingredient in aquaculture, poultry, and swine diets.

In fish feed, partial replacement of fishmeal with chlorella (up to 10–15%) has shown acceptable growth performance. Improved feed conversion ratios and enhanced pigmentation in salmonids have been reported at moderate inclusion levels.
