...
Nutrient-enriched waters, particularly those with high phosphorus and nitrogen concentrations, promote explosive growth. Eutrophic farm ponds, irrigation canals, and reservoirs are the most severely affected water body types.

Salinity tolerance is very low, which prevents establishment in brackish or estuarine environments. The species is strictly a freshwater plant, though it can tolerate mildly alkaline conditions up to pH 9.
...
Chemical control using herbicides such as diquat, glyphosate, and fluridone can provide temporary suppression. However, chemical treatments are expensive, may harm non-target species, and do not prevent re-infestation from surviving fragments.
