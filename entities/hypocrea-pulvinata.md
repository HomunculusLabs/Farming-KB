...
- Produces pulvinate (cushion-shaped) stromata on polypore hosts
- Primary hosts: Fomitopsis pinicola and Piptoporus betulinus
- Frequently co-occurs with Ophiostoma polyporicola on the same sporocarp
- Ophiostoma polyporicola ascomata are often found growing out from H. pulvinata stromata
- Documented by Doi (1972) and Helfer (1991)
- Also recorded from other aphyllophorales including Antrodia and Tyromyces
...
The close physical association with Ophiostoma polyporicola — often emerging from within Hypocrea stromata — suggests a possible commensal or parasitic relationship between these two fungicolous species. This type of multi-level mycoparasitism (fungi parasitizing fungi that parasitize fungi) is characteristic of the complex food webs found on decaying wood.

## Reading notes
- This note is classified as an entity page in the local wiki.
- The page title is Hypocrea pulvinata.
