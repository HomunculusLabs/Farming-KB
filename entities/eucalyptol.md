...
- **Chemical class:** Monoterpene cyclic ether
- **Molecular formula:** C₁₀H₁₈O
- **Molecular weight:** 154.25 g/mol
- **IUPAC name:** 1,3,3-trimethyl-2-oxabicyclo[2.2.2]octane
- **CAS number:** 470-82-6
- **Structure:** Bicyclic ether with a characteristic fresh, camphoraceous
  odor
- **Boiling point:** 176 °C
...
Eucalyptol exerts its pharmacological effects through multiple
pathways:

- **Anti-inflammatory:** Inhibits NF-κB and TNF-α signaling cascades,
...
Eucalyptol is FDA-approved as an over-the-counter ingredient in
cough suppressants, mouthwashes, and topical analgesics at
concentrations of 0.05–1.0%.

Clinical studies have demonstrated efficacy in:
- **Asthma management:** 200 mg TID reduced steroid dependence in
  a randomized controlled trial (n=32, 12 weeks)
- **Chronic obstructive pulmonary disease:** Improved lung function
  markers and reduced dyspnea scores
- **Oral hygiene:** Reduced plaque formation and gingivitis as a
