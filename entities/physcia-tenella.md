...
*Physcia tenella* (Scop.) DC. is classified in the order Caliciales, family Physciaceae. The species has a complex taxonomic history with several synonyms reflecting its morphological variability across different geographic regions and substrate conditions.

The thallus is foliose and orbicular, forming rosettes 1–3 cm across with a loosely attached lower surface. Lobes are 0.5–2 mm wide, radiating from a central point, with margins that are typically ciliate with short, simple to branched hairs.

The upper surface is pale gray to almost white, pruinose, and often maculate with white spots or flecks. The lower surface is white to pale tan with sparse, simple rhizines. The medulla is white and the cortex contains atranorin.

Soredia are produced on the lobe margins or on raised soralia along the upper surface. These granular vegetative propagules are the primary means of dispersal and contribute to the species' colonizing ability.

Apothecia are produced infrequently, with brown discs 0.5–1.5 mm diameter and a thalline margin. Spores are brown, two-celled (septate), and measure approximately 16–22 × 7–10 µm, which is diagnostic for the genus.
...
*Physcia tenella* contributes to the early successional stages of bark colonization. Its efficient soredial dispersal allows rapid establishment on newly available substrates, including young trees and recently exposed bark surfaces.

The species serves as a food source for various lichen-feeding invertebrates, including specialized mites and larvae of some Lepidoptera. Its abundance in urban environments provides important habitat connectivity for these organisms in otherwise species-poor landscapes.

## Chemistry and Secondary Metabolites

*Physcia tenella* contains atranorin in the cortex, producing a yellow reaction with the KC spot test. This compound provides UV screening and is common across the Physciaceae family.

The medullary chemistry is typically negative for diagnostic substances — the K and C spot tests are negative in the medulla. This absence of medullary secondary metabolites distinguishes *P. tenella* from several closely related *Physcia* species that produce atranorin, zeorin, or other compounds in the medulla.

Chloroatranorin may be present in trace amounts in the upper cortex. The relatively simple chemistry profile of *P. tenella* reflects its generalist ecological strategy compared to more chemically specialized lichen species.
...
*Physcia tenella* is globally secure and is one of the most common lichens in temperate regions. No conservation concerns exist at the species level, and it is not listed on any regional or national Red Lists.
...
*Physcia tenella* reproduces primarily through soredia, which are produced abundantly on marginal and laminal soralia. Soredia are dispersed by wind and can colonize suitable bark surfaces within the same tree canopy or at considerable distances.

The efficiency of soredial dispersal contributes to the species' rapid colonization ability. Studies have shown that *P. tenella* can establish on newly available bark substrates within one to two growing seasons, making it a pioneer species in epiphytic succession.
