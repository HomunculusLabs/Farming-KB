...
Two main row types exist: two-row barley (H. vulgare subsp. distichon) with fertile central spikelets only, and six-row barley (subsp. vulgare) with all three spikelets fertile. Six-row types produce more grain per spike.

The grain (caryopsis) is covered by lemma and palea that may adhere tightly (hulled barley) or fall free (naked or hull-less barley). Hulled types dominate malting barley production.

Plants grow 60–120 cm tall with flat leaf blades and a hollow culm. Barley is self-pollinating, with outcrossing rates typically below 1%.
