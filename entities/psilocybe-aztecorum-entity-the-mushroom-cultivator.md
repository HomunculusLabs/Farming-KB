...
bagasse compost suggests that P. aztecorum is adaptable to a wider range of
substrates than some other Psilocybe species. Dr. Kneebone later expanded this
research to include experiments using bagasse compost for growing Agaricus
brunnescens.

## Cultivation Parameters

Detailed species-specific cultivation parameters for Psilocybe aztecorum are not
provided in The Mushroom Cultivator, as the species does not receive its own
dedicated parameter section. However, based on the composting reference and general
knowledge of the species, the following can be inferred:

- **Compost Substrate:** Sugar cane bagasse-based compost, prepared using standard
