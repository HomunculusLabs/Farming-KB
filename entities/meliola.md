...
foliicolous (leaf-inhabiting) fungi known.
...
- **Species Diversity:** The order Meliolales contains more than 1,580 species
...
- **Host Range:** Most (>90%) plant hosts are dicotyledonous angiosperms, but
  ...
  Reports on some large tropical plant families common in rain forests,
  including Orchidaceae, Gesneriaceae, and Araceae, are limited and may reflect
  under-collection rather than true absence.

- **Colony Appearance:** Colonies are dark, superficial, and circular to
  irregular patches on leaf surfaces. They can be thin or dense and velvety
  with setae. Each patch normally represents a single species colony, but
  colonies can become confluent with heavy infections. Colonies occur mostly on
  mature leaves but also on leaf petioles and young twigs. Fruit is rarely
  infected.

- **Distinctive Morphology - Setae:** The most distinctive feature of *Meliola*
  is the presence of mycelial setae — dark, stiff, bristlelike structures that
  arise laterally from hyphal cells and immediately bend to assume a
  perpendicular position. Setose colonies tend to collect debris such as pollen
  and insect frass that absorbs water (Parbery and Brown 1986).

- **Hyphopodia:** Black mildew hyphae feature short, two-celled lateral branches
  called hyphopodia, which can be either mucronate or capitate. These are
  distributed in opposite, alternate, or mixed arrangements at the ends of
  hyphal cells. A fine hyphal filament beneath the hyphopodium penetrates the
  host cell wall to produce an haustorium within the host cell.

- **Ascomata and Spores:** Ascomata are darkly pigmented, either cleistothecia
  or perithecia, and may have appendages. Ascospores are dark brown, usually
...
- **[[geographic-distribution-of-psilocybe-species]]:** Most diverse in the tropics, where they are most
  ...
  especially abundant in naturally or anthropogenically disturbed areas.

- **Hyphal Characteristics:** Most *Meliola* species produce hyphae of a uniform
  6-10 micrometer diameter and have a characteristic branching pattern. This
  contrasts with sooty molds, which have more variable hyphal morphology.
...
- Hansford, C.G. 1961. The Meliolineae: a monograph. Sydowia Beih.
- Hansford, C.G. 1963. Icones Fungorum Meliolinearum.
- Hawksworth, D.L. et al. 1995. Ainsworth and Bisby's Dictionary of the Fungi.
- Parbery, D.G. and Brown, J.F. 1986. Sooty moulds and black mildews.
