...
Cosmospora is a genus of fungicolous ascomycetes in the family Nectriaceae (Hypocreales), formerly classified within the large and heterogeneous genus Nectria (subgenus Dialonectria, formerly the N. episphaeria-group). The genus was redefined by Rossman et al. (1999) as part of a major taxonomic revision that split Nectria into several distinct genera. Cosmospora contains approximately 60 species, most of which are fungicolous — growing on the sporocarps or mycelium of other fungi.
...
- Contains approximately 60 species, most fungicolous
- Formerly classified as Nectria subgenus Dialonectria (N. episphaeria-group)
...
- Cosmospora vilior — common on old Hypoxylon stromata and polypores, with Acremonium berkeleyanum anamorph
- Cosmospora coccinea — found on Inonotus species
- Cosmospora purtonii — polypore-associated with Fusarium aquaeductuum anamorph
- Cosmospora leptosphaeriae — host-specific to Leptosphaeria
- Cosmospora ganymede — reported from the rhytismataceous fungus Zeus olympius

## Reading notes
- This note is classified as an entity page in the local wiki.
- The page title is Cosmospora.
...
- Existing wikilink already present on this page: [[leptosphaeria]].
