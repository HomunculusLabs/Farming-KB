...
updated: 2026-04-28
sources:
  - Hofmann, A. (1978). "Ergot alkaloids — their pharmacology and
    therapeutic use." British Journal of Anaesthesia, 50(9), 875-884.
  - Schardl, C.L. et al. (2006). "Ergot alkaloids — biology and molecular
    biology." Alkaloids: Chemical and Biological Perspectives, 63, 45-86.
  - Tfelt-Hansen, P. (2001). "Ergotamine, ergometrine and
    dihydroergotamine." In: The Headaches, 3rd ed. Lippincott.
  - Stoll, A. & Burckhardt, W. (1935). "Die Alkaloide des Mutterkorns."
    Helvetica Chimica Acta, 18(1), 636-645.
---
...
ergot alkaloid and one of the principal active constituents of ergot, the
sclerotium of *Claviceps purpurea*. First isolated in 1935 by Arthur Stoll and
...
to lysergic acid diethylamide (LSD), ergometrine occupies a pivotal position
in the history of both obstetric medicine and psychedelic pharmacology.

## Chemical Identity

| Property | Value |
|----------|-------|
| IUPAC name | (8β)-9,10-Didehydro-6-methylergoline-8-carboxamide |
| CAS number | 60-79-7 |
| Molecular formula | C₁₉H₂₃N₃O₂ |
| Molecular weight | 325.4 g/mol |
| Melting point | 162°C (decomposes) |

### Structure-Activity Relationships

- **Ergoline nucleus**: Tetracyclic ring system responsible for affinity at
  5-HT, dopamine, and adrenergic receptors.
- **C-8 amide**: Essential for uterotonic and vasoconstrictive activity.
  Substitution with diethylamide yields LSD — profoundly different
  pharmacological character.
- **C-6 methyl group**: Present in all natural ergot alkaloids; contributes
...
- **Ipomoea tricolor** (Morning Glory): Minor constituent alongside ergine.
- **Rivea corymbosa** (Ololiuqui): Similar alkaloid profile.
- **Argyreia nervosa** (Hawaiian Baby Woodrose): Trace amounts alongside
  higher ergine concentrations.

## Medical Use

### Postpartum Hemorrhage

Primary indication. Ergometrine maleate (0.5 mg IM or IV) administered
immediately after delivery. Onset: 2-5 min (IM), 30-60 sec (IV). Duration:
2-4 hours. Reduces blood loss ~40-50% vs placebo.

### Comparison with Oxytocin

| Property | Ergometrine | Oxytocin |
|----------|-------------|----------|
| Duration | 2-4 hours | 30-60 min |
| Contraction type | Sustained tonic | Rhythmic |
| Vasoconstriction | Significant | Minimal |
| Side effects | Nausea, hypertension | Minimal |

### Contraindications

Pregnancy (before placental delivery), severe hypertension, pre-eclampsia,
cardiovascular disease, peripheral vascular disease, sepsis.

## Toxicity and Ergotism

Ergometrine contributes to **ergotism** (St. Anthony's Fire), the disease from
chronic ergot ingestion.

- **Gangrenous ergotism**: Severe peripheral vasoconstriction → ischemia →
