...
sources:
  ...
  - "Caroline, M. (2014). Companion Planting. Fox Chapel Publishing."
---
...
- **Mandala gardens (Java, Indonesia)**: Circular garden designs incorporating diverse companion plantings for food security.
...
### 1. Pest Suppression (Push-Pull and Masking)

Plants protect neighbors through multiple mechanisms:
...
- **Trellising**: Tall crops (corn, sunflowers, Jerusalem artichokes) provide structural support for climbing plants (beans, cucumbers, Malabar spinach).
...
Some plants release biochemical compounds that influence the growth of neighboring species:

| Plant | Allelopathic Effect | Companion Implication |
|-------|--------------------|-----------------------|
| **Black walnut** | Releases juglone — toxic to many species | Avoid planting tomatoes, potatoes near walnut trees |
| **Sunflower** | Seed hulls contain toxins | Good companion for corn; avoid near potatoes and beans |
| **Wormwood** | Absorbs water aggressively, releases absinthin | Useful as pest repellent border; keep away from most vegetables |
| **Fennel** | Inhibits growth of many garden plants | Best grown alone; compatible only with dill (though cross-pollinates) |
...
| **Nasturtium** | Trap crop for aphids; repels whiteflies |

### Antagonistic Pairings to Avoid
- **Tomatoes + potatoes**: Both susceptible to early and late blight; shared disease risk
- **Beans + onions**: Onions inhibit nitrogen-fixing bacteria on bean roots
- **Cabbage + grapes**: Grape vines can inhibit cabbage growth
- **Fennel + most vegetables**: Fennel is a poor companion to nearly all garden plants

## Guild Design in Permaculture

In permaculture, companion planting is formalized as **plant guilds** — curated assemblages of species that collectively fulfill multiple ecological functions:

### Apple Tree Guild Example

| Role | Species | Function |
|------|---------|----------|
| **Canopy** | Apple (*Malus domestica*) | Primary crop; habitat |
...
Meta-analyses of companion planting research show:

- **Yield advantage**: Intercropping systems produce 20–30% more total yield per unit area compared to monocultures (land equivalent ratio > 1.0 in most studies)
- **Pest reduction**: Companion planting reduces pest populations by 30–60% in well-designed systems, particularly for aphids, cabbage white butterflies, and Colorado potato beetles
- **Soil health**: Polyculture systems show increased soil organic matter (15–25% higher), improved water retention, and enhanced microbial diversity compared to monocultures
- **Biodiversity**: Companion-planted gardens support 2–3× more beneficial insect species than monocultures

## Implementation Guidelines

### Planning Principles
1. **Observe before planting**: Understand existing soil, light, wind, and water patterns
2. **Maximize diversity**: Aim for 5+ species in any planting area
3. **Layer vertically**: Incorporate canopy, understory, herbaceous, ground cover, and root layers
4. **Include nitrogen fixers**: Every garden bed benefits from at least one legume
5. **Plan for succession**: Stagger planting times for continuous harvests and habitat
6. **Incorporate aromatic herbs**: Many pest-repellent companions are culinary herbs — dual-purpose plantings
7. **Leave space for beneficial insects**: Include umbelliferous flowers (dill, fennel, yarrow, Queen Anne's lace) as insectary plants
