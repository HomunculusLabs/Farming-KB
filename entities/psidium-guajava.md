...
**Psidium guajava** L., known as guava, is a small evergreen tree in the family Myrtaceae native to tropical the Americas. It is one of the most widely cultivated tropical fruits globally, grown commercially across India, Brazil, Thailand, Mexico, and the Caribbean.

Guava is distinguished by its high vitamin C content, aromatic pulp, and multiple culinary applications. The fruit, leaves, and bark have a long history of use in traditional medicine across Asia, Africa, and Latin America.

Trees typically reach 3–10 meters in height and produce fruit year-round in tropical climates. The species has naturalized widely and is considered invasive in some Pacific and Indian Ocean islands.

## Taxonomy and Morphology

**Classification:** Plantae → Magnoliophyta → Magnoliopsida → Myrtales → Myrtaceae → Psidium → P. guajava.

**Authority:** Carl Linnaeus, first described in Species Plantarum (1753). The genus Psidium contains approximately 100 species, with P. guajava being the most economically important.

Young branches are four-angled and covered with fine, pubescent bark. Mature bark is smooth, pale brown to grey, and flakes in thin patches.

Leaves are opposite, simple, elliptic to obovate, 5–15 cm long, with prominent lateral veins. The upper surface is dark green and glabrous; the lower surface is paler with a dense pubescence.

Flowers are solitary or in small axillary cymes, with 4–5 white petals approximately 2 cm long. The numerous stamens form a conspicuous brush-like cluster.

Fruits are round, ovoid, or pear-shaped berries, 4–12 cm in diameter. Skin color ranges from pale yellow to deep pink depending on variety. The pulp may be white, pink, or red, containing numerous small, hard, yellowish seeds.
...
Guava is most commonly propagated by seed, though air-layering, grafting, and stem cuttings are used for commercial orchards to maintain cultivar characteristics. Seedling trees begin bearing in 2–4 years.
...
In Ayurvedic medicine, guava fruit is valued for its astringent, digestive, and heart-strengthening properties. The leaves are prescribed for diarrhea, dysentery, and as a wound wash.
