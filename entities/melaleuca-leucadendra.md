...
The papery bark has been used by Aboriginal Australians for wrapping food, lining containers, and as a bedding material. Traditional uses also include using the bark as makeshift bandages and roofing material for temporary shelters.

## Taxonomy and Morphology

**Melaleuca leucadendra** was described by Carl Linnaeus in 1759, making it one of the earliest named Melaleuca species. The specific epithet derives from Greek *leukos* (white) and *dendron* (tree), referring to the white bark.
...
The bark is thick, papery, and exfoliating in broad, layered sheets, ranging from white to cream or pale brown. This paperbark characteristic is shared with other Melaleuca species and is the origin of the common name.

Bark layers can accumulate to a thickness of 2–5 cm and are highly water-resistant. This insulating property protects the cambium from fire, allowing the tree to survive low-intensity grass fires that are common in its native habitat.
...
Cajeput oil is steam-distilled from the fresh leaves and twigs, yielding 0.5–1.5% by weight. The oil is colorless to pale yellow with a characteristic camphoraceous, slightly medicinal aroma.

Distillation is typically carried out on a small scale by rural producers in Indonesia and Vietnam. The oil quality varies with chemotype, harvest season, and distillation technique.
