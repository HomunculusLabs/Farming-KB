...
Full chemical name: 2-Methoxy-4-methyl-5-methylsulfinylamphetamine.

The name TOMSO follows the pattern: TOM for the parent compound (2-methoxy-4-methyl-5-methylthioamphetamine) plus SO for sulfoxide.
...
The hydrochloride salt melts at 227-229 degrees Celsius after vacuum drying for 24 hours.
...
TOMSO is essentially inactive when taken alone at doses up to 150 mg.

However, when combined with alcohol, it produces dramatic psychedelic effects.

## Qualitative Effects

At 100 mg alone, no effects were observed.
...
Remarkable time-slowing was experienced, and the overall experience was described as favorable.

At 150 mg alone, at best a threshold effect was observed going nowhere.

After drinking a tall drink containing 3 oz of vodka, the subject became a "rolling plus three" lasting until well after midnight.

The effect was "not an alcohol response" but something dramatically different.

## The Alcohol Interaction

The most striking feature of TOMSO is its interaction with alcohol.

A compound that is essentially inactive alone becomes a potent psychedelic when combined with ethanol.

This phenomenon is attributed to the alcohol "kindling and promoting" the TOMSO to active status.

The mechanism is not well understood but may involve metabolic pathways shared between ethanol and the sulfoxide group.

This represents an unusual and potentially dangerous pharmacological interaction.

## Research Context

TOMSO was synthesized to investigate the extraordinary sensitivity of one individual to 5-TOM.

The hypothesis was that this individual might be an unusually efficient metabolizer of sulfur-containing compounds, producing the sulfoxide metabolite TOMSO as the actual active agent.

Two approaches were taken to investigate this hypothesis.

The first approach attempted to trace the metabolic fate of a model sulfur compound (4-tert-butyl thioanisole) but was abandoned when no metabolites could be detected in urine.

The second approach was to synthesize the putative active metabolite (TOMSO) and test it directly.

## Synthesis

The synthesis begins with 1-(2-methoxy-4-methyl-5-methylthiophenyl)-2-nitropropene (the nitrostyrene precursor to 5-TOM).
