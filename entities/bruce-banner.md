...
**Breeding notes:** Multiple phenotypes and cut numbers exist under the Bruce Banner name. The most sought-after versions include:
- **Bruce Banner #1** — heavier, more indica-leaning phenotype
- **Bruce Banner #3** — the most popular and widely distributed cut, considered the "truest" expression; highest THC, best balance of cerebral and physical effects
- **Bruce Banner #4** — a more balanced 50/50 phenotype with pronounced diesel aroma
