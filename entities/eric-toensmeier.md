...
updated: 2026-04-28
sources:
  - https://www.google.com/search?q=eric+toensmeier+permaculture+biography
  - https://www.perennialsolutions.org/about/
  - https://www.yaleenvironment360.org/authors/eric-toensmeier/
...
- **Education:** Studied at the University of Massachusetts; informal training through permaculture design courses and hands-on practice
- **Career:** Transitioned from landscaper to author, researcher, and international consultant on perennial food systems
- **Current roles:** Lecturer at Yale School of the Environment (intermittent); Senior Fellow, Project Drawdown (2015–present); Director, Perennial Solutions
...
**Edible Forest Gardens** (Chelsea Green, 2005) — with Dave Jacke (2 volumes)
- Seminal two-volume work on temperate-zone food forest design
- Volume 1: Vision and Theory — ecological principles, forest architecture, guild design
- Volume 2: Design and Practice — species selection, implementation, maintenance
- Widely considered the most thorough treatment of food forest ecology ever published
- Over 1,000 pages of detailed design guidance

**Paradise Lot: Two Plant Geeks, One-Tenth of an Acre, and the Making of an Edible Garden Oasis in the City** (Chelsea Green, 2013) — with Jonathan Bates
- Memoir and practical guide documenting the transformation of a degraded urban lot in Holyoke, Massachusetts
- Demonstrates intensive perennial polyculture on a small residential scale
- Inspired a generation of urban food forest practitioners
