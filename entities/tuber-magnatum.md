...
sources:
  ...
  - Mello, A., et al. (2006). "Tuber magnatum Pico: a review of its biology and ecology." Journal of Applied Microbiology, 101(2), 267-279.
...
These compounds are responsible for the characteristic garlicky, cheesy, and deeply earthy fragrance that distinguishes it from all other truffles.
...
- **Family:** Tuberaceae
- **Genus:** Tuber
- **Species:** T. magnatum Pico (1788)

**Synonyms:**
- Tuber Magnum Pico (original publication)
- Tuber gemmatum Batsch (non-valid)
...
Mycorrhizal root tips are pale yellow to cream, with a distinctive monopodial-pinnate branching pattern and an emanating hyphal mantle. The mantle surface is covered with a dense weft of hyphae forming a felt-like texture.

## Volatile Organic Compounds

The aroma profile of T. magnatum is its most commercially significant attribute. Major VOCs identified include:

- **Dimethyl sulfide (DMS):** Most abundant; responsible for the garlic/onion note
- **Bis(methylthio)methane:** Adds depth to the alliaceous character
- **2,4-Dithiapentane:** Characteristic truffle sulfur note
- **Methanethiol:** Pungent, sulfurous background
- **3-Methylbutanal:** Malty, fruity undertone
- **2,3-Butanedione (diacetyl):** Buttery quality
- **Phenylacetaldehyde:** Floral, honey-like nuance

The volatile profile changes rapidly after harvest — within 3–5 days, the characteristic sulfur compounds degrade significantly, which is why white truffles must be consumed as fresh as possible. Frozen or preserved specimens lose the signature aroma almost entirely.

## Harvesting and Market

White truffles are harvested from late September through January, with peak season in October and November. Harvesting requires trained dogs (traditionally *Lagotto Romagnolo*) due to the subterranean growth habit — truffles form 5–30 cm below the soil surface.

Key market facts:
- Average wholesale price: €2,000–5,000/kg (varies annually)
- Record auction price: €210,000 for a 1.5 kg specimen (2014, Hong Kong)
- Annual Italian harvest: 20–100 tonnes (highly variable year-to-year)
- Price volatility is extreme and correlated with autumn rainfall
- The Alba International White Truffle Fair is the world's premier market event
...
- **Tuber aestivum** — Summer/burgundy truffle; wider distribution, lower value
- **Tuber borchii** — Bianchetto truffle; similar appearance but milder aroma
- **Tuber macrosporum** — Smooth black truffle; similar season, strong garlic aroma
- **Tuber brumale** — Winter truffle; often found in same habitats, inferior flavor
