...
- **Family:** Asteraceae
- **Genus:** Carthamus
- **Species:** C. tinctorius L.
- **Synonyms:** Carthamus oxyacantha Bieb. (wild progenitor)

The genus name likely derives from the Arabic *qurtum* or Hebrew *kartom*, referring to the dye property. The specific epithet *tinctorius* means "used for dyeing," reflecting its primary historical use. Domestication occurred approximately 4,500 years ago in the Fertile Crescent region, with the wild progenitor identified as C. oxyacantha.

**Growth habit:** Erect annual, 30–150 cm tall, highly branched. The central stem is stout and grooved, with spiny lateral branches.

**Leaves:** Alternate, sessile or short-petiolate, oblong to lanceolate, 3–12 cm long. Basal leaves are entire; upper leaves become pinnately lobed with sharp terminal spines. The spines are a distinguishing feature from the visually similar saffron crocus.
...
Safflower produces several bioactive compound classes across different plant tissues.

**Seed oil composition (high-linoleic type):**

| Fatty Acid | Percentage |
|------------|-----------|
| Linoleic acid (ω-6) | 70–80% |
| Oleic acid (ω-9) | 10–15% |
| Palmitic acid | 5–8% |
| Stearic acid | 2–3% |

**Seed oil composition (high-oleic type):**

| Fatty Acid | Percentage |
|------------|-----------|
| Oleic acid (ω-9) | 70–80% |
| Linoleic acid (ω-6) | 10–15% |
| Palmitic acid | 4–7% |
| Stearic acid | 2–4% |
