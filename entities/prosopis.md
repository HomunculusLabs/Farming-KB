...
- **Genus**: Prosopis
- **Notable species**: *P. juliflora*, *P. glandulosa* (honey mesquite), *P. alba* (white mesquite), *P. chilensis*, *P. cineraria* (khejri)

## Key Facts

- Deep-rooted nitrogen-fixing trees that can access water tables at depths exceeding 50 meters in some species.
- Pods are edible and highly nutritious, containing 10–30% protein and 30–60% sugars, used as human food and animal fodder for millennia.
...
- *P. juliflora* has become a serious invasive species in parts of Africa, Australia, and South Asia, forming dense thickets that exclude native vegetation and reduce pasture productivity.
- Thorns on many species can be hazardous to livestock and humans; thornless cultivars have been developed.
- Deep roots can access water tables that shallow-rooted plants cannot, potentially drawing down water resources in very arid areas.

## Cultivation Notes

- Propagates from seed; scarification or hot water treatment improves germination.
- Drought-resistant once established; requires minimal irrigation after the first year.
- Can be coppiced for fuelwood and managed as a multi-purpose agroforestry component.
- Pod harvest timing is critical: pods should be collected from the ground after natural drop for best quality.
