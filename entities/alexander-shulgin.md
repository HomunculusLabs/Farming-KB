...
This paper systematically predicted:
...
## Drug Family Analysis (from Future Drugs)

### Opiate Substitutes
Shulgin identified multiple chemical families exploitable for heroin substitution:
- **Morphinans** (dextromethorphan family): N-phenethyl substitution yields compounds 20-40x morphine potency in primates
- **Benzomorphans** (pentazocine/Talwin family): Originally thought to lack abuse potential; later proven to cause hallucinations
- **Oripavine derivatives** (etorphine/M-99): 10,000x morphine potency; used as animal immobilizers
- **Meperidine analogs**: Over 4,000 described compounds in scientific literature with potential abuse utility
- **Open-chain analogs** (methadone family): Piperidinyl derivatives 1,500x methadone potency, much longer acting
- **Benzimidazoles**: Up to 1,000x morphine potency with identical dependence liability
...
### Depressant Families
- **Non-barbiturate hypnotics**: Glutethimide (Doriden) and methyprylon -- chemically distinct from barbiturates but pharmacologically identical, creating legal classification gaps
- **Methaqualone** (Quaalude): Synthesized from acetylanthranilic acid + substituted aniline; unlimited derivative potential
- **Benzodiazepines**: Librium and Valium abuse potential well documented but not scheduled at time of writing
- **Phencyclidine (PCP)**: Easy synthesis from inexpensive precursors; N-ethyl and thiophene analogs already appearing on illicit market outside controlled substance lists

### Hallucinogen Classification
Shulgin categorized hallucinogens into three qualitative families based on their phenomenology:
- **Indoles** (DMT, harmaline, LSD): Distortions arising from within the subject; intuitive and interpretive changes
- **Phenethylamines** (mescaline, DOM/STP, 2C-B): Sensory changes involving external world; perceptual syntheses
- **Atropine analogs** (JB-318, JB-336, benzilates): Artificial visual/auditory phenomena beclouded by amnesia; disruptive agents
...
Shulgin's systematic approach to psychedelic pharmacology -- synthesizing, testing, documenting, and publishing -- created the foundational reference works for an entire field. His work is cited in [[psychedelic-compounds-reference]] and remains essential to psychopharmacology research. His drug scheduling analysis in [[shulgin-designer-drugs-analysis]] proved remarkably prescient about the designer drug era.

## Related
[[mdma-reference]], [[dmt-reference]], [[psychedelic-compounds-reference]], [[shulgin-designer-drugs-analysis]]
