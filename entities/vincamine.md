...
Molecular formula: C₂₁H₂₆N₂O₃; Molecular weight: 354.44 g/mol; IUPAC name: ethyl (3α,14β,16α)-eburnamenine-14-carboxylate.

Vincamine belongs to the eburnamine class of indole alkaloids, structurally related to the iboga and aspidosperma alkaloid families. The core structure consists of a pentacyclic ring system combining a fused indole moiety with a piperidine and a seven-membered ring.
...
Vincamine is biosynthesized in plants through the strictosidine pathway common to monoterpenoid indole alkaloids. The biosynthetic route begins with the condensation of tryptamine (derived from tryptophan) and secologanin (a monoterpene glucoside) to form strictosidine.

Downstream enzymatic steps include hydroxylation, epoxide formation, and rearrangement catalyzed by cytochrome P450-dependent oxidoreductases. The specific P450 enzymes responsible for the eburnamine-type cyclization in Voacanga and Vinca species have been partially characterized through transcriptomic studies.

Voacanga africana, a tree native to West and Central Africa, is the primary commercial source of vincamine. The bark and seeds contain 0.5–1.5% vincamine by dry weight, with higher concentrations in the seeds. Vinca minor contains lower concentrations (0.1–0.3%) in the aerial parts.

## Synthesis

Commercial vincamine is produced primarily through extraction from Voacanga africana plant material, though several total syntheses have been reported in the literature. The biomimetic approach, developed by Szatmári and colleagues, mimics the plant biosynthetic pathway through a Pictet-Spengler reaction followed by a series of stereoselective cyclizations.

Semi-synthetic routes from tabersonine (abundantly available from Voacanga africana) represent the most practical laboratory-scale preparation. These routes typically involve hydroxylation, rearrangement, and esterification steps with overall yields of 8–15%.

Vinpocetine, the apovincaminic acid ethyl ester derivative, is produced semi-synthetically from vincamine through acid-catalyzed cleavage of the eburnamine ring system followed by re-esterification. Vinpocetine shows superior oral bioavailability (50–60%) and longer half-life (6–8 hours) compared to vincamine.
