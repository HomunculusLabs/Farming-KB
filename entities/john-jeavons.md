...
John Jeavons is an American agricultural researcher, author, and director of Ecology Action, best known as the developer of the Grow Biointensive method of sustainable mini-farming. His work focuses on enabling people to grow a complete diet using minimal land, water, and resources, making him a central figure in the sustainable agriculture and small-scale food production movements.
...
The Grow Biointensive method (originally called the "Biointensive method" and based on Alan Chadwick's French Intensive/Biodynamic approach) is a complete, closed-system approach to small-scale food production. It is designed to:

- Grow the maximum amount of food on the minimum area of land
- Use 67% to 88% less water than conventional farming
- Use 50% to 100% less purchased fertilizer
- Use up to 99% less energy than commercial agriculture
- Produce 2 to 6 times more food per unit of area

### Eight Core Components

1. **Deep soil preparation**: Double-digging beds to a depth of 24 inches, creating loose, well-aerated soil that promotes deep root growth and maximizes microbial activity.

2. **Composting**: Intensive compost production using crop residues and other organic materials. The goal is to close the nutrient cycle within the growing area, minimizing external inputs.
...
4. **Companion planting**: Strategic interplanting of compatible species to enhance growth, deter pests, and maximize space utilization.
...
- **Compost preparation**: Detailed guidance on building and managing compost piles using the biointensive approach.
...
The book has been translated into numerous languages and is used as a textbook in agricultural programs worldwide.

## Global Impact

The Grow Biointensive method has been adopted in over 150 countries through:
