...
found along trails, forest edges, and in secondary growth forests.

It prefers acidic substrates and is common on sandy or gravelly soils,
rotting logs, and at the bases of oak, pine, and other trees. Elevational
range is from sea level to approximately 1500 m.

C. cristatella is relatively tolerant of moderate air pollution compared
to many other macrolichens. This tolerance allows it to persist in
suburban and semi-urban environments where more sensitive species have
declined.
...
The bright red apothecia may serve a dispersal function, attracting
invertebrates that transport spores to new substrates. However, the
primary dispersal mechanism is wind-borne ascospore release.

## Chemistry and Secondary Metabolites

Cladonia cristatella contains rhodocladonic acid as its characteristic
pigment, responsible for the bright red color of the apothecia. This
compound is nearly unique to C. cristatella and a few closely related
species in the C. cristatella group.

The medulla contains fumarprotocetraric acid and protocetraric acid as
the major secondary metabolites. Spot tests yield: medulla K+ yellow,
C-, PD+ red to orange. The podetia cortex is K+ yellow.

The red pigment rhodocladonic acid is concentrated in the apothecial
disc and margin. It has been studied as a natural dye pigment and shows
some antioxidant activity in laboratory studies.

Chemistry is important for distinguishing C. cristatella from other
Cladonia species with red apothecia, such as C. macilenta (contains
 thamnolic acid) and C. diversa (contains squamatic acid).

## Similar Species

Cladonia cristatella is most similar to C. macilenta, which also has
red apothecia on slender podetia. C. macilenta has thamnolic acid in the
medulla (K+ yellow → turning yellowish, PD+ bright yellow) and
typically grows on bark rather than soil.

C. diversa is a closely related species found primarily in western North
America. It differs in chemistry (squamatic acid) and podetia that are
more extensively branched. C. floerkeana has brown apothecia rather than
red.

C. pyxidata has brown to pale apothecia and cup-shaped podetia, lacking
the bright red pigment entirely. C. fimbriata has soredia along the
podetia margins, which C. cristatella lacks.
