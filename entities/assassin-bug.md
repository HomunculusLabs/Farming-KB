...
Assassin bugs (family Reduviidae) are predatory true bugs recognized by their elongated heads, narrow necks, and curved, robust beak (rostrum) used for impaling prey. They are among the most effective generalist predators in the garden, actively hunting a wide variety of insect pests. Most species are medium to large insects, typically dark brown to black, and some have distinctive body shapes that aid in camouflage among foliage and bark.

## Classification

- **Order**: Hemiptera (true bugs)
- **Family**: Reduviidae
- **Common genera**: *Zelus*, *Pselliopus*, *Arilus*, *Sinea*
- **Type**: Predatory true bug (beneficial)

## Key Facts

- Generalist predators that actively hunt flies, mosquitoes, caterpillars, aphids, leafhoppers, and other insects
- Use powerful front legs to grasp prey, then inject digestive enzymes through their rostrum and suck out the liquefied contents
- Some species use sticky secretions on their front legs to help trap prey
...
- **Handle with caution**: Assassin bugs can bite defensively — the bite is painful but not dangerous
- Provide overwintering habitat through permanent mulch layers and standing dead plant material
- Avoid all broad-spectrum insecticides
- Maintain diverse plantings that support a variety of prey species
- Tolerate minor pest populations to maintain the prey base that sustains assassin bugs
- Learn to recognize nymphs — they look quite different from adults but are equally beneficial

## Relationships

- **Prey**: Flies, mosquitoes, caterpillars, aphids, leafhoppers, Japanese beetles, various insect larvae
- **Predators**: Birds, spiders, other assassin bugs (opportunistic cannibalism)
- **Confused with**: Kissing bugs (a subset of assassin bugs in genus *Triatoma* that feed on vertebrate blood — rare in garden settings)
- **Allies**: Spined soldier bugs, green lacewings, ladybird beetles, ground beetles, braconid wasps
...
Assassin Bug represents an important subject within its field of study.
