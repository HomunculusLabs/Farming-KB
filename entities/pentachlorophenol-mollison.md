...
- **Category**: Chlorinated phenol
- **Chemical formula**: C6HCl5O
- **Molecular weight**: 266.34 g/mol
- **CAS number**: 87-86-5
- **Class**: Biocide, wood preservative, herbicide
...
- More soluble at higher pH (exists as pentachlorophenate anion above pH 5), affecting its mobility in soils and water.
- Bioaccumulates in aquatic food chains.
- Production and use have been heavily restricted or banned in many countries since the 1980s-1990s.
...
- **Human health**: Acute exposure causes fever, sweating, respiratory distress, and can be fatal. Chronic exposure is linked to liver and kidney damage, and cancer.
- **Ecological impact**: Highly toxic to fish (LC50 values often below 0.1 mg/l), invertebrates, and aquatic plants.
- **Persistence**: Resists biodegradation under anaerobic conditions; more readily degraded aerobically in the presence of adapted microbial communities.
- **Mobility**: Moderately mobile in soils, can contaminate groundwater.
...
Pentachlorophenol finds application across multiple domains,
...
Understanding pentachlorophenol within broader ecosystem dynamics reveals
...
When incorporating pentachlorophenol into permaculture or land management plans,
