...
Additional morphological differences include the resinous glandular pubescence typical of Gaylussacia, which is absent or sparse in most Vaccinium species. The anthers of Gaylussacia also lack the elongated awns (appendages) present in many Vaccinium species, a feature visible with hand lens examination of fresh flowers.

## Morphology

Gaylussacia ursina is an erect, deciduous shrub typically growing 30–90 cm tall, occasionally reaching 1.2 meters in sheltered, moist sites. The overall habit is compact and rounded, with multiple stems arising from a persistent woody base. The bark on older stems is reddish-brown and exfoliating in thin strips.
...
Flowers are borne in short, axillary racemes of 1–3 flowers, appearing from May to June. Individual flowers are urceolate (urn-shaped), 5–7 mm long, white to pale pink, with a constricted corolla opening. The calyx is persistent and glandular, and the corolla is slightly longer than the calyx. Pollen is released through terminal pores in the anthers, typical of Ericaceae.

Fruits are globose berries 6–9 mm in diameter, dark blue to nearly black at maturity, with a dull, glaucous surface. Each berry contains exactly 10 hard stone cells (nutlets), which are the diagnostic feature separating Gaylussacia from Vaccinium. The fruit ripens from July through September and is edible, with a sweet-tart flavor similar to other huckleberries.

The stone cells are small, hard, and tan-colored, creating the slightly gritty texture characteristic of huckleberry fruits. They are easily noticeable when eating the berries raw but become less apparent when the fruit is cooked or processed. Berry yield per plant is variable, ranging from a few grams to over 50 grams in vigorous, open-grown specimens.

## Distribution and Habitat

Gaylussacia ursina is endemic to the southern Appalachian Mountains of the eastern United States. Its range extends from southwestern Virginia through western North Carolina, eastern Tennessee, northern Georgia, and into northern Alabama. The species is largely restricted to high-elevation sites above 600 meters, with most populations occurring between 900 and 1,800 meters.

The core of the species' distribution is in the Blue Ridge Mountains of North Carolina and Tennessee, where it is locally abundant in suitable habitat. Populations in Virginia and Alabama represent the northern and southern extremes of the range, respectively. The species is absent from the Great Smoky Mountains National Park at elevations below about 1,000 meters.

Elevational distribution follows a pattern typical of southern Appalachian endemics, with peak abundance in the oak-heath zone between 1,000 and 1,500 meters. Above this zone, populations become scattered and restricted to sheltered microsites. The species is generally absent from the highest summits and ridgelines, where harsh winter conditions and excessive wind exposure limit woody plant growth.
...
Gaylussacia ursina is an understory shrub that thrives in the partial shade of montane forest canopies. It is most abundant in forest openings, along trail edges, and on exposed ridges where light levels are moderate to high. The species is shade-tolerant but produces significantly more fruit in open conditions than under closed canopy.

The flowers are primarily pollinated by native bees, including bumblebees (Bombus spp.) and small solitary bees. The urceolate corolla shape restricts access to insects capable of vibrating the anthers (buzz pollination), a trait shared with many Vaccinium and Gaylussacia species. Honeybees are less effective pollinators due to their difficulty accessing the nectar.

Flowering phenology is closely tied to elevation, with lower-elevation populations blooming 2–3 weeks earlier than those at the upper limit of the species' range. This elevational stagger extends the overall flowering season across the landscape, benefiting pollinator populations that move between elevations during the foraging season.

Fruit dispersal is primarily by birds and mammals. American black bears (Ursus americanus) are particularly important dispersers, consuming large quantities of berries during late summer and fall. Other mammalian dispersers include raccoons, foxes, chipmunks, and mice. Bird species that consume the fruit include ruffed grouse, wild turkey, thrushes, and bluebirds.

Passage of seeds through the digestive tract of mammals and birds enhances germination rates by scarifying the seed coat. Seeds deposited in animal scat are often deposited in nutrient-rich microsites favorable for seedling establishment. This mutualistic dispersal relationship has likely contributed to the species' persistence in fragmented montane landscapes.
