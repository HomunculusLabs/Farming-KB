...
- **Disease type**: Fungal foliar disease (systemic within individual leaves)
- **Causal organism**: Taphrina deformans
- **Taxonomy**: Ascomycota, Taphrinomycetes, Taphrinales, Taphrinaceae
- **Host range**: Primarily peach (Prunus persica) and nectarine (Prunus persica var. nucipersica); occasionally almond (Prunus dulcis)
- **Symptoms**: Thickened, curled, puckered leaves that turn red, yellow, or purple; whitish spore bloom on leaf surfaces; premature leaf drop; reduced fruit yield; shoot dieback in severe cases
- **Infection timing**: Early spring during bud swell, when cool wet conditions prevail

## Key Facts

- Peach leaf curl is one of the most common and visually distinctive diseases of peach trees worldwide, found in every peach-growing region
- Infection occurs exclusively in early spring when buds begin to swell, during periods of cool (10-16C), wet weather — the fungus requires a film of water on bud surfaces to infect
- The fungus overwinters as blastospores (asexual spores) on tree bark and bud scales, remaining dormant until favorable spring conditions trigger infection
- Once leaves are infected and have fully unfolded, they cannot be effectively treated — all control measures must be preventative, applied before or during bud swell
- Ingham lists peach leaf curl as a disease manageable through AACT, suggesting that beneficial organisms applied during dormancy can reduce overwintering spore populations on bark surfaces
- Severe infections can cause nearly complete defoliation by late spring, significantly weakening trees and reducing fruit production for the current and following seasons
- Repeated annual infections can progressively weaken and eventually kill trees over several seasons due to carbohydrate depletion from repeated defoliation
- Traditional chemical control relies on a single dormant-season application of copper-based fungicide or lime sulfur, timed before bud swell
- Organic growers face limited effective options, making biological approaches like compost tea particularly valuable for certified organic stone fruit production
- The distorted leaf tissue provides a protected microenvironment for the fungus to produce vast quantities of ascospores that are dispersed to bark for the next infection cycle
- Taphrina deformans is an archiascomycete — representing an early-diverging lineage within the Ascomycota that lacks a true fruiting body (ascocarp)
