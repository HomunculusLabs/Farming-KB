...
The key intermediate, 4-chloro-2,5-dimethoxybenzaldehyde, can be prepared by chlorination of 2,5-dimethoxybenzaldehyde using sulfuryl chloride or N-chlorosuccinimide. Conversion to the propiophenone via a Henry reaction with nitroethane followed by reduction, or via Grignard addition of methylmagnesium bromide to the corresponding nitrile, provides the required ketone precursor. Reductive amination with ammonium acetate and sodium borohydride or catalytic hydrogenation completes the synthesis.
...
Set and setting are particularly important determinants of the DOC experience due to its duration. A supportive environment and experienced trip sitter are strongly recommended, especially for first-time users. The extended duration means that any anxiety or discomfort experienced during the onset phase must be managed for many hours, making psychological preparation and a calm environment essential for minimizing the risk of a traumatic experience.
