...
- **Cap**: 1 to 4 cm in diameter, convex to broadly convex, sometimes with a slight umbo. Hygrophanous, brown to reddish brown when moist, fading to pale tan or buff when dry. Surface smooth, slightly viscid when wet. Margin may be slightly translucent-striate when young and moist.
- **Gills**: Adnate to adnexed, close to subdistant. Grayish when young, becoming dark purplish brown with spore maturity.
- **Stipe**: 4 to 10 cm long, 1.5 to 3 mm thick. Equal, sometimes slightly thickened at the base. The most distinctive feature is the well-developed annular zone that stains blue to deep blue, often forming a conspicuous ring or ring zone. Below the ring, the stipe is pale brownish; above, it may be paler or white. Surface is smooth to finely pruinose near the apex.
- **Spore print**: Dark purplish brown.
- **Spores**: Ellipsoidal, 8 to 11 by 5 to 7 µm, with a germ pore. Spore walls are moderately thickened.
- **Partial veil**: Well-developed, leaving a persistent annular zone that characteristically bruises blue. This is the most diagnostic feature of the species.
...
*Psilocybe caeruleoannulata* is known from Central and South America, with collections reported from Mexico, Colombia, Ecuador, and Brazil. It grows in subtropical and tropical forest environments, typically found on decomposing plant material, enriched soils, and along forest trails. The species fruits during the rainy season and is associated with disturbed habitats including forest clearings, pastures at the edge of forests, and areas with accumulated herbaceous debris. It may also occur on dung or dung-enriched soils, though it is not exclusively coprophilous. Elevational range is primarily between 500 and 2000 meters, in areas with consistent annual rainfall exceeding 1500 mm. The species appears to be relatively uncommon even within its known range, and additional collections from under-explored regions of Central and South America would help clarify its full distribution and habitat preferences.
...
As a psilocybin-containing species, *P. caeruleoannulata* is controlled in most jurisdictions. In Mexico, psilocybin mushrooms are technically prohibited under federal law, though traditional indigenous use in ceremonial contexts has historically been tolerated. In the United States and most other countries, the species is treated as a Schedule I controlled substance equivalent to other psilocybin mushrooms.

## Seasonality

*P. caeruleoannulata* fruits during the rainy season in its tropical and subtropical range, typically from May through October depending on latitude and elevation. Fruitings are triggered by sustained rainfall and warm temperatures (18–28°C), often appearing within days of heavy precipitation events on suitable enriched substrates. At higher elevations, the fruiting window may be compressed into a shorter rainy period.

## Conservation Status

The conservation status of *P. caeruleoannulata* has not been formally assessed. As a tropical forest species dependent on specific moisture conditions and enriched substrates, it may be affected by deforestation and habitat fragmentation across its Central and South American range. Additional field surveys are needed to evaluate population trends.
