...
- **Category**: Permaculture organization / design consultancy
- **Founded by**: Dan Hemenway
- **Co-operated by**: Cynthia Baxter Hemenway
- **Location**: Sparr, Florida, USA (P.O. Box 52, Sparr FL 32192-0052)
...
- **Forest Ecosystem Rescue Network (FERN)**: Program to address forest decline through local chapter organization.

## Design Services

- Permaculture Design Client Survey as the starting point for all work.
...
- Yankee Permaculture published the 15-pamphlet Permaculture Design Course series.
- Barking Frogs Permaculture Center served as the publisher.
- Special order catalog included Permaculture Papers.
- Pamphlets placed in the public domain.

## Program Formats

- Weekend Workshop (max 25)
- One-Day Workshop (max 40)
- 10-Day Permaculture Design Intensive (max 30)
- Two-Week Workshop (max 30)
- Permaculture Design Course: three-week program with certification (max 30)
- Advanced Permaculture Training (APT)
