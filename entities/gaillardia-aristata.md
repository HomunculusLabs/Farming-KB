...
**Gaillardia aristata** Pursh, commonly known as blanketflower or great blanketflower, is a perennial herbaceous plant in the family Asteraceae. It is native to the western and central United States and Canada, ranging from British Columbia and Alberta south to California, Colorado, and the Great Plains.
...
**Kingdom:** Plantae — **Order:** Asterales — **Family:** Asteraceae — **Subfamily:** Asteroideae — **Tribe:** Heliantheae — **Genus:** Gaillardia

**Authority:** Frederick Traugott Pursh, *Flora Americae Septentrionalis* (1814).

*G. aristata* is a perennial herb growing 30–90 cm tall from a short, branching caudex with a fibrous root system. Unlike some related species, it does not produce rhizomes and spreads primarily by seed.

Stems are erect, usually unbranched or sparingly branched above the middle, and covered with a mixture of spreading and glandular hairs. The overall habit is tufted, with multiple stems arising from a single root crown.

Leaves are alternate, lanceolate to oblanceolate, 5–15 cm long and 1–3 cm wide, with entire to slightly toothed margins. Basal leaves form a rosette and are typically larger and broader than the reduced stem leaves.

Each flower head (capitulum) is 4–8 cm across, with 10–20 ray florets. The rays are yellow at the apex with a red or maroon band near the base, though color variation is considerable. The central disk is 1.5–3 cm across, composed of numerous dark red to purplish-brown disk florets.

The involucral bracts (phyllaries) are fused at the base into a conspicuous, hardened cup (the "globe" of the common name). The tips of the outer phyllaries are characteristically aristate (bristle-tipped), giving the species its specific epithet. Achenes are 3–5 mm, oblong, with a pappus of 5–8 short awns.

The root system consists of a deep, stout taproot that can extend 60–120 cm below the soil surface. This deep root system is the basis of the species' exceptional drought tolerance and allows it to persist on thin, rocky soils where shallow-rooted competitors cannot survive.
...
*G. aristata* is an exceptional pollinator plant, producing abundant nectar and pollen over an extended bloom period from June through September. The composite flower heads with exposed disk florets are accessible to a wide range of pollinators including bees, butterflies, moths, and hoverflies.
