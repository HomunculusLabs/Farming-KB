...
- **Authority:** (H.B.K.) Link et Otto
- **Common names:** Sinicuichi, Sun Opener, Shrubby Yellowcrest, Abrecaminos

The genus Heimia was named in honor of the German physician and botanist Ernst Ludwig Heim. There are only two or three recognized species in the genus, all native to the Americas. H. salicifolia is sometimes confused with the closely related H. myrtifolia, which may also possess psychoactive properties. The name "Sinicuichi" is derived from the Nahuatl language, though the precise Nahuatl etymology remains debated among linguists.

## Morphology

Sinicuichi (Heimia salicifolia) grows 2 to 6 feet (60 cm to 1.8 m) tall with lanceolate leaves 0.75 to 3.5 inches (2 to 9 cm) long. The yellow flowers are borne singly in the leaf axils. The persistent bell-shaped calyx develops long hornlike appendages. The shrub grows abundantly in moist places and along streams in the highlands.

The plant has a woody base with multiple branching stems. The bark is smooth and grayish-brown on mature stems. The leaves are alternate, narrow, and willow-like (hence the specific epithet "salicifolia," meaning "willow-leaved"). The fruit is a small, dry capsule containing numerous tiny seeds that are dispersed by wind and water.
...
The intoxication produced by Sinicuichi is distinctive for its auditory effects. Users report:

- Enhanced auditory perception and auditory hallucinations
- A sense of euphoria and well-being
- Memory disturbances, including the ability to recall past events vividly
- A yellowing of the visual field
- A general feeling of drowsiness and bodily heaviness
- A sensation of floating or dissociation from the body

Although it is believed that excessive use of Sinicuichi may be physically harmful, there are usually no uncomfortable aftereffects from moderate use. The auditory hallucinations are described as hearing voices, music, or sounds that seem to come from a great distance, and users often report that these auditory phenomena are perceived as meaningful or communicative.
...
Heimia salicifolia contains quinolizidine alkaloids, including:

- **Cryogenine** (also known as **vertine**) — to which the psychotropic activity is primarily attributed
- **Lythrine** — a related quinolizidine alkaloid
- **Lympholine** (lyfoline) — another minor alkaloid
