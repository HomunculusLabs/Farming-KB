...
Iris pseudocorus contributes to water purification through several mechanisms:

1. **Root zone filtration**: The extensive rhizome and root system provides surface area for beneficial microorganisms that break down organic pollutants and pathogens.
2. **Nutrient uptake**: Absorbs excess nitrogen and phosphorus from wastewater, reducing eutrophication potential.
3. **Sediment trapping**: Dense growth slows water flow, causing suspended particles to settle.
4. **Pathogen suppression**: Root exudates and associated microbial communities reduce bacterial and viral pathogen populations.
...
- **Companion in treatment systems**: Works well alongside Phragmites communis, Typha spp., Juncus effusus, and Mentha aquatica in multi-species treatment beds.

## Cultivation Notes

- Propagates by division of rhizomes in spring or autumn; also from seed (requires stratification).
- Prefers full sun to partial shade in permanently moist or shallow water conditions.
- Hardy to USDA zone 4 (-30 degrees C).
- Invasive potential should be assessed before planting near natural waterways; containment in constructed systems is recommended.
- Tolerates a wide pH range (5.5-7.5) and nutrient-rich conditions.
...
Iris Pseudocorus finds application across multiple domains,
...
Understanding iris pseudocorus within broader ecosystem dynamics reveals
...
When incorporating iris pseudocorus into permaculture or land management plans,
