...
**Classification:** Plantae → Magnoliophyta → Magnoliopsida → Myrtales → Myrtaceae → Syzygium → S. cumini.

**Authority:** (L.) Skeels, published in the USDA Bulletin in 1912. The basionym is *Myrtus cumini* L. (1753).

**Synonyms** include *Eugenia jambolana* Lam., *Eugenia cumini* (L.) Druce, and *Syzygium jambolanum* (DC.) Wight & Arn. The nomenclatural history reflects the species' movement between Eugenia and Syzygium genera.

The tree is evergreen with a dense, rounded canopy. Mature specimens develop a straight trunk up to 1.5 meters in girth with dark grey, rough, fissured bark.

Leaves are opposite, coriaceous, elliptic to lanceolate, 5–15 cm long and 2–5 cm wide. New foliage emerges pale pink to bronze before maturing to glossy dark green.

Flowers are small, fragrant, and creamy white, borne in axillary or terminal cymose panicles. Each flower measures 5–7 mm across with four rounded petals and numerous prominent stamens.

Fruits are ovoid or oblong berries, 1.5–3.5 cm long, ripening from green through pink to deep purple or nearly black. The pulp is juicy, slightly astringent, and stains the mouth. Each fruit contains a single large, oblong seed.
