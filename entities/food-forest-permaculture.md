...
updated: 2026-04-28
sources:
  - Jacke, Dave & Toensmeier, Eric. Edible Forest Gardens (2 vols.). Chelsea Green, 2005.
...
- Low-growing plants that spread horizontally to cover bare soil
- Species: Creeping thyme, strawberries, clover, creeping jenny, oregano, wintergreen, lingonberry, nasturtium, sweet woodruff
- Function: Soil protection, weed suppression, moisture retention, beneficial insect attraction
- Notes: Critical for soil health; prevents erosion and maintains soil microbiome
...
- Species: Watercress, water mint, taro, rice (in warm climates), duck potato, cattail
- Function: Water storage, habitat creation, additional food crops, edge effect maximization
...
- **Zone 1** (closest to dwelling): High-maintenance crops — herbs, salad greens, strawberries, intensively managed
- **Zone 2**: Fruit trees, berry bushes, vegetable beds — visited daily
- **Zone 3**: Larger trees, staple crops, grazing animals — visited weekly
- **Zone 4**: Foraging, timber, firewood — visited monthly
- **Zone 5**: Wild ecosystem — left undisturbed for biodiversity and observation

Sectors (sun, wind, water flow, fire risk, wildlife corridors) inform placement of each element.

## Yields and Productivity

### Caloric Production
- Mature food forests can produce **3–7 million kcal/acre/year** depending on climate and design
- This compares favorably to conventional grain agriculture (~2–4 million kcal/acre/year) while requiring no annual inputs
- Nut trees (chestnuts, walnuts, acorns) provide the caloric backbone; fruits and vegetables provide nutrition and diversity

### Diversity of Yields
A well-designed food forest produces:
- **Food:** Fruits, nuts, berries, vegetables, herbs, mushrooms, edible shoots and flowers
- **Medicine:** Medicinal herbs, fungi, tree medicines (willow bark, elderflower)
- **Fiber:** Basketry materials, rope, textiles
- **Fuel:** Firewood, coppiced poles
- **Forage:** Animal feed (chickens, ducks, pigs can be integrated)
