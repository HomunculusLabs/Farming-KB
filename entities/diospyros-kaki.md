...
Diospyros kaki Thunb. was described by Carl Peter Thunberg in 1780. The genus name derives from Greek "dios" (divine) and "pyros" (grain), while "kaki" is the Japanese name for the fruit.

The tree typically reaches 5–8 meters in height with a rounded, spreading crown. Bark is dark gray to brown, becoming fissured with age. Young branches are covered with fine gray pubescence.

Leaves are alternate, elliptic to obovate, 7–15 cm long and 5–10 cm wide, with entire margins. Foliage turns brilliant orange to red in autumn, contributing significant ornamental value.

Flowers are creamy-white, 2 cm across, appearing in leaf axils in late spring. Most commercial cultivars are female-only and produce fruit parthenocarpically without pollination, though pollinated fruits develop seeds.

The fruit is a berry 5–12 cm in diameter, broadly oblate to conical in shape. Skin color ranges from yellow-orange to deep reddish-orange. Flesh texture varies from firm and crisp (non-astringent types) to soft and gelatinous (astringent types).

When pollinated, the fruit develops dark brown seeds that alter the flesh texture around them, creating a gelatinous, sweet zone. Pollination variant (PVNA) cultivars like "Maru" can be eaten at either the firm or soft stage depending on seed formation.

## Distribution and Habitat

Diospyros kaki is native to China, where wild populations persist in mountainous regions of central and southern provinces. The species has been cultivated in China for over 2,000 years.
...
Soluble dietary fiber content reaches 3.6 g per 100 g, with pectin as the predominant fraction. The fiber profile supports digestive health and has been associated with improved lipid metabolism in clinical studies.
