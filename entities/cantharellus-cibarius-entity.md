...
sources:
  ...
  - Kuo, M. (2024). "Cantharellus cibarius." MushroomExpert.com.
  - Boa, E. (2004). "Wild Edible Fungi: A Global Overview." FAO.
  - Watling, R. (1997). "The Business of Fructification." Mycologist 11(3).
...
with well-developed soil profiles and organic duff layers.

## Edibility and Culinary Use

Chanterelles are among the finest edible wild mushrooms. Flavor is mildly
...
- **Vitamin D2:** Significant ergocalciferol content when UV-exposed
  post-harvest
- **Polysaccharides:** Beta-glucan fractions with demonstrated
...
The mycelial network extends the effective root zone by meters, improving
drought resilience and nutrient access. Fruiting bodies are consumed by
slugs, deer, rodents, and insects. Mycelium contributes to soil
aggregation and organic matter decomposition.

## Permaculture and Agroforestry Applications

- **Food forests:** Compatible with oak, beech, hazel, and pine
  understory layers; minimal management once established
- **Orchard integration:** May establish under mature fruit and nut trees
  as secondary yield
- **Silvopasture:** Compatible with grazed woodland if soil compaction
  is managed; prefers undisturbed duff
- **Nursery inoculation:** Bareroot seedlings can be inoculated for
  long-term establishment
- **Harvest economics:** Wild chanterelles sell for $15–50/kg retail;
  productive plots yield 10–50 kg/ha annually

## Related Species

- *C. tubaeformis* (Yellowfoot) — smaller, darker, hollow stipe;
  conifer associate, excellent edibility
- *C. lateritius* (Smooth chanterelle) — North American; smoother cap
