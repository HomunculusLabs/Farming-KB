...
- **IUPAC name:** 5-Hydroxy-2-(1H-indol-3-yl)ethanamine
...
Serotonin is synthesized in a two-step pathway from the essential amino acid [[tryptophan]]:

1. **Tryptophan hydroxylation:** [[tryptophan]] is converted to 5-hydroxytryptophan (5-HTP) by tryptophan hydroxylase (TPH), the rate-limiting enzyme. This reaction requires tetrahydrobiopterin (BH₄) as a cofactor and molecular oxygen.
...
- [[indole]] — the bicyclic aromatic scaffold common to all tryptamine compounds

### Serotonin Syndrome

Excessive serotonergic activity — whether from drug combinations (SSRIs + MAOIs, tramadol + SSRIs), overdose, or drug interactions — can produce **serotonin syndrome**, a potentially life-threatening condition characterized by:

- **Mild:** Tremor, diaphoresis, mydriasis, tachycardia, hyperreflexia
- **Moderate:** Hyperthermia, agitation, ocular clonus, hypertonicity, hyperactive bowel sounds
- **Severe:** Temperature exceeding 41.1°C, seizures, rhabdomyolysis, renal failure, disseminated intravascular coagulation, death

Management involves discontinuation of serotonergic agents, supportive care, and in severe cases administration of cyproheptadine (a 5-HT₂A antagonist) or chlorpromazine.

### Tryptamine Receptor Cross-Activity
...
- **Plants:** Serotonin (5-HT) is found in many plant species where it may function in defense, growth regulation, and as a precursor to [[melatonin-entity-tihkal]]
- **Fungi:** Serotonin-like compounds and serotonin receptors have been identified in various fungal species
- **Evolutionary conservation:** The 5-HT receptor gene family predates the divergence of protostomes and deuterostomes, indicating that serotonergic signaling is an ancient feature of animal nervous systems — over 700 million years old
