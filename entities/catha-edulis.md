...
created: 2026-04-28
type: species
tags: [plant, stimulant, celastraceae, cathinone, social-drug]
date: 2026-04-28
updated: 2026-04-28
sources: []
---
...
The flowers are small, fragrant, and borne in axillary cymes. They are white to pale yellow, with 5 petals and 5 sepals, approximately 5 mm in diameter. Male and female flowers are borne on separate plants (dioecious), with male flowers being slightly more numerous and conspicuous. Flowering occurs irregularly throughout the year, with peak flowering depending on local rainfall patterns.

The fruit is a small, three-lobed, woody capsule approximately 5 to 8 mm in diameter, containing one to three small brown seeds. The capsule splits open when mature to release the seeds, which are dispersed by wind and water.
...
The plant thrives at elevations between 1,500 and 2,500 meters in regions with a moderate climate, well-distributed rainfall (1,000 to 2,000 mm annually), and rich, well-draining soils (especially red volcanic loams). It requires temperatures between 5°C and 25°C and cannot tolerate frost or extreme heat. In its native range, khat is typically grown as an intercrop alongside coffee, enset, and food crops. It is shade-tolerant when young but requires full sun for optimal leaf production at maturity. The highest-quality khat is generally produced at elevations above 2,000 meters, where the cooler temperatures slow growth and promote alkaloid accumulation.
...
The alkaloid content of fresh leaves varies significantly depending on the cultivar, growing conditions (altitude, soil, rainfall), time of harvest, and the age of the harvested material. Fresh young leaves and shoot tips typically contain 0.1% to 0.5% cathinone and 0.05% to 0.2% cathine by dry weight. The highest alkaloid concentrations are found in leaves harvested from plants grown at elevations above 2,000 meters.

## Psychoactive Effects

Khat chewing produces stimulant effects broadly similar to those of amphetamine but generally milder in intensity and longer in duration. The pharmacological profile includes:
...
*Catha edulis* is propagated primarily from stem cuttings, as seed germination is unreliable and seedling vigor is variable. Hardwood cuttings of 20 to 50 cm length are taken from mature plants during the rainy season and planted directly in the field or in nursery beds. Rooting typically occurs within 4 to 8 weeks under humid conditions. Cuttings from high-quality, high-alkaloid mother plants are preferred, as alkaloid content is influenced by genetics as well as growing conditions.
...
The khat economy represents a complex and controversial aspect of development in the Horn of Africa and Yemen. On the positive side, khat cultivation provides livelihoods for hundreds of thousands of farmers, traders, and transport workers. It is a reliable cash crop that commands high prices and provides income stability in regions where alternatives are limited. The khat trade supports extensive transportation networks, retail infrastructure, and ancillary services.

On the negative side, critics argue that khat cultivation displaces food crops, depletes water resources (khat is relatively water-intensive compared to alternative crops), and diverts productive capacity from sectors that could contribute more broadly to economic development. In Yemen, it is estimated that khat cultivation consumes approximately 30% to 40% of the nation's renewable water resources, contributing to a severe water crisis. Household expenditure on khat can be substantial, raising concerns about family welfare and food security.

## Legal Status

Khat's legal status varies dramatically worldwide, reflecting the tension between traditional cultural practice and international drug control frameworks:

- **Legal and culturally accepted**: Yemen, Ethiopia, Kenya, Somalia, Djibouti, and Uganda (cultivation, sale, and use are legal and deeply integrated into cultural life)
