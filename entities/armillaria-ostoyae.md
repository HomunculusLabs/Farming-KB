...
The species was originally described as *Armillaria ostoyae* by Henri Romagnesi in 1970. In 2008, it was proposed to be renamed *Armillaria solidipes* based on earlier taxonomic work by Charles Horton Peck, though *A. ostoyae* remains the more widely used name in forest pathology literature. The genus *Armillaria* has undergone significant taxonomic revision, with molecular phylogenetics helping to clarify species boundaries within this morphologically variable group.
...
Research into biological control of *A. ostoyae* has explored several approaches:
