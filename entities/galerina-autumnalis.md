...
> only. Never consume wild mushrooms without expert verification.
...
galerina autumnalis is not cultivated for food or medicine under any circumstances.
This section is included solely for completeness within the standard species page format.
No legitimate cultivation parameters exist for this species, and any fruitbody production
of Galerina should be treated as a contamination event in cultivated mushroom operations.

## Growth Parameters

No growth parameters are provided for galerina autumnalis as this species is never
intentionally cultivated. Its presence in cultivation environments represents a
contamination risk that must be identified and eliminated immediately.
