---
title: "Sanghuangporus lonicericola"
type: species
tags:
  - fungi
  - polyporaceae
...
The context is corky and light brown. The hyphal system is dimitic, comprising generative hyphae with simple septa and skeletal hyphae that are thick-walled and unbranched. Setal hyphae are present in the trama, a characteristic feature of the Hymenochaetaceae.

Basidiospores are broadly ellipsoid, hyaline, thick-walled, and measure 4.5–6 × 3.5–4.5 μm. They are inamyloid and indextrinoid.

## Distribution and Habitat

*S. lonicericola* has been recorded in northeastern China, particularly in Heilongjiang and Jilin provinces. It is likely distributed across temperate forests of East Asia, though systematic surveys remain limited.

The species is lignicolous, fruiting on dead or moribund branches and trunks of *Lonicera* species (Caprifoliaceae). Specimens have been collected at elevations between 300 and 800 meters in mixed deciduous forests.

It typically fruits in summer and autumn, producing perennial basidiocarps that can persist on the same substrate for multiple years. The species shows moderate host specificity, preferentially colonizing Caprifoliaceae wood.
...
*S. lonicericola* is closely related to other East Asian *Sanghuangporus* species, particularly *S. vaninii* and *S. baumii*. These species are morphologically similar and were historically conflated under the name "sanghuang."

* **S. vaninii** — the most commercially available sanghuang species, cultivated in China for medicinal use. Basidiocarps are larger and typically found on *Populus* and *Morus* hosts.
* **S. baumii** — described from Shandong province, associated with mulberry trees. Produces a distinctly darker pore surface.
* **S. pini** — found on *Pinus* species, with a more restricted northern distribution.

*S. lonicericola* can be distinguished by its host association with *Lonicera*, its smaller pore size, and molecular markers including ITS and nLSU rDNA sequences.

## Traditional and Modern Use

Sanghuang has been used in traditional Chinese medicine since at least the Han dynasty (206 BCE–220 CE). The earliest recorded use appears in the *Shennong Ben Cao Jing*, where it is described as a remedy for various ailments.
