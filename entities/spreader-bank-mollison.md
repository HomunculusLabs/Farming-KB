...
- **Lower side**: Dead level, compacted, or even concreted
- **Length**: May be tens or hundreds of metres long
...
- Water enters from a dam, swale, or minor stream and leaves as a thin sheet flow downslope
- For irrigation of flatlands, the bank is pierced by a series of dead-level pipe outlets, each feeding an irrigation bay
- Irrigation bays are planed flat, confined by low side walls called steering banks
- A tail drain at the lower end leads excess water to a stream or secondary storage dam
- The uphill feeder drain is called the head race and has cross-slides that block flow
...
2. **Cross-slides**: Adjustable barriers in the head race that block flow
3. **Level pipes or sills**: Dead-level outlets that flood water into individual bays
