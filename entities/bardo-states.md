...
## Classification
- **Domain:** Tibetan Buddhist Psychology / Psychedelic Framework
- **Category:** Concept — states of consciousness
- **Tradition:** Tibetan Vajrayana Buddhism, adapted for psychedelic use
- **Geographic origin:** Tibet (originally India)

## Key Facts

### First Bardo: Chikhai Bardo — The Period of Ego-Loss
- **Tibetan name:** Chikhai Bardo (བར་དོ་ཆེན་པོ)
- **Duration:** Minutes to hours during psychedelic experience
- **Characteristics:** The initial moment and extended period of ego dissolution. Consciousness encounters the Clear Light — pure, undifferentiated awareness without mental concepts or ego structures.
- **Two phases:**
  1. **Primary Clear Light:** The first flash of ego-loss. "Liberation is the nervous system devoid of mental-conceptual activity." Duration varies from a finger-snap to several hours depending on preparation.
  2. **Secondary Clear Light:** Less intense than the primary, involving a dialogue between pure transcendence and lucid self-awareness. Flashes between non-self and witnessing self.
- **Physical symptoms:** Bodily pressure (earth-sinking-into-water), cold then heat (water-sinking-into-fire), disintegration (fire-sinking-into-air), head pressure (rocket-launching), tingling, melting sensations, nausea, trembling from pelvis upward.
- **Key instruction:** Recognize the symptoms as heralding transcendence. Do not fight them. Merge with and enjoy the sensations.
- **Optimal outcome:** The prepared subject recognizes the Clear Light, merges with it, and "all game bonds of illusion are broken asunder immediately."
- **Failed outcome:** Subject fails to recognize the state and descends into the Second Bardo.
...
- **Seven Vision Types (per Leary's adaptation):**
  ...
  4. **Wave-Vibration Structure of External Forms:** Perceiving external reality as wave energy patterns.
...
The Bardo framework has no direct connection to mushroom cultivation but is directly applicable to psilocybin experience:
- **Dose-dependent progression:** Low doses of psilocybin may only reach the edges of the First Bardo; higher doses produce the full Bardo progression from ego-loss through hallucinations to re-entry.
- **Session guidance:** The Bardo model provides the most detailed existing framework for guiding someone through a psilocybin experience — from preparation through ego-loss to integration.
- **Set and setting:** The emphasis on preparation ("the earnest practitioner should regard every moment of his or her life as if it were the last") directly applies to psilocybin session preparation.
- **Integration:** The concept of "rebirth" into ordinary consciousness maps onto modern psychedelic integration practices.

## Cross-References
- [[bardo-thodol]] — The original Tibetan text.
- [[dhyani-buddhas]] — The five archetypal figures that appear in the Second Bardo.
- [[clear-light-consciousness]] — The First Bardo state.
- [[kundalini]] — The energy phenomena of the First Bardo.
- [[lama-govinda]] — Govinda's esoteric interpretation of the Bardo.
- [[carl-g-jung-psychedelic]] — Jung's psychological analysis of the Bardo states.

## Sources and Further Reading
- Evans-Wentz, W.Y. (ed.) *The Tibetan Book of the Dead* (1927). Oxford University Press.
- Leary, T., Metzner, R., & Alpert, R. *The Psychedelic Experience* (1964).
- Govinda, A. *Foundations of Tibetan Mysticism* (1959).
- Fremantle, C. & Trungpa, C. *The Tibetan Book of the Dead* (1975). Shambhala.
