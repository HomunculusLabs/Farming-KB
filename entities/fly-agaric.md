...
| A. muscaria var. flavivolvata | Red to orange, yellowish volva | Western North America |
| A. muscaria var. alba | White | Rare, scattered |
| A. muscaria var. formosa | Orange to yellow-orange | Europe, eastern North America |
...
The combination of white gills, white spore print, skirt-like ring, shaggy volval remains at the bulbous base, and colored cap with warts distinguishes A. muscaria from all other genera. The shaggy basal volva distinguishes it from deadly species (A. phalloides, A. virosa) which have a smooth sac-like volva.
...
A. muscaria is the most thoroughly documented psychoactive mushroom in indigenous Siberian and Arctic traditions:
...
- **Preparation methods:** Mushrooms were dried, sometimes over fires, to convert ibotenic acid to muscimol. They were eaten fresh, dried, or soaked in fermented milk or berry juice. Reingestion of urine (containing active muscimol metabolites) was practiced to extend the experience — a method documented by multiple 18th-century explorers
- **Effects described:** Euphoria, visual distortions (macropsia/micropsia — objects appearing larger or smaller), auditory hallucinations, a sensation of flying, and deep dream-like states
- **Kamak:** The Koryak term for an A. muscaria inebriation state, distinguished from ordinary drunkenness
...
- **Fly poison:** The common name derives from the traditional European practice of crumbled caps in milk or sugar water to attract and kill flies — a practice validated by modern research showing insecticidal activity
- **Food use (processed):** In parts of Japan (Nagano Prefecture) and Eastern Europe, parboiled, extensively washed, and pickled A. muscaria is consumed as food — a practice that eliminates most of the water-soluble ibotenic acid

## Modern Use and Therapeutic Research

### Psychoactive Use

Contemporary use of A. muscaria is primarily in the form of dried mushroom material or muscimol extracts. Effects typically include:

- **Sedation and relaxation** (unlike classical psychedelics)
- **Dream-like imagery** with eyes closed ("waking dreams")
- **Dissociative states** with altered body perception and time distortion
- **Euphoria or dysphoria** depending on dose, set, and setting
- **Nausea** (from residual ibotenic acid) — reduced by proper preparation

### Emerging Therapeutic Applications

- **GABAergic modulation research:** Muscimol is being investigated as a research tool for understanding GABA_A receptor subtypes, particularly δ-subunit-containing extrasynaptic receptors involved in tonic inhibition
- **Neurological conditions:** Preliminary research interest in muscimol analogs for epilepsy, spasticity, and neuropathic pain
