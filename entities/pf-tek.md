...
- 1/2 to 2/3 cup horticultural vermiculite (medium grade, finer type preferred)
- 40-45 cc (ml) water (just under 1/4 cup)
...
The finer grade of vermiculite is recommended because it holds more water. Vermiculite particle size matters significantly: finer type averages ~1mm across, coarser type averages 4-5mm. Freshly ground brown rice is preferred over prepackaged.
...
### Maximum Formula Loading

The maximum formula requires slight tamping:
1. Loosely load the 1/2 pint jar and level the top of the mixture
2. Cover the jar mouth with one hand and grasp the jar
3. Lightly slam the bottom of the jar on the other palm a couple of times to lower the mixture level to 1/2 inch from jar top
4. Clean the inside of the jar down to substrate level and fill to the top with dry vermiculite
5. Incubate at room temperature; do not heat over 70F; loosen lid or untape lid holes; watch for loose water

## Pressure Canner Sterilization (Optional Upgrade)

For more reliable sterilization, a pressure canner can be used:

| Item | Pressure | Time |
|------|----------|------|
| 1/2 pint PF substrate jars | 12 psi | 20 minutes |
| Water bottles | 12 psi | 55 minutes |
| Syringes and needles | 12 psi | 10 minutes |

Always refer to the manufacturer's manual. Pressure canners can be dangerous if used incorrectly.

## Inoculation

- Shake syringe well to redistribute spores
- Use 1 cc per jar (allows 10 jars per syringe)
- Insert needle at angle toward jar center, touching glass to distribute spore water down the side
- Inoculate a few drops per needle hole
- Flame sterilize needle between jars using alcohol flame (denatured alcohol on inverted shot glass -- cleaner than butane)
...
- Store inoculated jars at approximately 70-75F in a dark, draft-free place
- Colonization typically takes 2-4 weeks
- Mycelium appears white and fluffy, spreading from inoculation points
- Signs of contamination: green, blue, black, or pink growth; foul odor
- Loosen lids (or untape lid holes) to allow gas exchange during colonization
- Watch for loose water in the jar (sign of excess moisture)

## Fruiting

After full colonization, cakes are removed from jars and placed in a humidity-controlled terrarium. See [[pf-tek-fruiting-chamber]] for complete construction and operation details.

- PF's design uses a 10-gallon aquarium with a Plexiglas spray shield creating dual chambers
- Never spray the fungus directly -- spray the shield to create molecularized humidity
- Spray at least 2 times per day; more is better
- Ventilate (fan) each time you spray
- Indirect light triggers fruiting; small fluorescent plant light is ideal
- Temperature: 65-85F; do NOT heat the terrarium directly
- Siphon out pooled water from terrarium bottom regularly

## Harvesting and Potency

See [[mushroom-harvesting-potency]] for complete details:

- **Harvest young** (pre-sporulation): light colored, conical caps, veil intact
- Pick ALL abhorts and mutants -- "these are the source of the potent magic"
- Mature specimens (dark gills, purple spores) are weaker but good for spore printing
- Cool desiccant drying preserves maximum potency
- Never dry in oven or with hot air -- heat destroys alkaloids
...
- Desiccant: Drierite, silica gel, or Damp Gone (drying) See also [[pf-tek-mushroom-life-cycle-timeline]].
