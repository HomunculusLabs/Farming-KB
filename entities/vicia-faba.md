...
**Classification:** Plantae → Tracheophyta → Magnoliopsida → Fabales → Fabaceae → Faboideae → *Vicia* → *V. faba*.

**Authority:** Carl Linnaeus, 1753. The species is placed in section *Faba* within the genus. *Vicia faba* is the sole member of its section, distinguished by its large seeds and absence of tendrils on the leaves.

**Growth habit:** Erect annual herb, 30–180 cm tall depending on cultivar group. Major types include: minor (small-seeded field bean, 30–60 cm), major (large-seeded broad bean, 60–180 cm), and equina (intermediate horse bean).

**Leaves:** Pinnately compound with 2–6 leaflets per leaf, lacking the terminal tendril characteristic of most *Vicia* species. Leaflets are 25–75 mm long, elliptical to obovate, with entire margins. Stipules are large, semi-sagittate, and conspicuous at the base of each leaf.
...
Fava bean seeds contain approximately 25–35% protein (dry weight basis), making them one of the highest-protein grain legumes. The protein is rich in lysine but limiting in methionine and cysteine, complementing cereal proteins in mixed diets.

Carbohydrate content ranges from 50–60%, with starch as the dominant fraction. Dietary fiber content is 6–8%, and the seeds contain notable amounts of folate (100–150 µg/100g), iron (5–6 mg/100g), magnesium, potassium, and zinc.

The seeds contain vicine and convicine, bioactive pyrimidine glycosides that can cause favism in genetically susceptible individuals (G6PD deficiency). Favism triggers acute hemolytic anemia upon ingestion, a condition primarily affecting populations in the Mediterranean, Middle East, and parts of Africa and Asia.

Young fava bean pods and leaves are also edible, with the tender pods consumed whole in many Mediterranean and Asian cuisines. The leaves are used as a pot herb similar to spinach in some traditions.
