...
- **Structure type:** Resorcinyl core with propyl side chain (C3), monoterpene moiety
- **CAS number:** 24274-48-4
- **Appearance:** Colorless crystalline solid at room temperature
...
CBDV exhibits a broad pharmacological profile with activity at multiple receptor systems:

- **TRPV1 (vanilloid receptor):** CBDV acts as a TRPV1 agonist, activating the receptor with moderate potency (EC50 ~5 µM). TRPV1 activation is implicated in anticonvulsant, anti-inflammatory, and analgesic effects.
- **TRPV2:** CBDV also activates TRPV2 channels, which are involved in calcium signaling, immune function, and neuronal development. This dual TRPV1/TRPV2 activity is unusual among cannabinoids.
- **GPR55:** CBDV acts as an antagonist at GPR55, a putative cannabinoid receptor implicated in seizure modulation. GPR55 antagonism is a proposed mechanism for anti-epileptic effects.
- **CB1/CB2:** Very low affinity (Ki >10 µM for both receptors). CBDV does not produce cannabinoid receptor-mediated psychoactivity.
- **5-HT1A:** Preliminary evidence suggests CBDV may act as a partial agonist at 5-HT1A serotonin receptors, contributing to anxiolytic and anti-nausea effects, though this activity requires further confirmation.

The combination of TRPV1 agonism and GPR55 antagonism is considered the primary mechanism for CBDV's anticonvulsant activity, though the exact contribution of each target remains under investigation. The multi-target profile is characteristic of many cannabinoids and may provide therapeutic advantages over single-target drugs by addressing seizure pathophysiology through complementary mechanisms.

Unlike many anticonvulsant pharmaceuticals, CBDV does not appear to cause significant sedation or cognitive impairment at therapeutic doses in animal models. This favorable side-effect profile has contributed to pharmaceutical interest in developing CBDV as a pediatric anti-epileptic medication.
...
- **Phase 2 trials:** GW Pharmaceuticals conducted a randomized, double-blind, placebo-controlled Phase 2 trial of CBDV (GWP42006) in adult patients with treatment-resistant focal seizures. Results showed trends toward seizure reduction but did not achieve statistical significance in the primary endpoint.
- **Rett syndrome:** A Phase 2 trial in patients with Rett syndrome (a neurodevelopmental disorder affecting primarily females, characterized by seizures and developmental regression) showed improvements in specific symptom domains. This remains the most promising clinical indication.

CBDV is also being investigated for **autism spectrum disorder (ASD)** based on preclinical evidence of neuroprotective and anti-inflammatory effects in the developing brain.

## Additional Bioactivities

Beyond anticonvulsant activity, CBDV demonstrates several other pharmacological effects in preclinical studies:
