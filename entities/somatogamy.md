...
- **Type**: Biological process / reproductive mechanism
- **Kingdom**: Fungi (particularly Basidiomycota)
- **Related processes**: Plasmogamy, karyogamy, meiosis

## The Process

Somatogamy occurs in the following sequence:

1. **Basidiospore germination**: A haploid basidiospore germinates to produce a monokaryotic hypha — a tubular filament with a single nucleus per cell
2. **Monokaryotic growth**: The monokaryotic mycelium grows vegetatively, exploring its substrate
3. **Encounter**: Two compatible monokaryotic mycelia, derived from different basidiospores, come into contact
4. **Somatogamy (cell fusion)**: The somatic cells of the two compatible mycelia fuse together — this is plasmogamy, the fusion of cytoplasm
5. **Dikaryon establishment**: The result is a dikaryotic mycelium, in which each cell contains two nuclei — one from each parent monokaryon
6. **Nuclear separation**: Importantly, the nuclei do NOT fuse at this stage. The two nuclei coexist and divide coordinately in each cell

### What Somatogamy Is NOT
...
For somatogamy to result in a viable dikaryotic mycelium, the two monokaryotic mycelia must be sexually compatible. In the Strophariaceae and many other agarics, compatibility is governed by a tetrapolar heterothallic mating system:
...
Somatogamy is one of three key nuclear events in the basidiomycete life cycle:

1. **Somatogamy** (plasmogamy) — fusion of somatic cells, placing two haploid nuclei in the same cell → establishes dikaryon
2. **Karyogamy** — fusion of the two nuclei within the basidium → produces diploid (2n) nucleus (brief stage)
3. **Meiosis** — reduction division of the diploid nucleus → produces four haploid nuclei → basidiospores

## Significance for the Dikaryotic Phase
...
Understanding somatogamy is essential for several aspects of cultivation:

### Multispore Inoculation
When cultivators inoculate plates or substrates with spore prints or spore syringes, they are relying on somatogamy to occur naturally. Hundreds of different mating types germinate from a single [[spore-print]]; compatible pairs fuse through somatogamy to establish the fertile dikaryotic mycelium needed for fruiting.
...
Different fungal groups employ different strategies for establishing the dikaryotic state:

- **Somatogamy** (Agaricales, many Basidiomycetes): Direct fusion of vegetative hyphal cells
