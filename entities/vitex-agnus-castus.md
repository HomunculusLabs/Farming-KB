...
created: 2026-04-28
type: species
tags: [species, plant, herbal, medicinal, permaculture, lamiaceae, hormonal, adaptogen, pollinator, mediterranean, drought-tolerant]
date: 2026-04-28
updated: 2026-04-28
sources:
...
- **Kingdom:** Plantae
- **Order:** Lamiales
- **Family:** Lamiaceae (formerly Verbenaceae under traditional classification)
...
### Plant Structure
Chaste tree is a multi-stemmed deciduous shrub that can develop into a small tree reaching 3–8 m (10–26 feet) in height under favorable conditions, though it more commonly grows as a 2–5 m (6.5–16 foot) rounded shrub. The growth habit is open and spreading, with a rounded crown and somewhat irregular branching pattern. In colder climates, the plant may die back to the ground in winter and regenerate from the rootstock, behaving effectively as a herbaceous perennial.

### Leaves
The leaves are compound (palmately compound), typically with 5–7 lanceolate to elliptic leaflets radiating from a central point like fingers from a palm. Individual leaflets are 4–10 cm (1.6–4 inches) long, dark green above and gray-green to silvery below due to a dense covering of fine hairs (tomentose indumentum). The aromatic foliage, when crushed, releases a distinctive spicy-peppery fragrance. Leaf arrangement is opposite along the stems.
...
- **Riverbanks and riparian zones:** Common along seasonal watercourses and wadis
- **Disturbed ground:** Colonizes roadsides, abandoned fields, and waste areas
- **Coastal areas:** Tolerant of salt spray and sandy coastal soils

## Medicinal Properties

### Traditional Uses
Chaste tree has one of the longest documented histories of medicinal use in Western herbalism:

- **Menstrual disorders:** Used for irregular menstruation, amenorrhea (absent periods), menorrhagia (heavy bleeding), and dysmenorrhea (painful periods) for over 2,500 years
- **Premenstrual syndrome (PMS):** The most extensively studied and clinically validated modern indication — systematic reviews and meta-analyses have confirmed its efficacy for PMS symptoms including breast tenderness (mastalgia), mood disturbance, headache, and bloating
- **Infertility:** Traditional use for promoting fertility, particularly in cases of luteal phase deficiency (inadequate progesterone production)
- **Lactation suppression:** Historically used to reduce or suppress breast milk production (counter to its modern use in supporting fertility)
...
### Hedge and Windbreak
Chaste tree responds well to pruning and can be trained as a dense hedge or informal screen. In Mediterranean permaculture designs, it serves as a windbreak component that requires minimal maintenance and no supplemental irrigation.

## Cultivation

- **Hardiness:** USDA Zones 6–9 (deciduous); in Zone 6, may die back to roots in severe winters but regrows vigorously in spring
- **Light:** Full sun required for optimal flowering and fruit production; tolerates very light shade
- **Soil:** Highly adaptable — thrives in poor, sandy, calcareous, and alkaline soils. Performs best in well-drained, moderately fertile soils
- **pH:** Tolerant of alkaline conditions (pH 6.5–8.5); performs well in calcareous Mediterranean soils
- **Moisture:** Extremely drought-tolerant once established; avoid waterlogged or persistently wet soils
- **Propagation:** Softwood cuttings in early summer (under mist); semi-hardwood cuttings in autumn; seed (requires cold stratification at 4°C for 30–90 days); division of established plants
- **Pruning:** Responds well to hard pruning in late winter/early spring. In colder zones, cut back to live wood after frost danger passes. For maximum berry production, prune after flowering
- **Harvest:** Ripe berries collected in autumn (September–October) when fully dark and dry; dried at temperatures below 40°C (104°F) to preserve volatile compounds
