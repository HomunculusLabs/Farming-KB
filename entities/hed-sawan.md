---
title: Hed Sawan (Heavenly Mushroom)
...
- **Type**: Dried mushroom snack
- **Cuisine**: Thai, specifically northeastern (Isan) regional
- **Purpose**: Income generation through product diversification
- **Shelf life**: 6+ months in airtight storage

## Production Method

The exact production method involves:

1. **Selection**: Choose fresh, high-quality mushrooms (typically oyster mushrooms)
2. **Preparation**: Clean mushrooms thoroughly and slice into thin, uniform pieces
3. **Seasoning**: Apply a sweet coating or seasoning blend (the exact recipe varies by producer)
4. **Drying**: Sun-dry or mechanically dehydrate until crispy and fully dry
5. **Cooling**: Allow to cool completely before packaging
6. **Packaging**: Package in airtight bags or containers to maintain crispness

## Product Characteristics

- **Texture**: Crispy, crunchy, light
...
Hed Sawan exemplifies the importance of value-added processing in small-scale mushroom farming. For farmers with disabilities in rural Thailand, the ability to transform excess or unsold fresh mushrooms into a premium product provides:

- Protection against market price fluctuations for fresh mushrooms
