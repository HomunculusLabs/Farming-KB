...
**Rudbeckia fulgida** was described by William Aiton in 1789 in *Hortus Kewensis*. The specific epithet *fulgida* means "shining" or "gleaming," referring to the bright flower colour.

The species includes several varieties, the most notable being var. *fulgida*, var. *deamii* (Deam's coneflower), and var. *sullivantii* (Sullivant's coneflower). The popular cultivar 'Goldsturm' was selected from var. *sullivantii* by Heinrich Hagemann in 1937.

Plants grow 60–90 cm tall with sturdy, branching stems. The rootstock is a short caudex or rhizome producing a dense crown of basal leaves.

Basal leaves are ovate to broadly lanceolate, 10–20 cm long, with entire or toothed margins. Stem leaves are smaller, lanceolate, and often entire.

Flower heads are 5–8 cm across, with 10–20 golden-yellow ray florets surrounding a dark brown to black, dome-shaped central disk 1.5–2.5 cm across. The disk is composed of numerous small tubular disk florets.

The involucral bracts (phyllaries) are lanceolate, 10–15 mm long, and often reflexed. This characteristic helps distinguish *R. fulgida* from the more erect-bracted *R. hirta*.

Chromosomal studies confirm *R. fulgida* is a diploid with 2n = 36. Hybridisation with other *Rudbeckia* species is rare in the wild, maintaining the species' distinct identity.
