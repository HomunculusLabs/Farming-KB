...
The taxonomy of the *C. album* aggregate is notoriously difficult. The species is a polyploid complex comprising multiple morphologically similar taxa: ssp. **album** (typical European/West Asian), ssp. **striatum** (more robust), ssp. **viride** (more glabrous), and var. **missouriense** (North American). The genus contains ~150 species, including cultivated quinoa (*C. quinoa*) and huauzontle (*C. nuttalliae*).

## Botanical Description

*Ch. album* is a fast-growing annual herb, typically 30–150 cm tall, but under optimal conditions can exceed 2 meters.
...
**Flowers:** Greenish, tiny (2–3 mm), perfect (bisexual) or pistillate, with 5 tepals. Anthers 5, exserted. Flowers from July to October in temperate regions.
...
**Root system:** Taproot with extensive lateral branching. The root system is effective at accessing nutrients from deep soil layers.

## Nutritional Profile

*Chenopodium album* is exceptionally nutritious, often exceeding cultivated spinach and other leafy greens in micronutrient density:

| Nutrient (per 100g fresh) | Approximate Value |
|---------------------------|-------------------|
| Energy | 43 kcal |
| Protein | 4.2 g |
| Fiber | 2.3 g |
| Vitamin A (β-carotene) | 5,600–11,600 IU |
| Vitamin C | 80 mg |
| Vitamin K | 500 µg |
| Calcium | 309 mg |
| Iron | 8.1 mg |
...
Notably, *C. album* exceeds most cultivated leafy greens in protein, iron, calcium, and vitamin A. **Anti-nutritional factors:** Contains oxalates (comparable to spinach; reduced by blanching) and variable saponin levels (bitter at high doses).
...
*C. album* concentrates nitrogen (excellent green manure), potassium, calcium, magnesium, and trace minerals (zinc, manganese, iron) in its tissues. These become bioavailable when used as mulch, compost, or chop-and-drop material.

### Chop-and-Drop Mulch

Fast-growing biomass can be cut multiple times per season for surface mulch, providing moisture retention, weed suppression, slow-release nutrients, soil organic matter, and erosion control.

### Companion Planting and Food Forest Integration

Volunteer *C. album* serves as a nurse plant (shade for seedlings), trap crop (aphids, leaf miners prefer it over crops), living mulch between rows, bioindicator of soil nitrogen levels, and herbaceous-layer biomass producer in food forests. Self-seeds readily in disturbed areas.

## Ethnobotany and Historical Use

*C. album* has been used as food since the Neolithic period (4000–2000 BCE in Europe). Key traditions include:
- **India:** Known as *bathua* (बथुआ); widely consumed in North Indian *saag*, *paratha*, raita, and curries, especially in winter
- **Nepal/Himalayas:** Known as *bethe*; used in dal, curries, and achar (pickle)
- **East Africa:** Consumed as a leafy green in Kenya, Tanzania, and Ethiopia
- **Traditional Chinese Medicine:** Known as *藜* (lí); diuretic, anthelmintic, digestive aid
- **Native American:** Food source and ceremonial plant; Navajo used for yellow dye
- **European folk medicine:** Poultice for burns/insect bites, laxative, digestive tonic

## Cultivation

Not commercially cultivated at scale but easily grown: direct seed in spring (germinates above 10°C), thin to 15–30 cm spacing, tolerates poor soils, drought-tolerant once established. Harvest young leaves before flowering for best tenderness. Yields 2–5 kg fresh weight/m²/season.

## Toxicity Considerations

- **Oxalates:** Blanching reduces levels; concern for kidney stone-prone individuals
- **Saponins:** Some accessions are bitter; cooking removes most
- **Nitrates:** Avoid harvesting from heavily fertilized or polluted sites
- **Heavy metals:** Dynamic accumulator — only harvest from clean soils
- **Photosensitivity:** Rare in livestock at high consumption
