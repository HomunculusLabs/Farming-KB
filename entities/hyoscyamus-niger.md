...
Two subspecies are generally recognized: *H. niger* subsp. *niger* (annual)
and *H. niger* subsp. *albus* (biennial, with white flowers).
...
- **Atropine** — a racemic mixture of D- and L-hyoscyamine, present in
  smaller amounts; whether it occurs naturally or forms during extraction
  remains debated
- Minor alkaloids including apohyoscyamine, hyoscine, norhyoscyamine,
  tigloidine, and cuscohygrine in trace concentrations

The tropane alkaloids act as competitive antagonists at muscarinic
acetylcholine receptors, producing the classic anticholinergic syndrome:
mydriasis (dilated pupils), cycloplegia (paralysis of accommodation),
tachycardia, dry mouth (xerostomia), anhidrosis, urinary retention,
decreased gastrointestinal motility, and at higher doses, central
anticholinergic effects including agitation, confusion, visual
hallucinations, and delirium. The alkaloid concentration is highest in the
seeds and leaves, with lower concentrations in stems and roots.
