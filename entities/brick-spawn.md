...
- Brick spawn is the most historically common form of commercial mushroom spawn, used extensively in European and American mushroom cultivation since the late 19th century.
- Duggar (1915) specified that brick spawn should be broken into approximately 9 to 12 or more pieces before use, with each piece about the size of a hen's egg.
- One piece of broken brick spawn is required per square foot of bed space.
- The spawn pieces are inserted deep into the compost (covered with approximately 1 inch of manure) and the compost is firmed over them.
...
- **Spawn distribution:** The brick format allows for uniform distribution of inoculum across bed surfaces, ensuring even [[mycelial-colonization]].
...
1. Break each brick into 9-12+ pieces (hen's egg size).
2. Lift the compost at regular intervals (approximately 1 piece per square foot).
3. Insert each piece deep enough to be covered by 1 inch of compost.
4. Create an aerating passage alongside the inserted piece.
5. Firm the compost over the spawn with the opposite hand.
