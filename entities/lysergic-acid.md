...
- **Quinoline ring** — additional fused ring distinguishing ergolines from simple
  tryptamines
- **C-8 carboxylic acid** — the reactive site for amide formation yielding
  psychoactive derivatives
- **Stereochemistry** — biological activity is highly stereospecific;
  only the (+)-isomer (9R, 10aR) configuration produces active compounds

## Biosynthesis

Lysergic acid is biosynthesized via the ergot alkaloid pathway in fungi of the
family Clavicipitaceae.

The pathway proceeds through several key intermediates:

1. **L-tryptophan** → *dimethylallyltryptophan* (DMAT) via prenylation
2. DMAT → *chanoclavine-I* via oxidation and cyclization
