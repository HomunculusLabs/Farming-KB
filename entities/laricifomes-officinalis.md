...
- **Order:** Polyporales
- **Family:** Fomitopsidaceae
- **Genus:** *Laricifomes* (monotypic — this is the only species)
- **Species:** *L. officinalis*
- **Basionym:** *Boletus officinalis* Vill. (1789)
- **Key synonyms:** *Fomes officinalis* (Vill.) Fr. (1821), *Fomitopsis officinalis* (Vill.) Bondartsev & Singer (1941), *Polyporus officinalis* (Vill.) Pers. (1801)
- **Historical name:** "Agaricum" (Dioscorides, ~70 AD)
- The species was transferred to its own genus *Laricifomes* based on phylogenetic analyses showing it is not closely related to the type species of *Fomitopsis*. DNA sequencing confirmed its distinct evolutionary lineage within Fomitopsidaceae.

## Morphology and Identification

### Fruiting Body (Basidiocarp)
- **Form:** Large, perennial, hoof-shaped to cylindrical conks, often extending laterally from the trunk
...
- Considered a powerful spiritual medicine by some tribal traditions
- Some tribal elders regarded it as the most powerful of all medicinal mushrooms

## Modern Medicinal Research

### Agaricin / Laricic Acid
- Bitter triterpenoid compound isolated in the 19th century (Knop, 1863)
- Historically used as a diaphoretic and antihidrotic, particularly for tuberculosis patients
- Largely abandoned as a pharmaceutical by the mid-20th century

### Antiviral Research (Stamets / NIH / USAMRIID)
- Paul Stamets discovered that mycelial extracts of *L. officinalis* protect human blood cells from orthopox viruses (the family including smallpox)
- Through the Biodefense BioShield program (NIH and USAMRIID), agarikon showed potent activity against vaccinia pox and cowpox viruses
- Additional antiviral activity demonstrated against herpesviruses (HSV-1, HSV-2), influenza A (including H5N1 avian influenza), and HIV
...
- β-glucans and polysaccharides show immunomodulatory activity
- Preliminary in vitro studies suggest some antiproliferative (anticancer) activity

## Notable Chemical Compounds

| Compound | Class | Significance |
|----------|-------|-------------|
| Agaricic acid (laricic acid) | Triterpenoid / organic acid | Classic bitter principle; antihidrotic, antibacterial |
| Lanoconol | Lanostane triterpenoid | Triterpenoid constituent |
| Lanoic acid | Lanostane triterpenoid | Bitter triterpenoid |
| Polyporenic acid C | Triterpenoid | Bioactive constituent |
...
- Considered **Endangered** in many European countries; estimated to have declined 50–80% across its European range over the past century
- Primary threat: loss and fragmentation of old-growth conifer forests due to logging
- Secondary threats: overharvesting, air pollution, climate change
- Protected by law in Austria, Germany, Switzerland, Poland, and other European countries
