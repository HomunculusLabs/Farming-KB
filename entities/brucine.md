...
- **IUPAC name**: (2S,3aS,8aS)-2,3,3a,8,8a-Hexahydro-3,4-dimethoxy-1H-2,8a-imino-1,3-diaza-fluorene
- **Molecular formula**: C₂₃H₂₆N₂O₄
- **Molecular weight**: 394.46 g/mol
- **CAS number**: 357-57-3
- **Melting point**: 178 °C (decomposes)
- **Boiling point**: Sublimes at approximately 280 °C
- **Density**: 1.41 g/cm³
- **Solubility**: Slightly soluble in water (1:500 at 25 °C); soluble in chloroform, ethanol, and dilute acids as salts
- **Optical rotation**: [α]D²⁰ = −85° (in chloroform)
...
Brucine acts as a competitive antagonist at the strychnine-sensitive glycine receptor (GlyR), blocking the glycine-binding site on the α subunit with approximately 10–30 times lower affinity than strychnine (Ki ≈ 50–200 nM for brucine versus 1–10 nM for strychnine). This reduced affinity accounts for its lower convulsant potency. Like strychnine, brucine preserves consciousness during convulsions, as its action is limited to disinhibition of motor pathways without suppressing higher cortical functions. The two methoxy substituents on ring D reduce the planar hydrophobic interaction with the GlyR binding pocket, accounting for the diminished affinity.
...
- **Chiral resolving agent**: Widely used in synthetic organic chemistry to resolve racemic mixtures of carboxylic acids, particularly N-acylamino acids; forms diastereomeric salts with differing solubility
- **Anti-arthritic**: Reduces joint swelling and histopathological damage in adjuvant-induced arthritis models
- **Immunomodulatory**: Modulates both humoral and cell-mediated immune responses at sub-toxic doses
- **Hepatoprotective**: Attenuates CCl₄-induced hepatic injury at doses below the convulsant threshold

## Toxicology

Brucine is toxic but considerably less so than strychnine, with an estimated lethal dose in humans of approximately 1–2 g (compared to 50–100 mg for strychnine). The clinical presentation of brucine poisoning resembles a milder form of strychnine poisoning, with muscle stiffness, hyperreflexia, and convulsions appearing at higher doses. The onset of symptoms is typically slower (30–120 minutes) due to the compound's lower receptor affinity. Treatment is supportive, following the same principles as strychnine poisoning management: activated charcoal, benzodiazepines for seizure control, and mechanical ventilation if needed. Recovery without sequelae is expected with adequate supportive care. Brucine has a NOAEL of approximately 2.8 mg/kg/day in subchronic rodent studies.
...
opportunities for brucine. [[jeavons-climate-adaptation-growing-seasons]]
