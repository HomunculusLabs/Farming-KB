...
and anthropogenic substrates makes it a familiar sight on walls, pavements,
and building facades across temperate cities.

## Taxonomy and Morphology

*Lecanora muralis* was originally described as *Lichen muralis* by
Schreber in 1771 and transferred to *Lecanora* by Rabenhorst in 1845.
The epithet *muralis* refers to its preference for growing on walls.

The thallus is crustose to squamulose, forming circular colonies 2-10 cm
in diameter. Individual squamules are 1-4 mm wide, radiating from the
centre in a rosette pattern, with closely adnate margins.

The upper surface is brown to greyish-brown at the centre, becoming white
to pale grey at the margins due to a dense pruina. The lower surface is
dark with a well-developed hypothallus spreading beneath the squamules.

Apothecia are frequent, 0.5-2 mm diameter, lecanorine with a well-
developed thalline margin matching the thallus colour. The disc is brown
to dark brown, flat to slightly convex.

Spores are ellipsoid, colourless, simple, 10-16 × 6-9 µm. The species
...
**stictic acid** in some populations. Chemical variability has been
documented across different substrates and geographic regions.

Extracts show moderate antibacterial activity, primarily attributed to
usnic acid. The species has been included in broad surveys of lichen
metabolites for potential pharmaceutical applications.
...
In [[bloomfield-stachybotrys-indoor-mold-trichothecenes-air-quality]],
