...
**Teucrium chamaedrys**, commonly known as wall germander, is a low-growing evergreen subshrub in the family Lamiaceae.
...
The species is valued both as an ornamental garden plant and as a medicinal herb, particularly in European phytotherapy for digestive and metabolic complaints.
...
Wall germander is native to much of Europe, from the British Isles eastward through central and southern Europe to the Caucasus and western Asia.
...
Several reports of liver injury linked to germander-containing dietary supplements led to regulatory restrictions in some countries.

The European Medicines Agency HMPC has issued a public statement noting the hepatotoxic risk and recommending caution in use.

Consequently, internal use of wall germander is now discouraged in modern herbal practice in favor of safer alternatives.

## Cultivation

Wall germander is an easy-to-grow ornamental herb suited to rock gardens, border edging, and knot garden designs.

It prefers well-drained, alkaline to neutral soils with full sun exposure.
...
Once established, wall germander is remarkably drought-tolerant and requires minimal supplemental irrigation.

Pruning after flowering maintains a compact form and encourages dense, bushy regrowth.

The species is generally pest-free, though it can be susceptible to root rot in waterlogged soils.

Wall germander responds well to shearing and has historically been used in formal knot gardens as a hedging substitute for boxwood.

It is also suitable for container cultivation, where its trailing stems create an attractive cascading effect.

## Ecological Role

The flowers of Teucrium chamaedrys are an important nectar source for bees, butterflies, and other pollinating insects.

Its long flowering period from midsummer into early autumn provides sustenance during a season when many other plants have finished blooming.

The dense, low-growing habit creates sheltered microhabitats for ground-dwelling invertebrates.

Wall germander contributes to soil stabilization on rocky slopes and walls, where its rooting stems help bind loose substrate.

In its native Mediterranean range, it forms part of the garrigue and maquis shrubland communities.
