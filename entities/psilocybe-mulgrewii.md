...
- **Size and stature:** P. mulgrewii is notably smaller and more delicate than [[psilocybe-cyanofibrillosa]]. The striate margin when moist is a good field mark.
- **Annulus:** The partial veil leaves only a faint, evanescent annular zone, much less prominent than the more persistent ring zone of [[stamets-psi-psilocybe-azurescens-species-guide]] and [[psilocybin]]-containing species. Analytical studies by Jochen-Gartz|Gartz reported the following approximate alkaloid concentrations in dried basidiocarps:

- **Psilocybin:** 0.3 to 0.7% dry weight
- **Psilocin:** 0.1 to 0.3% dry weight
- **Baeocystin:** 0.01 to 0.05% dry weight (trace amounts)

These values place P. mulgrewii in the moderate range of potency among section Cyanescens members, below [[psilocybe-cyanofibrillosa]]. Total tryptamine content ranges from approximately 0.4 to 1.0% dry weight, which is significant enough to produce pronounced psychoactive effects. For comparison, [[stamets-psi-psilocybe-azurescens-species-guide]] — Larger and more robust, with caps reaching 100 mm and a distinctly umbonate cap. Bruising is far more intense, producing deep indigo-black staining. Higher psilocybin content (up to 1.8%). Generally more abundant and the species most likely to be confused with P. mulgrewii due to shared habitat. Key distinction: overall size and intensity of bruising.
...
When working with Psilocybe mulgrewii, several practical factors should be
