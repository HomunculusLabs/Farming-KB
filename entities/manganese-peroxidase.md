...
The Mn(III) product forms chelates with organic acids (e.g., oxalate) secreted by fungi, creating a stable diffusible oxidant that can penetrate micropores in the lignin matrix inaccessible to the enzyme itself. This extends the effective range of [[lignin-degradation]] beyond the immediate vicinity of the enzyme. MnP works synergistically with other ligninolytic enzymes, targeting phenolic lignin units while lignin peroxidase attacks non-phenolic moieties.
...
- Core component of the fungal lignin degradation enzyme system (Table 2.14, Sinsabaugh and Liptak, 1997), alongside lignin peroxidase and laccases.

- The Mn(III) chelate product penetrates micropores in the lignin matrix inaccessible to the enzyme, extending the effective range of lignin degradation.

- More widely distributed among wood-decay fungi than lignin peroxidase; produced by nearly all white-rot species.

- Works synergistically with lignin peroxidase: MnP attacks phenolic lignin units while LiP targets non-phenolic moieties.

- Enzyme production is regulated by nitrogen and phosphorus availability (Sinsabaugh et al., 1993); fungi upregulate expression in nutrient-poor conditions.

- Temperature and cellulose:lignin ratio positively influence extracellular cellulase activity (Linkins et al., 1984); similar factors regulate peroxidase production.

- Cellulose becomes unavailable for microbial use when the cellulose:lignin ratio declines below 0.5.

- A significant driver of lignocellulose degradation in both terrestrial and aquatic decomposer systems.
...
- Critical for understanding substrate degradation in wood-based mushroom cultivation systems.
...
- Manganese availability in substrate formulations can influence enzyme production and degradation efficiency.

- In composting operations, MnP activity contributes to breakdown of recalcitrant organic matter, improving compost quality.
...
- Sinsabaugh, R.L. et al. (1993). Wood decomposition enzyme studies.
