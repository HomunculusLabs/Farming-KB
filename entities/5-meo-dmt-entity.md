...
| Property | Value |
|----------|-------|
| **IUPAC name** | N,N-dimethyl-2-[5-methoxy-1H-indol-3-yl]ethanamine |
| **CAS number** | 1019-45-0 |
| **Molecular formula** | C₁₃H₁₈N₂O |
| **Molecular weight** | 218.30 g/mol |
| **SMILES** | COc1ccc2[nH]c(CCN(C)C)c(C)c2c1 |
| **Appearance** | White to off-white crystalline powder or oily solid |
| **Melting point** | 69–71 °C (freebase) |
| **Solubility** | Soluble in ethanol, DMSO; slightly soluble in water (salt) |

5-MeO-DMT exists in freebase form as an oily or waxy solid and as a hydrochloride or fumarate salt as a stable crystalline powder. The freebase is typically vaporized for inhalation, while the salt form is used for intranasal or parenteral administration in research settings.

## Natural Sources

5-MeO-DMT is biosynthesized from tryptamine via sequential methylation and hydroxylation pathways, parallel to but divergent from the N,N-DMT pathway. The key biosynthetic step is O-methylation of serotonin by indole O-methyltransferase (IOMT), followed by N,N-dimethylation by tryptamine
N-methyltransferase (TNMT).
...
Indigenous use of this toad venom in Mesoamerican ceremonies is debated; most
ethnographic evidence supports plant-based sources (Virola, Anadenanthera) as
the primary traditional vectors.
...
|----------|--------------|-------------------|
| 5-HT1A | ~10–20 nM | Full agonist — anxiolytic and antidepressant |
| 5-HT2A | ~100–300 nM | Partial agonist — weaker than psilocin |
| 5-HT2C | ~200 nM | Agonist |
| Sigma-1 | ~2 µM | Agonist — neuroprotective, anti-inflammatory |
| MAO-A | Substrate | Rapidly metabolized; inactive orally without MAOi |

### Pharmacokinetics

| Parameter | Detail |
|-----------|--------|
| **Onset (vaporized)** | 5–15 seconds |
| **Duration (vaporized)** | 15–40 minutes; peak 2–5 minutes |
| **Onset (intranasal)** | 2–5 minutes |
| **Duration (intranasal)** | 30–60 minutes |
| **Oral bioavailability** | Negligible (first-pass MAO-A metabolism) |
| **Half-life** | ~1 hour (limited data) |
| **Metabolism** | MAO-A deamination to 5-MeO-IAA; CYP2D6 oxidation |

The high 5-HT1A affinity is particularly significant — 5-HT1A agonism is the
mechanism of anxiolytic drugs like buspirone and is associated with
antidepressant and prosocial effects. This may explain why 5-MeO-DMT
experiences frequently produce a stronger "afterglow" of well-being compared
to other psychedelics.

## Dosage and Effects

### Dosage Ranges (Vaporized Freebase)

| Range | Dose (mg) | Experience Level |
|-------|-----------|-----------------|
