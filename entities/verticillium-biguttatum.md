...
soil-borne plant pathogens worldwide.

V. biguttatum was first isolated from soil and characterized as a
mycoparasite of R. solani in the 1970s. Subsequent research has
established it as a significant natural regulator of R. solani
...
a combination of mechanical pressure and enzymatic degradation,
ultimately lysing the host hyphae and deriving nutrients from the
dead tissue.

The species produces cell wall-degrading enzymes including
chitinases and beta-1,3 glucanases that facilitate penetration of
the R. solani cell wall. The specific enzyme profile and mode of
interaction may vary depending on the anastomosis group (AG) of
the R. solani isolate, as different AGs represent genetically
distinct populations with varying susceptibility.
...
Field studies have shown significant reductions in stem canker
...
V. biguttatum occurs in agricultural soils worldwide,
particularly in temperate regions where R. solani is prevalent.
The parasite's distribution is closely linked to that of its
...
(plant pathogen) within the same genus illustrates the diversity
of ecological strategies in fungi. While V. dahliae attacks plant
vascular systems, V. biguttatum attacks fungal hyphae. Both
species produce similar conidial structures, but their ecological
roles are diametrically opposed, with V. biguttatum protecting
plants and V. dahliae causing disease.
