...
Young seed pods (called drumsticks) are cooked like green beans and are a popular ingredient in South Asian cuisine. The flowers are edible and can be brewed into tea or added to stir-fries. Seeds can be pressed for oil (ben oil) used in cooking and cosmetics, or used whole for water purification.
...
Root rot in waterlogged soil is the most significant disease threat. Termites may attack moringa wood in tropical regions, particularly in stressed or drought-weakened trees. Healthy, well-watered trees are rarely affected by serious pest or disease problems.
