...
because it requires
minimal equipment, no electricity beyond a grow light, and no daily maintenance 
or
monitoring. For cannabis growers on a budget or those seeking a truly hands-off 
approach,
the Kratky method offers a viable path to producing quality buds with 
significantly less
complexity than traditional hydroponic systems or even soil-based growing.
...
with the
correct nutrient concentration at the start. Many Kratky growers use a slightly 
lower initial
EC (around 0.8 to 1.0 for seedlings, increasing to 1.5 to 2.0 for vegetative and
 flowering
phases) to account for the fact that the solution becomes more concentrated as 
pure water
