---
title: "What Causes Cannabis Leaves to Curl and How to Fix It"
...
Leaf curling is one of the most common symptoms cannabis growers encounter,
and it can be caused by a wide range of issues. Because multiple problems
can produce similar symptoms, diagnosis requires looking at the overall
pattern: which leaves are affected, the direction of curling, whether
margins are also rolling, and what other symptoms accompany the curling. A
systematic approach to troubleshooting prevents misdiagnosis and
inappropriate treatments that can make the problem worse.
...
Watering problems are the second most common cause. Overwatering produces
downward-curling leaves that feel heavy and limp, often accompanied by
...
mites cause stippling and fine webbing but can also lead to leaf curling in
severe infestations. Close inspection of the undersides of affected leaves
usually reveals the culprit. Early intervention with appropriate organic
controls prevents the population from exploding and causing serious damage.

Temperature extremes at either end of the spectrum can trigger leaf curling.
Cold stress from temperatures below 50 degrees Fahrenheit causes leaves to
curl downward and develop a dark, water-soaked appearance. Heat stress above
85 degrees with low humidity causes upward curling and leaf cupping as the
plant tries to reduce transpiration surface area. Gradual acclimation to
temperature changes and maintaining stable growing conditions prevents both
problems in indoor and outdoor growing environments.
