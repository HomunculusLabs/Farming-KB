...
- concepts/cannabis-health-therapeutics.md
...
|----------|---------|-------------------|---------------|----------------|---------------|-----------|-----------------|
| **N (Nitrogen)** | Mobile | Pale yellow chlorosis, progressing upward; stunted growth; small leaves | OLDER leaves first, moves up | Vegetative (peak demand) | All — especially light-amended soil | Top-dress blood meal, compost, or FAA 1:1000 | Pre-amend soil with 2c blood/feather meal per cu.yd |
...
|-------------|----------------|---------------------|------------|
| Yellowing of bottom/older leaves | Lower canopy | Nitrogen (N) | Overwatering, root problems |
| Yellowing BETWEEN green veins (older leaves) | Lower-mid canopy | Magnesium (Mg) | Iron (if on new growth) |
| Yellowing BETWEEN green veins (new leaves) | Upper canopy/tips | Iron (Fe) or Manganese (Mn) | Fe = no spots; Mn = brown dead spots |
| Uniform yellowing of new leaves (top) | Growing tip, newest leaves | Sulfur (S) or Molybdenum (Mo) | N deficiency (but N shows on old leaves) |
| Dark green/purple leaf undersides | Older leaves, undersides | Phosphorus (P) | Cold temps cause temporary P lockout |
| Brown crispy leaf edges/tips | Older leaves, margins | Potassium (K) | Light burn, nutrient salt excess |
...
1. **Mobile nutrients** (N, P, K, Mg) — deficiency shows in OLDER leaves first; plant relocates to new growth
2. **Immobile nutrients** (Ca, Fe, Mn, Zn, Cu, B, S, Mo) — deficiency shows in NEW growth first
3. **pH lockout** is the #1 mimic — test pH before adding nutrients
   - Fe, Mn, Zn unavailable above pH 7.5
   - Ca, Mg deficient below pH 5.5
4. **Overwatering** causes identical symptoms to many deficiencies — check soil moisture first
5. **In living soil**, most deficiencies stem from under-amended base mix or pH issues
...
|----------|-------------------|
| Below 5.5 | Ca, Mg become deficient |
| 5.5 - 6.5 | Optimal for most nutrients |
| 6.0 - 7.0 | Target range for living soil |
| Above 7.0 | Fe begins locking out |
| Above 7.5 | Fe, Mn, Zn severely unavailable |

## Common Nutrient Problems (from wiki sources)
...
| N deficiency in flower | Normal transition | Reduce N inputs after week 5 flower |

## See Also

- [[cannabis-plant-nutrition]] — full nutrient science and organic sources
- [[soil-amendment-reference]] — comprehensive amendment reference by nutrient
- [[cannabis-living-soil-amendment-schedule]] — week-by-week feeding schedule
- [[cannabis-vegetative-stage]] — vegetative nutrition management
- [[cannabis-flowering-stage]] — flowering nutrition management
