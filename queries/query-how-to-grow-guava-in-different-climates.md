...
- **Growing season:** Spring through fall; one to two harvests per year.
- **Temperature range:** 55–90°F ideal; brief frost possible.
- **Key advantage:** Good balance of growth and manageable pest pressure.
- **Challenge:** Occasional cold snaps requiring protection below 28°F.

### Mediterranean (USDA 9–10)

- **Growing season:** Spring through early winter with irrigation.
- **Temperature range:** 50–95°F; dry summers, mild wet winters.
- **Key advantage:** Low disease pressure due to dry air.
- **Challenge:** Requires consistent summer irrigation; winter chilling below 27°F can defoliate trees.
...
1. Dig a hole 2× the width and equal depth of the root ball.
2. Loosen the sides and bottom of the hole to prevent root circling.
3. Place the tree so the root flare is level with or slightly above the soil line.
4. Backfill with native soil mixed with 20% compost; firm gently — do not compact.
5. Build a 3-inch berm around the drip line to retain water.
6. Apply 3–4 inches of mulch, keeping it 3 inches away from the trunk.
7. Water thoroughly at planting, then every 2–3 days for the first month.
...
- **Storage:** Ripe guava lasts 3–5 days at room temperature; 1–2 weeks refrigerated.

## Common Mistakes to Avoid

- **Overwatering** — the #1 killer of young guava trees; let the top inch of soil dry between waterings.
- **Planting in poorly drained soil** — always improve drainage before planting.
- **Ignoring pH** — guavas suffer in highly alkaline soils; test and amend annually.
- **Using plastic frost covers** — plastic transfers cold directly to foliage; use breathable frost cloth.
- **Under-fertilizing container trees** — nutrients leach quickly from pots; maintain a consistent feeding schedule.
- **Letting trees grow too tall** — unreachable fruit leads to waste and pest habitat; prune annually.
- **Skipping pest monitoring** — fruit flies can destroy an entire crop; set traps early in the season.

## Quick-Reference Growing Summary

| Factor | Tropical | Subtropical | Mediterranean | Temperate/Pot |
|---|---|---|---|---|
| **Sunlight** | Full sun | Full sun | Full sun | Full sun / grow light |
| **Water frequency** | 1–2× per week | 2× per week | 2–3× per week | Daily (summer) |
| **Fertilizer** | 4× per year | 3× per year | 3× per year | Every 6–8 weeks |
| **Pruning** | After harvest | After harvest | After harvest | As needed |
| **Min. temp** | No frost | ~27°F (brief) | ~27°F (brief) | Move indoors <32°F |
| **Harvest window** | Year-round | Summer–Fall | Summer–Fall | Late Summer–Fall |
| **Key challenge** | Fruit flies | Cold snaps | Summer irrigation | Light & space |
