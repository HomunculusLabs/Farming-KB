...
Nutrient burn, sometimes called tip burn or fertilizer burn, is one of the most
common problems encountered by cannabis growers, especially those new to bottled
nutrient programs. The condition is characterized by a progressive browning and
crisping of leaf tips that starts at the edges and works inward. In severe
cases, entire leaves become necrotic and die. While the symptoms appear on the
foliage, the actual damage begins at the root level, where high salt
concentrations in the growing medium create an osmotic gradient that pulls water
out of root cells rather than into them.

The fundamental mechanism behind nutrient burn is osmotic stress. Plant roots
rely on a balance between the salt concentration inside the root cells and the
