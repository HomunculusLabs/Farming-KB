...
The [[biochar]] page provides a comprehensive overview of biochar science, production
methods, and its role in sustainable agriculture.

The most immediate benefit biochar provides is improved soil structure. Its porous
particles act like microscopic sponges that hold both water and dissolved nutrients,
reducing leaching and making both available to plant roots over extended periods. In
sandy soils, biochar increases water-holding capacity and nutrient retention. In clay
soils, it improves drainage, reduces compaction, and creates pore spaces for root
penetration. The [[biochar-soil-amendment]] page covers the specific physical and
chemical mechanisms by which biochar modifies soil properties, and the
[[biochar-in-agriculture]] page reviews research on crop yield responses to biochar
application across different soil types and climates.

A critical caveat that many gardeners miss is that fresh biochar should not be applied
directly to soil without pre-charging or inoculation. Fresh biochar has an extremely high
cation exchange capacity and will initially adsorb nutrients from the surrounding soil,
potentially creating a temporary nutrient deficit for plants. This is sometimes called the
biochar hunger effect. Pre-charging involves soaking biochar in compost tea, liquid
fertilizer, worm castings slurry, or manure tea for several weeks before application,
allowing the pores to fill with nutrients and beneficial microorganisms. The
...
[[biochar-production-guide]] page explains how to produce biochar at home using simple
methods like the cone pit kiln or retort, and the [[mollison-designers-charcoal-production-biochar-soil-amendment]] page discusses biochar in the context of permaculture
design systems.
...
them from predation and desiccation. The [[biochar-and-fungi]] page specifically examines
how biochar supports mycorrhizal networks and fungal diversity in soil, and research has
shown that biochar-amended soils often have higher microbial biomass and greater
enzymatic activity than unamended soils. This biological benefit compounds over time as
the microbial community established in biochar pores contributes to nutrient cycling
and disease suppression.

For bioremediation purposes, biochar has shown promise in binding heavy metals and
organic pollutants, immobilizing them so they are less available for plant uptake or
groundwater contamination. The [[biochar-soil-remediation]] page covers this application
...
- Biochar is created by pyrolyzing biomass in low-oxygen conditions, producing a highly
  porous stable carbon material [[biochar]]
- Fresh biochar must be pre-charged with nutrients and microbes to avoid temporary
  nutrient binding [[biochar-soil-amendment]]
- Biochar improves water retention in sandy soils and drainage in clay soils
  [[biochar-in-agriculture]]
- Biochar persists in soil for centuries, making it an effective carbon sequestration
  tool [[biochar-production-guide]]
- Biochar provides habitat for mycorrhizal fungi and beneficial soil microorganisms
  [[biochar-and-fungi]]
- Biochar works best as a complement to compost, not a replacement for it
...
[[biochar-soil-amendment]] page provides detailed application guidelines for different
soil types and crop systems.
