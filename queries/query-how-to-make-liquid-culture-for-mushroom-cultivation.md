...
Liquid culture (LC) is a nutrient-rich liquid medium inoculated with mushroom mycelium, used to
rapidly expand mycelial mass for inoculating grain spawn or bulk substrates. To make it, you
prepare a sugar-based broth (commonly light malt extract dissolved in water), sterilize it in a
pressure cooker, and introduce clean mycelium from an agar plate or existing culture under sterile
conditions. The mycelium colonizes the liquid in 7 to 21 days, producing a network of floating
white threads that can be drawn into a syringe or poured directly onto sterilized grain.
...
Once fully colonized, LC can be used in several ways. The most common method is drawing the liquid
into a sterile syringe through the self-healing injection port and using it to inoculate grain
spawn jars or bags. This approach is extremely efficient, as each 60 mL syringe can inoculate 5
...
- Agitate LC jars regularly using a magnetic stirrer or manual shaking to accelerate colonization
