...
Rainwater is naturally soft, free of the chlorine, fluoride, and mineral salts found in most municipal water supplies.
...
Your gutter and downspout system is the conveyance network that moves rainwater from the roof to your storage tank.
Clean, well-maintained gutters are essential for efficient water collection from your roof catchment surface.
Install leaf guards or screens on your gutters to prevent debris from entering the system.
Clean the gutters at least twice per year (spring and fall) to remove accumulated leaves, twigs, and sediment.
The gutter should slope slightly toward the downspout (approximately 1 centimeter per 3 meters of gutter length).
This ensures water flows efficiently to the collection point rather than pooling in low spots along the gutter run.
The downspout must be modified to direct water into your storage tank or rain barrel.
A simple diverter fitting installed in the downspout allows you to direct water into the tank during the rainy season.
The diverter can be set to bypass the tank during freezing conditions or when the tank is already full.
Flexible downspout extensions or solid PVC piping connect the downspout diverter to the tank inlet.
Ensure all connections are secure and watertight to prevent water loss and mosquito breeding in standing water.
### Filtration and First-Flush Diversion
Filtration is essential for keeping debris out of your storage tank and maintaining water quality over time.
The first level of filtration is a screen or leaf guard at the gutter that removes large debris like leaves and twigs.
...
These include dust, pollen, bird droppings, and other debris that have accumulated since the last rainfall.
A first-flush diverter captures this initial dirty water and routes it away from the storage tank.
This ensures that only cleaner water from later in the storm enters your storage vessel.
Simple first-flush diverters can be constructed from PVC pipe with a float valve that automatically resets between rain events.
### Storage Tank Options
Storage tanks are the most visible and often most expensive component of a rainwater harvesting system.
Options range from simple 55-gallon food-grade plastic barrels for small systems to 10,000-gallon underground cisterns.
For most home gardeners, polyethylene plastic tanks in the 200 to 1000 gallon range offer the best balance of affordability and durability.
These tanks are available in a wide range of colors, with dark colors preferred to inhibit algae growth by blocking sunlight.
Tank placement is important for both function and aesthetics of your garden landscape.
The tank should be elevated on a sturdy, level platform at least 30 centimeters above the ground.
This elevation provides gravity-fed water pressure for irrigation hoses and drip systems.
A platform 60 to 90 centimeters high provides even better pressure for drip irrigation systems that require minimum operating pressure.
The tank should be located close to the garden area it serves to minimize the length of distribution hoses and reduce friction losses.
In cold climates, tanks must be drained before freezing temperatures arrive to prevent ice damage to the tank and plumbing connections.
...
|--------|-------------------|---------------|-----------------|
| Spring | High (frequent rain) | Moderate (growing) | Fill tanks, use surplus for deep watering |
| Summer | Low (dry periods) | High (peak growth) | Rely on stored water, supplement if needed |
| Fall | Moderate | Moderate to low | Top up tanks, reduce irrigation frequency |
| Winter | Variable | Minimal | Drain tanks in freezing climates, maintain in mild |
### System Cost Estimates
| System Size | Components | Estimated Cost | Garden Area Served |
|-------------|-----------|---------------|-------------------|
| 55 gallons (single barrel) | Barrel, diverter, screen, hose bib | 50 to 150 dollars | Small container garden |
| 200 gallons (2 to 3 barrels) | Barrels, linking kit, diverter, platform | 200 to 400 dollars | 100 to 200 square foot garden |
| 500 gallons (single tank) | Poly tank, diverter, first-flush, platform | 400 to 800 dollars | 200 to 400 square foot garden |
| 1000 gallons (single tank) | Poly tank, pump, filtration, plumbing | 800 to 2000 dollars | 400 to 800 square foot garden |
### Maintenance Requirements
Regular maintenance keeps your rainwater harvesting system functioning efficiently and ensures water quality remains high.
The most important maintenance task is cleaning gutters and screens at least twice per year.
Check the first-flush diverter for proper operation after each major storm event.
