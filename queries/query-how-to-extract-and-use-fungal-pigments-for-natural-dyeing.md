...
The basic extraction process is straightforward:

1. **Collect and identify** your mushrooms with absolute certainty. Never use a mushroom you cannot positively identify.
2. **Clean** the specimens by brushing off debris. Avoid washing unless absolutely necessary, as water can dilute pigment.
3. **Chop or tear** the mushrooms into small pieces to increase surface area. Fresh, dry, or frozen material all work; dried mushrooms are often more concentrated by weight.
4. **Soak** the pieces in water for several hours or overnight. This softens the tissue and begins pigment release.
...
Protein fibers absorb fungal pigments most readily and produce the most vivid results:

- **Wool**: The gold standard for mushroom dyeing. Absorbs color deeply and evenly.
- **Silk**: Produces brilliant, luminous colors with excellent fastness.
- **Alpaca, mohair, and other animal fibers**: Perform similarly to wool, often with excellent results.

Cellulose fibers can be dyed but require more preparation:

- **Cotton and linen** need a tannin pretreatment (such as oak gall or sumac) before mordanting to help the dye bind. Use a cellulosic mordanting method with alum and tannin for best results.
- **Bamboo and hemp** fall between protein and cellulose in their affinity for fungal dyes.
...
Fungal dyes vary significantly in their permanence:

- **Cortinarius reds** are among the most lightfast natural dyes known, often rivaling synthetic reds. Some specimens retain color for decades with minimal fading.
- **Phaeolus yellows and greens** have good to moderate lightfastness, especially when properly mordanted with alum.
- **Lichen dyes** tend to be moderately lightfast but can fade with prolonged direct sun exposure.
- **Tannin-based browns** from polypores are generally very stable and wash-fast.
