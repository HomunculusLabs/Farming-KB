...
- **Excellent for vegetables, herbs, and strawberries** — steady moisture improves yields
- **Low maintenance** — once built, the system largely manages itself

## Core Design Principles

Every wicking bed shares these essential components:
