...
- entities/steve-solomon.md
- entities/paul-stamets.md
...
| **Fedco Seeds** | Co-op: seeds, trees, tubers, bulbs | Cooperative model; divisions: Fedco Seeds, Organic Growers Supply, Fedco Trees, Moose Tubers, Fedco Bulbs; excellent value | Maine, USA | permaculture-beginners-guide |
| **Southern Exposure Seed Exchange** | Heirloom, traditional organic varieties | Vegetables, sunflowers, flowers, herbs; SE US-adapted varieties | Virginia, USA | permaculture-beginners-guide |
| **Seed Savers Exchange** | Heirloom seeds, seed exchange | Founded 1975; nonprofit; heirloom preservation pioneer; 20,000+ varieties; member exchange network | Iowa, USA | permaculture-beginners-guide |
| **Jung Seed Company** | Seeds, bulbs, root stock, trees | Full-line garden supplier including trees and ornamentals | Wisconsin, USA | permaculture-beginners-guide |

## Mushroom Spawn and Supply Companies
...
## Nursery and Perennial Plant Suppliers
...
### Seed Starting
- LED shop lights (T5/T8, 4000-5000K): $30-60 from hardware store — best value
- Heat mat with thermostat: $25-40 from Amazon
- Seed trays (72-cell): reusable 5+ seasons
- Timer: $5-10 basic outlet timer
...
### Soil Biology
- Microscope (400x minimum): for serious identification work
- Compost tea brewer: 5-gallon bucket + air pump
- Soil testing: Soil Food Web Inc. for professional microbiome analysis
...
- Test mushrooms if growing near industrial areas ($50-125 per analysis)
