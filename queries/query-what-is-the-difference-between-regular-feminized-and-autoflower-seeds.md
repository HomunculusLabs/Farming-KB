...
resilient plants compared to feminized seeds.

Feminized seeds are created by stressing a female plant to
produce male flowers (often using colloidal silver or
rodelization), then using that pollen to fertilize another
...
genotype refers to its genetic code. Even feminized seeds from
the same batch can produce noticeably different plants because
