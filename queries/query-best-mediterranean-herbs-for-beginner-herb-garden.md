...
updated: 2026-05-03
sources:
  - title: "The Mediterranean Herb Handbook"
...
Beautiful, fragrant, and deer-resistant. English lavender varieties ('Hidcote', 'Munstead') are the hardiest and most beginner-friendly. Use for culinary purposes, sachets, or simply enjoy the blooms.

## Soil Preparation Steps

1. **Test drainage** — Dig a 12" hole, fill with water, and check it drains within 1–2 hours.
2. **Amend heavy clay** — Mix in 2–3 inches of coarse sand or perlite plus 1–2 inches of compost.
3. **Add gravel** — A ½" layer of crushed gravel at the bottom of planting holes or containers improves drainage.
4. **Target pH** — Mediterranean herbs prefer slightly alkaline soil (pH 6.5–7.5). Add lime if your soil is acidic.
5. **Avoid rich soil** — Excess nitrogen produces leggy, less flavorful growth. Lean soil is ideal.

## Starting from Seed vs. Nursery Plants

| Herb | From Seed | From Nursery | Recommendation |
|------|-----------|-------------|----------------|
| Rosemary | Slow (3+ weeks), low germination (~30%) | Reliable | **Nursery** |
| Thyme | Moderate (2–3 weeks) | Widely available | Either; seed is fine |
| Oregano | Easy (1–2 weeks), high success | Inexpensive | **Seed** |
| Basil | Very easy (5–10 days) | Readily available | **Seed** — most rewarding |
| Lavender | Slow, stratification helps | Best for beginners | **Nursery** |

**Tip:** If starting from seed, use a heat mat and seed-starting mix. Transplant seedlings after they develop 2–3 sets of true leaves.

## Container vs. In-Ground Recommendations
...
- **Lavender:** Harvest flower spikes when roughly half the buds have opened. Cut in the morning after dew dries.
