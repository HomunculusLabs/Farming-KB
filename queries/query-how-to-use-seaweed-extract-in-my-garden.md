...
3. **Timing:** Apply in the early morning (before 9 AM) or late evening (after 6 PM). Stomata are open and temperatures are cool, maximizing absorption. Midday application risks leaf burn from magnified sunlight on wet droplets and rapid evaporation before absorption can occur
...
Soil drenches deliver seaweed compounds to the root zone and surrounding soil biology:
...
1. **Overdosing:** More is not better with seaweed. Excessive foliar applications can cause leaf burn, especially with alkaline extracts in hot weather. Stick to recommended rates and observe plant response
2. **Applying in full sun:** Wet leaves in direct sunlight can suffer magnification burns. Always apply in morning or evening
3. **Using as sole nitrogen source:** Seaweed does not provide enough nitrogen for heavy-feeding crops. Pair it with an appropriate nitrogen source like compost, fish hydrolysate, or cover crops
4. **Ignoring product type:** Alkaline hydrolysate and cold-pressed extracts behave differently. Cold-pressed products are more biologically active and can be used at lower rates; alkaline products are more stable and forgiving of timing errors
5. **Neglecting the soil:** Foliar applications are fast-acting but don't build long-term soil health. Incorporate kelp meal into your soil annually for cumulative benefits
6. **Incompatible tank mixes:** High-pH alkaline seaweed extracts can precipitate calcium, magnesium, and iron when mixed with hard water or certain nutrient solutions. If your spray water is hard (above 150 ppm calcium), consider using filtered or rainwater, or switch to a cold-pressed product

### Application Schedule Summary

| Growth Stage | Application | Rate | Method |
|-------------|-------------|------|--------|
| Seed soaking | Pre-plant | 5–10 mL/L, 6–12 hr | Soak |
| Transplanting | At planting | 20–30 mL/L, 5–15 min | Root dip |
| Early vegetative | Every 2 weeks | 15–20 mL/L | Foliar spray |
| Active growth | Every 2–3 weeks | 20–30 mL/L | Foliar or drench |
| Pre-flower | Once at onset | 20–25 mL/L | Foliar spray |
