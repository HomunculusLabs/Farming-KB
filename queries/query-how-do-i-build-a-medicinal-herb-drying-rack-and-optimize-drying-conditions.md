...
Drying is the single most critical post-harvest step for preserving medicinal potency. Fresh herbs contain 70–90% water, and the speed and method of moisture removal directly affect the concentration and stabilidecompositioncompounds—alkaloids, [[blesching-cannabis-terpenoids-and-flavonoids]] |
...
- **High-volatile-oil herbs** (lavender, chamomile, [[query-how-do-fungal-volatile-compounds-affect-plant-growth-and-other-microorganisms]].
...
4. **Mount the rack**: Install screw eyes into the top corners. Use S-hooks to hang from a wall-mounted bracket, ceiling hook, or closet rod. The rack should hang freely for [[mycelium-running-forestry-practices-and-mushrooms]] in the same space**: Mushrooms release enormous amounts of spores during drying, which can contaminate herb batches and cause respiratory irritation.
5. **Not labeling immediately**: Once dried, many herbs look similar. Label every jar with the herb name, harvest date, [[holzer-raised-bed-techniques-hugelkultur]]
