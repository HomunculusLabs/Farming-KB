...
The timing of food additions also affects the final microbial balance.
Adding all food sources at the beginning of the brew favors bacteria, which reproduce quickly and consume the easily available nutrients before slower-growing fungi can access them.
A staggered approach, where fungal food sources like humic acid are added at the start and simpler foods like molasses are added partway through, can help shift the balance toward fungal dominance by giving fungi a head start before bacteria accelerate their reproduction.
