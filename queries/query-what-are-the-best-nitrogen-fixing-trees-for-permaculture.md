---
title: What Are the Best Nitrogen-Fixing Trees for Permaculture?
tags: [nitrogen-fixing-trees, legumes, permaculture, agroforestry, food-forest, soil-fertility, nitrogen-fixation, polyculture]
date: 2026-04-28
updated: 2026-04-28
...
- **Black locust (*Robinia pseudoacacia*)** — Top temperate N-fixer for biomass and timber. Coppices on 5–10 year rotations.
- **Honey locust (*Gleditsia triacanthos*)** — Thornless cultivars available. Good silvopasture overstory; light shade allows pasture growth beneath.
- **Siberian pea shrub (*Caragana arborescens*)** — Extremely cold-hardy (Zone 2). Edible seeds (36% protein), nitrogen-fixing, windbreak staple. Fixes 30–60 kg N/ha/year.
- **Sea buckthorn (*Hippophae rhamnoides*)** — Actinorhizal. Edible, nutrient-dense berries (vitamin C superfruit). Fixes 15–45 kg N/ha/year; nitrogen-fixation confined to root zone. Dioecious — plant both sexes for fruit.
- **Alder (*Alnus spp.*)** — Actinorhizal; pioneer on wet/degraded sites. *A. glutinosa* (black alder) and *A. rubra* (red alder) are top performers. Fixes 100–300 kg N/ha/year — among the highest of any tree. Short-lived (40–60 years).
- **Russian olive (*Elaeagnus angustifolia*)** — Actinorhizal; very drought-hardy, silvery foliage, edible fruit. **Highly invasive in riparian areas of North America** — check local regulations before planting.
- **Autumn olive (*Elaeagnus umbellata*)** — Actinorhizal; edible berries, wildlife forage, tolerates poor soils. **Invasive in eastern North America** — consider goumi as a non-invasive alternative.
- **Goumi (*Elaeagnus multiflora*)** — Actinorhizal; non-invasive alternative to autumn olive. Excellent edible fruit, fixes 30–60 kg N/ha/year.
- **Silverberry (*Elaeagnus commutata*)** — Actinorhizal; very cold-hardy (Zone 2), ornamental and edible. Good windbreak component.
- **Redbud (*Cercis canadensis*)** — Moderate N-fixer; ornamental, edible flowers. Light shade, understory-compatible.
- **Kentucky coffeetree (*Gymnocladus dioicus*)** — Slow-growing but long-lived; N-fixing (rhizobial). Drought-tolerant native to central North America. Seeds require processing.

### Cold / Continental (Zone 1–3)

- **Caragana arborescens** — The cold-climate workhorse. Windbreaks, hedge rows, wildlife cover.
- **Alnus spp.** (*A. viridis*, *A. incana*) — Riparian and upland pioneers; highest N-fixation rates for cold zones.
- **Elaeagnus commutata** (silverberry) — Reliable actinorhizal shrub for shelterbelts.
- **Shepherdia argentea** (buffaloberry) — Actinorhizal; edible tart berries, extremely cold-hardy (Zone 2). Dioecious — plant multiple for fruit set.

## Non-Legume (Actinorhizal) Nitrogen Fixers

Actinorhizal trees form nodules with *Frankia* bacteria rather than rhizobia. They often tolerate poorer soils, higher pH, and wetter conditions than legumes. Key genera: **Alnus** (alders), **Elaeagnus** (Russian olive, autumn olive, goumi, silverberry), **Casuarina** (sheoaks — tropical/subtropical), **Hippophae** (sea buckthorn), **Shepherdia** (buffaloberry), **Myrica** (bayberry/sweetfern), and **Coriaria**. These are especially valuable in climates where leguminous NFTs underperform.
...
- **Invasive potential**: Black locust, Russian olive, autumn olive, leucaena, and mesquite are invasive in many regions. Research local regulations and consider non-invasive alternatives (goumi over autumn olive, caragana over black locust in sensitive areas).
...
Start with your USDA hardiness zone and annual rainfall, then filter by function. For **food-producing permaculture** prioritizing edibility: carob (pods), honey locust (pods), goumi (fruit), sea buckthorn (berries), caragana (seeds), and inga (pulp). For **pure biomass/mulch production**: black locust, alder, leucaena, and gliricidia are the fastest and highest-yielding. For **silvopasture** (trees + livestock): honey locust, mesquite, carob, leucaena, and caragana all provide fodder alongside N-fixation. For **cold climates** where options are limited, caragana + alder + silverberry form a reliable foundation trio.

Avoid planting invasive NFTs without a containment strategy. Black locust spreads aggressively by root suckers — coppice frequently and consider root barriers. Russian olive and autumn olive are prohibited in some jurisdictions. Leucaena can form monocultures in the tropics if not managed. When in doubt, choose native or naturalized alternatives with similar function.

## Quick-Reference Table

| Species | Zone | Growth Rate | N-Fix Rate (kg/ha/yr) | Coppiceable | Edible/Forage | Timber |
|---|---|---|---|---|---|---|
| *Leucaena leucocephala* | Tropical | Very Fast | 100–200 | Yes | Fodder, pods | Fuelwood |
| *Gliricidia sepium* | Tropical | Fast | 40–60 | Yes | Fodder | Fence posts |
| *Acacia auriculiformis* | Tropical | Fast | 60–150 | Yes | — | Timber, fuel |
| *Inga spp.* | Tropical | Moderate | 20–40 | Limited | Edible pulp | Shade |
| *Albizia lebbeck* | Tropical/Sub | Moderate | 30–50 | Yes | Fodder | Timber |
| *Prosopis spp.* | Subtropical/Arid | Moderate | 20–60 | Yes | Pods | Fuelwood |
| *Ceratonia siliqua* | Subtropical | Slow | 10–25 | Limited | Pods (flour) | — |
| *Robinia pseudoacacia* | Temp/Cold | Fast | 100–160 | Yes | Flowers | Premium posts |
| *Gleditsia triacanthos* | Temperate | Moderate | 15–40 | Limited | Pods (livestock) | — |
| *Caragana arborescens* | Temp/Cold | Moderate | 30–60 | Yes | Seeds (protein) | — |
| *Alnus glutinosa* | Temperate | Fast | 100–300 | Yes | — | Furniture |
| *Hippophae rhamnoides* | Temp/Cold | Moderate | 15–45 | Limited | Berries | — |
| *Elaeagnus multiflora* | Temperate | Moderate | 30–60 | Limited | Fruit | — |
| *Elaeagnus commutata* | Cold | Moderate | 20–40 | Limited | Fruit | — |
| *Shepherdia argentea* | Cold | Moderate | 15–35 | Limited | Berries | — |
| *Casuarina spp.* | Tropical/Sub | Fast | 40–100 | Yes | — | Timber, fuel |
| *Coriaria spp.* | Temp/Sub | Moderate | 20–40 | Yes | — | — |

> **Note**: N-fixation rates are highly variable and depend on soil conditions, plant age, moisture, and inoculant effectiveness. Values represent typical ranges from published research.
