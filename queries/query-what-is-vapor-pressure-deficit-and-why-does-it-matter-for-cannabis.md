...
Vapor pressure deficit (VPD) is a measurement expressing the difference between
...
rapidly, sometimes faster than they can replace lost water through root uptake.

The concept behind VPD is straightforward even if the underlying physics seem
complex at first. Warm air can hold significantly more water vapor than cold
air at the same relative humidity percentage. This means that the same 60
percent humidity reading at different temperatures represents vastly different
amounts of actual moisture and different levels of evaporative stress on the
plant. This is why relying on relative humidity alone is insufficient for
managing your grow environment effectively.

A humidity of 60 percent at 60 degrees Fahrenheit is comfortable for plants,
but that same 60 percent at 90 degrees Fahrenheit represents a very different
and potentially stressful environment. VPD accounts for both temperature and
