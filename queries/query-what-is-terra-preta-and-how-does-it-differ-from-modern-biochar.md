---
title: "What Is Terra Preta and How Does It Differ from Modern Biochar?"
...
Terra preta (Portuguese for "black soil") is a class of remarkably fertile anthropogenic soils found across the Amazon Basin.
...
One of the most important differences between ancient terra preta and fresh [[glomalin]], a sticky protein produced by [[soil-food-web]] within terra preta is far more complex than what develops in soil amended with fresh biochar.
...
## How Modern Biochar Compares

The following table summarizes the key differences between terra preta and modern biochar applications:

| Feature | Terra Preta | Modern Biochar |
|---------|-------------|----------------|
| Age | 500 to 7,000+ years | Fresh (days to months old) |
| Carbon stability | Highly stable, recalcitrant | Variable, depends on production |
| Microbial community | Mature, diverse, self-sustaining | Limited, requires inoculation |
| Nutrient content | Naturally enriched over time | Depends on feedstock and charging |
| Organic matter | Complex humus-like compounds | Primarily pyrogenic carbon |
...
Terra preta relies on stable charcoal to create a persistent carbon matrix that supports microbial life.

Both methods improve water retention and soil structure, but they operate through fundamentally different mechanisms.

In practice, the two approaches can be combined — burying wood beneath a biochar-amended layer creates a synergistic soil-building system.
...
- The microbial community within terra preta is far more mature and complex than what fresh [[glomalin]] from mycorrhizal fungi plays a critical role in binding charcoal into stable, nutrient-retaining aggregates.
