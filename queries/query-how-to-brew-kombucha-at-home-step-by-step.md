...
A healthy SCOBY should be creamy white to light tan, smooth on top, and have
a slightly vinegar-like aroma. Dark spots, fuzzy patches (especially green,
blue, or black), or moldy odors indicate contamination. The difference between
...
the acidic fermentation environment provides natural antimicrobial protection.

Common problems include slow or stalled fermentation (usually due to
insufficient starter liquid, low temperature, or chlorinated water), mold
contamination (discard the entire batch if you see fuzzy growth), and
