...
trying to rescue a failing seedling.
...
to correct the environment rather than add anything. If a seedling is wilting,
check soil moisture before watering. If leaves are yellowing, check for nutrient
burn before adding more food. If the stem is thin and stretched, increase light
intensity gradually rather than all at once. In most cases, a seedling that
receives prompt environmental correction will recover within a few days.
However, seedlings with severe damping-off, completely collapsed stems, or roots
that have turned brown and mushy are usually beyond saving, and it is more
efficient to start fresh with a new seed.

## Key Points
- Overwatering in oversized pots is the leading cause of seedling death: start
  small and water sparingly
- Damping-off fungus kills at the soil line: use sterile medium, warm
  temperatures, and good airflow
- Do not feed seedlings for the first two to three weeks: seeds contain enough
  stored nutrients
- Provide gentle light at 18 to 24 inches distance: too little causes
  stretching, too much causes burning
- Maintain temperatures between 70 and 80 degrees Fahrenheit and protect from
  strong wind
