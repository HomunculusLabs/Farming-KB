...
Cannabis concentrates are products made by extracting the most desirable compounds — primarily cannabinoids and terpenes — from the cannabis plant material.
These extracts can range from simple hand-rubbed hash to highly refined oils and waxes with potency exceeding 90% THC.
The production methods vary widely in complexity, safety, and end-product quality, from traditional mechanical separation to advanced solvent-based techniques.
...
Commercial operations typically use chemical solvents to strip cannabinoids and terpenes from plant material more efficiently.
Butane extraction (BHO) dissolves trichome resin in liquid butane, then purges the solvent to leave shatter, wax, crumble, or live resin.
CO2 extraction uses supercritical carbon dioxide under high pressure and temperature to selectively pull out desired compounds.
Ethanol extraction soaks plant material in food-grade alcohol, producing tinctures or further-refined oils.
Each solvent produces subtly different extract profiles because they pull different ratios of cannabinoids, terpenes, and plant waxes.
Proper solvent purging is critical — residual solvents in the final product pose serious health risks and are regulated in legal markets.
...
Home extraction with hydrocarbon solvents like butane carries serious fire and explosion risks if done improperly.
Professional labs use closed-loop systems in ventilated, explosion-proof environments to prevent solvent exposure.
Always purchase concentrates from licensed, tested sources in legal markets to ensure residual solvents and contaminants are within safe limits.
Solventless methods like ice water extraction and rosin pressing are much safer for home production and produce excellent results.
Proper storage in airtight, light-proof containers at cool temperatures preserves potency and prevents terpene degradation over time.

### What About Different Types of Hash?

Hashish is one of the oldest cannabis concentrates, with a history stretching back thousands of years across Central Asia and the Middle East.
Traditional methods involve hand-rubbing live plants to collect resin, which is then rolled into balls or pressed into slabs.
