...
tags: [chicory, coffee-substitute, greens, root-crops, foraging, homesteading, medicinal-plants, companion-planting]
date: 2026-04-28
updated: 2026-04-28
sources:
  - "Toensmeier, Eric. Perennial Vegetables: A Forgotten Garden of Eden. Chelsea Green, 2007."
  ...
  - "Foster, Steven and Duke, James A. A Field Guide to Medicinal Plants. Houghton Mifflin, 1990."
---
...
Chicory (*Cichorium intybus*) is a hardy perennial that serves triple duty in the homestead garden: its leaves supply nutritious bitter greens, its taproots can be dried and roasted into a caffeine-free [[gaias-garden-bees-and-pollinators]] and [[homesteading]] practitioners and [[lowenfels-soil-structure-aggregates]]. Every part of the plant is useful: young leaves in salads, mature leaves as cooked greens, roots for roasting, and flowers for both decoration and herbal preparations. As a [[permaculture-plants-insectary-bee-forage]] with a long bloom period
...
**When to plant:** Sow seeds outdoors in early spring (4–6 weeks before last frost) or mid-summer for fall greens. For root production, a spring sowing gives roots the full growing season to size up.
...
6. **Grind** to a coarse powder (finer than coffee grounds). Brew 1–2 tbsp per cup with boiling water; steep 10 minutes.
...
- **Pollinator support:** Deep blue flowers attract bees, butterflies, and hoverflies; plant near crops that need [[dynamic-accumulator-quick-reference]] in permaculture guilds
- **Living mulch:** Cut chicory foliage can be used as nutrient-rich [[hamilton-slug-and-snail-control]] methods; copper barriers |
| Bolting (premature flowering) | Heat stress; long days | Sow for fall harvest; provide afternoon shade |

---

## Quick-Reference Growing Summary

| Parameter | Leaf Chicory | Root Chicory (Coffee) | Forcing (Witloof) |
|-----------|-------------|----------------------|-------------------|
| **Days to harvest** | 45–60 (leaves) | 90–120 (roots) | 120 + 21 (forcing) |
| **Sun** | Full to partial | Full sun | Full sun (growing phase) |
| **Spacing** | 15–20 cm | 25–30 cm | 20–25 cm |
| **Water needs** | Moderate | Low–moderate | Moderate, then damp for forcing |
| **Soil pH** | 6.0–8.0 | 6.5–7.5 | 6.5–7.0 |
| **Hardiness** | Zone 3–9 | Zone 3–9 | Zone 4–9 |
| **Key nutrient** | Nitrogen (leaves) | Phosphorus (roots) | Balanced |
