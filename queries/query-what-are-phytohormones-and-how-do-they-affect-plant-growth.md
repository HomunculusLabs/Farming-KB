...
**Key fact:** Natural cytokinins are primarily produced in root tips and transported upward through the xylem. Roots essentially "tell" the shoots how much to grow based on nutrient and water availability.
...
- **Managing stress:** Reducing ethylene production (using AVG inhibitors or ethylene scrubbers) extends shelf life of cut flowers and stored produce

**Key fact:** Ethylene is a gas at room temperature — the only gaseous phytohormone. This means one ripening banana in a paper bag will accelerate ripening of all fruit nearby. Conversely, storing fruit with ethylene absorbers (potassium permanganate packets) extends shelf life.
...
### Salicylic Acid
- Primary mediator of defense against biotrophic pathogens and systemic acquired resistance (SAR)
- Triggers a whole-plant immune response after localized infection
- Aspirin (acetylsalicylic acid) is derived from salicylic acid — plants and humans share this defense pathway
- Foliar salicylic acid sprays can prime plant immune responses

### Strigolactones
- Released by roots into the soil to signal mycorrhizal fungi
- Also suppress lateral branching (a third branching hormone alongside auxin and cytokinin)
- Parasitic plants (Striga, Orobanche) detect strigolactones to locate host roots

---

## Practical Applications for Growers

| Application | Hormone(s) Involved | Practical Use |
|-------------|--------------------|---------------| 
| Rooting cuttings | Auxin (IBA, NAA) | Dip cuttings in rooting hormone powder/gel |
| Bushier plants | Auxin manipulation | Top the plant to remove apical dominance |
| Taller plants | Gibberellin | GA₃ spray to increase internode length |
| Compact plants | Anti-gibberellins | Paclobutrazol or chlormequat to reduce height |
| Breaking seed dormancy | Gibberellin, Ethylene | GA₃ soak or ethylene exposure |
| Ripening fruit | Ethylene | Ethylene gas or ripe banana in paper bag |
| Delaying senescence | Cytokinin | Foliar cytokinin sprays |
...
**"More hormone = more growth"**
False. Phytohormones work in delicate balance and concentration ranges. Excess auxin inhibits growth; excess ethylene causes premature senescence; excess gibberellin causes weak, leggy growth. The interactions between hormones (synergism and antagonism) matter more than absolute levels.

**"Synthetic hormones are harmful"**
Synthetic auxins and gibberellins used at labeled rates are safe for plants, humans, and the environment. However, synthetic auxin herbicides (2,4-D, dicamba) are a different matter — they are applied at much higher doses and are designed to be toxic to broadleaf plants.

**"Phytohormones are only in commercial products"**
Every plant constantly produces and responds to phytohormones. Many organic practices (compost tea, aloe vera gel as a foliar spray, willow water for rooting) work at least partially because they contain natural phytohormones or compounds that modulate hormone signaling.
