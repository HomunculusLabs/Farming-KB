...
Osteoclasts are responsible for bone resorption — the continuous breakdown of old bone tissue that is normally balanced by osteoblast-mediated bone formation. Dysregulated osteoclast activity leads to:

- **Osteoporosis** — excessive resorption exceeds formation, weakening bones.
- **Increased fracture vulnerability** — thin, brittle bones break more easily.

The endocannabinoid system regulates osteoclast activity through CB2 receptor signaling, making it a potential therapeutic target for bone diseases.
...
**Finding:** Mice with diminished endocannabinoid receptor signaling showed **increased bone loss** compared to wild-type controls.

**Significance:** Demonstrated that endogenous cannabinoid signaling is **necessary for normal bone maintenance** — not just that exogenous cannabinoids can supplement it.

### Study 3: Tam et al. (2008) — Hebrew University, Jerusalem
