...
Spawn is mushroom mycelium that has been grown on a carrier material,
serving as the inoculum for larger substrate masses. Common spawn carriers
include:
...
Mycelium does not require light during colonization and grows equally
well in complete darkness. In fact, exposure to light during the spawn
run can trigger premature pinning in some species. Incubation areas
should be kept dark or in very dim indirect light.
