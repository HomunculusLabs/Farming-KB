...
"If whole mushrooms or extracts of mushrooms are the products they cannot be patented there can be little financial attraction for manufacturers to run their products through the medicine registration process."

This is the central regulatory challenge: natural products cannot be easily patented, reducing the commercial incentive for the expensive clinical trials required for drug approval.

## WHO Guidelines

### Seminal Report (1991)
WHO published "Guidelines for the Assessment of Herbal Medicines" establishing basic criteria for evaluation of quality, safety, and efficacy of all herbal medicines (including mushrooms).

### Key Principles
- **Traditional experience matters**: "Long-term use as well as the medical, historical and ethnological background of those products shall be taken into account"
- **Long-term use definition**: "At least several decades"
- **Safety presumption**: "Prolonged and apparently uneventful use of a substance usually offers testimony of its safety"
- **Restrained regulation**: "If the product has been traditionally used without demonstrated harm, no specific restrictive regulatory action should be undertaken unless new evidence demands a revised risk-benefit assessment"
...
Procedures should correspond to **Good Manufacturing Practices (GMP)** and include stability testing of the final product.

## The European Situation

### EC Directive 65/65/EEC
Defines "any substance or combination of substances presented for treating or preventing disease" as a medical product requiring a license or marketing authorisation. However, herbal products have been granted special transitional provisions.

## The German Model: Commission E

### Overview
"Germany is by far the leading country in Europe for the consumption of herbal products."

The German Commission E is "an independent division of the German Federal Health Agency which collects information on herbal medicines and evaluates them in relation to safety and efficacy."

### Monograph System
- Published as brief monographs approving or disapproving over-the-counter sale
- "Believed to represent the most accurate information available worldwide on the safety and efficacy of herbs and phytomedicines"
...
- Help promote and maintain health by regulating bodily functions
- Protect against cancer, heart disease, diabetes, osteoporosis, and hypertension
...
| Country | Status of PSK | Status of [[lentinan]] | Status of PSP | Status of [[ahcc]] |
|---------|--------------|-------------------|--------------|----------------|
| **Japan** | Approved drug (NH) | Approved drug (NH) | Dietary supplement | Dietary supplement |
| **China** | Not registered | Not registered | Approved medicine | Not registered |
| **Korea** | Not registered | Not registered | Not registered | Not registered |
| **Germany** | Dietary supplement | Dietary supplement | Not available | Not available |
| **USA** | Dietary supplement | Dietary supplement | Dietary supplement | Dietary supplement |

*NH = National Health Insurance coverage*

## Regulatory Pathways

### Full Drug Approval (Japan model)
- Required Phase I, II, III clinical trials
- Manufacturing under pharmaceutical GMP
- Covered by national health insurance
- High cost; only viable for patentable derivatives
- Examples: PSK (Krestin), Lentinan

### FOSHU / Functional Food (Japan model)
...
- Low cost; accessible to consumers
