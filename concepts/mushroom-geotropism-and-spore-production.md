...
Several lines of evidence from Badham's experiments establish the connection between negative geotropism and spore formation:
...
4. **Rotation experiments**: When basidiocarps were rotated horizontally to equalize the effect of gravity under constant illumination, growth and pileus expansion were both horizontal. This confirms that gravity is the primary directional stimulus at this developmental stage.

## The Role of Gill-Produced Substances

The connection between sporulation and geotropism suggests that a substance produced in the gills (lamellae) may mediate the tropic shift. This hypothesis is supported by several earlier findings in the mycological literature:

- **Decapitation experiments** (Gruen, 1963; Hagimoto, 1963): Removal of the pileus (which contains the gills) affects the geotropic response of the stipe, suggesting that the pileus produces a factor involved in gravitropic sensing or response.

- **Agar diffusates** (Hagimoto and Konishi, 1960): Diffusates collected from agar placed beneath the gills can partially replace the influence of the pileus on stipe growth, indicating a diffusible substance is involved.

- **Mushroom hormones**: Several workers have postulated the existence of mushroom hormones involved in tropisms. These hormones appear to be produced in or associated with the lamellae, though their chemical identity has never been conclusively determined.

In *P. cubensis*, Badham proposed that a substance produced in the gills at the onset of sporulation modifies the first tropism (anemotropism), causing the mushroom to respond primarily to gravity instead. This gill-derived signal may override the evaporative-demand-based mechanism that drives anemotropic curvature during early development.

## Proposed Mechanism

The proposed two-phase mechanism for directed growth in *P. cubensis* can be summarized as follows:

**Phase 1 — Anemotropic elongation (Stage 1 to early Stage 2)**:
- Individual cells of the stipe respond to a gradient of evaporative demand created by wind
- The windward side experiences greater drying, leading to differential cell elongation
- The stipe bends toward the wind
- This phase is independent of spore production and occurs in both fertile and sterile basidiocarps

**Phase 2 — Negative geotropism (Stage 2 onward, fertile only)**:
- Spore production begins in the gills
- A substance produced in the gills (possibly a hormone) is released
- This substance modifies the stipe's tropic sensitivity, shifting dominance from evaporative demand to gravity sensing
- The stipe recurves upward; the pileus opens with lamellae facing downward for spore release
- This phase requires both spore production (fertile basidiocarps only) and light (needed for sporulation)

## Functional Significance for Spore Dispersal

The negative geotropic response at maturity has clear functional advantages for spore dispersal. Understanding these advantages requires considering the physics of spore release and transport in the context of the mushroom's natural habitat:
...
The tropic behavior of *P. cubensis* can be compared with observations in other basidiomycete species:
...
- Hagimoto, H. (1963). The mushroom growth hormone and geotropic response. *Bot. Mag.* (Tokyo), 76, 363-365.
