...
- Ice pick or sharpened 3-penny nail (for punching needle holes)
- Vise grip pliers (for holding the nail)
...
water can be used when experimenting to improve fruiting results.

An important detail: mix each jar's substrate individually for loading. This
ensures accurate formula rendering for every jar. Bulk mixing can lead to
inconsistent water distribution across jars.

### Step 2: Loading the Jar

Fill the jar very loosely with the substrate mixture. Leave a 1/2 to 3/4 inch
space at the top of the jar. Level the substrate surface. With a tissue or
