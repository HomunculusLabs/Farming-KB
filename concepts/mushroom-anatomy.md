...
air currents for dispersal.

## Cap (Pileus)

The cap is the most conspicuous part of the mushroom. Its surface can be
smooth, scaly, hairy, or slimy (viscid). Cap color varies widely and can
change with age, hydration, or bruising -- a critical identification feature.
The margin (edge) of the cap may be incurved (curving inward) when young,
flattening with maturity, and sometimes becoming uplifted or wavy.

Beneath the cap surface lies the context, or flesh (trama), which is the
sterile tissue between the outer skin (pileipellis) and the spore-producing
hymenium. Flesh texture, color changes when cut (bruising), and latex
production are all diagnostic characters.

## Gills, Pores, and Teeth (Hymenophore)

The hymenophore is the spore-bearing surface on the underside of the cap.
...
- **Teeth** -- Found in hedgehog mushrooms (Hydnum) and similar genera.
  The spore surface consists of downward-pointing spines.
- **Smooth** -- Some mushrooms (like chanterelles) have wrinkled or
  vein-like ridges rather than distinct gills or pores.
...
- **Annulus** -- A ring of tissue around the stalk, remnants of the partial
  veil that once connected the cap margin to the stalk, protecting the
  developing gills. Presence, position, and mobility of the annulus are
  important identification characters.
- **Volva** -- A cup-like structure at the base of the stalk, remnants of
  the universal veil that enclosed the entire young mushroom. Volvas are
...
Spores are microscopic reproductive units produced by the hymenium on
basidia (club-shaped cells). Each basidium typically produces four spores on
tiny stalks called sterigmata. Spore characteristics include shape (round,
elliptical, angular), size, color, and surface ornamentation (smooth, warty,
ridged).
