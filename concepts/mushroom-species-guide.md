...
## [[oyster-mushroom-pleurotus-ostreatus|Oyster Mushroom]] — Pleurotus ostreatus
| Parameter | Value |
|-----------|-------|
...
**Medicinal**: Contains beta-glucans, lovastatin (cholesterol-lowering), and ergothioneine. Anti-tumor and immunomodulatory activity documented. Effective mycoremediation species for petroleum and PAH degradation. See [[medicinal-mushroom-guide]] for details.
...
| **CO2** | < 1000 ppm |
| **Time to fruit** | 6-12 months on logs; 30-60 days on sawdust blocks |
| **Yield** | 2-3 lbs fresh per log; 3-5 years production |
| **Flushes** | 2/year on logs (spring + fall); up to 4 indoors |
Shiitake is the second most cultivated mushroom worldwide. Traditional log method uses 4-6 inch diameter oak or alder logs cut 3 feet long. Shock logs by submerging in cold water for 24-72 hours to initiate fruiting. Logs produce for 3-5 years on oak, 2-3 on alder. Supplements that increased growth over rice bran: yeast powder 2%, soybean meal 5%, milk powder 2%, molasses 1.5% (Han et al. 1981).
...
|-----------|-------|
| **Difficulty** | Intermediate |
| **Substrate** | Supplemented hardwood sawdust (oak, maple, beech). Bran at 15-20%. Also fruits on logs. |
| **Fruiting temp** | 60-75F (15-24C); optimum 65-70F |
| **Humidity** | 85-95% RH |
| **Light** | Indirect, 12h/day |
| **CO2** | < 800 ppm (sensitive; high CO2 causes elongated, poor-form fruiting bodies) |
| **Time to fruit** | 4-6 weeks from inoculation on supplemented sawdust |
| **Yield** | 0.5-1 lb per 5 lb block |
| **Flushes** | 2-3 flushes |
Lion's mane produces cascading white spines rather than gills. Prized for culinary use (tastes like lobster/crab) and medicinal properties (nerve growth factor stimulation). Requires higher air exchange than most species — poor formation under high CO2. Sterilize sawdust blocks at 15 psi for 90 minutes.
**Medicinal**: Contains hericenones (fruiting body) and erinacines (mycelium) that stimulate NGF and BDNF synthesis. Improves cognitive function in mild cognitive impairment (human RCTs). Reduces anxiety and depression. Promotes peripheral nerve regeneration. See [[medicinal-mushroom-guide]].
## Reishi — Ganoderma lucidum
| Parameter | Value |
|-----------|-------|
| **Difficulty** | Intermediate-Advanced |
| **Substrate** | Supplemented hardwood sawdust (oak preferred). 4:1 sawdust:bran. Also logs and stumps outdoors. |
| **Fruiting temp** | 72-85F (22-29C); optimum 75-80F |
| **Humidity** | 85-95% RH |
| **Light** | Indirect ambient; light influences antler vs. conk formation |
| **CO2** | Tolerates higher CO2 (600-1000 ppm); very high CO2 produces antler form |
| **Time to fruit** | 8-12 weeks from inoculation |
| **Yield** | 0.25-0.5 lb per 5 lb block (slow grower) |
| **Flushes** | Typically 1 large flush; blocks can be rehydrated |
Reishi is one of the most studied medicinal mushrooms. Forms distinctive lacquered, kidney-shaped conks. In high CO2 environments, produces antler-like growth. Prefers warmer temperatures than most cultivated species. Harvest when the white growing margin disappears and spores are being released. Can be dried and extracted for tea or tincture.
**Medicinal**: Contains ganoderic acids (triterpenoids: anti-inflammatory, hepatoprotective, apoptosis-inducing) and beta-glucans. Potent immunomodulator and adaptogen. Dual extraction essential (hot water for beta-glucans, ethanol for triterpenes). May have anticoagulant effects. See [[medicinal-mushroom-guide]].
## Wine Cap / King Stropharia — Stropharia rugoso-annulata
| Parameter | Value |
|-----------|-------|
| **Difficulty** | Beginner (outdoor) |
| **Substrate** | Wheat straw, wood chips (alder/maple), straw + sawdust mix. No sterilization required for outdoor beds. |
| **Fruiting temp** | 55-68F (13-20C); remarkably wide range (50-68F noted) |
| **Humidity** | 85-92% RH |
| **Light** | Indirect natural or fluorescent 12h/day |
| **CO2** | < 1000 ppm |
| **Time to fruit** | 2-4 weeks spawn run; primordia after 10-12 days post-casing |
| **Yield** | 2-3 lbs/sq ft average; up to 6 lbs/sq ft maximum |
| **Flushes** | Every 10-15 days over 8 week period |
Large, thick-fleshed mushroom with dark reddish-brown cap (50-400mm diameter). Spawn run at 76-82F. Pasteurize straw by submersion in 160F water for 20-30 minutes. Casing with peat/humus (1:1) at pH 5.7-6.0, depth 1-2 inches. Does NOT fruit on sterilized casing — steam pasteurization required. Grows well in outdoor beds, wood chip pathways, and garden borders. Thermal death limits reported as low as 90F and -5F. 22% protein (dry weight).
**Uses**: Excellent edible mushroom. Primary mycofiltration species for farm runoff and pathogen filtering — thrives in contact with bacteria. Used in [[mycoremediation-techniques]] for water treatment. See also [[mycoremediation-basics]].
## Ecological Roles (Stamets)
