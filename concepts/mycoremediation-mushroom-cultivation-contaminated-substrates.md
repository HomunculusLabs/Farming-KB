...
updated: 2026-04-24
type: concept
tags: [bulk-substrate, contamination, cultivation, mushroom-cultivation, mycology]
...
Multiple species demonstrate significant PAH degradation during cultivation on natural substrates:

- **Trametes versicolor**: Mineralized 34.1% of [14C]pyrene, the highest rate among tested species on wheat straw. Also mineralized 15.5% phenanthrene.
- **Kuehneromyces mutabilis**: Mineralized 6.7% [14C]pyrene and 4.7% CO2 from anthracene. Showed 47.7% pyrene mineralization in soil inoculation, removing about 75% of pyrene in nonsterilized soils.
- **Agrocybe aegerita**: Mineralized 3.3% [14C]pyrene and 3.7% phenanthrene on wheat straw.
- **Laetiporus sulphureus**: Mineralized 4.3% [14C]pyrene and 10.7% phenanthrene.

Bench-scale polyethylene columns using P. ostreatus showed variable laccase activity in soil without positive correlation to degradation rates. Pretreatment with bark and incubation at 22 degrees C before inoculation produced better four-ring PAH degradation (59%) than no pretreatment.

## Spent Mushroom Substrate as Enzyme Source

The aqueous compost extract of Agaricus bisporus serves as a source of crude laccase for enzymic oxidation of phenols. The specific activity of the compost extract is comparable to commercial enzymes, with removal rates of 100% for phenol at 1 mg/ml concentration within 48 hours at pH 5.0 using sodium-acetate buffer. This represents a low-cost enzyme source for bioremediation applications, as SMS is an abundant byproduct of the mushroom industry.

## Wastewater Treatment Applications

Mushroom cultivation fungi also treat various wastewater streams during growth:

- **Distillery waste**: Coriolus versicolor achieved 53% color reduction from molasses spent wash. Phanerochaete chrysosporium showed decolorization even in the absence of additional carbon source. Trametes sp. I-62 removed 73% color and 62% COD from distillery vinasses, with a 35-fold increase in laccase production.
- **Textile wastewater**: Pleurotus ostreatus, Coriolus versicolor, and Phanerochaete chrysosporium effectively decolorize [[mycoremediation-textile-dye-degradation]].
- **Olive mill wastewater**: OMW has been used as a growth medium for laccase and MnP production from Panus tigrinus, with solid-state fermentation proving more suitable than submerged fermentation.

## Economic Considerations

The dual-output nature of mushroom cultivation on contaminated substrates — both remediation and mushroom production — can offset treatment costs. Spent mushroom substrate is available in large quantities from commercial operations and can serve as a low-cost inoculum carrier or compost amendment. However, careful quality control is needed when mushrooms are cultivated on heavily contaminated substrates to ensure food safety. The use of non-edible species or focusing on SMS utilization rather than fruiting body harvest may be preferable for highly contaminated substrates.

## Mixed Cultures and Consortia

Mixed fungal cultures often outperform pure cultures in bioremediation applications. For wastewater treatment, combinations of yeasts, molds, and filamentous fungi improve nutrient assimilation and biomass yield. Two-step continuous fermentation using Candida utilis followed by Aspergillus niger achieved 87% total COD reduction from cane stillage. Mixed cultures of Geotrichum candidum, Candida krusei, and Hansenula anomala reduced whiskey stillage COD by 54.9%. For PAH degradation, certain indigenous bacteria were killed by Pleurotus mycelia, while Hypholoma and Stropharia supported bacterial development. Phanerochaete chrysosporium showed synergistic behavior with indigenous soil microorganisms in oxidizing low-molecular-weight PAHs in soil slurry, enhancing oxidation up to 43%.

## Bioaugmentation Strategies

Successful bioaugmentation requires fungal inoculum that can withstand competition from native microflora and penetrate surrounding soil. Spent mushroom culture provides advantageous inoculum. The influence of organizing soil and substrate in layers versus homogenized mix affects outcomes. FDA hydrolyzing and laccase activities in soil correlate with degradation rates. Absidia cylindrospora degraded 98% of fluorene within 288 hours during bioaugmentation of artificially contaminated soil in slurry applications, compared to 54% by native microflora alone. Maltosyl cyclodextrin (MCL) improved fluorene biodegradation enhancement during the first 144 hours.
