...
## The Spore Dispersal Mechanism

McKenna outlined a biological mechanism for interstellar colonization that does
...
1. **Atmospheric Percolation**: Spores, being extremely light, can reach the
   upper atmosphere of a planet through Brownian motion and thermal convection.
...
including benthic marine invertebrates — have been recovered from South African
...
## Symbiosis and Cultural Engineering

The hypothesis extends beyond mere biological presence to propose active
symbiosis with human civilization. According to McKenna's account, the mushroom
consciousness described itself as desiring ever-deeper symbiosis with the human
species. It achieved initial symbiosis by associating itself with domesticated
cattle and, through them, human nomadic populations. Like cultivated plants and
husbanded animals, the mushroom was able to embed itself into the human family,
ensuring that wherever human genes traveled, mushroom genes would be carried as
well.
...
McKenna maintained a deliberate ambiguity about the hypothesis, framing it as
a dialogue rather than a belief. He stated: "I don't necessarily believe what
the mushroom tells me; rather we have a dialogue. It is a very strange person
and has many bizarre opinions." He described being placed in a dilemma akin to
a child wishing to destroy a radio to see if there are little people inside —
unable to determine whether the mushroom itself is the alien intelligence, or
whether it serves as a technological artifact allowing communication with an
intelligence located light-years away through some form of Bell non-locality
principle.
...
- **Astrobiology**: Panspermia hypotheses have been debated since the work of
  ...
  extremophiles.
- **Speculative Philosophy**: The idea of biology as information technology
  capable of self-replication across cosmic distances reflects broader themes
  in McKenna's thought about consciousness as a fundamental property of matter.

The hypothesis remains untestable with current technology but serves as a
productive thought experiment about the possible mechanisms and time scales of
biological dispersal in the cosmos.

## Related Concepts

- [[mckenna-tryptamine-consciousness-dmt-spirit-molecule]] — the consciousness
  dimension of tryptamine experience
- [[entheogenic-fungi-history]] — historical record of psychoactive mushroom use
