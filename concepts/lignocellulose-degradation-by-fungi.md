...
- **[[fungal-manganese-peroxidase-remediation]] (MnP):** The most commonly produced ligninolytic
  ...
  *P. ostreatus* and is often the dominant peroxidase in oyster mushroom
  cultures.
- **Laccase:** A multicopper oxidase that oxidizes phenolic lignin subunits
  using molecular oxygen as the electron acceptor (producing water as a
  byproduct). Laccases have lower redox potential than peroxidases but are
...
- **Endoglucanases (EG):** Cleave internal beta-1,4 bonds in cellulose chains,
  creating new chain ends for exoglucanases to act on.
- **Exoglucanases / cellobiohydrolases (CBH):** Processively remove cellobiose
  units (glucose dimers) from the reducing and non-reducing ends of cellulose
  chains.
- **Beta-glucosidase:** Hydrolyzes cellobiose and short oligosaccharides into
  individual glucose molecules, relieving end-product inhibition of the other
  cellulase components.

### Hemicellulose-Degrading Enzymes

Hemicellulose is a complex, branched polymer requiring multiple enzymes:
- Xylanases break down xylan (the main hemicellulose in hardwoods)
- Mannanases degrade mannan-based hemicellulose (common in softwoods)
- Acetyl xylan esterases remove acetyl groups
- Alpha-glucuronidases remove glucuronic acid side chains

## Cultivation Implications

The enzymatic machinery of *Pleurotus* species has direct implications for
substrate selection and preparation in cultivation:

- **Substrate digestibility** correlates with lignin content and structure.
...
Lignocellulose-degrading enzymes from *Pleurotus* and related fungi have
applications beyond mushroom cultivation, including:

- **Bioremediation:** Degrading xenobiotic compounds, dyes, and pollutants
  using laccases and peroxidases
- **Biomass pretreatment:** Enzymatic hydrolysis of agricultural residues for
  biofuel production
- **Biopulping:** Fungal pretreatment of wood chips reduces chemical and energy
  requirements in paper production
- **Animal feed:** Solid-state fermentation of agricultural waste improves
