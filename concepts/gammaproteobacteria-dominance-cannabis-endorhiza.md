---
title: Gammaproteobacteria Dominance in Cannabis Endorhiza
created: 2026-05-09
tags: [microbiome, cannabis, gammaproteobacteria, alphaproteobacteria,
  endorhiza, endophyte, root-bacteria, cultivar-specificity]
source: understanding-cultivar-specificity-cannabis-microbiome.md
aliases: [Proteobacteria Cannabis Endorhiza, Endophytic Gammaproteobacteria,
...
environment and has implications for plant health and secondary metabolism.
...
- **Pseudomonas** (Gammaproteobacteria) — ubiquitous root endophyte
- **Oxalobacteraceae** (Betaproteobacteria) — root-associated family
- **Xanthomonadaceae** (Gammaproteobacteria) — plant-associated bacteria
- **Actinomycetales** (Actinobacteria) — common soil and root inhabitants
...
The preponderance of Proteobacteria in the endorhiza reflects several
selective advantages these organisms possess for life inside plant tissue:

**Oxygen tolerance.** Root interiors, while more hypoxic than rhizosphere
soil, still maintain microaerophilic pockets. Proteobacteria are broadly
facultative anaerobes, giving them metabolic flexibility that strict aerobes
or obligate anaerobes lack.
...
This cultivar-specific variation suggests that different Cannabis strains
