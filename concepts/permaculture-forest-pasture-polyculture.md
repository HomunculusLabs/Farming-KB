...
The age-old problem of seasonal fodder shortage is a central challenge in livestock management. Both annuals and perennials in pasture reach peak productivity in spring, with a lesser autumn flush of growth if early rains arrive. In temperate lands with winter-rainfall dominance, there is a predictable shortfall in midsummer and midwinter feed.

Midsummer shortage occurs because of summer drought, while midwinter shortage results from cold and slow growth of plants. Flock management through sale of young stock or culling after breeding can reduce summer feed requirements, but cannot address the fundamental gap that pasture alone leaves.

## Tree-Crop Infills for Feed Gaps

It is from data on seasonal feed shortfalls that the intelligent agriculturist can plan tree-crop infills to take up the gaps that pasture alone leaves. Mollison identifies specific tree crops that fill critical periods:
...
**Autumn and winter feed** is provided by:

- The same foliage plants as above

- Oaks, chestnut, and black walnut
...
The changeover also suits the comfort and well-being of animals, who can range into forest when extremes of heat and cold affect them, and occupy pastures during the tolerable periods of spring and autumn.

Mollison observes that this was likely the normal habit of cattle and other large herbivores before clear-felling for pasture, and that the non-functional hedgerows of today are the remains of older forests.
...
## Multi-Product Yields from Forest Farming

What few farmers plan is a long-range policy of diversification, and this is exactly what forest-pasture planning achieves. Tree products such as carob and chestnut can be directly converted to:
...
## Rolling Permaculture Development on Marginal Land

All large properties of about 20 hectares or more have areas that can be fenced out with minimal productivity loss. This is particularly true of:

- Steep terrain

- Stony ground

- Eroded or problem soils

- Awkward corners

- Cold or windswept valleys and rises

Such areas permit the development of a rolling permaculture that initially provides shelter as hedgerow, and later becomes a diverse forage and tree crop resource.
...
3. **Accumulate seed supplies** and plant many species for later assessment, selecting good seed and giving necessary pre-treatment (soaking, boiling, etc.)

4. **Mark selected strong seedlings** with pegs for later mulching and experimental treatment with fertilisers (seaweed solution, blood and bone, stable or poultry manure). An excellent strategy is to mulch within empty tyres around trees — this protects from wind, rabbits, and drought. Thorn or thistle mulch in tyres discourages small browsers
...
7. **Cull poorer specimens** for pole timber, leaving selected high-yielding or strong trees and shrubs to continue growth

## Benefits of Rolling Permaculture

A rolling permaculture development delivers multiple beneficial effects:
...
- Enables later diversification into a wide range of animal and plant products, nut crops, and timber

- Converts marginal land from a liability into a productive asset
