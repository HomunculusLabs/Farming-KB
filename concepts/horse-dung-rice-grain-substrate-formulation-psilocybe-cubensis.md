---
title: "Horse Dung Rice Grain Substrate Formulation Psilocybe Cubensis"
category: mycology
tags: [substrate, dung, rice-grain, psilocybe-cubensis, cultivation, bulk-substrate, gartz]
...
1. Gartz, J. "Growth-Promoting Effect of a Brassinosteroid in Mycelial Cultures of the Fungus *Psilocybe cubensis*." *Naturwissenschaften* 77, 388-389 (1990).
2. Gartz, J. "Biochem. Physiol. Pfl. 184, 337 (1989)."
3. Gartz, J. "J. Basic Microbiol. 29, 347 (1989)."

## Key Quantitative Data

- Brassinosteroid concentration tested: 10⁻² ppm (0.01 ppm) 22S,23S-homobrassinolide
- KH₂PO₄ supplementation: 5 g/L substrate
- Control fruiting time: 4-5 weeks post-inoculation
- Treated fruiting time: 3-3.5 weeks post-inoculation (15-30% acceleration)
- Control first flush yield: 1-3 fruit bodies
- Treated first flush yield: 4-7 fruit bodies (130-233% increase)
- Control dry mass: 2.3-2.9 g per 10 g substrate
- Treated dry mass: 3.4-3.9 g per 10 g substrate (17-48% increase)
- Total experimental runs per condition: 10 (statistically powered)

## Ecological Context

*Psilocybe cubensis* is fundamentally a coprophilous (dung-inhabiting) fungus. In nature, it colonizes the dung of grazing herbivores in subtropical and tropical grassland ecosystems. The horse dung/rice grain substrate is significant because it approximates the nutritional and structural conditions of the species' natural substrate:

- Herbivore dung provides partially digested plant cellulose and hemicellulose, along with nitrogen from urea and microbial biomass.
- The dung matrix has high water-holding capacity and a porous structure that facilitates gas exchange.
- Natural dung substrates are already colonized by bacteria that modify pH and release nutrients, conditions that properly prepared cultivated dung substrates attempt to replicate.

Understanding this ecological context is essential for optimizing substrate formulations. The dung/grain approach works well precisely because it engages the species' evolved metabolic pathways for digesting complex organic matter from herbivore digestive systems.

## Limitations and Considerations

The dung/grain formulation described by Gartz has several practical limitations for modern cultivators:

- **Sourcing**: Quality horse dung may be difficult to obtain in urban environments, and bagged commercial products may contain undesirable additives or preservatives.
