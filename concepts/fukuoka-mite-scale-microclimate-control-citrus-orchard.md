...
imbalance created by human intervention, primarily through improper [[fruit-tree-pruning-and-training-systems]]
pesticide use.
...
1. **Chemical repellency:** The black wattle, which produces tannin, excretes a
substance that repels insects.
2. **Microclimate modification:** The most direct cause of rapid population changes
is the alteration of temperature, humidity, and airflow around the fruit trees.

The interplanting of evergreen trees with deciduous trees is also an effective
preventive measure against these pests, as it creates a more varied and stable
microenvironment.

## The Ignorance of Chemical Control

Fukuoka condemned the recklessness of trying to control mites with pesticides when "not
