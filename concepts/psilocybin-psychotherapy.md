...
The "psycholytic" (mind-loosening) approach was developed primarily in Europe:
...
## Gartz's Documentation of European Research

[[jochen-gartz]] compiled particularly detailed accounts of German-language psycholytic therapy research that is less known in the English-language literature:

### Hanscarl Leuner's Work (Gottingen, Germany)

Leuner developed standardized psycholytic protocols and conducted extensive clinical [[dpt-compound-profile]] work from the 1950s through the early 1970s. His approach involved:
- Careful patient screening and preparation
- Series of 10-20 sessions with gradually increasing doses
- Use of music (classical, especially Requiem masses and modern compositions) to structure the experience
- Integration sessions focusing on dream analysis, emotional processing, and behavioral change
- Reported success with neurotic disorders, psychosomatic conditions, and character disorders

### Sandoz Indocybin Documentation

Gartz preserved documentation of Sandoz's psilocybin preparation:
- Packaged as 5mg tablets of synthetic psilocybin
...
Key findings from modern trials:

| Condition | Result | Evidence Level |
|---|---|---|
...
fMRI studies (primarily from Carhart-Harris at Imperial) reveal:
- **Default Mode Network (DMN):** Psilocybin reduces activity and connectivity in the DMN, associated with self-referential thinking and the ego. This correlates with subjective reports of ego dissolution.
- **Increased global connectivity:** Psilocybin increases communication between brain regions that normally don't interact, potentially explaining novel associations and creative thinking.
- **Entropy increase:** Brain activity becomes more "entropic" or disorganized, similar to the pattern seen in early childhood.
- **Lasting changes:** Some connectivity changes persist for weeks after a single dose.
...
- Discuss intentions, fears, and expectations
- Practice relaxation techniques
- Choose music playlist
- Identify potential challenging material

### Dosing Session

- Setting: Comfortable room, eye shades available, carefully selected music
- Monitors present throughout (usually two facilitators/guides)
- Dose: 20-30mg synthetic psilocybin (moderate to high)
- Duration: 6-8 hours in the clinic
- Approach: Non-directive support; "trust, let go, be open"
- "Talk-down" protocols available if needed for anxiety

### Integration Phase (3-5 sessions)

- Process the experience through discussion, art, journaling
