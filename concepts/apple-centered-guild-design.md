...
All that remains to create the apple guild is to fit the plants together. To decide how many plants to use, let the mature size of the central tree be the guide. A dwarf or semi-dwarf apple tree will support fewer guild members than a large standard tree, and will require smaller plant varieties.

With dwarf trees, avoid climbers such as vetch, which might trellis up the apple and shroud it with vines. Artichokes are also probably too large to fit under a dwarf tree. As a rule of thumb, the larger the plant, the fewer of its kind in the guild: one apple, one or two artichokes, several comfreys, a dozen insectary plants, dozens of bulbs, hundreds of clovers.

One potential drawback: come harvest time, the apple tree may be surrounded by a thicket of vegetation that will ensnare the legs of an orchard ladder. Fortunately, by the time mid- to late-fruiting apple varieties are ripe, much of the undergrowth will have died down and harvest will be easy.

## Multifunctional Guild Members

Many of the apple-guild members have more than one function. Clover and alfalfa are nitrogen fixers but also attract bees. Plantain and yarrow sequester nutrients and are medicinal as well. Artichokes produce both mulch and food. Mineral-collecting dandelions and chicory are also edible.
