...
It is important to note that room temperature is generally acceptable for germination.
Any room temperature will work, and in the overall view, cool temperatures are never
a problem for this stage. The cardinal rule is to not overheat.
Indirect light is all that is required during incubation, and if temperatures drop,
overhead light shining down on the tops of the jars can serve as a gentle heating
technique using a clamping-type light with a reflector.
