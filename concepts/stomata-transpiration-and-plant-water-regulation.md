---
title: Stomata Transpiration and Plant Water Regulation
created: 2026-04-21
updated: 2026-04-21
type: concept
...
Stomatal opening and closing is regulated by potassium (K+) ion concentrations:

### Opening
1. Proton pumps actively export H+ ions from guard cells
2. This creates an electrochemical gradient
3. Potassium ions (K+) are imported through channels to balance the charge
4. The increased K+ concentration lowers the water potential inside guard cells
5. Water enters by osmosis
6. Guard cells swell, opening the stoma

### Closing
1. Potassium ions are pumped out of guard cells
2. Water potential increases inside the cell
3. Water leaves by osmosis
4. Guard cells deflate, closing the stoma

Chlorine (Cl-) serves as the counterbalance to potassium -- potassium and chlorine work together in stomatal operation.

## Transpiration

### The Numbers

About 90% of a plant's water loss occurs through stomatal transpiration. This means approximately 90% of the water entering the roots arrives as a result of transpiration pulling it upward, molecule by hydrogen-bonded molecule.
