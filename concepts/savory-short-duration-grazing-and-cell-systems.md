...
- **Reduced overgrazing**: With very short grazing periods, even the most
  severely bitten plant is unlikely to be rebitten before it recovers.
- **Better nutrition**: Animals move frequently onto fresh, unfouled ground,
  receiving a better plane of nutrition with reduced parasite exposure.
- **Higher stock density**: Stock density rises dramatically as paddock size
  decreases, improving the distribution of animal impact across the land.
- **Lower risk**: Damage from drought, flood, insect outbreaks, disease, and
  parasitism has an inverse relationship to the number of paddocks.

Savory cites the Barlite Ranch in Texas, which with one hundred and one
paddocks carried cattle at twice the traditional stocking rate through one of
the worst dry years on record and even increased cattle numbers, while also
cutting supplementary feed costs in half.

## Herding as an Alternative to Fencing

Given the high cost of fencing and its disadvantages to wildlife and other
land users, herding has much to recommend it. A skilled herder with one
