...
The overwintered onion system exploits the hardiness of certain onion varieties to produce mature bulbs weeks before any spring-planted crop can reach harvest. The system is planted outdoors in late August and requires protection through the winter months.
...
- The two intermediate rows are harvested as scallions as soon as they are large enough in spring
- The remaining three rows are left to develop into mature bulbs
- The scallion harvest provides early income while the remaining plants gain more space and resources for bulb development

### Timing Advantage

Overwintered onion bulbs mature at the end of June, providing five or more weeks of market presence before the earliest spring-planted onions are ready. This early window is extremely valuable for farm-stand sales and restaurant accounts that want to feature local onions on early summer menus.

### Protection

Overwintered onions are initially protected under mobile greenhouses starting in late November. However, Coleman eventually moved to simpler protection structures (quick hoops) for this crop because the return on the crop did not always justify the length of time it occupied valuable greenhouse space. Under quick hoops, the onions receive row cover in mid-October with a layer of clear plastic added when real winter weather threatens in late November or early December.

## Purchased Onion Plants in the Cool House
...
Baby new potatoes are a high-value spring crop that takes advantage of the greenhouse environment to produce an exceptionally early harvest. The system requires careful advance planning and specific techniques.

### Pre-Sprouting

Seed potatoes are pre-sprouted for one month before planting:

- Starting in mid-February, seed potatoes are held at 70 degrees Fahrenheit for one week in the seed-starting greenhouse
- The warmth breaks apical dominance and increases the number of sprouts per seed piece
- More sprouts translate to more stems per hill and higher total yield

### Planting

- Planting begins in mid-March in the cold houses
- Two rows are planted per 30-inch bed, with seed pieces spaced 8 to 12 inches apart in the row
- If temperatures threaten to freeze under the inner cover after the potato foliage has emerged, an extra insulating layer of fabric is added at night
...
Watercress can be grown as a winter crop in the cool, moist conditions of a minimally heated greenhouse. The production system uses raised beds on the concrete floor:

- Boards frame out 3-inch-tall by 30-inch-wide beds on the greenhouse floor
- Frames are filled with potting soil
- Twelve rows of watercress are sown from seed
