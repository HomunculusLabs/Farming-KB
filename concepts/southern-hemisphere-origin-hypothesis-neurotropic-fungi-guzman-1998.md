...
- P. brasiliensis (Brazil), P. antioquensis and P. guatapensis (Colombia),
  P. sierrae and P. carbonaria (Chile), P. meridensis (Venezuela), and
  P. collybioides (Argentina) are all regional endemics.
...
The paper references Horak's observations about fungal connections between
South America and Southeast Asia through the South Pacific. Copelandia species
are found in both regions, and several Boletus and Psilocybe species show
antitropical distributions. This pattern is consistent with ancient Gondwanan
distribution, where fungal lineages spread across connected southern
