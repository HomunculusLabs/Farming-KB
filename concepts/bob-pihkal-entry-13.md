...
BOB raises questions about the BOX family that remain unanswered:
- What would compounds with sulfur instead of oxygen at the
  beta-oxygen position show?
- What would be the nature of action with an alpha-methyl group,
  making these into amphetamine derivatives?
- What about both a sulfur and a methyl group?
- What about the threo and erythro isomers, the D and L forms?

Shulgin describes this as "chemically simple, and
pharmacologically provocative" territory remaining terra
incognita, calling for someone, somewhere, someday to answer
these questions.
...
flexibility, and metabolic stability of the molecule. Beta-methoxy
substitution in particular is known to reduce or eliminate central
serotonergic activity, as the methoxy group can hydrogen-bond and alter
the preferred conformation of the ethylamine side chain.

The beta-hydroxy analogs (such as BOH, entry #15) tend to show even
more pronounced cardiovascular effects, suggesting that the hydroxyl
group may interact with adrenergic receptors or alter the compound's
pharmacokinetic profile. The consistent pattern of reduced central
activity with beta-substitution reinforces the importance of the
unsubstituted beta-carbon in phenethylamine psychedelic activity.
