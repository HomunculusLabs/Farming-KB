...
Blesching highlights the bidirectional relationship between ghrelin and
the ECS:
...
- Rimonabant (a CB1 antagonist) was developed specifically for obesity
  treatment based on this mechanism, though it was withdrawn due to
