...
The soil foodweb mediates every step of the nitrogen cycle:

- **Fixation:** Free-living and symbiotic bacteria convert atmospheric N₂ to ammonium
- **Mineralization:** Protozoa and bacterial-feeding nematodes release ammonium from bacterial biomass
- **Nitrification:** Specific bacteria oxidize ammonium to nitrite and nitrate
- **Immobilization:** Bacteria and fungi incorporate inorganic nitrogen into their biomass when available carbon is abundant
- **Denitrification:** Under anaerobic conditions, bacteria convert nitrate to N₂ gas, returning nitrogen to the atmosphere

## The Soil Foodweb and Disease Suppression

### Mechanisms of Suppression

A diverse and active soil foodweb suppresses plant diseases through multiple mechanisms:

- **Competition:** Beneficial organisms compete with pathogens for space, nutrients, and infection sites on root surfaces and leaf surfaces
- **Antibiosis:** Some bacteria and fungi produce compounds that directly inhibit or kill pathogens
- **Predation:** Protozoa, nematodes, and microarthropods consume pathogen organisms
- **[[endophytic-mycorrhizal-induced-systemic-resistance]] resistance:** Exposure of plant roots to beneficial organisms triggers the plant's immune system, making it more resistant to foliar and root diseases
- **Physical barriers:** Mycorrhizal fungal sheaths around roots physically block pathogen entry

### Ingham's Approach

Ingham advocates managing the soil foodweb for disease suppression rather than applying fungicides or bactericides. The principle is simple: a healthy, diverse soil biology leaves no ecological niches available for pathogen populations to establish. When disease problems occur, the solution is to identify what aspect of the foodweb is deficient and restore it.

## Assessing Soil Foodweb Health

Ingham recommends direct [[fungal-microscopic-examination-mounting-media-techniques]] of soil and compost samples to assess foodweb health. Key indicators include:

- **Total bacterial biomass:** Measured by direct counts or DNA analysis
- **Total fungal biomass:** Measured by hyphal length or [[ergosterol]] content
- **F:B ratio:** Indicates successional state and management history
- **Protozoan diversity:** Presence of flagellates, amoebae, and ciliates
- **Nematode community:** Diversity of feeding groups, presence of predators
- **Mycorrhizal colonization:** Percentage of root length colonized
