...
The original TEK recommends trying the standard punched-lid technique first before attempting the lidless method, as the lid technique is described as almost fail-proof. The lidless technique should only be attempted after gaining familiarity with the standard inoculation process.

## Jar Rejection Criteria
