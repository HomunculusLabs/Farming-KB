...
This means even [[bacillus-pumilus-radiation-resistance-surface-decontamination]] are relatively resistant to dry microwave irradiation due to the absence of free water for the microwaves to couple with.

The solution involves introducing small quantities of water (approximately 9 uL per cm2) to the contaminated surface.

The water absorbs microwave energy, flashes to steam, and contacts all exposed surfaces to produce the desired [[microwave-exposure-system-architecture-surface-sterilization]] might be limited.
...
The [[magnetron-oscillator-microwave-sterilization]]**: Generates 2.45 GHz microwave energy, the same frequency used in consumer microwave ovens
...
- **[[hydrogen-peroxide-tissue-culture-wild-polypores]], and elemental iodine have well-established protocols but introduce chemical contaminants that may be incompatible with biological systems.
