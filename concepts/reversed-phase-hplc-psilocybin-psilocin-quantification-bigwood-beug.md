...
The chromatography system utilized a reversed-phase column configuration, which is well-suited for separating moderately polar indole
alkaloids like psilocybin (4-phosphoryloxy-N,N-dimethyltryptamine) and psilocin (4-hydroxy-N,N-dimethyltryptamine). In reversed-phase
chromatography, the stationary phase is nonpolar, typically consisting of C18 (octadecylsilane) chains bonded to silica particles, while the
mobile phase is a polar solvent mixture, typically water and an organic modifier such as methanol or acetonitrile.
...
analytical chemistry and provided the precision necessary to detect subtle but real differences between flushes and between strains.

## Calibration Standards and Traceability

The HPLC method was calibrated using reference standards obtained from the National Institute on Drug Abuse (NIDA). NIDA-certified standards
provided traceability to a nationally recognized reference material, ensuring that reported concentrations were accurate in absolute terms
rather than merely relative to an in-house or laboratory-specific preparation. This level of standardization was important for allowing
comparison of Bigwood and Beug's results with those of other researchers who might use different instruments or laboratories.
...
## Analytical Precision Versus Biological Variability

The relationship between analytical precision (10% repeatability) and biological variability (400% to 1000% range) is a critical aspect of
