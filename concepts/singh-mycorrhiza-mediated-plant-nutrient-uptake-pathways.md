...
- AM fungal hyphae express zinc transporter genes (ZIP family homologs)
  that enable zinc absorption from soil solution at low concentrations
- Zinc is chelated by metallothioneins and other binding proteins during
  translocation through hyphae, preventing toxicity to fungal cells
- Mycorrhizal plants consistently show higher zinc concentrations in
...
- The copper-protective function of mycorrhizal fungi is exploited in
  phytoremediation of copper-contaminated soils, where fungal partners
  enable plant growth on otherwise phytotoxic substrates

## Other Micronutrient Transporters

Mycorrhizal fungi influence plant uptake of additional micronutrients:

- Iron: AM fungi produce siderophores that chelate and solubilize iron
  from soil minerals, enhancing iron availability to host plants
  particularly in calcareous soils. Fungal ferric reductase activity
  at the root interface reduces Fe(III) to more plant-available Fe(II)
...
- Molybdenum: fungal hyphae access molybdate from soil solution and
  contribute to plant molybdenum nutrition, important for nitrogenase
  and nitrate reductase enzyme function
