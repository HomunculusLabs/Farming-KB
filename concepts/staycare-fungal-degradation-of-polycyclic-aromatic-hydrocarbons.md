...
Polycyclic aromatic hydrocarbons (PAHs) are widespread environmental pollutants generated from incomplete combustion of organic materials, petroleum refining, and industrial processes. PAHs range from two-ring compounds (naphthalene) to five-ring and larger compounds (benzo[a]pyrene), with increasing molecular weight and hydrophobicity correlating with increased persistence and toxicity. Many PAHs are known or suspected carcinogens, mutagens, and teratogens, making their environmental removal a priority.
