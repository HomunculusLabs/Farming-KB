...
Zone 4 is visited infrequently, perhaps a few times per year. It contains
firewood, timber, and native plants. Management is limited to pasturing
and selective forestry. Ponds and swales may also be present. This zone
supports large animals, soil organisms, and beneficial insects. Human
uses include hunting, gathering, and grazing.

### Zone 5: Wild and Unmanaged

Zone 5 is left entirely to nature. It contains only native plants and
receives no human management. Water features include natural lakes and
creeks. Native animals, soil organisms, and beneficial insects thrive
here. Human uses are contemplative: inspiration, foraging, and
meditation. Zone 5 serves as the instruction manual for the ecological
garden and keeps our lives in tune with nature.

## Design Strategy

The overall strategy with garden zones is to begin at the doorstep,
design and develop the places closest to the house first, and gradually
work outward. This keeps a continuous area under control that gets as
much attention as it needs, rather than having scattered patches that are
easy to forget.

Choosing the zone for each design element depends on two factors: the
number of times you need to visit the plant, animal, or structure, and
the number of times it needs you to visit it.

## Zones Combined with Sectors

Zones organize pieces of a design by how often they are used, while
sectors help locate the pieces to manage external forces such as wind,
sun, water, wildlife, views, fire, and pollution. Sectors are the
energies flowing onto or across the site that a good design will use
wisely. Design elements can interact with sectors in three ways: block or
