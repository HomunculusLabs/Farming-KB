...
can be picked up across space using human reflexes as detectors led to
the invention of devices for diagnosing and treating disease through
vibrational frequencies.

## The Discovery of Electronic Reactions

Abrams trained at the University of Heidelberg in Germany. His
breakthrough came when he noticed that a nearby X-ray apparatus dulled
the resonant note he obtained from percussing a patient's abdomen.
Perplexed, he rotated his patient and discovered that the dulling
occurred only while the man faced east and west, but when aligned north
and south the percussion note was continuously resonant. There seemed
to be a relationship between the geomagnetic field and the
electromagnetic fields of individuals.
...
## The Reflexophone and Disease Detection
...
Abrams found he could differentiate between the wavelengths of
specifically diseased tissues using his "reflexophone" -- an instrument
like a variable electrical resistor that could emit sounds varying in
pitch. Different diseases read from the dial: 55 for syphilis, 58 for
sarcomatous tissue. He could infallibly select or "diagnose" even when
specimens were mixed up.

## Remote Diagnosis and the Blood Drop

Even more remarkable, Abrams found he could diagnose the ills of the
human body from a single drop of blood. Furthermore, by inducting the
effect from one reflexophone to another containing rheostats calibrated
...
telephone wires from a patient miles away, using nothing more than a
drop of blood.
...
anyone could offer a scientific reason for prescribing [[quinine-mollison]]. When
...
He then placed the malarial material in the container together with
