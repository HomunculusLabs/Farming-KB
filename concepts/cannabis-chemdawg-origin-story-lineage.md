...
Through these descendants, Chemdawg genetics are present in a significant portion of the premium cannabis strains available today. The strain's influence on modern [[comparison-cannabis-vegetative-stage-vs-flowering-stage]], which can translate into unwanted stretch if light is not kept close. This makes the strain challenging for indoor growers with limited headroom.

Key cultivation notes from Humboldt Seed Organisation:

- Medium to thick leaves with deep green coloration
- Flip to flowering around day 40 of [[limonene]], and [[cannabis-african-indian-strain-descriptions-clarke]]
