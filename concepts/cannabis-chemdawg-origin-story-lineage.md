...
# [[chemdog]], met a man named Joe at a Grateful Dead concert and bought an ounce of high-quality cannabis for $500. They exchanged numbers, and Chemdog later bought two more ounces from Joe.

Legend tells that when those ounces reached Chemdog on the East Coast, one ounce was seedless and the other was not — it contained 13 seeds, "the cannabis equivalent of magical beans." In 1991, Chemdog finally germinated those beans, and they gave rise to the entire Chemdawg family of strains.
...
The 13 seeds from that fateful purchase gave rise to an entire dynasty of influential strains:

- **Chemdawg 91**: One of the original phenotypes from the 1991 germination
- **Chemdawg D**: Another original phenotype, distinct from Chemdawg 91
- **Chemdog IX-III**: A specific cut that became the basis for many crosses, including Chemdog × Amnesia
- **Sour Diesel**: Widely believed to descend from Chemdawg 91 crossed with a Northern Lights/Shiva Skunk line
...
- Outdoor yield: above average
- Not generally recommended for rookie growers due to multiple challenges

## Sensory Profile

The finished buds are visually striking — described as the kind of nugs that make even experienced smokers take notice. The aroma is piney and fuel-like, characteristic of the "chem" family. The effect is powerful and euphoric, earning the strain its reputation as one of the strongest available.
...
Successful implementation of Chemdawg — Origin Story and Cannabis Lineage History requires attention to
