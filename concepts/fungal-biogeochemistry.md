...
Fungi are well suited as biogeochemical agents because they can be highly resistant to extreme environmental conditions such as metal toxicity, UV radiation, and desiccation; they can adopt a variety of growth, metabolic, and morphological strategies; they can exude protons and metal-complexing metabolites; and they form mutualistic symbiotic associations with plants, algae, and cyanobacteria (Burford et al., 2003; Braissant et al., 2004; Gadd, 2004, 2006). Most fungi exhibit a filamentous growth habit, providing an ability to increase or decrease their surface area, to adopt either exploration or exploitation strategies, and to form linear organs of aggregated hyphae for protected fungal translocation (Fomina et al., 2003). The fungal filamentous explorative growth habit and high surface-area-to-mass ratio, together with the ability to translocate nutrients and form hydrated mucilaginous sheaths surrounding hyphae, ensures that fungal processes are an integral component of biogeochemical change (Gadd, 2004, 2006).
...
Fungi can reduce oxidized metal species, leading to precipitation of elemental forms. The reductive ability of fungi is manifest by black colouration of fungal colonies precipitating elemental Ag or Te, or red colouration for those precipitating elemental Se (Gharieb et al., 1999):

- **Silver (Ag)**: Reduction to elemental silver nanoparticles, with potential nanotechnological applications
- **Selenium (Se)**: Reduction to elemental selenium, relevant to selenium cycling in seleniferous soils
- **Tellurium (Te)**: Reduction to elemental tellurium

These transformations contribute to the formation of mycogenic minerals -- mineral phases produced as a direct or indirect result of fungal activity. Mycogenic minerals include birnessite, ferrihydrite, goethite, schwertmannite, and various metal oxides and oxalates. Precipitation immobilizes metals in the soil environment and therefore limits bioavailability (Gadd, 2000).
...
Fungal mineral transformations contribute to soil formation (pedogenesis) and soil structure. Calcium oxalate biomineralization by mycorrhizal hyphae is particularly important in forest soils. Precipitation of carbonates, phosphates, and hydroxides increases soil aggregation. Hyphae can enmesh soil particles, alter alignment, and release organic metabolites that enhance aggregate stability (Bronick and Lal, 2005). Fungi contribute to the formation of soil aggregates through hyphal binding and production of extracellular polysaccharides that cement mineral particles together, improving soil structure and water retention.
