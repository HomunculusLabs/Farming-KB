...
### Fungal-Fungal Consortia

#### Mixed White Rot Fungi

- **PCB degradation**: Sasek et al. (1993) demonstrated substantial PCB degradation using a mixed population of white rot fungi together with methylotrophic and hydrocarbon-utilizing yeasts. The mixed fungal approach was more effective than single species.
- **Multiple white rot species**: Different white rot fungi produce different combinations of LiP, MnP, and laccase. Combining species provides a more complete enzyme portfolio. For example, combining P. chrysosporium (strong LiP) with T. versicolor (strong laccase) covers both non-phenolic and phenolic oxidation pathways.
...
1. **Complexity**: Understanding interactions among multiple organisms is extremely difficult
2. **Stability**: Consortia may be unstable; one member may outcompete others
3. **Reproducibility**: Complex communities are harder to standardize
4. **Scale-up**: Laboratory consortia may not maintain their structure at field scale
5. **Regulation**: Releasing multiple engineered or non-native organisms faces regulatory hurdles
6. **Monitoring**: Tracking individual members in complex environments is challenging
