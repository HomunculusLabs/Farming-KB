...
- **Oyster mushrooms** (Pleurotus species): Harvest when the cap margin
  begins to curl upward slightly and before excessive spore release.
  Waiting too long results in tough, dry texture and reduced market
  value. The cap should still be slightly convex, not fully flat.

- **Shiitake** (Lentinula edodes): Harvest when the cap is 60-80%
  expanded and the margin is still slightly incurved. Thick-fleshed
