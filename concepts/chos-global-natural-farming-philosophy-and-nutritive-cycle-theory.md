...
Dr. Cho identified that conventional/chemical agriculture is:
...
### Beyond Farming
"Natural farming respecting the natural cycle of life is more than a farming technique. It is a philosophy, a new economics and a way of life."

The system envisions contributing to "the alleviation of poverty, disease and environmental destruction by providing an alternative means of livelihood and food production."

## Strengths and Benefits

| Benefit | Description |
|---------|-------------|
| **Environment-Friendly** | Inputs from natural materials; zero emission in livestock; wastes recycled to resources |
| **Higher Yield** | Nutritive Cycle Theory ensures right nutrients at precise moments |
| **Low Cost** | Homemade materials; farm-sourced resources |
| **High Quality** | No harmful chemicals in production or environment |
| **Adaptable** | Replicable in any region with locally distinct natural resources |
| **Farmer Friendly** | No toxic chemicals; farmers cultivate their own substances |

## What Natural Farming Is vs. Is Not
...
### Foundation
"The NF methodology is based on the Nutritive Cycle Theory, that guides the Natural Farmer on what inputs to apply, how much and how often."

### Principle
The Nutritive Cycle Theory recognizes that plants have different nutritional needs at different growth stages. By matching the right inputs to the right growth phase, maximum quality and yield are achieved without chemical fertilizers.

### Application
- Uses "accurate amounts of substances at the precise moment"
- Nourishes soil with right nutrients when plants or animals need them
- Prevents both under-nutrition and over-feeding
...
2. **Disease Suppression**: Create antibiotic substances, enzymes, and lactic acids that suppress diseases and promote healthy soil conditions

### Collection Philosophy
- Collect from diverse locations (hills, mountains, forests, fields)
- Different organisms live in sun-exposed vs. shaded areas
- "It is better to culture microorganisms from different areas in order to collect different kinds of microorganisms (Microbial Diversity)"
- Culture at different weather conditions for maximum diversity
...
6. **Timing**: 5–6 days at 20°C; 2–3 days at 30–35°C
7. **Harvest**: When rice is covered with microorganisms, transfer to clay pot/glass jar (IMO-1)
8. **Preserve**: Mix with jaggery/brown sugar in 1:1 ratio
...
### Persecution
"When Dr. Cho Han promoted this technology in his home country South Korea, it appeared too subversive and Dr. Cho Han earned the ire of the chemical lobby and the government." He was jailed multiple times, "dubbed as a communist."

### Triumph
"Undauntedly, he carried on his experiments and when the results were too transparent for everybody to see, truth prevailed finally and the Korean government accepted the technology."

### Global Spread
The technology has spread to Japan, Mongolia, China, Thailand, Malaysia, Philippines, USA, and India.

## Core Natural Farming Inputs

The system uses 14+ natural preparations:
1. **IMO** (Indigenous Microorganisms)
2. **FPJ** ([[fermented-plant-juice]])
3. **FFJ** (Fermented Fruit Juice)
4. **OHN** (Oriental Herbal Nutrient)
