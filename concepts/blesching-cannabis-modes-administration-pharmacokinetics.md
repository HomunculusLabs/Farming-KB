...
Different cannabinoids vaporize at different temperatures: THC at approximately 157°C (315°F), CBD at 160-180°C (320-356°F), and various terpenes at temperatures ranging from 130°C to 220°C. This allows patients to select temperature settings that target specific therapeutic compounds. Lower temperatures preserve more terpenes and provide a more nuanced effect profile, while higher temperatures extract more cannabinoids but may also release unwanted compounds.

### Edibles (Cooked Cannabis)
Cannabis can be cooked into foods such as cookies, brownies, or savory dishes, usually in the form of cannabutter, infused oils, or tinctures added after cooking. When eaten, absorption through the gastrointestinal tract takes 45 minutes to 1.5 hours. Effects are delayed, last much longer, and are noticeably different from inhalation due to first-pass metabolism in the liver, which converts THC to 11-hydroxy-THC, a more potent metabolite that crosses the blood-brain barrier more effectively.

The extended duration of edibles (4-8 hours or more) makes them particularly suitable for conditions requiring sustained relief, such as chronic pain, spasticity, and sleep disorders. However, the delayed onset creates a risk of overconsumption, as patients may consume additional doses before the first dose takes effect. Best practice is to start with a very small dose (2.5-5mg THC), wait a full 2 hours, and only increase if needed.

### Fresh Raw Cannabis
Fresh cannabis leaf can be consumed as a salad mixed with other greens or juiced (often diluted with other vegetable juices to mask bitterness). Fresh raw cannabis contains CBD and THC in their acid forms (THCA, CBDA), which are not psychoactive. This makes raw cannabis ideal for patients who need large quantities of CBD for therapeutic and preventative purposes without intoxication. Research into the therapeutic value of raw cannabis is ongoing, with physician case studies and patient testimonials currently available.
...
Cannabis-infused oils, creams, balms, and lotions deliver medicine to specific isolated problem areas. Absorption rates may be similar to ingestion but tend to be less systemic and more localized. Common carriers include hemp oil, almond oil, and coconut oil (preferably virgin, organic). Topicals are particularly valuable for localized pain, inflammation, and skin conditions without producing psychoactive effects, as cannabinoids applied to the skin do not readily enter the bloodstream.

### Solvent-Based Concentrates
Hexane, butane, or isopropyl alcohol can dissolve cannabis ingredients to produce the highest cannabinoid concentrations. However, this method carries significant risks: flammability of solvents has led to explosions, injuries, and deaths, and solvent residue may contaminate the final product with toxic materials. Professional closed-loop extraction systems with proper purging procedures are essential for safety.

## Pharmaceutical Prescription Cannabinoids

Several FDA-approved pharmaceutical cannabinoid products exist:

- **Dronabinol** (synthetic THC, trade name Marinol): Approved for AIDS-related anorexia/cachexia and chemotherapy-induced nausea and vomiting. Marketed as a capsule containing synthetic THC in sesame oil.
- **Nabilone** (synthetic cannabinoid): Also approved for nausea and vomiting secondary to chemotherapy. A synthetic analogue of THC with a slightly modified molecular structure.
- **Sativex**: A plant-derived oral spray tincture containing both THC and CBD, used for multiple sclerosis spasticity and neuropathic pain. Unlike other pharmaceuticals, Sativex retains other biologically active components of cannabis through whole-plant extraction.

These pharmaceuticals are approved by the FDA and used to treat a large number of conditions, but with the exception of Sativex, they do not contain the other biologically active components of cannabis that may play important therapeutic roles through the entourage effect.

## Synthetic Cannabinoids Used in Research

Research-grade synthetic cannabinoids target specific receptor subtypes:

### CB1 Agonists
- **CP 55,940**: Equally strong at CB1 and CB2 receptors
- **HU 210**: Primarily CB1 selective, extremely potent
- **HU 239** (ajulemic acid): Modified THC analogue with reduced psychoactivity

### CB1 Antagonists
- **SR 141716A** (Rimonabant): Originally approved for obesity in Europe, withdrawn due to psychiatric side effects including depression and anxiety
- **AM 251**: Research tool compound used to study CB1 receptor function

### CB2 Agonists
- **JWH-015, JWH-133, JWH-300, JWH-359, JWH-361**: Research compounds targeting CB2-mediated anti-inflammatory effects
- **GW-405,833**: Primarily CB2 selective, studied for inflammatory conditions
- **AM 1241**: CB2 agonist studied for pain management without psychoactive effects

### CB2 Antagonists
- **SR144528**: Blocks both CB1 and CB2 but much stronger at CB2
- **AM 630**: Selective CB2 antagonist used in research to isolate CB2-mediated effects

## Pharmacokinetic Comparison by Route

| Route | Onset | Duration | Bioavailability | Key Considerations |
|-------|-------|----------|-----------------|-------------------|
| Smoking | Minutes | 2-3 hours | 10-35% | Combustion byproducts, lung irritation |
| Vaporization | Seconds-min | 2-3 hours | Higher than smoking | Temperature control critical |
| Oral/Edible | 45-90 min | 4-8 hours | 10-20% | First-pass to 11-OH-THC |
| Sublingual | 15-45 min | 3-5 hours | Moderate | Bypasses some first-pass |
| Topical | Variable | Variable | Low systemic | Localized effect preferred |

## Dosing Principles Across Administration Routes

Effective cannabis therapeutics requires careful attention to dosing, which varies dramatically by route of administration. A dose that provides therapeutic relief via vaporization may be insufficient or excessive when consumed orally. The concept of a "therapeutic window" — the range between the minimum effective dose and the dose at which adverse effects outweigh benefits — is highly individual and depends on factors including body weight, metabolism, tolerance, and the specific condition being treated.
