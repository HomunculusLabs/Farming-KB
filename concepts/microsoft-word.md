...
Word was originally written by programmers Charles Simonyi and Richard Brodie,
who had previously worked at Xerox PARC on the Bravo word processor. The first
DOS version appeared in 1983, but Word did not achieve market leadership until
the release of Word for Windows 2.0 in 1991, which was bundled with Windows 3.1
and featured a graphical interface that outperformed the dominant WordPerfect.
The transition from WordPerfect to Word during the early 1990s is one of the
