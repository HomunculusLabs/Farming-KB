...
The group comprises approximately **95 genera** and **900–1,500 species**, organized into three subclasses:

- **Peronosporomycetidae** — includes many economically important plant pathogens
- **Saprolegniomycetidae** — predominantly aquatic saprobes and parasites
- **Rhipidiomycetidae** — the smallest and least studied subclass

## Distinguishing Characteristics

Several key features separate oomycetes from true fungi:
