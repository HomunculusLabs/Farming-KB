...
work of Roger Heim and Raymond Cailleux during the 1950s. While the
popular literature -- notably the booklet by Oss and Oeric -- had
introduced cultivation to a wide audience, Gartz brought rigorous
mycological expertise to the subject, clarifying what works, what does not,
and what remains poorly understood.

## Basic Mycological Principles

The psychotropic mushroom species are, in terms of cultivation parameters
and nutrients, no different from table mushrooms and other common gilled
mushrooms. Gartz firmly rejects the speculative claims about
extraterrestrial origins of these species. Both psilocybin and psilocin
are substances that can be derived from tryptophan through discernible
biochemical pathways, and free tryptophan has been found in a large number
of mushroom species.

Mushroom propagation begins with basidiospores produced on the gills of
...
1. Decreased temperature to the optimal range for fruiting.
2. Increased humidity to 95-100%.
3. Decreased carbon dioxide concentration through increased air circulation.
4. In many species, exposure to light.

These conditions occur naturally in autumn, when plant substrates such as
twigs and leaves fall to the ground and are colonized by mycelia. The
proverbial "overnight" growth of mushrooms is actually the result of
mycelia that have previously massed together into knots, differentiated
into primordia, and then rapidly developed into mature fruiting bodies
given sufficient moisture and ideal temperatures.
...
monokaryotic mycelia that spontaneously combine to form dikaryotic mycelia.
Alternatively, selected monokaryotic strands can be systematically fused to
develop vigorous strains with desirable characteristics such as rapid
growth and high yield -- a standard technique widely used in commercial
champignon cultivation.

**Tissue culture from fruiting bodies.** A piece of tissue from inside a
young, unopened fruiting body is cut with a disinfected knife in a sterile
environment and placed onto nutrient agar. In most cases, visible mycelial
growth appears within days. This method preserves the genetic
characteristics of a known psychoactive specimen.

## Species Compatibility Testing

Cross-breeding experiments serve a dual purpose in mushroom cultivation.
