...
- **Nornicotine**: A nicotine metabolite with similar pharmacological
  activity.
- **Anabasine**: A minor alkaloid found in Nicotiana species with
  nicotinic receptor activity.
- **Anatabine and other minor alkaloids**: Present in varying
  concentrations.
- **Harmane and norharmane**: Beta-carboline alkaloids that act as
  MAO inhibitors, potentially contributing to the psychoactive and
  dependence-forming properties of Tobacco.

## Pharmacology and Effects

Nicotine acts on nicotinic acetylcholine receptors throughout the
body, producing a complex pharmacological profile:

- At low doses: mild stimulation, increased alertness, improved
  concentration, and mild euphoria
- At moderate doses: relaxation, reduced anxiety, altered sensory
  perception
- At high doses (as used in indigenous ceremonial contexts): powerful
