...
used, extra care is required to discourage contamination and insure
success. Good hygiene and good flow patterns to, from, and within
the growing rooms are crucial.

## Available Supplements

The following supplements can be added at various percentages of
total dry mass of the bulk substrate to enhance yields:
...
Until performance is established, the cultivator is better off
erring on the conservative side than risking over-supplementation.
If supplementing a substrate, the sterilization cycle should be
prolonged. Sterilization must be extended from 2 hours for plain
sawdust at 15 psi to 4 hours for the same sawdust supplemented
with 20% rice bran.

Supplemented sawdust, straw, and compost substrates undergo
thermogenesis, a spontaneous temperature increase as the mycelium
and other organisms grow. If this naturally occurring biological
combustion is not held in check, a plethora of molds awaken as
the substrate temperature approaches 100 degrees F (38 degrees C).
Below this threshold level, these organisms remain dormant, soon
being consumed by the mushroom mycelium.

## Managing Thermogenesis

Simply spacing spawn bags or jars apart from one another, and
...
between liquid inoculum and grain spawn: a semi-solid slurry
millimeters in diameter which would maximally carry water,
nutrients, and mycelium.

## Inexpensive Supplement Sources

A steady supply of supplements can be cheaply obtained by recycling
bakery waste, especially stale breads. A number of companies
transform bakery by-products into a pelletized cattle feed, which
also work well as inexpensive substitutes for many of the additives
listed above. The vehicle of supplementation (grain spawn) into a
semi-selective substrate is more successful than raising the base
nutrition prior to spawning.

## Shiitake Supplementation Research

Tan and Chang (1989) examined the effect of 17 formulations on
Shiitake yield and found that a formula (dry weight) consisting of
71% sawdust, 18% used tea leaves, 7% wheat bran, and 1.4% calcium
carbonate gave the highest yields. When calcium sulfate was
substituted for calcium carbonate, no effect on yield enhancing was
seen. Spent tea leaves proved to be an excellent supplement.
