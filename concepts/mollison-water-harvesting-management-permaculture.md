...
The productive pond integrates multiple trophic levels:

- **Plants:** Watercress, cattails, wild rice, duckweed, diatoms,
  water hyacinth (restricted locations only), mints
- **Invertebrates:** Freshwater shrimp, yabbies, crawfish, mussels
  (superior phosphorus fixers filtering 200 gallons/day each),
  snails (exclude spiral molluscs that eat green plants)
...
grows above duck height, provides a harvest window, and the
...
and bog plants that have phenomenal sewage demand. In cold climates
...
and can be mined for nutrient-rich muck to spread on fields. Longshore
drift traps collect broken shell (saleable as chicken grit) and
create permanent scour-hole ponds.

## Insect Traps and Pond Management

UV lamps placed over ponds with small fans can knock insects into the
water, potentially replacing manure input. Yellow attracts insects,
