---
title: Solomon Raised Beds and Bed Preparation
created: 2026-04-18
updated: 2026-04-18
...
- The soil warms faster in spring
- Easier to work without compacting (you don't walk on the beds)
- Allows deep soil preparation without machinery
- Clearly defines growing areas from paths
...
Standard raised bed width of 4 feet (120 cm) allows the gardener to reach the center of the bed from either side without stepping on the growing soil. This is critical for preventing soil compaction.

For Solomon's extensive spacing system, bed width matters less because the plants themselves don't form a dense canopy that would require reaching across -- there's open space between plants. A 4-foot width is still practical but the gardener could also use wider beds with access paths.

## Rototillers vs Hand Digging

Solomon has significant concerns about rototillers:
- They create a "hardpan" or "plow pan" layer at the depth of the tines
- Repeated tilling at the same depth creates an impenetrable layer that restricts root growth
- They destroy soil structure by over-pulverizing the soil
- The vibration kills earthworms and other soil organisms near the surface

For bed preparation, Solomon prefers hand digging with a spading fork or shovel. This allows the gardener to feel the soil structure, work at variable depths, and avoid creating hardpan layers.

## Seasonal Bed Management

Solomon's approach to bed management across seasons reflects his low-input philosophy:
