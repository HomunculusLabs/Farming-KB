...
organisms clustered around a central element. In permaculture, guild design
replaces monoculture thinking with interconnected polyculture systems that
mirror natural forest relationships.

## The Forest as Model

In the forest, a single fir tree may have 26 different types of flora and
insects that play roles in its growth and life. Fungi, bugs, birds, ferns,
and huckleberry bushes all work together to create an interconnected web.
Rather than thinking about organisms individually, it is useful to think of
them in clusters or groups -- the individuals clustered around a central
element form a guild.
...
A practical orchard guild combines:
- Apple and plum trees as the canopy layer
- Sheep that graze beneath the orchards, eating fallen fruit to prevent
...
In the forest there are interconnected levels from the understorey of ferns
and bushes to the upper canopy of mature trees. Instead of planting a flat
field of one crop, the idea is to intercrop taller and shorter species,
climbing plants and herbs and different kinds of trees, everything placed
...
At the edge between the forest and the lake there is always a mix of ecologies
and a whole other set of species that does not exist in either of the two.
Ecological productivity always increases at the boundary between systems
