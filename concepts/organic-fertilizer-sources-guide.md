...
# Organic Fertilizer Sources (Comprehensive Guide)
...
|--------|-------|--------------|----------|-------|
| Greensand (glauconite) | 0-0-7 | Slow | 2-3 years | Ancient sea bed mineral; 30+ elements including Ca, Mg, Fe; must be weathered |
| Wood ashes | 0-1-3 | Fast | 1-2 months | Free for fireplace owners; alkaline (raises pH); do not use from treated wood |
| Sulfate of potash (Sul-Po-Mag) | 0-0-2 | Fast | ~2 months | Very soluble; 23% S, 22% K, 11% Mg; some do not consider organic |

## Calcium Sources

| Source | N-P-K | Notes |
|--------|-------|-------|
| Calcitic limestone | 0-0-0 | CaCO3; raise pH max ~1 point per season; best applied in autumn |
| Dolomitic limestone | 0-0-0 | CaMg(CO3)2; provides ~10% Mg; too much Mg impacts uptake of other nutrients; binds soils |
