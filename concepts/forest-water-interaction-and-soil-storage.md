---
title: Forest Water Interaction and Soil Storage
...
The process begins at the crown, where forceful raindrops are broken
...
| Source | Rain (in) | N (lb) | P (lb) | K (lb) | Ca (lb) | Mg (lb) | Na (lb) |
|--------|-----------|--------|--------|--------|---------|---------|---------|
| Litter | 19.0 | 12 | 60 | 250 | 60 | 40 | 0 |
| Canopy Drip | 30.67 | 60 | 11 | 28 | 130 | 11 | 71 |
| **Total** | 30.67 | **25** | **23** | **340** | **380** | **17** | **750** |

### Regrowth (95% of total stand)

| Source | Rain (in) | N (lb) | P (lb) | K (lb) | Ca (lb) | Mg (lb) | Na (lb) |
|--------|-----------|--------|--------|--------|---------|---------|---------|
| Litter | 38.0 | 19 | 100 | 490 | 150 | 50 | 0 |
| Canopy Drip | 30.67 | 30 | 07 | 160 | 60 | 5 | 290 |
| **Total** | 30.67 | **41** | **26** | **260** | **550** | **200** | **340** |

By comparison, nearby open rainfall (9.25 inches) delivered only
...
The soil beneath a forest provides three major water storage
mechanisms, plus a minor fourth:
...
rain per 30 cm of depth — a remarkable capacity that transforms
ordinary soil into a vast reservoir.

### 2. Interstitial Storage

Water filling the cavities between soil particles. An additional 0–5
cm (0–2 inches) may be stored as interstitial water above retention
capacity. This is the water that eventually percolates through to
...
A lesser storage exists as water chemically combined with minerals in
the soil. While not readily available to plants, it represents a
significant long-term reservoir.

## The Forest as a Managed Water System

When we consider the visible (above-ground) forest mass as water —
and all but about 5–10% of this mass is water — and then add the
