...
Leaf mold is decomposed forest leaves — a primary soil amendment in KNF.

### Collection
- Collect fallen leaves from healthy forest floors
- Avoid leaves from diseased trees or roadsides
- Mix different types of leaves for diverse nutrients

### Production
1. Pile collected leaves in a shaded area
2. Moisten slightly (not wet)
3. Cover with breathable material
4. Turn periodically
5. Takes 6-12 months to fully decompose
6. Ready when dark, crumbly, and earthy-smelling

### Use
- Mix into potting soil
- Top dress around plants
- Base material for compost
- Mulch layer

## Biochar

Biochar (charcoal) provides habitat for microorganisms and improves soil structure.

### Production
1. Burn hardwood in a covered pit or container (limit oxygen)
2. Quench with water when charcoal stage reached (not ash)
