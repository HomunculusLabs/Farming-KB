...
The primary molecular strategy has been to transfer ligninolytic enzyme genes
from white rot fungi into other fungal species noted for their high secretion
capability. Notable examples include:
...
The rationale for using heterologous hosts like A. oryzae is that their
industrial fermentation platforms are already well developed, offering
scalable production systems for enzyme manufacture.
