...
Different mushroom species have evolved to decompose different materials in
nature, so substrate selection must match the species being cultivated. The
two broad categories are wood-based substrates and agricultural substrates.
...
A simple field test for straw: squeeze a handful firmly. A few drops of water
should appear between your fingers but no stream should flow. For sawdust
substrates, the squeeze test should produce barely a drop. The substrate
should hold its shape when squeezed but crumble when disturbed.
...
Supplementation dramatically increases yields but also increases the risk of
contamination, making proper pasteurization or sterilization even more
critical. Unsupplemented substrates are more forgiving but produce lower
yields per flush.

## Pasteurization vs. Sterilization

**Pasteurization** heats the substrate to 140-170°F (60-77°C) for 1-2 hours.
This kills most competitor organisms and mold spores while preserving
beneficial thermophilic bacteria that help defend against contamination.
Pasteurization is the standard for straw-based substrates and bulk
cultivation. Common methods include hot water baths, steam pasteurization
chambers, and the lime soak method (hydrated lime raises pH to inhibit
contaminants).
...
For commercial or high-yield grows, substrate is often prepared in bulk.
Straw is chopped to 2-4 inch pieces, soaked or steeped in hot water, drained,
and loaded into bags or containers. Sawdust is mixed with supplements and
water, bagged, and sterilized. Proper bagging technique is critical: bags
must allow gas exchange (through filter patches) while preventing contaminant
entry.
