...
The traditional view describes lichens as a mutualistic relationship where the fungus provides structure, moisture retention, and mineral acquisition, while the photobiont provides carbohydrates through photosynthesis. Modern research reveals a more complex picture:

- The relationship may be better described as "controlled parasitism" where the fungus exploits the photobiont
- Many lichens contain multiple photobiont species, not just one
- A diverse microbiome of bacteria and other fungi lives within the lichen thallus
- The term "holobiont" is increasingly used to describe the entire lichen ecosystem

### Photobiont Types

- Green algae (Trebouxia is the most common genus, found in approximately 40% of all lichens)
- Cyanobacteria (Nostoc is the most common; cyanobacteria can fix atmospheric nitrogen)
- Some lichens have both green algae and cyanobacteria in different layers or structures
...
### Leprose (Powdery)
Appearing as a powder or granular coating on the surface. Often difficult to see and identify without magnification. Lepraria species are common examples.

## Identification

Lichen identification requires attention to several features:

### Morphological Features
- Growth form (crustose, foliose, fruticose)
- Color of thallus (upper and lower surfaces)
- Presence and type of vegetative reproductive structures (soredia, isidia, lobules)
- Apothecia (cup-like fruiting bodies): color, shape, margin, disk
- Perithecia (flask-shaped fruiting bodies): embedded or protruding

### Chemical Tests
Lichen substances ([[antifungal-secondary-metabolites-coprophilous-fungi]]) are crucial for identification. Standard spot tests:
...
- UV light: some lichen substances fluoresce under long-wave UV (365 nm)

### Chemical Spot Test Results for Common Genera

| Lichen Substance | K Test | C Test | PD Test | UV Fluorescence |
|-----------------|--------|--------|---------|----------------|
| Atranorin | Yellow | + | - | - |
...
Lichens are among the most reliable biological indicators of [[cervantes-air-quality-ventilation]]:

### Sensitive Species
- Usnea, Lobaria, and Evernia are highly sensitive to sulfur dioxide and nitrogen pollution
- Their presence indicates relatively clean air
- These species are rare or absent in urban and industrial areas
...
- Bioaccumulation studies: lichens absorb [[fungal-biosorption-of-heavy-metals-by-filamentous-fungi]] from air and can be analyzed chemically
...
- Many invertebrates feed on lichens or use them for camouflage
- Birds use foliose lichens for nest material
- Lichens provide microhabitats for tardigrades, nematodes, and other microfauna

### Carbon Cycling
Lichens [[query-how-do-fungi-contribute-to-carbon-sequestration]] fixation in extreme environments (arctic tundra, deserts, high altitude) where vascular plants cannot survive. They are important primary producers in these systems.
...
- [[dighton-fungi-climate-change-feedback]] is altering lichen distributions, especially in mountain and arctic areas
