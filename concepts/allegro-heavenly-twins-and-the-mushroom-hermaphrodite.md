...
When the mushroom volva splits, one half remains in the ground (the "womb"), the other is forced upwards as a canopy (the "burden" or "crown"). The old myth-makers saw in this development the basis for twin-children bearing names related to "womb" and "penis." When the offspring are combined into one person — Adonis, Apollo, Dionysus — he is often portrayed as a beautiful, rather effeminate youth. On occasion this person is a Hermaphrodite.

The prime hermaphroditic deity was Hermaphroditus, offspring of Hermes (Sumerian "erect penis") and Aphrodite (Sumerian "organ of fecundity," the womb). In the botanical world, the ancients give us an androgynous plant-name Eryngion, recognizable as combining "Hermes" (phallus) and "Cain" (womb). Pliny says its root "grows into the likeness of one sex or the other."
...
## The Crucifixion Motif in Twin Mythology

The cross-piece laid across the neck of a servant — the yoke — was also the crux or furca that the criminal carried to execution. The Greek stauros was the upright set in the ground; the condemned man was hoisted up and left to die. To "take up the yoke" or "cross" was synonymous with crucifixion, and also a euphemism for sexual copulation.

The cross became the symbol of the phallic god Hermes — an upright piece with a cross-piece at the shoulders, often with an erect penis at an appropriate place. The similarity between this fertility symbol and the instrument of execution was obvious to all. Castor and Pollux were represented by crossed wooden beams in Sparta; the Greeks called the gibbet the "twin tree" (xulon didumon).
