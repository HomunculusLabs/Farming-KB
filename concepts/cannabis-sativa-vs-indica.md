---
title: Cannabis Sativa vs Indica
aliases: [sativa-indica, cannabis-strains, cannabis-varieties]
tags: [cannabis, pharmacology, herbal-medicine, plant-taxonomy]
sources:
...
Medicinal cannabis [[cannabis-sativa-vs-indica-strain-profiles-therapeutic-blesching]] consists of two primary species: Cannabis sativa and Cannabis indica. Both are psychoactive and both contain the cannabinoids required to engage the endocannabinoid system for specific therapeutic purposes. These two strains differ in their physical appearance, growth characteristics, cannabinoid profiles, and therapeutic applications. The distinction between them is clinically relevant when selecting a strain for treating specific conditions.

## Physical Characteristics

### Sativa

Sativa plants tend to grow taller and longer, with a finer leaf structure. They typically have narrower leaflets with longer internodal spacing. Sativas originated in equatorial regions and are adapted to long growing seasons with consistent light. The plants can reach heights of 2-4 meters when grown outdoors. Their aroma profile often includes sweet, fruity, or herbal notes. (see [[cannabis-sativa-vs-indica-guide]]).

### Indica

Indica plants tend to be short and stocky, with wider leaves and denser foliage. They originated in the Hindu Kush region of Central Asia and are adapted to harsher, shorter growing seasons at higher altitudes. Indica plants typically reach 0.5-2 meters in height and mature faster than sativas. Their aroma profile often includes earthy, musky, or skunky notes. (see [[cannabis-resin-production-and-quality-traits-clarke]]).

## Cannabinoid Ratios

The most therapeutically significant difference between sativa and indica strains lies in their THC:CBD/CBN ratios. These ratios determine the degree to which the balancing properties of the whole plant's constituents are additive or cancel each other out:

### Sativa Profile: Higher THC to Lower CBD/CBN Ratio

Sativa strains generally produce a higher ratio of THC relative to CBD and CBN. This cannabinoid profile creates effects that are predominantly mediated through CB1 receptor activation in the central nervous system.

### Indica Profile: Lower THC to Higher CBD/CBN Ratio

Indica strains generally have a lower THC ratio relative to CBD and CBN. This more balanced cannabinoid profile engages both CB1 and CB2 receptors, with proportionally greater CB2 activation from the higher CBD content.
...
| Social orientation | Usually more extrovert | Usually more introvert |
| Time of use | Best for daytime use | Better after work, bedtime |
| Alertness | Increases alertness | Sleeping aid |
| Depression | Consider for depression | Less suitable |
...
In practice, most commercially available cannabis strains are hybrids with varying ratios of sativa and indica genetics. Hybrids can be:

- **Sativa-dominant**: Retaining primarily sativa effects with some indica influence
- **Indica-dominant**: Retaining primarily indica effects with some sativa influence
- **Balanced**: Approximately equal genetic contribution from both species

Hybridization allows cultivators to combine desirable traits from both species, such as the pain relief of indicas with the mental clarity of sativas.
