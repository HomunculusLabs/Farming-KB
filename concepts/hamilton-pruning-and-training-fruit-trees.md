...
- **Sideshoot**: A shoot arising from the main stem.
- **Secondary shoot**: A shoot arising from a sideshoot.
- **Leading shoot**: The main stem that extends the branch system.
- **Fruiting spur**: A collection of short shoots on which fruit is produced, made by cutting sideshoots and secondary shoots back hard.
- **Downward-facing bud**: A bud angled downward; buds can also be outward-, inward-, and upward-facing, used to advantage when training to shape.
...
2. Second winter: remove central shoot, prune two remaining shoots to 18in (45cm) and tie to poles about 20 degrees above horizontal.
3. Third winter: select four shoots from these side branches (two from top, one underneath, and its extension). Tie in and rub off unwanted buds.
4. Fourth winter: reduce growth on main framework branches by about half. From now on, pruning aims at producing fruit.
5. Following summer: allow sideshoots to grow four to six leaves, forming new shoots at their base. Pinch out other new growth.
6. After picking fruit, prune the fruited shoot. Tie the replacement shoot into its place. Repeat annually.

### Plums (Fan)
Fan-trained plums grow best on south- or west-facing walls. Since plums are susceptible to silver leaf disease, never prune in winter when wounds remain unhealed for long periods.
1. Plant a one-year-old tree against the wall, cut back to 18in (45cm).
