...
valuable for the organic gardener who wishes to propagate fruit
trees, ornamentals, or change varieties without replacing mature
plants.

## Purpose of Grafting

Grafting is generally used to change a variety of an apple or pear
tree completely, or to put a pollinator onto an existing tree. There
is a risk with the latter approach: if you do not use a new variety
with the same vigor as the first tree, the more vigorous variety may
...
varieties. See [[hamilton-organic-seed-saving-propagation]] for the
full range of propagation techniques available to the organic gardener.
