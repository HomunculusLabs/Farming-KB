---
title: Ingham Field Guide — Overview
created: 2026-04-18
updated: 2026-04-18
type: concept
...
*The Field Guide I for Actively Aerated Compost Tea (AACT)* by Dr. Elaine R. Ingham (2001-2003, published 2004) is the definitive practical reference for making and applying [[cervantes-compost-tea-organic-brewing]]. Compiled and edited by Dr. Carole Ann Rollins, it represents the accumulated knowledge of Ingham's Soil Foodweb Institute.

## Purpose and Scope

The Field Guide is organized as a question-and-answer reference, compiled from Ingham's email responses, lectures, and consultations. It covers:

- Definitions and distinctions between types of compost tea
- AACT brewing techniques and ingredients
- [[ingham-aact-disease-suppression]]
- Nutrient cycling and retention
- Specific disease and pest management protocols
- [[ingham-aact-testing-methods]] for assessing tea quality
- Soil biology restoration protocols

## Key Distinctions

The Guide carefully differentiates between:
- **AACT (Actively Aerated Compost Tea)** — actively aerated during brewing, maintains aerobic conditions
- **FCT (Fermentative Compost Tea)** — anaerobic fermentation
- **LBCT (Long-Brewing Compost Tea)** — extended brewing period
- **NACT (Not-Aerobic Compost Tea)** — non-aerated, potentially anaerobic
- **Compost Extract** — liquid extracted without brewing
- **Compost Leachate** — liquid that drains from compost

## Core Philosophy

The Guide's central argument:
1. [[compost-biology-soil-food-web-inoculation]] must be established and maintained for plant health
...
4. [[ingham-aact-testing-methods]] is essential — you must know what biology you have and what you need
...
- Actively aerated compost tea (AACT) supports beneficial soil biology
- Microscopic analysis of compost extracts reveals biological diversity and health
- The soil food web approach focuses on feeding soil organisms rather than plants directly
- Compost quality directly determines the effectiveness of biological amendments
- Regular testing and observation are essential for maintaining biological soil health

## See Also

[[psilocybin-extraction-guide]], [[enoki-cultivation-guide]], [[garlic-growing-guide]], [[adaptogenic-herbs-guide]], [[ashwagandha-growing-guide]], [[2c-family-compounds-overview]], [[fukuoka-road-back-to-nature-overview]], [[morel-mushroom-guide]]
...
a more complete picture of soil function.
