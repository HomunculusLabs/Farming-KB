---
title: Fungal Diversity in Caves
created: 2026-04-16
updated: 2026-04-16
type: concept
tags: [mycology, fungi]
...
Caves provide stable environments with constant temperature approximating the mean annual surface temperature, near-saturation humidity, and complete darkness. Organic matter enters caves through water percolation, animal activity (including bat guano), and occasional surface detritus input.
...
Fungi in deep cave zones must grow oligotrophically, using extremely limited nutrient sources. Cave walls, sediments, and water films support slow-growing fungal communities adapted to nutrient scarcity. The nutrient flux in deep cave environments has been estimated at orders of magnitude below surface soils, creating conditions that select for fungi capable of sustained metabolic activity on minimal substrate availability.

The ability of fungi to grow on minimal nutrient inputs is a key adaptation for cave colonization. Many cave fungi grow very slowly and produce distinctive morphological features in response to the oligotrophic conditions. Some develop highly melanized cell walls that may serve dual functions: protecting against oxidative stress in the cave environment and slowing metabolic rates to conserve energy. Others produce extensive but sparsely branched mycelial networks that maximize surface area for nutrient absorption while minimizing the energetic cost of growth.
...
Bat guano deposits in caves support some of the most diverse and abundant fungal communities in subterranean environments. Guano provides a concentrated nutrient source that supports diverse saprotrophic fungi, including many species also found in surface dung communities.
...
Introduction of artificial lighting in caves for tourism promotes growth of photosynthetic organisms (lampenflora), including cyanobacteria and algae, which in turn support fungal communities that would not otherwise occur in deep cave zones.

These human-modified cave communities represent an intersection between natural cave mycobiota and introduced species, with potential impacts on native cave ecosystems and cave formations (speleothems). The photosynthetic organisms of lampenflora produce organic carbon through photosynthesis, creating a new energy source in zones that would otherwise be entirely dependent on external organic matter input. This supports a secondary community of saprotrophic fungi and bacteria that decompose the algal and cyanobacterial biomass, fundamentally altering the nutrient dynamics of the affected cave zone.
...
Fungal succession in caves follows organic matter input events. When organic material enters a cave, whether through flooding, animal activity, or surface input, a predictable sequence of fungal colonization occurs, from rapid colonizers exploiting simple compounds to slower-growing specialists.

The slow rates of organic matter processing in caves mean that successional sequences play out over much longer timescales than in surface environments. Primary colonizers such as *Mucor* and *Rhizopus* species appear within days of organic matter introduction, rapidly utilizing simple sugars and amino acids. These are followed by *Penicillium* and *Aspergillus* species that decompose more complex polysaccharides and cellulose. Late-successional fungi, including some melanized species adapted to extremely low nutrient availability, may persist on mineral substrates long after the original organic input has been fully processed.
...
Cave mycology presents unique logistical challenges. Cave fungi are often slow-growing and may be overlooked using standard incubation times. Specialized oligotrophic media may be needed to capture the full diversity of cave fungal communities.

Molecular methods are particularly valuable in cave environments, where many fungi may not sporulate and cannot be identified from culture. Environmental DNA from cave sediments, water, and air can reveal diverse communities invisible to traditional methods. Air sampling inside caves has revealed rich communities of airborne fungal spores, including both cave-resident species and surface species transported by air currents through cave entrances. These airborne spore communities serve both as a dispersal mechanism for cave fungi and as a potential indicator of cave environmental conditions.
...
Fungi growing on cave formations (speleothems) such as stalactites and stalagmites may contribute to both the formation and degradation of these geological features. The interactions between fungal biofilms and calcite deposition or dissolution represent an important but understudied aspect of cave geobiology.
...
Molecular surveys and culture-based studies have identified several fungal genera as recurrent inhabitants of cave environments worldwide:

- **Aspergillus and Penicillium**: Among the most frequently isolated genera from cave air, sediments, and guano deposits. These genera include both cosmopolitan species and cave-adapted strains with enhanced stress tolerance.
- **Cladosporium**: Common on cave walls and in entrance zones, often associated with organic matter transported by air currents from the surface.
- **Fusarium**: Found in guano-rich zones and on organic debris; some cave strains of *Fusarium* have been investigated for novel secondary metabolites.
- **Mucor and Mortierella**: Zygomycete fungi adapted to high-humidity environments; frequently isolated from cave soils and sediments.
- **Aureobasidium**: Black yeast-like fungi found on rock surfaces and speleothems, capable of surviving extreme desiccation and oligotrophic conditions.

Many cave fungal isolates show unique physiological adaptations not present in their surface counterparts, including enhanced melanin production (protecting against oxidative stress), slower metabolic rates, and the ability to utilize mineral substrates as nutrient sources.

## Cave Fungi and Human Health

Cave environments can harbor pathogenic fungi, particularly in guano-rich zones. *Histoplasma capsulatum*, the causative agent of histoplasmosis, thrives in bat guano deposits in caves and represents a significant occupational hazard for spelunkers, researchers, and cave workers. Other potentially pathogenic fungi found in caves include *Cryptococcus neoformans* and certain *Aspergillus* species capable of causing respiratory infections in immunocompromised individuals.
