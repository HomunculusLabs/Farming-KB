...
- Pooling/bulking of samples often results in loss of frequency and abundance information

## Trap Cultures

Field sampling recovers only sporulating species. Many AM fungi colonize roots without sporulating at the time of sampling. Trap cultures using host plants (especially Sudangrass/Sorghum bicolor) grown in greenhouse pots with field soil can recover additional species through successive propagation cycles (typically 4-5 months per cycle, with 2-3 cycles needed for full recovery).
...
- Chapter 15, Mutualistic Arbuscular Endomycorrhizal Fungi (Morton et al.) in Biodiversity of Fungi
