...
## Fukushima Daiichi: Lessons and Comparisons

The 2011 Fukushima accident provided additional data:

- Similar Cs-137 accumulation patterns as Chernobyl
- Rapid fungal colonization of contaminated debris
- Role of fungi in Cs-137 cycling in Cryptomeria japonica forests
- Wild mushroom consumption advisories remain in northeastern Japan

## Fungal Uptake Mechanisms

### Potassium Channel Mimicry (Cesium)

Primary cesium uptake occurs through potassium transport systems:

- Cs+ ions are similar in size to K+, allowing passive entry through
  potassium channels
- High-affinity potassium transporters (HAK/HKT family) cannot fully
  discriminate against Cs+
- Soil potassium availability inversely affects cesium uptake
