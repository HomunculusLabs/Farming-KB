...
1. Locate two pure lines differing in a particular trait
2. Cross them to produce an F1 generation
3. Inbred the F1 generation
4. Classify offspring of F1 and F2 generations with regard to the trait
5. Analyze results statistically
6. Compare to known patterns of inheritance to characterize the genes
