...
Several specific cases of misidentification have been documented in the literature:
...
Psilocin, the dephosphorylated and pharmacologically active form of psilocybin, is notably volatile. During drying, storage, and extraction procedures, significant quantities of psilocin may be lost to evaporation. This volatility means that studies reporting only psilocin content, or the ratio of psilocin to psilocybin, may be particularly unreliable unless special precautions are taken to minimize volatilization losses.

### Implications for Comparative Studies

The volatility of psilocin and the differential degradation rates of various alkaloids make it extremely difficult to compare results between studies that used different collection, preservation, and analytical protocols. A study using freshly frozen specimens analyzed immediately will yield very different alkaloid profiles from a study using air-dried herbarium material analyzed months or years after collection.

## Scholarly Critiques

### Ott (1993)

Jonathan Ott, in his 1993 work, provided a detailed critique of the methodological problems in published chemical analyses of neurotropic fungi. Ott argued that many reported alkaloid values should be treated with extreme skepticism due to the combined effects of misidentification, specimen degradation, and analytical inconsistencies.

### Stijve (1995)

T. Stijve similarly critiqued the reliability of chemical analyses in a 1995 publication, emphasizing the importance of voucher specimens and expert taxonomic verification. Stijve noted that many published chemical analyses lacked adequate documentation of specimen identity, making it impossible to verify the taxonomic basis of the reported results.

## Problematic Species Reports
