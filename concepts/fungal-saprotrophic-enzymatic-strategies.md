...
employ a non-specific oxidative enzyme system including [[fungal-manganese-peroxidase-remediation]] (MnP), and laccase, which can attack the diverse
inter-unit linkages in the lignin polymer.

White-rot fungi use low-molecular-weight [[staycare-veratryl-alcohol-as-lignin-peroxidase-mediator]] mediates
...
The Fe2+ then reacts with [[fenton-reaction-chemistry-and-biochemistry]], producing highly reactive hydroxyl radicals that
