---
title: Cannabis Pain Management Protocols
created: 2026-04-26
updated: 2026-04-23
sources:
...
- Indica strains (higher CBD to THC ratio) are generally more sedating and relaxing, better for evening use and sleep
- The THC:CBD ratio determines the degree to which the whole plant's constituents are additive or cancel each other out

For pain management, many patients benefit from indica or indica-dominant hybrids that offer both CB1 (neurological pain modulation) and CB2 (anti-inflammatory) receptor activation. Understanding the body's present endocannabinoid state helps guide strain selection: patients with mental or emotional problems are most likely lacking CB1 activation, while those with chronic inflammation are most likely CB2-deficient.

## Modes of Administration for Pain
