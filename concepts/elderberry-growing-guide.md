...
| Feature | S. nigra (European) | S. canadensis (American) |
|---------|-------------------|------------------------|
| Size | 10-20 feet | 5-12 feet |
| Berry size | Larger | Slightly smaller |
| Cold hardiness | Zones 5-8 | Zones 3-9 |
| Growth habit | Tree-like, large shrub | Multi-stemmed, spreading shrub |
| Self-fertile | Partially (improved with 2 varieties) | Partially (improved with 2 varieties) |
| Medicinal use | Primary species in commercial preparations | Equally medicinal |
| Ornamental varieties | Many (laciniata, 'Black Lace') | Fewer cultivars |
...
- 'York' (S. canadensis): Late-season, heavy yields
- 'Nova' (S. canadensis): Early-season, good pollinator for York
- 'Marge' (S. nigra): Large clusters, self-fertile
- 'Haschberg' (S. nigra): Austrian selection, commercial standard
...
- Antioxidant: High anthocyanin content provides anti-inflammatory action.
- Respiratory health: Traditional use for sinus infections and bronchitis.

Important: Raw elderberries contain cyanogenic glycosides (sambunigrin),
causing nausea and vomiting. Berries MUST be cooked. Stems, leaves, and
bark are toxic. Elderflowers are safe raw or cooked.

## Elderberry Syrup Recipe

A basic, well-tested recipe:

Ingredients:
- 3-4 cups fresh elderberries (or 1.5 cups dried)
- 6 cups water
...
Method:
1. Combine berries, water, ginger, cinnamon, and cloves in a pot
2. Bring to a boil, then reduce heat and simmer for 45-60 minutes
3. Mash berries with a potato masher midway through
4. Remove from heat and let cool slightly
5. Strain through a fine-mesh strainer or jelly bag, pressing to extract all
   liquid
6. Add honey to the warm (not hot) liquid and stir until dissolved
7. Bottle in sterilized glass jars
8. Store in the refrigerator for up to 3 months, or freeze for longer storage

Dosage: 1 tablespoon daily for adults as a preventative; 1 tablespoon every
2-3 hours during active illness.

## Cultivation

### Site Selection
Elderberries prefer full sun to partial shade (minimum 6 hours sun for best
fruit production). They tolerate a wide range of soils but perform best in
rich, moist, well-drained loam with a pH of 5.5-6.5. They are adaptable to
wet soils and can tolerate periodic flooding, making them suitable for
riparian areas and rain gardens. Avoid extremely dry, sandy sites without
irrigation.

### Planting
- Plant bare-root or container-grown plants in early spring or fall
...
Proper pruning is essential for high yields and plant health:

- Year 1-2: Remove dead, damaged, or weak canes only. Let the plant
  establish.
- Year 3+: Begin annual pruning in late winter or early spring while dormant
- Remove canes older than 3-4 years (they become less productive)
- Remove dead, damaged, or crossing canes
- Cut the oldest, darkest canes at ground level
- Leave 6-8 healthy canes per plant of varying ages
- Tip-prune young canes in summer to encourage branching (optional)
- Suckers can be removed to control spread or allowed to grow and thicken
  the hedge
