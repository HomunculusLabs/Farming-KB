...
- Planting rate: 1.5-2 bushels per acre (broadcast) or 1-1.5 bushels per acre (drilled).
...
- Yield: 60-100 bushels per acre (1 bushel = 32 pounds).
- Planting rate: 2-3 bushels per acre broadcast.
- Hull-less oats (naked oats): skip the dehulling step entirely. Lower yield but much easier to process. Highly recommended for homesteaders.
...
- Flint corn: hard kernels, good for cornmeal and polenta. Dries well for storage.
- Dent corn: the standard field corn. Indentation forms as kernels dry. Best for cornmeal and animal feed.
- Flour corn: soft starch, easy to grind. Best for fine corn flour.
- Popcorn: a distinct type with hard, dense kernels that explode when heated.
- Yield: 80-150 bushels per acre (1 bushel = 56 pounds).
- Planting: after soil reaches 50F. Block planting (4+ rows) for wind pollination. 8-12 inches apart in rows 30-36 inches apart.
...
- Oats: 2-3 pounds
- Barley: 2-3 pounds
- Corn: 0.25-0.5 pounds (in blocks, not rows)

## Growing and Maintenance

- Weed management is critical in the first 4-6 weeks. Grains are poor competitors when young. Use a hoe, wheel hoe, or tine weeder.
- Once the grain canopy closes (leaves shade the ground between rows), weeds are largely suppressed.
- Scouting for pests: watch for aphids, armyworms, and grasshoppers. Birds can devastate a crop near harvest.
- Irrigation: grains are relatively drought-tolerant once established. Most homestead grain plots can rely on rainfall. Irrigate during grain fill (flowering to maturity) if conditions are dry.
...
- Threshing by hand: beat sheaves against a tarp, inside a clean trash can, or on a hard surface. Labor-intensive but works for small quantities.
- Whack-a-mole method: place seed heads in a pillowcase and beat with a bat or mallet.
- Tread on it: spread grain on a tarp and walk on it with clean shoes.
- Small-scale threshers: available for $500-2,000. Worth it if growing more than 1/4 acre.

### Winnowing
Separating grain from chaff (the lightweight husks and debris):
- Pour grain slowly from one container to another in a light breeze. The wind carries away the chaff while the heavier grain falls straight down.
- Use a box fan set on low for consistent airflow.
- Repeat 3-5 times until grain is clean.
- Window winnowing: works well on a breezy day.

## Processing and Storage

- Moisture below 14% is essential for storage without molding.
...
- Hand-crank grain mills: $75-400. Corona-style mills are affordable but produce coarse flour. Stone burr mills produce finer flour.
- Electric grain mills: $200-600. Much faster and more consistent. Worth it for regular baking.
- Sift ground flour through fine mesh sieves for pastry-quality flour.
- Grind only what you need -- whole grain retains nutrients much better than pre-ground flour.
