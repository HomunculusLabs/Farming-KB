...
Animal bone charcoal (bone char) has been used historically for decolorization in sugar refining and may offer different selectivity than plant-derived charcoals. Each type of charcoal will produce slightly different results in terms of cannabinoid yield, terpene retention, and color removal.

Some modern processors use silica gel as an alternative or supplement to activated charcoal. Silica gel can be functionalized with specific chemical groups to selectively adsorb particular classes of impurities. This allows more targeted purification than the broad-spectrum adsorption of activated charcoal.
