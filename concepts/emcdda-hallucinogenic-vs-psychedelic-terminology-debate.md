...
- **"Psychodysleptic"** (meaning "mind-disrupting"), a more neutral term used in some European regulatory and scientific contexts, including by the EMCDDA.
- **"Hallucinogenic"** (referring to hallucination-producing properties), the term most widely adopted in the scientific community despite recognized inaccuracies.
- **"Phantastica"** and **"oneirogenic"** (dream-producing), less commonly used terms that have appeared in specialized literature.

All of these names depend on the purposes and starting premises of those using them and bring different positive or negative connotations.

## The Inaccuracy of "Hallucinogen"
...
Hallucinogens can be classified by their chemical structure and the compound class from which they are derived. Chemically related substances tend to exhibit similar subjective effects. The major chemical groups include:

### Indolealkylamines (Tryptamines)

This group includes LSD, psilocin, psilocybin, DMT, and 5-MeO-DMT. All are structurally related to the neurotransmitter serotonin (5-hydroxytryptamine or 5-HT). Psilocybin (4-phosphoryloxy-N,N-dimethyltryptamine or 4-PO-DMT) is the phosphate ester of psilocin (4-hydroxy-N,N-dimethyltryptamine or 4-HO-DMT). Psilocybin is more stable in air and is water-soluble, but it is converted in the body into psilocin, which is the pharmacologically active compound. Psilocin acts on the serotonin system as a 5-HT2A post-synaptic agonist or partial agonist.

### Phenylethylamines

This group includes mescaline, derived from the peyote cactus, as well as synthetic compounds such as 2C-B, 2C-I, and DOI. Phenylethylamine hallucinogens tend to produce effects that are somewhat different in character from tryptamines, with mescaline being noted for its vivid visual imagery and relatively gentle onset.

### Cannabinoids

Cannabis-derived substances, while pharmacologically distinct from classical hallucinogens, are sometimes grouped with them in broad classification systems due to their capacity to alter perception, mood, and cognition.

### Pseudo-Hallucinogens

Many other agents can be classified as pseudo-hallucinogens because they produce psychotic and delirious effects without the classic visual disturbances of true hallucinogens. These include anticholinergic compounds such as scopolamine and atropine (found in plants like Datura stramonium, known as jimson weed), which produce true delirium rather than the lucid altered states characteristic of classical hallucinogens.
...
## Psilocybin Mushroom Species and Families
