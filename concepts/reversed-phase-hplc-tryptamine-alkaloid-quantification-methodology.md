...
framework for tryptamine alkaloid analysis that has influenced subsequent
analytical work on psilocybin-containing mushrooms. Understanding the strengths
and limitations of this approach is essential for interpreting the reported
variability data.

## Chromatographic System Configuration

The analytical system used a reversed-phase HPLC column, which separates
compounds based on their hydrophobicity. In reversed-phase chromatography, the
stationary phase is non-polar, typically consisting of hydrocarbon chains bonded
to a silica support, while the mobile phase is a polar solvent mixture. Psilocybin
and psilocin, both moderately polar tryptamine derivatives, are retained on the
column to different degrees based on their relative hydrophobicity, with the more
polar psilocin (which lacks the phosphate group) typically eluting earlier than
psilocybin under appropriate mobile phase conditions.
...
affect relative comparisons across flushes if applied consistently.

## Qualitative Confirmation by Thin-Layer Chromatography

The HPLC results were qualitatively confirmed using thin-layer chromatography
