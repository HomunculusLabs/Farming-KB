---
title: Fungal Distillery Waste Treatment
created: 2026-04-14
updated: 2026-04-14
type: concept
tags: [mycology, fungi]
...
This topic complements [[fungal-wastewater-treatment]] and [[mycoremediation-basics]].
...
## Fungal Decolorization Performance
...
Yeast cultivation in stillage produces valuable SCP. *Saccharomyces cerevisiae* tolerates ethanol concentrations up to 23%. Key species for SCP from distillery waste include *C. utilis*, *Hansenula anomala*, *Candida rugosa*, and *Citeromyces* sp. WR-43-6. *Citeromyces* sp. achieved 100% COD reduction and 75% decolorization of alcohol factory stillage.

## Bioreactor Systems

Bioreactors for distillery waste treatment include:

- **Stirred-tank fermentors**: Most common; batch and continuous modes established
- **Fed-batch systems**: Used for *S. cerevisiae* SCP production
- **Bubble columns**: Applied with *A. niger* for vinasse treatment (37% decolorization, 69% COD removal)
- **Packed-bed reactors**: *Coriolus versicolor* achieved 75% decolorization; Ca-alginate immobilized *P. chrysosporium* achieved 59%
- **Two-stage continuous processes**: *C. utilis* (first stage biomass) + *A. niger* (second stage COD reduction) achieved 87% total COD reduction

## Mixed Cultures for Improved Performance

Mixed fungal cultures can improve assimilation of nutrients in stillage and provide better biomass yields. Combinations include:

- **C. utilis + Corynebacterium acetoacidophilum**: Increased amino acid and vitamin content
- **C. utilis + Azotobacter**: Azotobacter fixes nitrogen, eliminating nitrogen supplementation
- **Two-step continuous process**: *C. utilis* (first stage, high biomass) + *A. niger* (second stage, COD reduction) achieved 87% total COD reduction with mixed biomass output of 2.3–2.6 g/L/hour
- **C. utilis + Paecilomyces variotii**: Two-step continuous process for cane stillage treatment
- **Geotrichum candidum + Candida krusei + H. anomala**: 54.9% COD reduction of whiskey stillage
- **Trichoderma viride + Paecilomyces variotii**: Most effective of five filamentous fungi tested

Mixed cultures also help prevent contamination in continuous fermentation by occupying ecological niches that would otherwise be exploited by undesirable organisms.
