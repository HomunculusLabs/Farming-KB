...
Spawning rates in shelf cultivation are higher than in other methods, reaching up to 14% of the wet weight of substrate, approximately 7 kg of spawn per 50 kg of substrate per square meter.

## Mechanization

Many Korean growers have adopted equipment to reduce labor costs:
- Spawn mixing machines that ride on rails along shelf edges can reduce spawning labor by 50%
- Filling machines allow simultaneous filling and spawning, where substrate moves via conveyor onto shelves while workers sprinkle and mix spawn
