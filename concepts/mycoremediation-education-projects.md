---
title: Mycoremediation Education Projects
...
The fundamental principle behind screening is straightforward: any fungus capable of colonizing, consuming, and sporulating in the presence of a toxic contaminant shows promise for remediation of that contaminant. Students prepare "traps"—enriched substrate samples containing baseline levels of a particular soil contaminant. These traps are exposed to ambient air (ideally at known contaminated sites) and monitored to see which naturally occurring fungi develop into viable mycelium. The colonizing mycelium is then subcultured, and soil contaminant levels are gradually increased to "train" the fungi—encouraging the expression of genetic traits that enable contaminant breakdown.

Molds are expected and welcome in this process. The goal is to identify the organisms that thrive on the contaminant substrate, devouring it eagerly. Students can also collect fungi directly from known contaminated sites and clone them to reproduce strains already acclimated to site conditions and local ecology. These field-collected strains can be compared against lab-trained samples for mycoremediation effectiveness, and favorable mutations can be selected and improved strains reintroduced to original contaminated sites for in-situ studies.

## Oil Spill Remediation Experiments

Oil spills represent one of the most visible and environmentally devastating forms of pollution, ranging from massive oceanic disasters to small residential oil changes whose cumulative impact is significant. Fungi remediate oil using extracellular enzymes that cleave hydrocarbon molecules into smaller, more biodegradable units. This works because hydrocarbons share structural similarities with lignin—the woody component of wood that fungi naturally decompose. Fungi typically adapt to oil decomposition within just a few weeks after exhausting their natural food source.
...
Students inspect the bins weekly by gently peeling back layers to photograph and observe mycelial activity. After a few weeks, large yellow metabolite droplets form on the myceliated surface—these are the enzymes the mycelium exudes to break down the oil. At approximately one month, red wiggler worms are added to assess whether the substrate has been detoxified sufficiently to support higher organisms. Multiple bins allow staggered worm additions at weeks four, six, eight, ten, and twelve for a time-series study. Given the experiment's duration of up to three months, it should be started early in the academic year.
...
Treatment comparisons typically include: bare soil (control), soil covered with commercial erosion fabric, shredded wheat straw, and mushroom substrate. Students interview local landscaping companies or transportation departments for professional advice on experimental design. The mushroom substrate is allowed to colonize and thread mycelium into the soil for several weeks before testing. All trials are run in replicates, with data recorded and averaged to compare treatment efficiency. Students also calculate cost-effectiveness by comparing material costs against erosion prevention performance.

For contaminated water testing, students use diluted herbicides, fertilizers, and other environmental pollutants, measuring retention time and contaminant levels using test kits or low-tech bioassays such as dilution bean tests or worm assays. Results from all modules are graphed and analyzed to determine the best treatments and contributing variables.
...
Contact with bacteria can stimulate fungi to release metabolites that either encourage or limit bacterial growth, depending on fungal signaling pathways. Students create behavioral plates (petri plates subplated with two or more species separated by space) to study basic interactions—for example, between *Penicillium* and gram-positive bacteria such as *Streptococcus* or *Staphylococcus*. Isolates produced by fungi in response to bacterial interaction are then analyzed for specific functions and mechanisms.

## Engineering Mycoremediation Prototypes

Interdepartmental collaboration between engineering and microbiology students creates powerful synergies for mycoremediation research. Engineering students apply data to real-world design challenges, while microbiology students explore biological questions and test hypotheses. Together, they identify polluted sites, design remediation methods, test prototypes, and ultimately construct and implement filtration systems. This collaborative model bridges academic disciplines and prepares students for professional environmental remediation work.
