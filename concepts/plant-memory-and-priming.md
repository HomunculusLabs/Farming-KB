...
Plants that survive one stress event often show enhanced resistance to
subsequent stress events of the same or different type. This phenomenon, called
stress priming or acquired resistance, represents a form of immunological
memory. Primed plants mount faster, stronger, and more effective defense
responses upon subsequent challenge compared to naÃ¯ve plants.

The most well-characterized example is systemic acquired resistance (SAR), in
which a localized pathogen infection triggers a whole-plant defensive state
that persists for weeks to months. SAR involves the accumulation of salicylic
acid (SA) and the epigenetic priming of defense genes. These genes are not
constitutively active in the primed state but are poised for rapid activation:
their chromatin is marked with histone modifications that make them more
