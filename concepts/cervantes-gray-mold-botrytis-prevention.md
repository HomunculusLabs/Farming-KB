...
Botrytis thrives under specific environmental conditions
that growers must actively prevent:
...
- The bacterium Pseudomonas syringae offers suppression

## Chemical Control

When biological methods are insufficient, chemical controls
can be deployed:

- Bordeaux mixture keeps early stages in check when
  present on foliage
- Preventive spraying is advised in high-risk areas
- Spraying buds near harvest time is not recommended due
  to residue concerns
