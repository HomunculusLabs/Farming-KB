---
title: Fukuoka on Monoculture and the Meat-Based Agricultural System
created: 2026-04-28
updated: 2026-04-28
type: concept
...
**Mechanical destruction:** Large tractors weighing twenty to thirty tons
pulverize the soil structure with each pass. The soil near the surface becomes
hard as clay, and when the sun bakes and dries it, fist-sized cracks form. This
compaction and cracking cycle destroys the crumb structure that allows root
...
**Fallow land requirement:** The land lacks the fertility to produce crops
continuously year after year, so each year from one-third to one-half of the
fields must be left fallow. This represents an enormous inefficiency: a third to
a half of all farmland is temporarily removed from production at any given time
because the farming system itself has destroyed its capacity for continuous use.

## The Meat-Based Diet as Root Cause
