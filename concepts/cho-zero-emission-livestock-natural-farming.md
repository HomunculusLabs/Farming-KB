...
away moisture from the floor and controls dampness. Curtains on
the walls allow farmers to regulate air flow based on weather
conditions. The open design provides an ideal moisture level for
microorganism growth.

The floor must be soil-based, not concrete. Cho insisted that
separating chickens from soil causes disease. The floor is
carpeted with rice straw chopped to three centimeters long at
a thickness of about seven centimeters. FPJ, LAB, and IMO are
added to the soil floor mixture along with enzymes from the
straw and chicken feces.
