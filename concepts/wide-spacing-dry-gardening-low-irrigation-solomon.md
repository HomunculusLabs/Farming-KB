...
The complete organic fertilizer concept is critical for gardens that cannot obtain large quantities of manure. When properly formulated, it provides all essential plant nutrients in balanced, plant-available forms.

## Seed Selection

Solomon strongly emphasizes starting with quality seeds from reputable sources. He warns that seedling raisers and mass-market seed packet businesses are not always ethical. The successful home gardener must:

- Start with strong seeds from dependable, adaptive varieties
- Use truly healthy transplants rather than garden-center seedlings
- Deal with seed companies that conduct honest variety trials
- Learn to save seeds from the best-performing plants

Having run a seed company himself, Solomon provides detailed guidance on evaluating seed suppliers and selecting varieties suited to local conditions.
...
- **Soil depth**: Deeper soils store more moisture. Rocky or shallow soils reduce the effectiveness of wide spacing
- **Freezing**: In cold climates, soil that freezes solid to at least 18 inches depth for several months provides a natural pest control mechanism but limits year-round growing
- **Growing season length**: The number of frost-free days determines what can be grown and whether winter gardens are possible
- **Latitude**: Higher latitudes have shorter growing seasons but longer summer days, which compensates to some degree

## Crop-Specific Considerations

Some vegetables are particularly well suited to wide spacing dry gardening:

- **Potatoes**: The most space-efficient calorie producer, capable of producing significant calories per square foot
...
Solomon advocates minimal tool requirements. Properly maintained hand tools are sufficient:
...
He emphasizes the importance of keeping tools sharp and well-maintained, noting that most modern gardeners lack the basic skills of tool maintenance that their grandparents would have possessed.

## The Bigger Picture

Solomon frames wide spacing gardening within a larger narrative about resource scarcity and economic change. He argues that rising oil prices, declining purchasing power for working people, increasing water scarcity, and more expensive fertilizers are converging to make intensive gardening methods increasingly impractical. Wide spacing dry gardening represents a return to proven, low-input methods that can sustain food production under resource-constrained conditions.
