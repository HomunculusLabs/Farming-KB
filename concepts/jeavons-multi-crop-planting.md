...
## Companion Planting Over Time vs. In Space

Companion planting "over time" is the traditional crop rotation pattern: heavy
feeders followed by heavy givers, then light feeders. Companion planting "in
space" achieves the same nutritional cycling simultaneously. Both approaches
