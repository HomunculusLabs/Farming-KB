...
Also known as krestin, PSK is a protein-bound polysaccharide from turkey tail.
It is an approved anticancer drug in Japan, prescribed alongside chemotherapy.
Over 400 clinical publications demonstrate consistent immune-enhancing effects.

## Extraction Methods

### Hot Water Extraction

The traditional and most common method. Dried material is simmered at 80 to 100
degrees Celsius for 1 to 3 hours, then concentrated. Hot water effectively
extracts beta-glucans, polysaccharides, glycoproteins, and some minerals. This
produces the extracts used in most traditional Chinese medicine and commercial
mushroom supplements.

### Alcohol (Ethanol) Extraction

Ethanol targets lipophilic compounds: triterpenes, sterols, ergosterol, and
phenolic compounds. The material is soaked or refluxed in 50 to 95 percent
ethanol. Pure alcohol misses most polysaccharides, so it is almost always
combined with water extraction.

### Dual Extraction (Water + Alcohol)

The gold standard for medicinal mushrooms, particularly reishi and chaga.
Sequential extraction (water first, then alcohol on the same material) is
preferred because each solvent operates under optimal conditions. The two
extracts are combined into a single finished product.

### Ultrasonic-Assisted Extraction

High-frequency sound waves create cavitation bubbles that collapse violently,
disrupting cell walls and reducing extraction time from hours to minutes while
...
A critical distinction exists between fruiting body supplements and mycelium
grown on grain. Mycelium-on-grain products contain significant grain substrate
in the final powder, diluting mushroom content. Starch testing with iodine
reveals grain filler. Fruiting body extracts generally contain higher and more
consistent concentrations of bioactive compounds.

### Standardization

Quality extracts are standardized to specific markers: beta-glucan content
(measured by enzymatic assay), total polysaccharides, and triterpene content.
Products listing only "polysaccharide content" without distinguishing alpha-
glucans (from grain) from beta-glucans (from mushroom) may be misleading.

### Third-Party Testing

Independent analysis should confirm species identification, absence of heavy
metals and pesticides, and quantified levels of active compounds.
