...
by humans or animals. Understanding the mechanisms and risks of
bioaccumulation is essential for safe mycoremediation practice.
...
Several heavy metals pose particular risks when bioaccumulated
in mushrooms:

- **Lead (Pb)**: A potent neurotoxin that accumulates in bones
  and causes developmental damage, especially in children.
  Mushrooms growing near roads, industrial sites, or older
  buildings with lead paint are at risk for lead uptake.
- **Cadmium (Cd)**: A carcinogen that damages kidneys and bones.
  It is readily taken up by many mushroom species and can
  accumulate to dangerous levels even in soils with relatively
  low cadmium content.
- **Mercury (Hg)**: A neurotoxin that bioaccumulates through
  food chains. Mercury-contaminated sites near mining operations
  or industrial discharge points pose particular risks.
- **Arsenic (As)**: A carcinogen and toxin that affects multiple
  organ systems. Certain mushroom species are known arsenic
  hyperaccumulators.

## Species Variation in Accumulation

Different mushroom species vary significantly in their tendency
to accumulate heavy metals. Some species are hyperaccumulators
that concentrate metals preferentially, while others show lower
uptake rates. This variation depends on the specific metal-binding
proteins and chelating compounds produced by each species. When
planning mycoremediation, species selection should consider both
remediation effectiveness and the ultimate disposition of the
harvested biomass.
