---
title: Neurotropic Fungi Classification System of Guzmán, Allen and Gartz
created: 2026-04-28
tags:
  - mycology
  - taxonomy
...
Gastón Guzmán, John W. Allen, and Jochen Gartz published a landmark comprehensive treatment in 2000 (based on 1998 data) cataloguing 216 species of neurotropic (hallucinogenic, psychotropic, or entheogenic) fungi from around the world. Their system divides these fungi into four major groups based on their active chemical constituents and ethnobotanical significance, providing the most authoritative taxonomic framework for understanding the global diversity of psychoactive mushrooms.

## The Four Classification Groups

### Group 1: Psilocybin and Related Indole Fungi

This is by far the largest group, containing the majority of known neurotropic species. These fungi contain psilocybin, psilocin, baeocystin, and norbaeocystin. The key genera and their species counts are:

- **Psilocybe**: 116 species, representing the overwhelming majority
...
The bluing reaction serves as a primary field indicator for identifying neurotropic Psilocybe species. Species belonging to the sections Aztecorum, Brunneocystidiatae, Cordisporae, Cubensies, Mexicanae, Semilanceatae, Stuntzae, Subaeruginosae, and Zapotecorum all exhibit this characteristic blue bruising.
...
These species form mycorrhizal associations primarily with Pinus and Betula in northern hemisphere forests. Their use as sacred fungi is well documented among Siberian peoples including the Chukchee and Koryak.
...
Guzmán and colleagues carefully excluded several species that had been erroneously reported as neurotropic:
...
- **Panaeolus antillarum**: often erroneously identified as Copelandia by recreational users; it is actually an edible white mushroom that does not turn blue

## Taxonomic Principles

The classification follows Guzmán's concept of the genus Psilocybe (1983, 1995), a modification of Singer's (1986) system that excludes Section Chrysocystidiatae. The authors explicitly do not follow the broader Kühner and Romagnesi concept that would merge Psilocybe, Hypholoma, and Stropharia into a single genus. Under this framework, species like P. aeruginosa, P. albonitens, and P. capnoides as treated by Noordeloos (1995) are not accepted as Psilocybe.

Within the Panaeoloideous fungi, 29 species are distributed among three genera: Copelandia (12 species), Panaeolina (4 species), and Panaeolus (13 species). The taxonomy of this group remains particularly challenging, with several species of uncertain status (nomina dubia and nomina excludenda) noted by Gerhardt (1996).
...
The classification draws on more than 450 bibliographic references. The most important general works informing this system include Bresinsky and Besl (1990), Chilton (1978), Fericgla (1994), Furst (1992), Guzmán (1997), Heim (1978), Hobbs (1995), McKenna (1993), Ott (1976b, 1993), Schultes and Hofmann (1973, 1979), Singer (1978), and Wasson (1962, 1968, 1980). Ott (1993) provided a particularly important list of psilocybin-containing species with bibliographic references and notes on contradictions.

## Relationship to Other Classification Systems

The Guzmán-Allen-Gartz system differs from earlier attempts in several important respects. Ott (1993) listed species in Agrocybe, Conocybe, Copelandia, Galerina, Gerronema, Gymnopilus, Hygrocybe, Inocybe, Mycena, Panaeolina, Panaeolus, Pluteus, Psathyrella, and Psilocybe but did not provide the biogeographic analysis or the four-group organizational framework. Allen et al. (1992) had previously catalogued 128 species but without discussion of geographical distribution or taxonomic commentary. The 2000 treatment expanded this to 216 species with full analysis.
