...
coldest areas on the site. Observe how buildings, trees, and topography
create shade patterns.

**Wind**: Note prevailing wind directions and seasonal variations. Identify
wind-tunnel effects between buildings or through valleys. Observe where wind
is funneled, accelerated, or blocked by existing features.

**Soil**: Dig test pits across the site to examine soil profiles. Note soil
depth, texture, structure, color, root penetration, and stone content. Test
pH and drainage. Identify areas of compaction, erosion, or deposition. See
soil analysis.

## Climate Data Collection

Mollison emphasizes the importance of gathering comprehensive climate data
...
Mollison insists on thorough documentation of existing vegetation before any
design or clearing occurs. The survey should identify:
- All tree species with location, size, health, and condition
- Dominant understory shrubs and groundcover species
