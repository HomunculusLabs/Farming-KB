---
title: Garden Myths About Native Plants and Invasive Species
created: 2026-04-18
updated: 2026-04-18
type: concept
...
### Why It Is Not Always True
- **"Native" is a huge category**: A plant native to a region may be native to a specific microclimate within that region that is very different from your garden. A plant native to a wetland will not thrive in a sandy, well-drained suburban yard, even if both locations are in the same county
- **Garden conditions differ from wild conditions**: Gardens typically have disturbed soil, different hydrology, different light conditions, and different competitive dynamics than the natural habitats where native plants evolved
- **Urban environments are challenging**: Native plants evolved in pre-urban landscapes. Air pollution, compacted soils, heat islands, altered hydrology, and light pollution are conditions many native plants are not adapted to handle
