---
title: "Psilocybin Mushrooms in Mesoamerican Civilization"
created: 2026-04-26
aliases: [teonanacatl, Maria Sabina, Wasson, Oaxaca mushrooms, Mazatec]
tags: [mckenna, Mesoamerica, psilocybin, Wasson, Maria Sabina, Aztec, mushroom cult]
sources: "Food of the Gods (1992), Ch. 12–13"
type: concept
updated: 2026-04-26
---
...
McKenna interpreted the Greek myth of Glaukos — preserved in honey, resurrected from the dead, with a name meaning "blue-gray" (the color of bruised psilocybin mushroom flesh) — as evidence of a barely remembered mushroom cult in the ancient Aegean. The story contains all the motifs of mushroom shamanism: themes of death and rebirth, cattle, serpents with herbal knowledge, and a blue-gray child preserved in honey (honey being used in Mexico to preserve psilocybin mushrooms, and frequently mentioned in the Rig Veda in connection with Soma).

## The Broader Mesoamerican Hallucinogen Complex
...
The Mazatec people recognize multiple varieties of psychoactive mushrooms, each with distinct names and perceived qualities. Among the most commonly used species are *Psilocybe mexicana*, *Psilocybe caerulescens* (known locally as "derrumbe" for its tendency to grow after landslides), and *Psilocybe cubensis*. The Mazatec classification system is ecological rather than strictly taxonomic — mushrooms are named for where they grow, when they appear, and the quality of the visions they produce rather than their morphological characteristics.
