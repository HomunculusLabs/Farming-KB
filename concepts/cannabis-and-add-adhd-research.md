---
title: Cannabis and ADD/ADHD Research
created: 2026-04-18
updated: 2026-04-19
type: concept
...
**Mechanism:** ECS modulates dopamine, norepinephrine, GABA, and glutamate. CB1 receptors balance novelty-seeking (cortical glutamate) and safety assessment (GABA). This dual capacity to balance upper and downer effects simultaneously may present a new treatment approach.

**Key studies:**

- 2008 Heidelberg case study: 28-year-old male with ADHD -- after Dronabinol (THC), changed from "pushy, demanding, lacking distance" to "calm, but not sedated, organized and restrained"

- 2011 Rome (mice): CB1 receptors identified as novel molecular players in ADHD

- 2012 Melbourne (rats): CBD (3mg/kg) normalized social behavior, reduced hyperactivity, but had no effect on attention span

- 2013 UC Irvine survey: men used cannabis for inattention; women for sleep quality

- 2014 national US survey: daily cannabis users self-medicated for hyperactive-impulsive symptoms

## Study Summary

| Agent | Study Type | Year, Location, Key Finding | CHI |
|-------|-----------|---------------------------|-----|
| Cannabis (national survey) | Survey (2,811 users) | 2014 -- SUNY Albany: Supports CB receptor link to regulatory control | 3 |
| Cannabis | 76 patients with ADHD | 2013 -- UC Irvine: Men treat inattention; women improve sleep | 3 |
...
The clinical evidence for cannabis in ADHD is moderate and growing, with a CHI value of 15.

- **Individual case study (2008, Heidelberg):** The transformation described in the 28-year-old patient -- from "pushy, demanding, lacking distance" to "calm, but not sedated, organized and restrained" -- is qualitatively remarkable and consistent with prefrontal cortex functional improvement.

- **CB1 as a molecular target (2011, Rome):** Identification of CB1 receptors as "novel molecular players in ADHD" provides a strong mechanistic rationale for cannabinoid-based treatment and opens the door for targeted drug development.

- **CBD normalizes behavior (2012, Melbourne):** The demonstration that CBD specifically addresses hyperactivity and social dysfunction (but not attention) helps clarify which cannabinoid profiles may be most effective for different ADHD subtypes.

- **Gender-specific patterns (2013, UC Irvine):** The finding that men primarily used cannabis for inattention while women used it for sleep quality suggests that optimal cannabinoid therapy may need to be gender-specific.
