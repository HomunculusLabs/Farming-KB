...
Temperature is one of the most important variables in compost tea production. Microbial metabolism is directly tied to temperature, and even small deviations from the optimal range can dramatically affect the quality of the final brew.
...
Keeping track of water temperature during brewing is important for several reasons. Temperature records are helpful when submitting tea samples to biological testing labs, as temperature is one of the variables that affects organism counts. Temperature also serves as a troubleshooting reference if a batch turns out poorly.

**When brewing in cool conditions:**
- Move the brewer to a warmer location if possible — a garage, basement, or heated room
- Use a small, inexpensive aquarium heater with an automatic thermostat to maintain consistent warmth
- Wrap the bucket with insulation (blankets, bubble wrap) to reduce heat loss

**When brewing in hot conditions:**
- Move the brewer to a shaded, cool location
- Pack the bucket with ice or periodically add ice to keep temperatures down
- Avoid placing the brewer on concrete or asphalt surfaces that radiate heat
- Brew in the early morning or evening when ambient temperatures are lower

## Protecting Microbes from UV Radiation

Compost tea should always be brewed away from direct sunlight. Ultraviolet rays from the sun are lethal to the bacteria, fungi, protozoa, and nematodes in the tea. Even brief exposure to direct sunlight during brewing can significantly reduce microbial populations.

Additionally, the proteins in compost — primarily from worm bodies — have a tendency to cause foaming in the tea. This foam can overflow the brewing vessel, so site your brewer in a location that can tolerate some spillage.

## Water Quality: Rule #12

**Rule #12** states that compost teas are extremely sensitive to chlorine and preservatives in both the brewing water and the ingredients. This is critical because these chemicals are specifically designed to kill or discourage microbial life — the exact opposite of what you want in a compost tea.
...
It is vitally important that **none** of the ingredients used contain preservatives. Read labels carefully. Many commercially available molasses, kelp, and fish products contain preservatives that will kill the very microbes you are trying to grow.

## The Compost: Foundation of Every Brew

The quality of your compost directly determines the quality of your tea. All compost is either good, or it is not compost at all.

### Selecting Good Compost
...
### Vermicastings as a Substitute

Vermicompost (worm castings) is an excellent substitute for conventional compost. Vermicastings are:
- Full of beneficial microbes
- Very bacterial in character, reflecting the role bacteria play inside the worm's digestive system
- Most effective when fresh

### Compost Quantity

The amount of compost needed does not scale linearly with brew size:

| Brew Size | Compost Needed |
|-----------|---------------|
| 5 gallons | 5 lbs (20 cups) |
| 50 gallons | 7 lbs (28 cups) |
| 500 gallons | 15 lbs (60 cups) |

For an initial 5-gallon brew, use approximately 4 cups of compost or vermicompost.

## Bacterial Foods

Bacterial foods are simple sugars and compounds that bacteria can rapidly metabolize, causing their populations to multiply quickly during the brew.

### Simple Sugars

- **Molasses** (nonsulfured only — sulfur kills microbes): powdered or liquid form. The most common and effective bacterial food.
- **Cane syrup:** A good alternative to molasses
- **Maple syrup:** Works well as a bacterial food
- **Fruit juices:** Provide simple sugars that bacteria readily consume

**Dosage:** 2 tablespoons per 4–5 gallons of water. Scale proportionally for larger brews.

### Complex Bacterial Foods

- **Fish emulsion:** Supports both bacterial and some fungal growth
- **More complex sugars:** Provide sustained bacterial nutrition over longer brews
...
- **Fruit pulps:** Orange, blueberry, and apple pulps support fungal growth
- **Aloe vera extract:** (preservative-free) Supports fungal populations
...
- Can detrimentally impact tea quality if allowed to remain and build up
...
| Sunlight | Keep brewer in shade — UV kills microbes |
| Water | Dechlorinate by aerating 1–2 hours or use carbon filtration |
| Compost | Must be fully finished, smell good, no chemical residues |
| Preservatives | Absolutely none in any ingredient |
