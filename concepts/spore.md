...
Sexual (meiotic) spores result from fusion of compatible hyphae (plasmogamy)
...
- **Shape** -- Globular, ellipsoidal, cylindrical, angular, stellate, or
  irregular. Shape alone can distinguish genera.
- **Color** -- Transparent (hyaline) or pigmented (brown, black, rust,
  pink). Pigmented spores are often more resistant to UV radiation.
- **Wall ornamentation** -- Surface may be smooth, warty (echinulate),
  ridged, reticulate (net-like), or covered with appendages.
- **Germ pore** -- A thin-walled region where the spore wall will rupture
  during germination. Position and number of germ pores are taxonomically
  useful.

## Spore Dispersal

Fungi employ diverse dispersal strategies:

- **Wind dispersal** -- The most common mechanism. Mushrooms elevate their
...
- **Explosive discharge** -- Pilobolus, the "cannonball fungus," grows on
  ...
  light, landing on grass that will be eaten by a grazing animal.
