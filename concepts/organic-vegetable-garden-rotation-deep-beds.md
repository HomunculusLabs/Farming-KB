...
The deep bed method has been practiced for centuries worldwide. Instead of long rows with access paths between each row, crops are grown in beds 4ft (1.25m) wide, with all work done from narrow paths at the sides.

### Advantages
- Doubles the amount of land available for crops by eliminating unproductive paths
