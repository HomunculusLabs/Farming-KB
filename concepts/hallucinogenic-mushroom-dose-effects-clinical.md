...
- Enhanced visual perception (brighter colors, sharper detail)
- Visual distortions (geometric patterns, flowing surfaces, waves)
- New insights and altered perspectives (often about time and self)
- Feelings of unity and interconnectedness
- Enhanced appreciation of music and art
- Rapidly changing emotions described as "lots of fun"

### Negative Effects ("Bad Trip")
- Anxiety, panic attacks, and paranoia
- Confusion and disorientation
- Impaired judgment of time and distance
- Sense of unreality or depersonalization
- Frightening visual distortions or hallucinations
- Psychosis-like states (in severe cases)
- Despair, sadness, and depression during and after the experience

The EMCDDA notes that nearly a quarter of recent users in UK clubbing
surveys reported experiencing a panic attack during mushroom use.

## Acute Physiological Effects

Physiological effects are generally mild and not life-threatening:

- Dizziness and lightheadedness
- Nausea and abdominal discomfort (very common)
- Pupil dilation (mydriasis)
- Mild to moderate tachycardia (increased heart rate)
- Mild tachypnea (increased breathing rate)
- Mild blood pressure elevation
- Muscle aching or weakness
- Shivering and temperature dysregulation
- Increased reflexes

Over a quarter of UK survey respondents who used mushrooms in the
past year reported nausea or vomiting.

## Factors Influencing Effects

Multiple factors modulate the mushroom experience:

- **Individual sensitivity**: Wide variation exists; some
  individuals are highly sensitive, others barely responsive
- **Set**: The user's expectations, mood, and mental state
- **Setting**: The physical and social environment
- **Food intake**: Full stomach delays onset and may reduce peak
  intensity
- **Prior experience**: Familiarity with psychedelic effects
  reduces anxiety but also reduces novelty
- **Substance interactions**: Alcohol can potentiate negative
