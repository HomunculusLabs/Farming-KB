...
structures — cages, stars, and nets — that Nicholas Money compares to the
geodesic domes of Buckminster Fuller.

## Egg-Based Development
...
are coated with dark, olive-green gleba on their inner surfaces. The visual
effect is startling — the emergent fruiting body resembles a sea anemone or
a creature from a science fiction narrative more than a typical fungus.

## Laternea: The Lantern Fungus

*Laternea triscapa* (synonymous in some treatments with *Lysurus* species)
produces a structure in which the arms are partially or fully fused at their
bases, forming a lantern-like or columnar shape. The fused arms create a
chamber that partially encloses the gleba, offering some protection from
rain and physical disturbance while still allowing insect access. This
morphology represents an intermediate form between the fully open arms of
*Anthurus* and the closed cage of *Clathrus*, illustrating the evolutionary
plasticity of the phalloid receptacle.

## Ileodictyon: The Intestinal Net

*Ileodictyon cibarium*, the basket fungus or intestinal net fungus, is native
to New Zealand and southeastern Australia. Its receptacle expands into a
...
cage achieves this through biological growth rather than manufacturing, yet
the geometric principles are essentially the same. The resemblance extends
to the molecular scale: the carbon allotrope buckminsterfullerene (C60),
discovered in 1985, consists of 60 carbon atoms arranged in a truncated
icosahedron of hexagons and pentagons — the same geometric pattern found in
the arms of *Clathrus ruber*.

## Biomechanical Advantages of Polyhedral Structures

The polyhedral form of cage fungi offers significant biomechanical advantages.
The lattice construction is lightweight, requiring relatively little biological
material to construct, yet it is resistant to compression and deformation. The
interconnected arms mutually brace one another, distributing mechanical loads
efficiently across the structure. This is particularly important for a fungus
whose reproductive success depends on presenting its gleba to insect visitors
without collapsing under its own weight or being toppled by rain or wind. The
open structure also maximizes the surface area available for gleba coverage
while minimizing the biomass invested in structural tissue.

## Evolutionary Changes in Receptacle Development

The diversity of receptacle forms among cage fungi — from the closed sphere of
*Clathrus* to the open star of *Anthurus* to the net of *Ileodictyon* —
reflects evolutionary experimentation within the phalloid lineage. Nicholas
Money discusses how changes in the timing and pattern of arm separation, arm
fusion, and arm curvature can produce dramatically different mature structures
from fundamentally similar developmental programs. These variations likely
represent adaptations to different dispersal agents, climatic conditions, and
substrate types across the [[four-groups-neurotropic-fungi-global-distribution-guzman-1998]] of the group.

## Dispersal by Ants and Stingless Bees

While flies are the primary dispersal vectors for most stinkhorns and cage
fungi, some tropical species have evolved associations with ants and stingless
bees. These insects are attracted to the gleba and carry spores back to their
nests, where the spores may germinate on nutrient-rich nest material. The
association with social insects represents a more specialized dispersal
strategy than the generalist fly attraction employed by temperate species,
and may contribute to the ecological success of cage [[arbuscular-mycorrhizal-fungi-in-tropical-forest-restoration]] forests
where competition for suitable substrates is intense.
