---
title: Historical Witches and Cannabis
created: 2026-04-26
updated: 2026-04-24
sources:
...
The use of color-coded candles reflects the Golden Dawn system of color symbolism that has become standard in modern Western occult practice.

## Historical Ritual Structures

The guide's rituals follow structures that connect to well-documented historical witchcraft and ceremonial magick traditions:
...
The vowel-vibration technique described in the Smoke and Mirrors section closely parallels the LBRP, a foundational practice in modern ceremonial magick. The specific correspondences between vowels and body regions (head, throat, chest, stomach) map onto the chakra system, and the practice of drawing pentagrams at four quarters while vibrating divine names is a hallmark of Golden Dawn-derived practice. The guide's version substitutes simple vowel sounds for traditional Hebrew divine names, suggesting an adaptation that prioritizes accessibility over traditional orthodoxy.

### Sigil Magic

The Vortex ritual includes contemplation of a five-line sigil (BHWER / GRHRE / JNRED / NURWQ / NIRWC) while in an altered cannabis state. Sigil magic has roots in Renaissance ceremonial magick (particularly the work of Cornelius Agrippa and John Dee) and was revolutionized by Austin Osman Spare in the early 20th century. Spare's method involved creating abstract symbols from written intentions and charging them through gnosis -- an altered state of consciousness in which the conscious mind is bypassed. The guide's approach of contemplating a sigil while heavily under the influence of cannabis is a direct application of Spare's principles.
