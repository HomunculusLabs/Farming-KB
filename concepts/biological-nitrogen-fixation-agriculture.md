...
Biological nitrogen fixation (BNF) is the enzymatic conversion of atmospheric
...
heavily nodulated legumes, powered entirely by solar energy.

## The Nitrogenase Enzyme Complex

Nitrogenase consists of two metalloprotein components. The **Fe protein**
(dinitrogenase reductase, encoded by *nifH*) is a homodimer (~60–70 kDa)
containing a [4Fe-4S] cluster that serves as the obligate electron donor,
binding one ATP per subunit. The **MoFe protein** (dinitrogenase, encoded by
*nifD*/*nifK*) is an α₂β₂ heterotetramer containing the **P-cluster**
([8Fe-7S]) and the **FeMo-cofactor** ([Mo-7Fe-9S-C-homocitrate]) — the actual
N₂ reduction site with a central carbon interstitial. Three isozyme types exist:
Mo-nitrogenase (100% activity, *nifHDK*), V-nitrogenase (~50%, *vnfHDGK* under
Mo-limitation), and Fe-only nitrogenase (~25%, *anfHDGK* under combined Mo/V
limitation). At least 1 H₂ is produced per N₂ reduced; uptake hydrogenase
(*hup* genes) recaptures some, improving efficiency by 10–15%. The catalytic
mechanism follows the Lowe-Thorneley scheme: electrons accumulate on the
FeMo-cofactor through transient Fe protein docking (2 ATP per electron), N₂
binds at an Fe atom, and undergoes sequential hydrogenation through diazene
and hydrazine intermediates to yield 2 NH₃. The *nif* regulon is controlled by
**NifA**, regulated by N-status sensing (NtrC/NtrB, GlnD/GlnK) and, in
rhizobia, by the FixL/FixJ oxygen-sensing system.
...
cyanobacteria entering through stem glands (up to 72 kg N/ha/yr). **Free-living
diazotrophs** include *Azotobacter* (aerobic, all three nitrogenase types),
*Clostridium* (anaerobe, flooded paddies), and cyanobacteria (*Anabaena*,
*Nostoc*; 20–30 kg N/ha/crop as rice biofertilizers). **Associative fixers**:
*Azospirillum* (grasses, promotes growth via IAA), *G. diazotrophicus*
(sugarcane endophyte, 20–60 kg N/ha/yr), *Azoarcus* (Kallar grass),
*Herbaspirillum* (rice, maize).
...
alfalfa 80–200 kg N/ha, deriving from residue mineralization and rhizodeposition
(30–50% of fixed N released via exudates and nodule turnover).
...
- **Soil mineral N**: >25–50 kg/ha suppresses *nif* and *nod* expression.
  Starter N of 10–20 kg/ha benefits early growth without major suppression.
- **pH**: Optimal 6.0–7.5; acid soils (<5.5) inhibit rhizobial survival.
  Bradyrhizobium is more acid-tolerant; liming is primary amelioration.
- **Temperature**: Optima 20–30°C (temperate), 25–35°C (tropical). Cold
  delays nodulation to 30–45 days; heat reduces nitrogenase activity.
- **Moisture**: Optimal 60–80% field capacity. Drought causes nodule
  senescence; waterlogging inhibits rhizobial respiration.
- **Phosphorus**: Critical for ATP-intensive fixation. Legumes respond more
  to P fertilization than non-legumes. Mycorrhizae key in low-P soils.
- **Micronutrients**: Fe (nitrogenase + leghemoglobin), Mo (FeMo-cofactor),
  Co (cobalamin), Ca (infection thread formation).

## Frontiers: Engineering N₂ Fixation in Cereals
Transferring BNF to non-legumes pursues expressing ~20 *nif* genes in plant
mitochondria (functional Fe protein achieved in yeast, 2020), engineering Nod
factor perception using shared AM signaling components (CCaMK, DMI1, DMI2
