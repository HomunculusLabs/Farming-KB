...
Getting sugars into the phloem requires energy in a process called phloem loading. Apoplastic loaders (common in temperate climates and herbaceous plants) pump hydrogen ions out of the cell membrane to transport sucrose into companion cells. Symplastic loaders (common in the tropics and most trees) pass sugars through plasmodesmata. In both cases, the resulting high sugar concentration in sieve tubes draws water from the adjacent xylem, creating turgor pressure that drives sap flow toward sink areas where sugars are unloaded for use or storage.

## Appropriate Uses of Foliar Feeding
