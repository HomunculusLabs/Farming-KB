---
title: Poisonous Fungi — Identification, Toxins, and Treatment
...
- Treatment: antiphalloidian serum (Institut Pasteur), intravenous glucose (20–25%), salt solution

### Group 2: Neurotoxins (Nervous System Paralysis)
- **[[amanita-muscaria]]** ([[fly-agaric]]), **A. pantherina** (False Blusher)
- **Inocybe patouillardi** (Red Staining Inocybe)
- Symptoms: delirium, hallucinations, intestinal disturbances within 1–3 hours
...
Ramsbottom systematically refutes every popular rule-of-thumb test:
...
8. **"Bitter/acrid taste means poison"** — None of the really dangerous fungi has a sharp taste

## Key Toxins Identified

### Amanitin (Amanita-toxin)
- Complex chemical structure
- Resists heat, drying, and digestive juices
- Causes liver degeneration, kidney failure, progressive paralysis
- The primary lethal agent in A. phalloides poisoning
- Long incubation (10–12 hours) means stomach pumping is useless by the time symptoms appear

### Phalloidin
- Polypeptide, quickly active but destroyed by heat
- Contributes to early symptoms but not the fatal outcome (heat-resistant amanitin is the killer)
...
- Well-marked pharmacological effects but NOT the characteristic A. muscaria poisoning syndrome

### Mycetoatropine (Muscaridine)
- Alkaloid with effects similar to atropine on the central nervous system
- Precise chemical constitution was unknown in 1945
- Likely the primary psychoactive agent in A. muscaria

### Choline
- Occurs in fairly large amounts in A. muscaria
- Probably responsible for gastrointestinal symptoms
...
## Clinical Features of A. phalloides Poisoning

1. **Latent period:** 10–12 hours with no discomfort (almost diagnostic)
2. **Onset:** Sudden intense abdominal pain, vomiting, diarrhoea, extreme thirst
3. **False recovery:** Quiescence after ~2 days (most dangerous period)
4. **Relapse:** Symptoms recur more intensely; nervous system gradually paralysed, liver degenerates, delirium, collapse, death
5. **Recovery:** Slow if it occurs; prolonged convalescence
6. **Lethal dose:** Surprisingly small amount

## Treatments (1945)

1. **Antiphalloidian serum** (Institut Pasteur): Injected hypodermically or intravenously, dose ≥40 c.c. Produced by immunising sheep. No ill effects from injection.
