...
Procedure:
1. Dilute IMO-2 by 500-1000x with water, mix with rice bran
2. Moisture level should be 65-70% (ball test: forms when pressed, breaks when shaken)
3. Stack mixture 30-40 cm high on **soil floor** (not concrete)
4. Cover with paddy straw (70% shade, 30% light)
...
8. Sweet fragrance indicates completion; moisture drops to ~40%

Storage: Keep in ventilated jute/gunny bags in cool, shaded place. Moisture drops to 20-30% (dormancy state).

## IMO #4: Final Product (Soil Application)

Materials:
- IMO-3: 10 kg
- Field/crop soil: 5 kg
- Red fine soil (anthill/termite mound): 5 kg

Procedure:
1. Combine 1 part IMO-3 with 1 part soil (50% field soil, 50% fresh mountain/red soil)
2. Mix on soil floor, not concrete
3. Create heap ~20 cm high
4. Adjust moisture to 65-75% with NF inputs (FPJ, FFJ, FAA, LAB at 1:1000)
5. Add seawater (1:30 dilution) for weather resistance
6. Cover for 2 days; this is IMO-4

## Application

- **Soil Foundation**: Scatter IMO-4 over field (minimum 150 kg/ha), barely covering topsoil. Apply 7 days before seeding (14 days for fields with successive cropping disorder)
- **With Compost**: Mix IMO-4 with compost materials at 1:10 ratio, ferment 7-14 days (creates IMO-5)
- **Liquid Form**: Put IMO-4 in cloth bag, soak in water at 1:500-1:1000 dilution
- **General Use**: Apply 2-3 hours before sunset

## Key Principles

- Collect continuously every year for sustained results
- Maintain diversity -- collect from different environments and mix
- Include "tough guys" from high mountains or uncontaminated regions
- Never use plastic containers for culturing; use wood, bamboo, or clay

## Sources

- Cho, H.K. (2011). Dr. Cho's Global Natural Farming. SARRA.
- Cho, J.Y. Cho's Natural Farming: Recipes and Instructions for Use.
