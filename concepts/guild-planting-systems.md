...
Mollison emphasised that natural ecosystems never grow plants in
isolation; instead, species assemble into functional assemblages where
each member contributes something the others need. A guild mimics these
natural associations, creating resilient, low-maintenance productive
systems.
...
Every effective guild includes species that fill specific functional
niches. Understanding these roles allows designers to construct guilds
for any climate or purpose.
