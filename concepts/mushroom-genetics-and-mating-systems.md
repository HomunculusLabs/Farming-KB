---
title: Mushroom Genetics and Mating Systems — Cultivation Implications
created: 2026-04-16
updated: 2026-04-16
type: concept
...
Mitosis is the normal chromosome duplication process during cell division. All chromosomes are duplicated, line up, and one complete set is pulled to each end of the dividing cell. The result is two genetically identical daughter cells.

Meiosis occurs during sexual reproduction. Chromosomes are copied, but genes are shuffled through a process called recombination. The two sets of chromosomes (one from each parent) line up side by side, and reciprocal exchanges of chromosome sections take place. After two successive cell divisions, four cells are produced, each with ONE copy of each chromosome — and none are identical to any of the others. These cells are the basidiospores (in mushrooms) or ascospores (in cup fungi).

It is this recombination of genes within the genome and the combination of genomes from two parents that is the genius of sexual reproduction. Constant variation is introduced into the population, and the population is enriched in gene combinations better adapted to the environment. This contrasts sharply with asexual reproduction, where all offspring are identical and equally vulnerable to environmental change.
...
On the sparse plates, slower-growing monokaryons can be distinguished from faster-growing dikaryons. Pick approximately 25 dikaryons for fruiting ability testing. Monokaryotic cultures can be preserved for breeding programs if spores from multiple strains are available.
