...
## Selecting Plants for Hand Rubbing

Plants best suited to hand rubbing have sticky resin that
adheres to hands much better than it sticks to other foliage.
At the same time, the resin must be relatively easy to roll
into little balls to remove from hands.

Key guidelines for plant selection:
...
Understanding cervantes hand rubbed hash charas provides essential context for both practical application and deeper theoretical study in this domain.
