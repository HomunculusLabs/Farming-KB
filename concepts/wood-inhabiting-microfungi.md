---
title: Wood-Inhabiting Microfungi — Life Strategies and Inventory Methods
created: 2026-04-14
updated: 2026-04-14
type: concept
tags: [[mycology, fungi]
...
These numbers, from relatively limited sampling efforts, suggest that comprehensive inventories of wood-inhabiting microfungi would reveal far greater richness. The majority of these fungi are **saprobic**, obtaining nutrients from dead organic matter rather than from living hosts.

## Life Strategy Framework

Wood-inhabiting microfungi can be categorized using the **CSR (Competitor–Stress-tolerator–Ruderal) framework**, which describes their ecological strategies:

### Ruderal (R-selected)
- **Strategy**: Rapid colonization of newly available resources
- **Traits**: Fast growth rate, high reproductive output, short life cycles
...
- Washings are plated or filtered for examination
- Effective for recovering spores from leaf and woody litter surfaces
