...
contains the dermatophytes (skin-infecting fungi), systemic
dimorphic pathogens capable of causing life-threatening diseases
in humans and other vertebrates, and numerous keratinophilic
saprobes. The Onygenales, together with the Eurotiales, form the
Plectomycetes clade (also called Eurotiomycetes), which is
strongly supported by molecular phylogenetic analyses of nuclear
SSU rDNA, chitin synthetases, and RNA polymerase II.

## Classification and Families

The Onygenales contains several families of medical and
ecological importance:

- **Arthrodermataceae**: Contains the teleomorphic genera
  Arthroderma and their anamorphic states in Trichophyton,
  Microsporum, and Epidermophyton -- the dermatophytes that
  cause ringworm (tinea) infections of skin, hair, and nails
...
- **Gymnoascaceae**: Contains the genus Arachnomyces and
  ...
  fungi.
- **Myxotrichaceae**: Although traditionally placed in the
  Onygenales, molecular data suggest this family should be
  excluded from the order and placed among the Leotiales and
  Erysiphales.

## Dermatophytes

Dermatophytes are divided ecologically into three groups:
(1) anthropophilic species, specific to humans; (2) zoophilic
species, specific to nonhuman animals; and (3) geophilic species,
soil saprobes that grow mainly on keratinous debris but
occasionally cause infections. Zoophilic and geophilic
dermatophytes have access to large numbers of habitable sites
because they can colonize hair, feathers, and other dissociated
keratinous materials. Most zoophiles and geophiles are
distributed worldwide, but zoophilic species may be limited to
areas inhabited by particular types of animals.

A practical impediment to the study of pathogenic Arthroderma
species and related dermatophyte anamorphs is their strong
tendency to degenerate in pure culture, losing the ability to
form conidia and, in teleomorphic species, losing mating
competence.

## Systemic Dimorphic Pathogens

The systemic dimorphic pathogens of the Onygenales are among the
most virulent fungi known. These fungi cause disease by converting
