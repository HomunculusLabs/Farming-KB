...
- **Persistence**: Many pharmaceuticals are designed to be chemically stable and resistant to metabolic breakdown, which translates to environmental persistence
- **Low concentrations, high impact**: Even at ng/L to μg/L levels, pharmaceuticals can affect aquatic organisms (endocrine disruption, antibiotic resistance development)
- **Complex structures**: Many contain aromatic rings, halogen substituents, heterocyclic nitrogen, and other structural features that resist conventional biodegradation
- **Continuous input**: Unlike pesticide spills, pharmaceuticals enter the environment continuously through sewage systems

## Fungal Degradation of Drug Classes

### Antibiotics

Antibiotics in the environment contribute to the development and spread of antibiotic resistance genes. White rot fungi can degrade antibiotic compounds through their ligninolytic systems:

- **Sulfonamide antibiotics**: Degraded by laccase and peroxidase systems
- **Tetracyclines**: Phenolic structures make them susceptible to laccase oxidation
- **Macrolides**: Complex macrocyclic lactam rings can be attacked by peroxidase systems
- **Beta-lactams**: The beta-lactam ring may be opened by fungal enzymes
