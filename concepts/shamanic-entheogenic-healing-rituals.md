---
title: Shamanic Entheogenic Healing Rituals
concept_type: practice
source: metzner_r-hallucinogenic_drugs_in_psychotherapyshamanism.md
tags: [shamanic, healing, divination, entheogen, ceremony, indigenous, ritual, plant-teachers]
created: 2026-05-08
---
...
Shamanic divination through entheogens is the equivalent of Western
medical diagnosis, but encompasses a much broader scope of knowledge:

- **Illness diagnosis**: Determining the cause and origin of disease,
  including identifying sorcerers who may have caused harm.
- **Herbal knowledge**: Discovering which specific plants and herbs
  should be used to treat a particular illness.
- **Soul fragment location**: Determining where a lost soul fragment
  has gone and how to retrieve it.
- **Future guidance**: Receiving guidance about upcoming events,
  decisions, or community directions.

Indigenous healers consistently refer to entheogenic plants as "plant
teachers," recognizing that an intelligence associated with the medicine
communicates directly to the person who ingests it. This intelligence
provides information that could not be obtained through ordinary means.

## Ceremonial Forms Worldwide

### Mazatec Mushroom Ceremonies (Mexico)

Participants sit or lie in a very dark room with only a small candle. The
...
A small group sits in a circle in semidarkness while initiated healers sing
icaros — specific songs through which healing and diagnosis takes place. The
