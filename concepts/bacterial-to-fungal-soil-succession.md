---
title: Bacterial to Fungal Soil Succession
created: 2026-04-18
updated: 2026-04-18
type: concept
tags: [reference]
sources: [papers/elaine-ingham-phd_-the-field-guide-i-for-actively-aerated-com.md, papers/lowenfels-teaming-with-microbes.md]
---
...
The fungal-to-bacterial biomass ratio (F:B ratio) is a key indicator of soil ecological status:
- **Disturbed soils** (recently tilled, conventionally farmed): F:B ratio of 1:1 or less (bacterial-dominated)
- **Pasture and grassland soils**: F:B ratio of approximately 1:1 to 5:1
- **Shrub and savanna soils**: F:B ratio of approximately 5:1 to 10:1
- **Forest soils**: F:B ratio of 10:1 or more (fungal-dominated)
- **Old-growth forests**: F:B ratio can exceed 100:1

This ratio reflects the natural trajectory of ecosystem development. Disturbance (tillage, cultivation, fire, flooding) resets succession toward bacterial dominance. As disturbance decreases and perennial vegetation establishes, fungal biomass gradually increases.

## Why Bacteria Dominate Early Succession
...
The shift from bacterial to fungal dominance changes how nutrients cycle in soil:

**Bacterial-dominated nutrient cycling:**
- Rapid turnover -- nutrients cycle through bacterial biomass in hours to days
- Higher nitrogen availability in the form of nitrate
- Nutrients held in bacterial biomass are released quickly when bacteria are consumed
- Supports fast-growing, short-lived plants
- More susceptible to nutrient leaching due to rapid cycling
...
- Bare soil (without mulch or plant cover) heats up and dries out, stressing fungal networks

The degree of setback depends on the severity and frequency of disturbance. A single light tillage may only set succession back slightly, while repeated deep tillage with chemical inputs can maintain soils in a permanently bacterial-dominated state.

## Assessing Your Soil's Successional Stage

Gardeners can estimate the F:B ratio through several methods:
- **Visual assessment**: White fungal mycelium visible in compost, mulch, or soil indicates fungal activity. Dark, crumbly soil with visible hyphal threads suggests good fungal presence
