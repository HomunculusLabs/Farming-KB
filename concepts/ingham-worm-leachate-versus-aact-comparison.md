...
## Terminology: Castings vs. Vermicompost

Ingham provides precise definitions:

- **Worm castings** are technically the fecal pellets only — the actual "poops"
  from worms. If any non-fecal material is mixed in, the product is not pure
  castings.
...
designed to work reliably by maintaining specific biological standards.
...
- **Bag type**: Single-layer nylon bags need less compost than woven or
...
When worm castings are combined with wood chips nitrified with urea, the active
organisms in the castings rapidly immobilize nitrogen from the urea into
biomass, preventing leaching. This creates an effective combination where the
castings provide the biological workforce and the urea-wood chip mix provides
