---
title: "Soil Testing and Laboratory Analysis for Low-Input Gardens"
...
- "If you routinely garden with COF, there will never be any need to lime the garden separately"

## When Laboratory Testing Is Warranted

### Dry Climate Clay Soils

The primary situation where Solomon recommends professional soil analysis: "If you live in a dry climate providing under 30 inches (75 centimeters) of rainfall a year (where soils may already contain significant levels of calcium and sometimes excessive magnesium, too) and have clay to deal with, I suggest that you consult with a local soil-testing service or agricultural agency before adding any forms of lime in excess of the minimal amounts in COF."

The risk: arid-region clays may already be saturated with calcium and magnesium. Adding more lime could push magnesium to excessive levels, creating nutrient imbalances that lock out other essential elements.

### Gypsum vs. Lime Decision

In dry climates with clay soils, laboratory testing helps determine whether to use gypsum (calcium sulfate) instead of lime: "You might be advised to use gypsum instead of lime." Gypsum provides calcium without raising pH, making it the correct choice when calcium is needed but the soil is already alkaline or magnesium is excessive.

## Understanding Liming Materials
...
Solomon's COF recipe is the practical alternative to soil testing for most gardeners:

- 4 parts seed meal (cottonseed, canola, soy, or similar)
- 1 part agricultural lime (best finely ground)
- 1 part dolomite lime (best finely ground)
- 1 part gypsum (if omitted, double the agricultural lime)
- 1 part bone meal, rock phosphate, or high-phosphorus guano

All ingredients are mixed thoroughly and stored in a sealed container.

### Why COF Replaces Routine Testing

Solomon argues that COF eliminates the need for regular soil analysis because:
...
Solomon presents a graduated approach to soil improvement for gardeners with varying budgets:

1. **Minimum effort** — Spade up ground, keep weeds hoed, grow low-demand crops
2. **Basic improvement** — Add ¼" layer of steer manure or finished compost, plus lime
3. **Moderate investment** — Add ½" compost, chicken manure, lime, and COF
4. **Full program** — 1" compost, chicken manure, lime, and COF for all vegetables

### The Danger of Over-Amendment

A critical warning: "No matter how much organic matter you may have available, do not apply more than double the amount recommended or you'll risk unbalancing your soil's mineral content."

Solomon is particularly concerned about excessive compost: too much organic matter can cause nutritional dilution in vegetables, creating lush but nutrient-poor growth. His own garden uses genuine loam topsoil with minimal compost additions specifically to maximize the nutritional quality of his produce.

### Clay Soils: Special Considerations

"Chemically, clays act like discharged lead-acid batteries. They have capacity to soak up huge quantities of plant nutrients. Until they have been 'fully charged,' they tend to withhold nutrients from plants."

For clay soils, Solomon recommends applying about 1½ times the usual amount of COF for the first few years to saturate the clay's cation exchange capacity.

## The Role of Compost and Manure

### Compost as Nutrient Buffer

Compost plays a different role than COF in Solomon's system:

- Compost feeds soil microbes and improves soil structure
- It buffers nutrient availability and moisture retention
- It supplies trace elements and growth regulators
- It should NOT be relied upon as the primary nitrogen source for demanding crops

### Steer vs. Chicken Manure

Solomon distinguishes sharply between manure types:

- **Steer manure** (bagged, from supermarkets): Often contains semi-decomposed sawdust with little fertilizing value. "It does feed soil microbes and improves soil structure" but is not hugely overapplied.
- **Chicken manure**: "Far better stuff than weak steer manure for fertilizing the veggie patch." One product he used carried an NPK of 4-3-2 — comparable to COF itself.

## Foliar Feeding with Kelp

Solomon endorses foliar feeding with liquid kelp as a supplement to soil-based fertility:

- Spraying kelp solution on leaves delivers trace minerals and growth regulators directly
- More effective than mixing kelp meal into COF for micronutrient delivery
- Needs to be done regularly — foliar feeding is not a one-time event
- Gets the gardener walking among plants regularly, enabling early pest detection

## See Also

- [[solomon-seed-sprouting-conditions-laboratory-germination-technique]]
- [[solomon-complete-organic-fertilizer-cof-recipe]]
- Soil Improvement: Compost, Manure, and Lime
- Clay Soil Management and Preparation
- Watering Techniques and Drought Gardening
