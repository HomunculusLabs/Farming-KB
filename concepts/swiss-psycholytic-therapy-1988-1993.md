...
The Swiss program distinguished between two approaches:

**Psycholytic therapy** (low-to-medium doses):
- Explored the psychodynamic level of behavior
- Used lower doses that allowed patients to remain verbal and interactive
- Drew from psychoanalytic tradition
- Supported by sustained positive feelings among group session participants
