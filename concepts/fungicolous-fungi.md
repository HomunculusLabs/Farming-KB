...
The term "fungicolous" encompasses all fungi that grow on or within other fungi. This includes obligate parasites (mycoparasites), facultative parasites, saprotrophs that colonize dead fungal tissue, and species with complex interactions ranging from antagonism to commensalism. The phenomenon is widespread across all major fungal groups.

## Types of Fungicolous Interactions

### Mycoparasitism (Biotrophic)
...
- May be facultative, switching between fungal and non-fungal substrates
- Many common decomposers can grow on fungal remains

### Commensalism
- Grow on fungal structures without apparent benefit or harm to host
- May include endophytic fungi within fruiting bodies of other fungi
- Poorly understood and difficult to demonstrate
...
**Eurotiales**:
- *Aspergillus* and *Penicillium*: Many species can grow on fungal tissue, especially dead mushrooms

**Onygenales**:
- *Myxotrichum* species: Found on fungal fruiting bodies, especially on dung fungi
...
- *Tremella*: Many species are obligate parasites on other fungi, especially other basidiomycetes. T. mesenterica on *Stereum hirsutum*, T. fuciformis on *Annulohypoxylon*
- *Asterostroma* and *Sebacina*: Some mycoparasitic species

**Auriculariales**:
- Some *Exidia* species grow on other fungi

### Zygomycetes

**Zoopagales**:
- *Piptocephalis* and *Syncephalis*: Obligate parasites of Mucorales, found on dung
- *Helicocephalum* and *Rhopalomyces*: Predators that trap and digest other Zygomycetes

**Dimargaritales**:
- *Dimargaris* and *Dispira*: Parasites of Mucorales in dung habitats

### Hyphomycetes (Mitosporic Fungi)

- *Gongronella*: Parasitic on Mucorales
- Many common soil hyphomycetes are facultatively fungicolous
- Endophytic fungi within mushroom fruiting bodies

## Mechanisms of Interaction

### Physical Interactions
- **Hyphal coiling**: Trichoderma wraps around host hyphae
- **Penetration pegs**: Specialized structures for entering host cells
- **Haustoria**: Absorptive structures within host cells
- **Contact cells**: Modified appressoria that adhere to host surfaces
- **Trapping devices**: In predaceous fungi (nematode-trapping fungi are functionally analogous)
...
### Signaling
- Thigmotropic responses (growth toward host contact)
- Recognition of specific host molecules
- Quorum sensing in some mycoparasitic interactions
