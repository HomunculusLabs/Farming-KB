...
- The isolation was imperfect at best, meaning that pollen from multiple male plants could reach any given female
...
Each regional variety carried its own unique combination of the parent genetics, creating a diverse family of related strains that all shared the chaotic breeding origins but expressed those genetics in distinct ways.

## Growing Characteristics

Trainwreck inherits its growing style from the sativa side of its genetics, which means it requires careful management by indoor growers who want to keep their plants at a manageable size:

- **Height:** Moderately tall, with a pronounced tendency to stretch if not actively managed through training
- **Structure:** Gets leggy if left unchecked; can easily outgrow indoor spaces if the grower takes their eye off the ball for too long
- **Flowering time:** Approximately 9 weeks indoors — relatively short for a sativa-dominant strain
- **Outdoor harvest:** Around mid-October in the Northern Hemisphere
- **Yield:** Enormous — described as enough to keep a grower "in business for months"
- **Suitability:** Works well for both indoor and outdoor cultivation with proper management

The indica influence manifests primarily in the effects rather than the growth pattern, making Trainwreck an interesting case study in how sativa and indica genetics can express differently in various plant traits. The relatively short flowering time for a sativa-dominant is likely inherited from indica parentage somewhere in the train wreck genetic soup.
