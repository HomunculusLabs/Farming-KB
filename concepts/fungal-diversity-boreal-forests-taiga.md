...
- The boreal growing season compresses ECM fungal fruiting into a
  ...
  for access to host carbohydrate resources during this period.
- Early-season fruiters (Laccaria, Inocybe, Hebeloma) appear within
  weeks of soil thaw, while late-season Cortinarius and Tricholoma
  species dominate the autumn fruiting peak before hard frost
  terminates aboveground fungal activity entirely.
- This compressed phenology means that traditional mushroom surveys
  conducted at a single time point capture only a fraction of the
  total ECM diversity present in a boreal forest stand, biasing
  inventories toward species fruiting during the survey window and
  underestimating early and late-season taxa.

### Functional Roles in Nutrient Cycling
- ECM fungi in boreal forests are the primary agents of nitrogen
  mobilization from organic soil horizons, producing extracellular
  enzymes (proteases, oxidases) that break down complex organic
  nitrogen compounds in mor humus layers into forms accessible to
  host trees.
- In boreal systems where decomposition is slow and nutrient
  mineralization is limited by cold temperatures, the ECM pathway
  provides a shortcut that bypasses mineralization entirely —
  fungi deliver organic nitrogen directly to host roots rather
  than relying on bacterial decomposition to release mineral
  nitrogen into the soil solution.
- This direct organic nitrogen uptake pathway is estimated to supply
  the majority of tree nitrogen demand in boreal forests, making
  ECM fungal communities essential mediators of boreal forest
  productivity and carbon sequestration capacity.
...
- Fungi recovered from permafrost cores demonstrate remarkable longevity,
  with viable cultures obtained from soils frozen for 10,000-30,000 years
  or more, suggesting that certain fungal taxa can enter cryptobiotic
