...
infamous [[fungal-plant-pathogen-interactions]]ic fungus in history. Linked forever with the
Irish famine of the 1840s and the resulting diaspora that placed Irish
pubs in most towns in the [[hallucinogenic-plants-united-states]], this oomycete remains the most
...
human pythiosis, and like other [[oomycetes-water-molds]] it produces swimming
zoospores. These develop in sporangia that can be dispersed by wind. If
a sporangium drifts onto a wet leaf, the spores are expelled into the
film of water and charge over the waxy cuticle before forming a cyst. A
germ tube grows from the cyst, forms an [[fungal-appressorium-and-infection-structures]], and pierces
the epidermis with a penetration hypha.

Early in its infection, Phytophthora makes haustoria and feeds from the
potato plant without widespread destruction of tissues. But after a few
days, tissue damage is profound and the pathogen feeds on the
increasingly soupy remains of its dying host. Just five days after
entering the leaf, Phytophthora reemerges through open stomata and
releases its airborne sporangia from the tips of aerial hyphae. As
many as 300,000 sporangia can be launched each day from a single blotch
on a potato leaf.

## Tubers and Storage Rot

Washed from the leaves, the sporangia release their spores into the
soil to infect the buried tubers. Potatoes that appear healthy at the
time of harvest can rot in storage, a process accelerated by bacteria
that melt the starchy tissue into a slimy mess. Because the fungus does
not usually spread directly from the leaves down to the tubers, part of
the crop can be salvaged by removing the infected leaves and stems when
the blotches appear, a strategy unknown during the famine years.

## Modern Impact and Strain Diversity
...
[[herbarium-specimens-fungal-collections]] of potato leaves collected at the time of the
famine, researchers found that some other strain destroyed potatoes in
the 1840s. The current strain causing billions in annual losses is
different from the famine-era pathogen.

Plant breeders searching for resistant strains of potato are interested
in locating the pathogen's birthplace, reasoning that wild potatoes that
evolved alongside Phytophthora must have developed strong defenses.
Areas of extraordinary [[biodiversity-fungal-genetic-diversity]] are particularly fruitful
...
[[fungal-appressorium-and-infection-structures]] that generates turgor pressure to drive a penetration
peg through the cuticle.

Once inside, the fungus produces haustoria, specialized feeding
structures that invaginate host cells and extract nutrients without
immediately killing them. This biotrophic phase gives way to a
necrotrophic phase as the fungus kills host tissue and feeds on dead
remains. Phytophthora thrives under cool, moist conditions between 15
and 20 degrees Celsius, and modern forecasting systems use weather
data to predict blight risk and time fungicide applications.

## Lessons from the Famine

The Phytophthora catastrophe illustrates several enduring lessons. The
danger of monoculture and dependence on a single crop variety was
dramatically demonstrated. The importance of understanding plant
pathogens, even when their identity is contested, was established. And
the human cost of agricultural failure, compounded by political and
economic factors, remains a cautionary tale about food security that
resonates in modern discussions of crop diversity and [[fungal-pah-degradation-and-soil-bioremediation]]
