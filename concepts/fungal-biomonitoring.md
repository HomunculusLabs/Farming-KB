...
- **d13C for carbon source tracking**: Isotopic signatures distinguish fungi
  utilizing recent photosynthate (mycorrhizal) versus older soil carbon
...
- **Acid rain**: Combined acid deposition effects on
  ...
  multiple pollutant stresses

## Mycorrhizal Monitoring

Mycorrhizal community composition responds to soil pH changes, heavy metal
contamination, and forest management practices. Acidification shifts ECM
species composition, eliminating sensitive species while favoring
acid-tolerant taxa. Clear-cutting alters mycorrhizal community structure,
while climate change affects host-fungus phenological synchrony.

## Spore Monitoring

Airborne spore sampling using volumetric spore traps provides data on
seasonal fungal activity patterns, allergen exposure, pathogen spread
detection, and biosecurity. Spores of Alternaria, Cladosporium, Aspergillus,
and Penicillium dominate outdoor air spora and contribute to allergic
rhinitis, asthma, and hypersensitivity pneumonitis.

## Challenges and Limitations

Reliance on morphological identification of cultivable species systematically
underestimates fungal community complexity. Most environmental species are
refractory to cultivation, including biotrophs, many basidiomycetes, and
arbuscular endomycorrhizas. DNA-based techniques address these limitations,
though nucleic acid extraction bias remains a problem (Prosser, 2002).
