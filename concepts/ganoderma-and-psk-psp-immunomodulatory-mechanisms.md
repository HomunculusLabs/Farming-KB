---
title: Ganoderma and PSK PSP Immunomodulatory Mechanisms
...
## Ganoderma lucidum Immunomodulation

### Bioactive Compounds
Several major substances with potent immunomodulating action have been isolated from G. lucidum:
- **Polysaccharides** (particularly β-D-glucan)
- **Proteins** (e.g., Ling Zhi-8)
- **Triterpenoids**
- **Steroids**
- **Organic germanium**

### More Than 100 Polysaccharides
...
- Intercellular events after glucan-receptor binding have been determined

### Cytokine Production
Stimulation of immune effector cells results in production of:
- **Interferon (IFN)**
- **Interleukins (IL)**
...
- **Mitogenicity**: Induces cell division in immune cells
- **Macrophage activation**
- **NK cell activation**
- **T cell activation**

## PSK Immunomodulation

### No Effect Under Normal Conditions
"PSK has been shown to have no substantial effect on immune responses of the host under normal conditions."

### Immune Restoration
"It can restore the immune potential to the normal level after the host was depressed by tumour burden or anticancer chemotherapeutic agents." This is a critical property—PSK corrects immune suppression rather than overstimulating a normal immune system.

### Specific Immune Effects
1. **Antibody production restoration**: In ICR mice, antibody production against trinitrophenyl that had depressed immunity in Sarcoma 180-bearing mice can be restored
2. **CD4+ T-cell response**: Oral administration improves impaired antitumour CD4+ T-cell response in gut-associated lymphoid tissue
3. **Peripheral blood lymphocytes (PBLs)**: Enhances cytotoxic activity both in vivo and in vitro
4. **Tumour cell interaction**: May accelerate interaction of PBL with tumour cells (e.g., T24 human urinary bladder tumours)

### Local vs. Systemic Administration
"After intra-tumoural administration, PSK may come into close contact with tumour cells, whereupon local inflammatory responses occur and result in the non-specific killing of these abnormal cells."

"Local administration of PSK is more efficient than systemic use."

### Cytokine Gene Expression
"PSK induces gene expression of some cytokines such as TNF-α, IL-1, IL-8, and IL-6, in vivo and in vitro." These cytokines mediate multiple biological effects by direct stimulation of cytotoxic T cells.

## PSP Immunomodulation
...
PSP showed no direct cytotoxicity against:
- Peritoneal macrophages
- Five tumour cell lines (PU5, P338D1, JAR, B16 melanoma, S180 sarcoma)

### Cytokine Modulation
PSP stimulates cytokine production through gene expression and the production of immunomodulatory cytokines that mediate immunopotentiation in vivo.
...
- Combinations with **vitamin C** at 30-60 µg/ml + 200 µM vitamin C were as effective as Grifron-D alone at 480 µg/ml

### Mechanism: Oxidative Stress and Apoptosis
- Significantly elevated **lipid peroxidation** levels
- Positive **in situ hybridization** staining
...
3. **Cell-mediated immunity**: Helper T cells, T cell differentiation
4. **Alternative complement pathway**

## Comparative Immunomodulatory Profile

| Feature | G. lucidum | PSK | PSP | Grifron-D |
|---------|-----------|-----|-----|-----------|
| **Primary mechanism** | CR3 receptor binding | Immune restoration | Macrophage activation | Direct cytotoxicity |
| **Macrophage activation** | + | + | + | - |
| **NK cell activation** | + | + | + | - |
| **T cell activation** | + | + (CD4+) | + | - |
| **Cytokine induction** | IFN, IL, TNF-α | TNF-α, IL-1, IL-6, IL-8 | TNF, others | - |
| **Direct tumour cytotoxicity** | No | No | No | **Yes** |
| **Effect on normal immune** | Stimulates | **None** | Moderate | Unknown |
| **Immune restoration** | Yes | **Yes** (key feature) | Yes | N/A |
| **Administration route** | Oral/extract | Oral/IV | Oral | In vitro (research) |
| **Vitamin C synergy** | Unknown | Unknown | Unknown | **Yes** |
