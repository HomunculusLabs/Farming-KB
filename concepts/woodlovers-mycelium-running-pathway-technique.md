...
The most practical technique for mycelium running described in the source materials uses wet cardboard as a transfer medium:

### How It Works
1. An established outdoor bed is covered with wet cardboard and plastic
2. Over weeks and months, the mycelium colonizes the cardboard from below
3. The colonized cardboard becomes a portable inoculum
4. Place colonized cardboard at the bottom of a new bed location
...
2. The established mycelium will colonize the fresh chips from the edges
3. By autumn, the expanded area may produce mushrooms
4. Repeat annually to create progressively larger fruiting areas

## The Contaminated Spawn Salvage Pathway
...
## Watering and Running Interaction

The relationship between watering and mycelium running is nuanced:
