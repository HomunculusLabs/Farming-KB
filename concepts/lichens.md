...
updated: 2026-04-12
type: concept
tags: [fungi, biology, ecology, symbiosis, academia, plants]
sources: []
---
...
A lichen is not a single organism — it is a stable, self-supporting association between:

1. **Mycobiont**: The fungal partner (usually an ascomycete; ~98% of lichen fungi are ascomycetes, ~2% basidiomycetes)
2. **Photobiont**: The photosynthetic partner:
   - **Green algae** (Trebouxia, Coccomyxa, Dictyochloropsis): Most common. Provides sugars via photosynthesis
   - **Cyanobacteria** (Nostoc, Calothrix): Provides both sugars (photosynthesis) and fixed nitrogen. Found in ~10% of lichens
   - Some lichens have both green algae and cyanobacteria (tripartite associations)
3. **Microbiome**: Recent research reveals a complex community of bacteria and other microorganisms living within the lichen thallus, contributing to its function

The traditional view of lichens as "mutualism" (both partners benefit) has been refined. The relationship may be better described as **controlled parasitism** — the fungus cultivates the photobiont like a farmer cultivates a crop, harvesting photosynthates while providing shelter and mineral access.

## Lichen Growth Forms

### Crustose (Crust-Like)

- Grow tightly appressed to the substrate surface
- Cannot be removed without damaging the substrate
- Often appear as colored patches or stains on rock or bark
- Examples: Caloplaca (orange rock lichen), Lecanora (gray crust on bark)
- Among the slowest-growing organisms (0.1-5 mm per year)
- Often pioneer species on bare rock

### Foliose (Leaf-Like)

- Flat, leaf-like structures with distinct upper and lower surfaces
...
- Small, scale-like structures that can be lifted at the edges
- Often have a crustose base with squamule projections
- Examples: Cladonia squamules, Psora

### Gelatinous

- Soft, jelly-like consistency when wet; crisp and dark when dry
- Typically contain cyanobacteria as the photobiont
- Examples: Collema, Leptogium

## Lichen Anatomy

### Internal Structure (Foliose Lichens)
...
- **Soredia**: Powdery granules of algal cells wrapped in fungal hyphae. Asexual dispersal units. Formed in soralia (breaks in the cortex)
- **Isidia**: Coral-like outgrowths containing both fungal and algal tissue. Can break off for vegetative propagation
- **Apothecia**: Cup-like fruiting bodies of the fungal partner. Produce sexual spores (ascospores) — the fungus must re-associate with a photobiont after dispersal
- **Cyphellae**: Small pores on the lower surface of some foliose lichens for gas exchange
...
- **Reindeer/caribou**: Cladonia (reindeer moss) is the primary winter food for caribou in arctic tundra. Constitutes up to 90% of winter diet
- **Invertebrates**: Lichens provide food, shelter, and nesting material for mites, insects, and spiders
- **Birds**: Many birds use lichens in nest construction (camouflage). Ruby-throated hummingbird uses Usnea to build nests
- **Mammals**: Squirrels, deer, and primates have been observed eating lichens

### Air Quality Indicators

Lichens are among the most sensitive biological indicators of air quality:
...
Lichens produce a remarkable diversity of secondary compounds (over 1,000 described), many unique to lichens:

- **Usnic acid**: Antibacterial, antifungal, anti-inflammatory. Found in Usnea. Used in traditional medicine and commercial products (toothpaste, deodorant)
- **Atranorin**: UV-protective pigment. Most common lichen acid
- **Parietin**: Orange pigment in Xanthoria. Protects against UV radiation
- **Physodic acid**: Antibacterial, antioxidant. Found in Hypogymnia
- **Vulpinic acid**: Yellow, toxic pigment. Deters herbivory. Found in Letharia (wolf lichen)
