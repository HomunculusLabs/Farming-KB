...
Telephone helplines and poison control centres serve as important indicators of acute harm related to substance use and provide critical data for monitoring emerging drug trends. Data from drug helplines and poison information centres across Europe offer insight into the frequency and nature of adverse reactions to hallucinogenic mushrooms, as well as the clinical approaches used to manage mushroom related emergencies.

## FESAT Drug Helpline Network

The European Foundation of Drug Helplines (FESAT) collects information biannually from drug telephone helplines across Europe. According to the most recent FESAT reports at the time of the EMCDDA study, data were collected from 26 drug telephone help lines operating in 16 European countries.
