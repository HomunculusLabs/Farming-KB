---
title: Ale vs Lager Fermentation
created: 2026-04-17
updated: 2026-04-17
type: concept
...
- Faster fermentation, typically completing primary fermentation in 3-7 days
- Produces a wide range of flavor compounds (esters, phenols, higher alcohols) at warmer temperatures
- More tolerant of higher alcohol levels
...
- Slower fermentation, typically 1-3 weeks for primary fermentation
- Cleaner flavor profile with fewer esters and phenols at proper temperatures
- Produces sulfur compounds (especially during early fermentation) that dissipate with conditioning
- Requires cold conditioning (lagering) for proper flavor development
- More sensitive to temperature fluctuations than ale yeast
- Metabolizes certain sugars that ale yeast cannot (particularly melibiose)

The term "lager" comes from the German lagern, meaning "to store." The cold conditioning period that defines lager beer typically lasts 4-12 weeks at temperatures near freezing. During this time, the beer undergoes several beneficial changes:

- Residual yeast reabsorbs certain off-flavors (diacetyl, acetaldehyde)
- Flavor compounds meld and smooth out
- The beer clarifies as yeast and proteins settle
- A clean, crisp character develops

## Fermentation Temperature Effects

Temperature is the single most important variable in determining the flavor character of a beer. The same yeast strain can produce dramatically different results at different temperatures:

- Low-end of ale range (60-65 degrees F): Cleaner flavor, lower ester production
- Mid ale range (65-70 degrees F): Balanced ester and phenol production
- High ale range (70-75 degrees F and above): Increased ester and fusel alcohol production, potentially solventy
- Lager range (45-55 degrees F): Clean fermentation, minimal ester production
- Below 45 degrees F: Fermentation slows dramatically or stalls
...
A hybrid style fermented with ale yeast at cool temperatures (60-65 degrees F), then cold-conditioned like a lager. The result is a clean, delicate beer with subtle fruitiness.

### Altbier

German altbier is fermented with ale yeast at cool temperatures (58-65 degrees F), then cold-conditioned for several weeks. The name "alt" means "old," referring to the traditional ale fermentation method.

### California Common (Steam Beer)

Fermented with a lager yeast strain at warmer ale temperatures (58-65 degrees F). This style originated in 19th-century California, where refrigeration was unavailable but lager yeast was used because of the German immigrant influence.

### Belgian Strong Ales

Fermented with specialized Belgian ale yeast at temperatures that can exceed 75 degrees F. These yeasts produce complex spicy, fruity, and sometimes solventy character at high temperatures but remain drinkable due to the high alcohol content and malt backbone.
