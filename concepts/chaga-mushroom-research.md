---
title: Chaga Mushroom — Research Summary
created: 2026-04-13
updated: 2026-04-13
type: concept
tags: [medicinal-mushroom, antioxidant, anti-inflammatory, betulin, betulinic-acid, melanin, superoxide-dismutase, cancer, traditional-medicine]
sources: [raw/particles/cancer-treatments-medicinal-mushrooms.md]
---

## Inonotus obliquus (Chaga) — Research Summary

Chaga (Inonotus obliquus) is a sterile conk (sclerotium) that grows on birch trees (Betula spp.) [[query-how-do-i-grow-figs-in-cold-climates]] across the Northern Hemisphere — Siberia, Scandinavia, Canada, and northern parts of the United States and Japan. Unlike other [[cancer-medicinal-mushrooms-extraction-bioavailability]], the commercially used part is not the fruiting body but a dense mass of mycelium and wood that has been infected and transformed by the fungus over years or decades.

### Active Compounds

**Betulin and betulinic acid**:
- Derived from the birch tree host (not synthesized by the fungus itself)
- Betulin is the triterpene that gives birch bark its white color
- Chaga converts betulin to betulinic acid through enzymatic modification
- Betulinic acid has demonstrated anti-tumor, anti-inflammatory, and antiviral properties in vitro
...
**Anti-tumor**:
- Betulinic acid induces apoptosis (programmed cell death) in cancer cells in vitro through mitochondrial pathway activation
- Shows selectivity — toxic to cancer cells while relatively sparing normal cells
- Beta-glucans provide immune-mediated anti-tumor activity
- Anti-angiogenic effects demonstrated in vitro
- Inonotus obliquus extracts showed tumor growth inhibition in animal models

**Anti-inflammatory**:
- Reduces pro-inflammatory cytokines (TNF-alpha, IL-6, IL-1beta)
- Inhibits COX-2 and iNOS expression
- Reduces nitric oxide production in activated macrophages

**Immunomodulation**:
- Activates macrophages and NK cells
- Enhances overall immune competence

**Anti-diabetic**:
- Reduces blood glucose in animal models of diabetes
- Improves insulin sensitivity

**Gastroprotective**:
- Protects gastric mucosa against ulcer formation in animal studies
...
Used extensively in Siberian, Russian, and Scandinavian folk medicine for centuries. Referred to as the "King of Mushrooms" in Russian herbalism. Traditionally used as a tea or decoction for: cancer, stomach disorders, tuberculosis, liver problems, fatigue, and general vitality. The use is so deeply embedded in Siberian culture that chaga tea was one of the few non-alcoholic beverages available in many remote communities.
