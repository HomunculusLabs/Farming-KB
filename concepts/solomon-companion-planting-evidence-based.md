...
This is fundamentally different from companion planting, where the
legume is actively growing alongside other crops and hoarding its fixed
nitrogen for its own use. In a green manure scenario, the legume's
entire biomass is returned to the soil.
