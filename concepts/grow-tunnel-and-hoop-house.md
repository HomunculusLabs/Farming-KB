...
Larger, walk-in structures:

- **Height:** 6-12 feet at the peak, 4-6 feet at the sidewalls
- **Width:** 12-30 feet
- **Length:** 20-100+ feet
...
- **Hoops:** 9-gauge galvanized wire (cut to 60-72 inch lengths) or 1/2 inch PVC pipe
- **Cover:** Spun-bonded row cover (0.5-2.0 oz/sq yd weight) or 3-4 mil poly film
- **Anchor:** Earth staples (U-shaped wire pins), sandbags, or soil
...
5. **Ventilation:** For row cover fabric, ventilation is generally not needed (the fabric breathes). For poly film, lift or roll up the sides on warm days. (see [[greenhouse-growing-guide]]).
...
- **Galvanized steel tubing:** The industry standard. Available in swaged (slip-fit) or straight tubing with connectors. 1-3/8 to 2-3/8 inch diameter. Rust-resistant, strong, long-lasting.
- **PVC pipe:** Budget option. 1-2 inch schedule 40 or schedule 80 PVC. Less strong than steel; may collapse under heavy snow. Requires closer hoop spacing (4 feet vs 6 feet for steel).
- **Wood:** Can be used for the baseboard, end walls, and ridge beam, with metal or PVC for the hoops. More labor but uses natural materials.

### Foundation and Anchoring

- **Ground posts:** Drive 2-3 foot lengths of pipe or treated posts into the ground at each hoop location. The hoops attach to the tops of these posts.
- **Baseboard:** A horizontal beam (2x6 or 2x8 treated lumber, or steel channel) attached to the ground posts at ground level. Provides a surface to attach the plastic cover.
- **Sidewall height:** Taller sidewalls (5-6 feet) allow more growing space and better airflow. Shorter sidewalls (3-4 feet) reduce material cost and heat loss.

### Hoop Spacing and Configuration

- **Spacing:** 4-6 feet between hoops (closer for PVC, wider for steel)
- **Bows:** Each hoop is a bow (arch) made from one or two pieces of tubing bent into a semicircle
- **Ridge pipe:** A pipe running along the peak of the hoops, connected to each hoop with purlin clips. Adds lateral stability.
- **Purlins:** Horizontal pipes connecting the hoops at the sidewall height. Also add stability.
- **End walls:** Framed with wood or metal, with a door and ventilation opening. End walls can be solid or have roll-up sides.

### Covering

- **Polyethylene film:** 6-mil, UV-stabilized greenhouse film. Available in clear, diffuse, and infrared-blocking formulations.
- **Diffuse film:** Scatters light, reducing shadows and providing more even light distribution to plants. Recommended for most crops.
- **Infrared (IR) film:** Reduces heat loss at night by reflecting infrared radiation back into the tunnel.
- **Installation:** Attach to the baseboard with poly lock channel (a metal or plastic channel with a spring-loaded wire that grips the film). Pull the film tight over the hoops, attach at the ridge, and secure on both sides.

### Ventilation

Adequate ventilation is critical — high tunnels can overheat rapidly on sunny days:

- **Roll-up sides:** Hand-crank or motorized roll-up mechanisms on both sidewalls. Open to 50-100% on warm days.
- **End wall doors:** Large doors at both ends provide cross-ventilation. Leave both ends open on hot days.
- **Ridge vents:** A continuous opening along the peak allows hot air to escape (more common in commercial greenhouses than simple hoop houses).
- **Shade cloth:** In summer, install 30-50% shade cloth over the poly film to reduce heat stress.
...
- Grow heat-loving crops (tomatoes, peppers, eggplant, cucumbers, melons)
- Ventilate aggressively — remove end walls or switch to shade cloth
- Consider removing the plastic entirely in very hot climates
