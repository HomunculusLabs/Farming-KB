...
Sclerotia (singular: sclerotium) are compact, hardened aggregations of fungal mycelium that serve as long-term survival structures. They are formed by certain fungal species as a response to environmental stress or as part of their normal life cycle. Key characteristics:
...
The guide specifies that jars intended for sclerotia production "should be put in a clean (preferably dark) location." The preference for darkness is significant:
