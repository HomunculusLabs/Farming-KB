---
title: On-Farm Alcohol Fuel Production from Cellulose
...
Simple amylase columns (pipes filled with amylase culture on glass beads or quartzite pebbles) convert cellulose wastes to glucose, which is then fermented to alcohol. A grinder converts garbage and straw to fuel with no great difficulty.

### The Closed Solar Cycle
When housed in a greenhouse:
- **By-products**: Heat and CO₂ (for plant growth), mulch, and food
- **No critical materials are lost**
- Products not directly utilized recycle via animal feed (pig, worm, fish) to plant food
- This closes a solar cycle that can fuel every tractor or motorbike needed for essential use

"The technology is simple, well-known and widespread. Only very simple tools are needed (mainly tanks)."

## Yield Figures

Dr. Dick McCann (Dept. of Chemical Engineering, University of Sydney) provides yield estimates:

| Crop | Yield (litres/hectare/year) | Gallons/acre/year |
|------|-----|-----|
| Sugar beet | 5,000–8,000 | 458–720 |
| Wheat | ~500 | ~45 |

Sugar cane and sugar beet have the advantage of direct ferment to alcohol. Grains, wastes, and cellulose must go through preliminary processes (sprouting, boiling, grinding, enzyme activity) to produce glucose or sucrose before fermenting.
...
### High-Yield Annuals
- Sugar beet (5,000–8,000 l/ha)
- Sugar cane

### Tree Crops (Long-Term)
- **Carob**: Beans are 68% sugars; invaluable for fuel forests needing collection rather than annual cultivation
...
### Environmental
- Elimination of insidious lead pollution from car exhausts
- The heat budget of the planet is not adversely affected
- Threat of climatic change from burning fossil fuels and felling forests is avoided
