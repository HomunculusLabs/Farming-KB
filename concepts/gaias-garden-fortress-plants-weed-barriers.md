...
that requires no herbicides and minimal hand weeding.

## Design Considerations

- Place fortress plants at the edges of garden beds, along property
  boundaries, and between different planting zones
- Consider mature size when spacing fortress plants; overcrowding defeats
  the purpose
- Use a mix of species rather than a monoculture for better resilience
- Remember that fortress plants can also block desired plants; plan for
