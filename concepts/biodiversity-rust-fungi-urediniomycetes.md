...
Collection of rust fungi presents unique challenges because the fungi
cannot be cultured axenically away from their hosts. Specimens should
be collected with host material and pressed in standard plant presses.
Voucher specimens should include the infected plant portion with both
the rust structures and identifiable host features. Herbarium specimens
of rust fungi serve as irreplaceable records of geographic distribution,
host associations, and morphological variation.

For canopy-level sampling of rust fungi on tree hosts, specialized
access methods are required including ropes and pulleys, spiked foot
griffes (climbing irons), and even trained monkeys in some tropical
research programs. Shotgun collection of branches from tall trees has
also been employed, though this method risks damage to both the
collector and the specimens.
...
identification. The arrangement and morphology of paraphyses within
sori provide additional diagnostic features. Modern identification
increasingly incorporates molecular markers, particularly ITS region
sequences, which can be used even from herbarium specimens.
