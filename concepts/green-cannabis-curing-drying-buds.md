...
Before curing can begin, the plant must be harvested at the right time.
Greg Green identifies several indicators that signal harvest readiness:

- 50% to 70% of the pistils have changed color.
- The plant stops producing crystals (trichomes).
- The plant stops producing resin.
- Fan leaves and lower leaves have turned yellow and are starting to
  drop off.
- The smell has reached a peak.
- Bud mass has not increased in the past few days.

These indicators do not appear on every strain, so growers should also
consult the breeder's recommended flowering times. Once a grower learns
to identify a mature bud, they can judge other plants and strains by
visual inspection regardless of posted flowering times.

## Drying: Indica Harvest

The drying process for Indica plants follows these steps:
...
5. Every day, open the lid for several hours (six hours is recommended)
   to allow fresh air exchange, then close the lid again.
...
- It permits the slow conversion of non-psychoactive cannabinoid acids
