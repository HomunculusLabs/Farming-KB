...
- The beta-glucan binding site of CR3 has been mapped to a region of CD11b at the C-terminus of the I-domain
- The ligand-receptor complex is internalised, initiating intracellular signalling cascades including NF-kappa-B activation
...
Both are T-cell oriented immunopotentiators requiring a functional T cell component:
- Anti-tumour activity was abolished in neonatally thymectomised mice
- Activity was eliminated when T cells were suppressed with cyclosporin A
- Both act as unique DT-cell-oriented assistants where macrophages also play a role
- Neither demonstrated anti-tumour activity without immunocompetent T cell compartments

### T-Cell Activation Pathways
Mushroom glucans enhance T-cell mediated immunity through:
- **Helper T cell production**: Increased numbers of CD4+ helper T cells
- **Cytotoxic T cell activation**: Increased ratio of activated T cells and cytotoxic T cells in the spleen
- **Suppressor T cell inhibition**: Reduction of suppressor T cell activity that would otherwise dampen anti-tumour responses
- **LAK cell activation**: Interleukin-2-mediated lymphokine-activated killer cell activity

## Macrophage Activation

Macrophages are central effectors of mushroom-mediated antitumour immunity:

### Activation Products
- **Cytokines**: IL-1beta, IL-6, TNF-alpha, IFN-gamma production
- **Nitric oxide**: Released as a cytotoxic mediator
- **MHC class II upregulation**: Enhanced antigen-presenting capacity (demonstrated with Ganoderan and GLB from Reishi)
...
- Macrophage responses are associated with anti-proliferation and induction of apoptosis in HL-60 and U937 leukemic cells
- Colony stimulating factors (CSFs) and IL-3 production correlates with macrophage IL-1-producing activities
...
Mushroom polysaccharides modulate a broad cytokine network:

### Pro-inflammatory Cytokines
- **IL-1** (alpha and beta): Produced by activated macrophages, acts on lymphocytes, hepatocytes, and vascular endothelial cells
- **TNF-alpha**: Tumour necrosis factor with direct anti-proliferative effects
- **IL-6**: Involved in immune activation and acute phase responses
- **IFN-gamma**: Interferon-gamma with antiviral and immunoregulatory functions

### Interleukins
- **IL-2**: Produced by T cells; mediates LAK cell activation and cytotoxic T cell function
- **IL-3**: Colony-stimulating factor for haematopoietic cells
- **IL-10**: Anti-inflammatory cytokine also induced, suggesting immunoregulatory balance

### Gene Expression
Schizophyllan induces gene expression of cytokines differently in peritoneal exudate cells, splenocytes, and hepatocytes. Protein synthesis and gene expression of cytokines are regulated separately, indicating complex regulation of antitumour immune responses.
