...
- Complexation with nitrogen- and oxygen-containing ligands
- Electrostatic attraction to negatively charged cell surfaces
- Precipitation as metal oxides or sulfides
...
Fungi can alter the oxidation state of metals, changing their toxicity and mobility:
- Mercury methylation/demethylation
- Chromium(VI) reduction to less toxic Chromium(III)
- Arsenic speciation changes
...
Fungal-augmented constructed wetlands combine mycofiltration with plant uptake for passive, long-term treatment of metal-contaminated water.

## Limitations and Challenges

### Contaminated Biomass Disposal
Fungi that accumulate metals become hazardous waste themselves. Options include:
- Thermal treatment (ash contains concentrated metals for recovery)
- Chemical extraction of metals from biomass
- Secure landfill disposal

### Metal-Specific Constraints
- Mercury is particularly challenging due to volatilization risks
- Arsenic mobility depends strongly on redox conditions
- Mixed contamination (metals + organics) may require sequential treatment
...
### Scale and Economics
- Laboratory results often overestimate field performance
- Inoculation success in field soils is variable
- Long-term monitoring is essential but expensive
- Regulatory frameworks for fungal remediation are still developing
...
- [[mycofiltration-of-water]] -- water filtration using fungal mycelium
- [[mycoremediation-of-oil-spills]] -- fungal degradation of organic pollutants
- [[biochar-and-fungi]] -- combining biochar with fungal remediation
