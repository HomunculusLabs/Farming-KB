...
**Pyrene** (4 rings) is degraded through initial hydroxylation at the 1-position by cytochrome P450 to form 1-hydroxypyrene. Subsequent steps yield 1,6- and 1,8-dihydroxypyrene, with further ring oxidation products. Pyrene is more recalcitrant than lower-ring PAHs due to its stable aromatic structure and low water solubility.
