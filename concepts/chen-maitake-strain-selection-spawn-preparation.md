...
## Strain Characteristics and Testing

Each strain has a distinct genotype and phenotype (observable features)
but remains compatible in mating. Considerable differences exist among
strains in:
...
The paper provides several strategies to accelerate the prolonged spawn
run characteristic of maitake:

1. Select a vigorous, fast-growing fruiting strain.
2. Use the highest optimal temperature during spawn run (20 to 25
   degrees C).
3. Use generous, high-quality inoculum distributed throughout the
  substrate (rate of 1:10 or 1:20 spawn to substrate).
4. Use large-bore bags with ample headspace for oxygen.
