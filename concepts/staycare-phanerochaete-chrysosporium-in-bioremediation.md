...
- **Classification**: Basidiomycota, Corticiaceae
...
- **Presence in ALL white rot species**: MnP is more universally distributed than LiP among white rot fungi
- **Mechanism**: Converts Mn²⁺ → Mn³⁺; Mn³⁺ is a strong, diffusible oxidant
- **Role**: Essential for lignin degradation in vivo; Mn³⁺ oxidizes phenolic lignin units, and lipid peroxidation initiated by MnP can attack non-phenolic structures
- **Induction/repression**: Mn²⁺ presence induces MnP production and represses LiP production in P. chrysosporium (Reddy & D'Souza, 1994)

### H₂O₂ Sources

- **Glucose oxidase**: Oxidizes glucose to gluconic acid + H₂O₂
- **Glyoxal oxidase**: Oxidizes glyoxal and related aldehydes to oxalic acid + H₂O₂ (Kersten & Kirk, 1987)
- **Aryl alcohol oxidase**: Present in many white rot fungi (Gutierrez et al., 1994)

## Pollutant Degradation Capabilities

### Polycyclic Aromatic Hydrocarbons (PAHs)

P. chrysosporium degrades multiple PAHs through its ligninolytic system:

- **Anthracene**: Anthracene → 9,10-anthraquinone → phthalic acid → protocatechuic acid → CO₂
- **Phenanthrene**: Multiple pathways — ligninolytic (peroxidase-mediated) and non-ligninolytic (cytochrome P450)
- **Pyrene**: Degraded through quinone intermediates
- **Benzo[a]pyrene**: Oxidized to quinone derivatives

### Chlorinated Compounds

- **PCBs**: Degraded Aroclor 1242 in nitrogen-deficient cultures (Bumpus et al., 1987); also degraded Aroclor 1254, 1260 and mixtures (Yadav et al., 1995). Prefers lesser-chlorinated congeners.
- **2,4,5-T**: Degraded in both liquid culture and contaminated soil with corn cob supplement (Ryan & Bumpus, 1989)
- **2,4-D**: Degraded alone and in mixtures with 2,4,5-T (Yadav & Reddy, 1993)

### Nitroaromatics

- **TNT**: Degrades 30-50% at concentrations <20 mg/L; metabolites (not TNT itself) inhibit LiP production; MnP appears after TNT disappearance, suggesting TNT inhibits MnP production initially
...
- Effective at decolorizing various dyes, though Orange II is inhibitory at relatively low concentrations
- Static cultures often give better decolorization than agitated cultures (Kim, Ryu & Shin, 1996)
- LiP isoenzymes show different pH optima for different dyes (Ollika et al., 1993)

## Limitations

1. **Nitrogen requirement**: The need for nitrogen limitation complicates treatment of nitrogen-rich waste streams
2. **Low laccase production**: Limits applicability for processes relying on laccase-mediated degradation
3. **Culture sensitivity**: Agitation decreases ligninase activity due to shear forces/air-liquid interface inactivation (detergents like Tween 80 can alleviate this)
4. **Low pH**: Optimal activity at very low pH (2-5) may be impractical for some applications
5. **Bioavailability**: Cannot directly access sorbed pollutants in soil without physical contact via hyphal growth
6. **Field performance**: Laboratory strains often fail in field conditions due to competition, predation, and environmental variability

## Comparison with Other White Rot Fungi

| Feature | P. chrysosporium | T. versicolor | B. adusta | P. ostreatus |
|---------|------------------|---------------|-----------|--------------|
| LiP production | Yes | Variable | Yes | No |
| MnP production | Yes | Yes | Yes | Yes |
| Laccase production | Rare | Strong | Moderate | Strong |
| N-limitation needed | Yes | No | No | No |
| Temp optimum | 37-40°C | 27-30°C | 27-30°C | 27-30°C |
...
- Bumpus, J.A. et al. (1987). Biodegradation of Aroclor 1242 by Phanerochaete chrysosporium.
- Cullen, D. (1997). Recent advances on the molecular genetics of ligninolytic fungi.
- Hammel, K.E. et al. (1993). Oxidation of lignin by purified isozyme of P. chrysosporium.
- Kirk, T.K. et al. (1978). Effects of culture parameters on lignin metabolism.
- Pérez, J. & Jeffries, T.W. (1992). Roles of manganese and organic acid chelators.
- Reddy, C.A. & D'Souza, T.M. (1994). Physiology and molecular biology of the lignin peroxidases.
- Stewart, P. et al. (1992). Lignin peroxidase gene family in P. chrysosporium.
- Tien, M. & Kirk, T.K. (1983). Lignin-degrading enzyme from Phanerochaete chrysosporium.
