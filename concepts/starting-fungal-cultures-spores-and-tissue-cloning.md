...
- Metal transfer tool (scalpel or inoculation loop)
- Alcohol lamp
- Tape or Parafilm
- Ziplock bags
...
**Step 1: Organize the work area.** Wearing alcohol-wiped gloves, transfer all materials to the culturing space. Place agar plates at the inside edge of the hood work space against the filter face, where air is most sterile. Arrange equipment from sterile (near filter) to sanitized (middle) to not sterile (closest to you). Keep the spore print just outside or near the laminar hood, stepping back to reach it.

**Step 2: Sterilize the transfer tool.** Hold the inoculation loop, scalpel, or wire in the alcohol lamp flame until the tip glows red. Remove from flame, lift a petri plate lid about an inch, and dip the hot tip into the agar several times until it stops popping from heat and is cool. Close the lid. The tool now carries wet agar on its tip, which helps transfer spores.

**Step 3: Collect spores.** Scrape the spore print with the tool tip; spores will stick to the wet agar residue.

**Step 4: Streak the plate.** Lift the petri plate lid at an angle and drag the tool tip through the agar in a wide Z pattern. Close the lid. Minimizing lid-off time is critical -- the entire operation should take no longer than three seconds.

**Step 5: Seal the plate.** Wrap the seam with tape or Parafilm to keep the lid in place and prevent contamination.
...
### Understanding Sectoring

Streaking keeps spores in a tight line, helping them find suitable mating partners nearby. The technique also reveals different strains or ecotypes of the same mushroom as they "sector" -- separate from the pack. These sectors can look very different from the main culture, with the healthiest and most efficient strains surging outward much faster than inferior strains that may have mated but never developed affinity for the agar medium. Sectoring is a powerful tool for strain selection.

## Tissue Culturing: Cloning Mushrooms

Tissue culturing is essential when encountering a mushroom growing on a peculiar substrate, or one that is exceptionally large, ecologically unique, or otherwise warrants cultivation. Every mushroom presents unique cloning challenges -- the best tissue source area and optimal agar formula vary by species.

### Taking a Tissue Sample

A mushroom is essentially a dense bundle of mycelial tissue that has taken shape and color according to its species and growing conditions. To clone, the mushroom must be cut or peeled to reveal clean inner tissue, from which a small fragment is removed and transferred to an agar plate. The key challenge is accessing tissue that is uncontaminated by environmental microorganisms.

The interior tissue of the cap or stem, away from gills, pores, and outer surfaces, generally provides the cleanest sample. The outer surfaces are exposed to environmental spores, bacteria, and contaminants. Working quickly and using sterile technique minimizes contamination risk. The tissue fragment is placed on the agar plate, sealed, labeled, and incubated.

### Advantages of Cloning

- Produces genetically identical copies of the parent mushroom
- Preserves specific traits (flavor, size, growth rate, substrate preference)
- Faster than growing from spores -- no mating or germination phase needed
- The mushroom has already proven it can fruit in its environment
- Building a strain library from wild collections across different climates and substrates creates a versatile genetic resource

### Combining Methods

Experienced cultivators use both methods in tandem. When encountering a promising mushroom in the field, they take both a spore print (for genetic diversity and backup) and a tissue sample (for immediate genetic preservation). The spore print serves as insurance -- if the clone fails or becomes contaminated, the spores provide another opportunity to recover the strain. Over time, combining selective spore germination with strategic cloning builds a comprehensive culture collection representing the genetic breadth and specific adaptations of target species.
