...
mushrooms should be avoided as it can cause damage to delicate pins and promote
contamination. A fine fog introduced into the air space above the cropping
surface is preferred.

### Temperature

Temperature requirements for fruiting vary by species. Most oyster mushroom
species fruit optimally between 15 and 22 degrees Celsius, though some tropical
species require warmer conditions. A temperature drop of 3 to 5 degrees from
the colonization temperature is a common fruiting trigger, mimicking the
seasonal cooling that signals fruiting in nature.
