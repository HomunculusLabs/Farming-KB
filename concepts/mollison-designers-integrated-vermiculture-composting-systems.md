...
Key species for vermiculture include:
  ...
  - Perionyx excavatus (Indian Blue / Spenceri): Tropical composting
    worm, more heat-tolerant but less cold-hardy than Eisenia species
  - Lumbricus rubellus (European Nightcrawler): Larger worm suited
...
Worm bins can range from small-scale indoor systems to large outdoor
beds processing kilograms of organic waste daily. Design principles:

  - Shallow depth: Worm bins should be 30-50 cm deep, as composting
    worms are surface feeders and will not inhabit deep layers
  - Drainage: Bins must have drainage holes or a drainage layer to
