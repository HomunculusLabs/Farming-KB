...
Bees produce several valuable and unique products: honey, wax, pollen, propolis,
...
information, see [[bee-forage-plants]] for additional species selection.

## Pollen and Early Forage

As well as nectar producers, bees need pollen to rear replacement workers,
especially early in the season. Thus, willows (especially pussywillow), Acacias,
pines, and vine crop yielding early pollen are very beneficial on range.

Bees also gather propolis, a hard waxy substance, used to plug wind gaps or
repaint hives, and some sources of this are Xanthorrheas, poplars, and pines;
very few sources of propolis are needed in the whole range.

## Water for Hives

Clustered hives use very large quantities of water, which is used by the bees to
cool the hives. The bees ventilate hives as a "super organism", inhaling and
exhaling in about a 1.2 minute rhythm. As hive temperatures are normally high
(at about 21 degrees C), so hive insulation in cold weather is important.

In Denmark bees are over-wintered in thatched attic areas, or stored in
insulated hive houses in other parts of Europe. Conversely, in areas of hot
summers, hives need shade and good ventilation, or honey is lost as energy used
in cooling (fanning) by the hive.

Access to water is most safely achieved by providing soaked mats or hessian at
pond edges, so that bees cannot drown while drinking, and small ponds or
troughs free of dragonflies give less losses than large ponds (where dragonflies
are efficient predators).

## Forage Species Selection

Having designed the physical outline of a bee range (which in truth resemble any
well-sheltered farm), then local lists of honey plants can be consulted for
pathslides, road verges, hedgerow, and forest.

We could handily divide forages into early, mid, and late season for a good
spread of yield, and again into classical, bulk, and special honeys and pollens
for mixing and specific market.

### Seasonal Forage Categories

**[[solomon-sprouting-seeds-and-early-season-nutrition]] (Classical):** Rosemary, thyme, catnip, sage.

**Mid Season (Bulk):** Echium fastuosum, [[fukuoka-white-clover-cover-crop-system]], Acacia, blackberry,
catmint.

**Late Season (Bulk & Special):** Echium fastuosum, Eucalypt, leatherwood
(Eucryphia), mustard, smallfruits.

### Types of Honey

Some classical (highly preferred) honeys are: "heather" honeys (sage, thyme,
catmint, rosemary); pine tree or basswood (Tilia spp.) honeys in Europe and the
USA; marsh tupelo honeys (subtropics), leatherwood (Eucryphia) honeys of Chile
and Tasmania, and citrus honeys.

Bulk honeys suitable for blending derive from clovers, eucalypts, Acacias, field
crops such as mustard and buckwheat, fruit crop usually from the family
Rosaceae (blackberry, raspberry, apples), and "mixed garden honey".

Special pollens are those collected from plants such as some Acacia and
goldenrod, the pollens of which may cause asthma if inhaled by susceptible
people. Eaten, these honeys or pollens act to prevent allergic reaction.
