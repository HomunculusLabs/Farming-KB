...
Soil fundamentals for vegetable gardening, from Steve Solomon's *Gardening When It Counts*. Solomon argues that soil mineral balance directly determines the nutritional quality of your food. (see [[complete-organic-fertilizer-formulation]]).

## The Foundation: Mineral Balance

Plants need far more than just NPK (nitrogen, phosphorus, potassium). They need a complete balance of minerals, vitamins, amino acids, and an ever-extending list of other substances — including "phytamins," organic chemicals produced by the soil ecology. (see [[hamilton-organic-fertilizers-and-plant-nutrition]]).
...
Solomon's signature recipe, developed over decades of gardening:

### Formula (by volume, all parts measured by scoop/bucketful)

**Base** (choose one):
- 4 parts any kind of seedmeal (byproduct of making vegetable oil: cottonseed, linseed, sunflower, soy, canola) — typically analyzes at 6-4-2
- OR: 3 parts seedmeal plus 1 part "tankage" (blood-and-bone, meatmeal) — higher nitrogen, slightly better for leafy crops in spring
- OR: 4 parts less-potent coprameal (coconut meal, about one-third weaker than other seedmeals), supplemented with 1 part tankage

**Blend with**:
- 1 part ordinary agricultural lime (finely ground)
- 1 part gypsum (calcium sulfate) — if no gypsum, double the agricultural lime
...
- **Basic**: 4-6 quarts (4-6 liters) of COF per 100 sq ft of raised bed, applied at least once a year (best in spring)
- **Spread** down each 50 feet of row 12-18 inches wide
...
- **Low-demand**: Kale, collards, peas, beans, radishes, turnips — grow well on modestly fertile soil
- **Medium-demand**: Cabbage, beets, carrots, lettuce, onions, Swiss chard, corn — need reasonably fertile soil
- **High-demand**: Tomatoes, peppers, eggplant, broccoli, cauliflower, celery, cucumbers, melons, squash — need very fertile soil

These are minimums. All vegetables grow much better when given soil more fertile than the bare minimum.

## Nutritional Decline

Research shows that the vitamin and mineral content of American vegetables has declined substantially over the past 80 years. The soil needs complete mineralization — not just NPK — to produce truly nutritious food.
