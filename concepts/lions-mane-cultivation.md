...
- **Moisture content:** 60-65% (field capacity)
- **Common formula:** 4 parts hardwood sawdust : 1 part wheat bran, hydrated to 60-65%

### Pasteurization

Substrate is packed into autoclavable bags or jars and sterilized at 15 psi for 60-90 minutes. For larger operations, bulk pasteurization at 160-180°F (71-82°C) for 8-12 hours is effective.
...
- **Temperature:** 70-75°F (21-24°C) for optimal mycelial growth
- **Duration:** 14-21 days for full colonization of supplemented sawdust blocks
- **CO2 tolerance:** High; Lion's Mane mycelium colonizes aggressively in high-CO2 environments
- **Light:** Not required during colonization; indirect ambient light acceptable
...
|-----------|-------|---------|
| Temperature | 60-75°F (15-24°C) | 65-70°F (18-21°C) |
| Humidity | 85-95% RH | 90-95% RH |
| Fresh Air Exchange | Moderate-High | High |
...
Harvest when spines are at maximum elongation but before they begin to turn brown. The optimal harvest window is when the fruiting body is fully formed with white to cream spines, typically 5-10 days after primordia appear. If spines begin to discolor or the base starts browning, the mushroom is past prime.

### Harvesting Technique

Cut the fruiting body cleanly at the base with a sharp knife or scissors. Avoid pulling, which can damage the substrate block. Blocks typically produce 2-3 flushes, with the first flush being the largest.
...
- **Anti-inflammatory properties:** Reduction of inflammatory markers in laboratory studies
- **Gastrointestinal health:** Traditional use for stomach ailments; modern research supports protective effects on gastric mucosa
