...
| Millet | 166 | 83 | 13% |
| Perennial Wheat Grass Seed | 450 | 43 | 16% |
...
2. Flame-sterilize a scalpel and cut a triangular wedge of mycelium-covered agar
3. Transfer the wedge to the grain jar, exposing grain for minimal time
4. A petri dish 2/3 covered with mycelium should inoculate 6-8 quart jars
5. A "double wedge" transfer (cutting one wedge in half) grows out significantly faster
6. Shake jars thoroughly to distribute mycelial fragments, then incubate at appropriate temperature

### Grain-to-Grain Transfer
1. Scrutinize each spawn master for contamination signs (heavy growth, slimy kernels, unusual colors, sour odors)
2. Shake masters until grain separates into individual kernels
3. Each master jar can inoculate 10-12 quart jars or 7-9 half-gallon jars
4. Wait 12-24 hours after shaking masters before using (to detect delayed bacterial contamination)
5. Pour 1/10 of master contents into each receiving jar, shake to distribute
...
### Key Principles
Understanding mushroom cultivation grain spawn requires consideration of several interrelated factors.
