...
Many people believe that if you take a variety of rice which bears large heads of grain, grow it so that it receives lots of sunlight, apply plenty of fertilizer, and carry out thorough pest control, you will get good yields. However, varieties that bear large heads usually have fewer heads per plant. The heavy application of fertilizers will cause excessive vegetative growth, again defeating attempts to improve exposure to sunlight.
...
Fukuoka divides natural farming into two types. The first type of natural farming is based on a philosophy that recognises the limits of human understanding and seeks to work within the bounds of nature as it truly is. The second type is a natural farming that arises from negation of scientific agriculture but still operates within its conceptual framework.
