...
Among young adults aged 15–24 across 12 EU Member States, **lifetime prevalence**
of hallucinogenic mushroom use ranges from **less than 1% to 8%**.

### Highest Prevalence Countries
- **Netherlands** — highest estimates, likely driven by smartshop availability
- **Czech Republic** — high availability and liberal attitudes
- **United Kingdom** — significant market expansion in early 2000s
- **Germany** — notable prevalence despite restrictions
- **Ireland** — growing market before 2006 legislation

### Lowest Prevalence Countries
- **Lithuania** — <1% lifetime prevalence
- **Hungary** — minimal reported use
- **France** — low in older surveys (2000), though a 2003 survey of 17–18
  year-olds showed higher rates (4.3% lifetime, 2.9% last year, 1% last month)
...
- Weaker association with: **cannabis** and legal substances
- This suggests mushrooms are used within a broader pattern of
  experimentation with illicit substances, not as an entry-level drug

## Gender Differences

Following general patterns for illegal drug use, **male students** consistently
show higher prevalence rates than females for hallucinogenic mushroom use.

## Club Survey Data

Drug surveys conducted in club settings show:
- Overall illegal drug prevalence is **consistently higher** than in general or
  school populations
- Hallucinogenic mushroom use is **more common among regular club-goers**
- The club environment represents a concentrated subculture where mushroom
  use co-occurs with other substances
