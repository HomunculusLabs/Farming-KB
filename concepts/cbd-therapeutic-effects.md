...
Cannabidiol (CBD) is a non-psychoactive cannabinoid sourced from cannabis. Unlike THC, CBD does not produce intoxicating effects, making it therapeutically valuable for patients who need symptom relief without cognitive impairment. CBD has a greater affinity for CB2 receptors than CB1 receptors, but much of its therapeutic influence stems from its ability to suppress the enzyme fatty acid amide hydrolase (FAAH) that breaks down anandamide, thus keeping the "Bliss Molecule" active at higher concentrations and for longer duration.

At the same time, CBD tames the psychoactive influence of THC, allowing patients to benefit from THC's other therapeutic powers at higher concentrations without unwanted psychological side effects.

## Neuroprotection

CBD is considered a very promising agent with the highest prospect for therapeutic use in the treatment of neurodegenerative illness. Key findings include:

- **Epilepsy**: An oil-based solution of CBD has been documented as effective for pediatric patients suffering from epileptic seizures who failed to respond to traditional pharmaceutical anti-seizure medications. This application has been among the most widely validated clinical uses of CBD.
...
While the full complexity of CBD's interaction with the ECS is yet to be revealed, CBD's multi-target pharmacology is well documented. Rather than acting as a direct agonist at [[cannabinoid-receptors-cb1-and-cb2]], CBD modulates the system through:
...
3. **TRPV1 activation**: Engages the capsaicin/vanilloid receptor for additional pain modulation
4. **PPAR-gamma agonism**: Activates nuclear receptors involved in inflammation and metabolism
5. **GPR55 antagonism**: Blocks a putative cannabinoid receptor implicated in cancer cell proliferation
