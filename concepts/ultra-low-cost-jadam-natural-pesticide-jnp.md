...
updated: 2026-04-25
sources:
  - the-way-to-ultra-low-cost-agriculture-untitled.md
type: concept
---
...
The guide frames chemical pesticide as the single biggest culprit in making
...
acre. Bongha village in Korea successfully applied JADAM natural pesticide
...
- **Ultra-low cost**: Approximately 1/50 the cost of chemical pesticides.
...
- **Provides nutrients**: JNP delivers nutrients to crops while
  controlling pests, functioning as both pesticide and fertiliser.
- **Effective**: Pest control effect is described as no less than that of
  chemical pesticides.
- **Regulatory compliance**: JNP complies with international organic
...
effectively penetrate into the target pest. JWA is a natural surfactant
developed through a method that requires no heating.

JWA functions as the key ingredient of pesticide by:
- Increasing wetting of the target surface
- Improving coating and even distribution
- Enhancing penetration into pest organisms
- Providing its own pesticide and germicide effect
...
The guide emphasises that foliar application should always use water that
has passed the JADAM wetting agent test. This ensures compatibility between
the carrier water and the active ingredients.

## Combining JNP with Other Methods

The guide describes methods for combining JADAM inputs for comprehensive
crop protection. JNP can be used alongside JADAM liquid fertilisers and
microorganism solutions as part of a complete crop management programme.
The JADAM Natural Pesticide Institute has developed specific formulations
for:

- Powdery mildew and downy mildew control
- Aphid and mite control
- Tobacco moth and beet armyworm control
- Stinkbug and mealybug control
- Slug and snail control
- Rice water weevil (using surface spreading agent)
- Canker and leaf spot diseases
- Rice bakanae disease
- Citrus latid planthopper and leafhopper control
...
## Philosophy of Knowledge Sharing

The guide notes that JADAM's founder chose not to patent the knowledge,
believing that agricultural knowledge is a public asset shared by humanity.
All JADAM knowledge is available through books, websites, smartphones, and
workshops. The guide states: "Revolution is not achieved through battles.
Change becomes real when it seeps into us like water."
