...
Masanobu Fukuoka's critique of modern scientific farming centers on the observation that scientific agriculture creates the very problems it then claims to solve. Through a geometric model of centrifugal expansion versus centripetal convergence, Fukuoka argued that scientific farming is inherently unsustainable because it requires ever-increasing inputs of energy, technology, and labor, while [[natural-farming]] moves in the opposite direction toward simplicity, economy, and non-action. This framework underlies his broader "green philosophy" of agriculture and civilization.

## The Centrifugal-Centripetal Model

### Scientific Farming as Centrifugal and Divergent

Fukuoka characterized scientific farming as centrifugal and divergent:

- It breaks away from nature through the expansion of human wants and desires
- Each new technology creates new needs, which require further technologies to address
- The addition of new methods only makes the system more complex and diversified
- This generates ever-increasing expense and labor
- The outward expansion cannot be stopped; the system is "doomed to extinction"

### Natural Farming as Centripetal and Convergent

By contrast, [[natural-farming]] is centripetal and convergent:
...
This geometric progression in energy input represents what Fukuoka called "the energy-intensive agricultural methods of today."

### The Quality Question

Beyond quantity, Fukuoka argued that scientific farming degrades food quality. Modern agriculture has "created nothing from nature" but has instead "managed only to fabricate synthetic food products that are crude, expensive, and further alienate man from nature." The mechanization of food production has created "artificial, deformed food" by making quantitative and qualitative changes in aspects of nature without understanding the holistic system.

## The Chain of Unintended Consequences

### The Pine Forest Example

Fukuoka illustrated the cascading effects of human intervention through a detailed example of Japanese mountain forest management:

1. Trees are logged for lumber value; economic species (pine, cedar) are planted as "forestry conservation"
2. Altered tree cover changes forest soil characteristics, affecting plants and animals
3. Changes in air and temperature follow, affecting microbial life
4. Small birds lose their food source and disappear
5. Long-horned beetles flourish without bird predation
6. Beetles vector nematodes that attack red pines
7. Red pines fall victim to parasitic Botrytis fungi, weakened by the loss of edible matsutake fungus
8. Matsutake died from increased harmful Botrytis in the soil, caused by atmospheric pollution and acid rain
9. When pines die, bamboo grass thickets rise, feeding mice
10. Mice multiply and attack cedar saplings, prompting rodenticide application
11. As mice vanish, weasels and snakes that feed on them decline
12. To protect weasels, man begins raising mice to restore the rodent population

Fukuoka concluded: "Isn't this the stuff of crazed dreams?" This backward regression from effect to prior cause continues in an unending chain, demonstrating that "in nature, there is no cause and effect" in the simplistic linear sense assumed by scientific management.

### The Pesticide Cascade

In Japanese rice fields, where toxic chemicals are applied at least eight times per year, the amount of insect damage remains largely the same as in unsprayed fields. The first pesticide application:

- Fails to kill rice leafhoppers
- Eliminates tens of thousands of young spiders per square yard
- Destroys swarms of fireflies from grass stands

The second application kills chalcid wasps (natural predators) while leaving dragonfly larvae, tadpoles, and loaches as victims. Each intervention eliminates more of the natural balance that was keeping pests in check.
...
- Those who collect data on "a dead and fragmented nature" and claim to "know," "use," or "conquer" nature are examining something that is no longer nature
- "We must become aware of the insignificance of human knowledge and activity, and begin by grasping their uselessness and futility"

### Beyond Organic Farming

Fukuoka explicitly distanced [[natural-farming]] from what he called organic farming:
...
- [[do-nothing-farming]] - The core practice and philosophy
