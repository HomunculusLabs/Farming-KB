...
### Sample Processing
1. Collect soil from root zone
2. Combine subsamples (e.g., 10 x 10 cm3 into 100 cm3 beaker)
3. Mix thoroughly before subsampling

## Trap Cultures

Used to induce production of healthy spores for accurate identification, since field-collected spores may be intergraded morphologically.

### Trap Culture Protocol
