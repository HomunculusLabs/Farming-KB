...
is used as a biological amendment to restore and maintain the [[soil food
web]] in agricultural systems.

## Definition and Distinction from Other Preparations

AACT is strictly defined and distinguished from several related preparations:

- **Compost Extract**: No brewing period; organisms not given opportunity to
...
beneficial organisms including bacteria, fungi, protozoa, and nematodes. If
the liquid goes anaerobic and beneficial fungi, protozoa, or nematodes are
lost, it can no longer be called compost tea.

## Core Principle: Prevention, Not Pesticide

AACT is a preventative approach rather than a pesticide. Its mechanisms work
through establishing competitive microbial communities that occupy infection
sites, consume disease-organism food resources, and create conditions
unfavorable for pathogens. No toxic chemicals are involved in the disease
suppression mechanism.

## The Five Soil Food Web Benefits

Applying AACT to restore a healthy [[soil food web]] provides five benefits:
...
5. **Soil structure building**: Micro- and macro-aggregates, pores, and
   passageways are built through biological processes, increasing water
   holding capacity and rooting depth.
...
## Assessment: Direct Microscopy vs. Plate Counts

Dr. Ingham advocates direct microscopy for assessing compost tea biology:
...
- **Nematodes**: Bacterial-feeding, fungal-feeding, and predatory species
  that regulate microbial populations and cycle nutrients

## Balancing the Food Web

The bacterial to fungal ratio depends on the crop:

- **Bacterial-dominated**: Preferred for brassicas, cole crops, and early
  successional annuals
- **Fungal-dominated**: Required for perennials, trees, and later
  successional plants
- **Balanced**: Many crops benefit from roughly equal bacterial and fungal
  biomass

If any organism group is too low, that group needs improvement through
targeted compost tea application with appropriate food resources. Desired
ranges depend on the specific plant, climate, and current soil conditions.
