---
title: Mycophagy in Vertebrates
...
However, fungi also present nutritional challenges. Much of their nitrogen is locked in complex, indigestible forms such as chitin-based cell walls. Fogel and Trappe (1978) showed that fungi consist of a large amount of water (70–94%) and contain fewer calories per unit weight than nuts, eggs, and meat. Kinnear et al. (1979) reported fungi as having approximately 40% lipids and 8–10% proteins by weight. Cork and Kenagy (1989b) demonstrated that ground squirrels actually lost weight when fed entirely on fruit bodies of the hypogeous ectomycorrhizal fungus [[elaphomyces-granulatus]], as more than 80% of the nitrogen was unavailable in the digestive tract.
...
Reindeer herds of Fennoscandia rely heavily on lichens (lichenized fungi) as a food source during winter months, without which their populations could not be sustained. Mathiesen et al. (2000) showed that more than 25% of the gut contents of Norwegian reindeer consist of lichens during March. The hemicellulose in lichens contains xylan and lichen starch in β-1-4 and β-1-3 glucoside linkages, which differ significantly from plant carbohydrates and induce increased bacterial fermentation in the gut, leading to development of food-absorptive papillae on the gut wall.

However, this dependence creates sustainability concerns. Lichens in high arctic regions grow extremely slowly (2.5 to 10.6 mg g⁻¹ wk⁻¹ relative growth rate). Kumpula (2001) estimated that reindeer in Finland consume up to 2.6 kg of lichens per day during intensive digging periods and require approximately 1000 kg ha⁻¹ dry weight of lichens to sustain through winter. Both grazing pressure and trampling by reindeer herds threaten lichen community diversity and biomass.
...
Mycophagy in vertebrates has several important ecosystem-level consequences:

1. **Spore dispersal**: Many mammals, particularly those consuming hypogeous fungi, serve as critical dispersal agents for fungal spores that would otherwise remain buried underground.

2. **Nutrient redistribution**: Animals that consume fungi in one location and deposit spores in feces elsewhere redistribute nutrients across the landscape.

3. **Population regulation**: The seasonal availability of fungal fruit bodies can be a limiting factor for animal populations, particularly in temperate and boreal ecosystems.

4. **Grazing feedback**: While vertebrate mycophagy can reduce fungal reproductive potential, moderate grazing pressure may stimulate fungal community dynamics and productivity.

The complex interplay between vertebrate mycophagy and fungal ecology underscores the importance of fungi not just as decomposers or plant symbionts, but as foundational components of terrestrial food webs that support diverse animal communities.
## See also
