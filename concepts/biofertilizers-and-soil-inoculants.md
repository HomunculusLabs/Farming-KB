---
title: Biofertilizers and Soil Inoculants
created: 2026-04-21
updated: 2026-04-21
type: concept
tags: [reference]
...
- Symbiotic nitrogen fixers associated with legumes (soybeans, locust trees, wisteria)
- Form root nodules filled with specialized bacteria that capture atmospheric nitrogen
- The pink color in nodules comes from a compound similar to hemoglobin
...
Rhizobia convert atmospheric nitrogen gas (N2), which plants cannot use, into ammonium (NH4+) that plants can absorb. This process, called biological nitrogen fixation, provides an estimated 40-60 million tons of nitrogen for agriculture globally each year — roughly half of all nitrogen used by crops.
...
Mycorrhizal fungi require living roots to survive. They cannot persist long in fallow soil. This is why cover crops and continuous planting are important for maintaining mycorrhizal populations. High-phosphorus fertilizers suppress mycorrhizal colonization because the plant no longer "needs" the fungal partner.
...
- **Disease suppression**: Producing antibiotics that inhibit pathogens
- **Induced systemic resistance**: Triggering the plant's own immune defenses
- **Hormone production**: Synthesizing auxins, cytokinins, and gibberellins
- **Nutrient cycling**: Mineralizing organic matter and solubilizing minerals
...
3. For mycorrhizal inoculation, place spores near or on roots
