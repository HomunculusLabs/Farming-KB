...
Any adult who desires to become a shaman simply presents a gift to a practicing shaman, who:
1. Administers the *Banisteriopsis* drink
2. Gives some of his own supernatural power in the form of **tsentsak** (spirit helpers or "darts")
3. The tsentsak are regurgitated as a brilliant substance (visible only to those who have taken natem), cut with a machete, and given to the novice to swallow
...
The main supernatural forces believed to cause illness and death:
- Normally invisible; shamans can perceive them only under natem
- Have a natural aspect (ordinary material object) and a supernatural aspect (revealed by the drug as demons, giant butterflies, jaguars, monkeys)
- Used to bewitch (shoot into victims' bodies) or cure (suck out intruding objects)
- Form shields that protect their shaman masters from attacks
- A shaman may have hundreds; they must be kept "fed" with tobacco juice
...
The severity of witchcraft-induced illness depends on two factors: the force with which the tsentsak is shot into the body, and the character of the magical dart itself. If a tsentsak is shot all the way through the body of a victim, then death is virtually certain. More commonly, the dart lodges somewhere in the body, causing chronic illness that worsens over time as the tsentsak continues its work.

## Natem Consumption Patterns
