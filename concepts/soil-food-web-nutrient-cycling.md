...
- raw/papers/nature-mineral-fertilizers-npk-organic-different.md
...
6. **Microarthropods** (springtails, mites) shred organic matter, disperse spores, release nutrients

**Key insight**: Bacterial soils (vegetables, annuals) rely on protozoa for N cycling. Fungal soils (trees, perennials) rely on fungal-feeding nematodes. To shift toward fungal dominance, add fungal foods (kelp, humic acids, wood chips) AND ensure fungal-feeding nematodes are present.
...
- [[indigenous-microorganisms-imo]] — capture and multiply native beneficial microbes (Cho)
...
1. **Feed the microbes, not the plant** — organic matter is microbial food
2. **Maximize diversity** — different organisms perform different functions
3. **Minimize disturbance** — tilling destroys fungal networks and soil structure
4. **Keep soil covered** — mulch protects biology from temperature extremes
5. **Maintain moisture** — 40-60% field capacity keeps all trophic levels active
