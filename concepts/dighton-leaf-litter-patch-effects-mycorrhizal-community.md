...
influence the fungal communities colonizing tree roots.

The heterogeneity of dighton leaf litter patch effects mycorrhizal community distribution is a key driver of belowground
diversity. Because leaf litter accumulates unevenly depending on canopy structure,
wind patterns, topography, and understory vegetation, the resulting pattern creates
distinct zones of resource availability that different ectomycorrhizal species are
