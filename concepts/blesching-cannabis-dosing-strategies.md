...
Blesching provides a practical framework for selecting cannabis based on the
patient's dominant deficiency:

### CB1 Deficiency (Neurological/Emotional Conditions)
- Conditions: depression, PTSD, anxiety, insomnia, epilepsy, spasticity,
  neuropathic pain
- Strategy: Choose strains with higher THC:CBD ratios (sativa-dominant)
- THC preferentially activates CB1 receptors
- Sativas generally more stimulating, energizing, uplifting; more
  mental/emotional
...
- 0.5 mg Nabilone: Significant reduction in agitation
- 1.0 mg Nabilone: Further symptom reduction without side effects
- Conclusion: Low doses effective; gradual increase well-tolerated

### Cancer Appetite Stimulation
- 2.5 mg THC orally, three times daily: Effective appetite stimulant, well
  tolerated at low doses
- Conclusion: Low, frequent dosing preferred

### Cholestatic Pruritus
- 5 mg Marinol at bedtime: Effective; duration 4-6 hours suggesting need for
  more frequent dosing
- One patient required reduction to 2.5 mg due to coordination disturbance

## Strain Selection Framework

| Condition Type | Preferred Strain | THC:CBD Ratio | Primary Receptor | Best Time |
|---------------|------------------|---------------|-----------------|-----------|
...
Blesching notes that raw, fresh leaf or juice contains biologically active
cannabinoids in the form of relatively non-psychoactive THC-acid and CBD-acid.
William L. Courtney, MD, working with fresh cannabis as a dietary essential,
suggests raw preparations can deliver much higher concentrations of CBD before
any mind-altering effect occurs. This is particularly relevant for:

- Patients who cannot tolerate psychoactive effects
- Conditions requiring primarily CB2 activation
- High-dose anti-inflammatory protocols
- Daily maintenance therapy

## Key Takeaways

- Match strain selection to dominant receptor deficiency (CB1 = sativa, CB2 =
  indica)
- Route of administration critically affects onset, duration, and dosing
  strategy
