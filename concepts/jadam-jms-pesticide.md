...
### Peak Foam Timing
- Use JMS when foam reaches its peak on the surface
- Peak foam indicates highest microorganism population
...
JMS costs only labor plus potatoes (or other medium). Combined with JWA and JHS, this prevention spray is one of the lowest-cost crop protection methods available.
