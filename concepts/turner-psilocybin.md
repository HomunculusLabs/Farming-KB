...
type: concept
tags: [psychedelics, psilocybin, mushrooms, tryptamine, dosage, identification]
updated: 2026-04-26
---
...
Terence McKenna suggests [[query-how-to-store-mushroom-spores-long-term]] arriving from outer space may have been some of the earliest forms of life. Studies at the University of Leiden determined that certain mushroom spores could survive up to 45 million years in interstellar transit (Nature, Aug 1, 1985).

## Dosage

Doses refer to dried **Psilocybe cubensis**:

| Dose | Effect |
|------|--------|
| 1 gram | Little more than threshold effects |
| 2 grams | Mild psychedelic high |
| 5 grams | Similar intensity to a 250 mcg LSD trip (~15 mg psilocybin/psilocin) |
| 10-14 grams | Quite incredible experiences |

The potency of different batches varies, usually within +/-10%, although some strains can be nearly twice as potent as standard.

**Storage:** Mushrooms lose about 25% potency in six months. They keep much longer in an airtight container in the freezer. Fresh mushrooms should be dried at a low temperature (~95 degrees F) to preserve potency.

## The High

### Comparison to LSD

Mushrooms produce an experience similar to LSD but with a different signature:

- **Dreamy and drifty** vs. the penetrating brilliance and lucidity of acid
- Users feel more **relaxed**, sometimes even drowsy, rather than the speedy, edgy feeling of acid
- Trip lasts **5 to 7 hours** (most intense/visual during first 2 hours)
...
Mushroom visuals can be magnificent on large doses, especially in **pitch black** environments:

- More **"organic"** than acid visuals
- Tend towards **rounded forms** and images congruent with nature
- Acid visuals are usually more angular, with kaleidoscopic or abstract imagery

### Similarity to DMT

A large dose mushroom experience can feel quite similar to N,N-DMT, but with much less intensity. The visuals tend to have the same character as DMT visuals, and one easily goes into trance. This is not unexpected since mushrooms contain long-lasting tryptamines (psilocin = 4-OH-DMT).

### Negative Qualities

- Moves a bit slower and tends to be less intense than acid
- More difficult to break through to a full-on psychedelic state
- The trip cannot be guided as easily as an acid trip
...
Psilocybin can also be combined with LSD, DMT, or Nitrous Oxide. See the [[turner-5meo-dmt]]
