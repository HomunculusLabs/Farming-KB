---
title: Fungal Nutrition and Metabolism
created: 2026-04-26
...
## Carbon Sources and Energy Metabolism

Fungi can utilize a remarkable diversity of carbon compounds as energy sources:

- **Simple sugars**: Glucose, fructose, sucrose, and other monosaccharides and disaccharides are readily assimilated through membrane transporters. These are the preferred carbon sources for most fungi and support the fastest growth rates.
...
The ability of fungi to decompose complex organic matter depends on their extracellular enzyme systems. Different fungal groups produce characteristic suites of enzymes:

### Cellulose Degradation

Cellulose, a linear polymer of beta-1,4-linked glucose units, is the most abundant organic polymer on Earth. Fungal cellulase systems typically include:

- **Endoglucanases (endo-beta-1,4-glucanases)**: Randomly cleave internal beta-1,4-glycosidic bonds in the cellulose chain, creating new chain ends.
...
Lignin degradation is largely restricted to white-rot basidiomycetes and requires an oxidative, non-enzymatic approach because lignin lacks regular hydrolyzable bonds:

- **Lignin peroxidases (LiP)**: Heme-containing peroxidases that oxidize non-phenolic lignin subunits via electron transfer, generating aryl cation radicals.
- **Manganese peroxidases (MnP)**: Oxidize Mn(II) to Mn(III), which in turn oxidizes phenolic lignin components. MnP is the most commonly expressed ligninolytic peroxidase in soil environments.
- **Laccases**: Copper-containing oxidases that oxidize phenolic substrates and can also act on non-phenolic compounds in the presence of redox mediators.
- **Hydrogen peroxide-generating enzymes**: Including glyoxal oxidase, aryl alcohol oxidase, and methanol oxidase, which supply the H2O2 needed by peroxidases.

### Other Enzyme Systems

- **Hemicellulases**: Including xylanases, mannanases, and galactanases that break down the diverse hemicellulose polysaccharides (xylan, glucomannan, galactomannan, xyloglucan).
- **Pectinases**: Polygalacturonases, pectin lyases, and pectin methylesterases that degrade pectin, a major component of plant cell walls and middle lamellae.
- **Chitinases**: Degrade chitin, found in fungal cell walls and arthropod exoskeletons. Important in soil fungi for competitive interactions with other fungi and in mycoparasitism.
- **Proteases**: Secreted to degrade proteins in dead organic matter. Saprobic soil fungi produce a wide range of extracellular proteases.
- **Cutinases and esterases**: Break down cutin, suberin, and ester bonds in plant surface waxes and aliphatic biopolymers.
- **Laccases and tyrosinases**: Phenoloxidases involved in lignin degradation, humification, and detoxification of phenolic compounds.
