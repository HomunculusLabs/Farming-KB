...
Solomon uses a simple germination cabinet approach: a shallow box with a heat source (such as a heating mat or light bulb) beneath, holding the temperature at the ideal germination range for the species. Seeds are placed on moist paper towels or in barely damp peat/coconut fiber medium, covered loosely to maintain humidity, and checked daily.

The key principles:
- Keep medium barely damp, not wet (squeeze a handful — no free moisture should come out)
- Maintain temperature appropriate for the species
- Check daily; plant as soon as the root tip barely emerges
- Handle sprouted seeds very gently — the emerging root is fragile
