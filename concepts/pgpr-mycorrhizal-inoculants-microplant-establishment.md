...
Combined inoculation may address a broader range of stresses (nutrient deficiency, drought, pathogen attack) simultaneously.

However, compatibility between specific AMF and PGPR strains must be verified, as some combinations show antagonism rather than synergy.

## Selection of Inoculant Strains

Selection of effective inoculant strains for microplant systems requires consideration of multiple factors. Strains should be effective under the specific substrate conditions used in micropropagation (peat, coir, rockwool, hydroponics). Temperature tolerance should match greenhouse conditions. Strains should not be inhibited by the pesticides commonly used in micropropagation facilities. For commercial viability, inoculants should offer at least a 4-fold return on investment. Some researchers advocate seeking inoculants from pathogen-suppressive soils, while others pursue universal strains with broad environmental tolerance.

Strains should be effective under the specific substrate conditions used in micropropagation (peat, coir, rockwool, hydroponics).

Temperature tolerance should match greenhouse conditions.

Strains should not be inhibited by the pesticides commonly used in micropropagation facilities.

For commercial viability, inoculants should offer at least a 4-fold return on investment.

Some researchers advocate seeking inoculants from pathogen-suppressive soils, while others pursue universal strains with broad environmental tolerance.
