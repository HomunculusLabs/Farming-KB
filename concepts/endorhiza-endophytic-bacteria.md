---
title: Endorhiza Endophytic Bacteria
slug: endorhiza-endophytic-bacteria
source: understanding-cultivar-specificity-cannabis-microbiome.md
tags: [endorhiza, endophytes, cannabis, root-colonization, microbiome]
created: 2026-05-08
---
...
The endorhiza refers specifically to bacteria inhabiting root
interior tissues, distinct from:
- **Bulk soil**: Soil with no direct root influence
- **Rhizosphere**: Soil adhering to root surfaces
...
for producing antibiotics, siderophores, and phytohormones. Among
the most common root endophytes across all studied plant systems.

### Cellvibrio
An aerobic cellulolytic bacterium — notable as one of the few
non-endophytic core members. Degrades cellulose and may facilitate
nutrient release from root cell wall debris.

### Oxalobacteraceae
Betaproteobacteria family commonly found in root environments.
Members metabolize oxalic acid, potentially modulating root
calcium availability and protecting against fungal pathogens.

### Xanthomonadaceae
Gammaproteobacteria family including both plant pathogens and
non-pathogenic root associates. Consistent presence suggests
primarily commensal relationships in Cannabis.
