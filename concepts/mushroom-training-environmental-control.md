...
Humidity must be maintained between 75 and 90 percent. Key practices:
- Spray water to control humidity; water often but not much each time
- No water should enter the substrate bags
- Surface water must evaporate from mushrooms several times per day
- The manual notes: when people feel comfortable, mushrooms are in a good environment

## Temperature by Species

| Species | Temperature Range (C) | Season |
|---------|----------------------|--------|
