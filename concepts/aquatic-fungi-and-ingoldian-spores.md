...
Ingoldian spores come in an extraordinary variety of shapes:
- **Tetraradiate (star-shaped)**: Four arms connected to a central hub
- **Sigmoid**: Elongated S-shape twisted into a helix
- **Crescent-shaped**: Curved like a crescent moon
- **Compound forms**: Combinations resembling balloon-animal shapes

The largest Ingoldian spore belongs to *Actinospora*, spanning 0.5mm in diameter — visible to the naked eye with a hand lens and likely the largest spore produced by any fungus.

### Why the Elaborate Shapes?

**Search theory** (originally developed for antisubmarine warfare) provides the answer. Analysis shows that the probability of hitting a target increases in proportion to the length of the "search vehicle." Star-shaped spores have a much higher probability of encountering a submerged leaf than spherical spores of equal mass. The thin hyphal appendages span an enormous area (for a microorganism) with minimal cytoplasm investment.

**Three-point landing mechanism**: When one arm of a tetraradiate spore strikes a surface, water movement forces the spore to pivot around the attachment point until additional arms land. The arm tips swell, secrete adhesive, and produce infection hyphae that penetrate the leaf — attacking food from the corners of a triangle.

Sigmoid spores tumble through water flow, exploring a large volume. Upon contact they roll or somersault until a firm attachment is made, then secrete adhesive at a second point.

### Not About Slowing Descent
...
- [[ballistospore-discharge]] for comparison with the terrestrial spore catapult mechanism (Buller's drop) mentioned above
