...
A genetic bottleneck occurs when a breeding population is drastically
reduced in size, causing a loss of genetic variability. In cannabis,
this happens when breeders select only one or two plants from a vast
array as their breeding population. The genetic variability found in
the original population is lost and becomes unavailable to future
generations.

Cannabis naturally existed in wild breeding populations of hundreds if
not thousands of individuals. Within these many individuals lies a wide
range of versions of different genes. When breeders work with very
small populations, they drastically reduce this natural variability.
