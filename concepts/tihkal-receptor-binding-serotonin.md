...
Serotonin itself cannot reach the brain when administered systemically due to two obstacles:
1. The **5-hydroxy group** is highly polar, preventing passage across the blood-brain barrier
2. The **exposed amino group** is immediately destroyed by monoamine oxidase (MAO)

This is why structural modifications (O-methylation, alpha-methylation) are necessary to create brain-active serotonin analogues.

## Serotonin Receptor Binding: The Challenge to Simple Theories

TIHKAL presents several compelling challenges to the theory that serotonin receptor binding directly explains psychedelic activity:

### BOL-148 (2-Bromo-LSD)
- **As potent a serotonin agonist as LSD**
- **Completely inactive as a psychedelic** at 6-10 mg orally, even 20 mg/day for 7 days
- This directly contradicts the simple serotonin theory of psychedelic action

### MBL-61 (2-Bromo-1-methyl-LSD)
- **Five times more potent than LSD** as a serotonin agonist
- **Without any activity** in man at 14 mg orally
- As effective as LSD in displacing labeled LSD from postsynaptic serotonin receptor sites in animal brains

### The Implication
These compounds demonstrate that serotonin receptor binding alone is insufficient to explain psychedelic activity. As Shulgin notes: "How can serotonin be argued as a neurotransmitter that is a major player in explaining the action of psychedelic drugs, when this compound is nearly without activity?"

## Tryptamine-Serotonin Relationships

### Structural Relationship
All psychedelic tryptamines are structural analogues of serotonin. The conversion pathway:
- **Tryptamine** + 5-hydroxylation = **Serotonin** (5-HT)
- **Serotonin** + N-methylation = **Bufotenine** (5-HO-DMT)
- **Serotonin** + 5-O-methylation + alpha-methylation = **alpha,O-DMS** (one of the most potent tryptamines)

### DMT and Serotonin
- DMT has **identical serotonin binding capacity** to its 1-methyl homologue
- DMT has been proposed as both an **endogenous psychotogen** and a **natural neurotransmitter**
- The serotonin antagonist UML-491 (methysergide) dramatically **intensifies** DMT effects -- a paradoxical finding for simple agonist theory

### Alpha-Methylserotonin (alpha-MS)
- An effective inhibitor of 5-hydroxytryptophan decarboxylase (the immediate precursor step to serotonin)
- Represents a half-way modification of serotonin to allow CNS entry
- Would be metabolized to serotonin rather than melatonin

### alpha,O-Dimethylserotonin
- Designed specifically to overcome the two barriers to serotonin's brain entry
- O-methyl removes polarity; alpha-methyl protects from MAO
- Goes "directly into the central nervous system" and is one of the most potent tryptamines known

## Endogenous Carbolines and Serotonin
