...
The third ethic, sometimes called "fair share" or "set limits to consumption and reproduction, and redistribute surplus," is articulated by Mollison as the **Law of Return**: "Whatever we take, we must return" or "Nature demands a return for every gift received." The user must pay.

This law manifests in concrete practices: replanting what is harvested, recycling materials, designing for durability, and ensuring the beneficial disposal of wastes. Mollison argues that every object must responsibly provide for its own replacement, and society must, as a condition of use, replace an equal or greater resource than that consumed. Nature, he warns, imposes extreme penalties on those who violate this law — penalties that extend to their descendants and neighbors.

## Ethics in Practice

### The Hypocrisy Test

Mollison applies the ethics with uncompromising directness. He identifies hypocrisy wherever people claim environmental values but act contrary to them: preserving forests while buying daily newspapers and packaged food; advocating for native plants while relying on chemical agriculture; adopting diets that require broadscale, destructive food production. True conservationists, in his view, have gardens that support their own food needs and are actively working to reduce their energy consumption to what can be supplied locally.

### Ethics for Natural Systems

Beyond the home garden, Mollison articulates a specific set of ethical directives for natural systems:

1. **Implacable opposition** to further disturbance of any remaining natural forests where most species still exist in balance
...
Mollison distills the ethical framework into two primary responsibilities:

1. **Primarily**: Get our house and garden — our place of living — in order so that it supports us
2. **Secondarily**: Limit our population on Earth, or we ourselves become the final plague

These duties are intimately connected, because stable regions create stable populations. Without functional cities, homes, and gardens that feed and shelter people, societies must continue laying waste to natural systems.
