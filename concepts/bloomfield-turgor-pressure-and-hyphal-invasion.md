...
biological system. Saprophytic fungi employ a similar combination of
enzymatic softening and mechanical pressure when colonizing dead wood,
where [[fungal-bioremediation-mechanisms|fungal wood decay mechanisms]] involve the sequential secretion
of cellulases, hemicellulases, and lignin-modifying enzymes. The
interplay between physical force and biochemical digestion means that
turgor pressure alone provides an incomplete picture of fungal invasion
biology; the two mechanisms operate synergistically.

## Comparative Biomechanics Across Kingdoms

The study of hyphal biomechanics connects fungal biology to broader
questions in plant and animal physiology. Root hairs and pollen tubes
in plants also rely on turgor-driven tip growth, though at generally
lower pressures than those observed in rapidly invading fungal hyphae.
Comparative studies have revealed that the fundamental biophysical
constraints on tip-growing cells are remarkably conserved across
kingdoms, including the role of the actin cytoskeleton in vesicle
