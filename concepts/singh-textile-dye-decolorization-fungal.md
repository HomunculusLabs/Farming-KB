...
- **Dead biomass adsorption**: Heat-killed or dried fungal biomass
  retains adsorption capacity, with advantages of no nutrient
  requirements and longer shelf life.
- **Mechanism specificity**: Cationic dyes (e.g., Crystal Violet)
  bind electrostatically to negatively charged cell wall groups;
  anionic dyes (e.g., Reactive dyes) may require modified biomass
  with positively charged surfaces.

### Combined Mechanisms

In most practical applications, both enzymatic degradation and
biosorption contribute simultaneously. Live fungal cultures typically
