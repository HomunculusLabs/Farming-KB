...
tryptamine family — DMT, psilocybin, and ayahuasca — setting them
...
heard — "ripping cellophane, like someone crumpling up plastic
...
This progression mirrors progressive activation of deeper visual
processing layers — from pattern-recognition to foundational
spatial-mapping and world-rendering capacities.

## Contrast with Other Hallucinogen Classes

McKenna insisted each hallucinogen class constitutes "a
phenomenologically defined universe unto itself." Tryptamines differ
from LSD and mescaline in onset speed (fifteen seconds vs. thirty
to ninety minutes), visual cortex concentration (more visual,
less somatic), intensity of alien quality (higher existential
authenticity), and translinguistic dimension (language center
activation producing interior dialogue and glossolalia absent in
phenethylamines or lysergamides).

## The Geometric Modality as Threshold

The "shifting geometric surface of migrating and changing colored
forms" precedes full breakthrough. McKenna called this the "normal
hallucinogenic modality" shared across hallucinogens, but with
tryptamines it is merely the threshold to more complex experiences.
The transition from abstract geometry to representational
environments is discontinuous — the geometric surface is replaced
by an entirely different kind of visual experience, as if a door
opened onto a space always present but previously invisible.

When the full state is achieved, geometric surfaces give way to
inhabited spaces containing entities and information complexes.
The visual cortex renders complete representational environments,
drawing on systems normally dedicated to memory, imagination, and
dreaming but combining them in ways transcending ordinary function.

## Implications for Consciousness Studies

The tryptamine visual experience poses fundamental questions: Where
does visual content come from given its mathematical order? What is
the vision-language relationship given tryptamines activate both?
Can consciousness operate without sensory input given the vividness
of closed-eye visuals? The endogenous presence of DMT in the brain
suggests these capacities may serve unrecognized functions in
ordinary consciousness — in dreaming, creativity, or intuition.
