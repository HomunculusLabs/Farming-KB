...
aliases: [cannabis varieties, cannabis subspecies, sativa indica differences, cannabis taxonomy]
tags: [cannabis, taxonomy, genetics, breeding, sativa, indica]
...
strains. While taxonomically debated — some authorities classify all cannabis as a single polymorphic
species — the sativa/indica distinction remains the most widely used framework for understanding
cannabis genetics, effects, and cultivation requirements.

## Botanical Distinctions

### Morphology

**Sativa** plants are characteristically tall and lanky, with narrow, finger-like leaflets. In
optimal outdoor conditions, pure sativas can reach heights of 12-20 feet or more, with a
spaced-out branch structure and relatively sparse foliage. The internodal spacing is long,
creating an airy, open plant architecture. Sativa buds tend to be long, wispy, and less dense
than indica buds, often described as "foxtailed."

**Indica** plants are short and compact, typically 2-4 feet tall when grown indoors. They have
broad, dark green leaflets with shorter internodal spacing, creating a bushy, dense appearance.
Indica buds are typically thick, heavy, and tightly packed, forming dense colas that can
significantly increase yield per square foot compared to sativas.
...
tall, slow-flowering plants adapted to extended seasons.

### Indica Origins

Indicas originated in the Hindu Kush mountains of Central Asia (Afghanistan, Pakistan, northern
India, Nepal). The harsh continental climate — short growing seasons, early autumn frosts, wide
temperature swings — selected for compact, fast-flowering, resinous plants that could complete
their life cycle quickly and protect themselves with dense trichome production against UV
radiation and cold.

## The Indica Dominance of Indoor Growing

The rise of indoor [[arbuscular-mycorrhizal-fungi-cannabis-cultivation]] in the 1980s and 1990s dramatically shifted breeding
