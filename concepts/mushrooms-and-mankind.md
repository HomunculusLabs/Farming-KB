...
### Ancient Egypt
See [[egyptian-mushroom-symbolism]] for full treatment.
...
See [[soma-hypothesis]] for the academic debate.
- Soma: the pressed plant-god of the Rig Veda (120+ hymns)
- Wasson proposed Amanita muscaria as Soma (1968)
- Rudra: the Hindu red god of the forest — possibly the red mushroom itself
- Churning of the Milky Ocean at Angkor Wat: 54 gods and 54 demons churn the cosmic ocean to produce Amrita
- Arthur proposes a multi-plant Soma: Amanita muscaria + Psilocybe + Syrian Rue (MAOI) + Opium Poppy + Cannabis/green plants
...
- Cave darkness meditation reactivates pineal gland (pinoline + DMT = endogenous ayahuasca)
- Amrita = Soma = the mushroom
...
### Mithraism
- Mithraic temples had rows of salt-water bathtubs for sensory deprivation during the sacred meal
- Mithra born from a stone (mushroom button stage), entwined with the serpent
- The "Mithraic Stargate" — circular gate with astrological symbols for spiritual travel
- Hundreds of similarities with Christianity
...
This combination mimics the DMT-pinoline combination naturally produced by the pineal gland. Arthur argues that individually each proposed Soma candidate falls short, but combined they produce the described ecstatic state.

## Secret Societies and Suppression

Arthur argues that knowledge of the mushroom sacrament was deliberately suppressed:
- Egyptian mystery schools gave birth to Rosicrucians, Freemasons, Templars
- These societies preserved the Egyptian model of tiered learning with the mushroom at the highest level
- Modern initiations use a room and coffin as degraded replacements for the pyramid and sarcophagus
- High priests and bishops Arthur spoke with confirmed knowledge but refused to discuss due to oaths of secrecy
- The suppression of entheogen knowledge serves power structures by preventing direct religious experience

## The Symbolic Vocabulary

Arthur catalogs 40+ names and symbols for the mushroom across cultures. See [[mythological-mushroom-symbolism]] for the complete catalog organized by lifecycle stage and cross-cultural parallels.
...
- Religion has "completely lost the natural indigenous freedom it professes to impart"
- Five natural human drives that patriarchal systems repress: expand consciousness, heighten awareness, experience plant substances, freely enjoy sexuality, engage in rhythmic dance and trance
...
- [[egyptian-mushroom-symbolism]] — Egyptian mushroom mysteries
- [[sacred-sacrament-mushroom-rites]] — Comparative sacramental rites
- [[mythological-mushroom-symbolism]] — Symbolic vocabulary catalog
- [[soma-hypothesis]] — The Soma identification debate
