...
into a tunnel or steam room and steamed for 2-4 hours at 140-150
degrees F, then cooled to 80 degrees F and spawned. An alternative
program calls for 12-24 hours at 122 degrees F after high-temperature
pasteurization, promoting beneficial microbial growth for greater
substrate selectivity.

## Hot Water Bath Pasteurization

The method best suited to home cultivators is the hot water bath. A
55-gallon drum half-filled with water is heated to 160-170 degrees F.
Chopped dry straw is placed into a wire mesh basket and submerged for
30-45 minutes. After removal, all loose water must be allowed to drain
before the straw is spread out to cool to 80 degrees F or less, at
which point it can be spawned. Some compression of straw into the
container increases cropping efficiency.
...
3. **Supplementation level**: Supplemented substrates generally require
   sterilization; unsupplemented straw can be pasteurized
4. **Scale of operation**: Commercial compost operations use steam
   pasteurization tunnels; home cultivators use hot water baths or
   pressure cookers
...
This underscores the importance of proper [[stamets-contamination-sources-laboratory-hygiene]] and following recommended time-temperature protocols precisely. For pasteurization, the selective survival of beneficial microorganisms is actually desired, as they contribute to substrate selectivity.
