---
title: "Mushroom Natural Habitats"
tags: []
sources: []
---
...
- The boundary between dead wood and soil is especially productive
- Mycelium can be found beneath downed logs, in stacks of aging firewood, or in piles of leaves and wood chips

### Wood Chip Beds
- Wood chips from tree-trimming operations create ideal substrate
- Chips held together in a clump indicate active mycelium
...
Parasitic fungi attack living trees. [[paul-stamets]] notes that parasitic species often transition to saprophytic behavior after killing their host:
- **Armillaria** (honey mushrooms): Can form the largest organisms on Earth (2,400-acre site in eastern Oregon, estimated 2,200 years old). Causes devastating root rot but builds deep soil over centuries.
- **Phaeolus schweinitzii**: Root parasite causing core rot in conifers
- **Laetiporus** (chicken of the woods): Brown rotter found in river valleys, edibly non-parasitic but aggressive
...
3. **Secondary decomposers** (years): As wood chemistry changes, different species dominate
4. **Late-stage** (decades): Brown rot specialists, humus incorporation

The key insight: faster-decomposing hardwoods (alder, birch, aspen) produce mushrooms sooner but have shorter fruiting lifespans. Denser woods (oak, ironwood) take 1-3 years to first fruit but can produce for 5-10+ years.
...
Mushrooms produce staggering numbers of spores:
- A pound of fresh oyster mushrooms can produce ~2.5 billion spores
- A large artist conk (Ganoderma applanatum) can produce 5 trillion spores annually
- At 8 microns each, those 5 trillion spores would span ~24,854 miles — enough to encircle Earth

Stamets proposes the "Spore-Earth Unit" (SEU) — the amount of spores equivalent to encircle the Earth — as a new astromycological measurement. The Earth is "sporulating, seeding the galaxy with its germplasm."
