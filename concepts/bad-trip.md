...
- **Pre-existing mental health conditions**: Underlying psychotic or personality disorders may be unmasked or exacerbated by psychedelic use
- **Prior experience**: Inexperienced users may be less psychologically prepared for intense effects
- **Unpredictable potency**: Variability in psilocybin content between batches and species makes dose estimation unreliable
...
Intermittent and chronic psychotic states resulting from hallucinogenic mushroom use are possible, though the overall incidence appears low. In susceptible individuals, use can bring underlying psychotic or personality disorders to the surface. The absence of systematic research means that long-term psychiatric consequences remain incompletely understood. Psychological and physical dependence does not develop with mushrooms, and there are no withdrawal symptoms.
