...
## The Traditional Pasteurization Argument

Conventional mushroom cultivation texts, particularly those focused on *Agaricus
bisporus* (the button mushroom), strongly advocate for pasteurization over
...
pathogenic organisms and competing fungi while preserving heat-tolerant beneficial
bacteria.
...
Pasteurization does not kill all competing organisms. Heat-tolerant molds,
nematodes, and some bacteria survive pasteurization and can outcompete the mushroom
mycelium in the casing layer. In small-scale cultivation with limited laminar flow
hoods or clean rooms, the risk from surviving contaminants in pasteurized casing
can be significant.

### Consistency and Reproducibility
Sterile casing provides a more consistent and reproducible environment:
- No variability between batches due to different microbial populations
- Predictable moisture content (no water consumed by microbial metabolism)
- Known starting conditions for every cultivation cycle

### Species-Specific Considerations
The guide focuses on *Psilocybe mexicana*, *P. tampanensis*, and *Panaeolus
...
## The Peat-Vermiculite-Limestone Casing Recipe

The casing recipe used is:
