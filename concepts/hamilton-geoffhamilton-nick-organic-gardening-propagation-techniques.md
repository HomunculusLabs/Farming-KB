...
Second, it can be difficult to find plants that have been raised
organically.
...
A firm bed is usually required. If your soil has been recently
cultivated, compress it by walking over the surface with your weight on
your heels. Next, rake the soil down to a fine tillage. Never do this
when the soil is wet enough to stick to your boots; you risk destroying
the soil structure.

### When to Sow

The correct time to sow seeds varies from one plant to another and is
normally shown on the back of the seed packet. There is no point in
sowing too early. As a general rule, seeds sown in soil with a
temperature below 45 degrees F (7 degrees C) will not germinate until
the soil warms up. Seeds sown in mid-spring will often germinate at the
same time as, or even before, seeds sown in cold, wet soil. Exceptions
include some alpine seeds and some trees that require a period of
freezing weather before they will germinate.

By sowing seeds under cloches you can start sowing outside in early
spring. Place the cloches in position two weeks or so before sowing in
order to warm the soil up.

### Encouraging Germination

Some seeds have extremely hard coats. They germinate more successfully
if you soak them overnight in water. Very hard seeds can first be filed
with a nail file to assist the entry of water into the seed coat. Other
seeds, such as beets, have a natural germination inhibitor within the
seed coat. To speed up germination, remove the inhibitor by washing the
seeds under the cold tap or by soaking them in water overnight.

### Depth and Distance to Sow

There is no doubt that the main cause of seeds failing to germinate is
that they are sown too deeply. Seeds have a reserve of food that will
enable the shoot to reach the surface and find the light. Until it does
this, it cannot manufacture any more food. The general rule is to make
"shallow" rows — a furrow as shallow as you can.
