...
In a typical fruit tree guild, the central element is an apple or plum tree surrounded by a carefully chosen understory. Rather than managing each organism individually, guild design thinks in clusters -- groups of individuals that function together as a self-supporting system.
...
Time stacking extends the concept by planting species that produce at different seasons, ensuring continuous harvest and continuous ground cover across the year. By selecting early, mid, and late-season varieties of the same crop, a gardener extends the harvest window without increasing the number of beds.
...
## Guild Design in Urban Settings
