...
- **Minor species**: Oca, sunroot ([[green-manure]]) can be sown before winter — oats, tares, or fava beans — then slashed or dug-in in spring.

## Garden Layout and Planning

Planning the cool climate garden means designing for seasonal shifts in bed use:

- **Small beds** for the spring planting, with main crops of potato, tomato, and sweet corn
- **Larger mass beds** in the autumn planting for winter storage crops (potatoes, carrots, parsnips, turnips, cabbage, fava beans, peas, brassicas)

Chard and parsley are important all-year foods. Several successions should be sown at irregular intervals so that they are always present in the garden.

### Light and Mulch Considerations

The garden layout is similar to tropical designs but with important modifications:

- **Omit overshad ed areas or tree crop interplant**, as light levels can be low in cloudy weather and light saturation is rarely a problem
- **Mulch is appropriate** for nearly all crops, with one exception: spring carrot planting, when mulch is pulled from the seedbed to let it warm up early
- All other crops planted in mulch catch up with bare-soil crops and mature at the same time

## Protected Growing

For cool areas, two structures are invaluable:

- **A small glasshouse** for seedling trays
- **A series of cloches** for early transplants

Even potatoes can be sprouted on old hessian bags indoors or in any open shadehouse, then transplanted complete with leaves and roots by cutting up the bags into squares.
...
### Seed Saving from Umbellifers

When saving seed from any umbelliferous plant (carrots, parsnips, fennel, etc.), collect the **strong, mature seed from the terminal panicle only** — this germinates best of all. Side panicles contain immature and small seeds and can be pruned or rejected.

## Trellis Systems for Cool Climates

Trellis crops are important in mesothermal climates. Many peas, beans, and cucurbits will trellis, as will varieties of tomatoes. However, unlike in deserts, **trellis over the garden is inappropriate** in cool climates. The preferred trellis configurations are:

- **Vertical zigzag** trellis
- **Inverted "V"** trellis
- **House wall and garden fence** trellis

All trellis should be aligned **north–south** where possible for even sun exposure. These configurations greatly enlarge crop options and help control the microclimate around the house.
...
The preservation of open-pollinated, non-patented seed is critical for food sovereignty. Despite the enormous loss of locally adapted seed (estimated at 85% of European varieties) from the monopoly control of seed patenting by agro-chemical multinationals, the encouraging result of "people power" is that most gardeners and farmers today can assemble more species and varieties of seed than ever before in history, by using seed exchanges and local collections.
