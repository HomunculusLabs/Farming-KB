...
The EMCDDA 2006 thematic paper made an explicit finding with significant implications for drug policy and public health: hallucinogenic mushrooms do not produce psychological or physical dependence, and no withdrawal symptoms are associated with their use. This non-addictive profile fundamentally distinguishes psilocybin-containing mushrooms from most other substances monitored by the EMCDDA and represents a key factor in understanding both the limited diffusion of mushroom use and the relatively low public health burden it generates.
...
- **Rapid tolerance development**: Short-term tolerance to both physical and psychological effects develops quickly, making daily or compulsive use pharmacologically impractical
...
The practical consequence of rapid tolerance development is that dosages may need to increase for subsequent uses, but this escalation is limited by the ceiling effect of the psychedelic experience and the inherently self-limiting nature of repeated dosing.

### Cross-Tolerance with LSD

The EMCDDA classified psilocybin and psilocin as indolealkylamines (tryptamines), belonging to the same broad chemical group as LSD (an ergoline). Because of this shared pharmacological action at serotonin receptors, particularly the 5-HT2A receptor subtype, cross-tolerance exists between psilocybin mushrooms and other classic hallucinogens, most notably LSD.

A user who has recently taken LSD will find that mushrooms produce significantly reduced effects, and vice versa. This cross-tolerance has practical implications for recreational users who might alternate between substances and find both diminished. It also has implications for clinical research settings where tolerance management must be considered in study design.

### Tolerance Duration and Recovery

The EMCDDA data implied that tolerance is short-term in nature, recovering over a period of days rather than weeks. This distinguishes mushroom tolerance from the long-lasting or permanent tolerance changes associated with some other substance classes. The practical consequence is that mushroom users typically space their experiences by at least several days to allow tolerance to dissipate, a natural pattern that further limits the potential for habitual use.

## Low Rate of Regular Use

The EMCDDA data consistently showed that regular or frequent use of hallucinogenic mushrooms is rare across all survey types and geographic contexts:

### Current User Proportions

Among those who had ever used hallucinogenic mushrooms, the proportion who continued to use them regularly (defined as use during the last month) was lower than for both cannabis and ecstasy. This differential dropout rate suggests that a significant proportion of mushroom experimenters choose not to continue use, unlike the more persistent use patterns seen with other substances.

### Dutch Risk Assessment Findings

The 2000 Netherlands risk assessment report, one of the most thorough examinations of mushroom use patterns, noted that hallucinogenic mushrooms "tend to be taken as an experimental drug and people generally discontinue use after a few times." This characterization of mushrooms as predominantly experimental was supported by the broader epidemiological data showing low current-use rates relative to lifetime-use rates.

### Qualitative User Feedback

Dutch qualitative research provided insight into why users do not persist with mushroom use: they "do not find the use of hallucinogenic mushrooms a particularly pleasant experience as the experience lacks the positive mood altering (entactogenic) effects that ecstasy provokes." The term "entactogenic," derived from Greek, describes the specific positive mood-altering effect that allows users to feel contact with their own emotions and those of others. The absence of this quality in the mushroom experience reduced its appeal as a social or recreational substance.

## Comparison with Other Recreational Substances

### Versus Ecstasy (MDMA)

The EMCDDA drew a specific comparison between hallucinogenic mushrooms and ecstasy. While lifetime prevalence of mushroom use equaled or exceeded ecstasy use among school students in nine EU countries, the patterns of continued use diverged significantly:

- Ecstasy's entactogenic effects created stronger motivations for repeat use than the perceptual distortions produced by mushrooms
- Ecstasy's convenient tablet form made it easier to use in social settings compared to mushrooms that must be chewed or brewed
- The Mixmag survey found that among the 305 individuals who had used hallucinogenic mushrooms, over half planned to take them again, but this retention rate was lower than typically observed for ecstasy users

### Versus Cannabis

Prevalence of hallucinogenic mushroom use was consistently much lower than cannabis across all EU Member States. Cannabis lifetime prevalence among persons aged 18-36 ranged from 15% (Poland) to 45% (Denmark), while mushroom lifetime prevalence among young adults ranged from less than 1% to 8%. The relaxing properties of cannabis, combined with its less intense psychological effects and greater social acceptability, supported more frequent use patterns.
...
The EMCDDA identified the inherent self-limiting properties of mushroom use as one of the key "barriers to diffusion" that prevented the emerging trend from becoming more widespread:
