---
title: "Soil Chemistry: pH, CEC, and Base Saturation"
created: 2026-04-26
updated: 2026-04-24
...
The term pH stands for "potential hydrogen." A soil's pH is a measurement of the number of
hydrogen ions (H+) in the soil solution, expressed on a logarithmic scale from 1 (very acidic) to
10 (very alkaline), with 7 being neutral. The pH scale is logarithmic, meaning that each whole
number change represents a tenfold difference. A soil at pH 8 is ten times more alkaline than a
soil at pH 7.

Water molecules are often split into hydrogen ions (H+) and hydroxyl ions (OH-) by chemical
reactions in the soil. The hydroxyl ions go into the water solution, but the clay and organic
matter in the soil attract the hydrogen ions, making the soil more acidic. At some point, the
hydrogen ions take up all the available sites on soil particles, and nutrient ions can no longer
stick to the soil. The hydrogen ions then go into solution only when there is no more capacity in
the soil to hold them.

Somewhere around neutral, a pH of 7, seems best for most garden plants. However, you cannot
change the pH of a soil instantly. It takes time because chemical reactions within the soil can
continue to produce hydrogen ions that lower the pH. It is only after the buffer acid ions are
used up that the pH can be raised. This is the case when there are excess aluminum ions in the
soil, which react with water and release hydrogen ions.

## pH Effects on Nutrient Availability

The pH chart found in seed catalogs and botany books shows the impact of soil pH on the
availability of essential plant nutrients. The pH has a strong influence on nutrient
availability, particularly that of phosphorus.
...
weak acid that breaks apart some water molecules in soil. In organic soils and soils with lots
of clay, the hydrogen cation is tied up, leaving the hydroxyl anion in solution. This causes the
percentage of hydrogen ions, the measure of acidity, to go down. Applications of organic matter
generally increase the pH.

In a natural system, the plant controls its rhizosphere pH. Plants synthesize and release exudates
of various components that adjust the pH. Acidic exudates attract fungi and alkaline ones attract
bacteria. The plant has a lot of control over the pH of the soil in which it grows, because pH
is important to how and whether nutrients are available.

## Correcting pH

The usual recommendation for acidic soils is to apply finely ground calcitic limestone (CaCO3) or
dolomitic limestone (CaMg[CO3]2). Calcitic lime is used for soils with high magnesium levels and
dolomitic lime for soils low in magnesium. The rate of application is directly related to the
buffering pH of the soil, so a soil test is very important. The limestone binds with hydrogen ions,
and the end product is carbonic acid (H2CO3), which further breaks down into carbon dioxide (CO2)
and water (H2O).

Correcting alkaline soils usually involves applications of sulfur and water, which becomes sulfuric
acid. The acid reacts with the soil chemicals and becomes gypsum (CaSO4).
...
A soil with higher clay and humus contents will have a higher cation exchange capacity. In
general, the higher the cation exchange capacity, the higher the soil fertility. Clay and organic
matter have vast surface areas covered with negative electrical charges. Plant nutrients that are
cations (positively charged ions) are attracted to and attach to these negative sites on soil
particles.

The cation exchange capacity is a measure of how many negatively charged sites are available in
a particular soil. CEC ranges from 0 to 100, the latter being pure humus with lots of cations.
The CEC test is important for determining how much calcium, magnesium, potassium, and nitrogen
in the form of ammonium is available in the soil. Too much calcium can induce magnesium
deficiency. Too much potassium has negative effects on magnesium uptake. Excessive magnesium
isn't good for calcium availability.

Root cells pump out hydrogen ions (H+) to help transport nutrient molecules across the cellular
membrane. These ions accumulate on the cell walls of root hairs, where they often come into
contact with charged soil particles. The hydrogen ions exchange locations with the cations. Once
the new cation attaches to the cell wall, it can travel the apoplastic pathway or enter the cell
via the symplastic pathway.
