...
Fungal parasitism spans the full spectrum of host organisms:
...
- **Physical barriers**: Cuticle, cell wall, callose deposition at infection sites
- **Chemical defenses**: Phytoalexins (antimicrobial compounds synthesized after infection), saponins, glucosinolates
- **Pattern recognition**: Plants detect fungal PAMPs (pathogen-associated molecular patterns) via membrane receptors, triggering PTI (PAMP-triggered immunity)
- **Gene-for-gene resistance**: R genes recognize specific fungal avirulence (Avr) genes, triggering ETI (effector-triggered immunity). Basis of many resistant crop varieties
- **Endophytes**: Beneficial fungal endophytes can provide systemic resistance against pathogens (see [[endophytic-fungi]])
...
- Particularly dangerous for HIV/AIDS patients (CD4 count < 100)

**Dermatophytes (Ringworm)**
- Trichophyton, Microsporum, Epidermophyton species
- Superficial infections of skin, hair, and nails (tinea)
- **Athlete's foot** (tinea pedis), **jock itch** (tinea cruris), **ringworm** (tinea corporis), **nail fungus** (onychomycosis)
- Most common fungal infections globally. Affect 20-25% of the world's population
- Keratinolytic — digest keratin in skin, hair, nails

**Pneumocystis jirovecii**
- Causes Pneumocystis pneumonia (PCP) in immunocompromised patients
- Was the most common AIDS-defining illness before ART
- Cannot be cultured in vitro — classified as a fungus in 1988 based on molecular data

**Mucorales (Mucormycosis)**
- Rhizopus, Mucor, Lichtheimia species
- Rapidly progressive, often fatal infections (mucormycosis / "black fungus")
- Risk factors: diabetic ketoacidosis, neutropenia, iron overload, deferoxamine therapy
- COVID-19-associated mucormycosis: Major outbreak in India (2021) in diabetic COVID patients
- Requires surgical debridement plus antifungal therapy (amphotericin B)

### Antifungal Drug Classes

| Drug Class | Mechanism | Key Drugs | Major Target |
|-----------|-----------|-----------|-------------|
| Polyenes | Bind ergosterol, form pores | Amphotericin B, nystatin | Systemic infections |
| Azoles | Inhibit ergosterol synthesis | Fluconazole, itraconazole, voriconazole | Broad spectrum |
| Echinocandins | Inhibit beta-1,3-glucan synthesis | Caspofungin, micafungin | Candida, Aspergillus |
| Pyrimidine analogs | Inhibit DNA/RNA synthesis | Flucytosine | Combined with amphotericin |
| Allylamines | Inhibit squalene epoxidase | Terbinafine | Dermatophytes |

**Antifungal resistance** is a growing global health threat:
- Azole-resistant Aspergillus fumigatus emerging due to agricultural azole fungicide use
- Multidrug-resistant Candida auris spreading in healthcare facilities worldwide
- Limited drug pipeline — only 3 new antifungal drug classes in 20 years (vs. dozens of new antibacterials)

## Entomopathogenic Fungi

Fungi that infect and kill insects are critical natural regulators of insect populations and increasingly important as biocontrol agents.
...
- Commercial biocontrol products available for termites, grasshoppers, beetles, and other pests

**Beauveria bassiana**
- Similar life cycle to Metarhizium. One of the most widely used biocontrol fungi
- Commercial formulations: BotaniGard, Naturalis, Mycotrol
- Effective against whiteflies, thrips, aphids, beetles, and other soft-bodied insects
...
## Mycoparasites (Fungi That Parasitize Fungi)

### Trichoderma Species

- Aggressive mycoparasites that attack other fungi
- Mechanisms: Enzymatic degradation of competitor cell walls (chitinases, glucanases), antibiotic production, competition for nutrients and space
- **Biocontrol agents**: T. harzianum and T. viride are widely used commercial biocontrol products against plant pathogenic fungi (Rhizoctonia, Fusarium, Pythium)
- Also promote plant growth through root colonization and induced systemic resistance

### Other Mycoparasites

- **Ampelomyces quisqualis**: Parasitizes powdery mildew fungi. Commercial biocontrol agent
- **Sporidesmium sclerotivorum**: Parasitizes Sclerotinia sclerotiorum. Attacks the overwintering sclerotia
- **Pythium oligandrum**: Mycoparasitic oomycete used as a biocontrol agent against Pythium and Phytophthora species

## Ecological Significance

- **Population control**: Fungal pathogens regulate populations of plants, insects, and other organisms in natural ecosystems
- **Biodiversity**: By preventing any single species from dominating, fungal pathogens maintain species diversity (Janzen-Connell hypothesis in tropical forests)
- **Nutrient cycling**: By killing organisms and decomposing their remains, fungal parasites accelerate nutrient turnover
- **Evolutionary pressure**: Host-pathogen coevolution drives genetic diversity in both fungi and their hosts
...
- [[mushroom-contamination-troubleshooting]] for fungal contaminants in cultivation
