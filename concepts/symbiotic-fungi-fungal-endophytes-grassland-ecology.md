...
## [[root-exudates]] and Synergistic Interactions
...
Carbon flow through the mycorrhizosphere can be described as a conceptual model with
carbon pools (plants, roots, AM fungi, saprophytic microorganisms, soil organic matter)
connected by transfer arrows. The amount of recently assimilated carbon retained in each
pool can be estimated using 13C-labelling techniques.
