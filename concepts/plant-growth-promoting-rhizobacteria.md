...
colonize the rhizosphere and, when applied to seeds, roots, or soil, stimulate
...
surface (rhizoplane) without entering root tissues. Intracellular PGPR (iPGPR)
enter root cells and form endophytic associations. Common ePGPR genera include
...
siderophore types produced by PGPR include pseudobactin (Pseudomonas),
bacillibactin (Bacillus), and enterobactin (Enterobacter).
## Phytohormone Production
PGPR produce phytohormones that directly influence plant growth and
development. Indole-3-acetic acid (IAA) is the most common auxin produced by
PGPR and stimulates root elongation, lateral root formation, and root hair
...
ethylene), reducing ethylene levels in roots. Lower ethylene levels alleviate
