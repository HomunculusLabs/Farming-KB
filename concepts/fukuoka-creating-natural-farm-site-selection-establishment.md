---
title: Creating a Natural Farm - Site Selection and Establishment
...
format: epub
chars: 272157
tags: [fukuoka, natural-farming, farm-establishment, site-selection, soil-building, protective-forest, windbreak, orchard-design, agroforestry, temperate-zone]
...
### Indicators of Good Land

- Large trees growing densely on surrounding hills
- Deep, dark soil (black or dark brown color)
- Clean water from springs, streams, or rivers
- Diverse plant and animal life indicating ecological health
...
Bamboo is exceptionally valuable: grows to full height in one year, produces edible shoots, provides lightweight building material, and decomposes slowly when buried — holding water and air in soil while improving structure.

## Creating a Natural Orchard

### The Thinning Approach

Cut trees in stages rather than clearing. Leave all trunks, branches, and leaves to decay. Pile trimmings along contour lines as improvised terraces. Never use bulldozers — they scrape off irreplaceable topsoil.

### Why Bulldozers Destroy Soil

1. **Topsoil removal**: Organic-rich surface scraped away
2. **Compaction**: Heavy machinery compacts subsoil, causing groundwater stagnation
3. **Soil atrophy**: Ridge soil hardens, microorganisms die
4. **Long-term decline**: Cleared fields dry out and lose value within ten years

### Soil Fertility Timeline

- 12 inches of topsoil sustains an orchard ~10 years without fertilizer
- 3 feet of rich earth sustains ~30 years
- With nitrogen-fixing cover (white clover, beans, vetch): indefinitely

## Creating Fields Within the Orchard

Spaces between fruit trees function as fields. No clearing or ground preparation needed.

- **Year 1 Summer**: Green manure and buckwheat
- **Year 1 Winter**: Radishes and mustard
- **Year 2 Summer**: Adzuki beans and cowpeas (twining, reproduce without fertilizer)
- **Year 2 Winter**: Hairy vetch
- **Later years**: Wide variety of crops as soil matures

## Paddy Fields

Trees can be grown within paddy fields on mounds. Thailand's Sukhothai paddies exemplify this — trees, draft animals, fish, and amphibians in a harmonious system. Rice grows in dry fields watered only by rain, with weeds controlled through no-plowing, straw mulch, and continuous white clover.

## Windbreak Species

Fast-growing varieties: Japanese cedar, hinoki cypress, [[acacia]], camphor. Slow-growing but beneficial: camellia, parasol fir, strawberry tree, star anise. Region-specific: evergreen oak, Japanese cleyera, holly.

## References

- Masanobu Fukuoka, *Sowing Seeds in the Desert*, Chelsea Green Publishing
- Larry Korn (editor), Appendix A compilation
## See Also
