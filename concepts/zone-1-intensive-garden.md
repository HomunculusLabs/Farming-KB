...
Permaculture organizes a landscape into zones based on frequency of use and the frequency of care needed. The overall strategy is to place those elements that require the most attention closest to where we live:

- **Zone 1**: Intensive; most visited and cared for. Herbs, greens, flowers, dwarf trees, patio, greenhouse, rain barrels, bird feeders, small ponds, greywater
- **Zone 2**: Less intensive; visited regularly. Berries, useful shrubs, pond, chickens, food forest, cover crops, spot mulch
- **Zone 3**: Farm zone; visited occasionally. Large fruit and nut trees, cover crops, animal feed storage
- **Zone 4**: Minimal care. Firewood, forage, wild harvest, pasture, native plants
- **Zone 5**: Wild; unmanaged. The instruction manual for the ecological garden, where we observe and learn

Choosing the zone for each element depends on two things: how often we need to visit the plant, and how often it needs us.

## What Goes in Zone 1

Zone 1 contains the elements of daily life: herbs snipped for cooking, salad greens picked for dinner, cherry tomatoes grabbed for a snack. It also includes:

- Intensively weeded and mulched garden beds
- Trellises, arbors, and espaliered fruit trees
- Dense plantings of vegetables and flowers
...
Zone 1 receives the highest level of management: intensive weeding, dense planting, espaliering, daily food harvest, and frequent mulching. The key is that this intensity is focused on a small area close to the house, making it efficient rather than exhausting. A cup of coffee in one hand, a pair of snips in the other, and a five-minute stroll through Zone 1 yields dinner.
