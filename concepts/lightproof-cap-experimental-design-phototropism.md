...
**Condition one (untreated control):** No barrier was applied to the seedling.
It bent normally toward the light, confirming that the experimental conditions
were appropriate for observing phototropism and establishing the expected
response baseline.

**Condition two (tip removed):** The coleoptile tip was cut off with a sharp
