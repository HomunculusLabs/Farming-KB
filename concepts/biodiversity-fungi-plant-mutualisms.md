...
- **Desert adaptations**: Desert sequestrate fungi (Carbomyces, Terfezia, Tirmania) are adapted for passive wind dispersal, with ascomata that disintegrate into spore-bearing powder as they dry

## Knowledge Gaps

- The full diversity of mycorrhizal fungi is unknown, especially in tropical ecosystems
- Ectomycorrhizal succession on root systems over time is poorly documented
- The functional significance of different mycorrhizal types varies by ecosystem and is incompletely understood
- Molecular methods are revealing far greater diversity of mycorrhizal fungi than can be detected by sporocarp surveys alone
...
Further research on biodiversity fungi plant mutualisms continues to advance our understanding of this field. Contemporary studies build upon the foundational work described above, incorporating modern molecular techniques, genomic analyses, and ecological modeling approaches.
