...
Cannabinoid receptors (CB1 and CB2) are present and regulated in human retinal pigment epithelial cells (Wei et al., 2009, Molecular Vision). This suggests a role for the endocannabinoid system in retinal health and potential therapeutic applications.
...
- **Curcumin**: Broad anti-inflammatory and antioxidant effects (Goel et al., 2008)

## Clinical Considerations

### The Dosing Challenge
The primary limitation of cannabis for glaucoma is that the IOP-lowering effect lasts only 3-4 hours, requiring dosing 4-8 times per day. This frequent dosing schedule can be difficult to maintain and may produce undesirable psychoactive effects.
