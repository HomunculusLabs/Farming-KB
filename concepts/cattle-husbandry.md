...
- **Highland** — Long-haired, extremely cold-hardy. Lean meat, good on rough
  terrain. Excellent browsers.
- **Devon** — Red, hardy, good on grass. Original dual-purpose breed.
...
- Design handling facilities with curved chutes (solid sides), no sharp
  corners, and good lighting.
- Essential infrastructure: head catch/squeeze chute, alley, holding pen,
  loading chute.
...
- Breeding season: aim for 60-90 day calving window for management
  efficiency.
...
- More consistent marbling, faster weight gain, shorter time to harvest.
