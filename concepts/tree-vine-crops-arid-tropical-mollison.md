---
title: Tree Vine Crops Arid Tropical Mollison
created: 2026-04-19
updated: 2026-04-19
type: concept
tags: [reference]
...
- Fig iii (Ficus platypoda) -- Fruit and graft stock for cultivars
- Emu apple (Owenia acidula) -- Edible fruit, emu forage

### Legumes for Interplanting
- Centrosema pubescens -- Brings up moisture to topsoil (Yeomans)
- Pueraria spp. -- Aids surface moisture
- Leucaena -- Frost-free areas
- Tree lucerne (Chamaecytisus proliferus) -- Fire and frost resistant, stock and poultry fodder
- Mulga (Acacia aneura) and native acacias
- Acacia albida -- "Wet deciduous" in monsoon, hardy, poultry fodder
- Mesquites (Prosopis spp.)

## Pest Management

Natural controls for tropical and arid pests:

- Marigold (Tagetes) for eelworm -- 90% effective control
- Datura Lily (Brugmansia) for cabbage moth -- larvae attracted but do not pupate
- Wallflower extract (blended and sprayed) for cabbage moth
...
- Poultry for fruit fly and termites
- Moloch horridus (Mountain Devil) for ants
- Guinea fowl as general pest controllers
...
- Mollison, B. Permaculture Two: Practical Design for Town & Country in Permanent Agriculture. Tagari Books, 1979. Chapter 5.

#permaculture #tree-crops #arid-zone #tropical-agriculture #species-selection #carob #mulberry #native-species
