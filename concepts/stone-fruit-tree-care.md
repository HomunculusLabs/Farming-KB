...
- See [[apple-tree-care]] for contrasting pruning approach
...
- At planting: Cut whip to 24-30 inches; select 3-4 scaffold branches at wide angles
- Year 1: Remove central leader, leaving an open vase shape
- Year 2-3: Develop 3-5 primary scaffolds evenly spaced around the trunk
- Mature trees: Renew fruiting wood annually by removing 1/3 of older branches
...
- Head back long shoots to encourage lateral branching
- Paint all pruning cuts larger than 1 inch with wound sealant or latex paint (bacterial canker prevention)

### Chill Hours
- Peaches require 500-1000+ chill hours (hours below 45F) to break dormancy properly
- Insufficient chill: delayed bloom, poor fruit set, reduced fruit quality
- Too many chill: early bloom, increased frost risk
- Low-chill varieties (400-500 hours): Florida Prince, TropicSnow, Gulfcrimson — for zones 8-9
- Medium-chill (700-800 hours): Elberta, Red Haven, Georgia Belle — zones 6-7
- High-chill (800-1000+): Contender, Reliance — zones 5-6

### Thin Fruit
- Thin to 6-8 inches apart when fruit is marble-sized
- Peaches bear heavily — excess fruit causes small size and branch breakage
- Neglected thinning leads to broken branches (peach limbs are brittle)

## Plums (Prunus spp.)

**Japanese plums** (zones 5-9): Red, yellow, black; larger, juicier; bloom early. Varieties: Santa Rosa, Methley, Burbank. Require cross-pollination.
**European plums** (zones 4-8): Blue/purple, oval, better for drying; bloom later. Varieties: Stanley, Damson, Green Gage. Mostly self-fertile.
**American hybrids** (zones 3-8): Hardier, disease-resistant. Varieties: Toka, Superior, Pipestone. Partially self-fertile.
...
- Gumming (amber-colored sap oozing from cankers)
- Dead twigs and branches
- Blossom blast: sudden death of flower clusters
- Leaf spots that turn brown and drop out (shot-hole effect)
...
- Adequate chill ensures uniform bud break, normal flowering, and good fruit set
- Insufficient chill: delayed and prolonged bloom, reduced fruit set, small fruit, dieback
