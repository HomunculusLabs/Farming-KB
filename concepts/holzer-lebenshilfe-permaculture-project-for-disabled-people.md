...
- **Touch:** Different natural materials (stone, wood, and water)

The sensory garden is constructed with a view of the Mediterranean garden. The rocks are placed irregularly and raised beds provide structured growing areas. The remaining work is mostly carried out by hand.
...
- **Rest areas with seating**: Multiple rest areas are positioned at regular intervals throughout the garden, with seating at varying heights and orientations. Some rest areas are sheltered, allowing use in varied weather conditions.
- **Signage and wayfinding**: Clear, pictorial signage helps participants navigate the garden independently. Signs use symbols, colours, and textures rather than relying solely on text.
- **Sensory orientation features**: Distinct plantings, textures, and scents mark transitions between garden zones, helping visually impaired visitors orient themselves.

## Therapeutic Benefits Documented

The therapeutic benefits observed through the project span multiple dimensions:
- **Physical rehabilitation**: Natural movement patterns in the activity garden improve balance, coordination, and motor skills more effectively than repetitive clinical exercises because they are engaging and purposeful. Participants are motivated to navigate challenging terrain because the destination (a beautiful garden feature) provides intrinsic reward.
- **Psychological wellbeing**: Contact with living plants and natural environments has been shown to reduce anxiety, depression, and agitation. The nurturing role of caring for plants provides a sense of purpose and competence. Participants report increased self-esteem and feelings of contribution.
- **Social integration**: Shared gardening tasks create natural opportunities for cooperation, communication, and relationship-building. The project brings together participants with different disabilities, creating a supportive peer community. Family members report improved social skills and greater emotional expressiveness after regular participation.
- **Cognitive stimulation**: Learning plant names, understanding seasonal cycles, following multi-step gardening tasks, and planning harvest activities all engage cognitive functions. The garden provides a concrete, hands-on learning environment that is more accessible than abstract classroom settings.
- **Sensory regulation**: The sensory garden provides controlled, graduated sensory experiences that help participants with sensory processing difficulties develop tolerance and integration skills. The natural environment offers a wider and more nuanced range of sensory inputs than clinical sensory rooms.
