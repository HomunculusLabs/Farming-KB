...
goal of double-digging is not the height of the bed, but the looseness
and good structure of the soil.

## How Surface Cultivation Works

Surface cultivation involves loosening the upper 2 inches of the
growing bed with a cultivating tool instead of performing a full
double-dig. This shallow cultivation is sufficient for ongoing bed
maintenance between crops, especially for established beds where the
deeper soil structure is already well developed.

When surface cultivation is used, compost made without soil should be
applied, because soil is not being removed from the bed during the
soil preparation process. In standard double-digging, 7 5-gallon
buckets of soil are removed from the first trench and used to make
compost and flat soil. With surface cultivation, this soil removal
does not occur, so soil-free compost is needed to maintain proper
carbon ratios.

## Testing for Good Soil Structure

A simple field test determines whether your soil has good enough
structure to transition to surface cultivation:

1. Take a sample of reasonably moist soil.
2. Squeeze the sample firmly in your hand.
3. Open your hand and observe the results.

**Poor structure indicators:**
- If the soil falls apart easily when you open your hand, it does not
  have good soil structure.
- If the soil holds the shape of your hand even when you press it
  gently with your fingers from your other hand, it does not have good
  soil structure.

**Good structure indicator:**
- If the soil breaks apart into small clumps when you press it with
