---
title: Soil Rehabilitation Strategies
...
The mulched and continuously cropped soils showed dramatically improved aeration. Soil temperatures were lower by 10°C, crop grain yields increased, and organic matter production tripled compared to burned or conventionally cultivated soils.
...
Water retention gels that absorb and release water over many rain cycles can supplement natural soil water-holding capacity, though this is practical only for gardens or high-value tree crops where the cost amortizes over time.

### 2. Soil Conditioning

Compacted, collapsed, and eroded soils require rehabilitative aeration and a fundamental change in land use. The conditioning process aims to restore the physical structure of soil so that air, water, and roots can move freely through the profile.

### 3. Fertilization

Once undisturbed soil systems and permanent crops are established, wasteful or polluting fertilization can be reduced and replaced with sensible trace element adjustment via foliar sprays. Foliar application of very small amounts of key elements greatly assists plant establishment, as does [[seed-pelleting]] using elements found to be locally deficient. Legume-based interplant systems and green manures can supply nitrogen for food crops, while much of the phosphate locked up in clays can be made available through biological processes.
...
1. **Shaping the earth**: Raising or lowering beds to facilitate watering or drainage, and leveling bed surfaces where needed.
2. **Amending the soil**: Mixing compost or humus materials into the soil, and supplying clay, sand, or nutrients to bring the soil into balance.
3. **Mulching**: Applying surface mulch to reduce water loss, moderate temperature, and prevent erosion.

By these methods, productive soils can be created anywhere. Accessory systems include growing compost materials as hedgerows, herbs, or dedicated plots, and using trellis, shadecloth, glasshouses, and trickle irrigation to regulate wind, light, and heat effects on specific crops.
