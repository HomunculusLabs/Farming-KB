---
title: Fungal Biodegradation of Synthetic Pollutants
created: 2026-04-13
updated: 2026-04-13
type: concept
tags: [mycology, fungi]
...
- **Fungal species**: White-rot basidiomycetes (Phanerochaete, Trametes, Pleurotus) are generally most effective
- **Nutrient status**: Nitrogen limitation often induces ligninolytic enzyme production
- **Environmental conditions**: Optimal temperature, moisture, and pH vary by species
- **Pollutant concentration**: Very high concentrations can be toxic; very low concentrations may not induce enzyme systems
- **Bioavailability**: Pollutants bound to soil organic matter or trapped in aggregates are less accessible
- **Co-substrates**: Presence of natural organic matter can enhance co-metabolic degradation

## Limitations

- Ligninolytic enzymes are sensitive to environmental conditions
- Competition with native microorganisms can reduce fungal establishment
- Scale-up from laboratory to field has inconsistent results
- Some degradation products may be more toxic than parent compounds
- Regulatory approval for deliberate release of fungi is complex
