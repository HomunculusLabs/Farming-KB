...
Key rule: When increasing JHS, always increase JWA together. More JWA = more wetting power = stronger pesticide.

### JADAM Sulfur (JS)
| Context | JS Volume | Notes |
|---------|----------|-------|
...
## Complete Pesticide Programs (per 500L)
