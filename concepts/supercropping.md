...
The most common supercropping method involves gently squeezing and crushing the stem between thumb and forefinger at the point where you want the branch to bend. This crushes the inner tissue (the xylem and cambium) while leaving the outer bark intact. The branch can then be bent to a horizontal or downward position. The crushed area will heal and form a thickened knuckle that is actually stronger than the original stem.

Steps for stem crushing:
1. Select a branch that is at least 6-8 inches long and still flexible
2. Locate the point on the stem where you want the bend to occur
3. Gently squeeze the stem between thumb and forefinger, rolling it back and forth
4. Apply enough pressure to crush the inner tissue -- you will feel it soften
5. Do not break the stem completely; the outer bark should remain intact
6. Slowly bend the branch to the desired position (horizontal or downward)
7. Secure in place with a soft tie if needed

### Branch Breaking

Cervantes notes that some supercroppers go further, "breaking branches a few inches below main buds." This more aggressive approach involves actually snapping the branch partially and allowing it to heal in a new position. The break should not completely sever the branch -- some tissue connection must remain for fluid transport.
...
- Increased lateral branching: creates more bud sites per plant
- Height control: bent branches stay low, keeping plants manageable
- Stronger stems: healed knuckles support heavier buds
- No equipment needed: performed with fingers alone
- Can increase overall yield when done correctly on vigorous plants

## Risks and Cautions

- Overdoing it can severely stunt growth and reduce yield
- Open wounds invite pathogens -- sanitize hands before handling
- Broken branches that lose all fluid connection will die
- Stressed plants may exhibit hermaphroditic tendencies
- Recovery time delays flowering schedule
- Not suitable for autoflowering strains with limited vegetative time

## Best Practices

- Work on healthy, vigorously growing plants only
