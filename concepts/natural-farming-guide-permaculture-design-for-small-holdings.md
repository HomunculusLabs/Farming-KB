...
Sustainable systems are circular rather than linear. Used items go back to their source for natural recycling, using very little energy. When each resource is valued rather than exploited, an excess of resources is the natural result.
...
11. Use native species whenever possible; proven exotics second
12. Use local materials for building
13. Systems should require low maintenance and very little work
...
Sectors are outside influences (energies) affecting land use: sun, wind, fire, flood, water flow, wildlife, noise, pollution, views, and access. Map these on the property plan. Place elements to work with sectors: windbreaks where windy, flood-tolerant trees where wet, gardens where sunlight is right, fire-resistant vegetation in fire zones, ponds between fire danger and the house.

## Ecological Succession

Natural land progression occurs in three stages. Understanding this accelerates soil building:

Stage 1: Broad-leaved pioneer plants (often thorny) spread quickly to cover and protect soil, adding minerals.
Stage 2: Herbs and shrubs grow, some edible, outcompeting pioneers over time.
Stage 3: Trees grow when shrubs and herbs have created a beneficial environment. They shade pioneers, which die and fertilize the soil.

In a regular garden, everything is kept at Stage 1 through constant weeding, fertilizing, and tilling. Permaculture accelerates natural succession instead, using less energy to get more food.

## Swales for Water Management

A swale is a long, shallow ditch 3-5 feet across that stops and channels water into the soil (unlike a regular ditch that carries water elsewhere). Swales lie across slopes; water is forced into soil and absorbed by trees planted along them. They can be filled with rock, gravel, or gypsum for better water absorption.

Building swales: Multiple swales are placed together along the slope contour. The second swale is placed 10-60 feet from the first, depending on annual rainfall. After rainfalls soak deeply, plant trees directly behind the dirt mound. In wet climates, plant heavily between swales; in dry climates, only at swale edges. Trees take 3-10 years to fully mature.
