...
exogenous compounds. The name derives from the characteristic absorption at 450
nm when the reduced (Fe2+) enzyme binds carbon monoxide. First identified by
Martin Klingenberg and David Garfinkel in 1958 and formally characterized by
Tsuneo Omura and Ryo Sato in 1962, the CYP superfamily is one of the largest
...
toxicology, CYPs bioactivate procarcinogens: aflatoxin B1 to DNA-reactive
epoxides (CYP3A4/1A2), benzo[a]pyrene to BPDE (CYP1A1), and NDMA via CYP2E1. The
acetaminophen paradigm illustrates this: CYP2E1 generates NAPQI, normally
detoxified by glutathione; in overdose, GSH depletion leads to centrilobular
necrosis. NAC is the antidote.
## Drug Interactions, Evolution, and Applications
Major CYP-mediated interactions include terfenadine-ketoconazole (QT
prolongation, terfenadine withdrawn), cisapride-macrolides (fatal arrhythmias),
simvastatin-CYP3A4 inhibitors (rhabdomyolysis), warfarin with CYP2C9
inhibitors/inducers, and rifampin with oral contraceptives (contraceptive
failure). The CYP superfamily originated over 3.5 billion years ago with
