...
microorganisms. Exudate composition changes with plant age, health status, and
even in response to pathogen attack, allowing the plant to selectively attract
microbial allies when needed most.

## Bacterial Colonization of Root Surfaces

Bacteria are the most numerous organisms in the rhizosphere, with populations
reaching 10^9 to 10^10 cells per gram of soil near root surfaces, compared to
10^5 to 10^6 cells in bulk soil. This dramatic increase is called the
rhizosphere effect. Bacteria colonize the rhizoplane, the root surface itself,
forming biofilms that create a living interface between the root and the soil.
Different bacterial species occupy specific niches: some adhere tightly to the
root epidermis, while others occupy the mucilage layer or the surrounding soil
matrix. This spatial organization is critical for efficient nutrient exchange
...
## Nutrient Exchange at Root Surfaces
