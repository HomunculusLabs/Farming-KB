...
1. Improves soil ventilation: Fields recover fertility and soil
   becomes soft and fluffy when IMO mixed with LAB is sprayed on the
   field.

2. Enhances livestock digestion: LAB (1:500) with FPJ (1:300) used
   as drinking water for livestock helps recover their digestive
   function.

3. Enlarges fruits and leaves: LAB is extremely effective in making
...
6. Increases fertilizer solubility: LAB increases the solubility of
   fertilizers, making nutrients more available to plants.

7. Neutralizes ammonia gas: LAB reduces damage from gas by
   neutralizing ammonia produced where immature compost is applied.

8. Solubilizes phosphate: At 100-200 ppm concentration (100-200 ml
   LAB in 1000 ml water), LAB helps soil absorb insoluble phosphates
   and overcomes saline disorder from phosphate decomposition.

9. Fungal resistance: LAB has power to resist some fungi, providing
   temporary protection for crops.

10. Enhances anabolism: LAB reinforces the anabolic ability of
    microbes living on plant stems and leaves, a condition that
    arises from the abuse of insecticides and fungicides. When using
    LAB alone, it is more effective when combined with FPJ.
...
1. Keep refined LAB serum at cool temperature (1-15 degrees C) for
   longer storage periods.
2. Never store under direct sunlight.
3. For room temperature storage, mix with equal amount of brown sugar
   and stir with a wooden stick to extend shelf life.
4. The use of rice-washed water in obtaining LAB ensures that only
   the strongest bacteria survive, resulting in a more potent and
   resilient final product suitable for diverse agricultural
   applications.
