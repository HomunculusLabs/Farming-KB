...
- **Morphological part**: Caps and stems differ in alkaloid concentration,
  with caps typically being more potent in psilocybin content.

## Implications for Dosage and Safety

The finding that psilocybin and psilocin content can vary by a factor of four
or more even under tightly controlled growing conditions — and by over tenfold
in uncontrolled settings — has direct consequences for dosage estimation.
As Bigwood and Beug concluded, users have no reliable way to predict the amount
of psychoactive alkaloids they are ingesting based on dry mushroom weight
alone. This means that subjective experience variability stems not only from
the well-known influences of set-and-setting, but also from very real and
substantial differences in actual compound dosage.
