...
[[raised-bed-gardening]] methods popular in
...
The distinction between field crops and vegetables is not merely botanical but
practical:

- **Field crops** (grains, dry legumes, potatoes) are planted in rows wide
  enough to permit cultivation with a hoe or tractor, require lower soil
  fertility per unit of yield, and can be stored for months or years without
  refrigeration. They produce high calories per area.

- **Vegetables** require intensive [[crop-rotation-benefits]] are practiced.

The key insight: higher soil fertility allows closer plant spacing and higher
yields per unit area, but achieving and maintaining that fertility has real
costs. In a low-budget self-sufficiency scenario, these costs must be weighed
against the calorie returns from different cropping strategies.
...
with buckwheat seed from semi-tropical Queensland at his 41°S latitude — can
result in poor performance regardless of gardening skill.

## The Complete Recycling Model
...
2. Human and animal waste is recycled (humanure, [[cover-crops]], corn)
...
Solomon is realistic about the challenges. Complete self-sufficiency in food
production requires skills, land, tools, and time that most modern households
cannot easily assemble. His book aims to help gardeners produce as much of their
own food as practical, with the understanding that calorie self-sufficiency is
an aspirational goal that may require years of skill development and
...
Successful implementation of Solomon Self Sufficiency Calorie Production Economics requires attention to
