...
The fourfold variation under controlled conditions and tenfold variation between sources means that users have no reliable way to predict dosage from dry weight alone. This variability, combined with set and setting factors, contributes significantly to the wide range of subjective experiences reported by users of this species.
