...
- Systemic, vertically transmitted (seed-borne) grass endophytes
- Genera: Epichloe, Neotyphodium (now reclassified as Epichloe)
- Form intercellular hyphae in leaf sheaths, stems, and inflorescences
- Never produce fruiting bodies on the host — transmit only through seeds
- Produce bioactive alkaloids: lolines, ergot alkaloids, peramine, lolitrem B
- Primarily studied in cool-season grasses (fescue, ryegrass, bluegrass)
...
### Drought Tolerance
- Clavicipitaceous endophytes in grasses produce loline alkaloids that act as osmoregulators (Belesky and Malinowski 2000)
- Infected grasses show altered apoplastic carbohydrate concentrations (higher glucose and fructose)
- Endophyte-infected plants maintain stomatal function longer under water stress
- AMF (often considered root endophytes) enhance water uptake via extended hyphal networks

### Pest and Herbivore Resistance
- Alkaloid-producing endophytes deter insect herbivores and grazing animals
...
- Stimulates nitrate assimilation, solubilizes insoluble phosphates (Varma & Kharkwal)
- Upregulates nitrate reductase and starch-degrading enzyme genes (SEX1) in roots
- Enhances seed production, biomass, and stress tolerance across diverse plant species
- Dark septate endophytes produce siderophores (ferricrocin) for iron acquisition (Bartholdy et al. 2001)
...
- Basidiomycete in Sebacinaceae; axenically cultivable (rare for root endophytes)
- Colonizes inter- and intracellularly in root differentiation zone; forms chlamydospores in dead cells
- Promotes growth in Arabidopsis, tobacco, barley, and many crop species
- Potential for application in agro-forestry, horticulture, viticulture, and tissue culture establishment
- Does not require the DMI-1 gene (unlike AMF), suggesting different signaling pathway

### Dark Septate Endophytes (DSE)
- Melanized hyphae; found globally in stressed environments
- Phialocephala fortinii most studied species
- May facilitate nutrient uptake similar to mycorrhizae
- Co-occur with mycorrhizal fungi; complex interactions between communities

## Endophytes and Cannabis

Cannabis roots harbor diverse endophytic communities:
- Root interior (endorhiza) communities shaped primarily by plant genotype (Tier 2 selection)
- Core endorhiza includes fungal/actinomycete groups (Actinomycetales, Mortierellaceae)
...
- See [[cannabis-pest-management]] and [[cannabis-indoor-living-soil]]
...
3. **Use living soil approaches**: [[cannabis-indoor-living-soil]] and [[no-till-farming]] preserve endophyte networks
...
- [[fungal-symbiosis-with-plants]] — Endophytes in the symbiosis spectrum, signaling
...
- [[soil-food-web]] — Endophytes in the broader soil biology context
- [[cannabis-indoor-living-soil]] — Living soil approach that supports endophytes
