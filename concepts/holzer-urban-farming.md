---
title: Holzer Urban Farming Adaptations
created: 2026-04-14
updated: 2026-04-14
type: concept
...
Holzer demonstrates that permaculture principles can be applied on balconies, terraces, small green areas, and even inside houses. The same principles that work on a 45-hectare farm scale down to a few square metres.
...
## Liquid Fertiliser for Urban Use

The same plant-based liquid fertilisers used on the farm work on balconies:
- Neutralise odours with stonemeal or valerian
- Chamomile tea: antibacterial, prevents root diseases
- Tansy tea: effective against root lice and rust
- Source plants from countryside walks or forest edges

## Children and Nature

Holzer emphasises that children should grow up around nature even in urban settings:
- A simple window box with a radish or carrot seed can spark a lifelong connection
- The desire to discover nature exists in every child
- Parents should engage with children's discoveries rather than discouraging them
- Growing up around plants teaches causal relationships and natural cycles
