...
The most innovative mechanism described in the [[nasa-microwave-sterilization-challenge-organisms-kill-kinetics]]
...
a fundamentally new approach to [[bacillus-pumilus-radiation-resistance-surface-decontamination]].
...
for the microwaves to interact with. The [[rotational-transition-water-dipole-microwave-sterilization-physics]] generates rapid internal heating that denatures proteins and
disrupts cell membranes.

[[query-what-is-the-difference-between-bacterial-and-fungal-dominant-soil]] spores, however, present a different challenge. Spores
...
[[e-coli-pseudomonas-cepacia-microwave-susceptibility-surface-sterilization]]) showed rapid kill under microwave irradiation, Bacillus
pumilus spores — selected as a [[challenge-organisms-nasa-microwave-surface-sterilization-testing]] for their known radiation
...
topography. Unlike liquid water, which has [[bloomfield-buller-drop-surface-tension-spore-catapult-basidiospore-discharge]] that limits its
...
The system components include a [[magnetron-oscillator-microwave-sterilization]] as the microwave source,
a [[rectangular-waveguide-dipole-antenna-microwave-surface-sterilization]] for energy transport, a
[[coaxial-power-splitter-waveguide-microwave-sterilization]], and [[dipole-antenna-array-configuration-microwave-surface-sterilization]] for
