...
The best water for flushing is distilled water or water treated by reverse osmosis,
which contains minimal dissolved solids. Plain tap water containing dissolved solids is
less effective but still much better than no flushing at all. If using tap water, a
clearing solution can help chelate and remove residual nutrients. Check the pH of
irrigation water -- in dry climates it is often alkaline with a pH above 6.0; in rainy
climates it is often acidic with a pH below 6.0.

## Flushing and Nutrient Lockout

Excessive salt buildup can cause nutrient lockout -- a condition where nutrients are
present in the soil but unavailable to roots due to high salinity. Flushing is the
primary remedy for lockout. After flushing, a mild nutrient solution can be applied to
restore appropriate feeding levels. Toxic salt buildup that limits water intake by roots
also becomes a problem if pH is not managed.
