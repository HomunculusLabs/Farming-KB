...
If something is not working in the garden, it is the farmer's fault, not
Nature's. The farmer has made a mistake in soil preparation, crop choice,
timing, or management.
...
conditions thrive. Those that are poorly matched show stress through pest
and disease vulnerability.

## The Plant as Coworker

When a grower accepts the first rule, a plant bothered by pests becomes a
coworker rather than a victim. The plant is communicating that conditions
are not right for its optimum growth.

This communication should prompt investigation, not intervention. The farmer
should ask: Is the soil ready for this crop? Was the preceding crop a heavy
...
Coleman provided a systematic set of diagnostic questions for the farmer
confronted with pest or disease problems.

Is the soil ready for that crop, or should the rotation or cultural
...
Was the compost mature? Immature compost causes a wide range of problems
