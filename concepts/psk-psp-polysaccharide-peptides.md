---
title: PSK and PSP Polysaccharide-Peptides
created: 2026-04-13
updated: 2026-04-13
type: concept
tags: [reference]
...
- Improved tolerance to chemotherapy (reduced side effects)

### Mechanism of Action

PSK demonstrates multiple immunomodulatory activities:
- **Macrophage activation** — significantly increased phagocytic function
- **T-cell enhancement** — promotes lymphocyte proliferation, increases CD4+/CD8+ ratio
- **Cytokine modulation** — activates TNF-α gene transcription, modulates IL-2 and IFN-γ
- **Anti-inflammatory** — modulates excessive inflammatory responses
