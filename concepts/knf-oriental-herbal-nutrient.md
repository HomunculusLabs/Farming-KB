...
Seven herbs are used, each with specific functions:

1. **Angelica (Dong Quai)**: Restores plant vitality and promotes recovery
...
### Stage 1: Individual Herb Fermentation

For each herb (prepare separately):

1. Chop or crush the herb
2. Place in a jar
3. Add rice wine (or vodka/soju if rice wine unavailable) at 1:2 ratio (herb to alcohol)
4. Seal the jar
5. Let ferment for 7-14 days in a cool, dark place
6. Each herb produces its own extract

### Stage 2: Combine All Herb Extracts

1. After individual fermentation is complete
2. Combine all seven herb extracts into one jar
3. Add brown sugar (1:1 ratio with the combined extract)
4. Let the mixture ferment together for 5-7 more days
5. OHN is ready when well blended

### Alternative Quick Method

1. Combine all seven herbs together
2. Add alcohol at 1:2 ratio
3. Ferment 14-21 days
4. Add brown sugar and ferment 5-7 more days

## Dilution and Use

- Basic dilution ratio: 1:1,000
- For plant stress recovery: 1:500
- For pest/disease resistance: 1:500 with WSC
- Can be mixed with FPJ for general plant health
- Effective as a seed soak before planting (1:1,000)
