...
## From Where Do Nutrients Come?

The productivity of mountain forests poses a direct challenge to the fertilizer paradigm. Scientists analyze tree tissues, identify nutrient components, and conclude that these nutrients must be supplied by external inputs. But in the forest, the accounting does not work out:
...
The process by which forest soil maintains and increases its fertility without external inputs involves a chain of natural processes:
...
### Biological Soil Working
Grass roots penetrate 12 to 15 inches or more into the earth, carrying air and water deep into the soil. When these roots die, humus increases and soil microbes proliferate. Earthworms appear where there is humus, and as earthworm populations grow, moles begin burrowing through the soil.

### Companion Species Effects
When black wattle is planted among cedar or cypress, the timber trees thrive due to microbes present on the black wattle roots. This nitrogen-fixing relationship enriches the entire soil ecosystem without any human intervention.

## Contrast with Farmed Soil
...
| Soil structure | Loose, aggregated, porous | Compacted, hardened, impermeable |
| Water retention | High | Declining |
| Topsoil depth | Deepening | Thinning through erosion |
...
The process by which farmers convert living forest soil into dead mineral soil follows a predictable sequence:

1. **Tree removal**: Felling trees and carrying away all biomass (trunk, branches, leaves)
2. **Root destruction**: Pulling up roots of trees and grasses, then burning them
3. **Soil destruction**: Turning the soil over repeatedly, driving out air and essential humus
4. **Biological killing**: Reducing living soil to barren mineral matter
5. **Chemical dependency**: Planting saplings in dead soil and attempting to sustain them with fertilizer
...
Even if one wished to apply fertilizers wisely, the complexity of soil ecosystems makes this impossible. Fukuoka notes that scientists themselves acknowledge that the more they learn, "the more they realize just how awesome is the complexity and mystery of nature." The amount of research material "hidden in a single gram of soil, a single particle, is mind-boggling."

Very limited research exists on relationships between fertilizers and soil microbes. Most experiments ignore this relationship entirely, conducting tests in pots where most soil microbes die off. Results from such artificial conditions "cannot be applied to situations under natural conditions."

## The Soil Creation Timeline

The process of soil formation from bare rock illustrates the scale on which natural fertility operates. Since ancient times, rock outcroppings have been battered by the elements — first into boulders and stones, then into sand and earth. As this weathering gave rise to and nurtured microbes, grasses, and eventually towering trees, the land became buried under a mantle of rich soil.
