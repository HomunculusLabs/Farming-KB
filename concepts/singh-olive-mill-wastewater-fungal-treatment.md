...
- **Penicillium strain P4**: Produces 21.5 g dry weight per liter
  biomass on undiluted OMW after 20 days; eliminates high amounts of
  COD and phenolic content
- **Fusarium, Paecilomyces, Scopulariopsis**: Exhibit marked capacity
  for detoxification of OMW, removing antibacterial activity completely

## Immobilized Bioreactor Applications

Immobilization enhances fungal treatment performance for OMW:
...
Sequential treatment combining fungal and other processes shows enhanced
results:
- Aerobic pretreatment with P. chrysosporium followed by anaerobic
  digestion reduces phenolics and toxic aromatic compounds
- Combined A. niger and electrochemical treatment with H2O2 removes
  66 to 86% COD and 65% phenols; pilot plant achieves 75% COD removal
