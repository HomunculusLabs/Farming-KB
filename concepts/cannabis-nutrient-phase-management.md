...
Cannabis plants require nutrients in three tiers of importance. The
primary nutrients, known collectively as NPK, are Nitrogen (N),
Phosphorus (P), and Potassium (K). These are the main elements that
plants consume in large quantities and are always displayed as three
numbers on fertilizer packaging, such as 20-20-20, representing the
