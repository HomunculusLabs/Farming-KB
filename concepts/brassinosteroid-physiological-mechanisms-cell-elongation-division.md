...
Cell elongation is one of the most prominent and well-characterized effects of
brassinosteroid application. When brassinosteroids are applied to plant or
fungal tissues, cells undergo rapid extension, leading to visible increases in
organ size and overall biomass.

### Cell Wall Loosening

Brassinosteroids stimulate the activity of enzymes that modify cell wall
...
Brassinosteroids enhance the capacity of cells to generate and maintain
osmotic gradients needed for turgor-driven expansion through upregulation of
