...
2. Determine the longest expected dry period (consecutive days with
   negligible rainfall)
3. Required storage = Daily demand x Number of dry days x Safety factor
   (typically 1.2 to 1.5)
4. Verify that annual supply (from the catchment equation) meets or
   exceeds annual demand

For a household of 4 people using 150 litres per person per day during a
60-day dry period with a 1.3 safety factor:

    4 x 150 x 60 x 1.3 = 46,800 litres (approximately 47 m3)
