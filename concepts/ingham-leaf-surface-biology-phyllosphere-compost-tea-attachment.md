...
- **Smooth wax films**: Poor spray adhesion, droplets run off easily
- **Crystalline wax plates or tubes**: Better micro-droplet retention
...
(guttation peaks at dawn), and environmental conditions.

## Microbial Colonization Dynamics

Successful foliar colonization follows a sequence:

1. **Deposition**: Organisms arrive via spray application
2. **Attachment**: Adhesion to cuticle through hydrophobic interactions
   and extracellular polymer production
