...
molecular phylogenetic methods have reshaped our understanding of fungal
evolutionary relationships. Modern systematics recognizes Kingdom Fungi as a
monophyletic group more closely related to animals than to plants, comprising
...
Contemporary phylogenetic analyses based on multiple protein-coding genes
(alpha-tubulin, beta-tubulin, actin, and elongation factor 1-alpha, in
addition to ribosomal RNA genes) have resolved the broad-scale relationships
...
implications for understanding fungal evolution:
...
result of convergent evolution driven by similar ecological roles as
...
*Plasmodiophora brassicae* (cause of clubroot in crucifers), have been placed
within a protozoan lineage near alveolates.

## Phylum Chytridiomycota: The Flagellated Fungi

Chytridiomycota (chytrids) are the most basal lineage within Kingdom Fungi and
the only fungi that produce motile cells (zoospores or gametes) at some stage
in their life cycle. They possess a single posteriorly inserted smooth
flagellum, an ancestral trait shared with the opisthokont common ancestor of
fungi and animals. Chytrids are primarily aquatic organisms found in
freshwater, marine, and soil habitats, where they function as decomposers,
parasites of algae, invertebrates and other microorganisms, and occasionally
as pathogens of plants and animals.

Recent phylogenetic analyses have shown that the Chytridiomycota as
traditionally defined is not monophyletic — some chytrid lineages are more
closely related to non-flagellated fungal groups than to other chytrids. The
...
fungi that reproduce asexually through sporangiospores produced within
...
and the group remains in a state of taxonomic flux.

## Phylum Ascomycota: The Sac Fungi

Ascomycota is the largest phylum of fungi, containing approximately 64,000
described species — roughly half of all named fungal species. The defining
...
sauce production), and *Fusarium* (plant pathogens and mycotoxin producers).

## Phylum Basidiomycota: The Club Fungi

Basidiomycota includes most organisms commonly recognized as "mushrooms" —
gilled fungi, boletes, chanterelles, bracket fungi, puffballs, and their
relatives. The defining feature is the basidium, a specialized cell on which
sexual spores (basidiospores) are produced externally, typically four per
basidium. The group contains approximately 30,000 described species and
includes many ecologically important decomposers of wood and litter,
mycorrhizal partners of forest trees, and plant pathogens including the rusts
and smuts that cause devastating crop diseases. Basidiomycetes are responsible
for the bulk of wood decay in forest ecosystems and play a critical role in
global carbon cycling through their ability to decompose lignin — the
recalcitrant polymer that gives wood its structural rigidity and that few
