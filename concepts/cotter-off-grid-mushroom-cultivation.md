...
The log disk method uses chainsaw-cut rounds 6 to 8 inches thick stacked with
cardboard sheets between them. Water generously, cover loosely with plastic or
leaves, and inspect after two weeks for an even white mycelial layer on the
cut face. Flip and add fresh cardboard and rounds to expand. Move colonized
rounds to fruiting areas stacked as totems so they fuse and share resources. The
wafering method uses a machete or hatchet to slice flaps in log bark, inserting
cardboard wafers that inoculate the wood over several years of growth.

## Culture Storage Without Electricity
