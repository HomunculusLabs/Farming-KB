...
Mollison argues that bioregional and tribal congresses are the first
move toward this alternative. No world centre is needed -- people meet
as affinity groups. Centralised administrations and tax funding should
be avoided.

## Bioregional Organisation (Section 14.5)
Bioregional organisation is presented as the primary strategy for
scaling permaculture from individual sites to regional systems. The
framework identifies categories of bioregional activity:

### Category A: Food and Food Support Systems
- **A1:** Plant resources (nurseries, botanical gardens, research
  institutes, seed sources/exchanges, native reserves, demonstration
  farms, skilled people, publications, contractors, produce, species
  checklists)
...
Long-range planning, [[singh-fungal-biosensors-environmental-monitoring]].
...
### Investment Types
- **Short-term** (amortise 1-2 years): Draught-proofing, insulation,
...
The Mondragon Cooperatives of Spain demonstrate successful large-scale
...
- Profit distribution: 10% to community, 20% reserves, 70% to
  workers
...
Later reduced from 3,000-5,000 to cooperatives of 300-500 to preserve
individual identity. However, alliances of smaller cooperatives can
manufacture any vehicle or machine if each produces a part.

## Commonwork
The commonwork model allows individuals to choose a set of duties and
occupations that fit skills, choice, and age within bioregional
networks. A few also develop special skills and become teachers in
trades or disciplines.

## Land Access Strategies (Section 14.11)
- **Land lease system:** Oxfam model pairing land-wanters with
  land-havers
- **Garden/farm club:** Shares purchase farm 12 hours from city
- **City farms:** Urban [[fukuoka-agricultural-production-net-energy-deduction]]
- **Towns as farms:** Integrated urban-rural systems
- **Farm link:** Producer-consumer cooperative, 20-50 families linked
  to farms
- **Gleaning systems:** Redistribution of unwanted food from orchards
  and canneries

## Revolving Loans and Local Currency (Section 14.10)
Regional currency backed by reserves (can be living things like trees
-- wealth increases). Notes dated, reissued every 4-5 years to prevent
hoarding. Dollars supplied for needs, repaid in local currency.
Critical personnel: assessor-designers (permaculture team), accountants,
## See Also
