...
The EMCDDA search used four English-language keyword combinations:

| Keywords | Google hits analyzed | AltaVista hits analyzed | Unique shops found |
|----------|---------------------|------------------------|-------------------|
| "magic mushrooms shop" | 16 (from 837,000) | 14 (from 674,000) | 19 |
| "buy magic mushrooms" | 16 (from 686,000) | 10 (from 733,000) | 16 |
| "psilocybe cubensis shop" | 24 (from 60,500) | 5 (from 52,100) | 24 |
| "buy psilocybe cubensis" | 17 (from 29,900) | 7 (from 32,700) | 18 |

For each search engine and keyword combination, the first 300 results were analyzed. Duplicate shops found across multiple searches were counted only once, yielding a total of 39 unique online retailers. The survey captured a point-in-time snapshot and does not represent the total number of online shops that may have existed, as some operated through less discoverable channels.

## Geographic Distribution of Online Shops

The geographic analysis of the 39 identified online shops revealed a striking concentration in the Netherlands:
...
Website statistics from one Dutch online shop provided insight into the geographic distribution of customers. Between May 2004 and February 2006, server access data showed:

- **Netherlands:** 73% of site visitors
- **Belgium:** 14% of visitors
- **Germany:** 2% of visitors
- **France:** 2% of visitors
- **Other countries:** 9% combined

This data indicates that while online shops shipped internationally, the majority of traffic came from the domestic market and neighboring countries with geographic proximity and cultural familiarity.
...
The majority of online shops offered international shipping, though most imposed restrictions based on destination country legality. Common practices included:

- **Legal verification:** Many sites advised customers to verify the legal status of mushroom products in their country before ordering.
- **Country-specific blocking:** Some shops automatically blocked orders from countries where mushroom sales were prohibited.
- **Multi-language sites:** Shops frequently offered versions in English, French, and German to attract international customers.
- **Disclaimer language:** Sites typically included disclaimers stating products were sold for "research purposes only" or "not for human consumption."

## Market Impact of Legal Changes
