...
1. **Expanded consciousness**: The experience invariably involves a profoundly expanded state in which fundamental self-concepts and views of reality may be transcended.
2. **Set and setting**: Internal set (intention, expectation, motivation) and external setting are the primary determinants of the experience, with the drug playing a catalytic role. This model can be extended to nondrug altered states including hypnosis, meditation, rhythmic drumming, sensory isolation, and fasting.
...
4. **Experienced therapist prerequisite**: Effective psychedelic psychotherapy requires that the therapist has personal experience with the substances. The vast majority of practitioners would not sanction co-ingestion with clients.
5. **Transpersonal access**: Mystical and spiritual dimensions of consciousness can be accessed, as recognized early by Albert Hofmann (based on similarity to childhood mystical experiences in nature), Stanislav Grof (transpersonal realms beyond perinatal matrices), and Leary (who adapted the Tibetan Bardo Thodol and Tao Te Ching as guidebooks for psychedelic experience).
...
Three distinctive features differentiate shamanic entheogenic ceremonies from Western psychotherapy sessions:
...
3. **Darkness**: Ceremonies are almost always conducted in darkness or low light to facilitate the emergence of visions. The peyote ceremony around a fire is the main exception, where participants may see visions staring into the flames.
...
Participants typically have backgrounds in multiple practices including Buddhist vipassana, tantra yoga, holotropic breathwork, and various psychotherapy modalities. The majority have expanded beyond conventional materialism to accept "the reality of nonmaterial spirit beings and to recognize that we live in multiple worlds of consciousness."
...
Metzner traces how each paradigm emerged in historical sequence. The indigenous shamanic paradigm represents the oldest and most widespread use of psychoactive plants, documented in over two hundred cultures worldwide. The psychiatric-medical paradigm emerged in the mid-twentieth century as Western psychiatry began investigating these substances for therapeutic potential, culminating in over a thousand clinical studies and six international conferences before the mid-1970s moratorium. The psychospiritual paradigm arose partly in response to the limitations of the medical model, emphasizing consciousness expansion, personal growth, and spiritual insight over symptom reduction. The创造性 problem解决 paradigm has only recently been formalized, drawing on contemporary research into creative cognition, divergent thinking, and problem restructuring.
