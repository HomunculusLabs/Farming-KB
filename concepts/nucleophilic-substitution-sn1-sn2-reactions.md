...
The SN2 reaction proceeds through a concerted, single-step mechanism in which the
nucleophile attacks the electrophilic carbon from the back side while the leaving
group departs simultaneously. This results in an inversion of stereochemistry at the
carbon center, known as the Walden inversion. The reaction rate depends on the
concentration of both the nucleophile and the substrate, making it second-order
overall.

The stereochemical outcome is particularly important in pharmaceutical synthesis. A
single SN2 reaction at a chiral center will convert an R-configured substrate into
its S-configured product, or vice versa. This has profound implications for drug
design because enantiomers can have dramatically different biological activities.

Key factors favoring SN2 include a strong nucleophile, a good leaving group, a polar
aprotic solvent (such as DMSO or acetone), and a primary or methyl substrate. Steric
hindrance strongly disfavors the SN2 pathway because the nucleophile must physically
approach the carbon center. Tertiary substrates essentially never undergo SN2
reactions due to extreme crowding around the reactive carbon.

## SN1 Mechanism

The SN1 reaction follows a two-step mechanism. In the first step, the leaving group
departs spontaneously to form a planar carbocation intermediate. This step is rate-
determining and depends only on the substrate concentration, making the overall
reaction first-order. In the second step, the nucleophile attacks the carbocation
