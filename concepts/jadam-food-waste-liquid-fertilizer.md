...
updated: 2026-04-22
type: concept
tags: [jadam, fertilizer, fermentation, soil]
sources:
  - "raw/papers/jadam-organic-farming-ultra-low-cost-agriculture.md"
---

Food waste is an excellent nitrogen-rich ingredient for [[jadam-anaerobic-fermentation]] principles:
...
## Types of Food Waste and Their Properties
...
Always apply in early morning or late afternoon to avoid leaf burn from midday sun. When using as a foliar spray, add [[ultra-low-cost-jadam-microorganism-solution-and-soil-foundation]] to re-inoculate before spring applications. In warm climates, keep containers in shade to prevent excessive gas buildup from continued fermentation.
## Practical Considerations

When working with JADAM Food Waste Liquid Fertilizer, several practical factors should be
