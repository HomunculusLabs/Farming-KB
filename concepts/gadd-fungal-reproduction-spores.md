...
Sexual reproduction (teleomorph stage) involves the fusion of compatible nuclei (plasmogamy), followed by nuclear fusion (karyogamy) and meiosis, producing genetically recombinant offspring.

### Mating Systems

- **Heterothallism**: Requires interaction between two compatible mating types, designated + and - (in many groups) or by more complex mating-type loci (in basidiomycetes). Most filamentous fungi are heterothallic.
- **Homothallism**: A single isolate can complete the sexual cycle without a mating partner, as it carries both mating-type alleles. Homothallic species are self-fertile.
- **Secondary homothallism**: Spores contain nuclei of both mating types, so a single spore can initiate a self-fertile mycelium, but the genetics involve heterothallic mating-type loci.
