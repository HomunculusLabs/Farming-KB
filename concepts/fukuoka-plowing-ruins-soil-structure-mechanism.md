# Plowing Ruins the Soil: Fukuoka's Mechanism for How Tillage Destroys Soil Structure
...
and initiates a cascade of degradation that ultimately renders the soil
dependent on artificial inputs. His analysis went beyond the simple
observation that tilling damages soil; he explained exactly how and why the
damage occurs, and why the damage is self-perpetuating.

## The Bread Dough Analogy

Fukuoka's most memorable explanation of tillage damage was the bread dough
analogy. He asked readers to imagine a lump of bread dough that has risen
perfectly, filled with air pockets that give it lightness and structure.
If you knead this dough — which is essentially what plowing does to soil —
you collapse all the air pockets. The dough becomes dense, compact, and
heavy. To restore its lightness, you would need to let it rise again,
which takes time and the right conditions. But if you knead it again
before it has risen, you collapse whatever structure has begun to form.
