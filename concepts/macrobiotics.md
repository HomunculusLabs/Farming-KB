...
Supplementary (5-10%):
- Beans and legumes: adzuki, chickpeas, lentils
- Sea vegetables: nori, wakame, kombu, hijiki
- Soups (miso-based)

Minimal:
- Fish occasionally
- Fruits, nuts, seeds in moderation
- Seasonings: miso, tamari, sea salt, umeboshi

Foods generally avoided in macrobiotic practice include refined sugar, dairy products, eggs, poultry, red meat, tropical fruits, nightshade vegetables, and processed foods. The reasoning is that these foods are either extremely yin (sugar, tropical fruits) or extremely yang (red meat) and thus disrupt the body's natural equilibrium.

## Michio Kushi and Western Popularization
...
In macrobiotic theory, foods are classified along a yin-yang spectrum:

- **Most yang** (contractive): salt, eggs, poultry, red meat, hard cheeses
- **Moderately yang**: fish, root vegetables, sea vegetables, beans
- **Balanced**: whole grains (especially brown rice), leafy greens
- **Moderately yin** (expansive): fruits, nuts, seeds, sweet vegetables
- **Most yin**: sugar, tropical fruits, alcohol, drugs, chemicals

The goal is to consume primarily balanced and moderately balanced foods, avoiding extremes. Illness is understood as the result of excessive yin or yang in the diet, and healing comes from restoring balance.
...
Fukuoka argued that truly natural food, grown without chemicals and in harmony with the local ecosystem, has a fundamentally different quality from industrially produced food. This perspective resonates with the macrobiotic emphasis on food quality over mere nutritional content.
