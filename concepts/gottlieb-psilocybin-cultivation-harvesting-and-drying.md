...
type: concept
tags: [cultivation, harvesting, psilocybin]
---
...
- Temperature affects potency: higher temperatures (75 degrees F) produce
  faster growth but lower psilocybin content compared to lower temperatures
  (70 degrees F). This is a significant factor in overall yield optimization
  -- cultivators may choose to run at lower temperatures if alkaloid
  potency is prioritized over throughput.

## Harvesting Procedure

1. Filter the medium from each jar through a clean flannel cloth.
2. Collect the mycelial material from the cloth.
3. Place mycelium in a Pyrex baking dish.
4. Repeat for each jar until each baking dish is approximately 1/3 full
   of mycelia (each dish holds a dozen or more mycelial mats from separate
   jars).
5. Process all harvestable jars in a single session to minimize delays.
6. Unharvestable jars that have reached peak should be refrigerated.

## Drying Procedure

1. Place baking dishes in an oven at no higher than 200 degrees F.
2. Use an oven thermometer -- do not rely on the oven knob temperature
   settings, which may be inaccurate.
...
- Standard dose: 6-20 mg psilocybin/psilocin for a 150 lb person; average
  10 mg.
- Crude extraction yields brownish crystalline powder at least 25% pure.
- Actual dose of crude material: 25-100 mg depending on mycelial potency
  and extraction efficiency.
- Alkaloid content varies by species, strain, and cultivation conditions.
- Each new batch should be tested to determine proper dose distribution.
- Psilocybin and psilocin have the same effect on the user; the only
  difference is the phosphate bond in psilocybin, which disappears upon
  assimilation.
- Dose varies for different individuals.

## Large-Scale Harvest Schedule

In the 2,800-jar continuous rotation system:
- Approximately 235 jars are harvested every 1-2 days on a staggered
  schedule.
- Groups of 235 jars are labeled with date and approximate inoculation time.
- Harvested jars are resterilized, refilled with fresh medium, autoclaved,
  and reinoculated immediately to maintain continuous production.
- This creates a perpetual cycle with minimal downtime, producing 5,000+
  doses per week from a single 10 x 15 foot room.
- Working about three hours a day, approximately 235 jars can be inoculated
  per session, completing the full 2,800-jar rotation in 12 days.
