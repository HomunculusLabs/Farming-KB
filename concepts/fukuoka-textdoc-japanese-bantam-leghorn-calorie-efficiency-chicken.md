...
|---|---|
| Free-range native chickens | Over 100% |
| Broilers (chicken meat) | 50% |
| Eggs (caged White Leghorn) | ~50% |
| Pork | 20% |
| Milk | 15% |
| Beef | 8% |
...
eggs, milk, or meat are actually very energy-wasteful. In fact, the larger and more
highly improved the breed of animal being raised, the greater the energy input
required and the greater the effort and pains that must be taken by the farmer.

## Native Breeds as the Superior Choice

The question we must answer then is: What should be raised, and where? First we
must select breeds that can be left to graze the mountain pastures. Raising large
numbers of genetically improved Holstein cows and beef cattle in indoor pens or small
lots on concentrated feed is a highly risky business for both man and livestock alike.

Moreover, such methods yield higher rates of energy loss than other forms of animal
