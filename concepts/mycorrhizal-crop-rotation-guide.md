---
title: Mycorrhizal Crop Rotation Guide
created: 2026-04-19
updated: 2026-04-19
type: concept
...
- **Wheat** (Triticum spp.) — dry weight increases of 29-100% after inoculation
- **Oats** (Avena sativa) — root growth increases of up to 70%
- **Barley** (Hordeum vulgare) — seed yield increases of 27%; seed phosphorus increases of 35%

### Non-Host Crops (Do NOT Form Mycorrhizae)

- **Brassicas:** mustard, cabbage, broccoli, cauliflower, Brussels sprout, radish, rapeseed, arugula, horseradish
- **Beets** (Beta vulgaris)
...
## Rotation Principles for Mycorrhizal Health

### 1. Maintain Continuous Host Planting
...
## Specific Crop Rotation Research

### Alfalfa

Alfalfa (a legume with nitrogen-fixing nodules) shows that inoculated plants:
- Develop larger root masses
- Form more nitrogen-fixing nodules
- With Funneliformis mosseae: twice the arbuscules, almost double the biomass
- With Rhizophagus fasciculatus and F. mosseae: reduced Verticillium and Fusarium wilt incidence
...
Potatoes show particularly strong mycorrhizal responses:
- Inoculation increased tuber number by almost 50%
- Different varieties show selectivity for fungal species
- Rhizophagus intraradices produced the most potatoes in one trial
- In the Andes, eight of eleven Glomeromycota families colonize potatoes at different altitudes
