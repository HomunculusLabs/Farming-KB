...
- Most common type for home gardens
- Upright shrubs, 4-6 feet tall at maturity
- Hardiness varies by variety: zones 3-8
- Large berries, excellent fresh eating
- **Northern highbush**: Zones 3-7. Varieties: Bluecrop, Duke, Patriot, Elliott, Jersey, Legacy
- **Southern highbush**: Zones 5-10. Varieties: O'Neal, Sunshine Blue, Emerald, Star, Misty
...
- Cross between highbush and lowbush; zones 3-5; compact 2-4 feet
- Varieties: Northblue, Northcountry, Northsky, Polaris, Chippewa
...
### Soil Preparation
- Begin amending soil 6-12 months before planting if possible
...
- Do not add fertilizer at planting time — young roots are sensitive to burn
- Water thoroughly after planting
- Apply 3-4 inches of acidic mulch (pine needles, pine bark)

### Cross-Pollination
- Most blueberries benefit from cross-pollination (plant 2-3 different varieties)
- Rabbiteye varieties require cross-pollination to produce fruit
- Choose varieties with overlapping bloom times
- Plant different varieties within 6-8 feet of each other for bee access
...
- Prune annually once plants are 3-4 years old
- Young plants (1-2 years) need only removal of dead or damaged wood

### Pruning Method
1. Remove dead, damaged, or diseased canes first
2. Remove canes older than 5-6 years (gray, peeling bark, low productivity)
3. Thin crowded canes — leave 6-8 of the strongest, healthiest canes per plant
4. Remove low, horizontal canes that touch the ground
5. Remove weak, spindly growth
6. Cut branches back to strong lateral shoots or to the base
7. Do not remove more than 1/3 of the plant in a single year
8. Rabbiteye berries fruit on older wood — prune more conservatively

### Young Plant Pruning (Years 1-2)
- Remove flower buds in the first year to redirect energy to root and shoot growth
- In year two, allow some fruit but continue removing flowers on weaker shoots
...
- **Frame netting**: Build a PVC or wooden frame over the planting and drape netting over the frame. Prevents birds from reaching through and getting tangled
- **Bud cages**: Individual wire cages around each plant for smaller plantings

### Best Practices
- Install netting before berries begin to turn blue (birds watch for color change)
- Ensure netting is secured at the ground — birds will find gaps
- Check netting regularly for birds caught inside (release them)
- Remove netting after harvest to prevent wildlife entanglement
- Visual deterrents (scare tape, owl decoys) provide temporary relief but birds habituate quickly
- Netting is the only reliable long-term solution
