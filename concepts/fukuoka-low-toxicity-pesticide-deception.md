...
their use. But, if anything, that just makes them more harmful because
new types are developed one after another in rapid succession, complicating
matters. It is the most talented chemists who develop pesticides such as
these that ordinary people are unable to avoid as manifestly polluting.

## The Pesticide Cascade Effect

Fukuoka understood that "low toxicity" pesticides create a false sense
of security. When farmers believe they are using something safe, they
apply it more freely, more frequently, and in greater quantities. This
increased usage multiplies the actual harm done, even if each individual
application is marginally less toxic than older formulations.

Furthermore, the rapid succession of new pesticide types creates
complicated interactions in the environment that no one fully
understands. Each new chemical enters an ecosystem already burdened
with residues of previous applications, creating cumulative effects
that are impossible to predict or measure.

## Science's Contradictory Role

Science and technology strike people with one hand and help them with
the other. Both tendencies can be found in the universities. Each
college claims to have its own policy and objectives. Things have
clearly gotten out of control, but who is going to bring them back
under control? And in what direction?

Fukuoka believed that humanity had entered an age of confrontation
...
method of farming that uses plants and animals rather than heavy
machinery and chemical inputs.

If you think of this as a means for raising soil fertility using
microbes, as cultivation with plant roots, then it becomes the most
advanced science. Natural farming is a method that actually goes a step
beyond science.
