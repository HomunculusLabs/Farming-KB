...
The legal status of [[query-how-to-store-mushroom-spores-long-term]] themselves are legal to possess and distribute
...
Multispore inoculation produces genetic variability — each [[comparison-seed-saving-techniques-vs-tissue-culture-cloning]]
...
Based on current understanding, the following management
approaches are recommended: monitor conditions regularly,
adapt practices to local context, and document outcomes
