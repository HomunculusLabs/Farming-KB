...
A more compelling explanation focuses on the effects of toxins on **developing insect larvae** that hatch from eggs deposited in fruiting body tissues. Several observations support this hypothesis:

1. **High vulnerability of embryos**: All embryos, including insect larvae, undergo rapid cell division and tissue differentiation, making them exquisitely prone to genetic damage from compounds that block gene expression
2. **Insect-fungal coevolution**: Insects and fungi have interacted for 400 million years or more, providing ample evolutionary time for the development of defense and counter-defense mechanisms
3. **Structural integrity matters**: Even if the spore-producing gills are not directly consumed, sabotage of the stem or cap by burrowing larvae can disrupt the precise geometry required for spore dispersal
...
The insecticide hypothesis does not explain all fungal toxins, and multiple evolutionary explanations may apply:
...
*Coprinus atramentarius* contains **coprine**, which blocks the second stage of alcohol metabolism (conversion of acetaldehyde to acetate). Symptoms identical to the drug disulfiram (Antabuse) result when the mushroom is consumed with alcohol: tingling, nausea, vomiting, and racing heartbeat. The evolutionary purpose of this specific interaction with ethanol metabolism remains mysterious.
