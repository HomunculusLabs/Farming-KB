---
title: Permaculture Design Principles and the Law of Return
...
This mythic structure gives meaning to individual acts that relates to the whole of nature and rebounds on society. Reared on such myths, people move carefully in the world, aware that every unthinking act can have catastrophic consequences. Mollison argues that modern society, having replaced nature-based myth with fixed prohibitions relating only to other people and unrelated to nature, has developed destructive and people-centered civilizations and religions.

## The Self-Managed System

The ultimate goal of permaculture design is the creation of self-managed systems. As Mollison states: "The role of beneficial authority is to return function and responsibility to life and to people; if successful, no further authority is needed. The role of successful design is to create a self-managed system."

This principle means that the measure of good design is not how much control it exerts but how little control is needed once the system is established. A well-designed permaculture system should, over time, require decreasing human intervention as its internal feedback loops, biological relationships, and physical structures assume the regulatory functions that initially required human management.
