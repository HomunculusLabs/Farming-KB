...
industrial products. The wastewaters remaining after fermentation processes
are highly coloured due to the presence of melanoidin pigments. These
pigments are produced by the Maillard reaction between sugars and amino
acids at elevated temperatures and represent a class of recalcitrant,
...
Melanoidin pigments are dark brown, high molecular weight polymers formed
through non-enzymatic browning reactions between reducing sugars and amino
compounds. Their chemical complexity and recalcitrance to biological
...
attacking recalcitrant polymeric substrates including lignin, a compound
with some structural parallels to melanoidins.
...
mineralization of the organic load rather than simple colour removal.
With some non-wood-rotting organisms such as Rhizoctonia species,
decolorization is solely adsorptive, which has inherent limitations because
the mycelium becomes saturated and adsorbed melanoidin must still be
managed.

## Carbon Source Requirements

The provision of an additional carbon source, usually glucose, greatly
improves melanoidin decolorization by white rot fungi. This requirement
reflects the co-metabolic nature of melanoidin degradation, where the
fungus uses the readily metabolizable carbon source for growth and energy
generation while the oxidative enzyme system modifies the recalcitrant
melanoidin polymers. Rates and extents of decolorization depend on the
organism, the effluent concentration, and the intensity of the initial
colour. Decolorization may take as little as one day or as many as ten days
depending on these factors. Some effluents can be inhibitory to fungal
growth, requiring dilution before effective treatment.

## Enzymatic Mechanisms of Melanoidin Degradation

The mechanism of melanoidin decolorization by fungi involves multiple
enzyme systems. In Coriolus (Trametes) versicolor, Watanabe and colleagues
...
synergistic action. Dehorter and Blondeau isolated a manganese-dependent
melanoidin-degrading activity from T. versicolor that requires oxygen but
not hydrogen peroxide.

## Mutant Strains with Enhanced Activity

Mutants of Coriolus versicolor with enhanced melanoidin-degrading activity
have been isolated through screening approaches. Sermkiattipong and
colleagues obtained mutant strains showing improved decolorization
