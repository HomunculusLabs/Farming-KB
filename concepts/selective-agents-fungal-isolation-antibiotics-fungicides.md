...
- **Chloramphenicol:** 50-200 mg/L; broad antibacterial; autoclavable
- **Tetracycline:** 25-100 mg/L; broad; heat labile, light sensitive
- **Ampicillin:** 100-300 mg/L; broad; heat labile, pH sensitive
### Gram-Specific Agents
- **Penicillins:** 30-100 IU/mL; gram-positive; heat labile
- **Streptomycin:** 50-500 mg/L; gram-negative; heat labile
- **Rifampicin:** 5-25 mg/L; broad; photosensitive
...
- **Photosensitive:** Rose bengal, rifampicin, natamycin, nystatin
- No single medium recovers all fungi; use multiple media
- Always include nonselective control plates

## Media Preparation Protocols

Selective media are prepared by incorporating antibacterial and antifungal
agents into the base growth medium at specific concentrations. The timing
of additive incorporation is critical — most antibiotics are
heat-sensitive and must be added after the medium has been autoclaved
and cooled to approximately 50-55°C. Adding antibiotics to excessively
hot media will degrade their efficacy.

Common base media for fungal isolation include Potato Dextrose Agar
(PDA), Malt Extract Agar (MEA), and Corn Meal Agar (CMA). The choice
of base medium depends on the nutritional requirements of the target
fungal group. For general isolation, PDA supplemented with antibiotics
provides a versatile starting point.

## Selective Isolation of Specific Fungal Groups

Different fungal groups require tailored selective regimes. For
oomycete isolation, PARP medium (pimaricin, ampicillin, rifampicin,
pentachloronitrobenzene) is highly effective. Zygomycetes can be
selected using antibiotics that inhibit the faster-growing
