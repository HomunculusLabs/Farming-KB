...
rows 2.5 inches apart, allowing twelve rows on a 30-inch bed (four-row
model, three passes) or the same in two passes (six-row model).
...
Before using the Tilther, Coleman aerates each bed with a broadfork,
...
consisting of a cloth basket collector mounted behind a bow-saw frame
holding a scalloped knife blade. Coleman has also been working on a
battery-powered hand harvester design for smaller growers that would be
light enough for one-hand use and adjustable for different cutting heights.
