...
The strategy requires only that the spore survive long enough to encounter a habitable planetary surface where it can germinate and establish a mycelial network.
The elegance of the strategy is that it requires no intentionality or technology on the part of the organism—only the physics of small objects in a gravitational field combined with vast stretches of time.
...
On those time scales, he argues, "the percolation of spores between the stars is a perfectly viable strategy for biology."
He compares it to the principle by which plants migrate into a desert or across an ocean.
The vastness of geological and galactic time makes even extremely improbable events essentially certain over sufficient duration.
Looking at the galaxy on such scales, biological percolation between star systems becomes as natural as the migration of species between continents.
The argument is essentially probabilistic: given enough time and enough spores, even extremely unlikely events become inevitable.

## The Fossil Record Gap

McKenna supports his hypothesis by noting an anomaly in the fungal fossil record.
...
McKenna describes the mechanism by which he believes the mushroom established its symbiotic relationship with human beings.
