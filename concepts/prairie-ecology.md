...
### Mixed-Grass Prairie
Transitional zone with 15-30 inches of precipitation:

- Mix of tallgrass and shortgrass species
- Mid-height grasses like western wheatgrass, green needlegrass, and side oats grama
- Moderate species diversity
- Fire return interval of 3-10 years

### Shortgrass Prairie
Arid regions with 10-15 inches of annual precipitation:

- Dominated by buffalo grass and blue grama
- Heights of 6-18 inches
- Lower species diversity but high ecological resilience
- Less frequent fire; drought is the primary disturbance

## Fire Ecology

### The Role of Fire
Fire is the keystone process maintaining prairie ecosystems. Without fire, woody species encroach and prairie converts to shrubland or forest. Fire provides several ecological functions:

- **Removes thatch buildup**: Allows sunlight to reach soil and warm it in spring
- **Releases nutrients**: Ash returns minerals to soil; blackened soil absorbs solar radiation
- **Controls woody invasion**: Kills or top-kills tree and shrub seedlings
- **Stimulates flowering**: Many prairie forbs flower more prolifically after fire
- **Controls pests**: Reduces thatch-dwelling insect populations and disease organisms

### Fire Adaptations
Prairie plants have evolved remarkable fire adaptations:

- **Growing points below ground**: Meristems are protected by soil, allowing regrowth after fire
- **Thick bark on roots**: Crown roots of dominant grasses survive fire and resprout
- **Fire-stimulated germination**: Some species require fire cues (heat, smoke chemicals) for seed germination
...
- **Conditions**: Wind speed, humidity, temperature, and fuel moisture must meet safety criteria
- **Permits**: Most jurisdictions require burn permits and trained personnel

## Deep Root Systems

### Root-to-Shoot Ratios
Prairie grasses allocate 60-80% of their biomass below ground, the inverse of most crop plants. This massive root system:

- Big bluestem roots can extend 7-10 feet deep
- Switchgrass roots reach 10+ feet
- The total root mass per acre can exceed 10,000 pounds
...
### Warm-Season Grasses
Active during summer months; use the C4 photosynthetic pathway for high water-use efficiency:
...
| Side oats grama | 1-3 ft | 3-5 ft | Forage, erosion control |
| Blue grama | 1-2 ft | 2-4 ft | Forage, lawn alternative |
...
### Legumes
Nitrogen-fixing forbs enrich prairie soil:
...
### Late-Season Forbs
Important for migrating butterflies and seed-eating birds:
