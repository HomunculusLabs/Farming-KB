...
overview covers the major classes found in the US, their chemistry,
distribution, and health risks, based on Halpern's 2004 review in
Pharmacology and Therapeutics.

## DMT-Containing Plants and Ayahuasca Analogs
...
Key US botanical sources include **Phalaris spp.** (canary grass),
...
plants: **Peganum harmala** (Syrian rue), now wild in the western US
...
approximations, with recipes and user reports available online.
...
**Atropa belladonna** (deadly nightshade); **Mandragora officinarum**
(mandrake); and **Hyoscyamus niger** (henbane). The entire plant is
