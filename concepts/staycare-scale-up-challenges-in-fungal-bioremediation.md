...
- **Soil systems**: Oxygen penetration into soil is limited; compaction, waterlogging, and depth reduce oxygen availability
- **Reactor design**: Scaling from shake flasks to bioreactors requires careful attention to aeration, mixing, and heat removal
