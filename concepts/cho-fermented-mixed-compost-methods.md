...
- Store in cool shade
- Can be stored for about one year
...
FMC contains many ingredients (FPJ, FAA, etc.) that produce hormones
during fermentation:
- **Auxin**: Produced by yeast and filamentous fungi
- **Gibberellins**: From red fungi
- **Cytokines**: From bacteria and yeast

Cytokine hormone promotes leaf/branch growth, cell division, embryo
and seed formation, flower bud formation, germination, and prevents
aging. The combination of hormones makes FMC far more biologically
active than conventional compost.

## Application Guidelines

1. Apply 2-3 hours before sunset (avoid hot sun) or on cloudy days
   to protect microorganisms from UV radiation
2. Cover with soil immediately after applying, or lightly plow with
   1-2 inch rotary hoe
3. Partial topsoil application is recommended (microorganisms
   survive better)
...
- **Field**: Oil cake, bean cake litter
- **Sea**: Seaweed, fish waste

Major ingredients should be animal materials with abundant proteins
(bone meal, fish meal) and plant materials. Include as many kinds as
possible.
