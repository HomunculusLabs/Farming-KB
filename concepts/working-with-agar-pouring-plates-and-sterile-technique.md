...
contamination rates in all subsequent culture work.

## Temperature for Pouring

After sterilization, agar temperature is near 100 degrees C. The medium remains
liquid until it drops below approximately 40 degrees C. The agar should be left
to cool until it nearly reaches this temperature. A practical test: if you can
hold the flask in your bare hand for about 10 seconds without real discomfort,
the temperature is right for pouring.

It is better to pour a little too hot than to let the agar cool too much and
solidify in the bottle. If solidification occurs, the agar must be re-melted.

## Minimizing Condensation

Two techniques reduce condensation on dish lids:

- Let the agar cool before pouring (as described above).
- Stack dishes in groups of 10 and place a mug or jar of near-boiling water on
  top of the stack after pouring. The warmth from above prevents condensation
  from forming on the inner lid surface.
...
- Dishes are removed from their packaging sleeve and stacked in groups of 10.

Personal preparation is equally important. Hands should be washed thoroughly with soap and water before beginning. Wearing nitrile gloves reduces the transfer of skin oils and microorganisms to dish surfaces. Long sleeves and a face mask further reduce contamination risk, especially when working outside of a flow hood. Hair should be tied back or covered. The work area should be free of drafts — close windows, turn off fans, and avoid working near HVAC vents. All tools that will contact the agar or dish surfaces (flask neck, scissors for opening packaging) should be wiped with 70% isopropyl alcohol and allowed to air dry before use.

## Pouring Technique

1. Swirl the flask to mix ingredients thoroughly.
2. Remove the aluminum foil and polyfill/cotton covering.
3. Lift the lid of the bottom dish (which lifts the 9 dishes above it as well).
4. Swiftly pour a layer of nutrient medium to a depth of 0.3-0.5 cm.
5. Replace the lid immediately.
6. Repeat for each dish, working upward through the stack.

Speed is important when working in less than perfectly sterile environments.
...
After the agar has solidified, dishes are taped to prevent moisture loss and
contaminant introduction. Polyethylene clingfilm is cut from a roll, stretched
slightly, and wrapped around each dish, taping the lid and base together.
Polyethylene allows slow gas exchange, which is necessary for mycelial
respiration.
...
- **Selective media**: Antibiotics (gentamicin, chloramphenicol) can be added after autoclaving (when agar cools below 50 C) to suppress bacterial contamination during isolation from wild specimens. This is distinct from the sterile technique described above — antibiotics supplement but do not replace proper aseptic procedures.
