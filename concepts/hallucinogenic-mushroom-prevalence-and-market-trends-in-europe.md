...
### Terminology
These substances have been called 'psychedelic' (mind opening), 'psychotomimetic' (resembling psychosis), 'psychodysleptic' (mind disrupting), 'hallucinogenic', 'phantastica', and 'oneirogenic'.

## Prevalence Data

### General Population Surveys (15-24 year olds)

#### Lifetime Prevalence Range
- **Lowest**: Estonia, Hungary, Romania (~1-2%)
- **Moderate**: Germany, UK, Czech Republic (~4-6%)
- **Highest**: Denmark, Netherlands (~7-9%)

#### French Data (2003)
Among 17-18 year olds:
- **Lifetime**: 4.3%
- **Last year**: 2.9%
- **Last month**: 1.0%

### School Surveys (ESPAD 2003)
Among 15-16 year olds across 22 EU Member States plus Norway and candidate countries:
- Lifetime use ranges from **0% to 8%**
- Highest prevalence: **Czech Republic, Netherlands, France, and Belgium**

### Clubbing Surveys (Non-Probability)
In dance music settings across Europe, lifetime prevalence ranges dramatically:
- **Budapest**: 9%
- **Czech Republic**: 34%
- **UK**: 36-38%
- **Italy**: 43%
...
### Key Finding
"Substantially higher drug prevalence estimates are found in clubbing surveys than those found in general or school population surveys."

## Use Patterns and Limiting Factors

### Lower Current Use Rate
"The proportion of current users among those who have ever used is lower for hallucinogenic mushrooms than it is for cannabis and ecstasy."

### Self-Limiting Nature
"It has been reported that the effects of hallucinogenic mushrooms limit the appeal of regular use." The intensity and unpredictability of psychedelic experiences discourages frequent use.

### Comparison with Cannabis
Hallucinogenic mushroom prevalence is "generally much lower than for cannabis, where lifetime prevalence in 11 EU Member States for persons aged 18 to 36 is reported at between 15% (Poland) and 45% (Denmark)."
...
### Early Assessments
- **2000**: Hallucinogenic mushrooms subject to risk assessment in the Netherlands (CAM, 2000)
...
### Purpose
The European Perspectives on Drugs (E-POD) pilot project was designed to:
- Detect, track, and understand emerging trends
- Use triangulation of wide-ranging data sources
- Assess veracity of accumulated information

### Data Sources
- EMCDDA reporting form responses from 13+ countries
- Early Warning System reports
- National Reitox reports
- ESPAD School Survey Project
- Scientific articles
- Forensic science bulletins
- Media articles
