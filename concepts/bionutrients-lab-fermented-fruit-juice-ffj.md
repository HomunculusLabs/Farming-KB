---
title: Bionutrients Lab — Fermented Fruit Juice (FFJ)
created: 2026-04-24
updated: 2026-04-24
type: concept: [knf, natural-farming, bionutrients, ffj, fermentation, fruit, growth-promotant]
...
## Potency and Plant Part Selection

The potency of extracts relates to the energy concentration in different plant parts. The general order from most to least potent:

1. **Seed** — most concentrated energy (plant procreates itself from seed alone)
2. **Fruit** — second most potent
3. **Leaf** — third most potent

Because seeds are the most potent, seed-based ferments use a more dilute application rate (1:1000) compared to standard (1:500).
...
## Matching FFJ to Growth Stage

The Nutrioperiodism framework (Yasushi Inoue, 1930s) guides FFJ selection:
...
The natural farming approach to FFJ embodies farmer self-reliance:

- Any locally available fruit can be experimented with for fermentation
- Observe which fruits are abundant and healthy in your environment
- The specific nutritional profile of each fruit determines its best use
...
- As Dr. Han Kyu Cho emphasizes, the goal is for farmers to recover "independent authority" over their farming techniques by making use of local materials actively
