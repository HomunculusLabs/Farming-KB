...
- **Oak leaves** (Quercus sp.) -- high calcium even when soil has barely detectable levels. Chadwick used oak leaves and broken eggshells to line seed flats. Best practice: compost oak leaves with nitrogen fertilizer before use.
- Docks (Rumex sp.)
- Vetches (Vicia sp.)
