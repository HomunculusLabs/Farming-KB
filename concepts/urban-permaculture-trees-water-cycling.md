...
## Scale of Condensation

A single giant tree such as an Ocotillo may present 16 hectares of laminar leaf surface to the sea air. With 100 or so such trees per surface hectare, trees enormously magnify the available condensation surface. The taller the trees -- for example the giant redwoods and white pines -- the larger the volume of moist air intercepted, and the greater the precipitation that follows.

All types of trees act as condensers: Canary Island pines, laurels, holm oaks, redwoods, eucalypts, and Oregon pines. Evergreens work all year, but even deciduous trees catch moisture in winter. Anyone who has stood under a great tree which "rains" softly and continuously at night on a clear, cloudless evening has experienced tree condensation directly.

## Fog Drip

Precipitation from clear air is much less than from fog, where precipitation by condensation often exceeds local rainfall. Advection fogs are most noticeable where cold currents (such as the Oya Shio off East Asia and the Labrador current off northeast America) cause humid inland airstreams in spring and summer.
...
The USDA's 1949 Yearbook of Agriculture on Trees reports: "An ordinary elm of medium size will get rid of 15,000 pounds of water on a clear dry hot day." Evapotranspiration in a 40-inch rainfall area is generally not less than 15 inches per year.
...
Leaves are 86% water, having twice the specific heat of soil, remaining cooler than soil by day and warmer at night. Plants may be 15 degrees C warmer than the surrounding air temperature.

## Windbreak Design

As winds cross tree lines they are deflected in a new direction. Trees deform or "flag" permanently in prevailing strong winds, and can be used to indicate the effects of such winds. A graded scale from no effect (no deformation) to complete throw (trunk bent, tree reduced to creeping shrub) measures wind severity.

Windbreak design principles:

- **Permeability** -- a single hedgerow of 40% permeability causes optimal compression and turbulence for rainfall
- **Height effect** -- compression extends to twenty times the tree height; a 12-meter tree line compresses air to 244 meters above
- **Edge protection** -- forest edges with thick-stemmed, wind-adapted trees buffer the frontline wind attack
- **Never cut windward edges** -- removing the protective [edge causes "edge break," where windburn, salt, dust, or wind force kills the inner forest

## Compression and Turbulence Effects

Windstreams flowing across a forest are partly deflected over (about 60%) and partly absorbed into (about 40%) the trees. Within 1000 meters, the air with its tonnages of water and dust is brought to a standstill. The forest swallows these great energies, resulting in an almost imperceptible warming of the air, increased humidity (15-18% higher than ambient), and air in which no dust is detectable.
...
If dry hot air enters the forest, it is shaded, cooled, and humidified. If cold humid air enters, it is warmed, dehumidified, and slowly released via the tree crowns as misty spirals. The trees modify extremes of heat and humidity to a life-tolerable level.

## Trees and Precipitation

Trees have helped create both our soils and atmosphere. The first by mechanical (root pressure) and chemical (humic acid) breakdown of rock, adding life processes as humus and myriad decomposers. The second by gaseous exchange, establishing and maintaining an oxygenated atmosphere and an active water-vapour cycle essential to life.
