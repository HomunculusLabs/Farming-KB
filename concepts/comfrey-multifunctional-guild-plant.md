---
title: Comfrey as Multifunctional Guild Plant
created: 2026-04-19
updated: 2026-04-19
type: concept
tags: [reference]
...
Comfrey flowers are among the best attractants for beneficial insects. Bees of all species are drawn to comfrey's bell-shaped purple flowers, which provide abundant nectar over a long blooming period. This supports pollination of nearby food crops.

### Livestock Forage
Comfrey leaves are high in protein and minerals, making excellent fodder for chickens, ducks, rabbits, pigs, and other small livestock. Poultry will readily eat both leaves and flowers. Comfrey is listed in poultry forage plant tables as a primary herbaceous forage species.
...
### Under Fruit Trees
Comfrey planted in the drip line of fruit trees provides a continuous nutrient cycling system. The deep taproot accesses minerals below the tree roots, and leaf fall mulches the tree's root zone with mineral-rich organic matter.
...
Comfrey leaves are excellent "green" (nitrogen-rich) material for compost piles. Their high nutrient content accelerates decomposition of other materials and produces mineral-rich finished compost.

## Propagation

Comfrey is most easily propagated from root cuttings. Even small root fragments will generate new plants, which can make comfrey invasive in some settings. Plant in designated areas where spread is acceptable or manage by regular cutting.

## Harvesting

Cut leaves 2-3 inches above the crown. The plant will regrow rapidly. Avoid cutting in late fall to allow the plant to store energy for winter. Leaves can be used fresh as mulch, added directly to compost, or wilted for a few days before use to reduce volume.

## Design Considerations

- Place comfrey where its spreading habit won't interfere with desired plantings
- Use as edge plantings between zones
- Combine with other dynamic accumulators for maximum nutrient cycling
...
- Whitefield, P. The Earth Care Manual
