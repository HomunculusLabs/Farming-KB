...
- Lifecycle: Perennial, long-lived (50-100+ years)
...
- Hypertension: Mild blood pressure-lowering effects through vasodilation
  and ACE-inhibitor-like activity.
- Angina: May reduce frequency and severity of angina attacks.
- Atherosclerosis: Antioxidant compounds help protect blood vessels from
  oxidative damage.
...
- MUST be used under medical supervision when combined with prescription
  heart medications (digitalis, beta-blockers, ACE inhibitors, calcium
  channel blockers, blood thinners). It can potentiate or interact with
  these drugs.
...
- Space 10-20 feet apart (depending on species and intended use)
...
- For drying: spread on screens at 100-120 degrees F until hard and shriveled
