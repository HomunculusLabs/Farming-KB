---
title: Phytoremediation Mechanisms
created: 2026-04-17
updated: 2026-04-17
type: concept
...
## Major Mechanisms of Phytoremediation

Phytoremediation encompasses several distinct mechanisms, each suited to different contaminant types and environmental conditions. Understanding these mechanisms is essential for selecting appropriate plant species and designing effective remediation strategies.

### Phytoextraction

Phytoextraction (also called phytoaccumulation) is the uptake and accumulation of contaminants, primarily heavy metals, into plant tissues above ground. Hyperaccumulator plants can concentrate metals at levels 100-fold greater than normal plants. Species in the Brassicaceae family (mustards), such as Thlaspi caerulescens (alpine pennycress) and Alyssum species, are well-known hyperaccumulators of zinc, cadmium, and nickel.

The process involves root uptake of soluble metal ions from soil solution, translocation through the xylem to shoots and leaves, and sequestration in vacuoles or binding to cell wall components. Chelating agents such as EDTA are sometimes added to soil to increase metal solubility and bioavailability, though this practice raises concerns about groundwater contamination.

After sufficient accumulation, the above-ground biomass is harvested and disposed of as hazardous waste or processed for metal recovery through phytomining techniques. Successive cropping over multiple growing seasons can progressively reduce soil metal concentrations.

### Phytodegradation

Phytodegradation (also called phytotransformation) involves the breakdown of organic contaminants through plant metabolism. Plants produce enzymes including cytochrome P450 monooxygenases, peroxidases, and dehydrogenases that can transform organic molecules into less toxic or harmless compounds.

The process occurs in two phases analogous to mammalian liver metabolism. In Phase I, enzymes introduce functional groups such as hydroxyl groups to the contaminant molecule through oxidation, reduction, or hydrolysis. In Phase II, the transformed molecule is conjugated with endogenous plant compounds such as glucose, glutathione, or amino acids, making it more water-soluble and less toxic. These conjugates may then be stored in vacuoles or incorporated into cell wall lignin as bound residues.

Research has demonstrated phytodegradation of chlorinated solvents (TCE), explosives (TNT, RDX), petroleum hydrocarbons (PAHs, BTEX), herbicides (atrazine), and polychlorinated biphenyls (PCBs).

### Rhizodegradation

Rhizodegradation (also called phytostimulation) refers to the enhanced breakdown of contaminants in the root zone (rhizosphere) through the stimulation of microbial activity. Plant roots release exudates including sugars, amino acids, organic acids, and enzymes that serve as carbon and energy sources for soil microorganisms. This greatly increases microbial population density and [[singh-fungal-biodegradation-of-polycyclic-aromatic-hydrocarbons]] hydrocarbons (PAHs) and total petroleum hydrocarbons (TPHs). A multiprocess phytoremediation system combining volatilization, photooxidation, microbial remediation, and phytoremediation proved twice as effective as landfarming and 45% more effective than phytoremediation alone for removing 16 priority PAHs.

### Phytostabilization

Phytostabilization uses plants to immobilize contaminants in soil, reducing their bioavailability and preventing migration to groundwater or entry into the food chain. This is particularly relevant for heavy metals (lead, arsenic, chromium) and radionuclides that cannot be degraded.

Mechanisms include root uptake and sequestration (without significant translocation to shoots), adsorption to root surfaces, precipitation of insoluble compounds in the rhizosphere through pH changes or redox reactions, and reduction of wind and water erosion through vegetative cover. Mycorrhizal fungi associated with plant roots play a significant role in metal immobilization, reducing metal bioavailability and preventing translocation to above-ground tissues.

### Phytovolatilization

Phytovolatilization involves the uptake of contaminants by plants, their conversion to volatile forms, and release to the atmosphere through transpiration. This mechanism has been observed with selenium, mercury, and certain volatile organic compounds (VOCs) such as trichloroethylene (TCE).

While phytovolatilization can effectively remove contaminants from soil and groundwater, it transfers them to the atmosphere where their fate must be considered. Genetically modified plants have been developed to enhance the volatilization of specific contaminants, such as mercuric ion reductase-expressing plants that convert ionic mercury to less toxic elemental mercury vapor.
...
Phytoremediation is constrained by the growing season, climate, and the toxicity tolerance of plant species. It is generally limited to shallow contamination and may require many years to achieve cleanup goals. The introduction of non-native or genetically modified plant species raises ecological concerns, and harvested biomass containing accumulated metals must be properly managed.

Contaminant concentration must be within the phytotoxicity threshold of the selected plants. Very high concentrations may inhibit germination and growth. For sites with mixed contamination (organic and inorganic), selecting plants that tolerate multiple pollutant types is essential but challenging.
