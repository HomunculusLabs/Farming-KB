...
- **Water trenches** around mushroom houses limit ants/bugs while allowing wheelchair access (clean twice monthly)
- **Wide doors** for wheelchair and tricycle access
- **Aisles** inside mushroom houses must allow movement and work from seated position
- **Rack height** must allow people in wheelchairs to access the highest level
...
| Magnesium sulfate | Mineral supplement |
| Sugar | Energy for rapid colonisation |

## Trainee Selection Criteria

The manual emphasises rigorous selection to ensure programme sustainability:

1. **Age range**: Ideally 20-35 (exceptions possible with dedication)
2. **Literacy**: Basic literacy makes training more enjoyable and entrepreneurship more likely
3. **Multiple disabilities**: May create difficulties — assess individually
4. **Location diversity**: Prevents market saturation; encourages community replication
5. **Home interview**: Verify family support, community support, and land access
6. **Motivation assessment**: Most critical factor — more important than disability type
