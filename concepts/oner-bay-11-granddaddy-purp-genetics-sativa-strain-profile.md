...
- **Height**: Can be constrained to approximately 4 feet indoors with proper management
...
- **Height**: Can grow beyond 10 feet if allowed to develop naturally
...
Bay 11 displays classic sativa growth characteristics:
- **Legginess**: The plant can be somewhat leggy, particularly in indoor environments with insufficient light intensity
- **Stretch**: Expect significant stretch after flipping to flowering, especially outdoors
- **Branch structure**: Heavy lateral branching that requires early staking or trellising
- **Resilience**: Generally robust plants, though the heavy bud development makes support systems essential

## Appearance

The buds of Bay 11 are visually striking and colorful:
- **Base color**: Deep green
- **Accents**: White trichome coverage with orange pistils and hints of blue
- **Overall impression**: Described as "the cannabis equivalent of setting off a bunch of party poppers"—a riot of color
- **Trichome coverage**: Heavy crystal production that gives buds a frosted, sugar-coated appearance
- **Bag appeal**: Extremely high; the colorful, resinous buds make any grow room visually impressive
...
Bay 11 is a versatile medical strain with applications for:
