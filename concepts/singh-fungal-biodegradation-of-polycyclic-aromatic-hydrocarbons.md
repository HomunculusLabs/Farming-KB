---
title: Fungal Biodegradation of Polycyclic Aromatic Hydrocarbons
created: 2026-04-26
tags:
  - mycoremediation
...
environmental pollutants consisting of two or more fused benzene rings.
...
- Manganese peroxidase (MnP, EC 1.11.1.13): Generates Mn(III) through
...
- Lignin peroxidase (LiP, EC 1.11.1.14): A versatile peroxidase
  ...
  high-molecular-weight PAHs via veratryl alcohol-mediated cycles.

- Cytochrome P450 monooxygenases: Intracellular enzymes in
  non-ligninolytic fungi (e.g., Cunninghamella, Penicillium) that
  catalyze initial epoxidation of PAH rings, producing arene oxides
  that are subsequently hydrolyzed to trans-dihydrodiols.
...
1. Ligninolytic pathway: Extracellular enzymes generate free radicals
   ...
   substrate into fungal cells.

2. Cytochrome P450 pathway: The PAH enters the cell and undergoes
   regio- and stereoselective oxidation. The initial epoxide is
   conjugated with glucuronic acid or sulfate and may be further
   metabolized through ring fission.

## Key PAH-Degrading Fungal Genera

- Phanerochaete chrysosporium: Model white-rot fungus with well-
  characterized LiP and MnP systems; degrades anthracene, phenanthrene,
  and pyrene.

- Trametes versicolor: Produces laccase and MnP; effective against
...
- Bjerkandera adusta: Produces MnP and versatile peroxidase; active
  against high-molecular-weight PAHs.

- Cunninghamella elegans: Non-ligninolytic zygomycete that uses
