---
title: Phytochrome — The Red and Far-Red Light Photoreceptor
...
The critical breakthrough came in the early 1950s when Harry Borthwick and his team at the USDA discovered that far-red light (approximately 730 nm) — light with wavelengths just longer than visible red — could completely reverse the effect of red light. If irises were given red light followed immediately by far-red light, they behaved as if they had seen no light at all and did not flower. If far-red was followed by another pulse of red, flowering was induced again. This on-off cycling could be repeated indefinitely with just seconds of illumination each time.

By the early 1960s, Butler and colleagues demonstrated that a single molecular photoreceptor was responsible for both effects. They named it phytochrome, from the Greek "phyton" (plant) and "chroma" (color).

## How Phytochrome Works

Phytochrome exists in two interconvertible forms:

- **Pr (phytochrome red-absorbing form)** — absorbs red light (~660 nm); this is the inactive or "off" state synthesized in darkness
- **Pfr (phytochrome far-red-absorbing form)** — absorbs far-red light (~730 nm); this is the biologically active or "on" state

The switching mechanism works as follows:

1. In darkness, phytochrome slowly reverts to the Pr form. This is why plants "see" darkness — the gradual accumulation of Pr signals that no red light has been received recently.
2. When red light strikes the plant, Pr absorbs it and converts to Pfr — the active form that triggers downstream responses including flowering gene expression.
3. When far-red light strikes the plant, Pfr absorbs it and converts back to Pr — deactivating the signal.
4. The conversion is extremely efficient; just a few seconds of light at the appropriate wavelength is sufficient for complete conversion.

This system effectively makes phytochrome a biological light switch that remembers the last color of light the plant perceived.
...
- If the night is short, some Pfr remains when dawn arrives — the plant perceives a "short night" (long day) condition
- If the night is long, all Pfr has reverted to Pr before dawn — the plant perceives a "long night" (short day) condition
- A flash of red light in the middle of the night converts remaining Pr back to Pfr, resetting the clock and making the plant "think" the night was shorter than it actually was
- Far-red light immediately after the red flash converts Pfr back to Pr, restoring the original night-length measurement

## Where Phytochrome Operates in the Plant

Unlike phototropism (which Darwin showed is sensed at the shoot tip), phytochrome for photoperiodism operates primarily in the leaves. Experiments demonstrated that:
