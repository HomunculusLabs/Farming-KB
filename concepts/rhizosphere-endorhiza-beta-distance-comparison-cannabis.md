...
endorhiza. This comparison reveals how [[cannabis-rhizosphere-microbial-communities]] shift
...
Using both unweighted and [[weighted-unifrac-strain-clustering-cannabis-endorhiza-community-structure]] distances, the study compared
...
organisms that can metabolize [[mycorrhiza-root-exudates]], but retaining most of the
soil's original taxonomic composition.

### Bulk Soil vs. Endorhiza: Most Different
Distances between bulk soil and [[cannabis-rhizosphere-endorhiza-communities]] were significantly
