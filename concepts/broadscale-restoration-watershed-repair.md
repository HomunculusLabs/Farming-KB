...
## Microcatchments
On slopes or flat areas, microcatchments can be made by pitting the land with
a shovel. The pits:
- Collect seeds, water, animal droppings, and mulch
- Create rich, sheltered microclimates for plants to establish
- Form patterns that slow and spread sheet flow across the landscape
Simply laying down mulch on bare spots conserves enough water to allow many
seeds to germinate.
## Succession and Natural Recovery
The structures built are only temporary. Their primary function is to allow
