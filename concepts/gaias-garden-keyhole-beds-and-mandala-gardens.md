...
Paths are a necessary evil in gardens but consume growing area. The shape of a garden bed determines how much area goes to paths versus plants:

- **Single rows** with paths between each row sacrifice about 50% of the area to paths (40 sq ft of path for 50 sq ft of planting)
- **Raised beds** with paths every 3-4 rows sacrifice about 30% to paths (10 sq ft for 50 sq ft of planting)
- **Keyhole beds** need only about 12% for paths (6 sq ft for 50 sq ft of planting)

## Keyhole Bed Design

A keyhole bed is a circular or horseshoe-shaped raised bed, 8-12 feet in diameter, pierced on one side by a narrow path leading to a central circular clearing.
