...
7. Once plants are well established, careful management makes the garden
   self-sustaining. Pigs and other animals may forage, trees produce fruit and
   mulch, and smaller plants are harvested on an ongoing basis.

## Mimicking Forest Patterns

To mimic the natural pattern, pick plants to grow together based on height,
climbing ability, tolerance to shade, and water requirements. In a dry or cool
climate, space plants farther apart for better light and water distribution. In
warm, humid climates, put them closer together, but not too close to avoid
fungus problems.

In very fertile places with lots of water, put in all plants at once: walnuts
(long-lived), fruit trees like peaches (shorter-lived), legumes like autumn
olive (nutritious mulch), and perennials like comfrey and yarrow (weed
control).

## The Polyculture Advantage

Monoculture is concerned with the individual plant and how to push each one to
greatest yield. Polyculture, and particularly a forest garden, is concerned
with the whole. Pushing as many species as possible to work together yields
more in total than one species grown alone. Plants may not produce as much
fruit individually, but when collected in total, the quantity of food will be
greater, with the additional benefit of being self-reliant: more food for less
work.
...
Coaction means "acting together." When Species A and Species B are put together,
they affect each other positively, negatively, or not at all. If one is
benefited and the other negatively affected, Species A is a parasite. The goal
is to find combinations that help each other. This is important when working
with many communities that all interact in one mega-community.
...
Animals provide strategic benefits within the forest garden system:
...
- **Predator control:** Dogs can manage foxes, deer, and rabbits. If raised
  with chickens, they will leave poultry alone and protect them.

Animals are placed in the system for a time, and plants are started at
different times, following natural plant cycles rather than artificial
rotation schedules.

## Microclimate Creation

The forest garden creates diverse microclimates within a single plot. A tree
changes temperature and climate around itself. A large oak tree can transpire
40,000 gallons of water per year, cooling surrounding air and helping create
precipitation. Tree structures store water in canopy and bark, and water runs
off down to plants and soil below. This natural air conditioning allows
growing species that would not survive in the open.

## Recording and Species Indexing

Species should be recorded and indexed on 3 x 5 cards, noting all relevant
characteristics including: type of soil, amount of sunlight, specific uses
(food, animal forage, nutrient production, dye), height, growth rate, and
compatibility with other species. This systematic approach to species selection
ensures informed decisions when designing new plant communities.
