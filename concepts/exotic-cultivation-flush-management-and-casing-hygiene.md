...
2. **Maturation (5 to 7 days):** Within 5 to 7 days of pinhead appearance,
   mushrooms reach harvestable size and can be picked.

The source authors normally allow casings to produce **3 flushes** as standard
...
## Misting and Watering Regime

### Daily Misting

The casings are **misted each day** and the casing is **never allowed to dry
out**. Consistent surface moisture is essential because primordia and developing
pins are highly sensitive to desiccation. Allowing the casing to dry can halt
pin development entirely and may cause existing pins to abort.

### Post-Flush Watering

Directly after a flush is picked, **watering should be increased**. Maturing
mushrooms pull significant moisture from the casing soil during their growth,
leaving the casing noticeably drier than before the flush began. Compensating
for this moisture loss promptly encourages the mycelium to initiate the next
flush cycle without excessive delay.

### The Difficulty of Prescribing Exact Schedules
