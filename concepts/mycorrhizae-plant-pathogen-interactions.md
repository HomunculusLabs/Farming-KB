...
Plant pathogenic fungi that attack via roots encounter elevated populations of fungi and bacteria in the rhizosphere, encouraged by the presence of readily available carbohydrates in the form of [[root-exudates]] and dead root cells. This dense microbial community serves as a first line of defense against invasion. Among these rhizosphere inhabitants, mycorrhizal fungi hold special significance due to their intimate physical association with plant roots and their ability to modulate host plant physiology.

The number of fungal pathogens per host plant is significantly lower in non-crop plant species compared to crop species (Clay, 1997), suggesting that natural ecosystems have evolved more balanced pathogen–host relationships, potentially mediated in part by mycorrhizal associations.

## Climate Change and Pathogen Emergence

Simulation models predict significantly enhanced risks of fungal pathogen outbreaks and increased severity of these outbreaks on crop plants with predicted increases in temperature and reduced rainfall (Jahn et al., 1996; Luo et al., 1995). Similarly, Phytophthora-induced decline of oaks in Europe is predicted to increase due to climate change (Brasier, 1996).
...
In the arbuscular mycorrhizal (AM) condition, there is less mycorrhizal fungal tissue at the root surface compared to ECM associations, providing limited physical protection. Instead, AM-mediated defense operates primarily through indirect mechanisms:
...
A comprehensive meta-analysis by Borowicz (2001) of studies published between 1970 and early 1998 revealed that approximately 50% of published studies demonstrated that [[arbuscular-mycorrhizae]] afforded some degree of protection against plant pathogenic fungi and nematodes. Key findings include:

- Most studies were performed on economically important plant species in low-phosphate soil conditions under greenhouse or microplot experiments
- Pathogenic fungi typically reduced the growth of the AM fungus
...
The relationship between mycorrhizal fungi and pathogens is not simply one of mutual antagonism. Newsham et al. (1994) demonstrated this complexity through experimental manipulation of fungal communities associated with the annual grass *Vulpia ciliata* using two fungicides:
