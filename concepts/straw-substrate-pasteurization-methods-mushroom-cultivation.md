...
Temperature ranges for each treatment method differ:
- **Pasteurization**: 140-180°F (60-82°C) at atmospheric pressure (1 psi)
- **Atmospheric sterilization** ("super-pasteurization"): above 190°F (88°C) for at least 12 hours
- **Sterilization**: above 212°F (100°C) and above atmospheric pressure (>1 psi)

## Hot Water Bath Method (Submerged Pasteurization)

The simplest and most accessible method for small-scale cultivators:

1. **Chop straw** into 1 to 4 inch lengths
2. **Stuff straw** into a wire basket
3. **Submerge** in a cauldron of 160°F (71°C) water for 1 to 2 hours
4. **Heat source**: portable propane gas burner underneath
5. **Monitor temperature** with a probe thermometer at least 12 inches long, inserted deep into the brothing mass
6. **Drain** thoroughly after removal
