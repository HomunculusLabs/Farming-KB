...
Mexico possesses the highest number of neurotropic fungal species of any
...
Mexico's 76 neurotropic species compare to the following approximate
...
- **Oceania**: ~20 species (Australia, New Zealand)
- **Africa**: ~10 species (poorly documented)

Notable gaps exist for southeastern Russia, Mongolia, Arabia, Turkey,
Korea, Malaysia (except Java and Sumatra), Hawaii, Costa Rica, and many
African regions — likely reflecting under-collection rather than true
absence. As Gartz (1996) observed, "the mushrooms occur in abundance
wherever mycologists abound."

## Mexican Psilocybe Diversity
...
forests of Oaxaca and Chiapas are particularly rich areas.

## Indigenous Use Traditions
...
mushrooms in Mexican Indian languages, including:
...
- "San isidros" — after Saint Isidore, patron of agriculture
- "Pajaritos" — little birds
- "Derrumbes" — landslides
- "Hombrecitos" / "Mujercitas" — little men / little women (for
  *Cordyceps capitata* and *C. ophioglossoides*)

### Active Indigenous Groups

Multiple indigenous groups in Mexico maintain living traditions of
neurotropic mushroom use:

- **Mazatec** (Oaxaca) — the most widely documented; María Sabina's
  tradition
- **Mixtec** (Oaxaca) — use *P. zapotecorum* and various puffball
  species
- **Chinantec** (Oaxaca) — use *Dictyophora indusiata* for divination
- **Nahua** (central Mexico) — inheritors of the Aztec teonanácatl
  tradition
- **Trique** (Alta Mixteca, Oaxaca) — use *Elaphomyces* species for
  healing

## Impact on Modern Mycology

### Pre- and Post-Wasson Periods

Guzmán (1990) divided Mexican mycology into two periods:

1. **Before Wasson, Heim, and Singer** (pre-1954): Limited mycological
   study with no focus on neurotropic species
2. **After Wasson, Heim, and Singer** (post-1958): Intensive study of
   all fungi stimulated by the international attention generated by
   neurotropic mushroom research

The study of neurotropic fungi thus played a pivotal role in the
development of mycology as a whole in Mexico, generating interest that
extended far beyond the hallucinogenic species themselves.

### Commercial and Recreational Use

The 1960s saw the beginning of recreational mushroom use in Mexico,
leading to the development of an underground market and the eventual
government prohibition of neurotropic fungi. *P. cubensis* is the most
...
- [[neurotropic-fungi-chemical-groups-classification]] — [[guzman-allen-gartz-four-chemical-groups-neurotropic-fungi]]
