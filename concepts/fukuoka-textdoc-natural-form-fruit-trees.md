...
Fukuoka's journey began with a simple question: how to make it possible
not to prune. He thought that pruning would not be needed if the tree
...
irreversible for the individual organism.

## The Scientific Approach to Branch Spacing
...
Association, it created a stir among specialists but was laughed off as
nonsense by the farmers. The central leader type is characterized by a
dominant central trunk with scaffold branches arranged naturally, much
like forest trees such as cryptomeria, pine, and live oak.

## Natural Forms by Tree Type

Fukuoka catalogued the natural forms he observed across different species:

- **Early-ripening Satsuma orange**: low, pyramidal form
- **Late-ripening Satsuma orange**: tallish, cypress-like conical form
- **Summer orange, shaddock, persimmon, chestnut, pear, apple, loquat**:
  tall, cedar-like conical form

All are basically central leader type trees. Their differences in form
arise primarily from the differing number, angle, and directions of the
