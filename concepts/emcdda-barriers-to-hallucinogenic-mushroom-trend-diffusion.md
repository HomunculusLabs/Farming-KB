...
discourage repeat use. Psychoactive psilocybin doses are believed to be between 45 ug/kg body
weight and 315 ug/kg body weight, but translating these values into mushroom weight or count
...
Nearly a quarter of recent mushroom users reported experiencing a panic attack. Bad trips are
characterised by severe anxiety, agitation, confusion, disorientation, impaired concentration
and judgement. In serious cases, acute psychotic episodes may occur including bizarre and
frightening images, severe paranoia, and total loss of reality, which may lead to accidents,
self-injury or suicide attempts. A bad trip is usually followed by faintness, sadness and
depression, and paranoid interpretations that may persist for days, weeks or even months. These
adverse experiences strongly discourage repeat use and word-of-mouth promotion.

### Lack of Sociable Entactogenic Effects
Users do not find mushroom use a particularly pleasant experience compared to ecstasy. The
experience lacks the positive mood-altering (entactogenic) effects that ecstasy provokes.
"Entactogenic" is a relatively new term derived from Greek, describing a specific positive
...
under-25 age groups, meaning the drug use associated with it is unlikely to diffuse widely. The
association with specific niche subcultures rather than mainstream youth culture further
constrains the trend.

## Legal Control as a Reactive Barrier
Since 2001, six EU Member States (Denmark, Netherlands, Germany, Estonia, UK, Ireland) tightened
legislation on hallucinogenic mushrooms as prevalence concerns emerged. New legislation appeared
to have immediate impact on availability in the UK and on the general volume of internet sales.
The prohibition effect pushed the trend underground and reduced visible supply channels, though
it also stimulated interest in legal alternatives like [[amanita-muscaria-and-ibotenic-acid-containing-fungi]] Amanita pantherina.

## Comparison with Ecstasy Diffusion
The contrast with ecstasy diffusion is instructive for understanding drug trend dynamics. Ecstasy
achieved widespread adoption because it offered consistent dosage in tablet form, positive
entactogenic effects suited to social dance settings, easy concealment and consumption, and
social bonding experiences that encouraged peer recommendation. Mushrooms lack all of these
diffusion-friendly characteristics, which explains why their trend remained comparatively
contained despite smartshop availability and internet promotion.

## Implications for Emerging Drug Trend Analysis
The mushroom case study demonstrates that not all emerging drug trends follow the same diffusion
trajectory. The crucial part that contextual forces play in reinforcing or legitimating forms of
regulation is highlighted by the mushroom example. Product characteristics, user experience
quality, and practical barriers can be as important as supply-side factors in determining
whether an emerging trend achieves widespread diffusion or remains contained within niche
populations.
