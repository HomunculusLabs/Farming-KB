...
The mycelial archetype can be seen throughout the universe. Computer models
of the early universe show primordial filaments in space that resemble the
mycelial archetype. Models of dark matter distribution show more than
ninety-six percent of the mass of the universe theorized to be composed of
molecular threads, with galaxies interspersed throughout a mycelium-like
matrix.

Spiral galaxies conform to the same archetypal pattern as hurricanes and
mycelium. Nature tends to build upon its successes. The mycelial
architecture may not be merely a coincidence. Biological systems are
influenced by the laws of physics, and mycelium may exploit the natural
momentum of matter, just like salmon take advantage of the tides.

The arrangement of energy-conserving strings in string theory resembles
the architecture of mycelium, suggesting that the branching network
pattern is one of the most efficient forms for distributing resources and
information in nature. This convergence of form across scales from the
molecular to the cosmic implies deep structural principles at work.

## Fungi Beyond Earth

Fungi may not be unique to Earth. Scientists theorize that life is spread
