...
**Foothill and valley floor:** Deeper, more fertile soil allows walnuts and
ginkgo among evergreens such as Japanese cedar (*Cryptomeria japonica*) and oak.
...
Trees planted as windbreaks serve multiple functions beyond preventing wind
damage: they maintain soil fertility, filter water runoff, and improve the
environment for all creatures. Fast-growing varieties include Japanese cedar,
hinoki cypress, acacia, and camphor. Slower-growing but beneficial species
include camellia, parasol fir (*Firmiana simplex*), strawberry tree (*Arbutus
unedo*), and star anise (*Illicium verum*). Depending on local conditions,
evergreen oak, Japanese cleyera (*Ternstroemia japonica*), and holly may also
be used.
