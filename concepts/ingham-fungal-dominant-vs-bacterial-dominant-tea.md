---
title: "Fungal-Dominant vs Bacterial-Dominant Compost Tea"
created: 2026-04-26
updated: "2026-04-24"
sources:
...
The distinction between fungal-dominant and bacterial-dominant compost teas is one of the most important concepts in AACT application. It is always a question of dominance: even in fungal tea, bacteria must be present, but the fungal component must reach minimum levels for disease suppression.
...
- Foliar disease prevention when conditions favor disease (mildew, anthracnose)
- Brown rot on cherries, Verticillium wilt, cedar apple rust
- Scale insect control on rhododendrons and apples

## Fungal Dominance Requirements

Achieving adequate fungal biomass is the difficult part. The compost must have good fungal biomass, the machine must extract fungal hyphae intact, and oxygen must be maintained throughout brewing.

**Critical oxygen threshold**: When dissolved oxygen falls below 5.5-6 ppm, beneficial fungi are lost. This occurs repeatedly in testing. Beneficial fungi do not tolerate oxygen loss in tea, compost, or soil.
...
- **Fish hydrolysate**: Enzymatically hydrolyzed, containing bone, cartilage, and scale material
...
- **Minimum for disease prevention**: 2 micrograms fungal biomass in tea (below this, prevention is unreliable)
...
Match the fungal:bacterial ratio to the plant's requirements:
...
- **Foliar coverage target**: 60-70% bacteria, 2-5% fungi on leaf surface
- **Fungi at 5%+ of 70% total coverage**: Required for full disease protection

## Hyphal Diameter as Health Indicator

Literally the most beneficial species of fungi tend to have the widest diameter hyphae. Average hyphal diameter of 2.5 micrometers or greater is desired in compost. A few pathogenic species have wide hyphae, but those conditions typically also select for narrow-diameter fungi. A sick soil's fungal community generally lacks wide-diameter hyphae.

## The Whole Food Web

The whole food web is needed to prevent both easy and hard-to-prevent diseases. Bacteria alone account for only a few preventative mechanisms. A tea lacking the full set of organisms may show initial improvement that stalls because the food web is incomplete.

Failures with compost tea consistently occur when the full set of organisms is not extracted from the compost. Be specific about the disease being targeted and what organisms (bacteria, fungi, protozoa, nematodes) are needed to combat it.

## Calcium and Biology

Calcium is useless without balanced biology in the soil. Even with adequate calcium levels, plants cannot access it without the proper fungal and bacterial community to make it plant-available.

## Pathogenic Fungi Context

Pathogenic fungi need reduced oxygen conditions to outcompete beneficial fungi. This is why maintaining aerobic conditions in tea, compost, and soil is critical. The widest diameter hyphae tend to be the most beneficial species; narrow diameter hyphae are more often associated with disease organisms.

## Mycorrhizal Considerations

When VAM colonization is below 10-15%, an inoculum of mycorrhizal fungi will significantly improve colonization. Between 15-40%, adding compost, compost tea, or humic acids helps. Above 30-40% colonization, root disease problems and root-feeding nematodes begin to disappear.
