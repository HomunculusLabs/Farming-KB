...
The researchers cultivated an Amazonian strain of Psilocybe cubensis originating from a spore print collected near Pucallpa, Peru. The cultivation method — termed "miniculture" — used half-pint wide-mouth jars containing 10 grams of rye grain and 15 ml of water, autoclaved and inoculated with mycelium from agar cultures. After 28 days of colonization, jars were shaken every four days to distribute mycelium, then cased with a mixture of 2 parts peat, 1 part calcium carbonate, and 2 parts perlite/vermiculite.

Mushrooms were watered with 1 ml of sterile water every two days via syringe. First flush occurred 4–5 weeks after inoculation (approximately two weeks after casing). Minicultures continued producing for at least 20 weeks when uncontaminated, yielding an average of 2.7 g dry weight per jar. Each flush was harvested at maturity, immediately freeze-dried, sealed in plastic, and stored at −5°C until analysis.

Quantification used reversed-phase high-performance liquid chromatography (HPLC) calibrated against NIDA standards, with qualitative confirmation by thin-layer chromatography (TLC) using butanol-acetic acid-water (12:3:5). Detection limits were approximately 0.01 μg for both compounds, with linear response from 0.2 to 3 μg total and 10% repeatability.

## The Psilocin Accumulation Pattern

### First and Second Flushes: Near-Zero Psilocin

The most consistent finding across all three minicultures was the near-complete absence of psilocin in the first flush:

| Flush | Miniculture 1 Psilocin (mg/g) | Miniculture 2 Psilocin (mg/g) | Miniculture 3 Psilocin (mg/g) |
|---|---|---|---|
| 1 | 0.5 | 0 | 0 |
| 2 | 1.5 | 0 | 0 |
| 3 | 1.0 | 1.7 | 0.9 |
...
Psilocin was either completely undetectable (Minicultures 2 and 3) or present at only trace levels (0.5 mg/g in Miniculture 1) in the first flush. Even the second flush showed zero psilocin in two of three cultures, with only Miniculture 1 showing moderate accumulation (1.5 mg/g). This pattern was confirmed in additional strains grown by outside sources, where the first flush similarly showed nearly complete absence of psilocin.

### Third Flush: Onset of Accumulation

The third flush marked the beginning of consistent psilocin accumulation across all cultures, with levels rising to 0.9–1.7 mg/g. This represents a biosynthetic threshold — the point at which the organism's metabolic machinery shifts toward appreciable psilocin production.

### Fourth Flush: Peak Psilocin Levels

Psilocin levels reached their maximum in the fourth flush across all three minicultures, ranging from 1.8 to 2.9 mg/g. This represents the biosynthetic peak of the conversion pathway from psilocybin (the phosphorylated, stable storage form) to psilocin (the dephosphorylated, bioactive form).

### Fifth and Sixth Flushes: Apparent Decline

By the fifth flush, psilocin levels appeared to begin declining, though the researchers noted they could not follow this decline reliably because five flushes is typically the maximum obtainable before mycelium ceases fruiting. Miniculture 1 achieved a rare sixth flush, where psilocin dropped dramatically to 0.5 mg/g — consistent with an overall decline trajectory.

## Biosynthetic Interpretation

The observed pattern suggests several possible biosynthetic mechanisms:
...
Street samples analyzed by Bigwood and Beug showed highly variable psilocybin levels (0.7–6.2 mg/g) and consistently low psilocin levels (0–0.3 mg/g). The low psilocin in these samples may reflect early-flush harvesting by commercial cultivators seeking maximum yield, as early flushes produce larger individual mushrooms but lower psilocin content.
