...
facilitating efficient nutrient transfer. In the ericoid mycorrhizae, the
host cell dies as the association disintegrates, thereby restricting the
functional life (nutrient absorption capacity) of these epidermal cells to
the period prior to breakdown of the infected cell.
