...
### Protostelia (Protostelids)

**Taxonomy**: Class Eumycetozoa, Subclass Protostelia
**Diversity**: 37 described species in 17 genera; 50+ undescribed species observed
**Key genera**: Protostelium, Nematostelium, Soliformovum, Ceratiomyxa, Schizoplasmodiopsis, Cavostelium
...
- Litter (forest floor, grassland)
- Bark of living and dead trees
- Soil
- Dung (occasional)
- Rotting wood (occasional)
...
### Myxogastria (Myxomycetes / Plasmodial Slime Molds)

**Taxonomy**: Class Eumycetozoa, Subclass Myxogastria
...
4. Under environmental cues, plasmodium converts to fruiting body
5. Fruiting body produces spores for dispersal

**Plasmodium types**:
- **Protoplasmodium**: Microscopic, simple, produces single sporangium (Echinostelium)
- **Aphanoplasmodium**: Network of transparent, flattened strands (Stemonitales)
- **Phaneroplasmodium**: Largest type, with prominent veins and rhythmic protoplasmic streaming (Physarales)
...
### Dictyostelia (Dictyostelids / Cellular Slime Molds)
...
3. Starvation triggers aggregation via chemical attractants (acrasins: cAMP in D. discoideum, glorin in P. violaceum)
4. Multicellular pseudoplasmodium (slug/grex) forms and may migrate
...
- Differences between forest and disturbed-environment soils are striking
- More species at lower latitudes; at given latitude, more at lower elevations
- More clones in moist than dry soils; rare in saturated soils
- Highest diversity from Neotropical rain forest soils
- Most abundant during spring and fall
- Canopy soil of tropical rainforests supports distinct assemblages

**Expected species richness**:
- 50,000-ha temperate deciduous forest: 15-20 species
- Neotropical rainforest: 30+ species
- Grasslands, deserts, boreal/montane forests, tundra: fewer species

### Acrasids

**Taxonomy**: Heterolobosea (not Eumycetozoa, but traditionally studied together)
**Key genera**: Acrasis, Pocheina, Guttulinopsis, Copromyxa, Copromyxella, Fonticula

**Characteristics**:
- Amoebae aggregate directly into fruiting bodies
- Some species also have flagellated forms
- Limax (monopodial) amoebae with plate-like mitochondrial cristae
- Fruit directly without slug formation
