...
## Adhesive Traps: The Simplest Snares
...
a nematode brushes against the interior surface, the trigger mechanism
is released. The ring cells swell dramatically, reducing the diameter
of the opening from roughly 20 micrometers to just a few micrometers,
trapping the worm before it can escape. The entire sequence from
trigger to constriction takes less than one-tenth of a second.

## Chemical Lures and Siren Songs
