---
title: Psilocybe Species Diversity and Biogeographic Origin
tags:
  - mycology
  - biogeography
  - psilocybe
...
The genus Psilocybe contains 116 of the 216 known neurotropic fungal species, making it by far the most important genus in terms of psychoactive mushroom diversity. Analysis by Guzmán, Allen, and Gartz reveals striking biogeographic patterns suggesting a southern hemisphere origin for the genus, with subsequent northward dispersal. The distribution of species is heavily concentrated in subtropical and mesophytic forests, particularly in Mesoamerica and South America.

## Global Species Counts by Region

The distribution of neurotropic Psilocybe species across major world regions shows a clear concentration in tropical and subtropical areas:
...
- **Africa**: Only 6 to 8 known species, reflecting scarce mycological exploration rather than true absence
...
- **4 species** (9.5%) grow in tropical forests
...
## Distribution Patterns Following Hongo's Types
...
### North American and Eastern Asiatic Disjuncts
Psilocybe graveolens, P. muliercula, P. pintonii, and P. zapotecorum from the Americas are closely related to P. argentipes and P. subcaerulipes from Japan, suggesting ancient connections across the Pacific.

### Southeastern Asiatic Species
...
Neurotropic Psilocybe species span an extraordinary elevational range:

- From sea level in tropical coastal regions
- To approximately 4,000 meters in the high mountains of central Mexico (P. aztecorum)
- Copelandia cyanescens grows at 3,000 meters in Maui, Hawaiian Archipelago

## Exploration Gaps

Despite the apparent biogeographic patterns, significant gaps in exploration limit our understanding. No records of neurotropic fungi exist from southeastern Russia, Mongolia, Arabia, Turkey, or many regions of Africa. Even in well-studied countries like the USA, several states (Arizona, Colorado, Illinois, Maryland, Vermont, Massachusetts, New Hampshire, Pennsylvania) lack records of neurotropic Psilocybe species, likely due to limited mycological survey effort rather than true absence. The same applies to Korea, Malaysia (except Java and Sumatra), and Hawaii.

As Gartz (1996) aptly observed: "The mushrooms occur in abundance wherever mycologists abound." This sampling bias means that the true global diversity of neurotropic fungi is certainly higher than the 216 species documented, and new species continue to be described from under-explored regions.

## Conservation and Research Implications

The concentration of Psilocybe diversity in poorly explored tropical and subtropical regions has important implications for conservation. Deforestation of mesophytic cloud forests in Mexico, Central America, South America, and Southeast Asia threatens habitats that harbor the highest concentrations of neurotropic species. Many species are known from only a handful of collections and may be endemic to very small geographic areas. The continued description of new species from under-explored regions (Gartz et al. from South Africa, Stamets and Gartz from the USA, Guzmán and colleagues from Colombia, Thailand, New Zealand, and Spain) confirms that significant undiscovered diversity remains.

International legal frameworks that prohibit psychoactive fungi may inadvertently hamper mycological research and conservation efforts in regions where these species are concentrated. Researchers face practical obstacles when studying fungi that are simultaneously important scientific subjects and controlled substances.
