...
in biological systems as seals, gaskets, tubing, and [[aseptic-specimen-transfer-space-environment-microwave-sterilizable-access-port]] components. Their
...
- **Autoclaving**: [[heat-transfer-coefficient]] through elastomers is slow and can damage the
...
The [[microwave-sterilizable-access-port]] Port (MSAP) was the original motivation for this
