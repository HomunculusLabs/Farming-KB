...
- **74,000 to 120,000** fungal species have been named to date
- **1,500,000** species hypothesized by Hawksworth (1991) — now considered likely an underestimate
- We know at most **5%** of extant fungal species
- As habitats are degraded each year, hundreds or thousands of species are lost before being discovered
- Evidence from tropical plant studies and molecular investigations suggests the true number may far exceed 1.5 million
...
| Phylum | Key Characteristics | Examples |
|---|---|---|
| **Plasmodiophoromyctoa** | Intracellular parasites of plants | Plasmodiophora brassicae (club root) |
| **Dictyosteliomycota** | Cellular slime molds | Dictyostelium |
| **Acrasiomycota** | Cellular slime molds | Acrasis |
| **Myxomycota** | Plasmodial slime molds | Physarum |
...
- 2,500-3,000 species can be found in 200 hectares if studied by specialists for 25+ years
- Many fungi produce fruiting bodies only at intervals of many years
- Some live inside plants or arthropods, detectable only by culturing or molecular methods
- Pleomorphic fungi may have different names for different life stages
