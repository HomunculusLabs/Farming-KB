...
Cannabis has a haploid (n) chromosome number of 10 and a diploid (2n)
chromosome number of 20. Each chromosome contains hundreds of genes
influencing every phase of the plant's growth and development. The
chromosomes exist in homologous pairs, with one member of each pair
inherited from the staminate (pollen) parent and the other from the
pistillate (seed) parent.
