...
The speed and quality of the fruiting response depends on how well the
cultivator manages these transitions. Abrupt changes can shock the
mycelium, while overly gradual changes may not provide a strong enough
trigger.
...
High carbon dioxide causes mushrooms to develop long, stringy stems and
small, underdeveloped caps. This is the classic "leggy" appearance of
mushrooms grown in stagnant air. Adequate fresh air exchange produces
short, thick stems and large, well-developed caps.

### Airflow Patterns

The goal is not to create a wind tunnel but to ensure continuous gentle
air exchange. Direct drafts on the fruiting surface can cause the
mycelium to dry out and abort pins. The best approach uses passive
airflow through holes or vents positioned to create convection currents,
supplemented by a small oscillating fan pointed away from the growing
surface.
...
developing mushrooms, which can cause them to rot.
