...
- Has spiny oogonia, distinguishing it from many congeners.
- Causes hyphal interference and induces rapid hyphal lysis in many hosts (Elad et al. 1985).
- After first contact with a host hypha, stops host growth in an average of 4.5 minutes; penetration occurs after about 50 minutes, disrupting the hypha up to 1.2 mm ahead of the contact point.
- Less aggressive than P. mycoparasiticum but more aggressive than P. nunn (Laing and Deacon 1990); better at competing for nutrients than P. nunn (Elad et al. 1985).
...
- Produces antibiotic metabolites, including glucose oxidase (identified as the main antifungal agent; Kim et al. 1990), which releases hydrogen peroxide from glucose, highly toxic to V. dahliae. Also produces β-1,3 glucanase and chitinase.
