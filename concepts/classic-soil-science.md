...
|-------------|------|-------------|
| **Oi** | Fibric | Freshly fallen or slightly decomposed organic material (recognizable leaves, twigs) |
| **Oe** | Hemic | Partially decomposed organic matter (some original structure visible) |
| **Oa** | Sapric | Fully decomposed, dark organic material — essentially humus |
