...
argument that human interference in decomposition is not only unnecessary but actively
counterproductive.
...
transportation, and burning of fuel oil and the antipollution treatment of stack gases
are accounted for, cremation is neither fast nor clean. Simple burial or open burial,
where the corpse is exposed to the elements, are described as the most sensible and
complete methods of disposal, even if they seem primitive to the short-sighted.

## Nature vs. Human Refuse Processing

Designs for the most advanced refuse processing plants are described as child's play
compared with the infinitely elaborate methods used by nature. Human society
