---
title: Forest Garden Seven Layers
created: 2026-04-14
updated: 2026-04-15
type: concept
...
Many of the same fruits and nuts as the canopy, but on dwarf and semi-dwarf rootstocks. Also includes naturally small trees: apricot, fig, nectarine, almond, mulberry, persimmon, pawpaw. In a smaller forest garden, these may serve as the canopy. Flowering trees such as dogwood and mountain ash, and nitrogen-fixers like golden-chain tree and silk tree, add beauty and function.

### 3. Shrub Layer

This tier includes flowering, fruiting, wildlife-attracting, and other useful shrubs. The broad palette available lets gardeners emphasize food, crafts, ornamentals, birds, insects, natives, or biodiversity.

**Examples**: Blueberry, rose, hazelnut, butterfly bush, bamboo, serviceberry, Siberian pea shrub, and Elaeagnus species. Shrubs range from dwarf blueberries to nearly tree-sized hazelnuts and can be plugged into edges, openings, and niches of many forms.
...
- Trees and woody plants go in first, since they take longest to mature and define the garden's shape
- Design for full mature size of trees to avoid overcrowding
- Leave room for sunlight to penetrate between full-grown trees
- Include plenty of nitrogen-fixing and soil-building plants early on
- Set up a nursery area for propagating plants for the lower layers
- The more northerly the garden, the more space needed between trees for light penetration
