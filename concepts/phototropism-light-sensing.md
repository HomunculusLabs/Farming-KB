...
- **Frits Went** (1926): Isolated **auxin** (indole-3-acetic acid, IAA) as
  the hormone responsible for the bending response. Auxin accumulates on the
  shaded side of the stem, causing cells there to elongate more than cells on
  the lit side.
...
3. **Auxin lateral transport**: Auxin transporters (PIN proteins) on the
   ...
   to the shaded side.
4. **Asymmetric elongation**: Higher auxin concentration on the shaded side
   activates cell wall-loosening enzymes (expansins) and promotes cell
   elongation through acid growth.
5. **Curvature**: The longer cells on the shaded side cause the organ to bend
   toward the light source.

### Root Phototropism

Roots exhibit **negative phototropism** — growing away from light. This keeps
