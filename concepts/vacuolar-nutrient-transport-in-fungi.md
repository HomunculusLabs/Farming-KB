...
- **Compost and residue decomposition**: The efficiency with which fungi decompose crop residues is directly linked to their ability to transport nutrients from decomposed zones to colonize fresh substrate via the vacuolar network, influencing composting rates and soil organic matter dynamics.
