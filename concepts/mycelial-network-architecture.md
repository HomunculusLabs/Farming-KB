---
title: gadd-mycelial-network-dynamics Architecture
created: 2026-04-28
...
Ectomycorrhizal fungi and wood-decay fungi produce rhizomorphs: densely packed, rope-like bundles of hyphae. These structures allow long-distance transport of water and nutrients across meters of soil. Armillaria species produce melanized rhizomorphs that can survive harsh conditions and bridge between distant food sources, forming some of the largest living organisms on Earth. Individual Armillaria genets have been mapped spanning hundreds of hectares.

## Transport Mechanisms

### Cytoplasmic Streaming

Cytoplasmic streaming is the bulk flow of cytoplasm through hyphae, driven by pressure gradients and motor proteins moving along the cytoskeleton. Velocities can reach 10-60 micrometers per second. This mechanism rapidly distributes nutrients, signaling molecules, and even nuclei throughout the network, enabling coordinated behavior across the entire mycelium. In some basidiomycete species, individual nuclei can migrate across the network, contributing to genetic diversity.
...
Mycelial networks sense and respond to a wide range of environmental cues including nutrient gradients, pH, light, temperature, mechanical stress, and chemical signals from other organisms. These signals are integrated across the network to coordinate growth decisions. The distributed nature of sensing means that different parts of the same mycelium can respond differently to local conditions while maintaining overall coherence through cytoplasmic communication.
