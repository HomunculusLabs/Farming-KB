...
compared to open-air inoculation.

## Flame Sterilization

Metal inoculation loops, scalpel blades, and the necks of culture jars are
flame-sterilized using a butane or alcohol lamp before and after each use.
The tool is heated until it glows red-hot, then allowed to cool for several
seconds before contacting spores or media. This kills surface contaminants on
the tool.

## Spore Syringe Technique

A spore syringe is shaken to distribute spores evenly in the suspension. The
needle is flame-sterilized and cooled, then injected through a self-healing
port or tape-covered hole in the lid of the grain jar. Typically 1 to 2
milliliters of spore solution is used per jar. The injection site is
immediately covered with micropore tape or alcohol-soaked cotton.

## Agar Plate Inoculation

For agar work, spores are streaked onto the surface of a cooled agar plate
using a sterile loop. A small drop of spore solution is placed at one edge of
the plate, then the loop is dragged across the surface in a zigzag pattern to
isolate individual spores. This produces discrete colonies that can be
transferred to fresh plates for isolation of specific strains.
...
After inoculation, jars or plates are stored in a warm, dark location
appropriate for the target species. Grain jars are shaken at 20 to 30 percent
colonization to distribute mycelium evenly. Colonization progress is
