...
layer-cake of silt and leaves. Beside these can be planted willow,
Acacia, or other fibrous-rooted and hardy species. Mulch behind logs
and barriers quickly stabilises the seed bed for planting.

## The Net and Pan System

The "net and pan" planting pattern is an effective control in
overgrazed, eroded, mined, or bulldozed sites. If tyres are available,
the "pans" can be made from these, filled with mulch, and diversion
drains led in above the tread level. For people with access to logs,
these can be staked cross-slope on a slight downhill grade so that
water zigzags across the erosion face and absorbs into the ground.

## Slope Measurement

Slopes are measured as degrees from the horizontal, as percentages
