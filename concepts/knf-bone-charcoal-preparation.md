...
### Step 1: Source and Prepare Bones
- Use bones from vertebrate animals: pig, cow, or fish bones
- Bones should be boiled first, with all meat and fat removed
- Do not use raw bones with meat or fat still attached

### Step 2: Low-Temperature Burning
- Burn the cleaned bones at a **low temperature** to convert them to charcoal
- This is a careful process -- too high a temperature will destroy the mineral structure
- Too low a temperature will leave organic matter intact
- The bones should turn to a charcoal state: blackened but not ash

### Step 3: Size the Charcoal
- Use the bone charcoal as-is (whole pieces) or pound them lightly
- **Do not pound too much**, as excessive pounding turns the charcoal to powder
- Pieces should be small enough to fit in the extraction jar but large enough to remain intact during the acid extraction process

### Step 4: Extract with BRV
- Place the bone charcoal in a clay jar or Japanese cedar bucket
- Cover with porous paper (Korean paper or paper towel) secured with a rubber band
- Add BRV at a ratio of **charcoal to BRV = 1:10** by weight
...
The resulting Water-Soluble Calcium Phosphate can be used for:

- Drinking water for pregnant or ovulating livestock (dilution 1/500)
- Leaf spray during cross-over and vegetative growth periods (dilution 1/1,000)
- Correcting crop overgrowth
