...
- Late and low reproduction; larger fruits in smaller quantities
- Large seeds, innate seed dormancy, no seed bank
- More herbivore defense, form seedling banks
- **AMF response**: Facultative or obligate mycorrhizal
- Depend on AMF for successful establishment
...
### Two Simultaneous Activities Required
1. **AMF ecology research**: Greenhouse and field experiments to understand AMF role in plant growth, spatial/temporal variation, and mycorrhizal dependency
...
2. Extract spores by wet sifting and decanting (Gerdemann and Nicolson 1963, modified by Daniels and Skipper 1982)
3. Count spores under stereoscopic microscope at 5x
4. Use approximately 150 spores per 200 g of soil for inoculation
5. Germinate seeds in greenhouse, inoculate when seedlings reach approximately 10 cm height
6. Monitor AMF colonization using root-dying technique (Phillips and Hayman 1970)
7. Transplant after 3 months of inoculation, preferably at beginning of rainy season

### Measured Growth Parameters
- Stem height and diameter, leaf area
- Dry weight: stem, root, leaf, total
- Root/shoot ratio, leaf area ratio (LAR), specific leaf area (SLA)
- Net assimilation rate (NAR), relative growth rate (RGR)
- Survivorship in field
