...
|-----------|-----------|-------------|
| 0–5 meq/100g | Sandy | Low nutrient holding. Frequent small amendments needed. Leaching risk. |
| 5–15 meq/100g | Loamy/silt | Moderate. Standard amendment schedules work. |
| 15–30+ meq/100g | Clay, high-OM | High nutrient holding. Amendments last longer. Can over-apply without knowing. |

**CEC drives amendment rates**: A soil with CEC of 5 needs half the lime of a soil with CEC of 10 to achieve the same pH change. Always use CEC-adjusted recommendations.

## Base Saturation (Albrecht Method)

The Albrecht approach (used by Logan Labs, Kinsey) evaluates the **percent** of CEC occupied by each cation, not just absolute amounts:

| Cation | Target % of CEC | Role |
|--------|-----------------|------|
| Calcium (Ca) | 60–75% | Soil structure, pH buffer |
| Magnesium (Mg) | 10–20% | Chlorophyll, enzyme function |
| Potassium (K) | 2–5% | Disease resistance, quality |
| Hydrogen (H) | 10–15% | pH indicator |
| Sodium (Na) | 0.5–5% | Keep low — displaces Ca, causes structure problems |

**The Ca:Mg ratio** matters: Aim for 3:1 to 7:1. If Mg dominates (>20%), soil becomes tight and poorly drained. If Ca is very high relative to Mg, soil may be overly loose and droughty.

## Phosphorus Interpretation

Phosphorus is notoriously difficult to interpret because labs use different extraction methods:

| Extraction Method | What It Measures | Typical For |
|-------------------|-----------------|-------------|
| **Bray P1** | Acid-extractable P | Acid to neutral soils (pH < 7) |
| **Mehlich-3** | Multi-element extraction | Wide pH range, most common modern method |
| **Olsen P** | Bicarbonate-extractable P | Alkaline soils (pH > 7) |

Check which method your lab uses before comparing results to guidelines. Living soil systems with active [[mycorrhizal-fungi]] networks can access phosphorus that lab extraction underestimates — plants may need less P than the test suggests.
...
1. Get lab results with recommendations
2. Follow recommended amendment rates (usually in lbs/1000 sq ft or lbs/acre)
3. Re-test in 1–2 years to assess
...
| Test Result | Conventional Fix | Biological Fix |
|-------------|-----------------|----------------|
| Low pH | Agricultural lime | Lime + build OM for buffering |
| High pH | Elemental sulfur | Sulfur + organic matter + compost tea |
| Low P | Triple super phosphate | Rock phosphate + mycorrhizae + FPJ |
