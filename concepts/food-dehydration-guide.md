...
Recommended brands: Excalibur (horizontal airflow, best quality), Nesco (vertical airflow, affordable), or Cosori (mid-range with timer).
...
- Apples, pears, peaches: Dip in lemon juice or ascorbic acid solution (1 tsp per cup of water) to prevent browning
- Bananas: Dip in lemon juice
- Berries: No pre-treatment needed
- Grapes: No pre-treatment (become raisins)

### Vegetables

- Blanch vegetables in boiling water for 2-5 minutes, then ice bath. Blanching destroys enzymes that cause off-flavors and color loss during storage.
- Tomatoes: Slice and salt lightly. No blanching needed.
- Bell peppers: Remove seeds and slice. No blanching needed.
- Root vegetables: Peel, slice 1/8-1/4 inch thick, blanch.

### Meats

- Use lean cuts only -- fat becomes rancid in storage
- Slice 1/8-1/4 inch thick against the grain
- Marinate if desired (soy sauce, Worcestershire, spices)
- Dry at 160 F until leathery but not brittle

## Drying Times

Drying times vary by food thickness, humidity, and dehydrator. Check periodically after the minimum time.

- Herbs: 2-4 hours
- Fruit leather: 4-8 hours
- Sliced apples: 6-12 hours
- Sliced bananas: 6-10 hours
- Sliced tomatoes: 10-18 hours
- Bell pepper strips: 6-10 hours
- Sliced carrots: 6-10 hours
- Berries: 12-24 hours
- Beef jerky: 4-8 hours

## Testing for Doneness

- Fruits: Leathery and pliable, no visible moisture when squeezed
- Vegetables: Brittle or crisp -- snap when bent
- Herbs: Crumble easily between fingers
- Fruit leather: Peels away from tray cleanly, no sticky spots
- Jerky: Bends and cracks but does not break; no moist spots when cut open
...
- Stored at room temperature (70 F): 6-12 months
- Stored in cool conditions (50-60 F): 1-2 years
- Vacuum sealed with oxygen absorbers: 2-5 years
- Frozen: Indefinite (but not necessary if properly dried)

## Reconstitution

Most dehydrated foods can be rehydrated by soaking in water:

- Vegetables: Soak in boiling water for 15-30 minutes, or cold water for 1-2 hours
- Fruits: Soak in warm water for 30-60 minutes
- Herbs: Add directly to cooking -- no reconstitution needed
- Jerky: Eat as-is or add to soups and stews

Use the soaking liquid in cooking -- it contains water-soluble nutrients.

## Making Fruit Leather

Fruit leather (fruit roll-ups) is an excellent use for overripe fruit and homestead fruit that is too blemished for fresh eating.
