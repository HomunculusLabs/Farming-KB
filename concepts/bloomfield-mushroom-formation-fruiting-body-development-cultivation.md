...
Even a casual inspection of a fruiting body is enough to frighten a
biologist who dreams of solving something in his or her lifetime. The
fly agaric, with its bright red cap splattered with white scales, can
enlarge to the diameter of a dinner plate. Underneath, hundreds of
white gills are spaced as evenly as spokes on a bicycle wheel, all
their edges hanging flush with the bottom of the cap. This integrity of
form signifies that hyphae in the fruiting body communicate positional
information with their neighbors, but science remains deaf to the
chemical language of these arias.

## The Embryonic Mushroom
...
existing hyphae rather than further increase in the number of cells.

In comparison with animal tissues, there is little if any
differentiation among cell types in most of the mushroom. If a piece of
stem or cap tissue is placed on agar, the hyphae will grow outward,
revert to their invasive behavior, and regenerate a mycelium. Every
mushroom cell behaves like an animal stem cell. Something about the
position of hyphae within the fruiting body and relative to one another
is critical in determining the way that each cell grows, but only while
it stays in that place.

## Hyphal Construction: A Unique Developmental Mode

Fungi do not have meristems, the specialized groups of dividing cells
that build the tissues of leaves, stems, roots, and fruits in plants.
Instead, mushrooms are produced by the elongation and branching of
innumerable hyphae. When a mushroom's stalk or cap is cut, you'll see
ellipses and circles rather than cylinders, because it is impossible to
cut along a hypha very far before passing through the other side. A
fruiting body can contain millions of hyphae bundled together. This
hyphal construction is a unique feature of fungi; nothing else develops
in the same fashion.

The only obvious differentiation, other than variations in cell length
and diameter in the cap and stem, occurs within the fertile hymenium,
where spores are produced. In most mushroom species, all hyphal apices
that emerge at the gill surface become basidia. In ink-caps, three
distinct cell types inhabit the gills: basidia, sausage-shaped
paraphyses that form a sterile pavement between them, and enormous
cystidia that inflate across the gap to connect with the opposing gill,
acting as braces that prevent tearing as the cap expands.
