...
Source: [[white-clover-living-mulch]] also withers and turns yellow. The idea is not to kill the clover, but only to weaken it to allow the rice seedlings to be established. When the water is drained (as soon as possible) the clover recovers and spreads to cover the field's surface again beneath the growing rice plants.

After that, he hardly does anything in the way of water management. For the first half of the season, he does not irrigate at all. The water retention of the soil increases each year with the accumulation of [[fukuoka-straw-mulch-philosophy]], making it possible to grow rice in a dry field.
...
When working with Fukuoka: Rice Grown in Dry Fields, several practical factors should be
