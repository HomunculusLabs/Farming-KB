...
- Generally fast-growing and opportunistic
...
#### Phycomyces
Known for Phycomyces blakesleeanus, a model organism for studying phototropism (growth toward light) and sensory perception in fungi. The large sporangiophores are sensitive to light, gravity, wind, and [[query-how-do-plants-use-chemical-signals-to-defend-against-insects]].
...
### Ecological Roles of Zygomycetes
...
#### Rhizophagus
Formerly grouped within Glomus. Rhizophagus irregularis is the primary species used in commercial [[pgpr-mycorrhizal-inoculants-microplant-establishment]]. It is effective across many crop species and is the most common AMF in agricultural soils.

#### Gigaspora and Scutellospora
Produce very large spores (up to 500 micrometers). These genera are important in tropical soils and are sensitive to soil disturbance, making them less common in intensively farmed land.

#### Funneliformis
Contains F. mosseae, one of the most common AMF worldwide. It is widely used in research and commercial inoculants, particularly in temperate agricultural systems.

### How Arbuscular Mycorrhizae Work

1. Fungal hyphae extend from plant roots into surrounding soil, greatly increasing the absorptive surface area
2. Hyphae enter root cells and form highly branched arbuscules, the site of [[arbuscule-isolation-and-nutrient-exchange-mechanisms]]
...
5. External hyphae (extraradical mycelium) can connect multiple plants, creating common [[dighton-mycorrhizal-networks-carbon-transfer]]
...
- Reduced need for phosphorus fertilizers in agricultural systems

### Management Considerations

- AMF are sensitive to tillage: no-till practices preserve mycorrhizal networks
- High phosphorus fertilizers suppress AMF colonization (plants don't need the fungal help)
- Cover crops and crop rotation maintain AMF populations between cash crops
- Some crops (Brassicas, Chenopods) are non-mycorrhizal and do not support AMF
- Commercial inoculants exist but native AMF populations are often sufficient if soil is not disturbed

## Mucormycosis (Zygomycosis)

Mucormycosis is a rare but serious fungal infection caused by Mucorales (especially Rhizopus, Mucor, Lichtheimia). It primarily affects immunocompromised individuals (diabetic ketoacidosis patients, transplant recipients, chemotherapy patients). The infection is aggressive, invading blood vessels and causing tissue necrosis. Rhinocerebral mucormycosis (starting in the sinuses) is the most common form. Treatment requires aggressive surgical debridement combined with antifungal therapy (amphotericin B).

## Identification Tips

- Zygomycetes: look for fast-growing, cottony colonies with black sporangia on bread or fruit
- Microscopic identification requires examining sporangia, columellae, rhizoids, and stolons
- Glomeromycota: identified by large spores (100-800 um) in soil, requiring specialized extraction methods
- AMF spore identification requires compound microscopy and often molecular methods
