...
discovery." Over decades of development, Word had accumulated hundreds of
...
unaware of capabilities that could significantly improve their productivity. The
Ribbon reorganizes commands into task-oriented tabs (Home, Insert, Design,
Layout, References, Mailings, Review, and View), making related functions
...
Styles, and Editing. Within groups, the most commonly used commands appear as
...
a bridge between the visual Ribbon interface and programmatic extensibility.
...
received substantial criticism for removing the ability to switch back to the
