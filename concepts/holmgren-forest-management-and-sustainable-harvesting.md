---
title: Holmgren Forest Management and Sustainable Harvesting
created: 2026-04-18
updated: 2026-04-18
type: concept
...
The Indian caste system's regulation of land use (as interpreted through a permaculture lens) shows sophisticated understanding of forest management:

- Zone 1-2 (gardens): Everyone's right for family needs
- Zone 3 (arable land): Private enterprise for market crops, but limited by labour constraints
- Zone 4 (forests and rangelands): Strictly regulated commons — entrepreneurial drive constrained because unrestrained exploitation would destroy the free resources (fertility, water, fodder, fuel) that managed natural systems provided to the whole society
- Zone 5 (sacred): Beyond utilitarian use by anyone

## Forest Gardens in the Permaculture Vision

Small-scale food forests are the best-understood example of productive forestry. The broader concept extends to:

- Agroforestry combinations (timber and pasture, timber and fodder, seed and honey)
- Dryland tree crops (olives, carobs)
- Riparian forest buffers along waterways
- Shelterbelts and hedgerows as linear forest elements
- Keyline-based forest placement in catchment systems

The permaculture concept began with the question of how to create forests that were agriculturally productive, rather than simply seeing the need for less farmland and more forest for catchment protection. This productive forest vision remains central to Holmgren's work.

## Source

From *Permaculture: Principles and Pathways Beyond Sustainability* by David Holmgren, Principle 3 (Obtain a Yield).
