---
title: Singh PAH Biodegradation by Fungi in Soils and Bioreactors
created: 2026-04-21
updated: 2026-04-21
type: concept
tags: [mycoremediation, biology, soil, pollution]
...
- Benzo[a]pyrene eliminated up to 30%, 47%, and 94% after 1, 2, and 4 months in creosote-contaminated soil
- Total PAHs lowered to 96% after 4 months
...
- Recovered 8.5% 14CO2 from [14C]benzo[a]pyrene after 15 days; 73% water-soluble metabolites
- Indigenous microflora from activated sludge, acid forest soil enhanced mineralization by 20-27%
- Significant reduction in mutagenic potential observed in Salmonella typhimurium revertant assay

### Irpex lacteus
- Efficiently removed 3- and 4-ring PAHs from artificially spiked soil after 3 months
- Produced LiP and laccase but NO MnP in sterile soil
- Efficiently colonized sterile and nonsterile soil from wheat straw inoculum
...
- Pycnosporus cinnabarinus laccase + ABTS: 95% benzo[a]pyrene degradation in 24h

## Soil Factors Affecting Biodegradation

### Critical Parameters
- Soil moisture, pH, redox potential, oxygen, nutrient content, temperature
- Adsorption/covalent binding to organic carbon affects bioavailability
- Octanol-water (Kow) partitioning coefficient correlates with retention
- PAH solubility determines degradation rate: phenanthrene > pyrene > benzo[a]pyrene

### Temperature Effects
- Degradation increases 1.4-3.6x when temperature rises from 8C to 22C
- At 8C: 12-20% degradation (except heterocyclic compounds at 40%)
- Four-ring PAHs show more degradation than three-ring at both temperatures
- Pretreated soil inoculated at 8C showed higher degradation than expected

### Substrate Enhancement
- Wheat straw is the best substrate for soil colonization and PAH mineralization
- Fish oil added to spent mushroom compost enhances creosote-contaminated soil treatment
- Surfactants (Tween 80, Tween 40) enhance ligninolytic enzyme activities
- Maltosyl cyclodextrin (MCL) enhances fluorene biodegradation

### Nitrogen Considerations
- P. chrysosporium inhibited by nitrogen above certain levels
- P. ostreatus and B. adusta degrade xenobiotics even with nitrogen present
- This makes P. ostreatus suitable for nitrogen-rich contaminated soils
...
## Bioreactors and Pilot Systems

- Laccase bioreactors for benzo[a]pyrene treatment
...
Pilot-scale constructed wetlands are employed to treat PAH-contaminated sites. The combination of fungal and plant systems in wetland environments shows promise for passive, low-maintenance bioremediation of PAH-contaminated groundwater and surface water.

## Genetic Engineering Approaches

- 10 structural genes for LiP isozymes (lipA through lipJ) identified in P. chrysosporium
- LiP isozymes show kinetic and substrate range differences
- Competitive RT-PCR used to understand physiological state of P. chrysosporium in soil
- Three MnP genes coordinately regulated; expression correlates with fluorene degradation
- Unusual pattern of lip gene expression: early phase dominated by lipA and lipD; lipJ highest in later stages
- Heterologous expression of LiP remains challenging

## Limitations and Challenges

- Two-three ring PAHs degraded faster (half-lives of days); four+ ring PAHs persist (months to years)
- High molecular weight PAHs limited by low solubility and slow diffusion
- Four white-rot fungi (P. chrysosporium, P. ostreatus, C. versicolor, Wye isolate) unable to thrive in highly contaminated soil (remained metabolically inactive)
