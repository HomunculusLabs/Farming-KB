...
Shulgin explored both psilocin and psilocybin as pure chemicals and found them **completely interchangeable** as to their pharmacological properties. There is no proof that the phosphate ester (psilocybin) converts to the indolol (psilocin) metabolically, but it is a good guess, and there have been no demonstrated differences in their pharmacology.

The same equivalence extends to the acetate ester: psilocin, the acetate ester, and the phosphate ester (psilocybin) all produce essentially identical effects.
...
- Congeners such as **baeocystin** and **norbaeocystin** present in widely different proportions across species and largely unexplored pharmacologically
- Decreases in psilocybin/psilocin content observed as a function of nutrient diet
...
- TIHKAL Entry #18 (4-HO-DMT), pp. 3180-3400
- TIHKAL commentary on 4-HO-DET and related 4-hydroxy tryptamines
