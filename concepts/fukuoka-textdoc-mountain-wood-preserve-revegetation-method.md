---
title: Mountain Wood Preserve and Revegetation Method for Natural Farms
created: 2026-04-28
tags:
  - fukuoka
  - reforestation
...
3. **Enrichment of the farm** by carrying nutrients built up in the humus of the upland woods or forest downhill with rainwater or by other natural means

Whatever the means employed, the natural farmer must secure a nearby supply of humus that can serve as a source of soil fertility. When there is no uphill wood available for use as a preserve, a new wood or bamboo grove can be developed specifically for this purpose.
...
The mechanism by which a forest generates soil fertility operates through
several interconnected processes that together form a self-reinforcing cycle
of enrichment. Understanding these processes helps explain why the wood
preserve is so effective as a fertility source for the farm below.
...
from subsoil layers that shallow-rooted crop plants cannot reach. These
minerals are brought to the surface in leaf tissue and deposited on the
forest floor as litter, where they enter the surface soil nutrient pool.

## Integration With the Farm Ecosystem

The wood preserve does not operate in isolation from the rest of the farm.
...
Fukuoka's design philosophy was to create farm ecosystems in which every
component serves multiple functions. The wood preserve is not merely a
source of organic matter; it is simultaneously a pest management system, a
water regulation system, a biodiversity reservoir, and a microclimate
moderator.
