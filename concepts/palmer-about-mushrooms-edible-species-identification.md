---
title: Palmer - Edible Species Identification
created: 2026-04-26
updated: 2026-04-24
sources:
...
- Top ranges from pure white to deep brown.
- Taste and smell are peculiar to the species -- once learned, not easily confused.
...
- Has a movable ring around the stem.
- Soon after maturity, gills turn black, then it opens umbrella-like and melts into inky fluid.
- No poisonous counterpart exists. Never eat stale specimens or those with black gills.
- The ink from its deliquescence is a genuine fluid; Palmer wrote manuscript with it.

### The Elm-tree Mushroom (Agaricus ulmarius)
- Grows only in fall, exclusively on elm trees.
- Often found in a cleft or where a limb has been sawn off.
- Thick, solid stem (sometimes set to one side); broad, white gills; firm white flesh.
