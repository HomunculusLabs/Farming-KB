---
title: Allegro John the Baptist as Red-Topped Mushroom and Herodias Story
...
All three words sound nearly identical and converge on the same visual: a mushroom cap presented on a plate. The "head on a platter" is the mushroom cap served for consumption at a sacred meal.
...
The mushroom's **deep red canopy** is the first feature to attract attention in the field. The **white flecks** dotting the cap are the wart-like remnants of the universal veil (volva) that enclosed the young fruiting body. This striking contrast between red ground and white spots is the visual template for numerous biblical descriptions.
...
In Numbers 11:7, **bdellium** is described as having "white spots like fingernails." This description parallels the mushroom's white warts on its coloured cap, adding another Old Testament colour-reference that prefigures the Amanita imagery developed in the New Testament.
