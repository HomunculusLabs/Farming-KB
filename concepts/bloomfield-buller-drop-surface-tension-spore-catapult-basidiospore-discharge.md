...
The explosive discharge of basidiospores from mushroom gills is one
of the fastest biological movements known, propelling spores at
accelerations of tens of thousands of g-forces. This feat is
...
The mechanism relies upon water condensation on the spore surface.
Seconds before discharge, a bead of liquid develops at the base of
the spore on a hump called the hilar appendix, grows until almost as
wide as the spore itself, and then the fluid and spore are launched.

The space between gills is saturated with water vapor evaporating
from mushroom tissues. Sugars and molecules seep from the spore's
interior, causing water to condense in two separate areas:

- One covering most of the spore body
- Another on the hilar appendix

These deposits remain separated by a narrow bridge of dry surface.
As the hilar appendix drop swells, it pulls the spore's center of
mass toward its base, like a person's center of mass shifting when
handed a bucket of water. When the two globules grow large enough to
make contact, the drop rockets from the hump and merges with the
rest of the spore fluid, driven by surface energy minimization. This
coalescence shifts the center of mass violently away from the gill
in approximately one microsecond, propelling the spore from its
basidial attachment. No metabolic energy is expended; surface
tension converts potential energy to kinetic energy through a purely
physical process.

## Performance Specifications

The catapult's performance is astonishing for a water droplet
mechanism:

- A basidiospore covers one millimeter in one thousandth of a
  second from a standing start, 100 times its own size
- The spore pulls thousands of g's, 10 times more than a jumping
  flea
- Final speed: approximately one meter per second

## Mushroom Cooling and Drop Formation
