...
- Maintain undisturbed root zones (no-till approach, see [[no-till-farming]])
...
- [[cannabis-indoor-living-soil]] — practical living soil setup using these principles
- [[soil-food-web]] — the broader soil biology context
