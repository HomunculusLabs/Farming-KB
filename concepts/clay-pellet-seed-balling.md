...
A typical clay pellet is formed from clay soil mixed with water, enclosing one or more
seeds. Fukuoka's formula is simple and draws on local materials. The clay serves as a
protective shell that hardens when dry, shielding the seed inside from external threats.
...
Fukuoka developed a simple manufacturing process that can be done by hand or with
minimal equipment. The basic steps are:

1. **Prepare the clay**: Collect clay-rich soil, preferably from a depth where it is
   free of weed seeds. Screen it to remove stones and debris.
2. **Mix the ingredients**: Combine clay with water and the seeds to be sown. The
   consistency should be such that the mixture holds together when rolled.
3. **Form the pellets**: Roll small quantities of the mixture into balls roughly
   one-quarter to one-half inch in diameter, each containing one or more seeds.
4. **Dry the pellets**: Spread the pellets in the sun to dry. They harden into
   durable shells that resist cracking and crumbling.
...
The timing of seeding is critical. Fukuoka sows rice in the fall, allowing the seeds
to experience the natural winter dormancy period. This cold treatment, or
stratification, is important for proper germination timing in the spring.

### Revegetation and Reforestation

Fukuoka extends the clay pellet technique to large-scale revegetation projects. In
areas stripped of vegetation by human activity or natural disaster, broadcasting clay
pellets containing seeds of trees, shrubs, and grasses can initiate ecological recovery
without any site preparation.

He describes scattering pellets from aircraft over barren hillsides, a method that
