...
- **Japanese mugwort** (Artemisia princeps): Strong against cold and heat, rich in iron. Used for giving vitality when crops sprout buds in spring. Pick tender parts with growing point, end of March to April.
- **Dropwort** (Oenanthe javanica): Full of iron and manganese. Good for blood circulation and injury recovery. Harvest winter through May; cut into 5cm pieces.
...
- Do not wash ingredients; use with their own skin.
- Only one kind of plant per container.
- Brown sugar: 1/2 to 2/3 the weight of the ingredient. Use 1:1 for storage. Brown sugar contains iron, calcium, and sodium. Molasses is not recommended (too much moisture).
- Clay jar or Japanese cedar wooden container with small opening preferred.
- Stone weight for pressing; porous paper cover.

### Method

1. Shake off dirt from ingredients (do not wash).
2. Measure ingredient and brown sugar by weight.
3. Pile ingredient and brown sugar layer by layer. Put extra brown sugar on top.
4. Press with stone weight to extract air. Cover with paper.
5. After half a day, materials should fill 2/3 of the jar (optimum fermentation). Remove stone weight.
6. Keep in shade at 23-25 deg C for 7 days.
7. Good result: fragrance and clean juice when filtered. If bubbles or fungi appear, add brown sugar, stir, and filter.
8. Do not apply pressure when filtering.

### Storage

- Add more brown sugar if not used immediately.
- Use PE, glass (brown), clay jar, or Japanese cedar container.
- Bury container or keep in cool storehouse, no direct sunlight.
- Can be kept 2-3 years for ripe FPJ.
- Optimum storage: 1-15 deg C.
