...
McKenna argued that psilocybin is unique in its dose-dependent effects, each of which could have conferred adaptive advantages:
...
A key objection is that if mushrooms provided enhanced visual acuity, language, and consciousness, then these enhancements would be external to the genome and natural selection would have no reason to build them into human biology (since the mushrooms provided them externally).
...
- The hypothesis is unfalsifiable in its strongest claims.
...
Recent investigations into terence mckenna stoned ape hypothesis have yielded insights into previously unknown aspects of the subject.
...
Applied work with terence mckenna stoned ape hypothesis spans multiple contexts and scales.
