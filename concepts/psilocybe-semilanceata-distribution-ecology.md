...
**Northern Europe**:
- **Great Britain and Ireland**: Very common; one of the most frequently collected neurotropic fungi; recorded from Sowerby (1797 to 1809) onward
...
**Central Europe**:
- **Germany**: Common and widespread
- **Austria**: Documented
- **Switzerland**: Common in alpine pastures
- **Czech Republic**: Well documented (Semerdzieva & Nerud, 1973; Wurst et al., 1984)
- **Poland**: Documented
- **Hungary**: Documented
- **Netherlands**: Common

**Southern Europe**:
- **France**: Common (Heim et al., 1967; Guzmán et al., 1996)
- **Italy**: Common in the north (Gitti et al., 1983; Festi, 1985; Samorini, 1988)
- **Spain**: Documented from multiple regions (Becker, 1989; Samorini, 1994)
- **Portugal**: Documented
- **Greece**: Documented (Pantidou, 1991; Zervakis et al., 1998)
- **Bulgaria**: Documented (Kutan & Kotlaba, 1988)
- **Romania**: Documented
- **Yugoslavia/Serbia**: Documented

**Islands**:
- **Azores**: Not specifically listed for P. semilanceata
- **Canary Islands**: Not specifically listed
- **Madeira**: Not specifically listed
...
**Canada**:
- Documented from British Columbia and eastern provinces

### South America

P. semilanceata has a disjunct distribution in South America:
- **Chile**: Documented by Singer (1969), Guzmán (1983), and Garrido (1985); well established in southern Chile
