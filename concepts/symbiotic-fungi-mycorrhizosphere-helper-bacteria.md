...
Mycorrhizosphere bacteria occupy several ecological niches. Intrahyphal
...
Mycorrhiza helper bacteria are a functional group of mycorrhizosphere
bacteria that promote mycorrhiza formation. The concept was formalized
by Garbaye in 1994. A strong correlation exists between the induction
of fungal growth in dual laboratory cultures and the mycorrhization
helper effect, making dual culture assays a common screening method.
MHB include diverse Gram-negative species such as Pseudomonas
fluorescens and Gram-positive species including Streptomyces isolates.

## Streptomyces AcH 505: A Model Mycorrhiza Helper Bacterium
...
Media composition and the distance between and size of microbial inocula
...
isolates are most responsive to helper bacteria, suggesting that
bacteria compensate for poor growth conditions but may not further
increase maximum growth of fungi already under optimal conditions. The
quantity of bacterial inoculum also matters: too little produces no
effect, adequate amounts promote fungal growth, and excess can lead to
antagonism.
...
particularly suitable for studying rapid fungal responses to bacterial
metabolites.

## Research Methods

Dual culture assays on solid media, cellophane membrane separation
techniques, and cross-walled Petri dishes for volatile-mediated
interactions are standard approaches. Temperature influences
reproducibility: using 10 degrees Celsius rather than the typical 20 to
25 degrees Celsius better reflects temperate and boreal forest soil
conditions and may produce more ecologically relevant results.

## Applications

Mycorrhiza helper bacteria offer potential applications in forestry,
agriculture, and ecological restoration. The ability to simultaneously
promote beneficial mycorrhizal symbiosis while suppressing pathogenic
