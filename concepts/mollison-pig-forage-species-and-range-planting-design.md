...
In the tropics: cattails (Typha), arrowroot (Canna edulis), Jerusalem
artichoke, comfrey, yams, taro, sweet potato, cassava (bole),
elephant-foot yam, and Marantia.

In cooler areas: cattails, potatoes, Jerusalem artichoke, and comfrey.

### Greens and Seeds Following Rooted Ground

In the tropics: chicory, lucerne, comfrey, white clover, pigeon pea
(Cajanus cajan), Desmodium ovalifolium, pumpkin, chayote (choko),
sunflower (heads), and cowpea.

In cooler areas: chicory, lucerne, comfrey, white clover, grasses, and
broad beans (favas).

### Fruits (Protected 3 to 5 Years If Valuable)

In the tropics: papaya, mango, banana species, and avocado are staples.
Also guava, anona, Inga in grasslands, sapote, and canistel.

In cooler areas: apple, pear, and plum. Pigs assist orchard health in
grasslands and sapote systems.

### Pest Control for Pigs

neem tree oil for mites. The fruits of some trees are poisonous to pigs
and should be avoided. Pyrethrum daisy-flowers, dried and used in nests
or dust baths, control mites. Diatomaceous earth is effective against
lice.

## Stocking Densities and the Pig Tractor Effect

Twenty pigs per 4,000 square metres (1 acre) will "plow" (by rooting
and scratching) the area for planting comfrey, sunroot, lucerne,
chicory, and clover. The area then needs to rest. One hundred pigs in
2 ha (5 acre) pens will plow 40 ha (100 acres) in 18 months. They will
remove gorse, blackberries, and small shrubs. They can be followed by
sowing, then cattle, then pigs again in a rotational system.

Count on at least 1 ha (2.5 acres) per breeding sow. Areas for tree
planting are outside and in the corners to start with; later, pens can
be planted out in blocks using electric fencing to keep pigs away from
young trees. In the tropics, banana, papaya, and like fruits will be
rooted out by pigs, so these need to be outside the pens. As pigs are
moved, root crop can be planted in the pens.

## Pig Tractor for Pasture Establishment
...
grasses, and clover. Cows follow along 2-3 months behind the pig
tractor. A continuous rotation is set up, and excess milk product (whey,
skim milk) is fed to the pigs as accessory food. Piglets ranging over
such pasture rarely show iron anaemia deficiency, parasite cycles are
broken, and the soil constantly improves in humus.

## Shelter and Comfort

A farrowing pen is used by a sow and litter for nearly 3 months. Rested
for 6 months, each pen can be used by two sows a year. Various small
or one large shelter sheds (best thatched or insulated against cold) can
be used on rearing ranges, or dense thickets provided in the tropics.

Strong diagonal posts wrapped in hessian make ideal rubbing places, and
the hessian can be kept dampened with sump oil, or vegetable oils with
neem (Azadirachta indica or Melia azedarach, white cedar) or pyrethrum
oil added to keep pigs free of lice.

Restricted wallows and dust baths can be arranged by sheltering or
dampening sites. Dust baths (a roof over a soft dry area) kill lice and
can be laced with dried neem tree leaves or pyrethrum flowers. Rested
mudwallows planted to cattails (Typha spp.) provide excellent root and
shoot foods at any time of year. Duck potato (Sagittaria) can be planted
in pond margins for summer-dry forage.
