...
source_author: Mueller & Bills (eds.)
...
The largest phylum of fungi, containing an estimated 30,000+ described species (and likely hundreds of thousands undescribed). Ascomycetes produce spores inside a microscopic sac called an **ascus**. The group spans enormous ecological and morphological diversity:

- **Class Archiascomycetes** — basal ascomycetes including *Taphrina* (peach leaf curl) and fission yeasts (*Schizosaccharomyces*)
- **Class Saccharomycetes** — the true yeasts, including *Saccharomyces cerevisiae* (brewer's/baker's yeast), critical to fermentation industries
- **Class Euascomycetes** — the vast majority of filamentous ascomycetes, including molds (*Penicillium*, *Aspergillus*), plant pathogens, lichenized fungi, cup fungi, morels, and truffles

Many of the most important fungi for human affairs are ascomycetes: producers of antibiotics (e.g., *Penicillium*), food contaminants (e.g., aflatoxin-producing *Aspergillus flavus*), and industrial workhorses for enzyme and metabolite production.

### Phylum Basidiomycota

Basidiomycetes produce spores on specialized cells called **basidia**, externally rather than within an enclosing structure. This phylum includes most familiar mushroom-forming fungi:
