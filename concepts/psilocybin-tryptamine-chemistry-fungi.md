...
Modern analytical methods for detecting psychoactive compounds in fungi
include high-performance liquid chromatography (HPLC), gas chromatography
with mass spectrometry (GC-MS), liquid chromatography with tandem mass
spectrometry (LC-MS/MS), and thin-layer chromatography (TLC). These methods
allow simultaneous quantification of psilocybin, psilocin, baeocystin,
norbaeocystin, and aeruginascin from small samples of dried fungal
material.

## Bluing Reaction as Indicator

The characteristic blueing reaction observed in many neurotropic fungi
when bruised or damaged is associated with the oxidation of psilocin
