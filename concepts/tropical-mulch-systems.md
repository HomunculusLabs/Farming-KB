...
Tropical soils face unique challenges: high temperatures accelerate decomposition, heavy rainfall leaches soluble nutrients, and many tropical soils (especially laterites and coral-derived soils) are inherently infertile. Without organic matter, these soils become compacted, acidic or excessively alkaline, and unable to retain moisture. Mulch addresses all of these issues simultaneously by:

- Protecting the soil surface from rain impact and erosion
- Reducing soil temperature fluctuations
- Conserving moisture and improving water infiltration
- Feeding soil microbiology that cycles nutrients to plant roots
- Supplying a slow-release source of minerals and organic compounds
- Suppressing competitive weeds, especially aggressive grasses

Mollison emphasizes that **all crops thrive in mulch**, making it a universal strategy rather than a crop-specific recommendation.

## Humus Sources for Tropical Soils

Mollison catalogs a wide range of humus sources available in tropical environments. The key principle is that any organic material can be directed into soil-building pathways.
...
### Silica-Rich Mulch Materials

Plants high in silica play a special role in tropical mulch systems. Materials from palms, bamboo, *Casuarina*, and *Acacia* species are silica-rich and have a remarkable effect on soil chemistry: they can reduce soil pH from 8.5 down to 6.5 on coral-derived island soils. This is especially valuable on atolls and coral islands where alkaline conditions limit plant growth.

### Aquatic Weeds

Water plants are abundant, fast-growing, and nutrient-dense mulch sources:

- **Azolla**: A small floating fern that hosts *Anabaena* cyanobacteria in its leaf cavities, fixing atmospheric nitrogen. Azolla mulch provides both organic matter and significant nitrogen inputs.
- **Pistia** (water lettuce): Another prolific aquatic weed that can be harvested and applied as mulch.
- **Water hyacinth**: Despite its reputation as an invasive, it is a productive biomass source when managed. Aquatic weeds are conveniently gathered as dry rolls when seasonal water bodies dry up, making collection easy.

### Crop Wastes and Domestic Materials

A broad category of readily available materials:

- Corn husks and stalks
- Kitchen scraps and food processing wastes
- Bones (slow-release phosphorus and calcium)
- Animal manures
- Cardboard and newspaper (sheet mulching)
- Cinnamon leaves (aromatic, may deter some pests)

### Hedgerow and Forage Plants

Hedgerows serve a dual purpose as windbreaks, boundary markers, and mulch sources. Species recommended by Mollison include:
...
### Soft Herbaceous Mulch Plants

Quick-growing herbaceous plants provide readily decomposable green mulch:

- Nasturtium, comfrey, marigolds, tobacco, taro tops
- These break down rapidly, feeding soil biology and releasing nutrients quickly
...
- **Clovers and low growers**: Clover, Desmodium

## Weed Suppression Through Mulch

Mulch is the primary non-chemical strategy for weed control in tropical systems. Key insights from Mollison:
...
## Crop Responses to Mulch (Table 10.1)

Mollison references experimental data (Table 10.1) showing differential crop responses to mulch types:
...
- Every organic material has a pathway to soil — the designer's job is to identify and shorten that pathway.
- Diversity of mulch materials produces more resilient soils than reliance on any single source.
- Animal integration turns problematic waste streams into valuable inputs.
- Silica-rich materials are essential tools for correcting alkaline tropical soils.
- Aquatic weeds, often treated as nuisances, are among the most productive and accessible mulch sources in the wet tropics.
- The combination of living ground covers, green mulch, and woody debris creates a continuous humus-building cycle that sustains tropical food production without external inputs.
