---
title: Mycorrhizal Fungi in Biogeochemical Cycling
tags: [mycorrhiza, biogeochemistry, nutrient-cycling, fungi, plant-ecology, soil-science]
date: 2026-04-28
updated: 2026-04-28
sources:
...
Two principal categories of mycorrhiza dominate terrestrial ecosystems, each with distinct colonization strategies and ecological roles.

### Endomycorrhizas

Endomycorrhizal fungi, including the globally dominant arbuscular mycorrhizal fungi (AMF), colonize the interior of host plant root cells. Arbuscular mycorrhizal fungi penetrate root cortical cells and form highly branched structures called arbuscules, which serve as the primary interface for nutrient exchange between fungus and plant.

AMF are obligate symbionts that depend on their host for carbon, while providing the plant with enhanced access to soil nutrients, particularly phosphorus. Arbuscular mycorrhizas associate with approximately 80 percent of all land plant species and are especially important in grasslands, tropical forests, and agricultural systems.

### Ericoid mycorrhizas

Ericoid mycorrhizas, another endomycorrhizal type, associate with plants in the Ericaceae family and are particularly important in acidic, nutrient-poor environments such as heathlands and boreal forests. Ericoid mycorrhizal fungi have demonstrated the ability to dissolve a variety of metal-bearing minerals, contributing to nutrient mobilization in some of the most nutrient-limited terrestrial habitats. Their ability to access nutrients from organic sources and mineral substrates makes them essential for plant survival in these challenging environments.

### Ectomycorrhizas

Ectomycorrhizal fungi colonize the exterior of root cells, forming a distinctive hyphal mantle around the root tip and a network of hyphae (the Hartig net) between cortical cells. The fungal partner extends an extensive extramatrical mycelium into the surrounding soil, forming rhizomorphs and cord-like structures that explore large soil volumes.
...
Mobilization of phosphorus is regarded as one of the most important functions of mycorrhizal fungi. Phosphorus is often the limiting nutrient in terrestrial ecosystems due to its tendency to form insoluble compounds with iron, aluminum, and calcium in soil. Mycorrhizal fungi solubilize phosphate minerals through acidification and chelation, making phosphorus available to their host plants.

### Zinc phosphate dissolution

Experimental research on zinc phosphate dissolution by the Paxillus involutus and Scots pine (Pinus sylvestris) ectomycorrhizal association revealed complex interactions between mycorrhizal status, fungal zinc tolerance, and environmental phosphorus levels:
...
## Metal Tolerance and Plant Protection
...
Mycorrhizal fungi play a pivotal role in the terrestrial carbon cycle. They receive a substantial portion of net primary production from their host plants (estimated at 10 to 20 percent of total plant-fixed carbon) in exchange for nutrients. This carbon flows through mycorrhizal networks into soil pools, where it contributes to the formation of stable soil organic matter.

Mycorrhizal hyphae and their exudates promote soil aggregation, physically protecting organic carbon from microbial decomposition. The fungal filamentous growth habit, combined with exopolymer production, plays a direct role in the maintenance of soil structure. The carbon allocated to mycorrhizal mycelium represents a major pathway for carbon transfer from the atmosphere to soil, with significant implications for global carbon sequestration and climate regulation.

Mycorrhizal fungi also influence plant community composition by mediating competitive interactions between plant species. Plants with more effective mycorrhizal associations may outcompete neighbors for soil nutrients, and mycorrhizal networks can even facilitate nutrient transfer between individual plants, creating below-ground connections that shape above-ground community structure. This phenomenon, sometimes called the "wood wide web," means that mycorrhizal networks function as resource distribution systems at the ecosystem scale, not merely at the individual root level.
...
Embedded within the physical structure of mycelial networks is an equally complex set of physiological processes that contribute to uptake, storage, and redistribution of nutrients throughout the network. As the colony grows out from a resource base, nutrient translocation is predominantly towards the growing margin. If additional resources are found, redistribution back to the base can also occur, although not necessarily by the same transport system.
