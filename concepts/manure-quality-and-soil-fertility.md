---
title: Manure Quality and Soil Fertility
aliases: [animal-manure, compost, organic-matter, soil-health]
tags: [gardening, soil-science, organic-farming, composting]
sources:
...
Manure nutrient content varies dramatically between sources. Published NPK values for common manures show extremely wide ranges:

| Manure Type | Nitrogen (%) | Phosphorus (%) | Potassium (%) |
|------------|-------------|----------------|---------------|
| Horse manure | 0.5 - 1.3 | 0.2 - 0.5 | 0.3 - 1.0 |
| Dairy manure | 0.5 - 0.7 | 0.2 - 0.4 | 0.4 - 0.6 |
| Steer manure | 0.6 - 1.4 | 0.2 - 0.5 | 0.3 - 0.6 |
| Sheep manure | 0.8 - 1.2 | 0.2 - 0.5 | 0.6 - 1.0 |
| Pig manure | 0.4 - 0.6 | 0.2 - 0.4 | 0.3 - 0.5 |
| Poultry manure | 1.0 - 2.0 | 0.5 - 1.5 | 0.5 - 1.8 |
...
The type and quantity of bedding mixed with manure significantly dilutes its nutrient value. Straw, sawdust, wood shavings, and other bedding materials absorb nutrients but also add carbon that must be broken down before the nitrogen becomes available. A manure sample with heavy bedding may have half the effective nutrient content of pure manure from the same species.

### Storage and Handling

How manure is stored affects its nutrient content:

- **Fresh manure**: Highest nutrient content but may contain weed seeds and pathogens
- **Aged/composted manure**: Some nitrogen loss through volatilization, but weed seeds are killed and pathogens reduced
- **Exposed manure**: Significant nitrogen loss from rain leaching and ammonia volatilization
- **Stored under cover**: Better nutrient retention than exposed storage

## The Limitations of Manure-Only Fertility

Solomon argues that even high-quality manure is not sufficient alone to produce the most nutritious vegetables. His reasoning:
...
For gardeners who cannot obtain manure, Solomon describes methods for making low-grade compost from available organic materials:
