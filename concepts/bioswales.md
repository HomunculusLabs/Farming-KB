...
A bioswale is a linear, vegetated channel designed to convey, slow, filter, and infiltrate stormwater runoff. Unlike conventional drainage ditches or culverts that rapidly move water off-site, bioswales use engineered soil media, dense vegetation, and graded contours to treat polluted runoff through physical filtration, biological uptake, and microbial degradation as water moves through the system. They are a cornerstone of low-impact development (LID) and green infrastructure, widely used in parking lots, roadsides, residential developments, agricultural properties, and urban landscapes.

Bioswales differ from rain gardens in their linear form and primary function: rain gardens are depression-based systems designed primarily for infiltration, while bioswales are conveyance channels that manage and treat water as it flows from one point to another. Both use similar biological treatment mechanisms but serve different roles in the stormwater management landscape.

## How Bioswales Work

### The Treatment Train

As stormwater enters a bioswale, it passes through a sequence of treatment processes:
...
Bioswales are designed with specific hydraulic characteristics to ensure adequate residence time for treatment:

- **Longitudinal slope**: 1–5% (steeper slopes require check dams to slow flow)
- **Side slopes**: 3:1 (horizontal:vertical) or flatter for maintenance access
...
On slopes steeper than 3%, check dams (small barriers) are installed at regular intervals (every 3–10 m) to create temporary ponding areas. These mini-wetlands dramatically increase treatment effectiveness by extending contact time between runoff and the soil media. Check dams can be constructed from stone, timber, earth berms, or coir fiber logs.

## Soil Media Specification

The engineered soil media is critical to bioswale performance. A typical specification:

- **Sand**: 60–70% (concrete sand, washed, 0.5–2 mm particle size)
- **Compost**: 20–30% (aged, well-decomposed, low in phosphorus)
- **Topsoil**: 10–20% (loamy, minimal clay content)

The media should have a infiltration rate of 2.5–15 cm/hour. High clay content reduces infiltration and can cause ponding. The media depth is typically 45–90 cm, underlain by a gravel drainage layer with a perforated pipe (4" underdrain) that carries filtered water to the outlet.
...
### Flowering Perennials (Pollinator Habitat and Aesthetics)

- **Swamp milkweed (Asclepias incarnata)**: Monarch butterfly host; tolerates wet soils
...
On farms and homesteads, bioswales serve as vegetated waterways that convey field runoff while trapping sediment, nutrients, and agricultural chemicals. They are typically wider (2–5 m) and less engineered than urban bioswales, using existing on-farm materials.

### Design for Agricultural Settings
