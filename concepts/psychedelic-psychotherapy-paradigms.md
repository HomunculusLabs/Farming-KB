...
[[set-and-setting]]" hypothesis: the primary determinants of a psychedelic
experience are internal set (intention, expectation, motivation) and external
setting (context, environment, guide presence).

## Shared Fundamental Principles

Despite methodological differences, the psycholytic and psychedelic paradigms
share several core assumptions that distinguish them from conventional
pharmacotherapy:
...
## The Empathogen Extension

### Discovery of Phenethylamines
