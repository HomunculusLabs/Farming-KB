...
Some of these popular names are also known and applied by users outside of Australia and New Zealand, creating a shared vernacular that transcends national borders while retaining distinctive regional flavours.
...
## The Gap Between Scientific and User Terminology

There is a persistent gap between scientific names and the terminology used by mushroom collectors and consumers. This disconnect has practical implications for both identification and safety.
...
Successful implementation of Psilocybin Mushroom Common Names and Slang requires attention to
