...
## Two-Plot Rotation (Two Houses, One Move Each)

### Configuration
- Two greenhouses, each moving once per year from one plot to an adjoining plot
- The two pairs of plots are adjacent to each other
...
| Date | Action | Plot |
|------|--------|------|
| Mid-October | Move house from tomatoes to fall spinach | Plot 1 → Plot 2 |
| End of November | Move house from spinach to leeks | Plot 2 → Plot 3 |
| February 1 | Begin sowing carrots in emptied leek beds | Plot 3 (under house) |
| Mid-March | All leeks sold; entire house planted to early carrots | Plot 3 |
| May 1 | Carrots no longer need protection; move house | Plot 3 → Plot 2 |
| Mid-April | Prepare Plot 2 soil; cover with clear plastic for warming | Plot 2 |
| ~May 5 | Set out tomatoes under house | Plot 2 |
| Mid-May | Set out new leek transplants on Plot 1 (previous tomato plot) | Plot 1 (exposed) |
| After carrots | Plant summer lettuce on Plot 3, then early September spinach | Plot 3 (exposed) |

### Soil Warming Protocol
When preparing a plot for tomatoes after the house moves:
- Prepare the soil in mid-April
- Cover with a sheet of clear plastic to begin warming
- Allow a few days with the closed-up greenhouse to continue warming
- Set tomatoes out around May 5

### Key Insight: Progressive Hardiness Chain
The three-plot sequence exploits a natural hardiness gradient: tomatoes (frost-tender) → spinach (moderately hardy) → leeks (very hardy, can withstand November exposure during the move). Each crop hands off to the next as protection requirements change.

## Four-Plot Rotation (One House, Five Moves)

### Timeline and Crops
| Period | Plot 1 | Plot 2 | Plot 3 | Plot 4 |
|--------|--------|--------|--------|--------|
| 11/30–3/25 | Overwinter Onions | — | — | — |
| 3/25–4/25 | — | Early Carrots & Beets | — | — |
| 4/25–5/25 | — | — | Early Beans & Zucchini | — |
| 5/25–7/15 | — | — | — | Summer Tomatoes |
| 7/15–11/30 | — | Fall Cucumbers → Late Lettuce | Zucchini → Tomatoes | — |
