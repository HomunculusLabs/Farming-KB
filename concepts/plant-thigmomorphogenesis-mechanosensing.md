...
Thigmomorphogenesis (from Greek: *thigma* = touch, *morphosis* = shape, *genesis* = origin) refers to the growth responses of plants to mechanical stimulation. The term was coined by M.J. Jaffe in 1973 to describe the observed phenomenon that mechanically stimulated plants grow shorter and stockier than untouched controls.
...
These responses are adaptive: a plant growing in a windy environment benefits from shorter stature and stronger stems that resist breakage.

## Mechanisms of Touch Perception

Plants detect mechanical forces through several interconnected molecular mechanisms:
