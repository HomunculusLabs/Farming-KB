...
growers, especially beginners. Learning to read the plant's visual signals
takes practice but becomes an invaluable skill over multiple growing cycles.
Green provides a step by step diagnostic flowchart that guides growers from
the most common problems to the more obscure micronutrient issues.

## The Three Primary Nutrients

The three major nutrients found in soil are Nitrogen, Phosphorous, and
Potassium, or NPK for short. NPK can come in two forms, naturally
occurring in the soil or as a stand alone fertilizer, usually in a
bottle. When looking at a fertilizer bag, the percentage of each part is
stated as a ratio such as 20:20:20, meaning 20% N, 20% P, 20% K. The
