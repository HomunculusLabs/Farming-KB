---
title: Mycorrhizal Fungi in Grasses and Lawns
created: 2026-04-16
updated: 2026-04-16
type: concept
...
Many common lawn and turf grass species readily form arbuscular mycorrhizal associations:
...
In a freshly seeded lawn, the best way to discourage weed growth is to encourage the quick germination of grass seed — and mycorrhizal inoculation helps grass seeds germinate faster and establish quicker. But allowing a few weeds to grow in a lawn, golf course, or playing field is not necessarily a bad idea.

Monocultures — areas planted in a single crop — are magnets for problems. If a fungal or nematode infection occurs in one place, it is likely to spread throughout a lawn planted in a single species of grass. Some weeds actually add nutrients to a lawn.
...
New lawns are usually established from seed or by laying sod. Several inoculation approaches are effective:

- **Seed coating**: Roll grass seed in arbuscular mycorrhizal mixes designed for lawns before planting, or place the inoculum directly in the spreader along with the seed before dropping onto soil
- **Sod dusting**: If squares or rolls of sod are used, dust the soil side with mycorrhizal mixes or spray with a liquid formula
- **Liquid formulas**: After grass has been planted and established, fungal spores can be replenished with powder mixes small enough to wash into the root system with regular watering, or liquid-based inoculants can be applied for greater efficiency

Mixing spores and propagules into existing lawn soil is not generally recommended because the fungal mix can also benefit weeds. Inoculating existing lawn soils is best reserved for special situations.

### Aeration Before Application

Arbuscular mycorrhizae are particularly sensitive to soil compaction in areas where heavy traffic is the norm. The solution is aeration, accomplished by hand tool or machine. If you aerate the grass prior to applying liquid or granular mycorrhizal propagules, the aeration holes offer direct routes down through the soil to the root zone.

## When to Inoculate

Inoculation is most effective in these situations:

- **New lawns on construction-damaged soil**: The construction process severely damages soil structure and removes organic materials. Many important soil organisms that once thrived are no longer present. Mycorrhizae can help restore the soils and rebuild the food web, which benefits grasses and other plants. In this case, adding mycorrhizal fungi is almost mandatory.

- **Golf greens on sand**: Golf greens benefit from mycorrhizal fungi because they are constructed mostly atop sand, which lacks organic matter and holds few nutrients. These grasses can be bolstered by adding fungal spores.

- **Recreational fields**: Grasses in recreational fields are exposed to stress factors from compaction to wet and dry conditions, which can damage existing mycorrhizae. Adding propagules can replace depleted fungi.

## Mycorrhizal Species Found in Lawn Mixes

Commercial lawn mycorrhizal mixes typically include these species:
...
Some grasses welcome associations with many different types of fungi. In a Canadian study using soils of varying fertility, researchers found 17 species of arbuscular mycorrhizal fungi in root zones of velvet bentgrass (*Agrostis canina*) and 15 in creeping bentgrass (*A. stolonifera*).
