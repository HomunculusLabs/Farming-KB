...
3. Functional design is sustainable and provides a useful product or
   surplus. If it does not, it creates pollution (overabundance of an
   unused resource) and work (when one element fails to help another).
4. Maximize useful energy and decrease waste.
5. Successful design serves people's needs and provides diverse, useful
   connections between elements.
6. Pollution causes chaos in the system.
7. Use only what can be returned to the soil; build cooperation into the
   functional organization of systems.

## Sustainable Land Goals

When designing a sustainable land system, achievable goals include:

- The system should become self-sustaining and productive long-term.
- About one-third of land should grow human food; the rest for animal
  living space and fodder.
- The land should produce more than needed; excess can be sold or shared.
