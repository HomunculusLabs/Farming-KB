---
title: Solomon on Mulching and Cover Cropping
created: 2026-04-21
updated: 2026-04-18
type: concept
...
### Straw Mulch for Potatoes

Straw mulching (using wheat or rye straw) after seed potatoes are planted has been proven to greatly reduce Colorado potato beetle problems by providing habitat for predatory beetles that feed on both adult beetles and their larvae. However, this restricts irrigation to furrows (see Solomon's irrigation practices), which helps prevent late blight but may somewhat reduce yield.

### Mulch and Soil Moisture

In unirrigated gardens, a thick mulch layer can actually prevent light rains from reaching the soil surface. The mulch itself absorbs the moisture and then loses it to evaporation. In dryland conditions, bare soil with capillary connections to subsoil moisture may outperform mulched soil. Mulch is most beneficial:
- When irrigation is provided beneath the mulch
- When rainfall is regular and adequate
- In hot climates where evaporation from bare soil is extreme

### Green Manure Crops

While the book focuses primarily on complete organic fertilizer (COF) as the primary fertility source, Solomon acknowledges the role of green manures and cover crops in a broader soil management strategy. His general guidance:

- Green manures add organic matter but may not provide balanced mineral nutrition
- Leguminous green manures fix nitrogen but the nitrogen becomes available only after decomposition
- In a low-input system focused on calorie production per unit of labor, COF application is more efficient than managing cover crop rotations
- Cover crops are most valuable when the garden is idle (over winter) or between main crops

### Crop Rotation

Solomon strongly advocates rotation to manage soil-borne diseases:
- Do not grow potatoes (or other solanums) on ground that has had them for at least three years
- This reduces disease problems, especially scab and late blight
- Rotation also helps break pest cycles for other crop families

### The Efficiency Question

Solomon's core argument is about efficiency of human labor and land use. A gardener who must grow a significant portion of their family's food cannot afford to devote large areas or much time to cover crop management when the same ground could produce food crops fertilized with inexpensive COF. His approach favors:
1. Complete organic fertilizer as the primary fertility source
2. Deep tillage (once) to create open soil structure
3. Crop rotation for disease management
4. Spot applications of compost or manure for high-demand crops
5. Strategic mulching where it clearly benefits the crop (e.g., potatoes for pest management)

### Living Systems and Organic Matter
...
- Compost tea from high-quality composts contains beneficial microorganisms
- Applied as a foliar spray weekly, these organisms can prevent disease organisms from gaining a foothold
