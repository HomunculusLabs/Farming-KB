...
- Crops occur multiple times per year if humidity and temperature are correct
- Practically no further care needed apart from maintaining moisture levels

### Activating Dormant Logs
If logs fail to fruit after a few years:
1. Soak them for a few hours
