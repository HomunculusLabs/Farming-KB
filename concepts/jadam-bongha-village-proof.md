...
| Metric | Value |
|---|---|
| Total area | 134 ha (330 acres) |
| Participating households | 160 |
| Crops grown | Rice, pepper, cabbage, persimmon |
| Annual pesticide production | ~10,000 L (2,640 gal) |
| Annual pesticide cost | ~$2,300 USD total |
| Cost per acre | **$7 per acre** |
| Cost per hectare | ~$17 per hectare |

## Large-Scale Production Equipment

Bongha village uses specialized machines for large-scale JADAM input production:
...
- Shared equipment reduces individual investment
- Collective knowledge sharing accelerates learning
- Community-scale production achieves economies of scale
- 160 households successfully coordinating organic practices

### Recognition
Youngsang Cho specifically thanks Jeongho Gim of Bongha village: "who audaciously attempted JADAM organic farming on a scale of 330 acres and led that to a success. He proved that JADAM system can be used on large-scale farms."

## Comparison with Conventional Farming

For a typical 330-acre conventional rice/vegetable operation:
- Chemical pesticide costs: $50,000-100,000+ per year
- Bongha village JADAM pesticide costs: ~$2,300 per year
- **Savings: 95-98%** on pesticide costs alone

## Implications for Global Agriculture

The Bongha village model demonstrates that:
1. JADAM organic farming is viable at commercial scale
2. Equipment can be shared among farming communities
3. Pesticide self-sufficiency is achievable for large operations
4. The method works across diverse crops (rice, pepper, cabbage, fruit trees)
5. Cost savings are dramatic and sustainable
