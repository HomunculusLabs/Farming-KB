...
McKenna's argument about language unfolds across several interlocking propositions:

1. **Language constitutes reality**: "Perhaps language is more properly understood when thought of as magic, for it is the implicit position of magic that the world is made of language."
2. **Different languages create different worlds**: The Hopi language has no past or future tenses; the Inuit have no first-person pronoun. "How, then, can the Hopi world be like ours?"
3. **Grammar limits perception**: The internal rules of language have been carefully studied, but "too little attention has been devoted to examining how language creates and defines the limits of reality"
4. **Shamanism transcends linguistic limits**: Through psychedelic ecstasy, the shaman "has attained a vision of the beginnings and the endings of all things and who can communicate that vision"

The conclusion McKenna draws is radical: if language is the "primary datum of knowing," then Western rationalism has "been sadly misled." Only shamanic approaches, anchored in direct experiential encounters with plant hallucinogens, can answer the fundamental questions: "Who are we, where did we come from, and toward what fate do we move?"
...
McKenna cites the Hopi language as evidence that different linguistic frameworks create fundamentally different realities. The Hopi temporal system, as described by Benjamin Lee Whorf, does not divide time into past, present, and future tenses but instead uses a system based on **manifestation** (events that are observable or have been observed) versus **unmanifestation** (events that exist in the subjective realm or are expected). This means that Hopi speakers do not conceptualize time as a linear progression of discrete moments but as a continuous field in which events move between states of accessibility to consciousness.
...
- Ritual speech (chants, songs, invocations) was treated as **technology** for altering consciousness, healing illness, and influencing natural events
- The boundary between literal and metaphorical speech was not sharply drawn; mythic narratives were understood as simultaneously true on multiple levels

McKenna argues that this Archaic relationship to language was not "primitive" or "naive" but rather more honest about the nature of linguistic reality than the modern Western assumption that language neutrally describes an independently existing world. The Archaic perspective, in his view, recognized what modern science is only beginning to acknowledge: that perception is always theory-laden, that categorization shapes cognition, and that the map (language) cannot be cleanly separated from the territory (reality).

## Addiction, Habit, and the Linguistic Construction of Desire

McKenna connects his linguistic theory to his analysis of addiction and habitual behavior. He observes:
