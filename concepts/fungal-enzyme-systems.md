...
Cellulose, the most abundant organic polymer on Earth, is broken down by:
- **Exo-1,4-beta-glucanase**: Cleaves cellobiose units from chain ends
- **Endo-1,4-beta-glucanase**: Randomly cleaves internal beta-1,4-glycosidic bonds
- **1,4-beta-glucosidases**: Hydrolyzes cellobiose to glucose

### Hemicellulose-Degrading Enzymes

Hemicellulose degradation requires a complex suite of enzymes due to the structural diversity of hemicelluloses:
- **Endo-1,4-beta-xylanases** and **endo-1,4-beta-mannases**: Break backbone chains
- **1,4-beta-xylosidases** and **1,4-beta-D-mannosidases**: Remove terminal sugars
- **Alpha-L-arabinosidases, alpha-glucuronidases, alpha-galactosidases**: Remove side groups
- **Acetylxylan esterases** and **acetyl galactoglucomannan esterases**: Remove acetyl groups

### Pectin-Degrading Enzymes

- **Polygalacturonases** (endo and exo forms): Break homopolymer alpha-1,4-galacturonan chains
- **Pectinlyases**: Cleave pectin via beta-elimination
- **Pectinesterases**: Remove methyl esters from pectin
...
Different fungal species possess different enzymatic capabilities, which dictates their appearance during decomposition succession. Initial colonizers ("sugar fungi") produce enzymes for simple carbohydrate utilization. As decomposition proceeds and recalcitrant chemicals accumulate, species capable of producing lignin-degrading enzymes (primarily basidiomycetes) dominate. This shift in enzymatic competence drives the observed patterns of fungal succession on decomposing resources.

## Mycorrhizal Enzyme Systems
...
Ectomycorrhizal species vary widely in their enzymatic repertoires. Some ECM basidiomycetes produce lignin-degrading enzymes (peroxidases, laccases) that allow them to access nitrogen and phosphorus from organic matter, effectively functioning as both mutualists and saprotrophs. This dual capability blurs the traditional distinction between saprotrophic and mycorrhizal fungal functional groups.
...
- **Moisture**: Adequate water films are required for enzyme diffusion and substrate contact

## Enzyme Pools in Soil

The total enzyme activity in soil represents contributions from:
- Active fungal hyphae (growing and metabolically active)
- Free enzymes adsorbed to soil particles (stabilized and persisting for weeks to months)
