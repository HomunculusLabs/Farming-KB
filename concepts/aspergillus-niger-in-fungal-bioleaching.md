---
title: Aspergillus niger in Fungal Bioleaching
created: 2026-04-19
updated: 2026-04-19
type: concept
tags: [reference]
...
aspergillus niger in fungal bioleaching is the most extensively studied fungus for bioleaching of metals from ores, industrial wastes, and contaminated soils. Its bioleaching capability derives from organic acid production -- primarily citric acid, oxalic acid, and gluconic acid -- which solubilize metal compounds through acidolysis, complexation, and redox reactions. The broad metabolic potential of fungi for organic acid formation (Bigelis & Arora, 1992) provides a huge industrial potential that has been scarcely investigated beyond model organisms.
...
A. niger employs two primary bioleaching mechanisms:

1. **Acidolysis**: Production of organic acids (citrate, oxalate, gluconate, tartrate, succinate, malate, fumarate, alpha-ketoglutarate) lowers pH and protonates metal-containing mineral surfaces

2. **Complexolysis**: Organic acids form soluble metal complexes, particularly citrate and oxalate chelates
...
These mechanisms work in concert. During fungal growth, organic acids are formed and minerals are solubilized, allowing optical measurement of metal leaching via clear zone formation on solidified media. Bioleaching allows metal cycling by a process close to natural biogeochemical cycles and contributes to sustainable development, reducing demand for non-renewable resources.

## Substrates and Leached Elements

A. niger has been demonstrated to leach metals from an extraordinary range of solid substrates:

### Ores and Minerals

- Low-grade copper ores: Cu, Y, La, Nd, Sm, Dy (Kiel and Schwartz, 1980)

- Lateritic nickel ores: Ni (multiple studies, 7-30 day periods)

- Spodumene: Li (Ilgar, Guay and Torma, 1993)

- Manganese ores: Mn (Noble et al., 1991)

- Silicate manganese ore: Al, Fe, Mg, Mn (Bosecker, 1993)

- Bauxite: Al, Fe, Si (multiple studies)

- Electronic waste: Al, Cu, Ni, Pb, Sn, Zn (Brandl et al., 1999)

### Industrial Wastes

- Red mud: Al (Vachon et al., 1994)

- Fly ash: Al, Fe (Singer et al., 1982)

- Mining residues: Cu, Fe, Ni, Zn (Mulligan, Galvez-Cloutier and Renaud, 1999)

- Gypsum: Ca (Gharieb, Sayer and Gadd, 1998)

- Malachite, chrysocolla, lydite: Cu (Kiel, 1977)

- Pyromorphite: Pb (Sayer et al., 1999)

### Soils and Clay Minerals

- Contaminated soils: Zn, Pb, Cu (Burri, 1999; Frei, 1999)

- Plant biomass: Cd, Cu, Zn (Ryser, 2000)
