...
This combination provides readily available sugars and amino acids that fuel rapid bacterial reproduction while the kelp adds micronutrients and growth factors.

### Fungal-Dominant Tea Recipes

For fungal-dominant teas (used for perennials, trees, and pastures), Ingham recommends food sources that push the combined C:N ratio above 25:1. A typical recipe might include:

- 1 tablespoon of humic acid per 5 gallons of water
- 1 tablespoon of kelp meal per 5 gallons
- 1/2 teaspoon of fish hydrolysate per 5 gallons

The humic acid provides complex carbon compounds that favor fungal growth, while the reduced fish hydrolysate provides just enough nitrogen to support fungal metabolism without triggering bacterial dominance.
