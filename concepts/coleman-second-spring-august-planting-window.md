...
The reason August seems early for a "winter" planting is that growth rates
in fall are much slower than in spring. A crop of spinach sown in April
might reach harvestable size in 30 days. The same variety sown in September
may take 60 to 75 days because of shorter days and cooler temperatures.
This slowdown is gradual — each successive planting takes a bit longer than
the one before — so the grower must plant earlier than intuition suggests.

## The Reverse Logic of Fall Planting

Spring planting follows forward logic: the ground warms, days lengthen,
and the grower adds successive plantings as conditions improve. Fall
...
must be sown much earlier (July or early August) because they require
months to reach their full size.

Coleman categorized winter crops into three groups based on their timing
requirements. The first group — crops sown in July and early August for
harvest beginning in October — includes leeks, carrots, and certain root
crops. The second group — crops sown in August and early September for
harvest beginning in November — includes most salad greens and braising
...
The second spring is followed by a winter succession planting period from
November through February. During this period, new crops are sown inside the
greenhouse for harvest in late winter and spring. These winter sowings grow
very slowly because of short days and cold temperatures, but they provide a
critical function: they ensure that there are always crops at various stages
of growth in the greenhouse, providing a continuous harvest through the
winter months.

Coleman's goal was to never leave a greenhouse bed unplanted. Within
twenty-four hours of harvesting a crop, the residues were removed, the soil
was re-prepared, and a new crop was planted. This intensive management
required careful planning to ensure that the succession worked — that each
crop was harvested before it began to decline in quality, and that the
following crop was timed to be ready when the preceding crop was removed.
...
it comes earlier, compressing the window.

Growers in mild winter climates (Zones 7-9) have a much longer second
spring and may be able to plant winter crops through November or even
December. Growers in very cold climates (Zones 3-4) may need to begin
the second spring in July. The general principle remains the same: plan
backward from the Persephone months, accounting for the slower growth
rates of fall, and sow crops early enough that they reach productive
size before day length becomes limiting.
