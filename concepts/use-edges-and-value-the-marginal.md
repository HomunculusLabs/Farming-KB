...
zones are often the most diverse, productive, and creative areas in any
system. The principle also extends to valuing marginal people, ideas, and
practices that mainstream culture tends to overlook.

## The Ecology of Edges

In ecology, edges are the transitional zones between two or more distinct
ecosystem types. The edge between a forest and a grassland supports species
from both ecosystems plus additional species that specialise in edge
conditions. This "edge effect" means that edges typically have higher
species diversity and greater biological productivity than either of the
adjacent ecosystems.
...
- Curved paths and garden beds increase the ratio of edge to area
- Zone boundaries (between intensively managed and wild areas) create
  transitional zones of high diversity

The principle also suggests designing systems with permeable boundaries rather
than hard edges, allowing exchange between system elements and preventing the
isolation that leads to stagnation.

## The Value of the Overlooked

Valuing the marginal is partly about overcoming cultural biases that prevent
us from seeing value in people, places, and practices that do not conform to
mainstream standards. Weeds, pests, marginal lands, traditional peoples,
