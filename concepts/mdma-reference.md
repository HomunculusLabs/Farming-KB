...
- Structure: substituted amphetamine with a methylenedioxy group attached to the phenyl ring
- Stereoisomers: exists as R-MDMA and S-MDMA enantiomers
...
MDMA has a complex mechanism that distinguishes it from classical psychedelics:

- Serotonin release: MDMA reverses the serotonin transporter (SERT), causing a massive release of stored serotonin from presynaptic neurons. This is the primary mechanism responsible for MDMA's empathogenic effects
- Serotonin reuptake inhibition: blocks SERT, preventing reabsorption of released serotonin
- Dopamine release: reverses the dopamine transporter (DAT), releasing dopamine (responsible for stimulant effects and euphoria)
- Norepinephrine release: reverses the norepinephrine transporter (NET), contributing to stimulant effects, increased heart rate, and blood pressure
...
- Onset (oral): 30-60 minutes; peak: 2-4 hours; duration: 3-6 hours primary
- Comedown: 3-24 hours after effects wear off
- Half-life: ~7-9 hours
- Active metabolite: MDA (N-demethylation by CYP2D6) — contributes to psychedelic effects
- CYP2D6 genetic polymorphism significantly affects metabolism
...
- Common: 75-125 mg
- Strong: 125-175 mg
- Heavy: 175+ mg (not recommended — significantly increased risks)
...
- Intense empathy and emotional openness
- Increased sociability and desire to connect
- Enhanced tactile sensitivity, music appreciation
- Reduced fear, anxiety, and social anxiety
- Inner peace, emotional catharsis, euphoria (warm, not overwhelming)
- Enhanced introspection without overwhelming anxiety

### Physical Effects

- Pupil dilation, increased heart rate and blood pressure
- Elevated body temperature (hyperthermia risk)
- Jaw clenching, teeth grinding, sweating
- Increased energy, reduced appetite, nausea (especially at onset)
...
- Social anxiety in autism spectrum disorder (pilot studies show promise)
- Anxiety related to life-threatening illness
- Couples therapy (enhanced empathy and communication)
- Addiction treatment (alcohol, other substances)
- End-of-life anxiety
