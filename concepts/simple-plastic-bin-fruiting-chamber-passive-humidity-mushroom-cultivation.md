...
The fruiting containers consist of simple clear plastic bins — standard storage or shoebox-sized containers — that are covered with polyethylene sheeting (plastic wrap or similar).
...
- Over-watering is equally problematic and can lead to waterlogged casing that suffocates the mycelium
- A light misting once or twice daily is the starting point, adjusted based on visual assessment

## Advantages of the Minimalist Approach

### Low Cost

The entire system requires only plastic bins, polyethylene sheeting, and a heat source for melting holes. No humidifiers, fans, timers, hygrometers, or other electronic equipment is needed. This makes it accessible to cultivators with minimal budgets.

### Low Maintenance

Without mechanical components, there is nothing to break, adjust, or calibrate. The daily maintenance consists only of misting the casings and removing aborts. There are no water reservoirs to refill, no filters to clean, and no pumps to maintain.

### Space Efficiency

The stackable bin design allows vertical use of growing space. Multiple bins can be stacked on shelves, making it possible to operate a significant number of fruiting trays in a small footprint. This is particularly valuable for cultivators working in closets, cabinets, or other constrained spaces.
