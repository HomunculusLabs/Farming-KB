...
After approximately 12 hours, thousands of spores will have fallen from the
gills in a beautiful radiating symmetry pattern known as a **spore print**.

The resulting deposit reveals the spore color, which is a key identification
feature. Spore print colors include white, brown, pink, and black deposits,
each characteristic of different mushroom groups. This color information is
essential for distinguishing between species in the field.

### Preservation and Storage

Spore prints are remarkably resilient. They can be sealed, stored, saved for
future use, and even mailed without harm. This durability makes them ideal for
long-term preservation and exchange between cultivators and researchers.
Properly dried and folded prints can remain viable for years when kept cool and
dry, making them a practical long-term genetic resource.

## Building a Species Library

By collecting spores of many mushrooms, one creates a **species library**, an
invaluable personal or institutional resource. A mushroom hunter may find a
particular species only once in a lifetime, making the spore print the only
resource available for future propagation of that strain. Each print captures a
snapshot of genetic diversity from a specific location, time, and individual
fruiting body, preserving material that might otherwise be lost forever.

Cultivators who diligently collect and catalog spore prints build an archive
that grows in value over time, enabling them to revisit and attempt cultivation
of species encountered years earlier.
...
colonize substrates without laboratory intervention.

### Limitations for Sterile Substrates
