---
title: Casing Layer Microbiology — The Role of Microorganisms in Fruiting
created: 2026-04-16
updated: 2026-04-16
type: concept
tags: [reference]
...
Stanek (1974) coined the term "hyphosphere" to describe the zone of bacterial activity immediately surrounding mushroom mycelium — analogous to the rhizosphere around plant roots. Hyphosphere bacteria were found to be predominantly Gram-negative (like Pseudomonas putida) and to utilize nitrogenous compounds secreted by the mycelium.

The mutualistic relationship between hyphosphere bacteria and mushroom mycelium involves bidirectional stimulation. Extracts of mycelium stimulate bacterial growth, and extracts of bacteria stimulate mycelial growth. Mycelium infected with beneficial bacteria grows more quickly through compost, giving it a competitive advantage over other microorganisms.

This concept has profound implications: the casing layer is not just a physical environment for fruiting but a biological interface where mycelium and bacteria engage in a mutually beneficial relationship that culminates in mushroom production.

## Microbial Succession in the Casing

When a casing layer is first applied to colonized substrate, a microbial succession begins. Understanding this succession helps the cultivator time interventions for maximum effect.

Initially, the casing contains the microorganisms present in its raw materials — peat, vermiculite, limestone, and any soil or compost added. These organisms include bacteria, actinomycetes, and occasionally fungal spores.
...
Beyond Pseudomonas, several other microorganisms in the casing layer influence mushroom cultivation.

Actinomycetes — particularly Streptomyces species — contribute to the characteristic "earthy" smell of healthy casing. They help break down complex organic matter and may suppress certain competitors through antibiotic production.
...
The choice of casing materials directly affects microbial activity and, consequently, fruiting performance.
...
Pasteurizing the casing before application eliminates harmful organisms but also destroys beneficial bacteria. For species that readily form primordia (like Agaricus brunnescens), pasteurization may be unnecessary and counterproductive. For species that are difficult to fruit, the loss of beneficial bacteria from pasteurization can be partially compensated by inoculating with prepared Pseudomonas cultures.

Monitoring casing pH is important because microbial activity can shift pH over time. The initial pH of 7.0-7.5 may drift lower as bacteria metabolize organic compounds. Regular pH checks and buffering adjustments maintain conditions favorable for both mycelium and beneficial bacteria.
