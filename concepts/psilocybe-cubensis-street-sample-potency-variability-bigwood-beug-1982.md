...
The tenfold variation in potency has direct risk implications:

- **Overdose risk**: Consumers who develop familiarity with lower-potency samples may be caught off guard by a high-potency batch, leading to unexpectedly intense experiences that could include panic, confusion, or dangerous behavior.
- **Underdose risk**: Those seeking therapeutic or entheogenic effects may consistently receive sub-therapeutic doses if they encounter low-potency material, potentially leading them to increase their dose dangerously.
- **Inconsistent therapeutic outcomes**: In therapeutic settings where consistent dosing is important, the variability of natural mushroom material introduces a significant confounding variable.

## Analytical Methodology

### Sample Preparation

The street samples were commercially packaged, air-dried mushrooms sold by the ounce in sealed plastic bags. They were kept frozen until analysis to minimize degradation of alkaloids.

### HPLC Analysis

Quantification was performed using reversed-phase high performance liquid chromatography (HPLC) with a Hewlett-Packard 8380A reporting integrator-plotter. The system was calibrated against standards from the National Institute on Drug Abuse.

The method demonstrated:
- A linear relationship between concentration and peak area from 0.2 to 3 μg total psilocybin or psilocin
- 10% repeatability in measurements
- A detection limit of approximately 0.01 μg for both compounds
