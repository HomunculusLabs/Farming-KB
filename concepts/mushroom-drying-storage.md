...
- **Potency retention**: Halts [[enzymatic-degradation-in-mycoremediation]] of psilocybin/psilocin and medicinal compounds
...
The gold standard for home mushroom drying:

- **Temperature setting**: 115-120°F (46-49°C) for active mushrooms. Higher temperatures (150-160°F) are fine for culinary mushrooms
...
- Takes 24-48 hours to reach "cracker dry" — still flexible in the center
- Combine with desiccant chamber for final drying

### Air Drying

Traditional method; works in dry climates:
...
- Most ovens cannot go below 170°F (77°C)
- This temperature degrades psilocybin and medicinal compounds
- Oven drying is acceptable for culinary mushrooms only
- If forced to use an oven: crack the door, use lowest setting, and monitor constantly

### Freeze Drying (Professional)

- Preserves shape, color, and potency better than any other method
- Sublimates ice directly from frozen tissue — no heat damage
- Equipment costs $2,000-10,000+ for consumer units
- Best option for commercial or research applications
- Lyophilized mushrooms can last 10+ years with no potency loss

## Drying Active Mushrooms: Temperature Debate
...
- Using moderate heat (115-120°F) in a dehydrator preserves the psilocybin that remains
- **Bottom line**: Dehydrator at 115-120°F is widely accepted as safe. Some growers use higher temps (160°F) with no reported potency loss in blind testing. The most important factor is getting them cracker-dry quickly

## Determining Dryness: The "Cracker Dry" Test

Properly dried mushrooms should be:

- Brittle enough to snap cleanly when bent — no flexibility at all
- Light and airy feeling, not leathery or rubbery
...
Desiccants absorb residual moisture after initial drying. Essential for long-term storage.

### Silica Gel

- Most common and effective desiccant for mushrooms
- Indicating silica gel changes color (blue to pink, or orange to green) when saturated
- Can be recharged by baking at 250°F (121°C) for 2-3 hours
- Available at craft stores, online, or save packets from product packaging

### DampRid (Calcium Chloride)

- Aggressive moisture absorber
- Turns to liquid as it absorbs water
- Good for storage chambers but messy if it contacts mushrooms directly
- Place in a separate container within the storage container
...
5. Check after 24-48 hours. Mushrooms should reach cracker-dry
6. Remove mushrooms and store separately

## Long-Term Storage

### Storage Containers

- **Glass mason jars** with airtight lids — best option
- **Vacuum-sealed bags** — excellent for long-term storage
- **Mylar bags with oxygen absorbers** — best for multi-year storage
- Avoid plastic bags (permeable to moisture and air)
- Avoid paper bags (absorb moisture from air)

### Environmental Conditions

- **Temperature**: Cool is better. Refrigeration (35-40°F) is ideal. Freezing is acceptable for cracker-dry mushrooms
- **Light**: Store in darkness. UV light degrades active compounds
- **Oxygen**: Minimize exposure. Oxygen oxidizes psilocybin over time
- **Moisture**: Must be cracker-dry before storage. Any residual moisture will cause mold

### Storage Duration

| Storage Method | Expected Duration | Potency Retention |
|---------------|-------------------|-------------------|
| Room temp, sealed jar | 6-12 months | Good |
| Refrigerator, sealed jar | 1-2 years | Very good |
| Freezer, vacuum-sealed | 2-5+ years | Excellent |
