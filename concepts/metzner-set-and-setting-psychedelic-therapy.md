...
The set and setting model emerged from the Harvard Psilocybin Project
(1960-1962), where Leary, Metzner, and Alpert administered psilocybin and
...
across individuals. The Harvard group's insight was that hallucinogens are
not simply "drugs" that impose a specific chemical effect on the brain, but
rather catalysts or amplifiers of mental processes that are shaped by
non-drug factors.
...
Metzner drew explicit parallels between the set and setting framework and the
structured contexts of shamanic ceremonies across cultures. Indigenous
[[shamanic-entheogenic-healing-rituals]] universally incorporate elements that correspond to both set
and setting:
