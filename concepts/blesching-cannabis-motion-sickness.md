...
Seasickness, airsickness, and carsickness are associated with nausea, vomiting,
dizziness, and vertigo. Motion sickness occurs due to discord between the
movements perceived by the eyes versus those perceived by the inner ear. If
this conflict finds no resolution, nausea may progress to vomiting. An
estimated 7-28% of travelers experience acute motion sickness.
...
sickness, mental stress, and physical nausea and vomiting.

### Study Summary

| Drug | Study Type | Key Findings | CHI |
|------|-----------|-------------|-----|
| ECS (CB1/CB2), Anandamide | 21 healthy male volunteers | 2010, German multi-institutional: CB1 expression significantly lower in motion sickness subjects; anandamide fell in sick subjects, rose in well subjects | 3 |
| CBD (0.5-40 mg/kg) and THC (0.5-10 mg/kg) | Animal study (S. murinus) | 2008, Bradford, UK: THC prevented motion-induced vomiting; CBD did not | 1 |
...
or reduce motion sickness symptoms.

## Mind-Body Medicine

Researchers Grace and Graham wrote: "Nausea and vomiting occurred when an
