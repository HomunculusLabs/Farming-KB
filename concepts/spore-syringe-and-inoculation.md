...
containing a single nucleus per cell.
...
consistent, reproducible results, cultivators use cloned tissue or isolated
...
Spores are collected by placing a sterile foil or glass surface beneath the cap
of a mature mushroom and allowing the spore print to deposit over 12–24 hours.
The resulting print is a dense layer of spores characteristic in color to the
species (white, brown, black, pink, rust, etc.). The mushroom cap should be
placed gills-down on the collection surface and covered with a glass or bowl
to minimize airflow disturbance while allowing gas exchange.

### Syringe Assembly

1. **Sterilize equipment** — syringes (typically 10–20 cc), needles (18–20
...
3. **Draw and seal** — the spore suspension is drawn into the syringe, which is
   capped with a sterile needle and often sealed with heat-shrink tubing for
   long-term storage. Some cultivators add a tiny drop of sterile glycerin to
   protect spores during freezing for long-term preservation.

Properly prepared spore syringes can remain viable for months to years when
stored in a cool, dark place. Refrigeration at 2–4°C extends viability
significantly; some reports indicate viable spores after 5+ years of cold
storage.

## Inoculation Techniques

### Grain Jar Inoculation

The most common inoculation method for grain spawn. Working in a still-air box
or under a laminar flow hood:

1. Shake the spore syringe vigorously to distribute spores evenly throughout
   the suspension.
2. Flame-sterilize the needle tip until it glows red-orange, then allow it to
   cool for 10–15 seconds (touching a sterile surface briefly to cool without
   contaminating).
3. Insert the needle through the jar's inoculation port (self-healing silicone
   port or micropore tape covering a drilled hole).
4. Inject 1–2 cc of spore solution per quart jar, aiming to distribute drops
   across the grain surface for multiple colonization points.
5. Remove the needle and flame-sterilize the tip again before proceeding to the
   next jar or capping the syringe.
