---
title: Clay Seed Balls (Tsuchi Dango)
created: 2026-04-14
updated: 2026-04-15
type: concept
tags: [reference]
...
- **Rot** -- seeds left on the surface can rot during heavy rains, especially rice seeds sown in autumn
- **Poor germination** -- seeds set too deeply rot; seeds on the surface may dry out. Fukuoka notes: "Germination is best on the surface, where there is exposure to oxygen."
...
5. This forms tiny pellets about half an inch in diameter

### Kneading Method

1. Soak unhulled rice seed in water for several hours
2. Mix with moist clay by kneading with hands or feet
3. Push the clay through a screen of chicken wire to separate into small clods
4. Let dry for one to two days until easily rolled between palms
5. Ideally, there is one seed in each pellet

In one day, enough pellets can be made to seed several acres. The kneading method is more suited to larger-scale production and can be a communal activity.
