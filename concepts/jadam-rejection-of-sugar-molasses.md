...
- Facilitating aging by decreasing vitamin E
...
JADAM replaces all of these with the simplest possible combination: water and leaf mold. Prepare a container, add ingredients, fill with water, add a handful of leaf mold, and close the lid. The result:
- Costs essentially nothing
- Minimum nutrient loss (no sugar acidification)
- Easy and simple
