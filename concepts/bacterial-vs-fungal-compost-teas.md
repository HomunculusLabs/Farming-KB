...
A good bacterial tea has:
- Great bacterial numbers and diversity
- Above 300 micrograms per ml total bacteria for adequate leaf surface coverage
- Active bacteria in proper proportion to total bacteria

Bacterial tea alone can prevent some diseases — black spot, apple scab (sometimes), mildew in unfavorable years, and Taphrina. However, it cannot prevent anthracnose or mildew when conditions strongly favor those diseases.

## Fungal Dominance

Fungal-dominant teas are needed when:
- Growing late successional plants (trees, shrubs, perennials)
- Suppressing root rot diseases (Pythium, Phytophthora, Rhizoctonia)
- Building soil structure and water-holding capacity
- Retaining calcium, nitrogen, and phosphorus in soil
- Reducing water use by 30–50% through improved soil aggregation

### Why Fungi Are Harder to Grow

Getting adequate fungal biomass is the difficult challenge in compost tea production. The entire chain must succeed:
1. Compost must have good fungal biomass (above 150 µg, preferably 300+ µg)
2. Fungal hyphae must extract from the compost during brewing
...
Tillage causes bacteria to bloom and burns off organic residues rapidly, leading to bacterial-dominated soils and loss of organic matter. No-till allows fungal biomass to build over time.
