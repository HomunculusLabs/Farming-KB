...
The word *Mu* here carries specific meaning — it is not mere emptiness but "cosmic nothingness," referring to the state where willful human actions are cast aside. A Mu economy is one that operates without the artificial impositions of human will upon natural processes. It does not measure, does not calculate, and does not rank.

> "Establishing Mu economics will require us to get rid of our false system of values and unearth the original and true value of agriculture."

The "false system of values" Fukuoka identifies is the one that equates cost with worth, that treats food as a commodity, and that judges agricultural success by yield per hectare or profit per season. The "original and true value of agriculture" is something far deeper — it is the sustenance of human life through partnership with the natural world, a relationship that has no price.
...
> "If all the farmers of the world thought along these lines, crop prices everywhere would settle to the same level and would no longer be needed."
...
Fukuoka's economic vision leads directly to a sharp critique of the global food trade system. If prices have no natural basis, then the elaborate apparatus of international agricultural trade is not merely inefficient — it is absurd.
...
The market demands uniformity — perfectly straight cucumbers, identically sized apples, blemish-free surfaces. Nature produces variety. In a Mu economy, the crooked cucumber and the small fruit are not seconds or rejects; they are expressions of natural diversity, each with its own character and value.

Fukuoka pointed to the irrationality of modern trade patterns with particular force:

> "What sense is there in importing oranges from the United States and exporting mandarins back?"

This kind of exchange — driven not by need but by comparative advantage, trade agreements, and corporate profit — wastes energy, degrades food quality, and severs the connection between people and the land that sustains them.

His prescription was simple and radical:
...
When food is treated as a commodity to be traded for profit, the result is not abundance but confusion — overproduction here, scarcity there, dietary habits shaped by advertising rather than nutrition, and farmers trapped in cycles of debt and dependency.

## Small-Scale Trading Vision

Fukuoka was not proposing the total abolition of all exchange. He recognized that even in a society organized around Mu principles, some degree of trade might be necessary. But the scale and nature of that trade would be fundamentally different from what exists today:
...
## Japan's Agricultural Policy Critique
...
The consequences of this reduction have been severe:

> "The destruction of an agriculture stripped of its basic meaning has already reached a perilous state."

Fukuoka dismissed the conventional policy responses to agricultural crisis as symptoms of the very disease they claim to treat:

> "Economic relief measures are being attempted today, but the most important step that must be taken is not increasing the price of rice. Nor is it lowering the price of materials or cutting back production expenses or raising labor productivity with labor-saving techniques and mechanization or reorganizing the distribution system."

Every one of these measures operates within the monetary economy that created the crisis. Raising the price of rice treats food as a commodity. Mechanization treats labor as a cost to be eliminated. Reorganizing distribution treats food as a product to be moved through supply chains. None of them addresses the root problem: that agriculture has been severed from its foundation in natural process and human relationship.
...
The transition to a Mu economy is not a technical problem with a technical solution:

> "Turning around to return to the source of Mu and dedicating ourselves to a Mu economy will not be easy, but it is the only choice we have."

The difficulty is not logistical but spiritual. It requires letting go of deeply held assumptions about progress, productivity, and the nature of value. It requires the humility to recognize that human cleverness has led us astray and that the way forward is actually the way back.
...
> "Our world has fallen into a state of chaos because man, led astray by an embarrassment of knowledge, has engaged in futile labors."

The "embarrassment of knowledge" is the accumulated weight of human cleverness — the technologies, the systems, the theories that promised mastery over nature and delivered instead alienation and destruction. The "futile labors" are the endless efforts to fix problems created by previous efforts, each solution generating new problems in an accelerating spiral of complexity and failure.

Yet the way out remains open:

> "The road back to the land, back to the bosom of a pure, innocent nature still remains open to us all."

This is Fukuoka's final and most fundamental message. The destruction is not total, the alternatives are not exhausted, and the door to a different way of living has not been closed. Mu economics is not a utopian dream but a practical possibility — one that requires only the willingness to set aside human willfulness and return to the source from which all true value flows.
