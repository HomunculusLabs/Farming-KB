...
type: concept
tags: [mycology, spore-dispersal, gravitropism, fungal-ecology, mushroom-biology]
...
### The Gill Spacing Problem

The spacing between adjacent gills (lamellar spacing) is exquisitely tuned to the physics of ballistospore discharge:

- Gills are spaced such that a discharged spore clears the gap between gills and falls freely into the open air below.
- If gills are too close together, spores collide with the opposing gill and fail to disperse.
- If gills are too far apart, fewer spores are produced per unit area of cap.
- The downward orientation of gills ensures that gravity assists spore clearance through the inter-gill spaces.

## Gravitropic Recurvature at Maturity
...
Light plays an essential but possibly indirect role in the gravitropic response at maturity:
...
### For Coprophilous Species

Plunkett (1961) suggested that negative gravitropism is particularly important for coprophilous (dung-dwelling) and lignicolous (wood-dwelling) species:

- **Unstable substrates**: Dung pats and fallen logs present inherently unstable growing surfaces that may be tilted, overturned, or irregularly shaped.
- **Gravity as a reliable cue**: Regardless of substrate orientation, gravity always provides a reliable directional cue for orienting the gills downward.
- **Spore deposition on substrate**: For coprophilous species, spores need to land on fresh substrate (dung) to complete the life cycle. Downward-facing gills, combined with the elevated position provided by the stipe, maximize the chance that spores will be carried by wind to suitable substrate below.

### For Wind Dispersal

The combination of an elevated stipe and downward-facing gills creates an optimal configuration for wind dispersal:
