...
Shiitake is a primary decomposer of hardwood trees and naturally occurs on oaks and beeches in forests worldwide. Log cultivation mimics this natural relationship.

### Suitable Wood Species

Shiitake grows on a wide range of non-aromatic, broad-leaf hardwoods:

- **Dense hardwoods** (preferred for longevity): Oak, ironwood, beech. These produce fruitings for up to 6 years but are slower to colonize.
- **Fast-decomposing hardwoods** (faster colonization, shorter lifespan): Alder, cottonwood, poplar, sweetgum. These have approximately half the productive lifespan of dense hardwoods.
- **Other suitable species**: Ash, elm, birch, willow, and many other broad-leaf woods.

**Unsuitable species**: Fruit woods are notoriously poor for Shiitake. Aromatic woods (cedar, redwood, pine) contain resins that inhibit mycelial growth. At least 75 hardwood species and 10 species suitable for Shiitake specifically have been documented.

### Log Selection and Preparation

Logs should be cut from healthy, living trees during dormancy (late fall through early spring, before bud break). The ideal log diameter is 4-8 inches, with lengths of 3-4 feet being most manageable. Logs should be inoculated within 2-6 weeks of felling, before the natural anti-fungal defenses of the wood degrade but while moisture content remains adequate.

## Indoor Method: Supplemented Sawdust Blocks

Modern indoor cultivation uses supplemented sawdust substrates for faster, more controlled production.
...
| Rice or wheat bran | 40 lbs (18.1 kg) |
| Gypsum | Buffer as needed |
| Water | To achieve 65-75% moisture |

At make-up, the substrate pH is 5.5-6.0. By the time of fruiting, the pH drops to 3.5-4.5 (optimal fruiting range: 4.2-4.6 per Chang and Miles, 1989). Alternative supplements include various grains, cereal brans, flours, tea leaves, yeast, and molasses.

Pine (Pinus radiata) has been successfully used when combined with hardwood at a ratio of 6 parts pine to 3 parts hardwood to 1 part barley grain.

### Spawn Selection

Stamets recommends:
- **1st and 2nd generation spawn**: Rye, wheat, sorghum, or corn grain
- **3rd (final) generation spawn**: Sawdust spawn (produces better results for the final expansion)

### Block Preparation and Colonization

1. Substrate is mixed, moistened, and packed into polypropylene bags with microporous filter patches (or bottles fitted with cotton plugs)
2. Blocks are sterilized in a retort or autoclave
3. Inoculated with grain or sawdust spawn
4. Incubated in controlled environment growing rooms

### Colonization Timeline

The progression of Shiitake colonization on supplemented sawdust blocks:
...
|-------|-----------|-------|
| Spawn Run | Temperature | 70-80 degrees F (21-27 degrees C) |
