...
Side shoots and branches between the graft and the ground fulfil an important browsing protection function:
- Twigs just above ground: eaten by hares
- Middle height: eaten by roe deer
- Higher branches: eaten by red deer
- Animals find food at the right height for them without damaging the trunk
...
For areas with particularly high browsing danger or limited cultivation space:

### Ingredients
- Bone salve (intense, long-lasting odour that repels deer)
- Linseed oil (made from flax seeds; binds ingredients together; ensures adhesion to bark)
- Slaked lime (beneficial to tree; emits heat; helps combine ingredients)
- Fine quartz sand (remains when odour fades; causes unpleasant sensation between teeth)
- Fresh cow dung (bulks out salve; absorbs other ingredients; helps repel animals; good consistency)

### Preparation
Mix all ingredients to a spreadable consistency.

### Application Methods
1. **Paint**: apply directly to tree bark with a brush or broom
2. **Sprinkle**: add more linseed oil and less sand for sprinkling consistency; sprinkle over plants (similar to sprinkling holy water in a church)

### How It Works
- Bone salve has an intense, long-lasting odour that gets into the bark and lasts for many years
- Similar effect to mineral naphtha or beechwood tar (which can be substituted for bone salve)
- If odour fades, quartz sand remains and causes unpleasant sensation in animals' teeth
- Slaked lime emits heat which is beneficial to the tree

### Enhanced Repellent (Substitute for Bone Salve)
If using naphtha or beechwood tar instead of bone salve (less intense odour):
- Mix in singed hair (pig bristles or cattle hair)
- To singe: put hair in a metal container, light a fire beneath, so hair is singed by heat
- Produces a floury mass to mix into the salve
- Smell of singed hair only noticeable to humans for a short time but continues repelling wild animals
