...
TLC is the simplest and most accessible chromatographic method for screening mushroom samples for psilocin and psilocybin.

**Procedure:**
1. Extract dried mushroom material with a suitable solvent (typically methanol)
2. Spot the extract alongside reference standards on a silica gel plate
3. Develop the plate in an appropriate solvent system
4. Visualize using Ehrlich's reagent (p-dimethylaminobenzaldehyde in acid)

**Ehrlich's Reagent:** This is the most widely used colorimetric test for indole compounds. When Ehrlich's reagent is applied to a TLC plate containing psilocin or psilocybin, it produces a distinctive blue-purple color. Shirota et al. note that spots are "visualized by heating with Ehrlich's reagent and/or by UV light at 254 nm."

**Advantages:**
- Low cost and minimal equipment requirements
- Rapid results (minutes)
- Can screen multiple samples simultaneously
- Ehrlich's reagent provides indole-specific detection

**Limitations:**
- Lower resolution than GC or HPLC
- Semi-quantitative at best
- Cannot distinguish between structurally similar indole alkaloids
- Confirmation requires a second method

### Gas Chromatography (GC)

GC provides higher resolution than TLC and can quantify psilocin and psilocybin with greater precision.

**Considerations:**
- Psilocybin is thermally labile and may degrade in the GC injector
- Derivatization is typically required for reliable analysis
- GC-MS (gas chromatography-mass spectrometry) provides definitive identification through molecular fragmentation patterns
- Psilocin is more amenable to GC analysis than psilocybin due to lower thermal lability

**Applications:**
- Confirmation of TLC screening results
- Quantitative analysis of mushroom potency
- Detection of psilocin/psilocybin in biological fluids (blood, urine)
...
**Advantages:**
- No thermal degradation of analytes
- High resolution and reproducibility
- Compatible with both analytical and preparative scales
- UV detection provides compound-specific identification
- Can be coupled with mass spectrometry (LC-MS) for definitive identification
