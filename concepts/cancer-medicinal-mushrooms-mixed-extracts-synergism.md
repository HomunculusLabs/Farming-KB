...
## Evidence for Complementary Effects
...
The rationale for mixed extracts rests on several biological principles:

1. Different mushrooms activate different immune pathways: Lentinan
   primarily activates NK cells and T-cells; PSK/PSP target T-cells
   and antigen-presenting cells; Ganoderma activates macrophages,
   NK cells and complement pathways
2. Broader immune coverage reduces the likelihood of immune escape by
   tumour cells
3. Lower doses of individual components may achieve equivalent or
   superior effects through synergy, reducing any risk of side effects
4. Traditional formulations commonly combined multiple mushroom species,
   suggesting historical validation of the multi-species approach
5. Mixtures can address both innate (macrophage, NK cell) and adaptive
   (T-cell, B-cell) immune responses simultaneously

## AHCC as a Model Multi-Species Product

AHCC represents the most studied example of a multi-species mushroom
extract. Derived from the co-cultivation of Lentinus edodes, Trametes
versicolor and Schizophyllum commune on rice, it produces alpha-1,3
glucans of low molecular weight (~5,000 daltons) that are orally
bioavailable. The arabinoxylane derivative (MGN-3) from this
fermentation increased human NK activity by a factor of five over two
months, one of the most potent NK activation results reported for any
mushroom-derived product.

## Chemotherapy Combination Synergy

The synergistic potential extends to combination with conventional
...
## Dietary Fibre and Colorectal Prevention
