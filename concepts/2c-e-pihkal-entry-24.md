...
The 5-ethoxy homologue (5-ethoxy-4-ethyl-2-methoxyphenethylamine) is active at 10-15 mg but dramatically longer-lasting than 2C-E. Plateau requires 3-4 hours to achieve, and experiments were sometimes interrupted with Valium or Halcion at the 16-hour point. After a night's sleep, effects were still evident the next day. One subject nicknamed it "Eternity." It is described as "gentle, forgiving, and extremely long lived" -- contrasting with 2C-E's more intense but shorter profile.

## Synthesis Summary

Synthesized from p-dimethoxybenzene via Friedel-Crafts acetylation to give 2,5-dimethoxyacetophenone. Wolff-Kishner reduction (hydrazine/KOH in triethylene glycol) gives 2,5-dimethoxy-1-ethylbenzene. Formylation with SnCl4/dichloromethyl methyl ether gives 2,5-dimethoxy-4-ethylbenzaldehyde (mp 46-48 C). Condensation with nitromethane yields the nitrostyrene (mp 96-100 C). Reduction with LAH in THF (with or without H2SO4 activation) gives the free base, which is distilled (bp 90-100 C at 0.25 mm/Hg) and converted to the HCl salt as "magnificent white crystals."
