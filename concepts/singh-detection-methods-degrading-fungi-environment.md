...
A diverse range of immunological techniques has been applied to wood
decay and degradative fungi detection:

- **Immunofluorescence**: Provides sensitive and quantitative analysis for
  the detection of Basidiomycetes in wood. An indirect
  immunofluorescence test has been developed to detect 10 propagules/ml
  of Hormoconis resinae in aviation kerosene within 5 hours.

- **Dot-immunoblot assay**: Performed on nitrocellulose paper with
