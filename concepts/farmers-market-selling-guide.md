...
- Jams, jellies, preserves (pH below 4.6)
...
- Tablecloths (hanging to the ground hides storage underneath)
- Display baskets, crates, and risers for vertical display
- Price signs (large, clear, consistent style)
- Cash box with change ($100 in small bills and coins)
- Card payment: Square reader or similar ($30-50 hardware, 2.6% + $0.10/transaction)
