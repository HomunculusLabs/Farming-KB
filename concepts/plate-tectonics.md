...
Plate tectonics is the modern framework for understanding Earth's active outer shell.
It explains continents, ocean basins, earthquakes, volcanoes, mountain belts, and seafloor spreading.
The theory holds that the lithosphere is divided into moving plates.
These plates include both crust and the uppermost rigid mantle.

They move over the weaker asthenosphere on geological timescales.
Motion is usually measured in centimeters per year.
That pace is slow by human standards but powerful over millions of years.
Plate tectonics unifies many observations that once seemed unrelated.
It connects the shapes of continents with fossil distributions and rock belts.
...
That aging makes subduction possible and drives long-term recycling.
Continental lithosphere is more buoyant and can survive for billions of years.
## History and Context

Before plate tectonics, many geologists explained mountains by vertical crustal movements.
Alfred Wegener proposed continental drift in the early twentieth century.

He noticed that continents appeared to fit together like puzzle pieces.
He also cited matching fossils, glacial deposits, and rock sequences across oceans.
Wegener's idea was criticized because he lacked a convincing mechanism.
Many geologists rejected continental drift for decades.
Evidence from oceanography changed the debate after World War II.
Sonar mapping revealed a global system of mid-ocean ridges.

Paleomagnetic studies showed apparent polar wander paths.
These paths made more sense if continents had moved.
Harry Hess proposed seafloor spreading in the 1960s.
Vine, Matthews, and Morley linked magnetic stripes to spreading and geomagnetic reversals.
Subduction provided the missing sink for old oceanic crust.
By the late 1960s, plate tectonics had become a unifying geological paradigm.

It transformed earth science much as evolution transformed biology.
The theory remains active rather than complete.
Researchers still debate early Earth tectonics, mantle dynamics, and plate initiation.
## Applications and Significance

Plate tectonics is essential for assessing natural hazards.
Most large earthquakes occur near plate boundaries.

Subduction zones can generate megathrust earthquakes and tsunamis.
Volcanic hazard maps depend on tectonic setting.
Understanding plate boundaries helps cities plan building codes and evacuation routes.
Plate tectonics also guides mineral and energy exploration.
Porphyry copper deposits often form above subduction zones.
Rift basins can accumulate sediments, organic matter, and hydrocarbons.

Ancient plate margins help geologists locate ore belts.
...
Plate tectonics may also matter for planetary habitability.
Earth is the only known planet with active global plate tectonics.
Some scientists argue that tectonics helps regulate climate and nutrients.
