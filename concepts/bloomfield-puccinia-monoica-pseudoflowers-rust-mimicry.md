...
secretions that attract insect pollinators. The fungus hijacks the
sexual apparatus of insects to accomplish its own reproduction.
...
insatiable appetite for yellow advertisements, and in so doing, changes
the ecology of its entire habitat. This represents a staggering feat of
biochemical manipulation: a microorganism reprogramming the development
of a multicellular plant to produce a structure that mimics an entirely
different organism's reproductive organ.

The rust produces its spermagonia on the surface of the host plant,
structures that secrete a sweet fluid and exude spermatia. Flies and
other insects are drawn to the sugary exudate, just as they would be to
nectar, and in the process pick up and transfer spermatia between
different rust infections. This insect-mediated transfer serves the same
function as pollination in flowering plants, allowing the rust to
achieve genetic recombination through what is functionally a sexual
process.
