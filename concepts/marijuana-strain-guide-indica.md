---
title: Marijuana Strain Guide — Indica
created: 2026-04-12
updated: 2026-04-12
type: concept
...
Indica plants are compact, bushy, and well-suited for confined growing spaces. Key morphological features include:

- Short, stocky stature (typically 3-5 feet)
- Wide, dark green leaf blades
- Short internodal spacing
- Dense, heavy bud clusters
- Shorter flowering period (7-9 weeks indoors)
...
Indica strains are traditionally associated with full-body relaxation and sedation. Common reported effects include:
...
A classic purple indica with a complex grape and berry aroma. Distinctive deep purple coloration in cooler growing conditions. Heavy sedating effects make it a popular evening strain. Originally from Northern California.

### OG Kush

While technically a hybrid, OG Kush expresses strong indica-dominant effects. Earthy, pine, and lemon aroma. Extremely potent with long-lasting effects. One of the most influential strains in modern cannabis history.
...
Created by DJ Short in the 1970s. Sweet blueberry aroma and flavor. Notable purple hues during flowering. Moderate potency with gentle relaxing effects. Winner of the High Times Cannabis Cup.

### Hindu Kush

The quintessential landrace indica from the mountain range of the same name. Pure indica genetics with centuries of selective breeding. Earthy, sandalwood aroma. Extremely resilient and easy to grow. Foundation genetics for many modern strains.

## Growing Indica Strains

Indicas are generally considered easier to grow than sativas, making them popular with beginners.
...
The shorter flowering period (7-9 weeks) is a major advantage. This allows for:

- Faster harvest cycles
- More grows per year
- Reduced risk of pest and mold problems
- Lower electricity costs for indoor growers

### Environmental Preferences

Indicas prefer slightly cooler temperatures than sativas, particularly during flowering. Cool night temperatures (65-70F) can enhance purple coloration in strains with anthocyanin expression. They tolerate slightly higher humidity during vegetative growth but need reduced humidity during flowering to prevent bud rot.

## Best Uses for Indica Strains

Indica strains are generally best suited for:
...
Patients commonly use indica strains for:
