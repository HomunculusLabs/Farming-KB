---
title: Permaculture Site Observation Methods
...
Make non-interpretative notes about what is seen, measured, or experienced. Record observations without guesses or judgments. For example: "moles have thrown up earth mounds on the field" — not "moles are damaging the soil." This takes discipline but yields a wealth of primary data untainted by assumption.

### Stage 2: Speculation
Select observations that interest you and list possible meanings and explanations. For the mole example:
- Molehills may only be conspicuous on fields and actually occur elsewhere
- They may occur only on fields because fields are particularly attractive to moles
- The soil type in fields may be especially suitable for burrowing

Many speculations can arise from a single observation. Each speculation is a species of hypothesis — a guess about which you can obtain more information.

### Stage 3: Testing Speculations
Confirm or deny speculations through:
- **Library research**: Studying the biology and behavior of the observed organism or process
- **Asking others**: Consulting local knowledge, experienced farmers, indigenous peoples
- **Targeted observation**: Devising further observations focused on testing specific ideas
...
Essential observation tools include:
- **Camera**: For documenting conditions and recording changes over time
- **Notebook**: For immediate recording of observations, ideas, and sketches
- **Video recorder**: For reviewing dynamic processes such as water flow, animal behavior, or wind patterns
- **Memory**: A good memory for events — when the frost came, how long the pond held water, which trees leafed out first
