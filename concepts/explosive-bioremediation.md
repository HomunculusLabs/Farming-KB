---
title: Bioremediation of Explosives and Munitions
created: 2026-04-18
updated: 2026-04-18
type: concept
...
The principal explosive contaminants include 2,4,6-trinitrotoluene (TNT), hexahydro-1,3,5-trinitro-1,3,5-triazine (RDX), octahydro-1,3,5,7-tetranitro-1,3,5,7-tetrazocine (HMX), and perchlorate.
...
TNT biodegradation proceeds through several distinct pathways depending on the microbial community and environmental conditions.
...
These reduction products are generally less toxic than the parent TNT but can be further transformed through condensation reactions to form azo compounds and other polymeric products that are recalcitrant to further degradation.
...
Perchlorate is highly soluble and mobile in groundwater, and its treatment requires either physical removal (ion exchange) or biological reduction to chloride.

Dissimilatory perchlorate-reducing bacteria use perchlorate as a terminal electron acceptor, reducing it sequentially to chlorate, chlorite, and finally chloride and oxygen.

Dechloromonas and Azospira species are among the most well-characterized perchlorate-reducing bacteria.

The biological reduction of perchlorate requires an electron donor (typically acetate, lactate, or hydrogen) and anaerobic conditions.

In situ bioremediation of perchlorate-contaminated groundwater has been achieved through injection of electron donor solutions to stimulate indigenous perchlorate-reducing bacteria.
...
Perchlorate-degrading rhizosphere bacteria can enhance phytoremediation by reducing perchlorate in the root zone before plant uptake.
