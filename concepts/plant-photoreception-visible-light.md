---
title: Plant Photoreception Across the Visible Spectrum
created: 2026-05-09
tags: [plant-biology, photoreception, photoreceptors, uv-light, spectrum]
date: 2026-05-09
updated: 2026-05-09
sources:
type: concept
...
- Control chloroplast movement within cells to optimize light absorption
- Control stomatal opening in response to blue light
- Located primarily at shoot tips and in leaf cells

### Cryptochromes (Blue/UV-A Detectors)

- Detect blue light (~450 nm) and UV-A light (~320-400 nm)
- Regulate [[plant-circadian-rhythms]] and the biological clock
- Control de-etiolation (the transition from dark-grown to light-grown
  seedling development)
- Influence flowering time independently of phytochrome
- Contribute to magnetoreception (sensing Earth's magnetic field) in some
  species
- Found throughout the plant body

### UVR8 (UV-B Detectors)

- Specifically detects UV-B radiation (~280-315 nm)
- Triggers protective responses including flavonoid production
- Activates DNA repair mechanisms
- Controls gene expression for UV protection
- Essential for plant survival under high-UV conditions

## What Plants See That Humans Cannot

Chamovitz emphasizes that plant light perception extends well beyond human
visual capabilities:
