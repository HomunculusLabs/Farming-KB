...
agar for truffles), half is removed, and replaced with plant growth
medium. The fungus is inoculated on the fungal medium side and allowed
to grow for a determined period (approximately 10 days for truffles)
before plant seeds are added to the plant medium side. This system
permits testing of fungi that cannot grow on standard media while still
allowing detection of auxin effects on plant roots.
...
bona fide auxin producer capable of physiologically relevant hormone
synthesis.

## Piriformospora indica as a Model System

The axenically cultivable endophytic fungus Piriformospora indica,
which shares features with AM fungi, serves as a model for studying
fungal auxin effects. P. indica induces bushy root growth in A. thaliana
...
concentrations of auxin capable of inducing significant root
modification at biologically meaningful distances.

## Implications for Mycorrhizal Establishment
