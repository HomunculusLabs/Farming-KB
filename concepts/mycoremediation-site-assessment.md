...
### Soil Properties
- **Texture:** Sandy soils favor fungal penetration and contact with contaminants. Clay-rich soils limit hyphal growth and reduce bioavailability of sorbed contaminants
- **Organic matter content:** High organic matter improves fungal growth but can sequester contaminants and reduce bioavailability. Balance between supporting fungal biomass and enabling contaminant access is critical
- **pH:** Most white-rot fungi prefer pH 4.5-5.5. Extremely alkaline or acidic soils may require amendment (sulfur for alkaline, lime for acidic) before fungal inoculation
- **Moisture holding capacity:** Fungal activity requires adequate but not excessive moisture (60-80% of water holding capacity). Well-drained soils are easier to manage than waterlogged sites
- **Nutrient status:** Nitrogen and phosphorus levels should be assessed. Ligninolytic enzyme production by white-rot fungi requires low nitrogen, so nutrient-rich sites may need carbon amendment to adjust the C:N ratio

### Hydrology
- **Groundwater depth:** Contaminated groundwater may require different treatment approaches (permeable reactive barriers, injection) than contaminated soil
- **Surface water proximity:** Runoff control is necessary during treatment to prevent contaminant mobilization
- **Drainage:** Adequate drainage prevents waterlogging while maintaining soil moisture. Permeable soils are preferred
