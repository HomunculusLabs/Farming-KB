---
title: Permaculture mollison-designers-appropriate-technology-small-scale-tools Design
created: 2026-04-20
updated: 2026-04-20
type: concept
...
matched to smallholder farming systems.
## Digital and Communication Technology
While permaculture's roots lie in land-based systems, the framework also
applies to digital technology selection. Appropriate digital tools are those
that serve communication and record-keeping needs without creating dependency
on fragile infrastructure. Simple, open-source software, local data storage,
and low-bandwidth communication tools are preferred over cloud-dependent,
