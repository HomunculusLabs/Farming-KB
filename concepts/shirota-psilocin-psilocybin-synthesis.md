...
## Psilocybin Synthesis Challenge

The phosphorylation of psilocin to produce psilocybin presented the principal
synthetic challenge. Several phosphorylation methodologies were evaluated,
including the phosphoryl iodide method using tribenzyl phosphite, iodine, and
DMAP. Most methods either failed to consume the psilocin starting material or
produced intractable mixtures. The pyrophosphate method, using
tetrabenzylpyrophosphate and n-butyllithium, was ultimately selected for its
easy handling and reagent stability.

## Zwitterionic Intermediate Discovery

The key innovation of the Shirota synthesis was the discovery and
characterization of a zwitterionic intermediate. When the phosphorylation
