...
Paraglomus, and Geosiphon. The last is notable as the only known
fungal endosymbiosis with cyanobacteria. These genera collectively
associate with the vast majority of terrestrial plant species.
...
- **Orchidaceous mycorrhiza**: Fungus penetrates cell wall and
  forms hyphal coils; orchid seeds germinate only in presence
  of suitable fungus.
- **Arbutoid and Monotropoid**: Intermediates sharing ECM and
  endomycorrhizal features; associated with specific plant
  families.
