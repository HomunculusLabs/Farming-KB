...
When rain strikes a seed ball, the clay absorbs moisture and slowly breaks down. The compost provides a nutrient-rich micro-environment for the seed to sprout. Once germinated, the seedling pushes roots through the softening clay into the soil below. No soil preparation, digging, or irrigation is required -- the seed waits for natural conditions.
...
- **Clay**: red or brown clay, powdered dry (not potter's clay with grog). Bentonite or local subsoil clay works. Avoid sandy or gravelly material.
- **Compost**: finished, sieved compost or worm castings. Should be fine enough to pass through a 1/4 inch screen.
- **Seeds**: any seeds appropriate to the site and season. See species recommendations below.
- **Water**: enough to achieve workable consistency
