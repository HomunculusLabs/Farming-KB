---
title: Hamilton Layering Propagation Techniques
created: 2026-04-28
tags:
  - organic-gardening
  - propagation
...
of plant, and choosing the right method depends on the growth habit of
the plant you wish to propagate.

## Tip Layering

Tip layering is used primarily for bramble fruits — blackberries,
loganberries, and other hybrid berries. It is performed in late summer
when the current season's shoots are long and flexible.

To tip layer, pull down as many shoots as you need and make a hole in
the soil where the tip of each shoot rests. Place the tip in the hole
and pin it in position using a forked stick or wire peg. Cover the tip
with soil and firm it gently. Leave the layer in place until the leaves
of the parent plant fall in autumn.

Once the layer has developed a good root system — usually by late
autumn — cut it from the parent plant, carefully lift it with roots
intact, and transplant to its permanent position. Tip layering is
remarkably reliable and is the standard method for increasing bramble
fruit plantations.

## Normal Layering

Normal (simple) layering involves burying part of a shoot underground
with the tip left exposed above the soil surface. It is suitable for
plants that root less readily from cuttings, such as rhododendron,
