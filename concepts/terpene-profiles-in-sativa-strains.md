...
- **Prevalence**: Moderate in most strains, higher in some indica-dominant varieties
- **Sativa association**: Less prominent in pure sativas but present in many sativa-dominant hybrids
- **Effects**: Calming, anti-anxiety, sedative, analgesic. Modulates the intensity of THC psychoactivity
- **Other sources**: Lavender, birch bark, coriander
- **Notable strains**: Amnesia Haze (notable linalool content for a sativa), LA Confidential
...
- **Aroma**: Sweet, herbaceous, woody, citrus
- **Prevalence**: Present at low levels in many strains, higher in some sativas
- **Sativa association**: More commonly noted in sativa-dominant varieties
- **Effects**: Antiviral, decongestant, uplifting
- **Other sources**: Mint, parsley, mango, basil
- **Notable sativa strains**: Space Grape, various tropical sativa varieties

## Sativa Terpene Patterns

### The "Sativa Terpene Profile"

Sativa-dominant strains tend to share common terpene patterns distinguishing them from indicas:

1. **Higher terpinolene**: Contributes to complex, multi-layered aromas
2. **Prominent limonene**: Citrus notes and perceived uplifting effects
3. **Higher pinene**: Pine notes and cognitive clarity
4. **Lower myrcene**: Less sedation compared to indicas
5. **Greater terpene diversity**: Wider range of compounds at detectable levels
...
The entourage effect, proposed by Ethan Russo and others, suggests that the therapeutic and psychoactive effects of cannabis result from the synergistic interaction of all its chemical components — cannabinoids, terpenes, flavonoids, and other compounds — rather than from any single molecule (THC) in isolation.
...
Understanding terpene profiles allows consumers and patients to make more informed choices:

- For focus and energy: Seek strains high in pinene, limonene, and terpinolene with low myrcene
- For relaxation without sedation: Strains with linalool and humulene, moderate caryophyllene
- For anti-inflammatory effects: Caryophyllene, myrcene, and pinene combinations
- For mood elevation: Limonene-dominant profiles

## Terpene Testing and Quality

### Laboratory Analysis

Modern testing laboratories profile terpene content using gas chromatography-mass spectrometry (GC-MS). Results are reported as percentage of total weight. Total terpene content in dried flower typically ranges from 1% to 4%.

### Factors Affecting Terpene Production

- **Genetics**: Primary determinant of which terpenes and in what ratios
- **Growing conditions**: Light intensity, temperature, and nutrients all influence synthesis
