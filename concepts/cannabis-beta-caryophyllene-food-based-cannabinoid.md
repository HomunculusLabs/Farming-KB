...
- May enhance sexual interest and function
...
Documented medicinal properties include improved fat and sugar metabolism, possible treatment for high blood pressure, antioxidant properties, broad-spectrum antibiotic activity, and ability to cure mite infestation in animals.

**Rosemary (Rosmarinus officinalis) — 1–8%**
Medicinal uses supported by scientific studies:
- Antimicrobial (bacteria, fungi)
- Treatment of dyspepsia (digestive complaints)
- Promotion of circulation
- Radioprotective properties
- Possible prevention of skin cancer and other tumors
...
- Effective treatment for chronic anal fissures (as a cream)

## Mechanism of Action

(E)-β-Caryophyllene acts as a selective CB2 receptor agonist. CB2 receptors are primarily found in:
- Immune cells throughout the body
- The spleen
- Tonsils
- Peripheral tissues

Unlike CB1 receptors (concentrated in the brain and central nervous system), CB2 activation does not produce psychoactive effects. Instead, CB2 engagement modulates:
- **Inflammatory responses** — reducing excessive inflammation
- **Immune cell activity** — calming overactive immune responses
- **Oxidative stress** — providing cellular protection
- **Pain signaling** — particularly inflammatory pain

This selectivity makes (E)-β-BCP ideal for chronic, daily use as part of a dietary approach to health maintenance.

## Integration with Cannabis Therapy

For patients using medical cannabis, dietary (E)-β-caryophyllene can serve as a complementary CB2 activator. While cannabis provides both CB1 and CB2 stimulation through THC and CBD, adding spice-derived (E)-β-BCP to the diet may provide additional CB2 support without increasing psychoactive load.

This is particularly relevant for patients who:
- Use high-THC strains (primarily CB1-active) and need more CB2 balance
- Experience inflammation-related conditions where additional CB2 activation could help
- Are between cannabis doses and want to maintain CB2 engagement

## Practical Application

To incorporate (E)-β-caryophyllene into a therapeutic diet:
- Use black pepper generously on food (7–19% (E)-β-BCP)
- Add cinnamon to morning meals or beverages
- Include rosemary in cooking, especially roasted vegetables and meats
- Use cloves in teas, stews, and baked goods
- Incorporate basil and oregano into regular meal preparation
- Consider Indian bay-leaf in rice dishes and curries

## Safety Profile

All the spices listed have FDA approval and long histories of culinary use. Unlike cannabis, (E)-β-caryophyllene from dietary sources carries no legal restrictions and no psychoactive effects. The primary consideration is using high-quality, organic spices to avoid pesticide contamination that could undermine the therapeutic benefits.

## Key Research References

- Gertsch, J. et al. (2008). Beta-caryophyllene is a dietary cannabinoid. Proceedings of the National Academy of Sciences.
- Gertsch, J. et al. (2012). Antinociceptive effects of the beta-caryophyllene in inflammatory and neuropathic pain.
- Blesching, U. (2015). The Cannabis Health Index. North Atlantic Books. Chapter I: The Evidence-Based Science of Medical Cannabis.
