...
### Long-Day Crops (manipulated with supplemental lighting to induce flowering)
- **Irises** — Winter forcing for cut flower markets
- **Barley** — Geographic adaptation and yield optimization
- **Spinach and lettuce** — Bolting prevention in warm conditions
- **Cannabis** — Flowering initiation control (widely used in indoor
  cultivation, where a switch from 18/6 to 12/12 light cycle triggers flowering)
