...
This gene cluster has been identified in multiple distantly related fungal genera, suggesting either convergent evolution or horizontal gene transfer. The enzymes use S-adenosyl methionine (SAM) as a cofactor for both phosphorylation and methylation steps.
...
Psilocin is far less stable than psilocybin due to its free phenolic hydroxyl group:

- Oxidizes readily in the presence of air and light
- Highly sensitive to temperature and pH
- In dried mushroom material, psilocin levels decline faster than psilocybin
- Fresh mushrooms contain a higher psilocin:psilocybin ratio than dried material

### Moisture Effects

Moisture is the primary enemy of long-term storage. Water activity above 0.65 enables enzymatic activity and microbial growth. Desiccation below 10% moisture content, combined with airtight storage with desiccant packets, is recommended for maximum shelf life.

## Conversion: Psilocybin to Psilocin

The conversion of psilocybin to psilocin (dephosphorylation) can occur through several mechanisms:
...
- **GC-MS**: Requires derivatization due to the thermal instability of psilocybin; less commonly used
- **NMR**: Used for structural confirmation of isolated compounds
- **Thin-layer chromatography (TLC)**: Simple field-compatible method for semi-quantitative screening

## Potency Variation

Psilocybin content varies significantly based on species, strain, growing conditions, harvest timing, and post-harvest handling:

- **P. azurescens**: Up to 1.8% total alkaloids (dry weight) — among the highest recorded
- **P. semilanceata**: Typically 0.5-1.5% — highly potent for its small size
- **P. cyanescens**: 0.5-1.2% — consistently potent
- **P. cubensis**: 0.3-1.0% — moderate, variable depending on strain and conditions
