...
Roots release 10 to 20% of total net fixed carbon as low-molecular-weight
compounds, creating the rhizosphere -- an environment enriched in diverse
microbial populations. When mycorrhizal fungi are present, their hyphae
release substantial amounts of plant-derived carbon to the soil, creating the
mycorrhizosphere (Foster and Marks 1967). This zone extends the area of
microbial enrichment well beyond the root surface and leads to the selection
of distinct microbial communities that can improve plant fitness.

## Diversity of Mycorrhizosphere Bacteria
