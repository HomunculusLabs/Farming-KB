---
title: Cover Crops and Soil Health — Teaming with Microbes
created: 2026-04-23
updated: 2026-04-23
type: concept
...
While Lowenfels and Lewis do not devote a standalone chapter to cover crops, the principles throughout *Teaming with Microbes* directly support the practice. Cover crops align with [[teaming-with-microbes-bacterial-vs-fungal-dominance]] as needed for subsequent crops.

## The succession principle

The book's [[teaming-with-microbes-bacteria-the-smallest-workers]] and [[teaming-with-microbes-protozoa-and-nematodes]] that depend on them decline. The nutrient cycling system breaks down. Cover crops prevent this collapse by maintaining the root-exudate pipeline that feeds the entire web.

## Green mulches as living cover

The book's mulch principles (Rule #6) apply directly to cover crops. Fresh, green organic materials support bacteria. When a cover crop of grasses or legumes is incorporated into soil, it acts as a green [[teaming-with-microbes-soil-ph-and-biology]] for good populations — a consideration when selecting legume cover crops for acidic soils.

When legume cover crops are terminated and decomposed, the nitrogen fixed in their tissues becomes available to subsequent crops through the soil food web's [[teaming-with-microbes-fungi-the-underground-network]] is maintained rather than broken. The longer a root is alive, the longer and more branched the associated mycorrhizal fungi become (Rule #19).

This is especially important for [[teaming-with-microbes-compost-tea-brewing-guide]] to boost microbial diversity
- Plant through the residue using a trowel, dowel, or dibble to make discrete holes

## Protozoa and nutrient cycling

The book emphasizes that having bacteria and fungi without [[teaming-with-microbes-compost-tea-brewing-guide]] to support nutrient cycling organisms
- Keep all fertilizer NPK numbers below 10 to protect fragile soil food web organisms
- Time autumn applications so decomposition occurs before spring planting needs

## Specific Cover Crop Species and Their Effects
...
- **Field peas (Pisum sativum subsp. arvense)**: A cool-season legume that fixes nitrogen effectively and can be planted in early spring or late summer. Their moderate root system supports mycorrhizal connections and bacterial communities

## Termination Methods and Their Soil Food Web Effects

How a cover crop is terminated significantly affects the soil biology it leaves behind:
...
## Integration with the three tools

Cover crops complement the book's three soil food web tools:
- **[[teaming-with-microbes-mulch-and-soil-food-web]]:** Terminated cover crop residue becomes mulch, feeding the next cycle
...
Successful implementation of Cover Crops and Soil Health — Teaming with Microbes requires attention to
