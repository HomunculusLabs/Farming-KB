...
Ingold's methodology was elegantly simple. He collected foam from the surface
of streams, mounted it on microscope slides, and observed the remarkable
array of spore types. The foam concentrated spores released from decaying
leaves in the water, making them easy to collect and study.
...
types identifiable in a single stream sample.

The various shapes of Ingoldian spores are thought to be adaptations for
different dispersal strategies. Tetraradiate spores, for example, may be
more effective at anchoring to substrates in flowing water than simple
ellipsoidal spores. The branched arms increase the probability that at least
one arm will contact a surface as the spore tumbles through the current.

## Tetraradiate Spores and Marine Adaptations

Among the most distinctive Ingoldian spores are those with four radiating
arms, known as tetraradiate or stellate conidia. These remarkable structures
are produced by various aquatic ascomycetes and are particularly common in
marine environments. The four-armed geometry may serve multiple functions:
increasing surface area for nutrient absorption, improving attachment to
substrates, and facilitating orientation in three-dimensional water currents.
...
The succession of fungal species on submerged leaves follows a predictable
