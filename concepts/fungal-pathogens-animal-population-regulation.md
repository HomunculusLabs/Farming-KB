---
title: Fungal Pathogens and Animal Population Regulation
...
### Chytrid Fungal Disease as an Emerging Infectious Disease
...
Reports do not indicate that losses in frog numbers within a population affect the community structure of frogs. However, obtaining this information requires a complete understanding of frog metapopulation dynamics and niche overlap among species — data that is very difficult to obtain.

### Climate Change Concerns

Two compounding concerns exist regarding fungal pathogens and amphibian declines:

1. Potential loss of diversity in tropical ecosystems, which are among the main biomes where public conservation opinion is high
2. Predicted climate change creating warmer, wetter conditions that favor propagation of fungal pathogens, potentially exacerbating the situation
...
Butler and Strazanac (2000) documented the dramatic effect of the fungus Entomophaga maimaiga on populations of the gypsy moth (Lymantria dispar) in Appalachian forests in 1996. This represents a case where an introduced fungal pathogen achieved significant population control of an invasive insect pest.

### Limitations of Current Understanding

While these studies demonstrate dramatic effects of insect fungal pathogens on populations, they do not demonstrate effects on community structure. The question of whether fungal regulation of invertebrate populations can shift vegetation community structure remains open — if grazing pressure is sufficiently reduced to alter plant fitness and competitive relationships, vegetation community trajectories could change, but this linkage has not been directly demonstrated.

## Indirect Effects Through Food Sources
...
The catastrophic effects of chestnut blight, Phytophthora-induced oak decline in Europe, and Eucalyptus decline in Australia affect not only plant communities but also grazing fauna specific to those tree species. When a dominant tree species is eliminated, the animals dependent on it for food and habitat are also affected.

### Potential for Positive Cascading Effects

The use of nematode-trapping fungi and fungi that parasitize plant-pathogenic nematode eggs (Mankau, 1981) may reduce the incidence or severity of plant yield decrease caused by plant-infecting nematodes. This would have knock-on effects to other fauna grazing on other parts of the plant, creating positive cascading effects through the food web.

## Knowledge Gaps

Several important questions remain unanswered:

1. How important are fungi in regulating vertebrate populations beyond amphibians?
2. Do fungi regulate changes in vertebrate community structure?
