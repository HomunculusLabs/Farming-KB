...
takes progressively longer to reach harvestable size. The curve
...
possible to construct accurate planting calendars.
...
example, to plan a March 15 harvest of a crop in a cold greenhouse,
...
arrive at a planting date of November 17.

Growers at latitudes different from Coleman's 44 degrees north
should adjust their expected days to harvest based on the ratio
between day length at their latitude and his. Days to harvest will
be longer at higher latitudes and shorter at lower ones. The
National Weather Service offers instant day-length calculations for
any location through their online tools.

## Sunlight Versus Temperature
...
about insufficient sunlight for winter salad production. They were
...
October. After that date, seeds will still germinate but seedlings
grow very slowly and simply wait for the return of longer days.
Those sown earliest mature first as the season progresses. This
staggered maturity means that a careful planting schedule in late
summer and early fall provides continuous harvest through winter.
...
meaning the Persephone period barely exists. At 45 degrees north
(Portland, Minneapolis, the Loire Valley), the shortest day is
about 8 hours and 45 minutes, giving a six-week Persephone period.

At 60 degrees north (southern Alaska, Helsinki), the shortest day
