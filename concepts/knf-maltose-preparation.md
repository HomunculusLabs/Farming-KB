...
- Provides enzyme-rich sugar source for fermentations
- Rapidly decomposes rice straw in paddy fields via enzyme action
- Helps build soil foundation
- Treats seedling problems: damping-off, root rot, soft rot
- Helps crops recover from physiological/environmental damage (high or low temperatures)
- Used for seedling treatment in early growth stages
- Treats livestock dyspepsia and appetite loss
...
### Materials
- Hulled barley (or sweet potato, potato, taro as substitutes)
- Thin cloth
- Water
- Rice (hard-cooked, 2-3 bowls)
- Sieve

### Process

**Step 1 — Sprout the barley (1 week)**
1. Put hulled barley in a bowl, cover with cloth
2. Water daily, like growing bean sprouts
3. Wait until barley sprouts reach 1 cm and tips turn light green

**Step 2 — Dry and process**
4. Dry the sprouted barley
5. Pound the dried barley coarsely

**Step 3 — Extract maltose**
6. Pour water over pounded barley, rub and soak
7. Save the suspension (liquid) after soaking
8. Add suspension to 2-3 bowls of hard-cooked rice
9. Keep warm at 50°C for 5-6 hours (use rice cooker on warm setting)
10. Do NOT keep too long or it turns sour

**Step 4 — Finish**
11. Filter rice through sieve — use liquid only
12. The strained liquid is maltose

### Substitutes
For farming purposes, hulled barley is traditional but not required. Sweet potato, potato, or taro can also produce maltose. The key is the sprouting/enzymatic conversion process that activates amylase enzymes to convert starches into fermentable sugars.
...
| Livestock | Per above | Dyspepsia, appetite recovery |
...
- [[nutritive-cycle-theory]] — growth stage framework for KNF inputs
