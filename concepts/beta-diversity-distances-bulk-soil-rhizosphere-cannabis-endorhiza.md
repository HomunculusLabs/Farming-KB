...
The Winston et al. (2014) [[weighted-vs-unweighted-unifrac-cannabis-strain-microbiome]] distances. These inter-compartment distance comparisons revealed a key pattern: rhizosphere and bulk soil communities are significantly more similar to each other than either is to the [[edaphic-factors-microbial-community-structure]] uninfluenced by direct root interaction. This is the source pool from which rhizosphere and endorhiza communities are drawn.
