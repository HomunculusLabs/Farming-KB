...
- **Neuroinflammation**: CB2 activation on microglia reduces pro-inflammatory
  cytokine release, limiting secondary immune-mediated damage.
...
- **Glutamate modulation**: Riluzole (the only FDA-approved ALS drug) and
  CB1 activation share glutamate excitotoxicity reduction mechanisms.

## Epilepsy

The most dramatic evidence comes from epilepsy:

- **Dravet syndrome**: FDA-approved Epidiolex (CBD) demonstrated significant
  seizure reduction in Dravet and Lennox-Gastaut syndromes.

- **Neuroprotection**: By reducing seizure frequency, CBD prevents
  seizure-induced neuronal damage, especially in developing brains.

## Cross-Cutting Mechanisms

Across all neurological conditions, common neuroprotective themes emerge:

1. **Anti-inflammatory**: CB2-mediated microglial modulation
2. **Antioxidant**: Direct ROS scavenging by CBD
3. **Excitotoxicity reduction**: CB1-mediated glutamate regulation
4. **Anti-apoptotic**: Inhibition of neuronal death pathways
5. **Myelin support**: Promotion of oligodendrocyte function

## Clinical Considerations

The CHI emphasizes that while preclinical data is compelling, clinical
evidence for disease modification in humans remains limited. Most evidence
supports symptom management rather than disease modification. Dosing and
THC-to-CBD ratios should be tailored to specific conditions.
