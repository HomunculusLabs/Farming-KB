...
The soil food web is organized into distinct trophic levels:
...
The "microbial loop" concept describes how nutrients immobilized in
microbial biomass are made available to plants only through predation by
microbial feeders, not through direct mineralization. This means that a
soil with abundant predators tends to have more plant-available nitrogen
than one without.

## Soil Food Web Health Indicators

Healthy soil food webs exhibit:
- **High biomass**: Total microbial biomass (bacteria + fungi) exceeds
  300-500 micrograms per gram of soil.
- **Fungal:bacterial ratio**: Ratios of 1:1 to 10:1 indicate mature,
...
Conventional agricultural practices severely disrupt soil food webs:

- **Tillage**: Physically destroys fungal networks, exposes soil organisms
  to desiccation and UV radiation, and accelerates organic matter oxidation.
