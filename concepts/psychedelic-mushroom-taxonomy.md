...
## Reclassification: Hymenogastraceae

Historically, Psilocybe was placed in the family Strophariaceae (order Agaricales). Molecular phylogenetic studies, particularly those by Moncalvo et al. (2002) and later researchers using multi-gene analyses (ITS, LSU, RPB1, RPB2), revealed that the traditional Strophariaceae was polyphyletic.

Psilocybe and several related genera were reclassified into the family **Hymenogastraceae** (or in some treatments, **Hymenogastraceae sensu lato**). This family also includes genera such as Galerina, Hebeloma, and Inocybe — a finding with significant implications for mushroom foragers, since some of these genera contain deadly toxic species.

### Phylogenetic Placement

Within Agaricales, psilocybin-producing mushrooms do not form a single clade. Psilocybin biosynthesis appears to have evolved independently multiple times, suggesting convergent evolution or horizontal gene transfer of the biosynthetic gene cluster. The core genes involved (psiD, psiH, psiK, psiM) have been identified and characterized.

## Look-Alike Genera

Accurate identification is critical because several non-psychoactive genera resemble Psilocybe species and some contain dangerous toxins.

### Gymnopilus

Gymnopilus is a genus of around 200 species in the family Hymenogastraceae. Several species produce psilocybin, most notably **Gymnopilus spectabilis** (Big Laughing Gym) and **Gymnopilus junonius**. However, many Gymnopilus species are not psychedelic and can cause severe gastrointestinal distress. They are typically large, orange to rusty-brown mushrooms with a partial veil, found growing on dead wood.
...
Key features for distinguishing Psilocybe from look-alikes:

- **Spore print color**: Purple-brown to dark purplish-black (vs. rusty-brown in Gymnopilus, brown in Inocybe, rusty-brown in Galerina)
- **Blueing reaction**: Many Psilocybe species bruise blue where damaged, due to oxidation of psilocin. This is not universal and not exclusive to Psilocybe.
- **Pileus (cap)**: Typically hygrophanous (changing color as moisture content changes), smooth to slightly viscid
- **Lamellae (gills)**: Adnate to adnexed, grayish when young, darkening to purplish-brown with spore maturity
- **Stipe (stem)**: Central, cylindrical, often with a partial veil in some species
- **Habitat**: Dung, enriched soils, grasslands, decaying wood, or wood chips depending on species
...
Many species have restricted ranges, suggesting long evolutionary histories in specific ecological niches. See [[psychedelic-mushroom-chemistry]] for the biochemical basis of their activity and [[mycology-research-methods]] for techniques used in their study.
