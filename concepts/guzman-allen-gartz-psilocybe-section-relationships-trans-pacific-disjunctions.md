...
The taxonomic classification of Psilocybe into sections reveals a series of
remarkable trans-Pacific biogeographic disjunctions. Species placed within the
same taxonomic section are found on opposite sides of the Pacific Ocean — in
...
distribution patterns he identified in Japanese fungi. In the case of
...
(New Guinea, Indonesia, and Australia). The genera exhibiting this pattern
include Cystoagaricus, Galerina, Mycena, Paxillus, and others.

Horak's broader observation strengthens the biogeographic significance of the
Psilocybe disjunctions, suggesting that they are part of a general pattern of
fungal distribution in the [[guzman-allen-gartz-africa-southern-hemisphere-underexplored-neurotropic-fungi]] and South Pacific rather than
an anomaly restricted to a single genus.

## Implications for Ancient Distribution Patterns

The repeated pattern of trans-Pacific disjunctions in Psilocybe, and in
agarics and boletes more broadly, raises important questions about the
historical biogeography of these fungi. Several hypotheses have been proposed
to explain these distributions:

**Gondwanan vicariance**: If the common ancestors of these disjunct species
were distributed across the southern supercontinent of Gondwana prior to its
breakup (beginning approximately 180 million years ago), the current
distributions could reflect ancient vicariance events. Under this model, New
Zealand, South America, and the connections through Antarctica to Australia
would have shared a continuous fungal biota that was subsequently fragmented
by continental drift. The connections between South America and Southeast
Asia (via Antarctica and Australia) are consistent with former Gondwanan
land connections.

**Laurasian distribution**: The North American-East Asian connections
involving P. graveolens, P. muliercula, P. pintonii, P. argentipes, and P.
subcaerulipes may instead reflect ancient Laurasian distributions, where
species were once continuously distributed across the northern hemisphere land
mass and were subsequently separated by the opening of the Pacific or by
climatic changes.

**Multiple dispersal routes**: It is possible that no single explanation
accounts for all observed disjunctions. Different sections and species groups
may have different historical origins, with some reflecting Gondwanan patterns
and others reflecting Laurasian or more recent dispersal events.

## Biogeographic Significance

Regardless of the precise mechanism, the trans-Pacific disjunctions documented
in Psilocybe represent some of the most significant biogeographic patterns in
fungi. They demonstrate that:

1. Current political boundaries and continental configurations are poor
