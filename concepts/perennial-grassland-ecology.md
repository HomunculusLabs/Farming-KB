---
title: Perennial Grassland Ecology
...
- **Mountain meadows**: Called *alps* in Switzerland; often flower-rich and least modified by human activity
- **Continental interiors**: Variously termed prairie, pampas, veldt; greatly modified and now existing primarily as reserves
- **Savannahs**: Scattered tree systems in which grasses may be less numerous than forbs (non-grass plants including bulbs, orchids, succulents, annual or biennial dicotyledons, forage shrubs, and forage trees)
- **Reedbeds and coastal dunes**: Coastal or river fringes and swamps

### Artificial Grasslands

- **Pastures**: Semi-permanent systems relying on approximately 30 grass species plus forage legumes
- **Lawns**: A few species (5-10 common), mainly grass
- **Cereal crops**: Usually monoculture or simple mixed crop systems with a legume component; includes wet padi (rice) as a subset

## Biomass Distribution: Grasslands vs. Forests

A profound and counterintuitive fact about grasslands is their below-ground biomass productivity. While a forest may have a visible standing crop of **207 tonnes/ha**, grasses show only **7 t/ha** above ground. However, below ground the relationship inverts:
...
The critical difference lies in regeneration time:

- **Trees**: Measured in decades. If a forest takes 80 years to regrow from ground level, it "yields" approximately **25 t/ha/year**
- **Grasses**: Measured in seasons or weeks. If grasses can be cut or grazed twice in a season, they yield approximately **10 t/ha/year**

Grasses achieve rapid regeneration because their growth points (buds) develop close to the ground, below the level of cut or browse damage. They maintain approximately **97% of their total biomass** in living roots. Trees, when cut, lose most of their meristems (growth centres) and retain relatively less root reserves — less than 50% of their total mass.
...
Grasslands (herblands) occupy the gradient between forests and deserts:

- **Alpine herblands** lie above the treeline and below barren upper mountain slopes
- **Savannahs** lie between humid rainforest and deserts
- **Riverine or shoreline herbfields** lie between forest and open water

Grasses and herbs can retreat to the buffered atmosphere of the topsoil to escape cold and heat, while trees must stand and endure seasonal changes. Every forest has its characteristic herbland edges, each shaped by local place, soil, and history.
...
Eventually, human societies become dependent on the grasses, the animals that feed on them, and the fire itself. However, people flourish best on the **forest-plain edges**, where they and their associated animals can profit from both herbland and forest.

## Management of Fire in Grasslands

Management of natural grasslands by fire is a skilled task. Too frequent or too hot fires:
- Destroy soil structure
- Tip the balance from perennial bunch grasses and herbaceous species to **fire-loving annuals** (e.g., wild oat) of low nutrient value and poor yields in winter or late summer

Many aboriginal peoples managed their environments specifically to maintain herd species, berry crops, nettle crops, or other aspects of fire-succession ecology beneficial to their food supply or resource base.

## Biodiversity Loss in Modern Grasslands

Originally, grasslands contained many hundreds of plant species. Of the true grasses alone, which number approximately **7,500 species**, we now use only:
- **30-40 species** in pastures
- **Fewer than 20** as grains

We have eliminated almost all the ancestors of our herbs, vegetables, flowers, and root crops to make way for beef and a few grain crops. The Berlin Botanical Garden maintains about one acre of reconstituted European meadow with approximately 80 species of flowers — some now very rare in agricultural environments. That this recreated acre is one of the only areas so rich in native species is described as "a commentary on the sterility of western industrial societies and the chemicalised farm."

## The Burrowing Ecosystem
...
When burrowers are eliminated by plough culture, hoofed animals compact the earth without relief, and many meadow plants lose their primary propagation mechanism.
