...
Get a soil test (ideally in autumn). Apply recommended fertilizer — half plowed in deep, half disked/raked into the upper 7 inches. Once basic fertility is established, it need not be repeated yearly.

## Step 2: Annual Maintenance

Apply balanced fertilizer (N-P-K) in spring, worked into upper 3-5 inches. Common analyses and rates per 1,000 sq ft:

| Analysis | Rate (lbs/1000 sq ft) |
|----------|----------------------|
| 6-24-24 | 17 |
| 8-24-8 | 15 |
| 12-12-12 | 20 |
...
| Crop | Rate (lb/100 ft row) | Timing |
|------|---------------------|--------|
| Asparagus | 2 | Before spring growth |
| Cabbage, cauliflower, broccoli | 1 | 3 weeks after transplanting |
| Cucumber, muskmelon | 1 | 1 week after blossoming + 3 weeks later |
| Onions (mature) | 1 | 1-2 weeks after bulb formation |
| Peas and beans | 1 | After heavy bloom and pod set |
| Peppers, eggplants | 1 | After first fruit sets |
| Spinach, kale, mustard | 1 | When plants are 1/3 grown |
| Sweet corn | 1 | When 8-10 inches tall + 1 week after tassels |
| Tomato | 1 | 2 weeks after first fruit + 2 weeks after picking first + 1 month later |
| Sweet potatoes, watermelons, carrots, beets, turnips, lettuce | None | Excess nitrogen reduces yield/quality |

See also [[soil-testing]] and [[interpreting-soil-test-results]].

## Soil pH Adjustment

Optimal range for most vegetables: pH 6.0-6.8. Potatoes require more acidic soil.

### Lowering pH (Adding Sulfur)

| From | To | Sandy (lb/100 sq ft) | Loamy (lb/100 sq ft) | Clay (lb/100 sq ft) |
|------|----|---------------------|---------------------|-------------------|
| 8.5 | 6.5 | 4 | 5 | 6 |
| 7.5 | 6.5 | 1 | 1.5 | 2 |
| 7.5 | 5.5 | 2 | 3 | 4 |
...
### Raising pH (Adding Limestone to 6.5)

| Initial pH | Sandy (lb/100 sq ft) | Loam (lb/100 sq ft) | Clay (lb/100 sq ft) |
|-----------|---------------------|---------------------|-------------------|
| 4.5 | 28 | 46 | 46 |
| 4.8 | 24 | 37 | 42 |
| 5.2 | 17 | 25 | 34 |
...
Based on 9-inch plow depth, 100% calcium carbonate equivalent limestone.

## Organic Matter Management

- **Target levels**: Sandy soils 2-3% organic matter; clay soils 4-5%
