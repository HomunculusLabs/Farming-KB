---
title: Fungi as Food for Secondary Producers
...
Fungi present a distinctive nutritional profile compared to other food sources. Their protein content ranges widely among species, from approximately 11% in [[tuber-melanosporum]] to as high as 50% in [[agaricus-bisporus]] (when expressed as percentage of dry weight). Fat content is generally low (1–7%), and carbohydrate content is highly variable (21–75%). Compared to nuts, fungi have substantially lower fat content, and compared to meat, they offer comparable protein with different amino acid profiles.

Notable species with high protein content include:
- **Agaricus bisporus** (cultivated mushroom): ~50% protein
- **Boletus edulis** (porcini): ~33% protein
- **Lentinus edodes** (shiitake): ~40% protein
- **Trichoderma flavovirens**: ~25% protein

### Micronutrient Content

Fungi are particularly rich in phosphorus and potassium. In species consumed by red squirrels (Sciurus vulgaris), phosphorus ranges from 0.21% ([[elaphomyces-granulatus]]) to 0.96% ([[pholiota-squarrosa]]), and potassium from 0.6% to 7.9%. Potassium is consistently the most abundant mineral. Sodium content is uniformly low across species (0.02–0.10%), and calcium content is relatively modest.

The high mineral content of fungi compared to surrounding forest floor material makes them nutritionally concentrated food resources. However, fungal cell walls containing chitin and other complex polysaccharides can make much of the nitrogen and other nutrients inaccessible without specialized gut symbionts.

## Vertebrate Consumers

### Small Mammals

Small mammals are among the most significant fungal consumers in forest ecosystems. Fogel and Trappe (1978) documented the percentage contribution of fungi to the annual diet of nine small mammal species in the Pacific Northwest, showing considerable variation among species. The flying squirrel, in particular, derives a very high proportion of its diet from fungi, especially hypogeous (truffle-like) species.
...
Large, flesy mushrooms are heavily colonized by dipteran (fly) larvae. Hanski (1989) reviewed polyphagy in Diptera breeding in Agaricales, finding that fly species commonly utilize multiple fungal genera as food. Russula species supported the highest number of Diptera species (17), followed by Lactarius (14). This polyphagous strategy increases the likelihood that insect larvae will find at least one fungal species fruiting at any given time.
...
The consumption of fungi by animals generates multiple feedback effects on fungal communities and ecosystem processes:

- **Spore dispersal**: Animals, particularly mammals consuming hypogeous fungi, serve as essential dispersal vectors.
- **Competitive mediation**: Selective grazing alters the relative abundance of fungal species, potentially changing decomposition rates and nutrient cycling patterns.
- **Growth form alteration**: Grazing can induce changes in fungal morphology, such as shifts from dense to diffuse mycelial growth.
- **Nutrient mineralization**: Faunal grazing stimulates microbial turnover, generally increasing nutrient mineralization rates compared to systems without fauna.
