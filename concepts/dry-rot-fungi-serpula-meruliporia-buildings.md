...
Both *Serpula* and *Meruliporia* form elaborate mycelial strands — linear aggregates of hyphae that function as exploratory and transport structures:

- **Core**: A "parent" hypha occupies the central axis of the strand.
- **Sheath**: Thinner hyphae grow along the parent in both directions.
- **Consolidation**: The parent produces tendrils that wind around the other hyphae.
- Many fungi form these cables, even in culture plates.
...
Experiments suggest strands begin to develop in response to **nutrient exhaustion** — they are exploratory structures deployed when food is limited.

## *Serpula lacrymans* — The European Dry Rot Fungus

### Biology

- Prefers **cooler temperatures** than many indoor moulds.
- Capable of transporting water over long distances through mycelial strands.
- Produces fleshy fruiting bodies (sporophores) that release vast numbers of spores.

### Geographic Distribution and Outdoor Mystery
...
- Dry rot has "ravaged the British more than any other people" — or at least the British have been most vocal about it.
- Samuel Pepys documented dry rot in the Royal Navy (1690).
- The term "dry rot" is now used in a general sense for any wood-decay fungi in homes.
- **Leviticus 14** in the Bible describes a "plague" on houses (fungal growth on walls) and prescribes removing affected stones and scraping the house — some mycologists suggest this refers to indoor moulds, but the colour and behaviour are more suggestive of dry rot.

## *Meruliporia incrassata* — The Californian Menace

### Biology

- Primary cause of dry rot in California and warmer regions.
- Forms massive rhizomorphs that can extend across building foundations.
- Often grows hidden within wall cavities, making early detection difficult.

### The Glaviano v. Allstate Case
...
- This case established an important precedent for insurance coverage of hidden fungal damage.
...
- *Stachybotrys chartarum* ("toxic black mould") is a warmth-loving mould **absent** in Britain but prevalent in warmer climates.
- It is unrelated to dry rot but often conflated in public discourse about "mould damage."
- The health concerns associated with *Stachybotrys* (mycotoxins, respiratory issues) do not apply to *Serpula* or *Meruliporia*.

## Economic Impact

- Dry rot is one of the most expensive building maintenance problems.
- Treatment requires removal of affected timber, correction of moisture sources, and often extensive structural repair.
- Prevention focuses on controlling moisture and ventilation in buildings.
