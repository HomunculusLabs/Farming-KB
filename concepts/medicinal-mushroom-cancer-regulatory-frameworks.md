...
This means herbal products bypass expensive clinical trials, and since unprocessed products cannot be patented, manufacturers have little financial incentive for medicine registration. This historical framework has shaped the modern regulatory environment for mushroom-based products across much of the world.
...
The US regulatory environment for medicinal mushroom products is primarily governed by the Dietary Supplement Health and Education Act (DSHEA) of 1994:

- **Structure/function claims:** Permitted without FDA pre-approval, but must include the disclaimer "This statement has not been evaluated by the FDA. This product is not intended to diagnose, treat, cure, or prevent any disease."
- **Disease claims prohibited:** Any claim that a product treats, cures, or prevents cancer requires drug approval through the full FDA New Drug Application (NDA) process, including extensive clinical trials
- **GMP compliance:** Dietary supplement manufacturers must comply with Current Good Manufacturing Practices (cGMP) for dietary supplements
- **GRAS status:** Some mushroom-derived ingredients have Generally Recognized as Safe (GRAS) status for use in foods

This framework means that most medicinal mushroom products in the US are marketed as dietary supplements with immune support claims, rather than as cancer therapeutics. The research supporting [[medicinal-mushroom-cancer-chemoprevention]] is typically cited under structure/function claims rather than as approved therapeutic indications.

## European Union: Varying National Approaches

European regulation of mushroom-derived products varies significantly by member state:

- **Traditional Herbal Medicinal Products Directive (THMPD):** Allows registration of herbal medicines based on 30 years of traditional use (15 within the EU), with reduced clinical data requirements
- **Novel Food Regulation:** Some mushroom species and extracts may be classified as novel foods requiring safety assessment before marketing
