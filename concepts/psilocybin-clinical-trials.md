...
### Johns Hopkins and Imperial College Studies
...
- Results from the first Phase III trial (2025) demonstrated statistically significant improvement in depressive symptoms at 25mg dose compared to 1mg control.

## End-of-Life Anxiety and Depression

### Cancer-Related Distress

Psilocybin has shown consistent efficacy in reducing existential distress in patients with life-threatening cancer diagnoses:

- **Grob et al. (2011, UCLA)**: 12 patients with advanced cancer received a moderate dose of psilocybin. Significant reductions in anxiety and improvement in mood at 1- and 3-month follow-up.
- **Ross et al. (2016, NYU)**: 29 patients with cancer-related anxiety and depression received a single dose of psilocybin. At 6.5-month follow-up, 60-80% showed clinically significant reductions in depression and anxiety. Approximately 70% rated the experience as one of the top five most meaningful experiences of their lives.
- **Griffiths et al. (2016, Johns Hopkins)**: 51 patients with cancer diagnosis. Significant decreases in depression (78% response, 83% at 6 months) and anxiety (83% response, 67% at 6 months).

These studies consistently demonstrate rapid, substantial, and sustained improvement in mood and existential distress, often with a single or limited number of administrations.
...
- **Johnson et al. (2014, Johns Hopkins)**: Open-label pilot study of 15 long-term smokers (average 30+ years, 6+ failed quit attempts). 2-3 psilocybin sessions combined with cognitive behavioral therapy. At 6-month follow-up, 80% (12/15) were abstinent. At 12-month follow-up, 67% (10/15) remained abstinent — remarkably high for this population.
- At 2.5-year follow-up (2017), 60% (9/15) remained abstinent, far exceeding typical cessation rates (<35% at 6 months with existing therapies).

### Other Addictions

Preliminary research and ongoing trials are exploring psilocybin for:
...
- **Moreno et al. (2006, University of Arizona)**: Small pilot study of 9 patients with OCD. Moderate doses of psilocybin produced significant but temporary reductions in obsessional thoughts and compulsive behaviors. Duration of effect was limited, suggesting that single sessions may be insufficient for OCD without sustained therapeutic integration.
...
- **Psychological support**: The therapeutic context (preparation, session support, integration) is a critical variable but difficult to standardize
- **Dose optimization**: Optimal dosing protocols are still being established
- **Long-term follow-up**: High dropout rates in long-term studies limit conclusions about durability
...
5. **Follow-up assessments**: Standardized measures at multiple time points (days, weeks, months)

## Safety Profile in Clinical Settings

Across all published trials, psilocybin has demonstrated an excellent safety profile when administered in controlled clinical settings:
...
- **Australia (2023)**: Authorized psilocybin for TRD under the Authorized Prescriber scheme by specially trained psychiatrists
- **USA (2025)**: COMPASS Pathways submitted New Drug Application (NDA) for COMP360 for TRD; FDA decision pending
