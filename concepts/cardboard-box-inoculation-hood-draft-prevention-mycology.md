...
- Spray the interior and work area with disinfectant immediately before
  starting.
- Arrange all tools inside the hood before opening any jars.
- Work swiftly but deliberately — minimize the time jars are open.
- Keep movements inside the hood slow and controlled to avoid generating
  air currents.
- Flame-sterilize needles and scalpels outside the box to avoid igniting
  alcohol fumes inside the enclosed space.

## Comparison with Other Contamination Prevention Methods
