...
Rabbits are among the most space-efficient and productive homestead livestock. They produce lean meat, valuable manure, and fur while requiring minimal space, feed, and infrastructure. Their rapid reproduction cycle makes them ideal for building a sustainable food system quickly.

## Advantages of Rabbit Husbandry

- **Space efficiency** — A breeding trio (1 buck, 2 does) produces 60-100 fryers per year in a 4x8 foot area
- **Feed conversion** — Rabbits convert feed to meat more efficiently than cattle or sheep (3-4 lbs feed per lb of gain)
