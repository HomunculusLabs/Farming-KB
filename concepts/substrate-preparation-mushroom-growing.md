...
In Asia, rice straw can be used as a substrate because it is readily
available in most rural areas. Rice straw generally generates higher yield
and better quality mushrooms, with improved texture and taste compared to
sawdust. However, straw requires more preparation effort and fermentation
for 9 to 12 days before use. Because of its lower cost and local
availability, it may be better suited than sawdust in some areas.
...
4. **Final treatment** - Turn over the pile again, mix with 0.2 percent
   magnesium sulfate, and ferment 3 more days.
5. **Readiness check** - The last turn-over makes straw ready for use.
   Verify moisture is 65 to 75 percent and there is no urea smell. If
   any urea smell remains, ferment further until eliminated.
6. **Bagging** - Pack in size 8 x 12 inch polypropylene bags.

## Sawdust Substrate Recipe

The standard sawdust-based substrate recipe per 100 kg sawdust base:
...
1. **Weigh all components** using a scale for accuracy.
2. **Mix well** all ingredients using a mechanical mixer or manually
   with shovels and paddles.
3. **Add water** to maintain moisture content between 65 and 75 percent.
4. **Verify mixing** - Ensure all ingredients are well mixed with no
   lumps.
...
10. **Create center hole** using a pointed stick inserted almost to the
