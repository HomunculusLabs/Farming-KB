...
6. **Check for pests** -- inspect for mites, flies, ants twice weekly
7. **Harvest** -- collect mushrooms at least twice daily for young, high-quality produce
8. **Marketing** -- sell from farm, village, markets, restaurants, hotels
9. **Keep records** -- track income and expenses to monitor profit
10. **Plan for continuity** -- stagger production for year-round income

## Initial Investment Costs (Thailand, 2000)

| Item | Capacity | Cost (Baht) |
|---|---|---|
| Mushroom house (3m x 4m, ~2 year life) | 2,000 bags | 500-2,000 |
| Mushroom bags (3-month production life) | 1,000 bags | 3,500 |
| **Minimum total investment** | | **4,000-5,500** |

For self-production of bags, additional investment of 400-700 Baht is needed for 200-liter oil drums for pasteurization.

## Sales Outlets

Mushrooms can be sold through multiple channels:

- **Direct from farm** -- requires letting the community know about production
- **Community sales** -- village-level direct sales
- **Local markets** -- fresh produce markets
- **Neighboring markets** -- expanding the sales radius
- **Restaurants and hotels** -- commercial buyers, often at better prices
- **Supermarkets** -- requires quality consistency and packaging

Selling through wholesalers reduces profit margins but saves on marketing expenses and transportation. A good agreement with intermediaries can be beneficial.
