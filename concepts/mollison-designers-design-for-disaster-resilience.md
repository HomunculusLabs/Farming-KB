...
argues that permaculture design should anticipate and mitigate the
effects of natural disasters -- floods, fires, earthquakes, droughts,
and storms -- rather than simply maximizing production under normal
conditions. Resilient systems absorb shocks, recover quickly, and
maintain essential functions during and after disturbance events.

## Flood Design

Flooding is one of the most common and destructive natural disasters.
Mollison's flood-resilient design strategies include:
...
In seismically active regions, permaculture design must address
earthquake risks:
