...
## The Red/Far-Reversible System

Phytochrome exists in two stable, interconvertible forms:

| Form | Absorbs | Peak Wavelength | Biological State |
|------|---------|-----------------|------------------|
| **Pr** (red-absorbing) | Red light (~660 nm) | 660 nm | Inactive |
| **Pfr** (far-red-absorbing) | Far-red light (~730 nm) | 730 nm | Biologically active |

- **Red light** (660 nm) converts Pr → Pfr (activating the pigment).
- **Far-red light** (730 nm) converts Pfr → Pr (deactivating the pigment).
- In natural sunlight, the ratio of red to far-red is approximately 1.2:1, so Pfr accumulates during the day.
- In shade or under a canopy, far-red light is enriched (due to chlorophyll absorption of red), shifting the balance toward Pr — a signal that the plant is being shaded.

The photoreversibility is remarkably robust. Even after hundreds of alternating red and far-red flashes, the last flash always determines the biological outcome. It is, in essence, a biological toggle switch — one of the cleanest molecular switches found anywhere in biology.

The phytochrome molecule itself is a **chromoprotein**: a protein covalently bonded to a light-absorbing pigment called a **phytochromobilin**, which is structurally similar to the bilin pigments found in animal eyes (though plants and animals evolved light-sensing independently). When the chromophore absorbs a photon of the appropriate wavelength, it undergoes a conformational change that alters the protein's shape and thus its biochemical activity. This change in protein conformation is the molecular basis for the Pr/Pfr switch.

---

## What Plants Actually Measure: Continuous Darkness

Despite the common terminology of "day length" or "photoperiod," phytochrome-mediated responses are really about measuring the **length of continuous darkness**. During daylight, Pfr accumulates. After sunset, Pfr slowly reverts to Pr through a thermal (dark) reversion process, or is actively degraded. The plant's [[chrysanthemum-coronarium]] then tracks how long Pfr levels have been low — i.e., how long the night has been. If the dark period exceeds a critical threshold, specific physiological responses (like flowering) are triggered. This is why interrupting the night with a brief flash of red light resets the "darkness counter" — it converts the remaining Pr back to Pfr, and the plant behaves as if the night never happened.
...
## The Maryland Mammoth Tobacco Experiments (1918)

The foundations of photoperiodism predate the discovery of phytochrome by decades. In 1918, **Wightman Garner** and **Harriet Allard**, working at the USDA's Arlington Experimental Farm in Virginia, stumbled upon one of the most important findings in plant biology almost by accident. They noticed that a strain of tobacco called **Maryland Mammoth** would grow vegetatively throughout the summer without flowering, only blooming when brought into the greenhouse in winter. Through careful experiments, they determined that Maryland Mammoth was a short-day plant — it required days shorter than about 12 hours to flower. Under natural summer conditions, the long days prevented flowering indefinitely. This discovery, published in 1920, established the concept of photoperiodism and set the stage for all subsequent research into how plants measure time. Garner and Allard's work was remarkable in its simplicity and elegance — they grew plants in dark chambers and manually controlled the hours of light exposure, demonstrating that it was the duration of light (or, more precisely, darkness) that controlled flowering, not temperature, nutrition, or any other factor.

---

## Where Phytochrome Lives: Leaves, Not Shoot Tips
...
Phytochrome interacts intimately with the plant's **circadian clock**. The circadian clock provides an internal timing mechanism that oscillates with a roughly 24-hour period, and phytochrome signals help entrain (synchronize) this clock to the external light/dark cycle. The clock, in turn, gates phytochrome responses so that the plant's sensitivity to light changes throughout the day. This interaction ensures that light signals are interpreted in their proper temporal context — a red flash at dawn does not mean the same thing as a red flash at midnight.

Importantly, the circadian clock persists even in constant darkness, which is how scientists know it is truly endogenous. Phytochrome's role is to provide the daily "reset" signal that keeps the clock aligned with the solar cycle. Without this entrainment, the clock would drift — a phenomenon easily observed when plants are transferred to constant conditions in the laboratory. The interplay between phytochrome and the circadian system is central to virtually every time-dependent process in plants, from leaf movement to stomatal opening to the timing of metabolic pathways.
