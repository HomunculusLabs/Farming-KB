---
title: Endomycorrhizal (Arbuscular) Fungi — Collection and Identification
created: 2026-04-14
updated: 2026-04-14
type: concept
tags: [[mycology]], fungi]
...
### Soil Processing: Wet-Sieving and Centrifugation

The standard protocol for extracting AM fungal spores from soil:

1. **Wet-sieving** — Pass soil suspension through a series of nested sieves (typically 710 μm, 250 μm, 50 μm, and 20 μm mesh sizes) to separate spores by size
2. **Sucrose-density gradient centrifugation** — Resuspend sieved material in a 60–70% sucrose solution and centrifuge; spores float to the surface while denser soil particles sink
3. **Rinsing** — Carefully decant and rinse spores to remove sucrose

### Spore Counting

Two primary approaches:

- **Gridded Petri dishes** — Spores are counted under a stereomicroscope on dishes marked with a grid for systematic scanning
- **Buchner funnel filter paper** — Spores are collected on filter paper in a Buchner funnel apparatus and counted under magnification
...
3. Wall structure analysis under compound microscopy
