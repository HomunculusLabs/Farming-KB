...
with some K. fragilis strains showing metabolic shifts during aerated
cultures ranging from oxidation to mixed oxidation-fermentation.

## SCP from Oil Manufacturing Wastewater

Yeast strains isolated from decomposing oils assimilate 0.30 to 0.75 kg
of hexane extract per kilogram of yeast per day. Candida rugosa achieves
significant single-cell protein production from diesel oil as sole carbon
source, demonstrating the versatility of fungal SCP production across
wastewater types.

## Nutritional Quality and Safety

The amino acid profile of fungal SCP exceeds the FAO reference protein
...
- Digestibility of Aspergillus awamori biomass from Shochu distillery
  ...
  heating at 100 degrees Celsius for 20 minutes
- Organically bound selenium yeast production reaches 3200 micrograms
  per gram of dry biomass using adapted strains
- Higher yield and composition of A. awamori biomass within 24 hours
