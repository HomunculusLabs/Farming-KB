---
title: Oner Bruce Banner Genetics Cultivation Strain Profile
...
The five phenotypes identified by Green Dream Health Services each express different combinations of the parent traits:

- **Bruce 1**: Leans toward Strawberry Diesel with more elongated bud structure and sweeter aroma profile
- **Bruce 2**: A more balanced expression with moderate density and mixed terpene profile
- **Bruce 3**: The breeders' selection as the ideal phenotype, showing the most even blend of both parents
- **Bruce 4**: Expresses more Ghost OG influence with denser buds and heavier body effects
- **Bruce 5**: The most indica-leaning phenotype with the most physical relaxation and shortest stature

For growers seeking the classic Bruce Banner experience described in strain guides, the Bruce 3 phenotype represents the standard. However, all five phenotypes tested with high THC content according to Oner's account, making any selection from this cross a potent option.
...
- Resistance to common pests and mold, making it relatively forgiving for growers
