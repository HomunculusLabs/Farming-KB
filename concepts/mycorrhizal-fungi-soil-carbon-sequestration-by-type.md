...
- **Litter quality**: ERM host plants produce extremely recalcitrant litter rich in polyphenolic compounds, low-molecular-weight phenolics, and aliphatic acids that are fungistatic and fungitoxic. This litter has very high C:N ratios (often exceeding 100:1) and decomposes extremely slowly
...
- **Carbon allocation**: 10-30% of net photosynthate passes into EM fungi in many forest ecosystems. Given the greater productivity of boreal forests compared to Arctic heathlands, total EM carbon inputs are much larger
...
- **Chemical exudates**: EM fungi secrete oxalic and citric acids that form calcium oxalate crystals coating hyphae and rhizomorphs. These contribute to persistent low-molecular-weight organic compounds in forest soils
- **Defense against decomposition**: EM mycelia are better defended against fungal-feeding microarthropods than saprotrophs, due to melanin, polyphenolic compounds, and in some cases toxins that kill and predate fungivores. Mycorrhizal colonization reduced root decomposition rates by 30% in one study
...
AM fungi associate with most herbaceous plants, grasses, and many tropical trees, and dominate in agricultural and temperate grassland ecosystems:
...
Across major biome types, mycorrhizal type correlates with predictable carbon cycling patterns:

| Biome | Mycorrhiza Type | Root+Mycorrhiza as % of Soil Respiration | Litter Decomposition Rate |
|-------|----------------|----------------------------------------|--------------------------|
| Tundra | ERM | Very high (70-90%) | Very slow |
| Boreal forest | EM | High (60-80%) | Slow |
| Temperate coniferous | EM | Moderate-high (50-70%) | Moderate-slow |
| Temperate deciduous | EM/AM | Moderate (40-60%) | Moderate |
| Temperate grassland | AM | Lower (30-50%) | Faster |
| Crops | AM | Lower (20-40%) | Fast |

This gradient reflects both the litter quality of dominant plant species (high C:N, polyphenol-rich litter under EM/ERM vs. low C:N, nutrient-rich litter under AM) and the direct effects of mycorrhizal fungi on decomposition processes.

## The Nutrient Competition Mechanism

A key mechanism by which mycorrhizal fungi (especially EM and ERM) promote carbon sequestration is through competition with saprotrophic decomposer fungi:

1. Both mycorrhizal and saprotrophic fungi require mineral nitrogen and phosphorus
2. In nitrogen-limited boreal and heathland soils, these nutrients are the primary factor limiting decomposition
3. Mycorrhizal fungi receive a continuous supply of carbohydrates from host plants, giving them a massive competitive advantage over saprotrophs in acquiring limiting nutrients
4. When mycorrhizal fungi extract nitrogen from decomposing litter, they leave behind organic residues with even higher C:N ratios
5. These increasingly nutrient-poor residues become increasingly difficult for saprotrophs to decompose
6. The result is a positive feedback loop: more mycorrhizal activity leads to slower decomposition, which leads to more carbon accumulation, which supports more mycorrhizal biomass

This mechanism effectively means that mycorrhizal fungi can "lock up" carbon by removing the nutrients that decomposer organisms need to access it.
...
- **Vegetation shift effects**: Converting boreal forests to AM-dominated ecosystems (through forestry practices, fire regime changes, or climate-driv [[fungi-in-the-environment-fungal-endophytes-plant-communities]] lthy, photosynthetically active plant communities are the foundation of mycorrhizal carbon sequestration

## Related Topics

- myc [[fungi-in-the-environment-mycorrhizal-carbon-cycle-soil-carbon-pools]] gi types and plant associations
