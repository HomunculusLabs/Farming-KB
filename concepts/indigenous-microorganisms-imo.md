...
**What**: Collect microbes from a healthy, undisturbed forest floor.

**Materials**:
- Wooden box (12" x 8" x 3") — made of natural wood, bamboo, or cedar (no plastic)
- Hard-cooked rice (less moisture to collect aerobic microbes)
- White porous paper (no newspaper — newspaper ink is toxic)
- Rubber band or string
- Container box/basket made of bamboo (protects from animals)

**Method 1 — Native Forest Soil Collection**:
...
8. Leave for 3-7 days depending on temperature:
   - At 20C: 5-6 days
   - At 30-35C: 2-3 days
...
4. Fill the bamboo cavity with boiled rice (low moisture), level higher than the edge
...
**Key principles from Carandang**: Bamboo attracts powerful beneficial microorganisms because bamboo roots exude sugary substances. You can also trap plant-specific microorganisms by inverting a cooked rice container over cut stems of the specific plant you want to grow.

### Stage 2: IMO-2 (Cultivation)

**What**: Multiply the collected microbes with a sugar source.

**Materials**:
- IMO-1 (rice with microbes)
- Jaggery / brown sugar (equal weight to IMO-1 rice, 1:1 ratio)
- Glass jar or clay pot (not metal, not plastic)

**Process**:
1. Mix IMO-1 rice with equal weight of jaggery/brown sugar in container
2. The closer the sugar is to its natural state, the better — crude/unrefined sugar (jaggery) is best; brown sugar is acceptable; **white refined sugar is not recommended** (chemically bleached)
3. Fill container 2/3 full (leaves room for expansion and air)
4. Cover with porous paper and rubber band — must breathe
5. Store in cool, dark place
6. Ferment 3-5 days (summer) or 5-7 days (winter)
7. Liquid should accumulate at bottom — this is IMO-2

**Alternative from Carandang**: Add 1/3 amount of crude sugar or molasses (by weight) to the infected cooked rice. After a week, the concoction looks like sticky, liquidy rice. Add equal amount of crude sugar/molasses for storage. Dilute 1:20 with water for basic use.

**Signs of success**: Sweet, fermented smell. No rotting or putrid odor. Liquid should be golden-amber colored.
...
**Process**:
1. Dilute IMO-2 with water at 1:1000 ratio
2. Mix with rice bran until moisture reaches 65-70% (ball test: lumps when pressed, divides when twisted)
3. Pile on soil floor (NOT concrete), max 30-40 cm high
4. Cover with paddy straw to keep temperature below 50C
