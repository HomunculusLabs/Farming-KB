...
- **Pinning** (~2 weeks): After birthing into the terrarium, small primordia appear. This
  phase is sensitive to humidity and temperature fluctuations.
- **Fruiting cycle** (~2 weeks): Pins develop into mature mushrooms over 5–14 days. The
  first flush typically yields the most.
- **Total time**: Approximately **4–6 weeks** from inoculation to first harvest.

Multiple flushes are possible, though each subsequent flush typically yields fewer mushrooms.

## Desiccant Drying Method

### Recommended Desiccants
- **Drierite** (anhydrous calcium sulfate) — excellent absorption, can be recharged by
  heating.
- **Silica gel** — widely available, effective, often with color-changing indicator beads.
- **Damp Gone** — commercial moisture absorber, convenient.
