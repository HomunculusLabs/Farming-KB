...
The occurrence and decomposition of a mushroom pre-determines the nature
...
Human activities generate debris fields on a scale that dwarfs natural
catastrophes. Clear-cutting forests, constructing cities, and generating
industrial waste all stress the fungal recycling systems of nature. Many
inventions of modern chemistry proved to be bitter fruits of science,
levying a heavy toll on the biosphere.
...
benefits are repressed, perceived need for artificial fertilizers increases,
creating a cycle of chemical dependence that erodes sustainability.

## Harnessing Fungal Succession for Restoration

The same responsiveness of fungi to debris can be harnessed for ecological
restoration. By introducing selected mushroom species to damaged landscapes,
it is possible to accelerate decomposition and jump-start soil recovery.
We can create mycologically sustainable environments by introducing
plant-partnering fungi in combination with mulching with saprophytic
mushroom mycelia. Mycofilters of select mushroom species can be
constructed to destroy toxic waste and prevent disease. In the near
future, we can orchestrate selected mushroom species to manage species
successions and restore devastated landscapes.

## The Fungi to Plant Ratio

Fungi outnumber plants at a ratio of at least six to one. Only about ten
percent of fungi produce visible mushrooms, and only ten percent of those
have been identified. Our taxonomic knowledge is exceeded by our ignorance
by at least one order of magnitude. The surprising diversity of fungi speaks
to the complexity needed for a healthy environment. Our bodies and our
environs are habitats with immune systems; fungi are a common bridge
between the two.

## The Mycelial Recycling Loop
