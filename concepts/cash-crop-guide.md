---
title: Cash Crop Guide for Small Farms
created: 2026-04-19
updated: 2026-04-19
type: concept
tags: [reference]
sources: [papers/the-ultimate-guide-to-natural-farming-and-sustainable-living.md]
---
...
- **Low bulk**: Reduces transportation and storage costs (e.g., honey, berries, herbs)
- **Easy processing**: Minimal equipment needed
- **Value-added potential**: Raw materials processed into higher-value products (jam, butter, dried fruit, smoked meat)
- **Non-perishable backup**: A second cash crop that stores well for year-round sales (firewood, nuts)
- **Polyculture compatibility**: Crops that work together in a diverse growing system
...
- **Cutting**: Cut clovers with scythe or mower just as they begin to blossom
- **Drying**: Let hay dry in the field for ~2 days (unless hot and windy)
- **Testing**: Take a 2-inch bunch and twist — it should break on the third twist when dry enough
- **Collection**: Rake into windrows, load with pitchfork onto hay wagon, take to barn
- **Critical**: Rain destroys hay — plan cutting around weather forecasts

## Egg Sales

- **Minimum for profit**: ~100 free-range chickens to make meaningful income
- **Annual production**: Up to 300 eggs per hen = ~3,000 eggs total
- **Pricing**: A few dollars per dozen (rural) to slightly more (suburban)
- **Profitability**: Only possible with free-range — otherwise feed costs consume revenue
- **Legal requirements**: Check local laws — usually eggs must be clean, graded (above certain quantities), and refrigerated
...
- **Pricing**: ~$300–500 per season per share
- **Start small**: Begin with a few families — ensure overflowing, high-quality boxes
- **Quality over quantity**: Better to impress with abundance than underdeliver
- **Customer satisfaction**: If a customer isn't happy, do whatever it takes to make it right
- **Extras**: Include surprise bonus items for good measure
