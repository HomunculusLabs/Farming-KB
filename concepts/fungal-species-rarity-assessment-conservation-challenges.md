...
Herbaria play a critical role in fungal conservation by:

- Documenting the historical occurrence of species at specific
  localities
- Providing baseline data against which population changes can be
  measured
- Housing voucher specimens that authenticate species identifications
- Maintaining collections that may contain DNA suitable for molecular
  analyses
- Serving as repositories for specimens collected during biodiversity
  surveys
...
- PCR-amplified DNA from environmental samples can detect species
  that do not fruit
- Molecular analyses of ectomycorrhizal roots have shown that
  substantial numbers of species present on host roots rarely fruit
- Low correlation between above-ground sporocarp surveys and
  below-ground molecular detection has been reported for
