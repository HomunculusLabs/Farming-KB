---
title: Mechanical Soil Conditioning
...
3. Seed can be **dropped in thin furrows** — beans or corn seeded this way grow through existing grass
4. **No fertiliser or top-dressing is needed** — only the beneficial effect of entrapped air and subsequent biological activity
...
- A **23 cm (9 inch) blanket of aerated, living soil**

### Direct Cropping

If tree seed, soybeans, millet, or other crops are to be planted:

1. After a few hard grazings or mowings, mount a seed box on the chisel plough frame
2. Place seed in the chisel furrow
3. Follow germination with grazing or mowing
4. New plants (sunflowers, millet, melons) grow faster than shocked pasture
5. Harvest before grasses recover — **never any bare cultivation**
...
- Previously boggy country supports vehicles without sinking after a year
- Drought effects are greatly reduced by soil water storage
- Water filtered through soil and living roots runs clean into dams and rivers
- Trees show greatly increased growth from combined warmth, water, root run, and deep nutrients

## Herringbone Ploughing Pattern

The critical rule for chisel ploughing is to **drive slightly downhill**, creating herringbone patterns:

- **Spines** follow the valleys
- **Ribs** slope outward and downslope
- This pattern prevents fast run-off and absorbs overland flow
- Water is directed to ridges rather than concentrated in valleys

### Depth Guidelines

- **First treatment**: maximum 10 cm
- **Subsequent treatments**: 15-23 cm
- **Plant roots** then penetrate to 30-50 cm in pasture, more in forests
- **Sewage waste-water disposal** (per Yeomans): ripping to 90 cm or 1.5 m with deep-rooted trees

## Timing

Early spring or the end of a gentle rainy period is ideal because:

- Soil is not brought up as dry clods (too dry)
- Soil does not collapse back (too wet)
- Biological activity is beginning to accelerate

## Limitations and Cautions

- **Not beneficial** for coarse-particle soils, cinders, or dunes
- **Stony/boulder soils** are better rehabilitated by organic (root penetration) methods
...
For small gardens, aeration is achieved without machinery:

- **Garden fork method**: Drive in a fork and lever gently, then remove
- **Sheet mulch method**: Apply thick surface sheet mulch and let worms do the work

## Key Principles

1. **Never invert the soil** — open it without turning
2. **One treatment is sufficient** if followed by permanent vegetation
3. **Always plough downhill** in herringbone patterns from valleys to ridges
4. **Timing matters** — work when soil is moist but not saturated
5. **Biological processes complete the work** — conditioning initiates, life sustains
