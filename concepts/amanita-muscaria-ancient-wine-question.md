...
1. Ancient peoples discover that grape juice + Amanita muscaria = intoxicating beverage (sacred wine)
2. They observe that grape juice left alone also produces a (different) intoxicating effect (alcoholic fermentation)
3. Both are called "wine" and the preparation methods are conflated over time
4. The dilution practice from the mushroom version is retained for the alcoholic version, even though it no longer serves its original purpose
