...
domain: mycology
tags: [microwave-sterilization, aseptic-transfer, nasa, closed-system, contamination-control, eclss]
created: 2026-05-11
---
...
developed at NASA's Lyndon B. Johnson Space Center for aseptic sampling and
material transfer into and out of biologically sensitive closed systems.
The MSAP was designed to solve the problem of reliably sterilising mating
fixtures on Environmental Control and Life Support System (ECLSS) water
loops and spaceflight experiment containers. Traditional sterilisation
methods (autoclaving, gamma irradiation, chemical disinfection) either
impose excessive thermal stress on adjacent components, introduce chemical
contaminants, or cannot effectively sterilise complex surface geometries.
The MSAP uses microwave energy to sterilise all mating surfaces before and
after each transfer operation, overcoming these limitations.

## The Problem of Aseptic Access

Spacecraft water systems and biological experiments require periodic
...
penetrates into surface irregularities via the waveguide design, and
