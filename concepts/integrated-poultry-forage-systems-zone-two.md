...
Chickens with plum and cherry trees sharply reduce crawling and
flying pests. All pests that go into soil and re-emerge are
reduced because chickens eat encysted parasite eggs. Dead animals
can be hung in the chicken run; they convert to larvae that drop
into the pen and are eaten before hatching flies.

## Pest Control Through Chickens

Before planting, chickens and ducks are released to dig out slugs
...
that prepare sites for following forest species.

Existing forest of low-forage species can be adjusted in five-acre
blocks, selecting different vines for different oak trees. These
