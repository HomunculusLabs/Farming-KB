...
into the forest. The significance of this pathogen demonstrates
how parasitic fungi, when unchecked, can radically reshape forest
composition in very short time periods.

## Ecological Value of Parasitic Fungi
...
- Facultative behavior: Many fungi shift between parasitic and
  saprophytic modes depending on host tree health
- Ecosystem indicators: Prominent parasitic infestations often
  signal broader environmental imbalances like acid rain
- Soil deepening: The gradual decomposition of killed trees adds
  measurable soil depth and nutrient complexity over time
- Old-growth dependency: Some parasitic species require the
  specific conditions found only in ancient forest ecosystems
...
- Salvage operations that inoculate killed trees with beneficial
  fungi rather than removing them from the ecosystem
- Research into how parasitic blights select for stronger,
  more disease-resistant tree populations
- Conservation of old-growth habitat to protect specialized
