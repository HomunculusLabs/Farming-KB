...
## How Pigs Fit into a Permaculture System
...
Pigs are effective in a rotational land-clearing system:

1. **Year 1**: 20 pigs per acre clear the land (remove blackberries and scrub)
2. **Year 2**: Remove pigs, replant the area, introduce cattle to graze
3. **Year 3**: Replant, then let pigs return

This cycle keeps the land productive without mechanical clearing.
...
Plants can be grown specifically as pig forage:
- **Cattail**
- **Legumes**
- **Chicory**
- **Comfrey**
...
- **Daily consumption**: Up to 25 pounds (11.3 kg) of food per day per pig
- **Forage-based**: Pigs thrive on diverse forage when available
- **Fattening for bacon**: Feed grain for a couple weeks at the end to fatten if bacon is the goal
- **Healthy pork**: If you do not care about bacon and want leaner pork, forage alone is sufficient
- **Lactating sows**: 7 pounds (3.2 kg) of grain per day at birth, working up to 12 pounds (5.4 kg) when piglets are a few weeks old
- **Sow forage space**: At least 2.5 acres (1 hectare) per sow for herself and her piglets
...
### White Breeds
- **Good mothering instincts**: Excellent for raising their own young
- **Excellent foragers**
- Popular choices: Chester White, Yorkshire, Landrance
- Produce large litters but not always the strongest foragers

### Heritage Breeds
- **Best of both worlds**: Good mothers AND excellent foragers
- Options: British Saddleback, Large Black, Tamworth
