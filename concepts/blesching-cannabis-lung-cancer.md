...
Lung cancer cells contain both CB1 and CB2 receptor sites. The reviewed
experiments revealed that anandamide, THC, and CBN produced anti-lung cancer
activity, ranging from growth inhibition to initiation of apoptosis. CBN has a
higher affinity for CB2, while THC and anandamide bind relatively equally to
both CB1 and CB2. Both sativa and indica strains bind to CB1 and CB2, but
indicas tend to have a lower THC:CBN ratio, which may favor CB2 activation.
