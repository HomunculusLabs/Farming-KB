...
The source provides mineral analysis for tagasaste foliage, showing the importance of mineral content in forage species:

| Mineral | Tagasaste | Lucerne | Rye Grass | Wheat Grain |
|---|---|---|---|---|
| Calcium | 0.48-1.62% | 2.2% | 1.0% | 0.04% |
| Phosphorous | 0.12-0.41% | 0.33% | 0.26% | 0.24% |
| Total Ash | 4-10% | 10% | 10% | 2% |

The high ash (mineral) content of tagasaste (4-10%) compared to wheat grain (2%) demonstrates the mineral-accumulating capacity of deep-rooted perennials.
