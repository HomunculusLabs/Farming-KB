...
McKenna emphasizes that "shamanism is primarily techniques, not ritual." This distinction is crucial.

While shamanic practices may be embedded in elaborate ritual frameworks, the core of shamanism is a set of practical techniques for altering consciousness, exploring non-ordinary states, and navigating the resulting experiences.

These techniques have been developed over millennia through careful empirical observation. The shaman is not merely performing inherited ceremonies but is actively exploring and mapping experiential territory, testing hypotheses about the effects of different plants, doses, and settings.

McKenna notes that in archaic societies where shamanism is a thriving institution, "the signs are fairly easy to recognize: oddness or uniqueness in an individual."

The shaman is identified by their difference from the group, not by their conformity to it.

## The Shaman as Phenomenologist

McKenna describes shamans as "the true phenomenologists of this world." This is a deliberate and philosophically loaded characterization.
...
"They are called on in crisis, and the crisis can be someone dying or ill, a psychological difficulty, a marital quarrel, a theft, or weather that must be predicted."

The crises that call for shamanic intervention span the full range of human experience: physical illness, psychological disturbance, social conflict, ecological uncertainty (weather prediction), and spiritual emergencies.

In each case, the shaman brings the same basic toolkit: the ability to enter non-ordinary states of consciousness, gather information from these states, and translate that information into actionable guidance for the community.

This crisis-oriented function suggests that shamanic knowledge is not theoretical but practical. It is tested and validated through its effectiveness in real-world situations where failure has immediate consequences.

## Signs of Shamanic Calling

McKenna describes the markers that traditional societies use to identify potential shamans:

- Oddness or uniqueness that sets an individual apart from the group
