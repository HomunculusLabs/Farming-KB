...
the initially bound metal subsequently available for transport to the
cell interior.
...
highest uptake levels, exceeding 0.8 mmol per gram or 200 mg per gram
dry weight. Lead is also consistently biosorbed to high levels, while
divalent cations such as cadmium, copper, and zinc typically show
uptake in the 0.1 to 0.5 mmol per gram range.
