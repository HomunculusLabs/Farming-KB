...
## Overview
Chapter 4 of the Designers' Manual introduces pattern understanding as
a foundational design skill. Mollison argues that nature expresses
itself through recurring patterns at every scale, from molecular
structures to landscape forms. Learning to read these patterns allows
designers to place elements where they function most efficiently and
...
details serve the larger system rather than competing with it. A common
mistake is to begin with species selection (fine detail) before
understanding site patterns (coarse scale).

## Reading Landscape Patterns
Site analysis begins with pattern reading. Ridge and valley shapes
reveal water collection and flow paths. Tree canopy form indicates wind
exposure and soil moisture. Vegetation bands across a slope often mark
soil type transitions or moisture gradients. Animal tracks concentrate
along edges and corridors. Designers trained in pattern recognition can
read a landscape quickly, identifying key forces and opportunities
without extensive measurement.

## Edge Effect and Pattern Diversity
The boundary between two systems -- forest and field, land and water,
shade and sun -- is where the greatest diversity and productivity
occur. Mollison emphasises increasing edge through zigzag fences, curved
...
into which detailed designs fit. Mollison stresses that zones and
sectors are pattern templates adapted to local conditions.

## Common Design Patterns
Mollison catalogues frequently used permaculture design patterns: the
herb spiral (compact vertical garden with microclimates), the keyhole
bed (maximised edge with minimal path), the chinampa (raised bed in
water), the mandala garden (circular sector arrangement), and the
