---
title: "Japan japan-narcotics-control-law-psilocybin-fungi-2002 Law and australian-magic-mushroom-common-names Regulation"
aliases: ["Japan magic mushroom law 2002", "Japanese psilocybin regulation", "Narcotics and Psychotropic Control Law Japan fungi"]
...
Chromatographic methods provide more reliable and objective identification.

TLC is the simplest and most accessible method, suitable for rapid screening of seized material in field laboratories.

GC and HPLC offer higher resolution and quantification capability but require more sophisticated instrumentation.

All chromatographic methods require comparison with authenticated reference standards of known purity.

The need for these standards, in quantities sufficient for routine forensic work, was the direct motivation for the Shirota synthesis.

## Scale Requirements for Forensic Standards

Forensic laboratories require standard compounds in multi-gram quantities to support routine analytical work.

Each analytical run consumes a small amount of standard material, but the cumulative demand across many cases and many laboratories is substantial.

Multiple forensic laboratories across Japan needed access to these standards simultaneously after the 2002 regulatory change.

The Shirota synthesis was specifically designed to meet this demand, achieving gram-scale production without chromatographic purification.

The ability to produce psilocin and psilocybin on a gram scale, using simple equipment and readily available reagents, represented a significant advance over previous synthetic routes.
