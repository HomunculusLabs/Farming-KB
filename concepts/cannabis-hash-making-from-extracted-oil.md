...
"Cannabis Alchemy" by D. Gold describes several methods for converting extracted cannabis oil into hashish of varying quality. These methods go beyond traditional [[cannabis-hashish-making-methods]] by using solvent extraction followed by reconstitution onto plant material.

## The Iso-Hash Method ("Texas Super Hash")

Contributed by a correspondent identified as "Tex" from Austin, this method produces what was called "2-on-1 Hash" -- one ounce of hash from two ounces of extracted oil reconstituted onto one ounce of ground cannabis.

### Procedure

1. **Pre-dry**: Take three ounces of commercial cannabis, spread 1/4 inch thick on a cookie sheet, place in a preheated 250F oven (then turned off) for 15 minutes. Crumble when dry.

2. **First batch**: Take 3/4 ounce (21g) of dried weed, add to blender with 4 ounces of isopropyl alcohol. Run at highest speed for 5 minutes, reducing cannabis to very fine particles. Pour directly into the reaction vessel.

3. **Second batch**: Place remaining 2.25 ounces of weed in blender with 8 ounces of alcohol. Blend at high speed for 10 minutes.

4. **Set up soxhlet**: Fit a large chemist-type coffee filter into the soxhlet basket. Pour the second batch into the basket over the reaction vessel (which already contains the first batch).

5. **Extract**: Run the apparatus for approximately 2 hours. Finely ground material extracts much faster.

6. **Isomerize**: Add 15 drops of concentrated activator (acid catalyst) solution to initiate [[neem-oil-cannabis]] of CBD to THC. Leave soxhlet basket in place to wash residual oil from the 2.25 ounces during isomerization.
