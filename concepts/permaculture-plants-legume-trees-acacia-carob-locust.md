---
title: Permaculture Nitrogen-Fixing Legume Trees - Acacia, Carob, Locust, Tagasaste
created: 2026-04-26
updated: 2026-04-24
sources:
...
### Bee Forage
Produces both nectar and pollen in spring.

## Carob (Ceratonia siliqua)

Family: CAESALPINIACEAE

The largest (to 15 m) of Europe's leguminous trees, native to the Mediterranean region. Grows in minimum rainfall 250 mm but does better with higher rainfalls. Sensitive to cold below -4C when young; mature trees suffer little damage at -8C. Evergreen, spreading crowns to 10 m. Prefers slightly alkaline, sandy soils with good drainage but grows in virtually any soil except compacted clay. Life span 500+ years.

### Pod Production and Uses
Generally dioecious (male and female trees needed). Pod is a fleshy bean up to 300 mm, flavoursome and nutritious: crude protein 2.25-21%; crude fat 0.5-1.5%; total sugars 37.1-56.6%. Pods are excellent stockfeed, commercially sold as chocolate substitute, seed contains industrial gums. Potential for alcohol fuel production.

Yields: up to 1 tonne from a single tree in a good season; about 8 t/ha is typical at 90-100 trees/ha. Tap roots traced to 20 m deep.

### Salt and Fire Tolerance
...
- **Giant (Salvador) type**: Tall forest tree 20+ m, little seed, fastest biomass rate (K8, K28, K67)
