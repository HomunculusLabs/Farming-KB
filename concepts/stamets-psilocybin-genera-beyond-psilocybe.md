...
While the genus Psilocybe contains the majority of known psilocybin-
producing mushrooms, several other genera also harbor psychoactive
species. Paul Stamets identifies Panaeolus, Pluteus, Gymnopilus,
Conocybe, and Inocybe as significant genera containing psilocybin
mushrooms, though the vast majority of species in these genera are not
active. More than half of the species in the genus Psilocybe are
psilocybin producers, making it by far the richest genus.

## Safety Considerations by Genus

### Psilocybe and Panaeolus: Relatively Safe

Psilocybin mushrooms from the genera Psilocybe and Panaeolus are
generally safe to identify, in that there are no known poisonous species
in those two genera. This does not mean that misidentification with toxic
species from other genera is impossible, but the genera themselves
contain no deadly members. This makes them the recommended starting
point for anyone learning to identify psilocybin mushrooms.

### Conocybe and Inocybe: Potentially Dangerous

There are, however, several nasty species in the genera Conocybe and
Inocybe that could be damaging or could kill you. Stamets strongly
recommends that foragers avoid the genera Conocybe and Inocybe until
