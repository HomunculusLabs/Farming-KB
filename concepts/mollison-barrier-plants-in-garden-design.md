---
title: "Barrier Plants in Permaculture Garden Design"
created: 2026-04-26
tags:
  - permaculture
  - garden-design
...
## Reasons for Plant Barriers

There are several reasons to erect barriers of plant species:

- As a block around annual gardens to resist invasive grasses
  (such as kikuyu and buffalo grass, knotweeds, etc.)
- As a corral for animals, or to keep grazing animals out of
  a compound, or to guide animals to a form or corral
- Against hot, dry, or salt-bearing winds on seacoasts, cliffs,
  or exposed sites
- As contoured strips to disperse overland water flow, catch
  silt, and prevent soil erosion

## Garden Barriers Against Weeds

Around annual, mulched gardens laboriously freed of weeds, a
band of grass-barrier plants prevents re-invasion. There are
4-5 forms of plants which are effective, and all can be used
if space permits:
...
ample mulch for the garden, and establish in one season. When
first placed, they need to be mulched, manured, and watered.
...
Corrals or cattle-goat-sheep barriers can be strengthened with
one or two strands of barbed wire, but should have the
potential to resist on their own through thorny or distasteful
shrubs. These can be planted as a hedge, or as a coppice crop
cut and built into a thorn fence (boma). The latter enables
...
reinforcement. All are drought-tolerant and provide additional
products such as fruit or fencing material.

## Wind Barriers on Coasts
...
As contoured strips, barrier plants disperse overland water
flow, catch silt, and prevent erosion of soils. On very steep
slopes, there is often no recourse other than to plant pampas,
bamboo, lemongrass, and root-mat pioneers, and to make upslope
plantings of chestnut, Acacia, carob, or olive which cascade
seed downslope over time. Cross-swales of lemongrass or Vetiver
grass are particularly effective in spreading water across
slopes.

## The Hedge Sequence in Design

In Gangamma's Mandala design, the hedge sequence from inner to
...
Some barrier plants also serve as fire breaks. Green, succulent
species such as comfrey, Atriplex, and ice plant create
fire-resistant borders. The management of leaf litter and
mulch around barrier plantings is important for fire control.
Raking under bamboo and clump canes, and routing leaf mulch
through animal bedding, reduces fuel loads near gardens and
buildings.

## Maintenance and Establishment

When first placed, barrier plants need to be mulched, manured,
and watered. Within one season, most species establish
sufficiently to function as barriers. The same plants that form
barriers also provide mulch, and if initially cared for,
establish rapidly. Ongoing maintenance involves periodic
cutting for mulch, replanting gaps, and ensuring the barrier
remains dense enough to resist invasion.
