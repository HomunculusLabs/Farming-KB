---
title: Sewage Water Reduction and Dry Toilets
...
When using wastewater from kitchen, bathroom, and laundry, it is essential to understand what chemicals are being released to gardens, soils, and waterways. A typical analysis of powdered detergent or soap includes:

- Sodium or potassium salts or polysulphates
- Silicates, sulphates, or bicarbonates
- Borates
- Residual biocides concentrated in animal fats (e.g., DDT, Dieldrin, Hexachlor from dairy cattle)
...
- Use **plain soaps** on crops whenever possible
- Route more complex pollutants to **tree systems** (well-monitored), as woody perennials cope better than garden vegetables and allow more time for decomposition of long-term pollutants
- In critical areas (especially arid or delicate environments), create **special soaps** from unpolluted oils, potash, or sodium
- Plant **special crops** (many water plants) to remove excesses before passing greywater to soils and streams
