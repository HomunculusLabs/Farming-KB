...
Additives provide supplemental nitrogen and minerals, typically used at 2-10% of total substrate mass (maximum 5% recommended to avoid thermogenesis killing mycelium):

- **Rice bran**: The most common supplement for sawdust-based cultivation
- **Wheat bran**: Widely available alternative nitrogen source
- **Oat bran, soybean meal, corn meal**: Additional nitrogen supplements
- **Gypsum (calcium sulfate)**: Prevents grain kernels from clumping, provides calcium and sulfur, acts as pH buffer
- **Calcium carbonate**: Used to raise pH and correct acidity
