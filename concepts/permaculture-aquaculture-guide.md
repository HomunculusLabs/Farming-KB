...
- Protection from contaminant runoff (avoid placing below intensive animal operations without buffer zones)
- Integration with existing swale systems and drainage patterns

### Pond Types

Multiple pond types serve different functions in a permaculture system:
- **Storage ponds** for irrigation reserves
...
Polyculture is the key principle in permaculture aquaculture -- multiple species occupying different ecological niches in the same water body:

### Fish Species

Different species feed at different levels and on different foods:
- **Surface feeders** consume insects and floating plants
...
A healthy pond supports a complete food web:
- Algae and phytoplankton (primary producers)
- Zooplankton (grazers on algae)
- Insects and larvae (larval mosquitoes, dragonflies)
- Small fish (plankton feeders)
- Larger fish (predators)
- Decomposers (bacteria, fungi on the bottom)

Edge plantings are critical -- the transition zone between water and land supports the greatest diversity of species. Reed beds, iris, and other marginal plants filter water and provide habitat.
