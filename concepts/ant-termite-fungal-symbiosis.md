...
Fungus-growing ants (Attini) and fungus-growing termites (Macrotermitinae) represent two of the most remarkable mutualistic symbioses in nature. These insects cultivate specific fungi as food sources, creating sophisticated agricultural systems that rival human agriculture in complexity. The ant-fungus association alone is responsible for an estimated 20% of the photosynthate turnover in the Neotropics.

## Fungus-Growing Ants (Attini)

### Evolution and Diversity

- The fungus-culturing habit was acquired by ants only once in evolutionary time
- All ants able to culture fungi belong to a single tribe (Attini) in the family Myrmicidae
- Associations range from relatively loose (lower attines) to highly specific (higher attines)
- The most complete treatment of the ants is in Holldobler and Wilson (1990)
