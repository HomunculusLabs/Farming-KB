...
## Practical Steps for Attaining Natural Form
...
The proper way to grow a citrus tree having a natural form would be to plant the seed directly in the orchard. Although the seed itself is the product of extensive cross-breeding between different varieties of artificially cultivated citrus trees, and trees grown from seed generally revert or degenerate, planting seed is very helpful in gaining an idea of the natural form.

### Step 3: Corrective Formative Pruning

For transplanted saplings, some pinching back is generally necessary to correct the arrangement of branches. If dieback occurs at the tip or if too much of the root system has been cut, an unnaturally large number of suckers may emerge, causing the branches to become entangled.
