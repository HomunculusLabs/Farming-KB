---
title: Bacteroidetes Strain Differentiation in Cannabis Endorhiza
...
- **Sphingobacteriales**: Present as part of the core [[proteobacteria-dominance-cannabis-endorhiza-community]]
  ...
  facultatively anaerobic, and many species produce sphingolipids in
  their outer membranes.
- **Flavobacteriales**: Also contributed to strain-differentiating OTUs.
  Members of this order are frequently associated with plant surfaces and
  tissues, with some species exhibiting plant growth-promoting properties.
  Flavobacteria are yellow-pigmented, aerobic bacteria common in freshwater
  and soil habitats.

## Strain-Specific OTU Differences

The analysis of significant OTU abundance differences between cannabis
strains revealed that Bacteroidetes, alongside Proteobacteria orders
(Pseudomonadales, Burkholderiales, Sphingomonadales, and Rhizobiales),
accounted for multiple cultivar-differentiating taxa. This is significant
because:

1. It demonstrates that cultivar-specificity in the cannabis endorhiza is
   not driven by a single bacterial group but involves coordinated shifts
   across multiple phyla, creating a distinct microbiome signature for
   each cultivar.
...
- **Polysaccharide degradation**: Sphingobacteriales and Flavobacteriales
  ...
  endorhiza, they may help process root exudates and dead root cell
  material, recycling nutrients for the living plant.
