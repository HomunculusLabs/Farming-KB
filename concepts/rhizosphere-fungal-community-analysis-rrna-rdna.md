---
title: Rhizosphere Fungal Community Analysis Using rRNA and rDNA
created: 2026-04-18
updated: 2026-04-18
type: concept
tags: [reference]
...
Soils and soil-borne microbial communities are among the greatest sources of organismal diversity on Earth. Plant roots and the soil they impact (the rhizosphere) host a great diversity of fungi. This chapter describes a molecular approach to analyzing rhizosphere fungal communities using both rRNA (targeting metabolically active organisms) and rDNA (targeting all organisms present, including dormant) from Andropogon gerardii rhizosphere in a tallgrass prairie ecosystem.
...
- Results may not reflect actual community composition in situ
...
- **Limitation**: rDNA may persist in environmental DNA pools from organisms that are no longer metabolically active -- dormant, inactive, or residual naked DNA is still detectable by PCR
- Higher species richness is expected in rDNA-assayed communities

### rRNA (Transcribed RNA)
- Targets organisms actively transcribing ribosomal RNA at time of sampling
- rRNA is less stable than rDNA in the environment
- Metabolically active organisms maintain higher rRNA numbers and transcribe/process precursors at higher rates
- Provides a view of the active community subset
- Lower species richness expected compared to rDNA

### Key Hypotheses
1. rRNA serves as a convenient target for molecular fungal community analysis
2. Fungal communities inferred from rRNA data include taxa that are a subset of those observed in rDNA-inferred communities

## Method Overview

### Sampling
Rhizosphere tissue collection at Konza Prairie Biological Station (39 degrees 05' N, 96 degrees 35' W), a Long-Term Ecological Research (LTER) site representing tallgrass prairie.

### Equipment
- Liquid nitrogen vapor cryoshipper
- FastPrep instrument for cell lysis
- Microcentrifuge (refrigerated and nonrefrigerated)
- Rotating shaker, micropipettors
- -80 degrees C ultrafreezer
- Thermocycler, NanoDrop spectrophotometer
- Gel electrophoresis apparatus, UV illuminator
