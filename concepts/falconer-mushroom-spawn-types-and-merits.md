...
It is put up in two ways: nicely packed in thin wooden
boxes, each containing two or three pounds of spawn,
...
makers always endeavor to get it to use in spawning the
artificial spawn. It is seldom used for spawning mushroom
beds because not easy to obtain. In using virgin spawn
for spawning beds, larger and heavier mushrooms have
...
apparent should be of a fresh bluish white color, and the
fine threads clear white. Prominent yellowish threads or
