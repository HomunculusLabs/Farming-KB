...
farmers even had the ability to judge nitrogen content by smell and
adjust dosage accordingly. The labeling of smell as "bad" drove
traditional farming practices into disrepute and opened the door for
commercial input manufacturers to capture the market.

## The JADAM Alternative: Water and Leaf Mold

JADAM's method for making all organic farming inputs is radically
simple: prepare a container, add the organic ingredient, fill with
water, and add a handful of leaf mold. That is all. No sugar, no
molasses, no commercial microorganisms, no temperature control, no
aeration, no C/N ratio calculations, no pH monitoring.

The indigenous microorganisms in the leaf mold actively break down
whatever ingredient is placed in the water and turn it into an
excellent liquid fertilizer or microbial culture. The solution costs
nothing. There is minimum nutrient loss. It is easy and simple. Most
importantly, it works.

## Odor Management

If odor is a concern, practical solutions exist that do not compromise
the method:
- Add phyllite powder (1 kg per 500 L) to reduce fumes
- Add charcoal powder to suppress odor
- Add fruit peels to absorb smells
- Place containers away from living areas
- Keep lids tightly sealed

But JADAM encourages farmers to reconsider their relationship with
smell. Smell is not an indicator of quality or safety. A sweet-smelling
input is not necessarily better than a foul-smelling one.

## Temperature Control Myth

Similarly, the insistence on maintaining specific temperatures (such as
32 degrees C) for microbial cultivation is unnecessary. Nature
cultivates microorganisms without any artificial heating. Our ancestors
produced liquid fertilizers without electricity or heaters. The
microorganisms produced at ambient temperatures are actually more suited
to the crop environment than those cultivated at artificially
maintained temperatures. Potatoes boiled and used as medium keep the
solution at pH 6.5, which is best for the soil.

## The Commercial Motivation

JADAM argues that the complexity of modern organic input making is not
driven by science but by commercial interests. Machine manufacturers,
their agents, and "experts" create conditions (temperature control,
aeration, lighting, pH management) that require purchased equipment.
Government subsidies flow to equipment manufacturers, not to farmers.
Farmers become technology-dependent consumers rather than self-sufficient
producers. JADAM's mission is to reverse this dynamic.

## See Also

- [[ultra-low-jadam-liquid-fertilizer-making]] - Sugar-free JLF method
- [[jadam-jms-pesticide]] - Potato-based culturing
