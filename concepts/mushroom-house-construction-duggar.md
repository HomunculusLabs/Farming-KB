---
title: Mushroom House Construction — Double Walls, Beds, and Ventilation (Duggar)
created: 2026-04-21
updated: 2026-04-21
type: concept
...
Source: Benjamin Minge Duggar, *Mushroom Growing* (1915), Chapters on mushroom house construction.

## Mushroom House Design Principles

Duggar's mushroom house design reflects the state of the art in early 20th century commercial mushroom cultivation. The fundamental requirements are: temperature control, moisture management, ventilation, and structural support for growing beds.

## Wall Construction

### Double Wall System
The standard mushroom house features double walls with an insulating air space between them. Key details:

- **Inner and outer walls** separated by an air space for insulation
- **Shavings insulation** — sawdust or wood shavings packed between the wall layers provide thermal insulation against external temperature fluctuations
- **Alternative materials** — hollow tile or concrete construction are viable alternatives to wood frame
- The double-wall design is essential for maintaining the steady temperatures (55-60°F) required for mushroom growing

### Moisture Management
A persistent problem in mushroom houses is condensation ("sweating") on cold walls. Duggar addressed this with:
- **Sloped roof design** — encourages air circulation and prevents moisture dripping onto beds
- **Air space between ceiling and roof** — provides a buffer zone where moisture can accumulate without contacting the growing space
- The roof ventilator system (preferred over wall ventilators) promotes upward air movement that carries excess moisture away
...
### Scantling Support
The traditional bed support uses 2x6 inch scantling (wooden framing members):
- Placed 4 feet apart
...
- **Permanent** — does not rot or decay in the moist mushroom house environment
...
- The investment is higher but justified by longer service life and reduced disease risk
...
- Must allow passage of workers with baskets and tools
- Should permit wheelbarrow access for filling and emptying beds

### Tier Height
- **Bed-to-bed spacing**: 3 feet minimum
- Allows room for mushroom growth, worker access, and air circulation
- More tiers can be added in taller buildings but each requires its own ventilation consideration

### Bed Depth
- **After compression**: 8-10 inches of compost/soil
- Beds settle significantly from initial filling depth
- Deeper beds hold more moisture but may have temperature management challenges
...
Duggar noted that in southern England, open-air mushroom culture was practiced using modified cold frames:
- No glass covers (unlike standard cold frames)
- Sheet iron or boards as covers, with straw insulation on top
- Not considered generally practical for commercial operations
- Demonstrates that mushrooms can be grown without specialized structures if climate permits
