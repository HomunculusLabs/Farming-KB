...
The largest group, comprising fungi that contain psilocybin and related indole
compounds (psilocin, baeocystin, norbaeocystin), or those likely to contain these
substances. This group spans 13 genera with the following species counts:
...
challenges as many species in this group lack reliable chemical studies confirming
the presence of psychoactive compounds. The paper considers 29 species in this
subgroup: Copelandia with 12, Panaeolina with 4, and Panaeolus with 13.
...
Several species commonly confused with neurotropic fungi were explicitly excluded:

- *Psilocybe pseudobullacea* — non-bluing, no confirmed neurotropic properties
- *Psilocybe atrobrunnea* — Høiland's (1978) report likely confused with *P.
  coprinifacies* or *P. maire*
- *Psathyrella sepulchralis* — wrongly confused with *P. zapotecorum*
- *Panaeolus antillarum* — often misidentified as *Copelandia* by users; does
  not turn blue and is considered edible
...
descriptions, and improved chemical analysis.

## Taxonomic Framework

The authors follow the concept of *Psilocybe* established by Guzmán (1983,
1995), a modification of Singer (1986) excluding Section Chrysocystidiatae.
They do not follow the broader concept of Kühner and Romagnesi (1953) which
merged *Psilocybe*, *Hypholoma* and *Stropharia* into a single genus. This
narrower framework helps resolve some of the confusion in earlier literature
where species were classified under different generic names across studies.
