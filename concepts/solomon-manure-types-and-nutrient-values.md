---
title: Solomon Manure Types and Nutrient Values
created: 2026-04-26
updated: 2026-04-23
sources:
...
explains why spreading manure without mineral supplementation falls
short.

## NPK Table by Animal

Approximate nutrient values vary widely depending on feed quality and
bedding material:

| Animal    | Nitrogen (%) | Phosphorus (%) | Potassium (%) |
|-----------|:------------:|:--------------:|:-------------:|
| Horse     | 0.5 - 0.6    | 0.20 - 0.25    | 0.30 - 0.55   |
| Cow       | 0.5 - 0.6    | 0.15 - 0.25    | 0.30 - 0.50   |
...
2. **Bedding material**: Straw, sawdust, or shavings mixed in dilute
   nutrient concentrations significantly. Sawdust especially ties up
   nitrogen during decomposition, creating a net nitrogen drain
   initially.
3. **Storage and handling**: Nitrogen is lost as ammonia during storage,
...
## Why Manure Alone Is Not Enough

Solomon illustrates this with a telling example. He describes a neighbor
("Ken") who grows a seemingly excellent garden using nothing but manure.
Yet Solomon is skeptical because Ken's children's teeth and bones did
not develop as one would expect for people growing up on homegrown
vegetables -- a subtle indicator that the produce was nutritionally
deficient despite looking good on the outside.
...
- **Low phosphorus**: Most manures (except poultry) are notably low in
  phosphorus, essential for root development, flowering, and fruit
  production.
- **Trace mineral gaps**: Manure from animals fed on mineral-deficient
  forage will itself be deficient in trace elements like boron, zinc,
  and copper.
- **Poor balance**: Even if total NPK seems adequate, the ratios may
  not match what vegetables require for optimal nutrition.
