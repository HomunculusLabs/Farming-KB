---
title: Growing by Chunking: Implementing Permaculture Gradually
created: 2026-04-19
updated: 2026-04-19
type: concept
tags: [reference]
...
Finish the chunk completely. Then observe how it performs through at least one season before starting the next.

### Step 5: Evaluate and Expand
Based on what you've learned from the first chunk, plan and implement the next one. Each chunk builds on knowledge and confidence gained from previous chunks.

## Suggested Chunking Sequence
...
### Start Close to Home
Begin with Zone 1 (closest to the house). Successes here are most visible and most frequently used, providing daily reinforcement.

### Build on Success
Each chunk should build confidence and skills. Don't take on complex projects (like greywater systems or large earthworks) until you've completed simpler ones.
