...
### Eight-Carbon Volatiles (C8 Compounds)

The most characteristic fungal VOCs, produced through oxidative cleavage of
linoleic acid by lipoxygenase and hydroperoxide lyase enzymes. This pathway
is largely absent in bacteria and plants, making C8 compounds distinctive
fungal signatures.

- **1-Octen-3-ol**: "Mushroom alcohol" — the most abundant and studied
...
- **Alpha-pinene, beta-pinene, limonene**: Common monoterpenes contributing
  pine-like or citrus-like notes in overall fungal aroma profiles.

### Aromatic Compounds

- **Benzaldehyde**: Almond-scented aromatic aldehyde with antifungal and
  antibacterial properties, mediating competitive interactions between
  fungal species.
