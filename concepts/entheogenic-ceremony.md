...
Wasson and Jonathan Ott, derives from the same Greek root as "enthusiasm" and
...
The terms "psychedelic," "hallucinogenic," and "entheogenic" are used somewhat
...
- **External setting**: physical environment, social context, presence of a
  guide
In this framework, the psychoactive substance functions as a catalyst or
nonspecific amplifier of psychic contents rather than the primary determinant
of experience. This contrasts with conventional psychiatric drugs (stimulants,
depressants, narcotics) where pharmacological action is paramount and set and
setting play minor roles.
Two analogies have been repeatedly invoked in both the psycholytic and
psychedelic paradigms:
- **The amplifier analogy**: the substance functions as a nonspecific
  amplifier of psychic contents, partly by lowering sensory thresholds
  ("cleansing of the doors of perception")
- **The microscope metaphor**: psychedelics open to direct, repeatable,
  verifiable observation realms of the human mind that are normally hidden
The set-and-setting model extends beyond drug-induced states to encompass
nondrug triggers including hypnosis, meditation, rhythmic drumming, sensory
