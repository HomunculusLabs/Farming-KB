...
Monoculture maximizes yield per individual plant but ignores total system output. Polyculture pushes many species to work together, yielding more total food despite individual plants being smaller. The additional benefit is self-reliance: more food for less work.
...
1. Pick plants based on height, climbing ability, tolerance to shade, and water requirements
2. In dry or cool climates, space plants farther apart for better light and water distribution; in warm humid climates, closer together (but not too close to avoid fungus)
3. In fertile areas with lots of water, plant everything at once (walnuts, fruit trees, legumes, perennials)
4. Total yield from all species combined exceeds what any monoculture produces; diversity gives security
5. Crop rotation is unnecessary in a diverse, multi-layered system; animals and staggered planting replace rotation
6. Create as many beneficial relationships between plants and animals as possible
7. Use ecological succession to build soil progressively, from pioneer weeds to mature canopy

## Establishing the System

1. Cut down woody pioneer weeds and lay them as mulch
...
- **Apple Tree Guild**: fava beans at base, clover groundcover with dandelions and chicory, ring of comfrey, artichoke, yarrow, nasturtiums, and dill, enclosed by daffodils that stop grass encroachment. Each plant serves a purpose: attracting bees, providing mulch, fixing nitrogen, and hindering grass growth.
