...
Cell wall proteins contain carboxyl, amino, sulfhydryl, and imidazole groups that can bind metal ions. These functional groups are particularly important for binding soft metal ions such as copper, cadmium, and mercury.

Melanin, a complex polymer found in the cell walls of many dematiaceous (dark-pigmented) fungi, contains numerous phenolic and carboxylic groups that contribute to metal binding capacity. Melanized fungi often show higher metal biosorption capacities than non-melanized species.

## Mechanisms of Metal Binding

Multiple mechanisms contribute to metal biosorption by fungal biomass:
