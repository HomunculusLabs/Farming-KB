...
Coleman presents a clear economic framework for the heating
decision: if a cheap or local fuel source exists such that one
additional crop covers the heating cost, adding heat makes
economic sense.
