---
title: Hops History and Brewing
created: 2026-04-17
updated: 2026-04-17
type: concept
tags: [reference]
...
## The Spread of Hopped Beer

Hopped beer spread gradually through Europe from the 10th to the 16th centuries. Key milestones in this transition include:

- 822 CE: First recorded use of hops in beer at a monastery in Picardy, France
- 11th-12th centuries: Hopped beer spreads through the Low Countries (modern Netherlands and Belgium)
- 13th century: Hopped beer becomes common in northern Germany, particularly Hamburg and Bremen
- 14th century: Hopped beer arrives in England, where it is initially met with resistance
- 1516: The Bavarian Reinheitsgebot codifies hops as the only permitted beer flavoring
- 16th century: Hops largely replace gruit herbs across continental Europe

The economic advantages of hops were significant. Brewers could grow their own hops rather than purchasing gruit from authorized merchants. Hopped beer also lasted longer, enabling wider trade. These factors combined to make hopped beer commercially dominant.

## Hop Chemistry

### Alpha Acids

The primary bittering compounds in hops are alpha acids, primarily humulone, cohumulone, and adhumulone. These compounds are not soluble in cold water or wort. During the boil, alpha acids undergo isomerization, converting to iso-alpha acids which are soluble and bitter. Longer boil times increase isomerization and thus bitterness.

Alpha acid content varies significantly between hop varieties, ranging from about 2% in noble hops to over 18% in high-alpha bittering hops. This measurement is the primary way brewers select hops for bittering.
...
## Major Hop Categories

### Noble Hops

Noble hops are traditional European varieties prized for their refined, mild aromas. They include:

- Hallertauer Mittelfruh (Germany): floral, spicy, mild
- Tettnanger (Germany): slightly spicy, herbal, floral
- Spalter Select (Germany): noble character with slightly more intensity
- Saaz (Czech Republic): earthy, herbal, spicy -- essential for Czech pilsner
- Styrian Goldings (Slovenia): floral, slightly spicy

Noble hops are characterized by low alpha acid content (3-5%), complex essential oil profiles, and a delicate, refined bitterness.

### American Hops

American hop varieties are known for intense, bold aromas often described as citrusy, piney, tropical, or fruity. Key varieties include:
