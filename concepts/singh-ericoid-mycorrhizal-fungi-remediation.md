...
fungus and its host plant with a competitive advantage in nutrient-poor
environments. This degradation capacity also has implications for
bioremediation of phenolic pollutants.

## Enzymatic Systems

The enzymatic repertoire of ericoid mycorrhizal fungi includes several
activities relevant to bioremediation. Polyphenol oxidases catalyze the
...
metalliferous environments.

## Nitrogen Metabolism and Pollution

The nitrogen metabolism of ericoid mycorrhizal fungi has direct relevance
to pollution remediation. These fungi utilize organic nitrogen sources
efficiently, including proteins and peptides that are inaccessible to
many other soil organisms. The NH4+ enhancement of polyphenol oxidase
synthesis suggests a regulatory link between nitrogen availability and
the fungus's ability to degrade phenolic compounds. In nitrogen-polluted
environments, this metabolic flexibility could be harnessed for
bioremediation. The capacity to use both organic and inorganic nitrogen
sources allows ericoid mycorrhizal fungi to function across a range of
