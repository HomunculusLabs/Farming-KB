...
Before selecting a purification system, test your water:

### Essential Tests

- **Coliform bacteria**: Indicates fecal contamination
- **E. coli**: Confirms fecal contamination (if present, water is unsafe)
- **pH**: Ideal range 6.5-8.5
- **Total dissolved solids (TDS)**: Below 500 ppm is good; above 1000 ppm indicates problems
- **Nitrate**: Below 10 ppm (higher levels dangerous for infants)
- **Lead**: Below 15 ppb (action level)
- **Arsenic**: Below 10 ppb
- **Iron and manganese**: Aesthetic (taste/stain) thresholds
...
- Annually for wells and springs
- After heavy rainfall or flooding
- When taste, color, or odor changes
- After any plumbing work
- When a new well is drilled or an existing one is deepened
...
- Excellent bacteria and cyst removal (0.2 micron or smaller pores)
- Long filter life (6,000+ gallons per element with proper cleaning)
- Simple operation — fill the top, water drips through

**Cons:**
- Slow flow rate
- Must clean elements regularly (scrub with a soft brush)
- Viruses may pass through standard ceramic pores (some systems add carbon for virus removal)
- Initial cost: $250-400 for a complete system

### UV (Ultraviolet) Purification

**How it works:** Water passes through a chamber where UV-C light (254 nm wavelength) disrupts the DNA of bacteria, viruses, and protozoa, rendering them unable to reproduce.

**Popular systems:**
- **Viqua (formerly TrojanUV)**: Residential UV systems, $200-600
- **Sterilight**: Similar range, widely available
- **Aquasana UV**: Integrated with whole-house filtration
...
- Fast treatment (processes water at flow rate)

**Cons:**
- Requires electricity (12V or 120V)
- Pre-filtration required (water must be clear for UV to penetrate)
- Lamp must be replaced annually ($50-100)
- Does not remove chemicals, heavy metals, or sediment
- Does not provide residual protection (water can be recontaminated after treatment)

### Reverse Osmosis (RO)

**How it works:** Water is forced under pressure through a semi-permeable membrane with pores of 0.0001 microns. This removes virtually everything including dissolved salts, heavy metals, bacteria, viruses, and chemicals.

**Types:**
- **Under-sink RO**: 3-5 stages, 50-75 GPD (gallons per day), $150-400
- **Countertop RO**: Portable, gravity-fed, slower, $100-300
- **Whole-house RO**: Rare — very expensive, wastes significant water
...
**Cons:**
- Wastes 3-4 gallons of water per gallon produced
- Removes beneficial minerals (water may taste flat)
- Requires water pressure (40-80 psi) — may need a booster pump
...
**How it works:** Bringing water to a rolling boil for 1 minute (3 minutes above 6,500 feet elevation) kills all bacteria, viruses, and protozoa.

**Pros:**
- 100% effective for biological contamination
- No equipment needed
- No chemicals
...
**Chlorine bleach:**
- 2 drops of unscented 6% sodium hypochlorite per gallon of water
- Wait 30 minutes before drinking
- Kills bacteria and most viruses
- Does not kill Cryptosporidium cysts

**Iodine tablets:**
- Follow package instructions (usually 1-2 tablets per quart)
- Wait 30 minutes
