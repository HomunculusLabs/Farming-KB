---
title: Mycofiltration of Water
created: 2026-04-12
updated: 2026-04-12
type: concept
tags: [mycoremediation, water, filtration, pollution, fungi, ecology, environment, mycology]
sources: []
---
## Overview
...
## Constructed Mycofiltration Systems
### Mycelial Filter Bundles
- Mushroom mycelium grown on straw, wood chips, or sawdust in mesh tubes
- Installed in drainage ditches, swales, and stormwater channels
- Replace conventional silt fences and straw bales
- Lifespan: 3-12 months depending on species and conditions
- After decomposing, they contribute organic matter to the soil
### Mycofiltration Barriers
- Layered mycelium installed as subsurface barriers
- Intercept groundwater contamination plumes
- Combined with sand, gravel, and activated carbon in multi-stage systems
- Used at construction sites, agricultural operations, and industrial facilities
### Floating Treatment Wetlands
- Mycelium-based floating platforms in ponds and lagoons
- Root zone and mycelial zone provide combined plant-fungal treatment
...
- Typical removal: 70-95% total suspended solids
### Heavy Metals
...
- Typical removal: 20-60% total nitrogen, 40-80% total phosphorus
### Pathogens
- E. coli and coliform bacteria from septic systems and animal operations
- Combined with UV treatment for drinking water applications
- Antimicrobial metabolites provide ongoing pathogen suppression
## Best Fungal Species for Water Filtration
### Pleurotus ostreatus (Oyster Mushroom)
- Fast-growing, aggressive mycelial network
- Degrades wide range of organic pollutants
- Tolerant of varying water quality
...
- Excellent for stormwater filtration
- Tolerant of compacted soils and varying moisture
- Produces large, robust fruiting bodies
- Well-suited to temperate climate applications
### Ganoderma lucidum (Reishi)
- Produces antimicrobial compounds
- Durable, long-lasting mycelial structures
- Effective against bacterial pathogens in water
## Design Considerations
### Sizing
- Hydraulic loading rate: 0.5-5 cm/day depending on contaminant load
- Contact time: minimum 30 minutes for chemical/biological treatment
- Filter depth: 15-60 cm depending on application
- Flow rate calculations based on contaminant concentration targets
### Maintenance
- Replace filter media when clogged or exhausted (typically 3-12 months)
- Monitor influent and effluent water quality regularly
- Re-inoculate with fresh spawn if mycelial viability declines
- Seasonal considerations: reduced activity in winter; protect from freezing
