...
- **Hyphochytridiomycetes**: Single order with 3 families, 4 genera. Produce zoospores with single anterior tinsellated flagellum.

**Key ecological roles**:
- Decompose pollen (seasonal resource pulses in lakes; peak chytrid zoospore attack during 2 weeks after pollen shower)
- Parasitize planktonic and benthic algae (quantified using MPN methods)
...
- **Saprolegniomycetidae**: Saprolegniales, Sclerosporales (mycelial)
...
A diverse group, with approximately 600+ species reported from freshwater habitats worldwide.

**Key orders and families**:
- *Lulworthiales*: Halosphaeriaceae (many marine-derived but some freshwater)
- *Sordariales*: Annulatascaceae, many genera restricted to freshwater
- *Pleosporales*: Numerous genera on submerged wood
- *Microascales*: Some freshwater representatives

**Substrata**: Primarily found on:
- Submerged wood (twigs, branches, logs) - most common substrate
- Submerged leaves and herbaceous debris
- Decaying fruits and seeds
- Aquatic macrophyte stems
...
Anamorphic fungi that produce conidia in freshwater habitats. Include the Ingoldian fungi.

**Ingoldian freshwater hyphomycetes** (see [[aquatic-fungi-and-ingoldian-spores]]):
- ~300 species with tetraradiate or sigmoid spores adapted for aquatic dispersal
- Key genera: Tricladium, Tetrachaetum, Flagellospora, Anguillospora, Lemonniera, Heliscus
- Primary decomposers of submerged leaves in streams
- Spore shapes maximize anchoring to substrates in flowing water
...
- High oxygen, flowing water
- Dominated by hyphomycetes on leaf litter
- Submerged wood supports diverse ascomycete communities
- Chytrids parasitize plankton
...
- High organic matter, fluctuating water levels
- Anaerobic fungi in sediments
- Diverse ascomycete communities on emergent vegetation
- Peronosporomycetes thrive in stagnant conditions
...
**Chytrids/Hyphochytrids**:
- Baiting with chitin (shrimp exoskeleton), cellulose (cellophane, onion skin), keratin (hair, snake skin), pollen (pine, spruce)
- In situ baiting with mesh bags containing baits
- Isolation on PmTG agar with antibiotics
- Documentation of developmental sequences essential for identification

**Peronosporomycetes**:
- Hemp seed and snake skin baiting
