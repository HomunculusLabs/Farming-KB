...
### Nitrogen (N)
- **Role**: Building block for amino acids, proteins, chlorophyll, and nucleic acids. Drives vegetative growth.
...
- **Deficiency**: Dark green or purplish leaves, especially on undersides. Slow growth, poor root development.
- **Organic sources**: Bone meal, rock phosphate, bat guano (high P), fish bone meal
- **Demand**: Important during early veg (roots) and throughout flowering (buds)

### Potassium (K)
- **Role**: Osmoregulation, enzyme activation, stomatal function, disease resistance, cold hardiness
- **Deficiency**: Brown leaf edges and tips (scorch), weak stems, poor bud development.
- **Organic sources**: Langbeinite (K-Mag), kelp meal, wood ash (use sparingly), greensand
- **Demand**: Increases through flowering — critical for bud size and density

## Secondary Macronutrients

### Calcium (Ca)
- **Role**: Cell wall structure, root development, membrane integrity
...
- **Deficiency**: Interveinal chlorosis (yellowing between veins) on older leaves first, then progressing upward
- **Organic sources**: Dolomite lime, Epsom salt (magnesium sulfate — use sparingly), kelp meal
- **Cal-Mag**: In living soil, cal-mag supplements are rarely needed unless using RO water or coco coir

### Sulfur (S)
- **Role**: Component of amino acids (cysteine, methionine), vitamins, enzyme function
- **Deficiency**: Uniform yellowing of new leaves (similar to N deficiency but on new growth)
- **Organic sources**: Gypsum, kelp meal, elemental sulfur (also lowers pH)

## Micronutrients

| Nutrient | Role | Deficiency Symptom | Organic Source |
|---|---|---|---|
| Iron (Fe) | Chlorophyll synthesis, enzyme function | Interveinal chlorosis on new leaves | Kelp, compost, chelated iron |
| Manganese (Mn) | Enzyme activation, photosynthesis | Interveinal chlorosis on new leaves, dead spots | Kelp, compost |
...
- 2 cups bone meal (P, Ca)
- 1-2 cups kelp meal (K, micronutrients, trace minerals)
- 1 cup dolomite lime (Ca, Mg, pH buffer)
- 1/2 cup langbeinite (K, Mg, S)
- 1/2 cup crustacean meal (chitin — fungal food, immune trigger)
- 1/2 cup neem seed meal (N, pest deterrence)
- 2-4 cups worm castings (microbial inoculant)

### Top-Dress During Grow
- **Week 3-4 veg**: Compost or worm castings if growth is slow
- **Week 1-2 flower**: Bone meal + kelp meal (P, K boost)
...
- **Microbiome note**: pH is a moderate predictor of microbial community structure (Winston et al. 2014, r-stat: 0.221), but N, salinity, and carbon are all stronger drivers. Focus on building biology rather than chasing a specific pH number.

### pH and Nutrient Availability (Lowenfels)
