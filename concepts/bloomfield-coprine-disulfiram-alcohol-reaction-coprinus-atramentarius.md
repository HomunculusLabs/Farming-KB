...
The biochemical pathway through which coprine produces its effects
closely parallels the pharmacology of disulfiram. Under normal
circumstances, the human body metabolizes alcohol (ethanol) in two
stages:

- **Stage 1:** Ethanol is converted to acetaldehyde by alcohol
  dehydrogenase (ADH)
- **Stage 2:** Acetaldehyde is converted to acetate (harmless) by
