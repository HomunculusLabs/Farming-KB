...
Fluorescent tubes are classified by diameter: T12 (1.5 inch), T8
(1 inch), T5 (0.625 inch), and CFL. The T12 uses old-fashioned
magnetic ballasts. The T8 and T5 use electronic ballasts. Growers
prefer slimmer T8 and T5 bulbs with electronic ballasts because they
run cooler, electricity cycles faster, and lights do not flicker.

Lumen output varies significantly between types:
- T12 (40-watt): about 2800 lumens, roughly 68 lumens per watt
- T8 (32-watt): about 3200 lumens, roughly 100 lumens per watt
- T5 (54-watt): about 5000 lumens, roughly 92 lumens per watt

Power twist or groove-type lamps offer additional lumens in the same
linear space. The deep wide grooves provide more glass surface area
and more light output. Several companies market variations of power
twist fluorescents.

## Spectrum and Kelvin Ratings

Fluorescent bulbs are available in various spectrums measured in
Kelvin temperature:
...
| Neutral           | 3500 K |
| Cool White        | 4100 K |
| Full Spectrum      | 5000 K |
| Daylight          | 6500 K |

Major manufacturers including GE, Osram/Sylvania, and Philips produce
fluorescent lamps across these spectrums. Sylvania's GroLux Standard
is designed as a standalone light source with the full spectrum
necessary for photosynthesis and chlorophyll production, making it
ideal for starting clones or seedlings. The Wide Spectrum GroLux
...
root clones. See [[cervantes-mother-plants]]
- **Small closet or stealth grows**: Limited heat signature makes them
  suitable for [[led-grow-lights]] are far more efficient in terms of lumens per
watt and canopy penetration.

Compact fluorescent lamps are not a good choice for side lighting
when using HID lamps, as their output is insufficient to penetrate
dense canopy foliage effectively.

## Ballast Considerations

All fluorescents require specific ballasts. Ballasts normally last 10
to 12 years. The end of a magnetic ballast's life is usually
...
approved location. See [[jorge-cervantes]]
