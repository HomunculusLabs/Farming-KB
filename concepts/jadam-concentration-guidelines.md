---
title: JADAM Concentration Guidelines
created: 2026-04-18
updated: 2026-04-18
type: concept
...
- Caution: continuous use above 10 L may suppress growth and damage white powdery coating on fruits
- Fog machines (17 L water): 500 cc (0.13 gal)

### JADAM Sulfur (JS)
- Open fields: start from 1 L (0.26 gal)
- Greenhouses/soft plants: start from 0.5 L (0.13 gal)
- Increase in 0.2 L (0.053 gal) increments
- Maximum: 2.5 L (above this causes concentration stress, burns leaf edges)
- Fog machines (17 L water): 0.1 L
- Use only 2-3 times per season when disease is present
- Caution: persimmons, grapes, walnuts, and perilla are particularly sensitive

### JADAM Herb Solution (JHS)
- Normal range: 3-20 L (0.8-5.3 gal)
- When increasing JHS, always increase JWA together
- JHS causes little concentration stress
- Fog machines (17 L water): 10 L
...
### Resistant Crops (can tolerate stronger doses)
- Apple
- Pepper

### Sensitive Crops (start lower, increase carefully)
- Persimmon
- Grape
- Walnut
- Perilla
- Greenhouse crops (soft leaves)
