---
title: Ectomycorrhizal Host Tree Partnerships
created: 2026-04-17
updated: 2026-04-17
type: concept
tags: [reference]
...
Approximately 2% of all plant species form ectomycorrhizal (ECM) associations, but these species include many of the world's most important forest trees. ECM fungi form a sheath (mantle) around fine root tips and penetrate between root cells to form a Hartig net, the primary site of nutrient exchange between fungus and plant.
...
The Fagaceae includes oaks (Quercus), beeches (Fagus), chestnuts (Castanea), and chinquapins (Castanopsis). These trees are among the most important ECM hosts for high-value mushroom species.

Oaks are the primary hosts for the most valuable European truffle species (Tuber melanosporum, Tuber magnatum, Tuber aestivum). The choice of oak species for truffle orchards is a critical factor in cultivation success, as different oak species create different soil conditions and mycorrhizal environments.

Beech forests support diverse ECM communities including boletes (particularly Boletus edulis), chanterelles, and various Russula and Lactarius species. Beech is a preferred host for many ECM fungi due to its dense, fine root systems that provide extensive colonization sites.
