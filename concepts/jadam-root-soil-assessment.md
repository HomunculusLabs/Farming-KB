---
title: "JADAM Root Soil Assessment — Reading Plant Roots to Judge Soil Condition"
created: 2026-04-14
updated: 2026-04-14
type: concept
...
- **Wide and deep root extension** — in good soil, roots extend wide and deep, guaranteeing high yield and high quality
...
Dig about 40 cm vertically into your soil. Take out a chunk from 20 cm depth. If that chunk contains a lot of roots, the soil is free from soil compaction. If you cannot find any roots in soil deeper than 20 cm, check a few more spots. If all spots return the same result, a layer of compacted soil is covering your entire field.
...
Historically one of the easiest crops to grow. Today, some farmers say it is the most difficult. The root cause: pepper roots are not settling properly into the soil. 30-40 years ago, pepper plants extended roots 1.5 m (5 ft) into the soil. Now, roots are coiled up, desperate to stay in nursery soil.

### Chinese Cabbage

Farming has become difficult. The problem is the same — roots show the same coiling as pepper.

### Fruit Trees

A pear tree nearly a century old has as many pears as young trees. This is the result of soil management using microorganisms. Strong root settlement through JMS application before active root growth determines the success of harvest.
