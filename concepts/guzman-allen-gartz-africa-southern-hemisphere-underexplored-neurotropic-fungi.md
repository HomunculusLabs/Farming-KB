---
title: Neurotropic Fungi of Africa and the Underexplored guzman allen gartz africa southern hemisphere underexplored neurotropic fungi
source: A Worldwide Geographical Distribution of the Neurotropic Fungi (Guzman, Allen & Gartz, 2000)
tags: [mycology, psilocybe, biogeography, africa, southern-hemisphere, neurotropic-fungi, biodiversity]
created: 2026-05-09
---
...
- **Southern/Austral hemisphere**: 59 species documented across
...
- **Northern hemisphere (USA and Canada)**: Only 18 species
  documented, despite far more intensive mycological exploration.
...
- **Scarce mycological exploration**: Most African countries lack
...
- **Taxonomic challenges**: Many tropical Psilocybe species are
...
- **Psilocybe aucklandii** (New Zealand) is closely related to **P.
  ...
  Zapotecorum.
- These trans-Pacific relationships suggest ancient Gondwanan
  distributions that predate continental drift, or more recent
  dispersal events along tropical corridors.

### Japan's Neurotropic Mycoflora

Hongo's nine types of fungal distribution are well illustrated by
Japan's neurotropic species:

- **Cosmopolitan**: Panaeolus spp. and [[guzman-panaeolina-foenisecii-psilocybin-controversy-conflicting-chemical-analyses]].
- **Southeast Asian**: Psilocybe subaeruginascens var.
  subaeruginascens (Japan and Java).
- **Endemic**: Several Panaeolina species described by Hongo, and
  Psilocybe argentipes and P. subcaerulipes, which are very closely
  related to American species P. graveolens, P. muliercula, and
  P. pintonii.

## Regions with No Records at All

Guzmán et al. specifically noted the absence of records from:

- Southeastern Russia, Mongolia, Arabia, and Turkey.
- Many regions of Africa.
- Korea, Malaysia (except Java and Sumatra), and Hawaii.
- Alaska and Costa Rica (among others).
- Several US states with no confirmed records: Arizona, Colorado,
  Illinois, Maryland, Vermont, Massachusetts, New Hampshire, and
  Pennsylvania.

## The Collector's Curse

Gartz (1996) wryly observed that "the mushrooms occur in abundance
wherever mycologists abound." Mueller and Halling's (1995) major
analysis of Agaricales biodiversity in Neotropical forests notably
failed to mention any Psilocybe species, despite their commonness in
the area, illustrating how even expert mycologists may overlook
neurotropic taxa. This bias has skewed our understanding of global
distribution patterns and likely means that the true number of
neurotropic fungal species worldwide is far greater than the 216
catalogued by Guzmán, Allen, and Gartz.
