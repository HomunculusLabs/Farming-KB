...
- **Appropriate crops**: Barnyard millet, foxtail millet, proso
  millet, wheat, barley, rice
- **Logic**: Where wild grasses thrive, cultivated grains of the
  same family will also perform well
...
- **Logic**: These moisture-loving indicator plants suggest
  conditions suitable for tuber crops in the same family
...
- **Indicator weeds**: Water hemlock
- **Appropriate crops**: Dropwort, honewort, carrot, parsley, celery
- **Logic**: Umbelliferous weeds indicate soil conditions favorable
  for the entire carrot family

### Mustard Family (Brassicaceae)
- **Indicator weeds**: Shepherd's purse
- **Appropriate crops**: Daikon, turnip, Chinese cabbage, leaf
  mustard, cabbage
- **Logic**: The ubiquitous shepherd's purse indicates conditions
  ideal for brassica crops

### Gourd Family (Cucurbitaceae)
- **Indicator weeds**: Snake gourd, bottle gourd
- **Appropriate crops**: Chayote, squash, muskmelon, watermelon,
  cucumber
- **Logic**: Wild cucurbits indicate warm, fertile conditions
  suitable for the full range of cultivated cucurbits

### Potato Family (Solanaceae)
- **Indicator weeds**: Ground cherry, sweet brier
- **Appropriate crops**: Hot red pepper, potato, tobacco, eggplant,
  tomato
- **Logic**: Nightshade family weeds indicate conditions for the
  major solanaceous crops

## The Orchard Vegetation System

Fukuoka also specified a complementary system for orchard
undergrowth. The complete natural farm integrates fruit trees with
protective trees, green manure trees, useful trees, green manure
crops, and vegetables in a layered polyculture:

### Protected and Green Manure Trees
- Acacia, wax myrtle, umbrella tree (protected canopy)
- Japanese alder, sugar maple, bay tree, cinnamon (green manure
  and useful trees providing year-round leaf fall)

### Green Manure Crops by Season
- **Year-round**: Ladino clover, alfalfa
- **Spring**: Bur clover
- **Winter**: Mustard family vegetables, lupine, hairy vetch,
  common vetch
- **Summer**: Soybean, peanut, adzuki bean, mung bean, cowpea

### Fruit Tree Companions
- **Evergreen fruit trees** (citrus, loquat): Butterbur, Japanese
  silverleaf buckwheat as understory
- **Deciduous fruit trees** (persimmon, walnut, peach, plum, apricot,
