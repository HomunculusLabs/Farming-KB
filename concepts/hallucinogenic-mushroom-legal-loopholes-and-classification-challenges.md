...
- Whether landowners on whose property hallucinogenic mushrooms grow could face criminal liability

## The "Treated or Prepared" Loophole

Several countries initially attempted to control hallucinogenic mushrooms by criminalising them only when they had been "treated or prepared." This approach was intended to distinguish between mushrooms in their natural state and those that had been processed for consumption, thereby avoiding the unjust criminalisation of people who might own land where mushrooms grow wild.

### Irish and UK Application

Both Ireland and the UK adopted the "treated or prepared" standard. Under this approach, fresh mushrooms sold in their natural state were not controlled, but dried mushrooms or those incorporated into food products were considered illegal preparations. This created an obvious loophole: retailers could sell fresh mushrooms legally, and smartshops and market stalls exploited this gap extensively.

### The UK Escalation

The UK government progressively tightened its interpretation of "preparation" as the market expanded:
...
A separate but related legal challenge arises from the biological classification of mushrooms. Several countries have catch all laws prohibiting cultivation of plants from which narcotic substances can be extracted. However, mushrooms are fungi, not plants, creating a jurisdictional gap:

### Italy, Greece, Cyprus, and Lithuania
...
Legal controls do not always apply to the same mushrooms across different countries, creating an inconsistent and sometimes contradictory legal landscape:
...
Italy lists "Fungi of the genus Stropharia, Conocybe and Psilocybe." This approach relies on taxonomic classification by genus, though it may not cover all species that contain psychoactive compounds.

### UK

The UK definition simply states "Fungus of any kind which contains psilocin or an ester of psilocin." This broad definition is based on chemical content rather than taxonomic classification, making it more resistant to evasion through the marketing of different species.
