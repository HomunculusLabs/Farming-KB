...
title: emcdda-psilocybin-pharmacology-and-chemistry Detail
created: 2026-04-12
updated: 2026-04-12
type: concept
...
Detailed pharmacokinetics, route of administration, toxicity data, psychological risks, and legal status for [[forensic-identification-methods-psilocybin-mushrooms-tlc-gc-hplc]]. See [[psilocybin-mushroom-chemistry]] for dosage guidelines, subjective effects, and acute incidents.
...
### Common Routes
- **Oral (raw)**: Mushrooms chewed and held in mouth or swallowed; most common method
...
- **Peak effects**: Typically 1-2 hours after ingestion
- **Duration**: 2-6 hours primary effects
- **After-effects**: Additional 2-6 hours (sleep difficulties, residual perceptual changes)
- **Tolerance**: Short-term tolerance develops rapidly; physical and [[hallucinogenic-mushroom-acute-psychological-effects-and-bad-trips]] diminish with consecutive daily use

### Acute Physiological Effects (EMCDDA Clinical Summary)
- Dizziness, nausea, weakness
- Muscle aching, shivering
- Abdominal pain
- Pupil dilation (mydriasis)
- Mild-to-moderate tachycardia and tachypnea
- Elevated blood pressure (risk factor for cardiovascular conditions, especially untreated hypertension)
- Body temperature generally remains normal
- Severe cases: persistent vomiting, diarrhea, severe stomach pain

### Acute Psychological Effects (EMCDDA Survey Data)

**Positive/neutral effects reported by users:**
- Mild relaxation (comparable to cannabis at low doses)
- Giddiness, uncontrollable laughter
- Energy, joy, euphoria
- Visual enhancement (brighter colors)
- Visual disturbances (moving surfaces, waves)
- New insights and perspectives (especially about time)
- Quickly changing emotions

**Negative effects reported by users:**
- Nausea and vomiting (>25% of recent users per Mixmag 2005 survey)
- Panic attacks (~25% of recent users per Mixmag 2005 survey)
...
- Higher potency in specific species: P. azurescens, P. bohemica
- P. cubensis: up to ~0.6% psilocybin/psilocin combined
- Psychoactive dose range: 45-315 ug/kg body weight
- Recreational dose: 1-5g dried (10-50g fresh)
- These values are orientation-only; actual concentration varies enormously
...
From clinical and self-report data compiled by Gartz:

| Parameter | Psilocybin Mushrooms | LSD |
|---|---|---|
| Duration | 4-6 hours | 8-12 hours |
| Onset | 20-60 min | 30-90 min |
| Visual intensity | High | High |
| Body load | Moderate (nausea common) | Low-moderate |
| Ego dissolution | Possible at high doses | More common at moderate doses |
| Safety margin | Extremely wide | Extremely wide |
| Natural vs. synthetic | Natural product | Semi-synthetic |
| Dose consistency | Variable (species, specimen) | Precise |
| "Bad trip" frequency | Moderate | Moderate |
...
- **Traumatic experiences:** "Bad trips" can be psychologically harmful, especially without preparation or integration support. [[lsd-set-and-setting-framework]] are critical.
