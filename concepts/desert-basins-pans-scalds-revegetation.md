---
title: Desert Basins, Pans, Scalds, and Revegetation
...
- **Simple profile**: Classical basin and range with water conservation beginning on foothill slopes
- **Complex foothills**: Provide many sites for water storages and swales

## Active Gully Erosion Healing

### Small Gullies

Small gullies can be filled, fenced, and planted directly. This straightforward approach works where erosion is recent and gully dimensions are modest.

### Large Gullies

Large gullies need multiple strategies working together:
1. **Diversion of headwaters**: Redirect water away from the gully head to prevent further incision
2. **Swales** to hold water on side walls and promote infiltration
3. **Gabions** on the gully floor to slow water flow and trap sediment
4. **Fencing** to exclude livestock and allow natural regeneration
5. **Tree planting** in and around the gully to stabilise slopes with root systems
6. **Spreader banks** to spread headwaters gently downstream rather than concentrating flow
