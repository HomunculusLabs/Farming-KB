---
created: 2026-04-12
source: biodiversity-of-fungi (Hyde et al. Ch. 21, Krug/Benny/Keller)
sources: []
tags:
- fungal-biodiversity
- ecology
...
Five orders of Myxomycetes include coprophilous species:
**Echinosteliales**
- Echinostelium minutum, E. brooksii
- Many are obligate coprophiles
**Physarales**
- Didymium species: D. iridis, D. megalosporum, D. minus, D. nigriceps, D. quadrifidum, D. saturnus, D. squamulosum, D. trachysporum, D. vaccinum, D. verrucosporum
- Lepidoderma chailletii
- Physaraceae: Badhamia (B. apiculospora, B. gracilis, B. macrocarpa, B. spinispora), Craterium leucocephalum, Fuligo (F. cinerea, F. septica), Leocarpus fragilis, Physarum (many species including P. compressum, P. gyrosum, P. nutans)
**Stemonitales**
- Colloderma oculatum
- Comatricha (C. mirabilis, C. nigra, C. pulchella)
- Lamproderma scintillans
- Macbrideola (M. coprophila, M. cornea)
- Stemonitis (S. fusca, S. pallida)
**Trichiales**
- Arcyria (A. cinerea, A. incarnata, A. leiocarpa, A. pomiformis, A. stipata)
- Perichaena (P. chrysosperma, P. corticalis, P. depressa, P. minor, P. pedata, P. vermicularis)
- Trichia (T. botrytis, T. contorta, T. fimicola)
### Zygomycetes
The Zygomycetes include 10 orders with coprophilous representatives. Key genera:
...
### Ascomycetes
The most species-rich group of coprophilous fungi, spanning 15+ orders:
**Key orders and genera**:
*Sordariales* (most diverse):
- Sordaria, Podospora (incl. Schizothecium), Sporormiella, Preussia, Delitschia, Neurospora, Gelasinospora, Chaetomium
- Lasiosphaeriaceae: Arnium, Bombardioidea, Camptosphaeria, Zopfiella, Triangularia
*Pezizales*:
- Ascobolus, Saccobolus, Thecotheus (Ascobolaceae)
- Lasiobolus, Coprotus, Pseudombrophila, Scutellinia, Trichophaea (Otideaceae)
- Peziza
*Xylariales*:
...
### Basidiomycetes
Relatively few genera are coprophilous:
**Agaricales**:
- Coprinus, Panaeolus, Psilocybe, Agrocybe, Bolbitius, Conocybe, Psathyrella, Agaricus
...
- Byssocorticium (Atheliales)
- Sebacina (Auriculariales)
## Succession Patterns
...
3. **Secondary stage** (2-6 weeks): Slower-growing Ascomycetes (Xylariales, Onygenales), Basidiomycetes begin fruiting
4. **Late stage** (months): Specialized fungi on remaining refractory material
...
- **Direct collection**: Fresh dung samples placed in moist chambers
- **Baiting**: Air-dried dung rehydrated on agar or filter paper in Petri dishes
- **Dung extract agar**: Prepared by boiling air-dried dung, filtering, and adding agar; promotes sporulation of obligate coprophiles
- **Incubation**: 20-25°C under natural or fluorescent light cycles; examination every 1-3 days over 4-8 weeks
