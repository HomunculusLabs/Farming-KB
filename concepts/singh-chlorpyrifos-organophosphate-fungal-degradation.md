...
where different fungi contribute distinct enzymatic activities that
collectively achieve more complete degradation of the parent compound
...
## Fenitrothion and Fenitrooxon Degradation

Fenitrothion and fenitrooxon are degraded enzymatically by Trichoderma
viride in the presence of alternative nutrients. The presence of
alternative nutrients appears to support fungal growth and enzyme
production, thereby enhancing organophosphate degradation capacity. This
nutrient-dependent enhancement suggests that biostimulation strategies
could be combined with bioaugmentation for improved field remediation of
organophosphate-contaminated soils. The enzyme systems responsible for
fenitrothion degradation by T. viride include both hydrolases and
oxidative enzymes that act on different moieties of the molecule.

## Biobed Systems for Pesticide Degradation

Biobed matrices represent a practical application of fungal degradation
of pesticides including chlorpyrifos. In biobed systems, organic
substrates such as straw, peat, and soil create a favorable environment
for microbial pesticide degradation. The performance of different fungal
species varies in biobed matrices, with Coriolus versicolor consistently
showing the highest chlorpyrifos degradation rates. Biobed systems
have been developed primarily for agricultural pesticide point-source
contamination, where farm equipment washing and pesticide handling areas
generate concentrated pesticide waste that requires on-farm treatment.
...
## Biosensor Detection of Organophosphates

Fungal-based biosensor technologies have been developed for the
detection of organophosphorus pesticide residues. A photothermal
biosensor containing acetyl cholinesterase has been employed for
detection of paraoxon, chlorpyrifos, and diazinon in tap water at
low concentrations of 0.2 ng. A ferromagnetic biosensor has been used
for the assay of organophosphorus pesticides. Cholinesterase and
tyrosinase are the principal enzymes used for pesticide detection in
biosensor systems. Enzyme-based biosensors involve enzyme-catalyzed
redox reactions, forming products or causing disappearance of
electroactive substrates that can be measured amperometrically.

## Future Research Directions

More research is needed on the fungal degradation of organophosphate
mixtures, as these compounds rarely occur alone in the environment.
The metabolic pathways of organophosphate degradation by fungi require
further elucidation, particularly the enzymatic mechanisms responsible
for ring cleavage. The combination of fungal bioaugmentation with
biostimulation using nutrient amendments could enhance field-scale
remediation. The development of fungal formulations optimized for
organophosphate degradation in biobed systems represents a practical
direction for on-farm pesticide waste management.
