...
The mycelial network created by arbuscular mycorrhizal fungi represents an ideal storage structure, where areas of lesser concentration of nutrients can serve as a sink toward which nutrients will flow from the soil. This same network architecture functions as a water distribution system that benefits the host plant during periods of water scarcity.
