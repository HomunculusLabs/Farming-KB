...
Repeated administration of psilocybin leads to rapid tolerance development, primarily through 5-HT2A receptor downregulation and desensitization. Key features:

- **Onset**: Tolerance develops within 24 hours of a single dose
- **Duration**: Full sensitivity typically returns within 1–2 weeks of abstinence
- **Mechanism**: Receptor internalization via clathrin-mediated endocytosis, reduced receptor mRNA expression
- **Cross-tolerance**: Extends to LSD and other 5-HT2A agonists, but not to cannabinoids or dissociatives

This tolerance profile is clinically important — it limits the frequency of therapeutic administration and is one reason psilocybin is not considered dependence-forming, as escalating dose seeking does not produce proportionally increased effects.

## Genetic Variability in HTR2A

Polymorphisms in the HTR2A gene influence individual responses to psilocybin:

- **rs6313 (T102C)**: The C allele is associated with reduced 5-HT2A receptor expression and has been linked to attenuated psychedelic responses and differential therapeutic outcomes
- **rs6314 (His452Tyr):** A relatively rare variant associated with altered receptor function and modified response to serotonergic drugs
- **rs6311 (-1438G/A)**: Promoter region polymorphism affecting receptor transcription levels

These genetic factors may explain the substantial inter-individual variability in subjective psychedelic experiences and therapeutic response rates, and represent potential biomarkers for personalized psychedelic therapy protocols.

## Comparison with Other Serotonergic Psychedelics

| Compound | 5-HT2A Ki (nM) | Efficacy (% of 5-HT) | Duration (hours) | Key Differentiator |
|----------|----------------|----------------------|-------------------|--------------------|
...
- Carhart-Harris RL et al. (2012). Neural correlates of the LSD experience revealed by multimodal neuroimaging. PNAS.
- Vollenweider FX & Preller KH (2020). Psychedelic drugs: A perspective on pharmacological mechanisms and translational research. Pharmacological Reviews.
- HTR2A gene polymorphisms and psychedelic response: Ott U et al. (2005). Pharmacogenomics Journal.
- Krahe TE et al. (2024). Mapping the synaptic effects of psychedelics via 5-HT2A signaling. Nature Neuroscience.

## Radioligand Development for 5-HT2A Imaging

The development of positron emission tomography (PET) radioligands selective for 5-HT2A has been critical for translating preclinical receptor pharmacology into clinical understanding. Key radioligands include:

- **[11C]Cimbi-36**: Developed at Copenhagen University, this is currently the most widely used 5-HT2A agonist PET radioligand. Its agonist properties make it ideal for studying psychedelic occupancy, as it competes with endogenous serotonin and exogenous agonists at the same binding site. Binding potential correlates with subjective psychedelic intensity.
...
The 5-HT2A receptor pharmacology of psilocybin has direct implications for several psychiatric conditions:
...
In patients with life-threatening cancer diagnoses, psilocybin produced significant reductions in death-related anxiety. The 5-HT2A-mediated disruption of the DMN may temporarily attenuate the neural substrate of self-referential rumination that perpetuates existential anxiety.
