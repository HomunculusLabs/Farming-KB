...
### Bacteria
- Aerobic bacteria, on average, produce alkaline slime layers and move pH in an alkaline direction
- Anaerobic bacteria push pH below 4.5

### Key Insight
- The pH range 5.5-7.0 is where both aerobic fungi AND aerobic bacteria can function
- This is the target range for AACT
...
Ingham challenges the conventional approach to pH:

### Chemical Paradigm
- Test soil pH
- Add lime to raise pH, sulfur to lower pH
- Match specific crops to specific pH ranges
- "Crops that require lower pH shouldn't be grown in high pH soils"
