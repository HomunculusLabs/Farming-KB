...
Fresh *Amanita muscaria* contains primarily **ibotenic acid**, a neurotoxic amino acid that is responsible for many of the unpleasant effects associated with raw consumption — nausea, confusion, and gastrointestinal distress. When properly dried, a significant portion of the ibotenic acid undergoes **decarboxylation**, converting into **muscimol**, which is the primary psychoactive and entheogenic compound sought by practitioners.

This conversion is not automatic or uniform. Proper drying is essential for both safety and potency. The drying method directly affects the ibotenic acid → muscimol conversion ratio, making it one of the most consequential decisions in preparation.

**Temperature and duration** are the critical variables:
...
Practitioners can use this variable deliberately, choosing preparation coarseness to dial the experience toward gentler extended journeys or more intense focused sessions.

## Specimen Variation: The Uncontrollable Factor

Nature does not produce standardized products. There is substantial **natural variation in potency between individual specimens** of the same species, growing in the same area, picked at the same time. One cap may contain twice (or half) the active principle of its neighbor. This variability is fundamentally beyond human control — it is a property of the living organism and its microenvironment.

**The practical solution is averaging.** By combining pieces from multiple specimens into a single preparation, the practitioner effectively creates an average of the total active principle. This averaged material is far more predictable than any individual specimen, because extra-strong and extra-weak specimens balance each other out in the combined mass.

This averaging technique was almost certainly known and deliberately practiced in ancient **Soma ceremonies**, where consistency of the sacramental experience would have been a practical and spiritual necessity. The ritual combining of multiple specimens into a single pressing is not merely symbolic — it is sound pharmacological practice.

## Preparation Principles

Drawing together the variables above, several core principles emerge:
...
There is no universal "correct" dose of *Amanita muscaria*. The number of interacting variables — specimen potency, drying method, physical preparation, individual body weight, metabolism, sensitivity, and prior experience — makes any single dosage figure misleading.
