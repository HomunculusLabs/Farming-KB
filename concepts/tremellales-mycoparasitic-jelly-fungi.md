---
title: Tremellales — Mycoparasitic Jelly Fungi and Host Interactions
...
Members of the Tremellales share a characteristic life cycle featuring:

- A dimorphic life cycle (yeast and hyphal phases)
- A septal pore apparatus with sacculate caps
- A tremelloid basidium

The dimorphic nature allows these fungi to exist as saprotrophic yeasts in one phase and as invasive mycoparasites in another, facilitating both dispersal and host colonization.

## Host Range and Diversity

### Tremella — The Largest Genus

Tremella is the largest and most heterogeneous genus in the Tremellaceae, with more than 170 known species. Its mycoparasitic species grow on an extraordinary range of hosts:

- **Hymenia of aphyllophorales** (crust and bracket fungi)
- **Basidiomes of Dacrymycetales** (jelly fungi)
- **Ascomata and/or stromata of pyrenomycetes**
- **Hymenomycetes** (gilled mushrooms and poroid fungi)
- **Lichens** (Bandoni 1995; Diederich 1996)

Notable species include:
- **Tremella encephala**: The firm nucleus regularly seen in its basidiomes is actually the host fungus, Stereum sanguinolentum (Bandoni 1984; Helfer 1991). This species essentially replaces the host hymenium.
- **Tremella mycophaga** and **T. simplex**: Parasitize Aleurodiscus amorphus
- **Tremella danica**: Grows on or in Myxarium nucleatum
- **Tremella polyporina**: Replaces the hymenium on basidiocarps of Postia (Tyromyces) species
- **Tremella obscura**: Attacks Dacrymyces species
- **Tremella juniperina**: Found on sporocarps of Colpoma juniperi
- **Tremella translucens**: Found on Lophodermium species

### Other Tremellaceous Genera

- **Trimorphomyces** and **Sirotrema**: Found on conidial masses of Arthrinium or on hymenia of Hypodermataceae, respectively (Oberwinkler and Bandoni 1983)
...
The Syzygosporaceae are a specialized group of Tremellales comprising parasites on Phanerochaete species, Gymnopus species, and Marasmius species, often causing gall-like deformations. Ginns (1986) synonymized Syzygospora, Christiansenia, and Carcinomyces in Syzygospora, recognizing nine species in three subgenera distinguished by basidial and conidial shape.
...
- **Rhynchogastrema**: Mycoparasitic species contact various soil hosts with haustoria, but axenic growth is possible (Metzler et al. 1989)
- **Phragmoxenidiaceae**: Phragmoxenidium mycophilum grows on Uthatobasidium fusisporum, contacting its host through micropores; its septa lack a parenthesome (Oberwinkler et al. 1990b)
- **Tetragoniomycetaceae**: Tetragoniomyces uliginosus grows on Ceratobasidium (Oberwinkler and Bandoni 1981)

## Colacosomes and Lenticular Bodies

A unique ultrastructural feature associated with mycoparasitism in the Platygloeomycetidae (which includes Tremellales relatives) is the presence of **colacosomes** — vesicular structures with an electron-opaque core and an electron-transparent sheath. The vesicular content projects through the cell wall of the parasite and makes contact with the plasmalemma of the host (Bauer and Oberwinkler 1991).

These organelles, first described as "lenticular bodies" from Sporidiobolus species (Kreger-van Rij and Veenhuis 1971) and later from Cryptomycocolax species and Colacogloea (Oberwinkler and Bauer 1990), have also been found in Bensingtonia and Rhodosporidium, suggesting those yeasts may also have mycoparasitic capabilities (Boekhout et al. 1992).

## Jelly Fungi as Hosts
...
- Two species each of Platygloea (Achroomyces) and Tremella were found on or in the hymenium of Dacrymycetaceae

This pattern of jelly fungi serving simultaneously as both parasites and hosts underscores the complex web of mycoparasitic interactions in fungal communities, where trophic roles can be easily reversed depending on the species encounter.

## Ecological Significance

Tremellalean mycoparasites play important roles in forest ecosystems by:
