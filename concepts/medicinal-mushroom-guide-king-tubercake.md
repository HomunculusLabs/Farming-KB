...
- **Native range:** Tropical West and Central Africa (Nigeria, Cameroon, Ghana, Congo, Sierra Leone).
- **Also found:** Southeast Asia (introduced or naturally distributed in Thailand, Malaysia, India).
...
- **Fever reduction:** Decoctions used as antipyretics for malaria and other fevers.
- **Pain relief:** Anti-inflammatory and analgesic preparations.
- **Childhood ailments:** Traditional treatment for childhood malnutrition and weakened immunity.
- **Reproductive health:** Used traditionally for menstrual disorders and fertility support.
...
### Lectin Research
- Isolated lectins demonstrate selective cytotoxicity against cancer cells while sparing normal cells.
- Activate lymphocytes and enhance immune surveillance.
- Anti-microbial activity against bacteria and fungi.

## Anti-Tumor Research

- Sclerotium polysaccharides demonstrated significant tumor inhibition (40-60%) in animal models.
- Proteoglycans induce apoptosis in cancer cell lines (breast, colon, lung).
...
- Reduces total cholesterol and LDL cholesterol in animal models.
- Increases HDL cholesterol ratios.
- Mechanism involves hepatic cholesterol synthesis inhibition and increased fecal bile acid excretion.

### Hepatoprotective Effects
- Protects liver from toxin-induced damage (CCl4, acetaminophen models).
- Reduces liver enzyme elevation (ALT, AST).
- Anti-fibrotic effects reduce liver scarring.
...
Both the sclerotia and fruiting bodies are nutritious:

- **Sclerotia:** High in complex carbohydrates (40-50% dry weight), moderate protein (10-15%), low fat.
- **Fruiting bodies:** Higher protein content (20-30% dry weight) with all essential amino acids.
- Rich in dietary fiber, potassium, phosphorus, iron, and zinc.
- Good source of B vitamins.

## Preparation Methods

### Sclerotium (Tuber) Preparation
...
1. Hot water extraction of sclerotium powder (60 min).
2. Alcohol maceration of spent material (4-6 weeks).
3. Combine extracts for comprehensive preparation.

## Dosing Guidelines

- **General health:** 2-4g dried sclerotium powder per day.
- **Immune support:** 3-6g dried sclerotium powder daily.
- **Blood sugar management:** 3-5g sclerotium powder per day (based on animal studies, extrapolated).
- **Tincture:** 2-3ml dual extract, 2-3 times daily.
- **Traditional decoction:** 20-30g fresh sclerotium per liter of water.
- **Culinary (fruiting bodies):** 100-200g fresh per week.
