...
The coupling of geotropism to spore production has clear adaptive value for coprophilous (dung-inhabiting) species. As Plunkett (1961) noted, the negative geotropic response is particularly useful for lignicolous or coprophagous species because their habitat is unstable and effective spore dispersal demands a horizontal pileus oriented above the substrate surface. By only switching to upward growth when spores are ready for release, the mushroom ensures that:

- The stipe has reached sufficient height above the substrate for effective spore dispersal into air currents.
