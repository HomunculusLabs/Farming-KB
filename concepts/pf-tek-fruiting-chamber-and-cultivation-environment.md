---
title: PF Tek [[comparison-laminar-flow-hood-vs-fruiting-chamber]] and Cultivation Environment
concept_type: topic
...
The PF TEK later incorporated the **perlite humidification technique**, which became the standard for home cultivation:
...
Mushrooms require fresh air to develop properly:

- Mycelium produces CO2 during growth; high CO2 concentrations suppress [[bloomfield-mushroom-formation-fruiting-body-development-cultivation]] and produce elongated, abnormal stems
- **Fanning**: The terrarium should be fanned (lid removed and air circulated) 2–4 times per day
- **Ventilation holes**: Small holes in the terrarium lid provide passive air exchange
- Balance must be maintained between air exchange (which reduces humidity) and humidity retention

### Light

Mushrooms use light as a directional cue (not for photosynthesis):

- **Indirect light**: Ambient room light is sufficient
- **Duration**: 12 hours on / 12 hours off, or ambient room lighting
- **Direction**: Position light above terrarium for upright growth; avoid direct sunlight

### Temperature

Fruiting temperature is slightly lower than colonization: **70–75°F (21–24°C)** is optimal. The temperature drop from incubation to fruiting serves as a trigger for pin formation. Normal room temperature is adequate; avoid temperatures above 80°F.

## The Time Scale of Mushroom Growth

### From Inoculation to Harvest

The PF TEK provided approximate timelines for the complete cultivation cycle:

1. **Inoculation to visible colonization**: 3–7 days
2. **Full colonization**: 14–28 days from inoculation
3. **Introduction to fruiting chamber**: Day 0 of fruiting
4. **Pin formation**: 5–10 days after introduction to fruiting conditions
5. **Mature mushrooms**: 5–7 days after pin formation
6. **Total time**: Approximately 4–6 weeks from inoculation to first harvest

### Flush Cycles

Each substrate cake can produce multiple crops ("flushes"): the **first flush** is typically largest, the **second flush** smaller, and a **third flush** further diminished. Many cultivators stop after 2–3 flushes.

## Harvesting and Preservation

### Harvest Timing

Mushrooms should be harvested just before or as the **veil tears** — the thin membrane connecting the cap to the stem:

- Harvesting at this stage maximizes potency (psilocybin content peaks before full cap expansion)
- If the cap fully expands and drops spores, the mushroom is past prime for potency but still active
- Harvest by grasping the base of the stem and gently twisting and pulling

### Cool Desiccation (Drying)

The PF TEK described a simple drying method:

- **Cool desiccation**: Place harvested mushrooms on a screen or paper towel in a dry, well-ventilated area
- Use a desiccant (silica gel, Drierite) in a sealed container for final drying
- Properly dried mushrooms should be crisp and snap cleanly when bent
- Dried mushrooms retain potency for months to years if stored in a cool, dark, airtight container
