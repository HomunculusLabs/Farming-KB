---
title: Holmgren Integrated Land Uses and Land Tenure
created: 2026-04-18
updated: 2026-04-18
type: concept
...
## Agroforestry and Integrated Tree Systems

Since the mid-1980s, the idea that trees planted on farms for catchment protection could be equally productive elements in the farm economy has taken root across Australia. Agroforestry combinations include:

- Timber and pasture
- Timber and fodder tree species
- Seed and honey production
- Dryland tree crops such as olives and carobs

These alternatives to annual crops and pastures represent the practical application of integrated land use thinking. The keyline-design|keyline concept of storing surplus run-off water in dams to irrigate pasture and rapidly build soil fertility is another example of integrated catchment-based design.

## Source

From *Permaculture: Principles and Pathways Beyond Sustainability* by David Holmgren, Principles 3 (Obtain a Yield), 7 (Design from Patterns to Details), and 8 (Integrate Rather Than Segregate).
