...
processes that parallel traditional alchemical methods. The term bridges
botanical extraction science with the philosophical traditions of alchemy,
emphasizing purification, transformation, and the pursuit of medicinal or
spiritual essences.
...
2700 BCE, where the plant was valued for both medicinal and ritual purposes.
The concept of extracting and concentrating the "essence" of cannabis aligns
directly with alchemical philosophy, which sought to isolate the purest form of
substances.
...
The alchemist's quest for the "philosopher's stone" finds its botanical
parallel in the pursuit of the purest possible cannabis extract, one that
captures the full spectrum of therapeutic compounds without unwanted
contaminants.

## Modern Cannabis Extraction Methods

Contemporary extraction techniques have evolved far beyond manual methods while
still embodying alchemical principles:

- **Solvent extraction**: Using ethanol, butane, or CO2 to dissolve and
