...
boil-a-bag substrate is deliberately simple, and its reliability depends entirely
on the sterilization protocols that surround it.
...
- **Exhaled breath**: The human breath carries moisture, bacteria, and fungal
  spores. Jarrold specifically recommends wearing a breathing mask during
  inoculation to prevent the cultivator's own exhaled microbes from settling onto
  sterile surfaces.

- **Unsterilized tools**: Syringe needles, scalpels, jar rims, and any implement
  that contacts the spore solution or substrate must be sterilized before each use.
  A single contaminated needle can introduce millions of competing organisms.
...
while the second 30-minute cycle catches heat-resistant endospores that may have
survived the initial pass. Endospores of bacteria such as Bacillus species are
notoriously resistant and can germinate after a single short sterilization, leading
to bacterial contamination that ruins the bag. The two-stage method is a practical
home cultivator's approximation of fractional sterilization used in laboratories.

The pressure cooker must reach and maintain a steady 15 psi throughout each cycle.
Fluctuations in pressure or premature removal of heat can leave cold spots inside
the bags where organisms survive. Bags should be packed loosely enough for steam
to circulate freely, ensuring even heat penetration.

## Cooling Before Inoculation

After the sterilization cycle is complete, the bags must cool to near room
temperature before inoculation. This is critical for two reasons. First, injecting
spore solution into a hot substrate will kill the spores outright. Second, a hot
bag creates convective air currents as it cools, drawing ambient air -- and the
airborne contaminants it carries -- through the filter and potentially into the
sterile substrate interior. Jarrold recommends allowing the bags to cool in a
clean, still-air environment, preferably the same space where inoculation will
later take place.

## Flame Sterilization of Needles and Tools

Between every single inoculation -- not just between batches, but between each
individual injection -- the syringe needle must be flame-sterilized. Jarrold
instructs the cultivator to pass the needle tip through a flame until it glows
