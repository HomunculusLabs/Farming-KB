...
The lignocellulose degradation strategy of soft rot fungi is distinct
from both white rot and brown rot approaches. White rot fungi deploy an
aggressive oxidative enzymatic system (LiP, MnP, laccase) that can
attack all major wood components simultaneously, including lignin. Brown
rot fungi use a non-enzymatic Fenton chemistry system to depolymerize
cellulose while largely leaving lignin behind as a modified residue.

Soft rot fungi take a slower, more targeted approach. They primarily
attack polysaccharide components of the cell wall, especially cellulose
and hemicellulose, through enzymatic hydrolysis. Their lignin
degradation capability is limited but measurable, with better lignin
...
environmental contaminants. Methylation of the 2-chloro-1,4-dihydro-
quinone intermediate formed during 2,4-D (a widely used herbicide)
degradation by P. chrysosporium appears to serve as a mechanism for
regenerating a substrate susceptible to attack by LiP and MnP (Valli &
Gold, 1991). This suggests that methylation plays a dual role: it can
directly detoxify harmful phenolic intermediates while simultaneously
converting them into forms that are more amenable to further oxidative
degradation by the fungal enzyme system.

## Soft Rot Fungi in Contaminated Environments

Soft rot fungi are particularly relevant to bioremediation in certain
