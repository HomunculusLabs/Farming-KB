...
- **Data complexity**: Multi-omics datasets require advanced bioinformatics
- **Functional annotation**: Many environmental fungal genes lack
  annotation
- **Standardization**: Lacking protocols for remediation contexts
- **Cost**: High-throughput technologies remain expensive for routine use
