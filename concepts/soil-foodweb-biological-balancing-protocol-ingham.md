...
- Increase fungal foods to shift the fungal:bacterial ratio
...
- Reduce tillage ([[fukuoka-why-tillage-destroys-soil]] fungal networks)

**If fungi are too high**:
- Reduce woody mulch and fungal food additions
- Increase bacterial foods
- Light tillage can set back fungal biomass if needed

### Step Five: Mycorrhizal Colonization
...
- Continue fungal food additions and minimize soil disturbance

### Steps Six Through Eight: Protozoa

**Assessment**: Flagellate, amoeba, and ciliate numbers are compared to desired minimum levels.

**If protozoa are too low**:
- Add protozoan inoculum from good compost, especially worm compost
- Commercial protozoan products are available
- Each group (flagellates, amoebae, ciliates) needs to be above minimum levels
