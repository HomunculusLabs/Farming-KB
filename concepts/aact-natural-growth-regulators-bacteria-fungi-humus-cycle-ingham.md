---
title: Natural Growth Regulators and the Bacteria-Fungi Humus Cycle in AACT
...
Decomposition of organic matter in soil follows a predictable biological succession:

1. **Bacteria go first**: Bacteria rapidly colonize fresh organic matter, consuming the simple, easy-to-use food resources—simple sugars, amino acids, soluble carbohydrates, and proteins. This initial bacterial burst generates heat in compost piles and represents the fastest phase of decomposition.

2. **Fungi follow**: As bacteria deplete the simple food resources, fungi become dominant. Fungi produce enzymes that can break down more complex compounds—cellulose, lignin, and other recalcitrant materials—that bacteria cannot access.

3. **Humus formation**: The complex "waste products" of fungal metabolism are what we call humus, or more specifically, humic acid. This is the stable, long-lasting organic matter that gives healthy soils their dark color, nutrient-holding capacity, and structure.

### Humus vs. Humic Acid

Ingham draws an important distinction:

- **Humus** includes all of the organic components of soil: living organisms (bacteria, fungi, protozoa, nematodes), roots, simple organic matter (sugars, amino acids, proteins, carbohydrates, lipids), intermediate compounds (polysaccharides, amino-sugars, hormones, fats, lipopolysaccharides, fulvic acids), and complex fractions (humic acids bound in three-dimensional structures)
- **Humic acid** refers specifically to the most complex fraction—highly branched, tertiary molecular complexes that are extremely stable and resistant to further decomposition

### The Role of Fungi in Humus Production

Fungi are the primary architects of humus:

- Fungal enzymes (cellulases, ligninases, peroxidases) break down complex plant materials
- Fungal hyphae physically bind organic particles together as they grow
- Fungal metabolites become the building blocks of humic acids
- Earthworms and microarthropods assist by grinding organic matter and distributing fungal hyphae
- Real humic acid requires ALL of these organisms to be present

### Favoring Fungi in Composting

A critical insight from Ingham's work is that most composting operations do not favor fungi from the start. This means the decomposition process takes longer and produces less humus than it could. To accelerate humus production:

- Favor fungi from the very beginning of the composting process
- Fungi can break down ligno-cellulosic waste without high temperatures
- The addition of molasses to compost piles favors fungi over bacteria and speeds up the process
- Fungal foods (humic acids, wood chips, leaf litter) in the initial compost mix shift the balance toward fungi
- Avoid excessive nitrogen that would favor bacterial over fungal dominance

## AACT Applications for Growth Regulation and Humus Building

### Delivering Growth Regulator Producers

AACT can be used to inoculate root zones with the organisms that produce natural growth hormones:
