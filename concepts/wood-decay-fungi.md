...
### Soft Rot
Soft rot is caused by ascomycetes and deuteromycetes, typically in wet or
aerated wood. They create cavities within the secondary cell wall. Important
in marine and freshwater environments where basidiomycetes cannot survive.

## Enzymatic Machinery

Lignin degradation is remarkable because lignin is an irregular, recalcitrant
polymer with no defined repeating units. White rot fungi address this through
a suite of nonspecific oxidative enzymes:
...
- **Phalanx strategy**: Dense, slow-expanding front with high resource
  investment per unit area. Effective in resource-rich environments.
- **Guerrilla strategy**: Rapid, extensive exploration with sparse
  investment. Better for finding widely scattered resources.

*Phanerochaete velutina* exhibits plastic switching between strategies
depending on resource distribution, with mycelial cords connecting multiple
wood resources acting as transport highways.
