...
that time. The Gartz et al. study was the first to systematically demonstrate that
brassinosteroids have potent biological activity in the fungal kingdom.

## The Cross-Kingdom Activity Spectrum

The observation that brassinosteroids stimulate fungal growth fits into a broader
pattern of plant-derived compounds exhibiting biological activity across kingdoms:
...
- **Ethylene**: Fungal pathogens often manipulate plant ethylene signaling, and
  some fungi produce ethylene endogenously.
- **Salicylic acid and jasmonic acid**: Components of plant defense signaling that
  fungi have evolved to detect and counteract.
