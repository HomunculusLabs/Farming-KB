...
sources: []
---
Fungal mycoparasitism refers to the direct antagonistic interaction in which
one fungal species parasitizes another. These interactions are central to
biocontrol, where beneficial fungi are deployed to suppress plant pathogenic
fungi in agricultural and natural ecosystems.

## Types of Fungal Antagonism

Fungal antagonism encompasses a spectrum of mechanisms from indirect
...
Other mycoparasitic fungi include species of Gliocladium, Laetisaria, and
Sporidesmium, each with distinct mechanisms of action and host ranges.
