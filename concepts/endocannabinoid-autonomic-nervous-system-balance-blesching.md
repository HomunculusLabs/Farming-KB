...
The endocannabinoid system (ECS) plays a central role in modulating the **autonomic nervous system (ANS)**, the involuntary division of the nervous system that controls heart rate, digestion, respiratory rate, and other automatic bodily functions. The ANS consists of two complementary branches — the **sympathetic nervous system** (SNS, "fight or flight") and the **parasympathetic nervous system** (PNS, "rest and digest") — and the ECS acts as a crucial bridge between these opposing forces, maintaining homeostatic balance.
...
The parasympathetic branch promotes recovery, repair, and calm:
