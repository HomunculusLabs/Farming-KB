...
- Decomposing roots release bulk cell contents rather than selective
  exudates
...
The Cellvibrio finding highlights the critical importance of sampling timing
in plant microbiome studies:

1. **Post-harvest sampling** captures a transitional microbiome that
   reflects both the living plant community and early successional decay
   communities. This can confound interpretation of endorhiza data.
2. **Active growth sampling** provides a more accurate picture of the
   functional plant-microbe interactions that occur during the plant's life.
3. **Time-series sampling** across the growing cycle is needed to fully
   understand how the Cannabis endorhiza community changes with plant
   development, flowering, and senescence.

Winston et al. specifically recommend future work with time-series sampling
of endorhiza communities across the reproductive cycle of Cannabis to
understand natural variation and avoid the confounding effects of post-harvest
decay on microbiome characterization.
