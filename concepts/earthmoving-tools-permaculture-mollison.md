...
useful here, one digging in, the other pulling over in a
see-saw motion. Try it, and be surprised at how rhythm and
cooperation will move mountains.
However, the exigencies of education have meant that designers
and architects have seldom been personally involved in earth
moving. A brief description and nomenclature of machinery and
modern tools is not only needed but essential to earth design,
given that when we move earth we should do so for permanent and
beneficial ends. We can revolutionise eroded and arid landscapes
...
## Finishing Tools
Rakes and rollers are the tools for finishing excavated earth.
Compaction is only necessary where traffic or water retention is
intended. Care must be taken to compact only 15-30cm (6-12
inches) of soil thoroughly at a time. Even very heavy machines
