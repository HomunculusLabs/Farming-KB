---
title: Mycoforestry Applications
created: 2026-04-14
updated: 2026-04-14
type: concept
tags: [reference]
...
Mycorrhizal fungi are essential for establishing vegetation on contaminated and degraded lands:
- **Ectomycorrhizal fungi (ECM)** associate with tree species (pine, spruce, oak, birch) and improve seedling survival on metal-contaminated soils
- **Vesicular-arbuscular mycorrhizal (VAM) fungi** colonize grasses and many tree species, enhancing tolerance to heavy metals and radionuclides
- ECM fungi exhibit extensive colonization of spruce at contaminated sites, with up to 90% of root tips mycorrhizal
- Six ECM morphotypes identified at petroleum-contaminated sites, with Laccaria species showing best colonization

## Heavy Metal Tolerance in Forest Fungi

Forest fungi show significant genetic variation in metal tolerance:
- Pisolithus tinctorius isolates from contaminated coal mine sites show varied Al tolerance (EC50 values 0.2-74 mM vs. 0.04-0.07 mM for wild-type)
- Genetic variation in Suillus luteus populations is larger at polluted sites
- Oidiodendron maius isolates from polluted soils cluster in distinct genetic groups
- ECM fungi from arsenic mine spoils contribute to plant arsenate tolerance

Glomalin from VAM fungi sequesters Cu, Cd, Pb, and Mn, acting as a long-term soil biostabilizer that supports reforestation on contaminated sites.
...
## Reforestation of Contaminated Land

Mycorrhizal inoculation improves reforestation success on contaminated sites:
- Inoculated plants show enhanced nutrient acquisition despite metal toxicity
- Fungal hyphae extend effective root absorption surface area
- Mycorrhizal plants accumulate higher aboveground biomass
- VAM fungi from metal-contaminated sites are pre-adapted and more effective than commercial inocula

Grasses inoculated with Glomus mosseae or G. intraradices remove 26-72% of 137Cs and 90Sr from contaminated soil, demonstrating that mycoforestry approaches can remediate radionuclide contamination while establishing vegetation cover.

Successful reforestation of contaminated sites requires careful species-fungus matching. Pisolithus tinctorius has been widely used for reforesting mine spoils and degraded sites because of its broad host range among pines and oaks and its tolerance of low pH, high metals, and low fertility. Suillus species are particularly effective with pines on metal-contaminated sites, while Laccaria species perform well on petroleum-contaminated soils. Container-grown seedlings inoculated at the nursery stage establish more effectively than field-inoculated bare-root stock, because the mycorrhizal association develops before outplanting stress occurs.

## Mycoforestry in Agroforestry Systems

Mycoforestry principles extend naturally into agroforestry, where tree-crop integration benefits from fungal symbiosis:
...
Several documented field applications demonstrate the commercial viability of mycoforestry:
...
- **Cost-effectiveness:** For sites with moderate contamination levels, conventional remediation methods (excavation, chemical treatment) may be faster and more cost-effective. Mycoforestry is most economically competitive for large-area, low-to-moderate contamination where establishing permanent vegetation cover is also a management objective.
- **Monitoring difficulties:** Assessing fungal colonization and remediation progress in the field requires specialized molecular tools. Traditional visual assessment of plant health provides only indirect evidence of mycoforestry effectiveness.
- **Species selection complexity:** Optimal fungal species vary by site conditions, contaminant type, and target tree species. General-purpose inocula may underperform site-specific selections, but site-specific screening adds cost and time to project planning.
...
Fungal mycelia contribute to soil structure on degraded sites:
- Hyphal networks bind soil particles, reducing erosion
- Glomalin contributes to soil aggregate stability
- Mycorrhizal networks connect plants, distributing resources across the community
- Saprotrophic fungi decompose organic amendments, building soil organic matter

## Forest Waste Management

Fungal processes add value to forestry waste streams:
- Spent mushroom substrate from cultivation of forest-origin mushrooms (shiitake, oyster) serves as inoculum for bioremediation
- Wood-decay fungi degrade treated wood waste containing preservatives (CCA, PCP)
- Composting of forest residues with fungal inocula produces pathogen-free soil amendments
- Fungal bioleaching recovers metals from ash and processing residues

## Integration with Phytoremediation

Mycoforestry combines fungal and plant remediation capabilities:
- Fungi degrade organic contaminants that plants cannot metabolize directly
- Plants provide carbon to fungal symbionts through root exudates
- Mycorrhizal networks extend the remediation zone beyond individual root systems
- Fungal enzyme systems make organic contaminants more bioavailable for plant uptake or microbial degradation
