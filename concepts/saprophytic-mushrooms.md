...
The ease of cultivation varies by decomposer category:

- **Primary decomposers on wood** (shiitake, oyster,
  reishi, lion's mane): Grown on logs, stumps, or
  sterilized sawdust blocks. These are the most commonly
  cultivated gourmet and medicinal mushrooms.

- **Primary decomposers on straw** (oyster, almond
  mushroom): Grow readily on pasteurized straw, making
  them accessible to beginners.

- **Secondary decomposers** (button, portobello,
  cremini): Require composted substrate, making them more
  complex to cultivate but economically significant.

- **Tertiary decomposers** (morels): Among the most
  difficult to cultivate, often requiring very specific
  environmental conditions to fruit.

## Habitat Preferences

Saprophytic mushrooms inhabit virtually every terrestrial
environment. Their habitat preferences determine which
species can be found in a given location:

- **Forest dwellers**: Species that decompose fallen
  trees and branches in forest ecosystems. These include
  many polypores and gilled mushrooms that fruit on
  logs and stumps.

- **Grland species**: Mushrooms that decompose grasses
  and herbaceous plant debris in meadows and pastures.
