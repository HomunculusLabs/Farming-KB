...
observation to fully unravel.

## Uredial Stage — The Fungal Photocopier

The most destructive phase of wheat rust is the uredial stage. Uredospores
are produced in brick-red pustules (uredinia) that erupt through the surface
of wheat stems and leaves. Each uredospore is a genetic clone — a faithful
photocopy of the parent — and can infect another wheat plant within hours
...
ridges approximately 0.5 micrometers in width that surround the stomata. The
growing hypha essentially "reads" the microscopic topography of the leaf,
changing direction to grow over the stomatal opening and then penetrating
into the leaf's interior.

## Haustoria — The Placenta of Fungi

Once inside the leaf, the fungus forms specialized feeding structures called
haustoria that penetrate the walls of living plant cells without killing
them. Haustoria function as a placenta-like interface, drawing nutrients from
the host cell while keeping it alive. This intimate parasitic relationship
...
are diploid — each contains two nuclei that will eventually fuse and undergo
meiosis, setting the stage for the sexual phase of the life cycle on the
alternate host.

## Basidiospores and Proof of Basidiomycete Affinity
