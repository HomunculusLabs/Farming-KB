...
### Protein
- Required for growth, milk production, reproduction, and immune function.
- Expressed as Crude Protein (CP) percentage.
...
- Deficiency: weight loss, reduced production, poor reproduction, cold
  sensitivity.
- Excess: obesity, health problems (especially in horses and breeding
  animals).

### Minerals
- **Macrominerals:** Calcium (Ca), Phosphorus (P), Magnesium (Mg), Potassium
  (K), Sodium (Na), Chlorine (Cl), Sulfur (S).
- **Microminerals:** Iron, Zinc, Copper, Manganese, Selenium, Iodine,
  Cobalt, Molybdenum.
...
- Always provide free-choice loose mineral formulated for the specific
  species. Block minerals are less effective (animals cannot consume enough
  to meet requirements).

### Vitamins
- Fat-soluble: A, D, E, K. Stored in body fat.
- Water-soluble: B-complex, C. Must be supplied daily (ruminants synthesize
  B vitamins in the rumen).
- Vitamin A: critical for vision, immunity, reproduction. Found in green
  forage. Deficient in stored hay after 6 months.
- Vitamin D: synthesized in skin with sunlight. Critical for calcium
  absorption. Deficient in animals kept indoors.
- Vitamin E: antioxidant, works with selenium. Deficient in old hay. White
  muscle disease in young animals.
- Supplement vitamins A, D, and E during winter or when feeding old hay.

## Common Feeds

### Grains (Energy Sources)
- **Corn:** Highest energy (TDN ~90%). Most widely fed grain. Good for
  fattening all species. Low in protein (9-10%).
- **Barley:** Moderate energy (TDN ~84%). Higher protein than corn (11-12%).
  Good for cattle and pigs. Can cause acidosis if fed at high levels.
- **Oats:** Lower energy (TDN ~75%), higher fiber. Very palatable and safe
  (low risk of digestive upset). Good for young animals and horses.
- **Wheat:** Good energy (TDN ~87%). Can cause digestive issues if ground
  too fine or fed at high levels. Limit to 50% of grain ration.
- **Sorghum (milo):** Similar to corn. Lower energy if tannin content is
...
- Pasture, hay, haylage, and silage are the foundation of ruminant diets.
- Aim for forage to provide 60-100% of ruminant nutrition.

### Byproduct Feeds
- **Whey:** From cheese making. Excellent protein and energy for pigs.
  Can constitute 20-30% of liquid diet.
- **Brewers grains:** Wet or dried. Good protein (25% CP) and energy.
  Excellent cattle feed.
- **Apple pomace:** Pressed apple residue. Good energy for cattle and pigs.
  Ferments well.
- **Vegetable scraps:** 10-20% of diet for pigs and poultry. Balance with
  other feeds.
- **Bakery waste:** Bread, dough, pastries. High energy. Feed in moderation.

### Silage
- Fermented forage (corn, grass, or small grain). 30-40% dry matter.
- Excellent winter feed for cattle. Maintains quality better than dry hay.
- Requires chopper, packer, and storage (bunker silo, silage bags, or
  wrapped bales).
- Corn silage: 7-9% CP, 70-75% TDN. Very high energy. Excellent for
  finishing cattle.
- Grass silage: 10-15% CP, 60-65% TDN. Good for maintenance and milk
  production.
