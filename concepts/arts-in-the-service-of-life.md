...
In traditional societies, art was not created for aesthetic pleasure alone. Its primary purposes were:
...
- The **jingles of advertisements** replacing meaningful song
- **Purely decorative and trivial patterns** replacing information-rich designs
- **Education divorced from relevant long-term observations** of the natural world

The destruction of tribal art has served not just monetary gain but the replacement of public information by "an exotic, secretive, irrelevant and basically uninformed centralised belief system." Book-burning and image-breaking represents the reaction of the alienated or intellectually-deprived to accumulated wisdom.
...
Flowforms are artificial replicates of the rock forms carved by turbulent streams, cast in concrete or fibreglass. Stacked in series below sewage pipe outfalls or above fish ponds, they efficiently mix air and water by inducing turbulence in flow. Three distinct mixing effects occur:

1. **Plunge or vertical overturn** — fluid drops from one basin to another, entraining air
2. **Figure-8 lateral flow** — water courses around the basins in a figure-8 pattern
3. **Interaction between vertical and lateral flows** — thecoursing water deflects the vertical drop flow, switching it from side to side in a regular rhythm

Within these major turbulence patterns (portrayed by Leonardo da Vinci and analyzed through catastrophic theory by Chappell), distinct vortices, counterflows, overfolds, and cusps further mix air and water at the edges of the basins and in the main flow stream.
...
Mollison issues a dual challenge:
...
### To Educators
- Revive meaningful **geometries, songs, and dances** that gave work and life meaning
- Develop **pattern education** that gives every member of society access to profound concepts
- Recognize that pattern, song, and dance are "the easiest of things to accurately reproduce" — unlike prose or tabulated data
