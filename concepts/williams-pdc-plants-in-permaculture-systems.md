...
- **Niche Species**: Complex plants that thrive within narrow
  microclimates
- **Appropriate Species**: Not native but grow well within local
  conditions without destabilizing the ecology

## Growing Beyond the Ground

Plants do not have to be grown only in the ground. Alternative growing
strategies include:
