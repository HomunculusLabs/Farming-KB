...
## The Range of the Continuum

McKenna describes the tryptamine continuum as having a range that corresponds roughly to dosage.

At low doses, the continuum manifests as enhanced pattern recognition, heightened color perception, and a generalized feeling of increased cognitive fluency.

At medium doses, the experiencer begins to access what McKenna calls "the other"—a distinct phenomenological space that is qualitatively different from ordinary consciousness.
...
McKenna reports that the spaces within the hypercontinuum have their own physics—regularities and constraints that are consistent across experiences and experiencers.

Objects in these spaces have mass, texture, and spatial extension that obey internal laws even when those laws differ from the physics of ordinary space.

The visual field is described as comprising "morphing, tessellated, multicolored, three-dimensional spaces" that exhibit mathematical regularities suggestive of fractal geometry.

Time within the hypercontinuum does not flow linearly; McKenna describes it as "a standing wave" or an "eternal present" in which past, present, and future coexist.

The physics of the other is not chaotic but lawful—there are rules that can be learned through repeated exposure, just as one learns the rules of any new environment.

This internal consistency is one of the strongest arguments against reducing the experience to mere hallucination: hallucinations typically lack the kind of structural regularity that characterizes the hypercontinuum.

## Entities Within the Continuum
...
The consistency of entity reports across independent experiencers—documented by Strassman, Shanon, and others—suggests that the entities are a stable feature of the hypercontinuum rather than idiosyncratic projections.

## The Continuum as Informative

McKenna insists that the hypercontinuum is not merely perceptual but informative—it contains information that the experiencer did not possess before the experience and could not have generated from memory or imagination.

This information is conveyed not through language in the ordinary sense but through what McKenna calls "direct transmission"—a form of communication that bypasses the usual linguistic channel.

The informational content of the experience includes what McKenna describes as "the teaching": insights about the nature of consciousness, time, and reality that have the quality of revealed knowledge.

The informative character of the experience distinguishes it from ordinary hallucination, which typically rearranges or distorts information already present in the mind.

McKenna argues that the hypercontinuum functions as a kind of library or database—a repository of information that exists independently of any individual mind but can be accessed through the tryptamine gateway.

The implication is that the universe contains vastly more information than is accessible to ordinary consciousness, and that tryptamines provide a means of accessing at least some of this hidden information.
...
The landscape is invisible not because it is distant or hidden but because the human perceptual apparatus is not normally tuned to receive information from it.
