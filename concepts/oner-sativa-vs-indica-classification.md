...
The Rev uses a canine metaphor to illustrate the difference:
sativas are like wolves -- wild, adaptable, and requiring skill
and understanding to work with effectively. Indicas are like
domesticated dogs -- smaller, more manageable, and bred for
specific traits that make them easy to keep. This metaphor captures
not just the physical differences but the fundamentally different
relationships each type demands from its cultivator.
...
forgiving of grower errors. Their compact structure, rapid flowering,
and heavy yields make them ideally suited to the commercial indoor
environment. This practical superiority in indoor settings is the
primary reason indicas dominated the market for so long.
...
Beyond growth characteristics, the sativa-indica distinction is
