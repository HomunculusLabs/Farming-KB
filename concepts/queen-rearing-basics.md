...
- **Genetic selection** — choose for traits like gentleness, productivity,
  disease resistance, and Varroa tolerance (VSH, hygiene)
- **Self-sufficiency** — not dependent on commercial availability or shipping
  schedules
...
2. Find the old queen and move her to a new hive with 3-4 frames of brood,
  2 frames of honey/pollen, and shaken bees from additional frames
3. The parent colony is now queenless; ensure it has eggs or very young
...
5. **Move to finisher colony** — transfer cell bars to a queenright colony
   above a queen excluder, or to a second queenless starter, for the
   remaining development period (about 10 days)
...
2. After 3 days, the cell cups with eggs are transferred to a cell bar
...
2. **Newspaper combine** — for combining a queenright nuc with a queenless
   colony; newspaper barrier allows gradual pheromone mixing
