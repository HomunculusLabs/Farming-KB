...
Fukuoka demonstrates that plowing is a self-perpetuating act of soil destruction: flooding a
field and stirring it with a plow makes the ground set hard as plaster, which then requires
...
Fukuoka's critique of the plow begins with a simple, undeniable physical observation: "Flood a
...
This passage reveals what Fukuoka sees as one of the fundamental delusions of modern agriculture:
...
only appear to be useful when one is in a hurry to get the job done," Fukuoka remarks, noting
that it takes over two acres of pasture to feed just one horse or cow — land that could feed
fifty to a hundred people if nature's own powers were fully utilized instead.
