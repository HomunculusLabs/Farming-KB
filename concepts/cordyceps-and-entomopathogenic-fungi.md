...
- Whiteflies, thrips, aphids, and other agricultural pests
- Colorado potato beetle
- Coffee berry borer
- Bed bugs, termites, and mosquitoes
...
6. After death, fungus emerges from cadaver and produces new conidia for dispersal
#### Commercial Products
- BotaniGard (LAM International)
- Naturalis-L (BioWorks)
- Mycotrol (BioWorks)
- Numerous products available globally for agricultural, horticultural, and residential use
#### Advantages
...
More host-specific than B. bassiana, primarily used against soil-dwelling scarab beetles (white grubs, Japanese beetle). Available commercially in Europe and Japan.
## Metarhizium
### Metarhizium anisopliae (Green Muscardine Fungus)
Another widely used entomopathogenic fungus, first described in the 19th century.
#### Host Range
Broad but somewhat more focused on soil-dwelling insects:
- Termites (extensively studied and used)
- Spittlebugs and planthoppers
- Grasshoppers and locusts
- Tick species (promising for biological control)
- Cockroaches
- Soil-dwelling beetle larvae
#### Commercial Products
- Met52 (Novozymes/BASF): used against ticks, termites, and agricultural pests
- Green Guard (Australian production): used against locusts and grasshoppers
- BioCane (Australia): used against sugarcane grubs
#### Special Features
- Root colonization: M. anisopliae can also colonize plant roots as an endophyte, providing protection against soil pests
- Some strains produce destruxins (cyclic depsipeptides) with insecticidal and antifungal properties
- Engineered strains have been developed for enhanced virulence (controversial; regulatory hurdles)
### Metarhizium robertsii
Formerly considered part of M. anisopliae, now recognized as a separate species. Strong root colonizer and effective against a wide range of soil insects. Interest is growing in its use as a dual-purpose biocontrol agent (protecting both above-ground and below-ground plant tissues).
...
- Common in subtropical and tropical environments
- Available commercially as NoFly and PFR-97
### Entomophthora muscae
- Causes "summit disease" in flies: infected flies climb to elevated positions, spread wings, and die
- Common natural regulator of housefly populations
- Not commercially produced due to difficulty of mass production
## Application Methods
### Conidial Sprays
