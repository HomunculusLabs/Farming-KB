...
1. Place the steamer basket or rack in the bottom of the pot and add water. The
   water level should be sufficient to generate steam for the full sterilization
   period but not so high that boiling water can slosh into the jar openings.
2. Load the prepared jars into the pot. The jars can sit in water as long as
   boiling water cannot enter the jars. Ensure the jars are stable and will not
   tip over during boiling.
3. Place the lid bands on loosely. This is critical: the loose bands allow
   steam to penetrate the jars quickly during the sterilization cycle. After
   sterilization and cooling, the bands are tightened for storage.
## The Sterilization Cycle
1. Heat the pot of water to a full boil.
2. Once boiling, reduce the heat to the lowest possible setting that
   maintains a gentle boil. Gas stoves are noted as the easiest to control for
   this purpose.
3. Keep the pot tightly covered and gently steam the jars for one hour. The
   emphasis is on gentle steaming rather than vigorous boiling. Overheating is
   explicitly warned against.
4. After one hour, remove the pot from heat and allow the jars to cool
   completely inside the covered pot. The jars must be cool to the touch before
   inoculation to avoid killing the spores.
## The Drying Problem
