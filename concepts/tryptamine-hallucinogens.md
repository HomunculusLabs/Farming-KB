...
The structural relationships among these compounds are not incidental. The close similarity between DMT and serotonin, and the fact that psilocybin is essentially phosphorylated DMT, suggests that tryptamine hallucinogens interact with the serotonergic system in ways that are fundamentally related to normal brain function.
...
3. **Action on language centers:** Tryptamines "invoke the Logos," working directly on the brain's language-processing areas to produce interior dialogue with what appears to be an alien intelligence
4. **Rapid onset and short duration:** Especially for smoked [[dmt]], which begins in approximately fifteen seconds and lasts five minutes
...
- [[self-transforming-machine-elves]] and other hyperdimensional entities
...
McKenna drew attention to the quantum mechanical nature of hallucinogenesis. Research by John Smythies, [[alexander-shulgin]], and others demonstrated that quantum mechanical correlates exist: moving a single atom on the molecular ring of an inactive compound can render it highly psychoactive.

McKenna saw this as "perfect proof of the dynamic linkage at the formative level between quantum mechanically described matter and mind."

## Hallucinogenic States and Quantum Physics

McKenna argued that the major quantum mechanical phenomena that humans experience, aside from waking consciousness itself, are dreams and hallucinations.

These states occur when sensory input is restricted, allowing interior images and psycho-physical processes to emerge at the quantum mechanical level. In this framework, the tryptamine hallucinogens are tools for accessing quantum-level informational processes that are normally filtered out by sensory consciousness.

## The Endogenous Hypothesis

A critical feature of tryptamine hallucinogens is that [[dmt]] is endogenous to the human brain, present in small amounts naturally. This, combined with the structural similarity between DMT and serotonin, suggests that the tryptamine state is not an artificial imposition on the brain but rather an amplification of natural neurological processes.
...
Tryptamine hallucinogens have been used in shamanic contexts across cultures. [[ayahuasca]] has been used in the Amazon for millennia, and psilocybin mushrooms were central to the mushroom cults of Mesoamerica until their suppression by the Spanish conquest.

McKenna argued that shamanism is primarily a set of techniques for exploring these dimensions, developed over millennia, and that shamans are "the true phenomenologists of this world" who understand plant chemistry while calling the results "spirits."

Shamans, in McKenna's experience, are characterized by "extraordinary centeredness" and intellectual sophistication. They are typically peripheral to the social life of their communities, called upon only in crises such as illness, death, psychological difficulty, or the need to predict weather.

They are "sacred" and therefore excluded from political power, sitting at the headman's side in council but returning to their huts at the village's edge afterward.
...
McKenna described a "black hole effect" surrounding tryptamine experiences, particularly [[dmt]]: the more one can articulate about the experience, the less others can understand.
