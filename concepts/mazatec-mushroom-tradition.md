...
- **Conocybe and Panaeolus species**: Occasionally used as alternatives

The Mazatec refer to the mushrooms generically as "nti-si-tho" ("the little
ones that spring forth") or by various respectful names that avoid speaking
their true name directly, reflecting the deep reverence in which they are held.

## The Velada Ceremony

The traditional Mazatec mushroom ceremony is called a velada (vigil), and it
is typically conducted at night by a curandero or curandera (healer). The
ceremony follows a structured format that has been passed down through
generations:

1. **Preparation**: The participants purify themselves through fasting and
   abstinence, typically for several days before the ceremony
2. **Setting**: The ceremony takes place in a darkened room, often with only
   a candle or small fire providing light
3. **Invocation**: The curandero offers prayers and invokes the spirits,
   saints, and sacred beings
4. **Distribution**: The mushrooms are consumed in pairs, with specific ritual
   words spoken as each pair is eaten
5. **Vigil**: The participants remain awake through the night, guided by the
   curandero through the visionary experience
6. **Interpretation**: In the morning, the curandero interprets the visions
   for healing or guidance

The mushrooms are typically consumed in a ritual manner -- often in pairs,
with the participant facing east. The curandero may consume mushrooms along
with the patient to guide and protect the experience.
