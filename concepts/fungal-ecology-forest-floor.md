---
title: Fungal Ecology on the Forest Floor
created: 2026-04-13
updated: 2026-04-13
type: concept
...
Fungi are primary agents of soil creation. As mycelium colonizes wood and organic matter, it converts solid material into humus -- the dark, organic component of soil. For every 12 inches of wood chips decomposed by oyster mushrooms, approximately 1-2 inches of soil are created after 4 years. Mycelium also produces glomalin, a sticky protein that aggregates soil particles, improving soil structure and water retention.
...
In old-growth forests, a continuous mycelial mat underlies the forest floor. This network extends for acres, connecting trees, decomposing organic matter, retaining water, and creating soil structure. When old-growth forests are cut, this ancient network is destroyed and takes decades or centuries to reform -- one reason why clear-cut forests recover so slowly.
...
Fungal Ecology Forest Floor is best evaluated by its role in whole-system design, not as an isolated technique. Key questions include where it fits in a site plan, which inputs it requires, what outputs it produces, and how its risks change across climates, seasons, and management styles.

## Implementation Notes

Start with small trials before relying on fungal ecology forest floor at production scale. Record timing, labor, water use, yields, failures, and maintenance needs so the practice can be adapted to local soil, weather, and household constraints.
