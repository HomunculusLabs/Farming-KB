...
The **rhizosphere** is the narrow zone of soil immediately influenced by plant
root secretions and root-associated microbial activity. First described by
...
Plant roots continuously release a diverse array of compounds into the
...
2. **Rhizosphere → Endorhiza** (Tier 2): Driven primarily by host genotype.
   Migration from rhizosphere into root tissue is selectively filtered by
   plant immune recognition and internal chemical environment.

Evidence from Cannabis shows that rhizosphere samples do not cluster
significantly by strain (ADONIS: R² = 0.11, p = 0.25), unlike endorhiza
samples. However, they also do not cluster as distinctly as bulk soil,
supporting their intermediate position.

## Sampling Methodology

Rhizosphere samples in the Winston et al. Cannabis study were collected by
shaking excavated roots into a sterile whirlpak bag to dislodge soil adhering
to the root surface. This soil — the rhizosphere — was separated from roots
that were subsequently rinsed for endorhiza extraction.

The method captures soil strongly influenced by root exudates but not soil
physically inside root tissue. Triplicate samples were taken from each plant
to account for spatial heterogeneity around the root system.

## Role of Mycorrhizal Fungi

Fungal saprotrophs and plant-mutualists play critical roles in rhizosphere
dynamics:
