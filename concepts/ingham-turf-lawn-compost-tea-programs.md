...
- Lack of diversity in fungal foods
...
- Weeds like dandelions outcompeting grass (indicator of low
  calcium availability to grass)
- Grass encroaching on tree and perennial areas (shift toward
  bacterial systems)
...
Application: 20 gallons of tea per acre, mixed with enough water
to cover the entire area evenly. De-chlorinate all water.

## Calcium and Lawn Health

There is little point adding calcium to soil unless fungi and
bacteria are improved as well. The biology must be balanced for
calcium to become plant-available. Ingham recommends adding calcium
to lawns with eggshells. The difference between lawns able to use
calcium vs. those without plant-available forms is quite noticeable
