...
This is the most detailed chapter and covers the foundational discoveries in plant light perception:
...
- A lightproof cap on the tip eliminates phototropism
- A clear glass cap on the tip preserves it
- Covering only the middle section has no effect

Julius von Sachs (1864) had previously established that blue light is the primary color inducing phototropism.
...
Scientists around WWII discovered that a brief flash of light during the dark period could manipulate flowering:

- Short-day plants fail to flower if given a night-break
- Long-day plants flower even in winter with a night-break
- Only red light (not blue or green) triggers the night-break response
- Far-red light reverses the red light effect
- The plant "remembers" the last color it saw

### Phytochrome Discovery

Warren L. Butler and colleagues (early 1960s) identified a single photoreceptor — phytochrome — responsible for both red and far-red responses. Phytochrome acts as a molecular switch: red light converts it to the active Pfr form, while far-red converts it to the inactive Pr form.

Chamovitz contrasts plant vision with human vision:

- Humans: ~125 million rods + 6 million cones per eye (~130 megapixels)
- Plants: No image formation, but perceive light direction, color, intensity, and duration
- Plants detect UV and far-red wavelengths beyond human visual range
- Phytochrome in leaves (not the tip) detects photoperiod cues for flowering
...
- Plants eavesdrop on neighbor's chemical signals
- Parasitic plants (dodder) "sniff out" host plants by detecting their volatile profiles
- Plant-plant warning signals through airborne VOCs

## Chapter 3: What a Plant Feels

Covers mechanoperception in plants:

- Thigmomorphogenesis — growth changes in response to mechanical stimulation
- Venus flytrap trigger hairs and rapid movement
- Mimosa pudica leaf folding response
