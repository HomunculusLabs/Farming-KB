...
The synthesis of urea has enabled humanity to produce any
organic material desired. Protein synthesis enables man-made
meat to be fabricated. Butter and cheese can be made from
petroleum. The level of technology needed to create a single
persimmon seed or leaf is incomparably greater than that used
to launch a rocket into outer space.

## The Vegetable Factory Delusion
