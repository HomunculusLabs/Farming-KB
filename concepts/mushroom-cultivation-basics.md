...
6. **Incubation** — grain fully colonizes (spawn)
7. **Laying out spawn** — onto trays OR inoculation into bulk substrate
8. **Casing** — covering with moist peat/soil mixture (for some species)
9. **Initiation** — lowering temperature, raising humidity to 95%, increasing fresh air, introducing light
10. **Cropping** — maintaining conditions, harvesting mushrooms in flushes
...
- **Inoculate at least 3 plates** to improve success odds
- Multispore = many strains mixed; some may be incompatible or low-yielding
- Germination visible in 3-7 days as thread-like grayish strands becoming white

### From Tissue (Cloning)
- Cut interior flesh from a fresh mushroom (within 24-48 hours of picking)
...
- ph range 5.5-7.5 suits most species; adjust with HCl or NaOH if needed
- Sterilize at 15 psi for 30 minutes (never exceed 250°F or sugar caramelizes)
- 1 liter fills ~30 petri dishes (100 x 15mm)
- At altitude: increase 5 psi per 1000ft above sea level

## Sterile Technique

### The Five Sources of Contamination
1. The immediate external environment (airborne spores)
...
- Remove all rugs, curtains, cloth materials
- Clean with mild disinfectant; high-gloss white paint helps
- Create an antechamber (airlock) at the entrance
- Equip: table, flame source, 10% bleach spray, petri dishes, labels, scalpel, inoculating loop
- **Spray 10% bleach and wait 15 minutes** before every session
- Clean MORE in spring/summer when airborne spore counts are highest
...
### Preparation
- Use rye, millet, or wheat berries (rye is standard)
- Soak grain 12-24 hours, boil until grains swell but don't burst
- Drain, load into jars (2/3 full), cover with filter/breathable lid
- Sterilize at 15 psi for 60-90 minutes
- Inoculate with agar wedge or grain-to-grain transfer

### Grain-to-Grain Transfer
- Once a jar is fully colonized, it becomes spawn
- Transfer grain pieces to new sterilized grain jars
- One colonized jar can inoculate 10 new jars
- Fastest expansion method — mycelium jumps from grain to grain

## Substrates

### Wood-Based Substrates (Lignicolous Species)
- **Best for**: Shiitake, oyster, enoki, reishi, lion's mane
...
- Fresh hardwood logs, 3-6 inch diameter, 3 feet long
