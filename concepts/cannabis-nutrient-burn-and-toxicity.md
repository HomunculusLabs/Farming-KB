...
- **Tip burn**: Yellow or brown crispy tips on leaves, beginning at the oldest/largest leaves and progressing upward
- **Leaf edge burn**: Scorched margins that may curl upward or appear dried and brittle
- **Progression**: Damage moves from leaf tips inward toward the stem, and from lower (older) leaves to upper (newer) growth
