---
title: Cannabis Chromatography for Cannabinoid Purification
created: 2026-04-16
updated: 2026-04-16
type: concept
...
Chromatography operates on the principle that different compounds have different affinities for a stationary phase versus a mobile phase. When a mixture of compounds dissolved in a solvent (the mobile phase) is passed through a column packed with an adsorbent material (the stationary phase), individual compounds travel at different rates through the column based on their relative affinities.

Compounds with greater affinity for the stationary phase move slowly through the column, while those with greater affinity for the mobile phase move quickly. This differential migration causes the compounds to separate into distinct bands or zones as they travel through the column, allowing individual components to be collected separately.
...
Modern preparative HPLC systems bridge the gap, capable of separating cannabinoids in both analytical and preparative modes. These automated systems can isolate individual cannabinoids at purities exceeding 99 percent, though at significant cost in equipment and consumables.
