---
title: Emcdda Psilocybin Psilocin Serotonin 5Ht2A Receptor Pharmacology
...
These chemically related substances tend to exhibit similar pharmacological effects, mediated through overlapping receptor systems.

## Molecular Structures

### Psilocybin
- Chemical name: **4-phosphoryloxy-N,N-dimethyltryptamine (4-PO-DMT)**
- Molecular weight: 284.22 g/mol
- The phosphate ester of psilocin
- More stable in air than psilocin
- Water soluble
- Not itself pharmacologically active — serves as a prodrug

### Psilocin
- Chemical name: **4-hydroxy-N,N-dimethyltryptamine (4-HO-DMT)**
- Molecular weight: 204.27 g/mol
- The dephosphorylated, pharmacologically active metabolite of psilocybin
- Less stable than psilocybin, more susceptible to oxidation
...
Beyond psilocybin and psilocin, two additional tryptamine alkaloids may be present in hallucinogenic mushrooms:

- **Baeocystin** (4-phosphoryloxy-N-methyltryptamine): Thought to be less active than psilocybin and psilocin, though its precise pharmacological contribution is not well characterized.
- **Norbaeocystin** (4-phosphoryloxytryptamine): Also considered less active, with limited pharmacological data.

These compounds share the same basic tryptamine structure but have fewer methyl groups on the terminal amine nitrogen. Their presence and relative concentrations vary by species, growing conditions, and specimen age.

## Onset, Duration, and Route of Administration

Based on the EMCDDA (2006) data:

- **Route of administration**: Mushrooms are typically chopped and eaten directly, or brewed into a tea. The tea method may slightly accelerate onset due to partial pre-extraction but primarily serves to reduce nausea.
- **Onset**: Effects typically begin within 20-60 minutes of ingestion, depending on stomach contents and individual metabolism.
- **Duration**: The primary effects last approximately 4-6 hours, with residual perceptual changes possible for several additional hours.
- **Peak effects**: Usually occur 1.5-3 hours after ingestion.

## Comparison with Other Serotonergic Hallucinogens

| Property | Psilocybin/Psilocin | LSD | DMT | Mescaline |
|----------|---------------------|-----|-----|-----------|
| Chemical class | Tryptamine | Ergoline | Tryptamine | Phenylethylamine |
| Primary receptor | 5-HT2A | 5-HT2A | 5-HT2A | 5-HT2A |
| Duration | 4-6 hours | 8-12 hours | 15-60 min | 8-12 hours |
| Natural source | Mushrooms | Synthetic | Plants/frogs | Cactus |
| Oral activity | Yes (prodrug) | Yes | No (inactive orally) | Yes |
| Potency (typical dose) | 10-20 mg | 50-200 µg | 30-60 mg | 200-500 mg |

The structural similarity to serotonin, shared across all tryptamine hallucinogens, is the key pharmacological feature that enables interaction with the 5-HT2A receptor and the resulting alterations in consciousness, perception, and mood.
## Key Considerations
...
- Jacob, P. III & Fehr, K.O. (1987). Pharmacology of hallucinogens. In: Psychotropic Drugs of Abuse. Pergamon Press.
- Gossop, M. (1993). Living with Drugs. Ashgate Publishing.
- Pechnick, R.N. & Ungerleider, J.T. (2005). Hallucinogens. In: Psychiatric Clinics [[huckleberries-and-wild-berries-of-north-america]].
...
Psilocybin produces rapid tolerance with repeated use — a single dose can reduce sensitivity to subsequent doses by approximately 50% within 24 hours. This tolerance is cross-reactive with other serotonergic hallucinogens (LSD, DMT, mescaline) but not with non-serotonergic drugs. Tolerance typically dissipates within 3-7 days of abstinence. The EMCDDA noted that this natural tolerance mechanism, combined with the intensity of the experience, contributed to the experimental rather than habitual use pattern observed in European populations.
