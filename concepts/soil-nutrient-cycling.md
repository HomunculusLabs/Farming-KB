...
In a healthy soil food web, nutrients follow a biological pathway rather than a chemical one:
...
- Potassium (K+)
- Ammonium (NH4+)
- Hydrogen (H+) -- determines pH

### How It Works
1. Negative charges on clay and organic matter particles attract and hold positively charged nutrients.
2. These nutrients are not fixed -- they can be exchanged with other cations in the soil solution.
3. Plant roots release hydrogen ions (H+) in exchange for nutrient cations.
4. This is the primary mechanism by which plants obtain calcium, magnesium, and potassium.

### Improving CEC
- Add organic matter (compost, manure, biochar).
- Build soil biology (fungal hyphae and bacterial biofilms increase effective CEC).
- Maintain proper pH (affects the charge on clay and organic particles).

## pH and Nutrient Availability

Soil pH affects nutrient availability because it determines the chemical form of nutrients and the charge on soil particles.
