...
Small holes are melted into the sides of the plastic bins to provide passive
air exchange. These holes allow stale air containing elevated CO2 to escape
and fresh air to enter, driven by slight pressure differences between the
chamber interior and exterior. The holes can be covered with mesh or filter
material to prevent the entry of flying insects such as fungus gnats and
fruit flies, which can introduce contamination and lay eggs in the substrate.

## Humidity Dynamics

The passive humidity system operates on simple evaporative principles. Water
evaporating from the casing soil surface increases the absolute humidity
within the bin. The polyethylene covering traps most of this moisture, while
the small air exchange holes allow some moisture to escape, preventing
condensation from becoming excessive. The system reaches an equilibrium
where the rate of evaporation from the casing approximately equals the rate
of moisture loss through the covering and holes.
