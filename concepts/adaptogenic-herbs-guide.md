...
### Dosing
- **Standardized extract (3% rosavins, 1% salidroside):** 200-400mg, once or twice daily.
- Take in the morning — can be stimulating and may disrupt sleep if taken late.
- Effects often felt within days to 2 weeks.
...
### Mechanisms
- Lowers cortisol and corticosterone levels.
- GABAergic modulation (calming, anxiolytic).
- Anti-inflammatory via COX-2 and LOX inhibition.
- Antioxidant: increases endogenous antioxidant enzymes (SOD, catalase, glutathione).
- Blood sugar regulation: enhances insulin secretion, improves glucose uptake.
- Hepatoprotective: protects liver from toxin damage.
- Immunomodulatory: enhances immune function while reducing allergic inflammation.

### Dosing
- **Leaf extract (standardized):** 300-600mg, twice daily.
- **Fresh leaves:** 5-10 leaves, 2-3 times daily (traditional method).
- **Tulsi tea:** 1-2 cups daily (steeped 5-10 minutes).
- **Tincture:** 2-4ml, 2-3 times daily.

### Contraindications
- Pregnancy (uterine stimulant effects). May slow blood clotting. Caution with hypoglycemic medications. May enhance effects of barbiturates and sedatives.
