---
title: Fish Amino Acid (FAA) Fertilizer
created: 2026-04-24
tags: [agriculture, natural-farming, KNF, FAA, fish-amino-acid, nitrogen-fertilizer]
type: concept
...
- Fish trash (head, bones, intestines, etc.) -- blue-black colored fish preferred
- Jaggery/brown sugar (equal weight to fish)
- IMO-3 (small amount for fat dissolution)
- Mosquito net or porous cloth
- Rubber band or thread
- Clay pot, PE container, or glass jar

## Preparation

1. **Cut fish** into pieces and put in clay pot or plastic jar
2. **Add jaggery** in equal amount (1:1 weight ratio). Fill jar to 2/3 of volume
3. **Cover** opening with mosquito net or porous cloth
4. **Ferment** for 7-10 days at 23-25C
5. **Check for fat**: If fat appears on the surface, add 2-3 teaspoons of IMO-3 to dissolve it
6. **Extract** the liquid for use

## Using Molasses Alternative
...
- **Standard dilution**: 1:1000 in water
- **With IMO/compost**: 1:1000
- **For pest control**: 1:500 or as needed

## The Science Behind FAA
