...
-   Symptoms: dead pinheads, loose mushroom connections, brown/black
    ...
    stem cut.
-   **Vector for mites and diseases** — carries *Verticillium* and
    *Trichoderma* spores. A single fly can carry up to 20 mites.

## Phorid Fly (Dung Fly)

**Order:** Diptera | **Family:** Phoridae
**Species:** *Megaselia nigra*, *M. halferata*

### Physical Characteristics
-   Humped back, rapid jerky run, rounded third antennal segment.
-   2-5 mm long; females live 16 days, males 10 days.
-   Larvae: 6-10 mm, white, semi-transparent, with "mouth hooks"
    (seven teeth). Three instars.
