---
title: Tropical Rainforest Restoration Using Arbuscular Mycorrhizal Fungi
created: 2026-04-17
updated: 2026-04-17
type: concept
tags: [mycology, fungi]
...
Fragmentation also increases light, heat, and wind exposure, causing tree damage and mortality.

Crucially, deforestation alters soil microbiota, including mycorrhiza-forming fungi and nitrogen-fixing bacteria, with species in the AMF suborder Gigasporineae being less affected by soil disturbance than Glomineae.
...
Greenhouse experiments should precede field applications to characterize species-specific responses.

## Native Versus Introduced AMF

The use of native AMF inocula is generally preferred in restoration to maintain regional fungal diversity and ensure adaptation to local conditions. Native AMF are adapted to local soil types, climate, and host plant communities. However, commercial AMF inocula may be useful when native AMF communities have been severely depleted or when rapid establishment of plant cover is the primary objective. The choice between native and introduced AMF should be based on restoration goals, the degree of site degradation, and the availability of native inoculum sources.

Native AMF are adapted to local soil types, climate, and host plant communities.
...
Restoration success should be evaluated using multiple criteria including plant survival and growth, AMF colonization levels, spore diversity and density in soil, soil aggregation and stability, and progress toward target community composition. Long-term monitoring is essential because the benefits of AMF inoculation may take years to fully manifest, and the trajectory of community assembly is influenced by ongoing interactions between AMF, plants, and the soil environment.

Long-term monitoring is essential because the benefits of AMF inoculation may take years to fully manifest, and the trajectory of community assembly is influenced by ongoing interactions between AMF, plants, and the soil environment.
