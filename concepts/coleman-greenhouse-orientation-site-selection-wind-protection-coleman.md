...
This biological imperative drives the entire scheduling system for winter crops. Plants must reach a minimum harvestable size before day length drops below ten hours. Once the short-day period begins, growth essentially pauses—crops survive but do not put on new growth. They enter a state of dormancy, maintained in harvestable condition by the double-layer protection system, and resume active growth when days lengthen past ten hours again in early February.

Coleman provides the ten-hour-day dates for various latitudes as a practical guide for growers in different regions:

- **44th parallel (Maine):** November 5 to February 5
- **41st parallel (New York):** approximately November 12 to January 28
...
- **32nd parallel (Savannah, GA to El Paso, TX):** shortest day never drops below ten hours

British greenhouse researcher W. J. C. Lawrence confirmed this threshold from his greenhouses at Merton near London on the 51st parallel, reporting that plant growth slowed during the period from October 27 to February 16 when days were shorter than ten hours.

---

## Wind Protection and Microclimate Sheltering
...
## Practical Site Selection Summary

Based on Coleman's principles and experience, the ideal site for a winter-harvest greenhouse combines several factors working in synergy. Orient the structure on an east-west axis to maximize low-angle winter sun exposure. Position it on well-drained ground, ideally on a gentle south-facing slope. Provide wind protection from the north and west through natural or constructed barriers. Ensure proximity to water access for irrigation of seedlings and for moistening soil surfaces to raise humidity under the row covers. Consider the ten-hour-day calendar for your specific latitude when planning crop scheduling. And above all, keep the system simple—soil-based thermal storage and passive double-layer protection are sufficient for successful winter production across a remarkably wide range of North American latitudes.
