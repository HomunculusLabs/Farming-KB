...
effectiveness of microbial bioremediation in field applications.
...
microbial activity. In many contaminated environments, carbon is
...
The indigenous consortia are already adapted to local conditions,
giving them a competitive advantage over introduced organisms.

## Bioaugmentation

### Principles and Applications

Bioaugmentation is the controlled addition of specific microorganisms
to an environment. The introduced species augment but do not replace
the resident population. In some cases, bioaugmentation populations are
supplemented with nutrients; in others, no biostimulation adjuvant is
used. The approach is attractive because it allows the introduction of
organisms with known degradative capabilities.

### Challenges and Limitations

Organisms that are efficient in laboratory conditions often do not fare
as well under field conditions. Laboratory strains face impoverished
...
much that they overgrow the introduced species. This nutrient
competition effect is one of the primary reasons for bioaugmentation
failure.

### Fungal Bioaugmentation Specifics
...
Wood rot species have been formulated on inexpensive substrates such as
corn cobs, sawdust, wood chips, peat, or wheat straw. These mycelia-
...
Encapsulation of inocula into dry nutritive matrices improves
bioaugmentation effectiveness. Calcium alginate has emerged as one of
the best polymers for fungal encapsulation. The gel allows substrate
diffusion, protects the inoculum during storage and after field
application, and can be supplemented with nutrients. Both the Forest
Products Laboratory and Tulane University groups found alginate
encapsulation gave good results for fungal bioremediation delivery.

Mycelium-coated pellets of Irpex lacteus, Bjerkandera adusta, and
T. versicolor removed over 80% of pentachlorophenol from soil in four
weeks. However, pellets without proliferated mycelium failed to survive
due to competition from indigenous fungi such as Trichoderma and
Fusarium species.

## Combined Approaches

The most promising direction may be the use of mixed bacteria-fungal
consortia rather than single-species inocula. Natural ecosystems show
that fungal bioremediation is a collaborative effort with bacteria.
Among natural isolates of P. chrysosporium, bacterial species including
Agrobacterium radiobacter and Burkholderia sp. were always present,
suggesting synergistic relationships.

## Recommendations

Biostimulation alone is often more effective and cost-efficient than
bioaugmentation. When bioaugmentation is necessary, success depends on:
using locally adapted strains; providing protective formulations such
as alginate encapsulation; ensuring adequate carbon sources for
inoculum establishment; and considering mixed consortia rather than
pure cultures. Regular reintroduction may be needed to maintain
population densities and continuous treatment efficacy.
