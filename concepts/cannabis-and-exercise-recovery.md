---
title: Cannabis and Exercise Recovery
created: 2026-04-12
updated: 2026-04-12
type: concept
tags: [cannabis, health, medicine, psychopharmacology, therapy, beginner]
sources: []
---
...
- **0-2 hours post-exercise:** Acute inflammation, muscle fatigue, elevated cortisol
- **2-24 hours:** Peak muscle soreness (DOMS — Delayed Onset Muscle Soreness)
- **24-72 hours:** Inflammation resolves, muscle repair and adaptation
- **72+ hours:** Full recovery for most moderate exercise; intense training may require longer

## How Cannabis Affects Recovery

### Anti-Inflammatory Effects

Cannabinoids have demonstrated significant anti-inflammatory properties:

- **CBD (Cannabidiol):** Binds to multiple receptor systems involved in inflammation:
  - Inhibits COX and LOX enzymes (similar mechanism to NSAIDs like ibuprofen)
  - Reduces pro-inflammatory cytokine production (TNF-alpha, IL-6, IL-1b)
  - Activates PPAR-gamma receptors (regulates inflammation and immune response)
  - Modulates TRPV1 receptors (pain and inflammation signaling)
...
- **Caryophyllene:** A terpene that acts as a CB2 receptor agonist, providing direct anti-inflammatory effects independent of cannabinoids.
...
- Opioid-sparing potential (may reduce need for opioid pain medications)
...
Quality sleep is critical for recovery, and cannabis can influence it:
...
- Cannabis reduces perceived stress and anxiety
- CBD has demonstrated anxiolytic effects in multiple studies
- Reduced stress may lower cortisol levels and improve recovery
- Mental recovery (reduced training anxiety, improved mood) supports consistent training
...
### When to Use Cannabis for Recovery

**Post-workout (0-2 hours after):**
- Topical application to sore muscles (immediate, localized relief)
- CBD tincture or edible for systemic anti-inflammatory effects
- Avoid inhalation immediately after intense cardio (may irritate lungs)

**Evening recovery (2-6 hours after):**
- Edible or tincture for sustained anti-inflammatory and pain relief
- Topical application before bed
- Vaporized cannabis for faster onset if needed

**Before sleep:**
- Indica-dominant strain or high-CBD product for sleep promotion
- Topical application to any remaining sore areas
- Allow 1-2 hours between cannabis use and sleep for optimal effects

### Consumption Methods

- **Tinctures (sublingual):** Fast onset (15-45 min), precise dosing, shorter duration (4-6 hours)
- **Edibles:** Slower onset (1-2 hours) but longer duration (6-8 hours). Dosing requires more caution.
- **Vaporizing:** Fastest onset (1-5 min), shorter duration (2-4 hours). Not ideal after cardio.
- **Capsules:** Precise dosing, predictable timing. Good for consistent daily protocols.

## Dosage Guidelines

### CBD Dosage
- Low: 10-25mg (mild inflammation, general recovery support)
- Medium: 25-50mg (moderate soreness, significant inflammation)
- High: 50-100mg+ (severe pain, intense DOMS)

### THC Dosage (experienced users)
