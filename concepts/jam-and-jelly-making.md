...
High-pectin fruits (set easily, may not need added pectin):
- Apples (especially underripe)
- Crabapples
- Cranberries
- Currants
- Gooseberries
...
- Quince
- Citrus (pectin concentrated in peel and seeds)
Low-pectin fruits (need added pectin or combining with high-pectin fruit):
- Strawberries
- Blueberries
- Peaches
- Pears
...
- Figs
### Adding Pectin
- Commercial liquid pectin: add at the end of cooking; one 3-ounce pouch sets 4-6 cups of fruit
- Commercial powdered pectin: add at the beginning of cooking; follow package instructions
- Low-sugar or no-sugar pectin: sets with less sugar; essential for reduced-sugar recipes
- Pomona's Universal Pectin: calcium-activated pectin; works with any amount of sugar, honey, or alternative sweeteners
- Homemade apple pectin: boil underripe apples, strain the liquid, and reduce — traditional method
### The Pectin-Acid-Sugar Triangle
Successful jelling requires three elements in balance:
1. **Pectin** — the gelling agent
2. **Acid** — helps pectin form a gel; add lemon juice (1 tablespoon per cup of fruit) if the fruit is low in acid
3. **Sugar** — helps pectin set, preserves color and texture, and acts as a preservative
If any element is out of balance, the jam will not set properly.
## Fruit Selection
...
- A mix of ripe and slightly underripe fruit is ideal
## The Jam Making Process
### Basic Equipment
- Large, heavy-bottomed pot (stainless steel or enameled; avoid aluminum which reacts with acid)
- Wooden spoon or heatproof spatula
- Canning jars (half-pint or pint with [[two-ag]]-piece lids)
- Jar lifter, funnel, and headspace tool
...
8. **Cool and check seals:** let jars cool 12-24 hours, check that lids are sealed.
...
### Sheet Test
1. Dip a cool metal spoon into the boiling jam
2. Lift the spoon and let the jam drip back into the pot
3. When the jam sheets off the spoon in two drops that merge into one sheet, it is set
### Temperature Test
- Jam sets at approximately 220F (104C) at sea level
- Use a candy or instant-read thermometer
- Subtract 2 degrees for every 1,000 feet of elevation above sea level
## Water Bath Canning
### Process
1. Sterilize jars: submerge in boiling water for 10 minutes, or run through a dishwasher cycle
2. Fill jars with hot jam, leaving 1/4 inch headspace
3. Wipe jar rims clean with a damp cloth
4. Place lids (pre-warmed in hot water) and rings — fingertip tight
5. Place jars in a water bath canner or large pot with a rack
6. Ensure jars are covered by at least 1 inch of water
7. Bring to a boil and process:
   - Half-pint jars: 5 minutes
   - Pint jars: 10 minutes
   - Add 1 minute per 1,000 feet above sea level
8. Remove jars with a jar lifter, place on a towel, and cool undisturbed for 12-24 hours
9. Check seals — the lid center should be concave and not flex
10. Label with contents and date
### Storage
