...
**Key actions**: Maintain warm (70–85°F), moist, dark conditions. Use the paper towel method or direct planting. See [[cannabis-germination-techniques]].

## Stage 2: Seedling

Duration: 2–3 weeks

The plant develops its first sets of true leaves — the pointed, serrated leaves characteristic of cannabis. The root system begins establishing.

**Requirements**:
- Low light intensity (fluorescent or LED at reduced power)
- High humidity (60–80%)
- Gentle conditions — no training, no nutrients
- Keep growing medium moist but not waterlogged
...
- Feed vegetative-strength nutrients (higher nitrogen)
- Train plants for desired structure
- Transplant as needed to larger containers
- Maintain 18/6 or 24/0 light cycle
...
See [[cannabis-vegetative-stage]].

## Stage 4: Pre-Flowering and Sexing

Duration: 1–2 weeks after switching to 12/12

When the light cycle is changed to 12 hours light / 12 hours dark, the plant begins transitioning to flowering. During this transition, sex organs become visible.

**Identifying females**: Look for white, hair-like pistils emerging from the nodes. These are the beginnings of buds.

**Identifying males**: Look for small, round pollen sacs (no white hairs). Males must be removed for sinsemilla production.

**Key actions**:
- Inspect plants daily for sex indicators
- Remove males immediately once identified
...
See [[cannabis-flowering-stage]].

## Stage 6: Harvest

Duration: 1 day (cutting) + 7–14 days (drying) + 2–4+ weeks (curing)

Cut plants, trim buds, dry slowly, and cure for quality.

See [[cannabis-harvesting-techniques]] and [[cannabis-drying-and-curing-guide]].

## Photoperiod Control

The cannabis photoperiod controls the transition between vegetative and flowering:

- **18+ hours light**: Vegetative growth (day-neutral cannabis stays in veg)
- **12 hours light / 12 hours dark**: Triggers flowering
- **Dark period is critical**: Even brief light leaks during the dark period can stress plants, cause hermaphroditism, or revert plants to vegetative growth

**Autoflowers are the exception**: Autoflowering strains begin flowering based on age rather than photoperiod. See [[cannabis-autoflower-guide]].
...
See [[cannabis-cloning-and-mother-plants]].

## Related

- [[cannabis-perpetual-grow-cycle]] Topics

- [[cannabis-germination-techniques]] — Stage 1
- [[cannabis-seedling-care-guide]] — Stage 2
- [[cannabis-vegetative-stage]] — Stage 3
- [[cannabis-pre-flowering-and-sexing]] — Stage 4
- [[cannabis-flowering-stage]] — Stage 5
- [[cannabis-harvesting-techniques]] — Stage 6
- [[cannabis-cloning-and-mother-plants]] — alternative to seeds
