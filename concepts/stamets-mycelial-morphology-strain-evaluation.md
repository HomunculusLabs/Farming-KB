...
Tomentose mycelium appears as fluffy, cotton-like growth that spreads more
slowly across the agar surface. Commercial Agaricus cultivators have long noted
that the slower growing cottony mycelium is inferior to the faster growing
rhizomorphic type. Cottony mycelia on agar often correlate with the later
occurrence of "stroma," a dense mat-like growth of mycelia on the casing which
rarely produces mushrooms.

### Linear (Intermediate) Mycelium
An intermediate type of mycelium occurs which grows linearly (longitudinally
radial) but does not have the twisted strands of interwoven hyphae that
characterize the rhizomorphic kind. Linear mycelium can produce abundant
...
generatively oriented rhizomorphs but rarely on somatically disposed cottony
mycelia. When a single wedge of mycelium is transferred to a petri dish and
two distinct mycelial types grow from it, the stringy sector typically forms
abundant primordia while the cottony sector does not.
