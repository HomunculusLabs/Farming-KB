...
The study used a single strain of *Psilocybe cubensis* originally collected from Pucallpa, Peru, as described by Repke et al. (1977). Using a single genetic lineage was critical: it eliminated strain-to-strain variability as a confounding factor, isolating the effects of flush number, [[psilocybin]] levels ranged from **3.2 to 13.3 mg/g dry weight** across all flushes. No consistent increasing or decreasing trend was observed across flushes. Psilocybin concentrations were highly variable, with individual flush measurements fluctuating considerably. This variability suggests that psilocybin biosynthesis is not simply a cumulative or depleting process but is influenced by factors such as substrate nutrient status, microclimate conditions, and fungal physiology at the time of each fruiting event.
...
- [[psilocybin-cap-stem-distribution-bigwood-beug]] for the cap [[savory-holistic-resource-management-animal-impact]] encompasses not only material inputs but also
