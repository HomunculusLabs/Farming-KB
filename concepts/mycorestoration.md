...
Practical mycorestoration requires matching fungal species
to specific site conditions and contamination profiles:
- **Site assessment** precedes all mycorestoration work and
...
- **Monitoring protocols** track remediation progress through
  periodic soil and water sampling, measuring contaminant
  concentrations and fungal biomass over time to document
  the rate and extent of biological cleanup achieved.

## Mycofiltration in Practice

Mycofiltration installations use living mycelial mats as
biological filters for water purification:
- **Construction** involves layering inoculated substrate
  in containment berms, swales, or constructed filtration
  beds positioned to intercept contaminated runoff before
  it reaches waterways, wetlands, or groundwater recharge
  zones.
...
Documented applications demonstrate real-world effectiveness:
- **Oil spill remediation** — Stamets' Washington State
  experiment showed oyster mushroom mycelium colonizing
  petroleum-contaminated soil, breaking down hydrocarbons
  and supporting ecological recovery. Within weeks, the
  inoculated plots showed visible fungal fruiting and
  subsequent insect and plant colonization.
- **Heavy metal binding** — mycorrhizal fungi immobilize
  heavy metals through extracellular sequestration and
  intracellular compartmentalization, reducing metal
  bioavailability and preventing uptake into food crops
