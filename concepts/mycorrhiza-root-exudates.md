...
- Crude extracts of *G. intraradices* mycelium reduced germination of
  *F. oxysporum* conidia.
- Exudates from strawberry roots colonized by *G. etunicatum* or
  *G. monosporum* inhibited sporangia production of *Phytophthora
  fragariae*.
- Microconidia germination of *F. oxysporum* f. sp. *lycopersici*
  more than doubled with root exudates from *G. mosseae*-colonized
  tomatoes, correlating with colonization level.

These variable effects highlight the complexity of exudate-mediated
interactions.
