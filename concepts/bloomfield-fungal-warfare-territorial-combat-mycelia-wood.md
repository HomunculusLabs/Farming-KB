...
fan of branching filaments, and the fungus works its way deeper into
the trunk.

## The Economics of War

Year after year, secreted enzymes convert wood into sugar molecules
absorbed by the fungus and burned in its mitochondria. But the young
mycelium is not dining alone. Other holes were dug through the bark,
the woodland air is filled with spores, and numerous fungi feed on
every tree. When these mycelia meet, they fight or fuse. Conflict
draws the dark lines that define the borders.
...
Not all encounters result in war. When compatible strains of the same
species meet, their hyphae can fuse, sharing cytoplasm and resources.
This fusion creates larger, more vigorous mycelia capable of more
effective wood decomposition. The genetic compatibility systems that
determine whether fusion or warfare ensues are complex — basidiomycete
fungi can have hundreds or even thousands of different mating types,
governed by multiple genes with multiple alleles.

The percentage of failed fungal marriages is probably very high. But
the evolution of so many sexes makes sense because lots of combinations
can work together, and this outcrossing favors the perpetuation of
tremendous genetic variation within a single species. This variation
translates into physiological flexibility when considering a population
of mycelia competing for the same woody substrate.
...
from view within the wood or beneath the soil. The bracket fungi that
sprout from the surface represent only the reproductive structures of
the organisms whose feeding mycelia are engaged in unseen combat within.
The zone lines, visible only when the wood is split or cut open,
provide a rare window into the dynamics of this hidden world.
...
competition can make more informed decisions about which trees to
remove, when to harvest, and how to manage dead wood for biodiversity.

## The Broader Significance

The territorial combat between fungal mycelia exemplifies a
fundamental principle of ecology: that competition shapes community
structure at every scale, from the African savanna to the microscopic
world within a decaying log. What Money calls the "Balkan map" within
a beech trunk is an ecological landscape as complex and politically
charged as any human conflict, played out over decades in slow motion
by organisms that communicate through chemistry rather than language.
