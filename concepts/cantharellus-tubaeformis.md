---
title: Cantharellus Tubaeformis
created: 2026-04-17
updated: 2026-04-17
type: concept
tags: [reference]
...
The cap of C. tubaeformis is 1-5 cm in diameter, convex when young and developing a central depression (funnel shape) with age. The cap color is brown to dark brown, sometimes with an olive tint, and the surface is smooth to slightly wrinkled.

The gills (technically false gills, as in all Cantharellus species) are well-developed, forked, and extend down the stem (decurrent). They are pale gray to yellowish, contrasting with the darker cap. This color contrast between the dark cap and lighter gills is one of the most useful field identification features.
...
Cantharellus tubaeformis is an ectomycorrhizal fungus that associates primarily with coniferous trees, particularly spruces (Picea species) and pines (Pinus species). It also occurs with birch (Betula) and other hardwoods in mixed forests.

It has a strong preference for mossy habitats, particularly beds of Hylocomium splendens (stair-step moss) and Pleurozium schreberi (red-stemmed feathermoss) that are common in boreal and montane coniferous forests. The moss layer appears to create favorable microclimatic conditions for fruiting, maintaining high humidity and stable temperatures near the soil surface.
