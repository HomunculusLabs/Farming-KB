...
Solomon recounts the experience of his wife Muriel, who grew up in a
low-income family on a self-sufficient, half-acre homestead in Tasmania.
The family's meager water supply came from small tanks that captured
rainwater off their roof. This was not unusual for the era; before
...
A rainwater harvesting system for garden use does not need to be complex.
The basic components are:

-  **Collection surface:** A roof provides the most efficient collection
    surface. Even a small garden shed can yield significant water over a
    rainy season. The larger the roof area, the more water captured.

-  **Conveyance:** Gutters and downspouts direct water from the roof to
    storage. Leaf screens prevent debris from entering the system.

-  **Storage:** Tanks, barrels, or cisterns hold the water until needed.
    Solomon's wife's family used small tanks. Modern gardeners can use
    anything from recycled food-grade barrels to larger poly tanks.

-  **Distribution:** A hose or watering can moves water from storage to
    the garden. Gravity-fed systems work well if the tank can be elevated.

## Water Quality Considerations

Rainwater is naturally soft and free of the chlorine, fluoride, and
minerals found in municipal water supplies. This makes it excellent for
garden use. However, water collected from roofs may contain dust, bird
droppings, or other contaminants. A first-flush diverter that discards
the first few gallons of each rainfall event helps keep the stored water
clean.

For vegetable gardens, the main concern is bacterial contamination from
bird droppings on the roof. Water used for watering the soil (rather
than for overhead irrigation of edible leaves) poses minimal risk.

## Sizing Your System

The amount of water you can capture depends on your roof area and local
rainfall. As a rough guide, one inch of rain on 1,000 square feet of
...
For drought-prone gardens, the goal is to store as much winter and
spring rainfall as possible to supplement summer irrigation needs.
Larger tanks provide more buffer against dry spells but cost more.

## Integration with Garden Irrigation
...
## Microirrigation and Low-Volume Systems

Solomon discusses microirrigation as a modern development: systems using
inexpensive low-pressure plastic tubing, cheap quick-disconnect fittings,
and miniature sprinkler heads with emission rates measured in gallons
per hour rather than per minute. These systems are very useful in
tunnels and cloches to keep plants watered for a few weeks until the
cover is removed. They can be fed from rainwater storage tanks, making
them an efficient use of harvested water.
