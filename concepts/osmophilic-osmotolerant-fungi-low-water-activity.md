...
ecological group within [[fungal-responses-extreme-environments]].

## Water Activity and Fungal Growth

Water activity (aw), which ranges from 0 to 1, is a
physicochemical index of water availability for biological
activity. Life exists over aw values from 0.60 to 1.0. Animal
life is confined almost entirely to 0.99 to 1 aw, and the
permanent wilting point of plants is around 0.98 aw. Most
microorganisms are restricted to substrata with aw values of
0.95 and higher (Pitt and Hocking 1997).

Osmophilic fungi are distinguished from [[xerophilic-xerotolerant-fungi]]
...
## Mechanism of Osmotic Tolerance

High osmotic concentrations outside a cell cause it to lose
water, potentially killing the fungus or preventing spore
germination. The ability to preserve foods with highly
concentrated sugar or salt solutions depends on this principle.
In environments with naturally high salt concentrations (salt
brines, some soils), fungi must cope with both high ionic
strengths and little available water.
...
While fungi and other microbes are common in moderately saline
environments such as salt marshes, saline soils, and seawater,
only a few halophilic fungi can grow in saturated NaCl solution
(6 mol/kg with a 0.75 aw). Naturally hypersaline environments
such as salt flats, saltpans, and brine pools appear to be the
domain of prokaryotes and algae, with few strictly halophilic
fungi present.

## Desert Soil Mycology

An interesting finding is that the number of colonies of
osmophilic fungi isolated per gram of desert soil in Saudi
Arabia was low, but species richness was high (Abdel-Hafez
1982b). One hundred species belonging to 38 genera were
isolated on 40-60% sucrose Czapek's agar, with Aspergillus
the most common genus. This pattern suggests that osmophilic
fungi maintain high diversity even in arid environments where
available water is episodically concentrated by evaporation.

## Relationship to Other Stress Tolerance

Osmophilic fungi overlap with [[halotolerant-halophilic-fungi-salt-tolerant-diversity]]
...
[[xerophilic-xerotolerant-fungi]], which tolerate
matric rather than osmotic water stress. Together, these three
groups illustrate the diverse strategies fungi employ to cope
with water limitation.

Osmophilic fungi also interact with
