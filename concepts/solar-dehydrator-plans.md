...
- **Collector box** — 2x4 foot (or 2x8 foot for higher capacity) plywood or OSB box, 6-8 inches deep
- **Absorber plate** — sheet metal (aluminum or steel), painted matte black with high-temperature paint
- **Glazing** — polycarbonate sheet, tempered glass, or UV-stabilized plastic. Glass performs best but is fragile.
- **Drying chamber** — plywood or OSB box, sized to match the collector width, 12-18 inches deep
- **Trays** — window screen (stainless steel or food-safe plastic, NOT fiberglass) stapled to wooden frames
- **Insulation** — rigid foam board (polyisocyanurate or XPS), 1-2 inches thick, lining the drying chamber walls
- **Vents** — adjustable openings at the bottom of the collector and top of the drying chamber. Hinged covers allow temperature control.
- **Sealant** — food-safe silicone caulk for all joints
- **Hardware** — screws, hinges, latches, weatherstripping

### Construction Steps

1. **Build the collector box** — cut plywood to size. The box should slope from back to front at approximately 30 degrees (your latitude angle is ideal). Line the bottom with rigid foam insulation.
...
- **Small (2x2 ft collector)** — processes 4-6 trays, suitable for herbs, small batches of fruit. Good for a single household.
...
- Sliced fruits: 8-16 hours
- Sliced vegetables: 6-14 hours
- Jerky: 6-10 hours

Food is properly dried when it is leathery and pliable (fruits), brittle and crisp (vegetables), or hard and breakable (jerky). No visible moisture when bent or torn.
...
- Clean trays after each use with warm soapy water
- Inspect glazing for cracks annually and replace if damaged
- Re-caulk joints as needed
