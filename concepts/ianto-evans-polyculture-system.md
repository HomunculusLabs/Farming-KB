...
- **Niche partitioning**: The variety of leaf shapes and root depths minimizes competition for sun, space, and nutrients.

## Yields and Benefits

From a single 20-square-foot bed per person, this polyculture provides:
- Continuous harvest for 6-9 months depending on climate
- Salad greens from week 6 through summer
- Edible flowers (calendula) and herbs (dill) from late spring
- Summer beans and early cabbages
- Fall parsnips and late cabbages
- Winter garlic or fava beans in mild climates
- Dense weed suppression without mulching
- Reduced irrigation needs due to living mulch effect

## Nutrient Cycling and Soil Health

The polyculture creates a self-reinforcing nutrient cycle. Fast-growing radishes and buckwheat take up readily available nutrients, preventing leaching. When these plants are harvested and the remaining material decomposes, nutrients become available to slower-growing companions. Bush beans fix atmospheric nitrogen through their root-associated Rhizobium bacteria, directly benefiting neighboring cabbages and subsequent crops. The continuous living root mass feeds soil microorganisms throughout the growing season, maintaining the soil food web that conventional rotation systems interrupt during fallow periods.

## Comparison with Conventional Gardening

| Aspect | Conventional Rows | Ianto Evans Polyculture |
|--------|-------------------|------------------------|
| Species per bed | 1-3 | 7+ |
| Harvest duration | 2-4 weeks per crop | 6-9 months continuous |
| Weed management | Regular cultivation | Self-suppressing living mulch |
