...
## Establishment Requirements for Degraded Sites
...
- **Sooty mold**: Indirectly controlled by managing the honeydew-producing insects and by beneficial organisms that consume the honeydew substrate before sooty mold fungi can colonize.

### Foliar Pest Mechanisms

AACT also provides protection against foliar pests through related mechanisms:

- **Physical barrier**: Beneficial organisms coating leaf surfaces create a film that interferes with pest feeding, egg-laying, and movement.
- **Predation**: Protozoa, nematodes, and microarthropods in the tea can consume pest eggs and early instars on foliage.
- **Plant signaling**: A healthy, microbially-active leaf surface triggers plant systemic defense responses, making the plant less attractive or palatable to pests.
- **Honeydew removal**: Beneficial organisms metabolize honeydew excretions, removing the food source for sooty mold and disrupting the mutualistic relationship between sap-feeding insects and the fungi that protect them.

## Why Biological Suppression Is More Durable

Chemical pesticides face an inherent arms race: pathogens evolve resistance, requiring new or more toxic chemicals, which further damage the biological communities that naturally suppress disease. AACT breaks this cycle entirely. Because suppression works through competition rather than toxicity, pathogens cannot evolve resistance to being outcompeted for food and space. The more diverse the beneficial community, the more resilient the suppression — there is no single mode of action for a pathogen to circumvent.

This durability is why Ingham states that pesticides can be deleted once beneficial organisms are properly established. The biological system doesn't just suppress current disease — it prevents future disease from gaining traction, year after year, without escalating chemical inputs.

## Key Distinctions from Chemical Approaches

| Aspect | AACT Biological Suppression | Chemical Pesticide |
|--------|---------------------------|-------------------|
| Mode of action | Competition and exclusion | Toxic kill |
| Residual effect | Self-sustaining if maintained | Degrades over time |
| Non-target impact | Builds beneficial communities | Often harmful to beneficials |
| Resistance development | Extremely unlikely | Common and accelerating |
| Application timing | Preventative, before disease pressure | Reactive, after symptoms appear |
| Soil health effect | Improves over time | Typically degrades |
| Cost trajectory | Decreases as biology stabilizes | Ongoing input dependency |
