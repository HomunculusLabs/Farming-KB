---
title: Mycofiltration of Chemical Runoff
created: 2026-04-17
updated: 2026-04-17
type: concept
tags: [reference]
...
The following advantages apply to installing mycofiltration mats on logging roads compared to conventional techniques using heavy equipment to build tank traps, ditches, and scarify the surface.

Sediment flow is reduced, preventing silt erosion into streams, spawning grounds, and fisheries. Moisture is enhanced, with the moisture bank improving and remoistening of arid landscapes becoming possible. Native mycoflora is reestablished through habitat enhancement of soil-building mycorrhizal and saprophytic types.

Hydrocarbon contaminants including diesel, oil, herbicides, pesticides, and other pollutants are reduced. Pathogenic microorganisms such as coliform bacteria, Escherichia coli, Pfiesteria, other bacteria, and protozoa are filtered through mycofiltration. Water temperature is cooled as it flows into streams, benefiting fisheries and marine systems.

Collateral disturbance to existing and adjacent ecosystems is low. Subsurface soil hydrophysics improve through subsurface growth of mycelium, which allows for water and mineral transport as well as aeration, minimizing flow of silt. Aesthetically, roads are transformed into nature trails.

## Agricultural Chemical Filtration

Wood chips applied to road surfaces also reduce sedimentation. The use of buffers such as wood chips has been recommended to lessen the impact of nitrates, pesticides, and hydrocarbons in order to control pollution vectors channeling from roads, ditches, and other sources.
...
Farmers can build soils while creating mycofiltration membranes for trapping pollutants by using thick mats of myceliated straw or wood chips. Corn farmers can first profitably grow oyster mushrooms on cornstalks and straw, and then use the spent substrate for mycofiltration. Through selective inoculations, we can steer the course of species succession on stressed woodlands and their disused roads.
...
The method jump-starts the road's recovery cycle by immediately introducing decomposer fungi to the wood substrate. As the fungi break down the organic matter, nutrients are released slowly, building soil depth and supporting the succession of plant communities that will eventually restore the forest ecosystem.
...
However, if wood is reduced to too fine a dust and piled too deeply, it suffocates aerobic fungi including beneficial saprophytes, and anaerobic organisms flourish. Chips should be no smaller than one-eighth inch and piled no more than a foot deep for optimal mycelial colonization.

## Integration With Watershed Management

Mycofiltration of chemical runoff integrates naturally with broader watershed management strategies. Placing mycofiltration buffer zones near streams, farms, suburban areas, and factories creates a network of biological filtration that protects downstream ecosystems.

Installation of mycofiltration membranes can utilize debris from multiple sources: forests (brush, tree trimmings, wood chips), pulp and paper mills (cellulose, fiber, cardboard, or paper waste), city and rural recycling centers (yard waste), farms (straw, corncobs, cotton, coffee wastes), and breweries (washed grains). These materials are inoculated with toxin-specific mushrooms.
