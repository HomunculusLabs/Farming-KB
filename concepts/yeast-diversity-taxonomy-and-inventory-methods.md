...
Yeasts are a polyphyletic group of ascomycetous and basidiomycetous fungi characterized by having a unicellular growth phase and sexual stages that are not enclosed in fruiting bodies. Approximately 100 genera comprising more than 700 described species are known, but current evidence suggests these represent less than 1% of species occurring in nature (Kurtzman and Fell 1998).
...
Molecular methods: nuclear-DNA reassociation and comparison of nucleotide sequences from the 5'-end of large (26S) rRNA/rDNA. A database of 26S 5'-end base sequences identifies most species. Species-specific PCR primers can screen large numbers of isolates more quickly.

## Major Yeast Culture Collections

- Italy: DBVPG, Universita di Perugia
- Japan: IFO; JCM
- Netherlands: CBS, Yeast Division
- Portugal: PYCC
- Germany: DSMZ
- Russia: VKM
- Slovakia: CCY; RIVE
