...
Many sites may already have existing water courses on them. The first instinct when encountering a naturally occurring flowing water course such as a small stream or river should be to leave it alone, unless it has been messed with by mankind previous to your arrival or if it will be affected by your design.

Modern design has long held the notion that water should be drained off a site as fast as possible. Therefore many sites have big drainage ditches that have eroded away into becoming small streams, and sometimes not so small. A straight flowing, fast running water course like this is an ecological disaster waiting to happen. In cases like this you will want to slow the water course down by altering the shape of the bank.

## Creating Meandering Water Courses

Instead of a straight, fast-flowing water course, you want a meandering S-curved water course. You do not have to do a lot to accomplish this; you only have to help it along and nature will do the rest.

To turn a straight flowing water course into a meandering one you need to place something in the stream that deflects the water in alternating patterns next to the banks. In some cases you may be able to simply use a big rock for this. Place big rocks along the bank in alternating patterns so that the water will deflect off one bank towards the other. The natural forces of erosion will take over from there and eventually carve out the other side of the bank.

If you do not have big enough rocks you can create a gabion, which is made by enclosing rocks in a cage, usually of chicken wire, and placing them in alternating patterns along the banks.

### Why Meandering Works

Meandering is the natural pattern that water adopts when unconstrained. A meandering stream slows water velocity, reduces bank erosion, creates varied microhabitats with pools and riffles, increases surface area for aeration, and promotes fertile sediment deposition on inner banks. The physics are straightforward: each curve forces water to slow on the outside of the bend and accelerate on the inside, creating a self-reinforcing pattern.

## Slowing Flow with Dams and Obstructions

Another way to slow the flow of a water course is to place small dams in it. Not enough to actually dam it up, unless you are trying to create a pond, but enough to drastically slow the water. The best two techniques are to either place logs from felled trees in the water, or to put big rocks in the water. These should be shallow enough that the water will flow over them without flooding out of the banks.

### Check Dams for Erosion Control

Check dams are small, semi-permanent structures placed across a water course to reduce flow velocity and capture sediment. Stacked rock check dams are particularly effective — they allow water to percolate through while catching debris and slowing flow. Over time, sediment builds up behind the check dam, naturally terracing the stream bed.

## Managing Overflow from Earthworks

When doing earthworks on your site to slow surface water runoff, all of your earthwork designs should take into account the overflow: what happens to the water that does not infiltrate, where does it go?

It is a good idea to use your earthworks to aim the overflow towards a pre-existing water course if you have one. If you do, the water you are adding will increase the flow rate of the water course and may turn it into an erosion-making machine. In that case you may want to add some of the above techniques to compensate for the addition to the flow.
...
- Placing alternating rocks or gabions in eroded drainage ditches to encourage meandering
- Using logs and rocks as small dams to reduce water velocity without completely blocking the channel
