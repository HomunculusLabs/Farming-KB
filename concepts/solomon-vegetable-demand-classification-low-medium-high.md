...
### Examples of Low-Demand Vegetables
- **Root crops**: Carrots, parsnips, radishes, turnips
- **Legumes**: Beans (bush and pole), peas
- **Leafy greens with modest needs**: Some lettuces, mustard greens
- **Alliums**: Garlic (to some extent), onions (depending on variety)

### Fertility Requirements
- Minimum ¼ inch (6 mm) layer of sacked steer manure or finished compost per 1,000 sq ft
- 50 lbs (25 kg) lime(s) per 1,000 sq ft (25 kg per 100 sq m)
- Alternatively: 1 inch layer of steer manure or ½ inch finished compost **plus** COF

These crops will grow to their maximum potential with even this minimal input.
...
Side-dressing is the practice of applying additional fertilizer alongside growing plants. Solomon recommends:

- **For transplanted seedlings**: Apply a small handful of COF around each plant at transplant time, mixed into the soil
- **For direct-seeded crops**: Wait until seedlings are established, then side-dress
- **Frequency**: Every 3–4 weeks during active growth
- **Method**: Sprinkle fertilizer in a band alongside the row, just beyond the leaf drip line, then lightly cultivate it into the soil surface
