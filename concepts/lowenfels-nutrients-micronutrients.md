...
Iron (Fe) atoms serve as carriers of electrons, and electrons can be easily passed around
...
Boron is the only mineral nutrient that does not have to be an ion to move into plant cells. Once
incorporated, boron is not mobile in plants because it readily bonds to sugar molecules. The
mobility of boron is dependent on carrier molecules to which it binds.
