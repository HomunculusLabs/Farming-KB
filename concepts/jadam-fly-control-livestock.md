---
title: Fly Control for Livestock Housing (JADAM Method)
created: 2026-04-20
updated: 2026-04-18
type: concept
...
Fly populations in livestock housing follow predictable seasonal patterns that inform optimal JADAM spray timing. In temperate climates, fly populations begin building in early spring as temperatures consistently exceed 15°C. The first JADAM application should coincide with this period, targeting overwintering sites and initial breeding areas. During peak summer months, when fly generation time can be as short as 7-10 days, applications every 1-2 days may be necessary for serious infestations. As temperatures decline in autumn, application frequency can be reduced as fly reproductive rates slow.

The time of day for application matters. Flies are least active in early morning and late evening, when they congregate on walls, ceilings, and overhead structures. Spraying during these periods ensures maximum contact with resting flies. Spraying during midday heat is less effective because flies are more active and spend less time on treated surfaces. In livestock housing with artificial lighting, spraying should be timed for periods when lights are off or dimmed, which encourages flies to settle on surfaces.
...
Effective JADAM fly control requires monitoring fly populations to determine when intervention is necessary and whether current methods are working. Simple monitoring techniques include counting flies on designated bait stations or sticky traps, tracking the proportion of animals showing fly-stress behaviors (tail flicking, ear twitching, bunching, reduced feed intake), and recording manure moisture levels and decomposition rates. These observations inform both the timing and intensity of spray applications.

As the JADAM system matures over successive seasons, fly pressure typically decreases as the microbial environment in livestock housing shifts toward communities that do not support fly breeding. Farmers who have maintained JADAM practices for multiple years report progressively lower fly populations and reduced need for intervention. This progressive improvement contrasts sharply with chemical fly control, where resistance development leads to progressively worse fly problems requiring increasingly intensive chemical intervention.
