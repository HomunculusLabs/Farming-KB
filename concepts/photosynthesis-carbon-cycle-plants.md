...
Carbon dioxide and water are converted into glucose and oxygen using light energy captured by chlorophyll and other pigments.
...
- Increasing CO2 generally increases photosynthetic rate
- Current atmospheric CO2 (~420 ppm) is below saturation for C3 plants
- C4 plants have a CO2-concentrating mechanism (more efficient at low CO2)
