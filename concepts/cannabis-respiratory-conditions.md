---
title: Cannabis Respiratory Conditions
created: 2026-04-13
updated: 2026-04-15
type: concept
...
### Understanding COPD
COPD encompasses chronic bronchitis and emphysema, conditions characterized by progressive airflow limitation. The CHI notes that COPD is one of the lung disorders that may be addressed by cannabinoid therapy. The CHI also references observed increases in walking distance in COPD patients using cannabinoid-based therapies.

### Potential Benefits
- Anti-inflammatory properties may help reduce chronic airway inflammation characteristic of COPD
- Bronchodilatory effects may ease breathing
- CBD's anti-inflammatory and antioxidant properties may help protect remaining lung tissue
- Cannabis may help manage COPD-related symptoms including pain, anxiety, and sleep disturbance

### Risks and Precautions
- Smoking cannabis is strongly discouraged for COPD patients
- Non-smoking methods (vaporizers, tinctures, edibles) should be used exclusively
- THC may increase heart rate, which can be concerning for patients with severe COPD and associated cardiovascular strain

## Cough and Bronchitis

- Cannabis smoke can irritate the airways and increase mucus production in some users
- Paradoxically, cannabis has also been used as an antitussive (cough suppressant), particularly for cough-induced insomnia
- The net effect depends on the individual, the strain used, and the method of administration
- Chronic bronchitis associated with heavy cannabis smoking is a recognized concern

## Cannabis as an Anti-Inflammatory for Respiratory Conditions

The anti-inflammatory properties of cannabinoids are relevant across respiratory conditions:
