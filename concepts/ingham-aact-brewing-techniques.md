...
AACT brewing is analogous to making milk or baking a cake — every step in the production chain can result in failure if not controlled properly. The compost can be "sick," the tea machine dirty, aeration inadequate, the holding tank problematic, or the delivery system flawed. Each element must be tested and verified.
...
Food is added to grow the organisms extracted from compost, not to substitute for poor compost. Key principles:
- Molasses amount relates more to machine aeration capacity than to organism needs
