...
- This blockade triggers a cascade of downstream effects:
  - Rapid increase in BDNF (brain-derived neurotrophic factor) production
...
- Duration (IV/IM): 30-60 minutes for primary effects; 1-2 hours for full recovery
- Duration (oral): 2-4 hours (longer due to first-pass metabolism)
