...
- Creation of edge habitats and corridors
- Division of zones for different management intensities

## Fence Types and Design

### Serrate or Zig-Zag Fences
Serrate or zig-zag fences not only stand on their own but resist wind-throw much better than straight barriers. This design principle applies to all boundary types and increases the functional edge available for planting.

### Living Fences (Hedges)
Living fences (fedge) combine the functions of fence and windbreak. Species used include:

- Erythrina ("willi-willi") for tropical coastal wind protection
- Euphorbia hedges in traditional systems (e.g., Nepal)
- Casuarina, Leucaena, or Grevillea for permanent hedgerow
...
Fences integrate with many other permaculture elements:
