...
The Chytridiomycota has been defined traditionally on the basis
of a single posteriorly inserted smooth flagellum. The flagellated
cells may function as zoospores (asexual) or gametes (sexual).
...
monophyletic, chytrid groups are consistently basal in phylogenetic
trees.

## Molecular Phylogeny

Phylogenetic analyses indicate that the grouping of approximately
800 species of Chytridiomycota, largely defined by the ancestral
character state of a smooth posterior flagellum, is not
monophyletic. Some chytrid lineage occupies the most basal branch
of Kingdom Fungi, consistent with a choanoflagellate-like ancestor.

The genus basidiobolus is considered to have been derived from
within the core chytrids in trees based on rDNA, though analyses
of protein-coding genes retain it within the zygomycetes. This
...
Barr and Desaulniers (1988) established five orders of chytrids
based on zoospore ultrastructure:
- **Blastocladiales**: may represent a lineage independent of the
...
A phylogenetic analysis using SSU rDNA characters (James et al.
2000) distinguished four monophyletic clades and four small
independent groups of chytrids, results consistent with groupings
based on zoospore ultrastructure. Relationships among the orders
and chytrid clades, however, were not resolved.

## Zoospore Ultrastructure

Barr and Desaulniers established their classification system based
on ultrastructural features of zoospores, including the position
and morphology of the flagellum, the organization of the
kinetosome-associated organelles, and the type of rumposome.
Their implicit evolutionary hypothesis is congruent with
