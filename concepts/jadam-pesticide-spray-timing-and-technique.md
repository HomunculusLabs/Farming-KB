...
harmful; JADAM states the opposite is true. The presence of dew means
humidity is nearly 100 percent, so pesticide will evaporate very slowly.
Furthermore, the bodies of aphids and mites do not accumulate dew, meaning
the pesticide stays concentrated on the pest bodies.

## Seasonal Spray Timing

In spring and autumn, JADAM recommends spraying in the early morning. In
summer, when mornings are short, spray in the evening of a humid day. To
check humidity levels, spray water on plants and observe how fast it dries.
If evaporation is very slow even during daytime, daytime spraying is
acceptable.

For greenhouses, pesticide can be sprayed even during rainy weather since
there is no risk of wash-off. In open fields, avoid spraying just before
rain. The general rule is to apply pesticide early morning or at sunset
to avoid hot times of day and maximize contact time.
...
that is the key component of effective pesticide application.

A simple water test is essential before every spray operation. Put a few
drops of JWA in the water: if it remains clear and produces abundant foam
when shaken, the water is suitable. If the water turns murky like milk, it
is too hard. Water on the far left of a hardness spectrum is optimum; water
on the far right produces no foam at all.

Rainwater is a typical soft water and can be collected for pesticide use.
Collect rainwater 30 minutes after rain begins; the first 30 minutes
contain pollutants that should be discarded. If soft water is not available,
JADAM recommends using a water softener device with ion-exchange resin that
removes calcium, magnesium, and iron.

## Wetting Power and Coverage

Pesticides must fully coat the target to be effective. Without proper
wetting power, pesticide breaks into droplets that form spots of high
concentration on leaf surfaces, causing concentration stress and reducing
effectiveness. With adequate JWA, pesticide evenly coats the target, leaves
no marks, and causes less concentration stress.

The amount of JWA used is critical. For 500 liters (132 gal) of water, use
3 to 15 liters (0.8-4 gal) of JWA. If pest problems are not serious, use
around 3 liters. For growing problems, increase to 5 liters. For serious
infestations, increase to 15 liters. Once problems are under control,
reduce back to 3 liters. Using JWA at over 10 liters continuously might
suppress growth in some crops and damage the white powder coating of some
fruits.
