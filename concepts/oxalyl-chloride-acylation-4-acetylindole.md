...
The procedure described by Shirota et al. proceeds as follows:

1. A solution of 4-acetylindole (17.6 g, 100 mmol) in 100 mL of anhydrous diethyl ether is prepared with stirring in an ice bath
2. Oxalyl chloride (13 mL, 146 mmol) is added, representing a 1.46-fold excess over the starting material
3. After stirring for 15 minutes, 200 mL of n-hexane is added to reduce solubility
4. The reaction flask is placed in a freezer and stored overnight
...
The second part of the acylation-amidation conversion treats the dissolved glyoxalyl intermediate with dimethylamine. Specifically:

1. The yellow crystals are dissolved in 100 mL of anhydrous THF with stirring in an ice bath
2. A 2 M dimethylamine solution in THF (60 mL, 120 mmol) is added over 15 minutes
3. Pyridine (10 mL, 123 mmol) is also added as a base to scavenge the HCl generated
4. Additional anhydrous ether is added when solidification begins
5. The mixture is stirred for 15 minutes at room temperature
...
The 1H NMR spectrum of compound 6 in CDCl3 shows the characteristic broad singlet of the indole N-H at delta 10.40, aromatic protons of the indole ring between delta 7.0 and 7.52, and two distinct N-methyl singlets at delta 3.02 and 2.92 for the dimethylamino group, confirming non-equivalence of the methyl groups due to restricted rotation around the amide bond.
...
- [[lialh4-reduction-glyoxalylamide-psilocin-synthesis|LiAlH4 Reduction of Glyoxalylamide to Psilocin]]
