...
5. **Wait**: Spore deposit typically forms within 4-24 hours depending on species, specimen freshness, and environmental conditions. Spores fall according to the radiating symmetry of the gills.
6. **Remove and dry**: Once a visible spore deposit has formed, carefully remove the cap and allow the print to dry completely. If taken on paper, fold, seal in an airtight container, and label with date, species, and collection number.

### Contaminant-Free Spore Prints
By choosing a healthy, young specimen with the veil intact and carefully removing the veil tissue under aseptic conditions, a nearly pure spore print is obtained. This is the ideal way to start a multispore culture. When using microscope slides, spores can be sandwiched between two pieces of glass and taped along the edges to prevent entry of contaminant spores. A spore print carelessly taken or stored can easily become contaminated.

## Spore Print Storage

Dry spore prints should be sealed in airtight containers and stored in a cool, dark place. Refrigeration extends viability. Label with species, collection date, and origin. When first produced, spores are moist, inflated cells with a relatively high rate of germination. As time passes, they dry, collapse at their centers, and become increasingly difficult to germinate. Properly stored prints can remain viable for years.
...
- Sterile spore print
- Sterile syringe (10-20 cc)
- Sterile water (distilled, boiled or autoclaved)
- Sterile inoculation loop or scalpel
- Flame source (alcohol lamp)
- Glove box or laminar flow hood

### Procedure

1. **Sterilize water**: For 30 minutes at 15 psi, sterilize a syringe and a water-filled test tube or flask. Allow to cool to room temperature.
2. **Prepare work area**: Clean and disinfect glove box or laminar flow hood.
3. **Load syringe**: Draw sterile water into the syringe. Flame-sterilize the needle before and after.
4. **Scrape spores**: Using a sterile loop or scalpel, carefully touch some spores from the print and insert into the sterile water. Tightly seal and let stand for 6-12 hours to rehydrate dehydrated spores.
5. **Suspend spores**: After rehydration, draw up several milliliters of the spore solution. For agar inoculation, inoculate several plates with one or two drops each.
...
Flame-sterilize the needle. Open the Petri dish just enough to inject 1-2 drops of spore solution onto the agar surface. Close and gently tilt the plate to spread the suspension. When starting a new culture from spores, it is best to inoculate at least three media dishes to improve chances of successful germination. Alternatively, use a sterile loop to streak the spore solution across the surface for isolated colony formation.

### Inoculating Grain

Inject 1-2 cc of spore solution through the injection port of a grain spawn jar. The solution runs down the inside of the jar, distributing spores across multiple grain kernels. This method is less reliable than agar-to-grain transfer because the cultivator cannot verify mycelial purity before grain colonization.

## Multispore vs. Single Spore
