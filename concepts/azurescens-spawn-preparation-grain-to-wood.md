...
### Procedure
1. Combine ingredients, bring to boil until fully dissolved
2. Pour approximately 1 cm depth into jars (no taller than 10 cm)
3. Loosely cap jars; cover with tin foil
4. Sterilize at maximum pressure (121C) for **20 minutes**
5. Cool to room temperature

### Spore Germination
1. Clean workspace with 70% ethanol
2. Sterilize inoculation loop or tweezers in gas flame
3. Cool loop on sterile agar surface (spores stick to the wet surface)
4. Pick up spores and transfer to agar
5. Incubate at **18-24C (65-75F)**
...
5. **Fallback**: If contamination problems persist, use wet sterilized cardboard as a more selective medium

## Stage 2: Grain Spawn

Grain spawn serves as an intermediate expansion step between agar and wood chips. The preparation of grain spawn follows standard procedures (not detailed in the azurescens source, but referenced as a prerequisite in the woodlovers guide).

## Stage 3: Wood Chip Spawn

### Chip Preparation

Two container options:

**Glass Jars (azurescens guide)**:
- Fill large jars **2/3 full** of fresh hardwood chips (beech, alder, or hazelnut)
- Moisture content target: **60-65%** — wood should not be sitting in water
- Sterilize at 121C for **1+ hours** (adjust for container size)
- Caps must be loose during sterilization (screwed tight = broken jars)

**Polypropylene Bags (woodlovers guide)**:
