---
title: Historical Periods of Neurotropic Fungi Discovery
created: 2026-04-28
tags:
  - mycology
  - history
...
## First Period: Ancient to Pre-Columbian Use
...
## Second Period: The Wasson-Heim Era (1953-1969)
...
## Third Period: Chemical Exploration (1960s-1970s)

The third period was characterized by widespread chemical screening of fungal species for indole alkaloids. Following the discovery of psilocybin, researchers around the world began testing diverse fungi for similar compounds. Ola'h (1969, 1970) conducted systematic chromatozinomic studies of the genus Panaeolus, describing several new species with putative psychoactive properties.

This period saw the expansion of known neurotropic genera beyond Psilocybe to include Copelandia, Conocybe, Inocybe, Pluteus, Gymnopilus, Gerronema, and others. However, the chemical methods of this era were sometimes imprecise, and many reports of psilocybin in unlikely species have since been questioned or retracted. Stijve and Kuyper (1988), for example, demonstrated the absence of psilocybin in Gerronema fibula and G. solipes, species previously reported to contain indole alkaloids.
...
The fifth and current period is characterized by a synthesis of traditional taxonomy with modern molecular techniques, ethnopharmacology, and global communication. Guzmán's 1995 supplement to his Psilocybe monograph, Gartz's 1996 comprehensive survey "Magic Mushrooms Around the World," and Stamets's 1996 identification guide all represent major contributions of this era.

This period has seen the description of new species from previously under-explored regions, including Psilocybe samuiensis from Thailand, P. natalensis from South Africa, and several new species from Colombia and the Caribbean. The development of improved chemical analysis methods, particularly HPLC and mass spectrometry, has allowed more precise and reliable detection of indole alkaloids in fungal specimens.

The internet and global communication have facilitated the exchange of information among researchers, cultivators, and enthusiasts worldwide, accelerating both scientific progress and popular interest. This period also encompasses the growing recognition of indigenous intellectual property rights and the ethical dimensions of neurotropic fungi research.

## Key Transitions Between Periods
...
The application of molecular phylogenetics since the 2000s has revolutionized the taxonomy of neurotropic fungi. DNA sequencing, particularly of the internal transcribed spacer (ITS) region, ribosomal RNA large subunit (LSU), and protein-coding genes such as RNA polymerase II subunits (rpb1, rpb2), has revealed that the traditional morphology-based classification of Psilocybe is polyphyletic. Notably, the bluing Psilocybe species (those containing psilocybin) form a clade within the family Hymenogastraceae that is distinct from the type species Psilocybe montana and its allies, which belong to the family Cortinariaceae.

This molecular evidence has led to the proposal of several new genera for bluing Psilocybe species, including *Psilocybe* sensu stricto, *Hypholoma*, and other segregate genera. The work of Walther, Allen, and colleagues in the 2010s and 2020s has further refined these relationships, demonstrating that the evolution of psilocybin biosynthesis occurred independently multiple times across the Agaricales.

## Indigenous Knowledge Systems and Epistemological Frameworks

The traditional ecological knowledge (TEK) surrounding neurotropic fungi represents an underappreciated dimension of their discovery history. Indigenous Mazatec, Mixtec, Zapotec, and Chinantec communities developed sophisticated taxonomies for psychoactive mushrooms that predate Linnaean classification by centuries. María Sabina's velada ceremonies, for instance, involved the use of multiple species that she distinguished by appearance, habitat, and psychoactive character — a functional taxonomy that was largely ignored by early Western researchers focused on herbarium specimens.

The concept of "entheogenic epistemology" — ways of knowing that emerge from altered states of consciousness induced by these fungi — has been explored by scholars such as Luna (1984) in the context of Mazatec curing practices and Schultes and Hofmann (1979) in their broader survey of plants of the gods. These knowledge systems challenge the conventional Western scientific framework in which "discovery" is defined by isolation of active compounds, suggesting that indigenous peoples had already achieved pharmacognostic understanding of these organisms centuries before Hofmann's chemical characterization of psilocybin.

## Biopiracy and Ethical Dimensions of Collection

The history of neurotropic fungi discovery is inseparable from questions of biopiracy and the exploitation of indigenous knowledge. Wasson's 1957 *Life* magazine article "Seeking the Magic Mushroom" exposed Huautla de Jiménez to international attention, leading to an influx of countercultural pilgrims that disrupted traditional Mazatec practices. María Sabina herself expressed regret over this exposure, noting that the sacred mushrooms had been "profaned" by their popularization among outsiders who lacked the cultural context for their reverent use.

The collection and export of fungal specimens from indigenous territories without benefit-sharing agreements raises ongoing ethical concerns. The Nagoya Protocol on Access and Benefit Sharing (2010), while primarily designed for plant genetic resources, has implications for fungal genetic resources as well. The psilocybin biosynthetic gene cluster identified in *Psilocybe cubensis* was isolated from specimens collected in regions where indigenous communities had used the species for millennia, yet no formal benefit-sharing mechanism connected the commercial development of synthetic psilocybin to these source communities.
