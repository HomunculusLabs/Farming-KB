...
As a commensal organism, Candida albicans thrives on human skin and mucosal linings. Up to 1,000 Candida cells can be present in every gram of feces, reflecting its abundance in the intestinal tract. The fungus normally exists in equilibrium with the host immune system and the other microorganisms that constitute the human microbiome.
...
When Candida becomes aggressive, the switch from yeast to hyphal form enables it to dig into solid tissues. The hyphae act like drills, applying mechanical pressure at their tips while secreting enzymes that dissolve the extracellular matrix and cellular components of host tissue. This dual strategy of mechanical force and enzymatic digestion allows the fungus to penetrate barriers that would be impenetrable to yeast cells alone.

Infections are usually associated with damage to the immune system. The fungus causes vaginal thrush, and its presence in the birth canal can lead to proliferation of the yeast on newborn babies. In more severe cases, particularly in patients with AIDS, organ transplants, or cancer therapy, Candida can cause systemic infections affecting multiple organ systems.

The transition from localized mucosal infection to systemic disease represents a critical clinical threshold. Once Candida enters the bloodstream, it can seed virtually any organ, forming dense networks of hyphae within tissues. Systemic candidiasis carries a high mortality rate, particularly among patients whose immune systems are already compromised by underlying disease or immunosuppressive therapy.
...
Some enzymes remain trapped in liquid-filled spaces within the wall, while others diffuse into the surrounding environment to attack host tissues. The vesicle secretion pathway from the endoplasmic reticulum to the hyphal tip is a fundamental feature of fungal cell biology. It ensures that destructive enzymes are delivered precisely where they are needed, at the interface between the invading hypha and the host tissue.

The efficiency of this directed secretion system means that proteases are concentrated at the point of tissue contact, maximizing their effect on host barriers while minimizing waste. This targeted delivery is analogous to the secretion of cellulases and pectinases at the hyphal tips of plant-pathogenic fungi, reflecting a common strategy of enzymatic attack deployed across different fungal lineages.

## Genetic Approaches to Virulence
...
Technical innovations in genomics and proteomics have transformed the study of Candida infections. No longer limited to analyzing a handful of genes and proteins, new methods allow comprehensive readings of the activity of every gene and gene product in the cells of the fungus and its host during the infection process. These approaches illuminate the full spectrum of proteins manufactured when Candida is transformed from a yeast into a hypha.

The flurry of gene expression that accompanies the invasion of living tissues can now be captured and analyzed in its entirety, rather than examined one gene at a time. This holistic approach has revealed that the yeast-to-hypha transition involves coordinated changes in the expression of hundreds of genes, affecting everything from cell wall composition to metabolic pathways.

Proteomic analyses complement genomic data by revealing which proteins are actually present and active during infection, providing a more direct picture of the pathogenic machinery. Together, genomics and proteomics offer the prospect of a complete molecular description of the infection process, from the initial yeast-to-hypha switch to the final colonization of host organs.

## Antifungal Treatment

Fluconazole is highly effective at treating different kinds of Candida infection. The drug blocks ergosterol synthesis through inhibition of the enzyme 14-alpha-demethylase, the same mechanism by which it treats cryptococcal infections. However, recent encounters with drug-resistant strains have heightened the demand for new therapeutic approaches.

The emergence of resistance underscores the need for continued development of novel antifungal strategies and the importance of understanding the full complexity of fungal virulence. Resistant strains of Candida have become an increasing concern in hospital settings, where immunocompromised patients are particularly vulnerable.

The ability of Candida to develop resistance through multiple mechanisms, including alterations in the target enzyme and increased efflux of the drug, makes it a formidable challenge for clinicians. The rise of fluconazole-resistant Candida strains in intensive care units underscores the urgency of developing new antifungal agents with novel mechanisms of action.
