...
The essential oils that serve as precursors contain allylbenzene or propenylbenzene structures that can be converted through chemical transformations into amphetamine derivatives. Key oils mentioned in PiHKAL include:

- **Safrole** (from sassafras) -- precursor to MDA, MDMA, and the entire MD-family
- **Isosafrole** -- alternative precursor to the MD-series
- **Myristicin** (from nutmeg and oil of parsley) -- precursor to MMDA
- **Elemicin** (from nutmeg) -- precursor to TMA
- **Eugenol** -- precursor to various DMA compounds
- **Methyl eugenol** and **methyl isoeugenol** -- precursors to 3,4-DMA
- **Apiole** (from oil of parsley) -- precursor to DMMDA
...
1. Isomerization of myristicin to isomyristicin (cis/trans mixture)
