---
title: Sandy Loam Texture and Physical Soil Properties in Cannabis Microbiome Assembly
created: 2026-05-11
source: understanding-cultivar-specificity-cannabis-microbiome.md
tags: [cannabis, microbiome, soil-texture, sandy-loam, sand-silt-clay, physical-properties, edaphic]
...
the diffusion of both oxygen and soluble nutrients through the soil matrix.

## Detailed Soil Physicochemical Profiles

The five soil types measured in the study showed the following characteristics:

| Soil ID | Sand | Silt | Clay | pH | Salinity | Total N | Org C | Water |
|---------|------|------|------|-----|----------|---------|-------|-------|
...
The first three soils (MB.1.B, MB.1.SD, MB.1.BK) came from the first experiment and
showed minimal chemical variation, consistent with the study's goal of isolating
cultivar effects under uniform edaphic conditions. The two second-experiment soils
...
biomass rather than differences in the mineral silt fraction itself. High organic carbon
in OC.2 soil correlated with higher water content (0.371 vs. 0.113), creating a very
different moisture regime that would select for different microbial functional groups.
