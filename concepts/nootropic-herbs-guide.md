---
title: Nootropic Herbs Guide
created: 2026-04-12
updated: 2026-04-12
type: concept
tags: [plants, medicine, health, neuroscience, pharmacology, preparation, species-profiles, biochemistry, ethnobotany]
sources: []
---
...
### Best Used With
- Bacopa for complementary memory enhancement.
- Ginkgo for circulatory support to deliver compounds to the brain.
...
- **Asiatic acid and madecassic acid:** Triterpenoid aglycones with neuroprotective and antioxidant properties.
- **Centellosides:** Additional saponins.

### Mechanisms
- **Cognitive enhancement:** Enhances dendritic and axonal arborization in the hippocampus. Increases synaptic density.
- **Anxiolytic:** Modulates GABA-A receptors. Reduces cortisol and corticosterone.
- **Circulatory:** Strengthens blood vessel walls, improves microcirculation (including cerebral blood flow).
- **Antioxidant:** Reduces oxidative stress in brain tissue.
- **Anti-inflammatory:** Inhibits NF-kB and reduces pro-inflammatory cytokines.
- **Wound healing:** Stimulates collagen synthesis and connective tissue repair (separate from cognitive effects).

### Clinical Evidence
- Improves mood and cognitive function in elderly populations. Reduces anxiety in clinical trials.
- Enhances memory and attention in healthy adults. Improves venous insufficiency and microcirculation.

### Dosing
- **Standardized extract (titrated to asiaticosides):** 250-500mg, 1-2 times daily.
- **Leaf powder:** 1-3g per day.
- **Tincture:** 2-4ml, 2-3 times daily.
- Can be taken long-term.
- Often combined with bacopa in Ayurvedic cognitive formulations (Medhya rasayana).
...
### Clinical Evidence
- Modest improvement in cognitive function in age-related decline and Alzheimer's (mixed results across meta-analyses). Improves attention and working memory in healthy adults under stress. Effective for intermittent claudication. Reduces anxiety. Limited evidence for tinnitus.

### Dosing
- **Standardized extract (24% flavonol glycosides, 6% terpene lactones):** 120-240mg/day, divided 2-3 doses.
- **Tincture:** 2-4ml, 2-3 times daily.
- Effects may take 4-6 weeks. Long-term use (6+ months) may be needed for dementia prevention.
