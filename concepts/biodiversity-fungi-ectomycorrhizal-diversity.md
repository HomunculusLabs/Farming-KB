...
influenced by the fungal hyphae and altered root exudation patterns.

## Seasonal Variation and Succession

ECM sporocarp production varies seasonally, typically peaking with
summer rains and at high elevations and latitudes. Some ECM species
fruit in very young tree stands, others are restricted to older stands,
...
limited dispersal ability (especially for animal-dispersed sequestrate
fungi) makes many ECM species vulnerable to habitat disruption.
Comprehensive, multi-year surveys using standardized methods are
essential for documenting ECM diversity and informing conservation
strategies.
