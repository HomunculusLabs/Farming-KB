...
preparation. The method progresses through three phases: initial extraction,
filtration, and evaporative concentration.

## Solvent Selection and Procurement

The extraction requires 200 proof anhydrous ethyl alcohol (100% pure, no
water). The PF TEK emphasizes that 200 proof is preferred because the absence
of water is critical, especially during the evaporation and concentration
...
in a strong zip-lock freezer bag, covering with a magazine for protection,
and pounding with the rubber heel of a large shoe. The resulting powder is
placed in a bottle with a tight-fitting leak-proof cap. Enough alcohol is
added to cover the material and create a loose slurry. The bottle is shaken
and left to soak for 24 hours, with periodic shaking to activate the
extraction.

## Filtration Phase

After 24 hours of soaking, the alcohol-slurry mixture is filtered. The PF TEK
recommends inexpensive dust-pollen masks as filters, available at hardware,
drug, and paint stores. These masks are fashioned over the mouth of a
drinking glass, and the slurry is poured through. The filter is squeezed to
