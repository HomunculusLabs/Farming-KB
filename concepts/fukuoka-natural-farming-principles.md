...
Masanobu Fukuoka (1913–2008), a Japanese farmer and philosopher, developed a system of
agriculture he called "natural farming" (自然農法, shizen nōhō) founded on five fundamental
...
grows without human pruning, its branches do not tangle, sunlight falls on every leaf, and it
bears fully each year rather than in alternate years. The pruning of trees, in his view, is
yet another example of human beings creating problems through intervention and then claiming
credit for solving them. The concept of right and wrong, good and bad, are alien to nature;
these are only distinctions invented by man. Nature maintained a great harmony without such
