...
- **Intensity**: Low to moderate. Seedlings are extremely sensitive to intense light and can burn easily.
- **Type**: Fluorescent (T5, CFL) or LED at reduced intensity work well
- **Distance**: Keep lights 18–24 inches above seedlings (adjust based on type and intensity)
- **Photoperiod**: 18 hours on / 6 hours off is standard. Some growers use 24/0 for seedlings.
- **Signs of too much light**: Leaves curl upward, tips bleach white or yellow, seedling stretches away from the light

### Temperature

- **Optimal**: 72–80°F (22–27°C) during lights on
