---
title: Psilocybin Mushroom Habitat Types
created: 2026-04-13
updated: 2026-04-13
type: concept
tags:
...
### 3. Enriched Soils and Garden Mulch
...
### 4. Tropical and Subtropical Forests

Forests in tropical and subtropical regions harbor the greatest diversity of psilocybin species:

- **Primary species**: Numerous *Psilocybe* species fruit on forest floor debris, decaying wood, and mossy banks in tropical rainforests and cloud forests.
- Species include *P. zapotecorum*, *P. caerulescens*, and many Mexican species found in cloud forest habitats above 1000 meters elevation.
- Amazonian and Atlantic coastal forest species fruit on decomposing forest litter.
- Fruiting often correlates with rainy seasons and can be highly seasonal.

### 5. Coastal Dune Grasslands
...
High-altitude grasslands support specialized species:

- Several *Psilocybe* species in Mexico and the Andes fruit in highland meadows above 2000 meters.
- *Psilocybe semilanceata* occurs in upland pastures in Europe and North America.

## Seasonal Patterns

| Region | Peak Season | Notes |
|---|---|---|
| Tropical | Year-round (wet season peaks) | Rainfall-dependent |
| Temperate | Autumn (Sep-Nov Northern / Mar-May Southern) | Cool, wet conditions |
| Mediterranean | Autumn/Winter | First rains trigger fruiting |
| Pacific NW | Autumn | Heavy fruiting Oct-Dec |
