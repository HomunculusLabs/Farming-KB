...
3. **Darkness or low light**: Ceremonies are almost always conducted in
   darkness or low light, which facilitates the emergence of visions.

### Common Elements Across Traditions

Anthropological literature reveals consistent features across shamanistic
hallucinogenic plant use worldwide:

1. **Central role of the guide**: An experienced healer with extensive
   personal knowledge of the medicines is always essential.
2. **Multi-level healing**: Healing can occur on physical, psychic, and
   spiritual levels through three main variations — extraction of toxic
   implants, retrieval of split-off soul fragments, and death-rebirth
   reconstitution.
3. **Divination and hidden knowledge**: The plant medicines are understood
   to possess an intelligence that communicates to those who ingest them.
   Indigenous healers refer to these as "plant teachers."
...
- **[[brazilian-ayahuasca-churches-santo-daime-udv-barquinha-structural-comparison]],
  ...
  in addictions and psychopathologies.
