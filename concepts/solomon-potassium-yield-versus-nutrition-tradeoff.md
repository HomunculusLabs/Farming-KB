...
Solomon's central observation is straightforward: higher potassium in soil produces bigger vegetables, but those bigger vegetables contain proportionally less nutrition per unit of weight or per calorie. The additional bulk yield triggered by potassium comes "in the form of calories, starch and fiber, and not in the form of protein, vitamins, enzymes, and minerals, which we need a lot of."

This means that a gardener or farmer faces a genuine tradeoff. Maximizing yield (pounds of harvest per unit area) and maximizing nutrition (nutrient density per calorie or per pound) are not the same objective and may require different soil management strategies. A carrot grown in high-potassium soil may weigh more and look more impressive, but a smaller carrot grown in moderate-potassium soil may provide more actual nourishment per calorie consumed.

The practical consequence for home gardeners, who grow food for nutrition rather than for market sale, is that they should deliberately manage potassium levels to optimize nutritional quality rather than bulk yield. This runs counter to standard agricultural advice, which universally treats higher yield as the goal.
...
Solomon acknowledges that a gardener "could sizably increase bulk yield by boosting the amount of potassium in garden soil higher" but immediately warns that "the nutritional content of veggies would decrease by just about as much as the yield went up." This direct proportional tradeoff makes excessive potassium a poor choice for any gardener whose goal is food quality rather than market weight.
...
Conventional soil testing and fertilizer recommendations typically treat potassium as a nutrient to be maintained at "optimum" levels for yield, without distinguishing between yield-optimum and nutrition-optimum levels. A soil test that reports potassium as "high" or "very high" may in fact be indicating conditions that favor bulk yield over nutritional quality.

Solomon's broader critique of [[soil-testing]] in organic gardens reinforces this point. He argues that soil tests developed for conventional agriculture may not be appropriate guides for gardeners whose goal is nutritional quality rather than maximum tonnage. The soil test framework itself embodies the assumption that more yield is always better, an assumption that Solomon directly challenges.
...
Solomon suggests that taste may serve as a practical indicator of nutritional quality. Vegetables grown with excessive potassium and pushed for maximum bulk yield tend to be less flavorful than those grown with balanced nutrition at moderate potassium levels. The decline in taste that many people associate with modern supermarket produce may be directly related to the potassium yield-nutrition tradeoff.

If the food "never tasted so good" with COF-grown vegetables, this may be because balanced nutrition, including moderate potassium, allows the full development of sugars, organic acids, aromatic compounds, and other flavor constituents that are diluted or suppressed in high-potassium, yield-pushed produce.
...
## Potassium Persistence and Soil Management

One of the most challenging aspects of potassium management is that excess potassium is difficult to remove from soil once it has accumulated. Unlike nitrogen, which leaches readily with rainfall or irrigation, potassium ions are held relatively tightly by clay minerals in the soil. A single season of heavy potassium application can elevate soil potassium levels for several years, even if no additional potassium is applied.
...
- Higher potassium produces larger vegetables with more starch, fiber, and water content
- The additional bulk does not come with proportional increases in protein, vitamins, or minerals
- Commercial incentives systematically favor yield over nutrition for both chemical and organic growers
- Home gardeners should deliberately limit potassium for nutritional quality
- Excess potassium can interfere with calcium uptake, compounding nutritional losses
- Potassium persists in soil and is difficult to correct once oversupplied
- Taste may serve as a practical indicator of nutritional quality
- Solomon's COF formula is designed to avoid excessive potassium while providing balanced overall nutrition
