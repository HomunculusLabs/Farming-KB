...
NFT hydroponic systems are high-performance gardens that perform well when fine-tuned. This relatively new form of hydroponics supplies aerated nutrient solution to roots located in gullies (channels). Seedlings or cuttings with strong root systems are placed on capillary matting on the bottom of a covered channel. The capillary matting stabilizes nutrient solution flow and holds roots in place.

Constantly aerated nutrient solution flows down the channel over and around the roots, and back to the reservoir. Irrigation is most often constant, 24 hours a day. Proper gully incline, volume, and flow of nutrient solution are key elements in NFT gardens. Roots receive plenty of oxygen and absorb maximum nutrient solution. The slope must be adequate to prevent water from stagnating.

Gullies are covered to keep humidity high in the root zone and light from shining on roots. Often a filter is necessary to prevent debris from blocking gullies and pump.

### NFT Limitations

Although high performance, NFT systems offer practically no buffering ability. In the absence of a growing medium, roots must be kept perfectly moist at all times. If a pump fails, roots dry and die quickly. If the system dries out for a day or longer, small feeder roots will die with grave consequences. Only growers with several years experience should try an NFT system if working alone.

### Hybrid NFT Systems

Many NFT systems are hybrids. In some, nutrient solution is delivered via spaghetti tubing to each plant for better irrigation distribution. The solution flows through a small basket of growing medium before running down the gully. Other hybrid NFT systems employ spray nozzles inside the gully to keep the root zone at 100 percent humidity.
...
Rooted clones and seedlings grown in aeroponic systems develop exceptionally fast. To grow clones, simply insert clone stems into the growth chamber and turn on the system. The roots develop in a perfect environment.

### Aeroponic Challenges

Aeroponic systems require greater attention to detail. There is no growing medium to act as a water/nutrient bank, making the system delicate. If the pump fails, roots soon dry and plants suffer. Systems using delicate spray nozzles must be kept free of debris. Imbalanced nutrient solution and pH can also cause problems quickly. Purchase quality components or a ready-made system from a qualified supplier.
...
Dissolved oxygen (DO) is the single most critical factor in water culture systems. Roots require oxygen for cellular respiration, and without adequate DO levels, roots suffocate and become susceptible to pathogens like Pythium (root rot). Cold water holds more dissolved oxygen than warm water — at 68°F (20°C), water holds approximately 9 mg/L of DO, while at 77°F (25°C) it holds only about 8 mg/L.
...
- [[cervantes-hydroponic-systems]] for general hydroponic overview
- [[cervantes-growing-medium]] for substrate options
- [[cervantes-nutrient-management]] for nutrient solution formulation
- [[cervantes-water-quality-management]] for water quality requirements
