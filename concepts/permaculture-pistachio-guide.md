---
title: Pistachio Growing Guide
created: 2026-04-18
updated: 2026-04-22
sources: Permaculture Plants: A Selection (Juniper Hall)
tags: nut-tree, permaculture, tree-crop, orchard, drought-tolerant
type: concept
---
...
A native of western Asia and Asia Minor, the pistachio is a long lived, relatively slow growing, deciduous tree, with a spreading growth habit, eventually reaching a height of 10 m.

## Nutritional Composition

Per 100 grams of edible portion: Water - 5.3%, Energy - 594 calories, Carbohydrate - 19.0 g, Fat - 53.7 g, Protein - 19.3 g, Ash - 2.7 g, Calcium - 131 mg, Potassium - 972 mg, Magnesium - 158 mg, Iron - 7.3 mg, Phosphorous - 500 mg, Vitamin A - 230 I.U., Thiamin - 0.67 mg, Niacin - 1.4 mg.
...
It prefers a deep, fertile soil, but is remarkably adaptable to different soil types, as long as there is sufficient depth of soil and it is well drained. It will tolerate a wide range of pH in the soil and will tolerate about twice the degree of salinity as most other fruit and nut trees. Its climatic requirements however, are more specific.

The ideal soil for pistachio cultivation is a deep loam or sandy loam with good internal drainage. Heavy clay soils that become waterlogged during winter can promote root rot diseases, particularly Phytophthora. Pistachios are among the most salt-tolerant of all cultivated nut trees, capable of producing viable crops in soils with electrical conductivity (EC) levels up to 8-10 dS/m, where most other fruit trees fail. This makes them suitable for marginal agricultural land and areas affected by irrigation-induced salinization. Soil testing before planting is recommended to assess drainage, pH, salinity, and nutrient levels, with particular attention to boron and chloride concentrations which can accumulate to toxic levels in arid region soils.

## Production

Trees can begin to crop in years 5-7, but may take up to 15 years before nuts are produced. They are dioecious, requiring both male and female trees, and flowers are wind pollinated. Usually, pistachio trees bear a crop biennially and are capable of producing in excess of 50 kg of nuts per tree.

## Harvest

The nuts comprise a single large seed inside a thin shell, which is surrounded by a thin hull. They ripen in early Autumn, when the fleshy hull becomes soft and partly separates from the shell. The shell splits open to reveal the kernel inside. Nuts are harvested either by being knocked off with sticks, picked by hand or shaken by a mechanical shaker. The nuts are then hulled and dried as quickly as possible to prevent spoilage of the kernels.

## Propagation

Trees are propagated by grafting onto the rootstocks of two other species of pistachio (P. vera is not recommended as a rootstock as it grows slowly with a straggling habit). Spacing of trees is about 8 m, with the ratio of male to female cultivars being 1 to 9. Pistachios naturally form low bushy trees which are difficult to manage, so have to be trained to encourage a strong trunk and up to 5 main limbs.
...
**Pistacia atlantica** (butum, Mt Atlas pistachio) -- A semi-evergreen to deciduous, slow to moderate growing tree (to 20 m), native to the Canary Islands and the Mediterranean region to the Caucasus and Pakistan. The tree is very hardy and can tolerate prolonged heat, drought, wind, cold and alkaline soil conditions. It bears small turpentine fruits called gadum which are eaten raw in the Middle East. It is valued commercially for a resin which oozes from its branches. Commonly used as a rootstock for Pistacia vera because it is resistant to nematodes and root-knot and prefers heavy soils.

**Pistacia terebinthus** (Cyprus turpentine tree, terebinth pistachio) -- Native to the Mediterranean region, this semi-evergreen tree grows to a height of 5 m. It grows on most soils. The sweet, greenish nuts are eaten out of hand or the oil is extracted from them. Young leaves are cooked and used as a vegetable. In Iran, the resin from the trunk is used as a chewing gum. Immature fruits, still on a portion of stem, are preserved in vinegar and salt, and then made into a relish. This species is also used as a rootstock for Pistacia vera.

## Other Pistacia Species
...
Pistachios are ideal anchor species for dryland food forest systems. Their deep taproot system (extending 3-6 meters) accesses water and nutrients unavailable to shallow-rooted understory plants, creating a complementary rather than competitive root architecture.

During the long establishment period, the space between young pistachio trees can be productive through strategic interplanting:

- **Nitrogen fixers** (carob, mesquite, tagasaste) provide both fertility and intermediate shade
- **Herbaceous legumes** (alfalfa, clover, vetch) fix nitrogen and provide cut-and-carry mulch material
