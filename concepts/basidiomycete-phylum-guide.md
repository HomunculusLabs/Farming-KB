---
title: Basidiomycete Phylum Guide
created: 2026-04-12
updated: 2026-04-12
type: concept
...
- Spores produced externally on basidia (club-shaped cells)
- Possess a clamp connection structure on septate hyphae
- Often produce large, visible fruiting bodies (basidiocarps / mushrooms)
- Includes many mycorrhizal and saprotrophic species
- Dikaryotic phase is often prolonged (n + n nuclei coexist)
...
### Polyporales
The bracket fungi and polypores. Includes Ganoderma (reishi), Trametes (turkey tail), Fomes (hoof fungus), and Laetiporus (chicken of the woods). Most are wood-decay fungi, playing crucial roles in forest decomposition. See reishi cultivation.

### Russulales
Includes Russula (brittlegills) and Lactarius (milk caps). Members have brittle flesh due to spherical cells (sphaerocysts) in their tissue. Many are ectomycorrhizal. Also includes Hericium (lion's mane); see [[lions-mane-guide]].

### Cantharellales
Contains Cantharellus (chanterelles) and Craterellus (trumpet mushrooms). These are popular edible ectomycorrhizal mushrooms with distinctive forked ridges rather than true gills. See chanterelles.
...
| Genus | Ecological Role | Significance |
|-------|----------------|-------------|
| Agaricus | Saprotroph | Commercial button/portobello mushroom |
| Pleurotus | Saprotroph, wood decomposer | Oyster mushrooms, easy to cultivate |
...
| Flammulina | Wood decomposer | Enoki mushroom |
...
Pleurotus species can degrade organic pollutants and are used in [[fungal-remediation-decision-tree|mycoremediation]]. Some basidiomycetes produce enzymes useful for bioremediation of contaminated soils.

## Reproduction

Basidiomycetes reproduce sexually through basidiospores, which are produced on the surface of basidia. Plasmogamy creates a dikaryotic mycelium that can persist for long periods. Karyogamy occurs in the basidium, followed immediately by meiosis to produce haploid basidiospores. Many also reproduce asexually through conidia or oidia.

## Identification Tips

- Spore print color is critical: white, cream, pink, brown, rusty, purple-brown, or black
- Check for gills, pores, teeth, or smooth surfaces under the cap
