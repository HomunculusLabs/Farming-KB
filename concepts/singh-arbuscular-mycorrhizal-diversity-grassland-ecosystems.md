...
- Dung deposition creates localized nutrient hotspots that alter AMF
  ...
  species
- Trampling compacts soil and disrupts hyphal networks, with effects
  varying by soil type, moisture, and grazing animal species

The relationship between grazing and AMF diversity often follows a
hump-shaped pattern, with intermediate grazing intensities supporting
maximum fungal diversity through a balance between disturbance and
plant community complexity.

## Fertilization Impacts

Nitrogen and phosphorus fertilization are among the strongest drivers of
AMF community change in grassland ecosystems:
...
Long-term fertilization experiments demonstrate that AMF diversity recovery
after cessation of fertilization is slow, requiring decades for full
community restoration in some cases.
