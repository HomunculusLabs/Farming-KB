...
Hallucinogenic mushrooms containing [[psilocybin-compound]] and [[psilocin]] present a distinct risk profile compared to most other recreational substances. They do not produce physical dependence or withdrawal symptoms, and acute toxicity is generally low. However, mental health risks are well documented, and rare but serious outcomes including fatalities have occurred, typically in combination with other risk factors such as alcohol consumption or pre-existing conditions. The EMCDDA 2006 case study provides a comprehensive European perspective on these consequences.
...
Several factors naturally limit habitual use of hallucinogenic mushrooms:
...
The acute toxicity of [[psilocybin-compound]] is considered low. Fatal intoxications directly attributable to hallucinogenic mushroom consumption are extremely rare. The EMCDDA case study documents:
...
- One suicide death in the Czech Republic in 2004, in which hallucinogenic mushrooms were detected in the autopsy report
...
- Slovenia: 2 cases (2005)
- Sweden: 30 to 40 calls annually to the Poisons Information Centre, remaining relatively stable over five years

These figures should be interpreted with caution due to substantial variation in reporting systems, coverage, capacity, and case definitions across EU Member States.

### Diagnosis and First Aid

Intoxication with hallucinogenic mushrooms is not always easily diagnosed unless there is information about recent ingestion from the user, friends, or family. Standard first aid protocols include:
...
- No evidence of irreversible organ damage attributable to [[psilocybin-compound]]
- Insufficient data on mutagenicity and teratogenicity to draw conclusions
- No established long-term somatic health consequences from moderate recreational use

## Mental Health Risks

### Bad Trips and Acute Psychiatric Emergencies

Mental health risks represent the most significant concern associated with hallucinogenic mushroom use. Although the proportion of users experiencing a "bad trip" is not precisely known, these individuals are most likely to contact emergency services. Characteristics of acute psychiatric presentations include:

- Extreme anxiety and severe agitation
- Confusion and disorientation
- Impaired concentration and judgment
- Acute psychotic episodes with bizarre, frightening images
- Severe paranoia and total loss of reality

### Risk of Self-Harm

Acute psychotic states can lead to:

- Accidents and unintentional injury
- Self-injury
- Suicide attempts

Documented fatal cases typically involve additional risk factors:

- A March 2004 case in Manchester, UK: a 31-year-old man died after leaping from a tower block window following consumption of Hawaiian [[psilocybin-compound]] containing mushrooms combined with alcohol. A coroner's inquest confirmed the contributory role of both substances.
...
A bad trip is typically followed by:

- Faintness
- Sadness and depression
- Paranoid interpretations

These after-effects may persist for days, weeks, or even months. Some symptoms may be associated with concurrent use of other controlled substances rather than mushroom use alone.
...
Intermittent and chronic psychotic states resulting from hallucinogenic mushroom use are possible. In susceptible individuals, mushroom use can bring to the surface underlying psychotic or [[personality-disorders]]. This is of particular concern for individuals with:
