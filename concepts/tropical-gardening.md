...
|------|-------------|-------------|-------|
| Cassava (manioc) | 1,600 | 8-18 months | Drought-tolerant; must be cooked to remove cyanide |
| Taro (kalo) | 500 | 6-12 months | Loves wet conditions; can grow in flooded areas |
...
- **Avocado**: Requires well-drained soil; 3-8 years to fruiting
- **Breadfruit**: High-calorie staple; 3-5 years to fruiting; prolific producer
- **Jackfruit**: Largest tree fruit; productive in humid tropics
...
- **Eggplant**: Prolific in warm, wet conditions
