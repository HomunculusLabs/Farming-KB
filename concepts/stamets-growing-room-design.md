...
- Thermal exhaust fan: 400-600 cfm at room apex
- Vortex fan: 200-400 cfm at head level near exit door (enhances cyclonic entrainment)
- Both fans covered with bug-proof, non-mildewing cloth; louvered shutters when not in use
- Each growing room should be independently controlled

### 8. Fresh Air Filtration
...
- Becomes thick with spores during cropping (especially Oyster -- spore load can literally stop high-volume cfm fans)
- Mist nozzles in recirculation duct-work can rinse spores from air
- Filters clog quickly during cropping -- change daily if used
- Recirculation duct centrally located below incoming air; damper door controls degree

### 10. Humidification
- 6-12 air exchanges/hour makes full humidification difficult with dry outside air
