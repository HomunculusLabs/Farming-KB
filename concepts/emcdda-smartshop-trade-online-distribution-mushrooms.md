...
- **Truffles/sclerotia**: [[psilocybe-azurescens]] mycelium on hardwood chips, 24 to 25
  EUR each
- **Grow kits**: Complete cultivation boxes with colonized substrate, 25 to
  100 EUR
...
interfaces in English, French, and German to attract foreign customers.
Website analytics from one Dutch online shop showed access patterns between
May 2004 and February 2006: 73 percent from the Netherlands, 14 percent from
Belgium, 2 percent from Germany, and 2 percent from France. Most sites
refrained from shipping to countries where sales were prohibited, though
enforcement was inconsistent. Online shops sold fresh mushrooms, mushroom
