---
title: GROW BIOINTENSIVE Method Overview and History
created: 2026-04-26
author: John Jeavons
sources: How to Grow More Vegetables, 8th edition
book: How to Grow More Vegetables
tags: [biointensive, sustainable-agriculture, mini-farming, organic-gardening, grow-biointensive]
type: concept
updated: 2026-04-26
---
...
The critical caveat of GROW BIOINTENSIVE is that it is a whole, interrelated farming system. Its components must all be used together for optimum effect. If not all elements are used together — particularly if high yields are achieved without recycling all wastes and growing sufficient organic matter — the practices can deplete the soil more rapidly than other farming practices because of the intensity of production.

Jeavons frames this in terms of the planet's limited topsoil. With approximately 42 to 84 years' worth of topsoil remaining worldwide, learning how to enrich, improve, and maintain soil in a sustainable way is of vital importance. The method seeks to approach "99% sustainability" — a system where nutrient losses are approximately balanced by nutrient gains from rainfall, rock breakdown, and biological processes.

To achieve this, Jeavons recommends dividing the growing area approximately as follows: 60% in carbon-and-calorie crops (grains and legumes that produce both dietary calories and compost material), 30% in special root crops (potatoes, burdock, garlic, parsnips) for maximum calories per unit area, and a maximum of 10% in vegetable crops for additional vitamins and minerals.

## The Diet Design Connection

GROW BIOINTENSIVE is not only a gardening method — it is a complete food-raising system designed to produce a complete diet. The method can theoretically produce all the food for one person on as little as 4,000 square feet at intermediate yield levels, compared to the 15,000 to 30,000 square feet required by commercial agriculture.

The Biosphere II project demonstrated that a complete year's diet for one person could be raised on the equivalent of just 3,403 square feet using Biointensive techniques. This level of efficiency depends on growing calorie crops (grains and root crops) alongside vegetables, compost crops, and seed crops — the full eight-component system.

## Soil Fertility and the Carbon Cycle

The method relies on cured compost as the primary source of soil fertility. Compost provides a slow-release biological nutrition that is fundamentally different from chemical fertilizers. The humus in compost acts as a nutrient exchange site — its surfaces carry negative electric charges that attract and hold positively charged nutrients (calcium, magnesium, potassium, trace minerals), releasing them gradually as plant roots "bargain" with the humus surface.

This biological nutrient release means that plants receive nutrition in forms and at rates they can use, rather than being flooded with soluble nutrients all at once. The result is healthier plants that are more resistant to disease and insect attack — most insects preferentially attack sick or stressed plants.

The method's emphasis on carbon-efficient crops is directly connected to soil fertility. Approximately 60% of the growing area must be dedicated to crops that produce large amounts of carbonaceous material for compost. Without this carbon input, the soil's organic matter (and therefore its fertility) will decline over time, regardless of how well individual beds are managed.

## Practical Application for Home Gardeners

Jeavons encourages beginners to start simply. The first year can focus on the easiest crops in 100 square feet. The second year doubles the area and adds more challenging crops. By the third and fourth years, permanent plantings (fruit trees, herbs, strawberries, asparagus) are added to soil that has been improved through successive seasons of Biointensive management.

The progression from gardener to mini-farmer involves learning increasingly sophisticated skills: from basic bed preparation and composting, through seed propagation and transplanting, to advanced planning, companion planting, crop rotation, calorie farming, and complete diet design. Each step builds on the previous one, and the whole system becomes more productive and sustainable as the gardener's skill and the soil's fertility increase together.
