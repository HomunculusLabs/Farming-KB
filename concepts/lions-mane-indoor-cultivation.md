---
title: Lions Mane Indoor Cultivation
created: 2026-04-16
updated: 2026-04-18
type: concept
...
The mycelium is whitish, forming triangular zones of collected rhizomorphs radiating from the dense center section, sometimes resembling the structure of a glaciated mountain as seen from high overhead. If the top and bottom of culture dishes are taped together, evaporation is lessened with an associated pooling of carbon dioxide, stimulating aerial growth. As cultures age, the mycelia become yellow to distinctly pinkish. Islands of young fruitbodies form in petri dish cultures incubated at 75°F in two to three weeks, characterized by elongated, aerial "spider-like" spines which change from whitish to yellowish in age.
...
### Cropping Cycle
- Flushes every 14 days apart

## Recommended Spawn Generation

Lion's Mane is a classic example of a species requiring greater attention to spawn creation than most other species. The mycelium grows relatively slowly on nutrified agar media, with fruitbodies often forming before the mycelium has grown to a mere 25mm in radius. The traditional scalpel and wedge technique results in comparatively slow growth unless a regimen of diligent and frequent shaking of spawn jars is followed.

The recommended approach is to wait until primordial colonies form upon the mycelial mat on agar media, then cut cultures into sections and blend in an Eberbach-like stirrer. Once blended, the myceliated fluid, now rich in growth hormones associated with primordia formation, is expanded by transferring to sterilized grain filled spawn jars. The result is an explosion of cellular activity. Two colonies from 100x15mm petri dishes are used with every 1000ml of sterile water. Once stirred, 20-50ml of liquid inoculum is poured into each liter to half-gallon jar.

The spawn jars must be used immediately for further expansion into either more sterilized grain or sterilized wood, lest the primordia develop into sizeable fruitbodies within the jar. Should this occur, further use of these spawn jars is not recommended since the developing mushrooms will be damaged in the course of shaking.
...
- 550 grams fresh weight from 5 lbs. of hardwood (alder) sawdust, unenriched
- 1-lb clusters are common using the above technique
- With multiple sites forming exterior to the bag, maximum yield efficiency approaches 2 lbs
...
1/4 to 1/2 lb clusters carefully packaged in damage-proof containers. The size of clusters can be controlled by limiting the number of mushrooms that form on each flush. Best sold individually regardless of weight. The snow-ball-like forms are appealing when wrapped in rice paper or presented in a see-through container.
