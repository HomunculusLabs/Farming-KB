---
title: Solomon on Choosing Seed Catalogs and Varieties
created: 2026-04-21
updated: 2026-04-21
type: "concept"
...
Seed catalogs list "days to maturity" for each variety, but Solomon warns that this figure is often misleading. Days to maturity is typically counted from transplant date for transplanted crops and from direct sowing date for direct-seeded crops, but catalogs do not always specify which method was used. The figure is usually based on optimal growing conditions that may not reflect local reality. Solomon advises adding 10-14 days to the catalog figure to account for the difference between ideal conditions and actual garden conditions. For cool-season crops, the effective growing season is shorter than the calendar growing season because heat causes bolting before maturity. Understanding these adjustments is critical for avoiding crop failures due to selecting varieties that cannot mature within the available season.
...
Beyond individual variety selection, Solomon emphasizes the importance of planning crop rotations and succession plantings. Rotating crop families prevents the buildup of family-specific soil-borne diseases and pests, and allows different nutrient demands to be balanced across growing seasons. A basic rotation might follow heavy-feeding crops like tomatoes or corn with light-feeding crops like root vegetables, followed by legumes that fix nitrogen for the next cycle. Succession planting, where new crops are planted as previous crops are harvested, maximizes the productivity of limited garden space. These planning skills are essential for the self-sufficient gardener and represent a level of garden management beyond simple variety selection.
