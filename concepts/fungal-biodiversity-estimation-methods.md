...
- **Gamma diversity**: Total diversity across all units in a region.

Inadequate spatial replication or mismatched scales can produce misleading
estimates and obscure real ecological patterns.

## Power Analysis for Sample Size

Power analysis determines the number of samples needed to detect a specified
effect size with given confidence. In fungal studies, it estimates effort
required to detect site differences, document temporal changes, or estimate
richness with acceptable precision. Under-sampled inventories miss real
differences; excessive sampling wastes resources. Power analysis optimizes
the balance between rigor and feasibility.
...
ecological interpretations and limit comparative study utility.

## Summary

Estimating fungal biodiversity requires integrating species richness estimates,
diversity indices, spatial scaling considerations, and rigorous sampling design.
Despite formidable challenges posed by fungal biology, existing methods provide
powerful tools for documenting diversity, detecting environmental change, and
