...
### Paper Towel / Cotton Wool Method
...
- Risk: lower success rate than other methods
- Advantage: Seeds can be planted at the recommended depth of four times the largest diameter of the seed

### Rockwool SBS Propagation Tray (Recommended)

A propagation kit with rockwool cubes in slots that automatically wick water from a reservoir below. Seeds are placed in tiny holes in the cubes, and the cover creates a miniature greenhouse environment. Germination hormone can be added to the reservoir.
