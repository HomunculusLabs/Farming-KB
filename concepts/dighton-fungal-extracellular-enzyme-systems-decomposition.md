...
Sinsabaugh and Liptak (1997) catalogued the ectoenzymes produced by
fungi and their biochemical effects on organic resources in plant
...
other fungal species with similar physiological competence.

Initial colonizers typically use soluble carbohydrate sources (sugars)
and are later replaced by fungal species with greater enzymatic
competence capable of breaking down cellulose and lignin. However,
there are few clear distinctions in succession, and many species overlap
in time and space. The classic model (Swift et al., 1979) presents
changes from "sugar" fungi to basidiomycetes in relation to changing
