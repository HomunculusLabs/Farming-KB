...
Guzmán (1997) documented more than 200 common names for sacred mushrooms
in Mexico, many in indigenous languages. The most historically significant
include:

- **Teonanácatl** (Nahuatl): "Divine mushroom," first reported by the
  Franciscan friar Bernardino de Sahagún (1569-1582) and later by Schultes
...
- **Teotlaquilnanácatl** (Nahuatl): "Divine fungus," reinforcing the
  sacred status of these organisms.

Common Spanish names used by indigenous communities include **san isidros**
(named after the patron saint of agriculture), **pajaritos** (little birds),
and **derrumbes** (landslides). These names most commonly describe *P.
cubensis*, *P. mexicana*, and *P. zapotecorum*, respectively.

## Key Indigenous Groups

Several indigenous groups in central and southern Mexico maintain
...
- **Mazatec** (Oaxaca): The most famous practitioners, popularized by
  ...
  *[[lycoperdon-mixtecorum]]* and *L. marginatum*, which Ott et al. (1975)
  ...
  experimentally proven to be poisonous.

- **Chinantec** (Oaxaca): Use *[[dictyophora-indusiata]]* and its three forms
  for divination purposes, as documented by Heim and Wasson (1958) and
  Wasson (1959). These fungi are employed as special "narcotic" fungi in
  ceremonial contexts.
...
- **Nahua** (various regions): As the cultural heirs of the Aztec
  ...
  "teonanácatl" and maintain ceremonial practices involving sacred
  mushrooms.
