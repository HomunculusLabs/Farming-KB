---
title: Fungal Evolution
created: 2026-04-11
updated: 2026-04-12
type: concept
tags: [fungi, biology, ecology, academia, theory, history]
sources: []
---
...
### Timing of Fungal Origins

- **Molecular clock estimates**: Fungi diverged from animals approximately 1.0-1.5 billion years ago
- The opisthokont clade (Fungi + Animals + Choanoflagellates) is well-supported by molecular phylogeny
- Fungi are more closely related to animals than to plants
- Shared derived features with animals: chitin synthesis, flagellum structure, lysine synthesis pathway (AAA pathway)

### Early Fossil Record

- The oldest widely accepted fungal fossils are from the **Ordovician period** (~460 million years ago)
- These include filamentous fossils from Wisconsin and possible chytrid-like spores from Sweden
- Controversial finds from the **Precambrian** (2.4 billion years ago, Ongeluk Formation, South Africa) suggest fungi may be far older, but these are debated
- The fossil record is sparse because soft-bodied fungi rarely fossilize. Most evidence comes from spores and hyphal filaments preserved in chert or amber

## Major Phyla and Their Divergence

### Phylogenetic Overview

The fungal kingdom is divided into several major phyla, representing deep evolutionary splits:
...
### Chytridiomycota: The Ancestral Fungi
...
- Endogone and related genera form associations with plant roots — possibly ancestral to mycorrhizae

### Glomeromycota: The Ancient Symbionts

- **Key feature**: Form arbuscular mycorrhizal (AM) associations with plant roots
...
- **Key feature**: Produce spores (ascospores) inside a sac-like structure called an ascus (plural: asci)
- Largest fungal phylum: ~64,000 described species, estimated 1 million+ total
- Enormous ecological diversity: yeasts, molds, morels, truffles, plant pathogens, lichen-forming fungi
- Major groups:
  - **Pezizomycotina**: Filamentous ascomycetes (most species)
  - **Saccharomycotina**: True yeasts (S. cerevisiae)
  - **Taphrinomycotina**: Fission yeasts and plant parasites (Schizosaccharomyces, Taphrina)
- Includes economically critical genera: Penicillium (antibiotics, cheese), Aspergillus (enzymes, toxins), Saccharomyces (fermentation), Candida (pathogen), Claviceps (ergot)
- Many form **lichen symbioses** — over 40% of ascomycete species are lichenized

### Basidiomycota: The Club Fungi

- **Key feature**: Produce spores (basidiospores) on the outside of a club-shaped cell called a basidium
...
The transition from aquatic to terrestrial life was a pivotal event in fungal evolution, closely linked with the evolution of land plants:

- **Timeline**: Fungi likely colonized land during the Cambrian-Ordovician (500-450 Ma), preceding or coinciding with the first land plants
- **Evidence**: Fossil hyphae and spores from Ordovician deposits; molecular clock estimates support this timing
- **Drivers**: New ecological niches on land — abundant dead plant material (lignin, cellulose) as a food source
- **Co-evolution with plants**: As plants colonized land, fungi provided mineral nutrient uptake through mycorrhizae while receiving carbon from photosynthesis
- **Decomposition**: Fungi evolved the ability to decompose lignin (white rot) and cellulose (brown rot), becoming the primary decomposers of woody material
...
- Plant pathogenic fungi evolved repeatedly from saprotrophic ancestors
- **Rust fungi** (Pucciniomycotina): Obligate biotrophs with complex life cycles requiring two hosts. Evolved ~100 Ma
- **Smuts** (Ustilaginomycotina): Parasites of grasses and other plants. Evolved from saprotrophic ancestors
- **Endophytes**: Fungi that live inside plant tissues without causing disease. May represent an intermediate stage between saprotrophism and pathogenicity

## Key Evolutionary Innovations

### Lignin Decomposition (White Rot)
