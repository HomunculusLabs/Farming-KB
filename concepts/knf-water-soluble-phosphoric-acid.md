---
title: KNF [[cho-water-soluble-phosphoric-acid-preparation]] Acid
created: 2026-04-12
updated: 2026-04-12
type: concept
...
- Animal bones (chicken bones, cow bones, fish bones, pig bones)
- Good quality charcoal
- Brown rice vinegar (BRV)
- Clay jar, wooden box, or PE container

## How to Make WPA

### From Animal Bones

1. Collect animal bones (any type, but chicken and fish bones work well)
2. Boil bones to remove all meat, fat, and marrow
3. Wash bones thoroughly
4. Dry bones in sunlight
...
12. Wait until bubbles stop
13. If bones fully dissolve, add more roasted bones
14. When bones no longer dissolve, WPA is complete

### Ratio

- Bones and BRV at approximately 1:10 ratio (bones to vinegar by weight)

## Recycling FAA Bones

Leftover bones from [[knf-fish-amino-acid]] FAA production can be used. Put them into BRV at 10:1 ratio (BRV to bones) to produce WPA.

## Fermentation Time

- Usually 7-14 days
- Ready when no more bubbles and bones stop dissolving
