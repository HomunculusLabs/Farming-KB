...
direction, and duration. These photoreceptors operate through mechanisms
analogous to, yet fundamentally different from, animal visual systems,
enabling coordinated responses touching every aspect of growth,
development, and survival.

## Light as Electromagnetic Radiation

Light consists of electromagnetic waves spanning approximately 0.4 to
0.7 micrometres. Blue light occupies the shorter end while red light
...
wavelengths producing radiant heat. Plants can detect very low light
...
evolved as signaling proteins. Cryptochromes help plants maintain
accurate internal clocks synchronized to daily light cycles.
...
blue light, triggering signaling cascades that alter cell elongation on
