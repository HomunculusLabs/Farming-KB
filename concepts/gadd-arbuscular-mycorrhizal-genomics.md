...
Arbuscular mycorrhizal (AM) fungi form one of the most ancient and widespread
symbiotic associations on Earth, dating back approximately 460 million years
to the Ordovician period. The development of genomic tools has opened new
avenues for understanding the molecular basis of this mutualistic
relationship between fungi and plants. Genomic approaches including expressed
...
indicating a requirement for specific plant-derived signals. Once inside the
root, the fungus grows through intercellular spaces to the inner cortex where
it forms arbuscules within cortical cells.

Arbuscules are highly branched hyphae enveloped in a plant-derived peri-
arbuscular membrane. Nutrient exchange takes place across the interface
between the arbuscule and the cortical cell, making the arbuscule central to
symbiotic function. In Arum-type associations, arbuscules develop by repeated
dichotomous branching of hyphal branches that penetrate cortical cell walls.
...
cytoskeletal rearrangement, vacuole fragmentation, nuclear migration towards
...
The [[mycorrhiza-induced-resistance-defense-priming]] phosphate transporter MtPT4 is located in the peri-
arbuscular membrane and functions in phosphate uptake. MtGST1, a glutathione-
S-transferase, shows expression in both arbuscule-containing and adjacent
cells. MtXTH1, a xyloglucan endo-trans-glycosylase/hydrolase, shows
systemic expression throughout the root, responding to a systemic signal.
...
apoplastic interface, facilitating nutrient exchange, and regulating the
structural relationship between fungal and plant cell surfaces.
