...
### Organic Matter and Major Nutrients

| Parameter | Value |
|---|---|
| Organic Matter (OM) | 0.21% |
| Total Carbon (T-C) | 0.12% |
| Total Nitrogen (T-N) | 0.01% |
| C/N Ratio | 9.25 |
...
| Element | Value |
|---|---|
| Cd (Cadmium) | - (not detected) |
| Cr (Chromium) | - (not detected) |
| Ni (Nickel) | - (not detected) |
| Pb (Lead) | 0.101 |
| As (Arsenic) | - (not detected) |

## Interpretation

### Nutritional Value
- Contains measurable NPK (nitrogen, phosphorus, potassium) -- the three primary plant nutrients
- Iron content (15.885 mg/kg) is the most significant micronutrient contribution
- C/N ratio of 9.25 indicates moderate organic matter that will not cause nitrogen immobilization
- Low sodium content means minimal salt stress risk
