...
Edges are secured with sandbags rather than buried trenches. Sandbags are much
faster to deploy than trenching and allow covering adjacent pairs of beds
without needing space between them for soil displacement.

The structure is stiffened against wind and snow by driving stakes 4 feet
from the last hoop at each end, tying ropes to the plastic edges, and pulling
them taut. Sandbags are then shifted to make the cover taut side-to-side.

## Cost Comparison

Three rows of quick hoops cover the same area as a 22-by-48-foot greenhouse
(about 1,000 square feet) at approximately one-twentieth the cost. This
dramatic cost difference makes season extension accessible to growers who
cannot afford full greenhouse structures.

The economics are compelling for small farms. Quick hoops can be erected for
overwintering crops in fall, disassembled in spring, and moved to cover other
crops later in the season. The same investment serves multiple purposes.
