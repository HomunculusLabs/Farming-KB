---
title: Dimethyltryptamine (DMT) psilocybin-psilocin-chemistry-and-pharmacology-emcdda
source: mckenna_t-tryptamines_consciousness.md
tags: [psychedelics, dmt, tryptamines, pharmacology, neuroscience, consciousness]
created: 2026-05-09
---
...
DMT belongs to the **tryptamine** class of compounds, which are structurally
derived from tryptophan, an essential amino acid. The tryptamine backbone
consists of an indole ring (a bicyclic structure of a benzene ring fused to
a pyrrole ring) linked to a two-carbon ethylamine side chain. In DMT, two
methyl groups are attached to the terminal nitrogen atom of this side chain
(N,N-dimethylation).

The molecular formula of DMT is C₁₂H₁₆N₂, with a molecular weight of
...
### Dosage
Effective doses vary by route:
- **Smoked**: 20-60 mg (freebase)
- **IV**: 0.2-0.5 mg/kg
- **Oral (ayahuasca)**: 30-100 mg DMT + MAOI

## Subjective Effects and Phenomenology

The DMT experience is characterized by:
- **Rapid onset**: A sensation described as a buzzing or vibrating sound
