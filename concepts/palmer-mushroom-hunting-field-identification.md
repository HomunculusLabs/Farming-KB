...
## Safety First: The Amanita Test

As a preliminary identification step, Palmer urged all students to first learn to recognize the **Amanita** family by three universal marks:
1. A **wrapper (volva)** at the base of the stem
2. A **ring or veil** around the stem
3. **Warts or scurf** on the cap

"Having mastered at a glance this first lesson, the student may be considered on reasonably safe ground."
...
- Distinguished from their "twin brothers" the Polyporei by growing from the **ground** (not wood), with a **distinct stem** and **easily separable tubes**
- If the tubes or pores are **brown, yellowish, or greenish**, the top being russet-color or any shade of brown, and on cutting the flesh it **remains white**, it is an edible or at least harmless variety
- If the plant is **brilliant-colored** (red or yellow), or **turns blue when bruised**, it is best to reject it
- If the tubes are **red at the orifice**, it is doubtless poisonous

## Puff-Ball Safety Rules

Palmer calls puff-balls "the safest mushrooms for the beginner" and provides these additional details:

- The **giant puff-ball** (*Lycoperdon giganteum*) in its infant state is the safest starting point
- Skin color varies from pure white to almost black; if the knife leaves a stain of yellow, it is too old
...
opportunities for palmer mushroom hunting field identification. [[jeavons-climate-adaptation-growing-seasons]]
