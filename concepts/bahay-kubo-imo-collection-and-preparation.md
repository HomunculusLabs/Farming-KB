...
**Important distinction:** For plants, use the full BIM formulation. For animals, use only pure lacto bacilli (isolated as described). Bamboo microorganisms are specifically used for fermenting animal feeds.

## Critical Principles

- Never use refined sugar (chemically bleached, harms microorganisms) — use crude sugar or molasses only
