...
The combination produces a mostly sativa-dominant plant expressing characteristics from both
lineages. Strawberry Diesel contributes the energetic onset and sweet aroma, while Ghost OG
provides structural backbone, resin coverage, and physical relaxation. This strategic pairing of
a racy sativa-leaning hybrid with a grounded OG Kush phenotype is characteristic of modern
...
- **Branching**: Side branching is moderate with sturdy enough structure to support developing
buds, though support is recommended during late flowering when colas become heavy with resin.

- **Bud structure**: Buds develop moderate density, balancing sativa airiness with the tighter,
resinous structure from OG Kush. Calyx-to-leaf ratio is favorable for trimming.

- **Color development**: Purple hues emerge during the final two to three weeks of flowering.
This anthocyanin expression can be enhanced by allowing nighttime temperatures to drop 10-15°F
below daytime highs.

- **Flowering time**: Typically 9-10 weeks from onset of 12/12 light cycle.

- **Resin production**: All phenotypes produce heavily resinous buds with thick trichome
coverage, making the strain well-suited for hashish and concentrate production.

## Potency and Effects

Bruce Banner consistently tests around 20% THC across all phenotypes. The effects unfold in
