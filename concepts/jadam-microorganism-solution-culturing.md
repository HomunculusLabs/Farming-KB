...
most beneficial to farming - photosynthetic bacteria, lactic acid
bacteria, and yeast - are all anaerobic, pumping oxygen into the
solution is counterproductive. Instead, the system relies on natural
fermentation in sealed containers, with the peak-bubble period
indicating maximum microbial population. At peak bubbles, microbial
numbers can be over 10,000 times greater than during periods of low
foam activity, making timing critical for effective application.
The philosophy underlying JMS production is that every farm already
possesses the microorganisms best adapted to local conditions. By
...
### Foliar Application with Wetting Agent
