...
## Mycopesticides and Biological Control

The Stametsian model incorporates entomopathogenic fungi as biological
alternatives to chemical pesticides. Certain fungi, notably species of Metarhizium
and Beauveria, are natural pathogens of insects and can be cultivated and applied
to target specific pest populations without the collateral damage to beneficial
organisms that characterizes broad-spectrum chemical pesticides. Stamets has
patented mycopesticide formulations using these fungi to control carpenter ants,
termites, and other structural and agricultural pests with remarkable specificity.

Beyond targeted pest control, the presence of a diverse fungal community in
[[fungi-grassland-agricultural-ecosystems-dighton]] supports a balanced food web that naturally suppresses
pest outbreaks. Mycelial networks in healthy soil support populations of predatory
nematodes, beneficial mites, and other organisms that keep pest species in check.
The Stametsian approach thus shifts the paradigm from pest eradication to
ecosystem balance, using fungi not as weapons but as architects of biological
communities that are inherently resistant to catastrophic pest damage.

Perhaps the most elegant application of fungal pest control is the "slugs fug"
garden design, where oyster mushroom beds are positioned as sacrificial traps
around vulnerable plantings. Slugs are attracted to the mushrooms but become
infected with nematodes carried by the Pleurotus mycelium, dying within days of
consumption. This creates a self-reinforcing biological control system where the
slug population itself becomes the vector for its own population suppression, all
without any chemical inputs.

## Practical Implementation and Scaling

Implementing the Stametsian permaculture model begins with an assessment of the
landscape and identification of ecological functions that fungi can provide. In a
typical design, wood chip beds inoculated with Garden Giant spawn are established
in key locations to build soil and produce food. Mycorrhizal inoculants are
applied when planting trees and shrubs to establish the underground nutrient-
sharing network. Straw or wood chip bales inoculated with oyster mushroom spawn
are placed in drainage channels to filter runoff water. Selective species are
introduced for targeted pest management around vulnerable crops.

The model is inherently scalable, working equally well in backyard gardens,
community farms, and large-scale agricultural operations. Its greatest strength is
that fungal installations, once established, become increasingly effective over
time as the mycelial networks expand and mature. Unlike chemical inputs that must
be repeatedly purchased and applied, fungal systems are self-propagating and self-
...
- Stamets, P. (2000). Growing Gourmet and Medicinal Mushrooms. Chapter 18: The Stametsian Permaculture Model.
- Stamets, P. (2005). Mycelium Running. Chapters on mycoremediation and mycopesticides.
