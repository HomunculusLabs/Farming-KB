...
### Soil Sterilization
Aims to destroy or eliminate microbial cells while maintaining existing chemical and physical characteristics of the soil. Used for experiments focused on specific AM fungi or to establish a negative control.

### Inoculum Reduction
Creates a perturbation that interferes with mycorrhizal formation without necessarily eliminating any component group. Allows establishment of different degrees of mycorrhizal formation between treatments for studying relative effects.

The same basic techniques may be used for both, with dosage or intensity adjusted for the desired outcome.
...
### Side Effects
- Increases availability of mineral nutrients (NH4+, NO3-, P, K, Ca, Mg)
- Complex changes in soil physical, chemical, and biological properties
- Indirectly reduces AM fungi by restricting weed populations that maintain infective propagules
- When AM fungi are re-inoculated after solarization, colonization rates can be 20% higher
