...
No single method detects all fungi at a site. Effective surveys combine:

- Visual searching for macrofungal fruiting bodies
- Baiting for microscopic and aquatic fungi
- Culturing from substrata for species that don't fruit readily
- Molecular methods (eDNA, metabarcoding) for detecting species missed by traditional approaches
