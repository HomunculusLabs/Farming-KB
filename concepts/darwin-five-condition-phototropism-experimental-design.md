---
title: Darwin Five Condition Phototropism Experimental Design
source: grahamholmes-what-a-plant-knowsindd.md
topics: [phototropism, darwin, experimental-design, photobiology, canary-grass, plant-vision, methodology]
created: 2026-05-09
---
...
Darwin and his son grew canary grass seedlings in total darkness for several days to eliminate any prior light exposure effects. They then placed a gas lamp twelve feet (3.5 metres) away — so dim that "they could not see the seedlings themselves, nor see a pencil line on paper." Despite this extremely low light level, after only three hours the plants had curved toward the light, with the bending consistently occurring about an inch (two centimetres) below the tip.

The five experimental conditions were:

### Condition A: Untreated Control
The seedling was left completely intact with no modifications. This served as the positive control, confirming that the experimental conditions (dark room, dim light) were conducive to phototropism. The plant bent toward the light as expected.
...
## Modern Applications of the Design Logic
