...
- Skipping the interview and designing from assumptions
- Asking only technical questions without understanding the client's philosophy
- Imposing the designer's values on the client
- Not documenting the interview thoroughly
- Failing to revisit the interview during the design process
