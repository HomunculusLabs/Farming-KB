...
In some cases, [[fungal-laccase-mediator-systems]] introduce additional kinetic complexity because the mediator concentration affects the effective rate of substrate oxidation. The kinetics of mediator oxidation by laccase and the subsequent oxidation of the target substrate by the oxidized mediator must both be considered.

## Reactor Design Considerations

The design of [[staycare-composting-as-a-fungal-bioremediation-strategy]] processes requires careful attention to maintaining adequate mass transfer at larger scales. Geometric similarity, power input per unit volume, and oxygen transfer rate are key scale-up parameters.

## Mathematical Modeling

Mathematical models of fungal bioremediation processes typically incorporate growth kinetics, [[fungal-laccase-mediator-systems]]
