...
### Adaptogenic Effects
- Regulates cortisol and stress hormone production.
- Modulates the hypothalamic-pituitary-adrenal (HPA) axis.
- Improves fatigue resistance and recovery.

### Immune Modulation
- Stimulates macrophage activity and NK cell function.
- Anti-inflammatory via NF-kB pathway inhibition.
- Immunomodulatory rather than purely immunostimulatory.

## Athletic Performance

Cordyceps is one of the most studied ergogenic mushrooms:

### Evidence
- Improved VO2 max and ventilatory threshold in human studies.
- Increased time to exhaustion in cycling and running tests.
- Enhanced aerobic capacity at moderate doses over 1-3 weeks of supplementation.
- Chinese Olympic athletes reportedly used cordyceps in the 1990s (anecdotal).
...
Cordyceps has a reputation as an aphrodisiac in TCM:
- Improved sexual function in animal models (increased testosterone, sperm quality).
- Enhanced libido reported in human studies.
- Mechanism may involve improved blood flow, reduced fatigue, and hormonal modulation.
...
### O. sinensis (Wild)
- Typically used in TCM decoctions with other herbs.
- Often ground into powder for capsules.
- Counterfeit products are extremely common — authentication requires DNA testing or chemical profiling.
- Not recommended for casual supplementation due to cost and sustainability concerns.

## Dosing Guidelines

### C. militaris
- **General energy/stamina:** 1000-2000mg extract daily.
- **Athletic performance:** 2000-3000mg daily, 2-4 weeks before events.
- **Tincture:** 2-4ml dual extract, 2 times daily.
- **Culinary (dried whole):** 3-5g in soups or broths.

### O. sinensis (if authentic)
- Traditional TCM dose: 3-9g per day in decoction.
- Most practitioners use C. militaris as a sustainable alternative.
