...
Mollison described several strategies for integrating tractors with
garden production. The most common is to use the tractor as a bed
preparation tool, running it across an area for 1-2 weeks before
planting. The chickens scratch the surface, incorporate mulch, eat
weed seeds, and fertilize. After the tractor moves on, the bed is
ready for planting with minimal additional preparation.

## Beyond Chickens

The chicken tractor concept extends to other poultry and small livestock:
- **Duck tractors**: Effective in orchards for slug control. Ducks
...
- **Guinea fowl tractors**: Excellent for tick and insect control in
  larger areas.
...
- **Feed costs**: Supplement with kitchen scraps, garden weeds, and
  black soldier fly larvae to reduce commercial feed dependence.
