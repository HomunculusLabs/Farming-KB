...
available in most agricultural regions, and serves as a forgiving
substrate for both home and commercial cultivators. Proper
pasteurization is essential to prepare straw for inoculation,
selectively eliminating competitor organisms while preserving
conditions favorable for mushroom mycelium.

## Straw as a Cultivation Substrate

Wheat, rice, oat, and sorghum straws are the best for mushroom
cultivation. Hay, resplendent with abundant seed kernels, should
not be used as the grain kernels tend to contaminate. However,
limited numbers of grain kernels generally boost yields. Straw is
a forgiving substrate for the small to mid-size cultivator,
accepting a limited number of contaminants and selectively favoring
mushroom mycelium.
...
A second method calls for the placement of straw in a highly
insulated room into which steam is injected. Before loading, the
straw must be moistened by spreading chopped straw over a large
...
Similar to the hydrated lime method, household bleach (5.25%
sodium hypochlorite) is used as a disinfectant. Five to six cups
of household bleach are added to 50 gallons of water. A basketful
of chopped wheat straw is immersed for a minimum of 4 and no more
than 12 hours. The bleach leachate is drained off and the straw is
immediately inoculated.

## The Detergent Bath Method

Biodegradable detergents containing fatty oils are used to treat
bulk substrates. Coupled with surfactants which allow thorough
penetration, these detergents kill a majority of contaminants
competitive to mushroom mycelium. The substrate is submerged into
and washed with a detergent solution. The environmentally benign
waste water is discarded, leaving the substrate ready for
inoculation.

## The Yeast Fermentation Method

A biological approach uses yeast cultures, specifically strains of
beer yeast (Saccharomyces cerevisiae). A yeast strain is propagated
in warm water with malt sugar for two to three days. Chopped straw
is then forcibly submerged into the yeast broth for no more than
48 hours. The yeasts absorb readily available nutrients, and
metabolites such as alcohol and anti-bacterial by-products are
generated, killing competitors.

## Comparison of Methods

Heat pasteurization techniques result in the highest consistency
of success, typically greater than 95%. The alternative methods
generally do not achieve this level but are practical wherever
steam is unavailable. The outcome of any method depends on the
cleanliness of the straw, water quality, spawn rate, and the
aerobic state of the substrate during colonization. Small
pilot-scale experimentation is strongly encouraged before
attempting alternative methods commercially.
