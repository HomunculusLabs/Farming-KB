---
title: "Compost Tea Application Rates and Timing"
created: 2026-04-26
updated: "2026-04-24"
sources:
...
- **Foliar standard**: 5 gallons of tea per acre
- **Mildew alert**: Increase to 10 gallons per acre during peak disease pressure
- **Soil drench at planting**: 15-20 gallons per acre
- **High-biomass tea** (800 micrograms fungal): Can reduce to 2 gallons per acre
- Water is used as a carrier; ensure the correct tea volume reaches each acre regardless of total spray volume
...
- If soil is too bacterial (75% of cases), apply fungal tea
- Apply in fall and spring for maximum benefit
- Wait until soil is warm enough for organisms to grow before spring drench
- CT acts the same in clay and sand soils: organisms form aggregates appropriate to each soil type

## Sticker-Spreaders

Organisms need about 20 minutes to attach to leaf surfaces. After that, they stick through their own growth. If applying in rain, use a spreader-sticker:
...
Do not spray just once and expect results. Coming from conventional methods, it takes time to establish the full food web. Organisms in soil die from being eaten, lack of food, lack of space, inhibitory compounds, chemicals, or air pollution — there is no evidence of death from old age.

Re-application frequency depends on:
- Presence of toxic chemical residues
...
Each of these disturbances requires returning to more frequent applications (every 7-10 days) until the food web recovers.

## Coverage Verification

The main agent of protection against diseases like black spot is coverage. If beneficial organisms already occupy the leaf surface, pathogens cannot push them out. A minimum of 70% total coverage (bacteria plus fungi) with at least 5% fungi is the target.
...
Citric acid kills some organisms at low concentrations and is used to reduce E. coli in tea. The exact amounts are proprietary and range testing is needed — too much will kill beneficial organisms along with pathogens.
