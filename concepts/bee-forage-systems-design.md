---
title: Bee Forage Systems Design
created: 2026-04-14
updated: 2026-04-14
type: concept
tags: [reference]
...
- **Banksia**: B. amula, B. ericifolia, B. integrifolia, B. spinulosa
- **Dryandra spp**: Autumn and winter nectar
- **Eucalyptus**: E. melliodora (yellow box -- the best honey), E. maculata (spotted gum), E. microcarpa (grey box)
- **Acacia spp**: Valuable pollen over winter/spring
- **Pride of Madeira**: Masses of winter flowers
- **Grey mangrove**: Autumn/winter light honey
...
- **Banksia**: B. ericifolia, B. serrata
- **Blueberries**: Nectar
- **Cape lilac**: Summer flowering
- **Palms**: Generally fire tolerant and useful in bee forage

### Autumn (March-May)
- **Eucalyptus**: E. albens, E. cladocalyx, E. gomphocephala, E. macrorhyncha, E. obliqua, E. salmonophloia (choice honey), E. salubris (light amber), E. viminalis, E. wandoo
- **Dryandra spp**: Autumn/winter
- **Banksia**: B. grandis, B. integrifolia, B. spinulosa
- **Grey mangrove**: Good light honey

### Year-Round / Extended
- **Eucalyptus stellulata** (black sally): Flowers most of the year
- **Eucalyptus platypus** (moort): Winter, spring, summer
- **Eucryphia lucida** (leatherwood): Extended nectar flow
- **Grevillea/Hakea spp**: Wildflower potential throughout

## System Components

### Remnant Forest and Woodlot Trees
Supplement native forest with multipurpose species that flower out of season with natives. Key strategy: plant eucalypts and banksias that fill gaps in the native flowering calendar.
