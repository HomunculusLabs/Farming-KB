...
The shotgun fruiting chamber (SGFC), popularized by RogerRabbit on the Shroomery cultivation forums, is one of the most widely used fruiting chambers for small-scale Psilocybe [[psilocybe-cubensis-cultivation-miniculture]]. Its name derives from the pattern of holes drilled throughout all six sides of the container, which provides continuous fresh air exchange (FAE) through natural convection. The design is inexpensive, requires no mechanical equipment, and is well-suited to beginners.

## Design Principles

The shotgun fruiting chamber operates on the principle of passive air exchange driven by temperature differentials between the inside and outside of the chamber. Warm air generated by the [[arbuscule-isolation-metabolic-activity-assays]] of colonizing mycelium rises and exits through upper holes, while cooler fresh air is drawn in through lower holes. This constant gentle circulation provides both fresh air exchange and [[bloomfield-mushroom-evaporative-cooling-fungal-frigidity]] without fans or pumps. The chamber relies on a thick layer of moist perlite at the bottom to maintain high humidity.
