...
4. **Crystallization**: Evaporating the salt solution to recover purified
   mineral crystals
5. **Recombination**: Adding the mineral salts back into the original extract
...
- **Salt** (Body): The mineral salts obtained through calcination,
  representing the plant's physical foundation and structural integrity

According to spagyric philosophy, conventional extraction only captures the
sulfur and mercury principles, discarding the salt (mineral) component. The
spagyric method preserves all three, producing a more complete medicine.

## Spagyric Cannabis Extraction Process

When applied specifically to cannabis, the spagyric process follows these
general steps:
