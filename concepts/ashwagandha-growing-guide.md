...
shrub increasingly cultivated in temperate regions as a summer annual. (see [[ginger-growing-guide]]).
...
root system is the primary medicinal part -- a thick, fleshy taproot with a
characteristic horse-like aroma. (see [[echinacea-growing-guide]]).

## Medicinal Uses

Ashwagandha is classified as an adaptogen -- a substance that helps the body
adapt to stress. The primary active compounds are withanolides (steroidal
lactones), withaferin A, and alkaloids.
...
- Athletic performance: Improves VO2 max, strength, and recovery.
- Hormonal balance: May support testosterone in men, reproductive hormones
  in women.
- Cognitive function: May improve memory, attention, and reaction time.
...
- Tincture: Dried root tincture (1:5 in 50-70% alcohol), 30-60 drops 2-3
  times daily.
- Capsules: Standardized extracts (2.5-5% withanolides), 300-600 mg daily.
...
Ashwagandha is adapted to hot, dry conditions and is relatively easy to grow
in warm climates:
...
- Seeds are small and should be sown shallowly
- Start indoors 6-8 weeks before last frost
- Sow in seed-starting mix, barely covering seeds
...
### Spacing
- Space plants 18-24 inches apart in all directions
- Rows 24-36 inches apart
- Plants need space for the root system to develop fully
...
- Overwatering is the most common mistake and promotes root rot
- No supplemental fertilizer needed; excessive fertility reduces root potency
- Weed carefully around young plants; once established, ashwagandha
  competes well with weeds
- No pruning needed; plants maintain a bushy habit naturally
- Remove flower buds if you want to maximize root growth (optional)

## Root Harvesting

Timing is critical for maximum medicinal potency:
- Harvest roots in late fall, 150-180 days after planting
- The optimal time is after the first flowers have appeared and berries are
  forming (but before heavy frost)
- Withanolide content peaks at this stage
- Harvest before any frost exposure; frost kills the plant
