...
In practice, mycologists use combinations of these concepts:

- Morphology remains the first line of identification
- Molecular data increasingly used to test morphological species boundaries
- Ecological data (host, substratum, distribution) supplement morphological identification
- The integrative approach combines multiple lines of evidence
...
- Endemism: Many fungi may have restricted geographic ranges
- Host specificity: Tropical plants host many more fungal species than previously assumed
- Microhabitat specialization: Each microhabitat may harbor unique species
- Temporal sporulation: Many fungi fruit only rarely, evading detection
