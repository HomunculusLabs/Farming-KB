---
title: Chlorophenol Degradation by White Rot Fungi
created: 2026-04-19
updated: 2026-04-19
type: concept
tags: [mycology, fungi]
...
TCP degradation by P. chrysosporium involves cycles of peroxidase-catalyzed oxidative dechlorination reactions followed by quinone reduction reactions, yielding the key intermediate 1,2,4,5-tetrahydroxybenzene which degrades to CO2. 2,4-Dichlorophenol (DCP), 2,4,5-trichlorophenol, and TCP were all oxidized to corresponding 1,4-benzoquinones. DCP degradation involves LiP and MnP at multiple stages.

The oxidative dechlorination of chlorophenols by ligninolytic peroxidases proceeds via one-electron oxidation of the phenolic substrate, generating phenoxy radicals that spontaneously eliminate chloride ions. The resulting quinone products are then reduced to hydroquinones, which can undergo further cycles of oxidative dechlorination. This cycling between quinone and hydroquinone forms, with progressive loss of chlorine atoms, continues until all chlorines are removed. The non-specific nature of this mechanism means it is effective against a wide range of chlorophenol congeners, regardless of chlorine substitution pattern.
...
Beyond PCP and TCP, white rot fungi degrade a range of chlorophenol compounds:

- **2,4-dichlorophenol (DCP)** -- degraded by both LiP and MnP pathways in P. chrysosporium, with dechlorination preceding ring cleavage

- **2,4,5-trichlorophenol** -- oxidized to corresponding quinones before further degradation

- **Chlorinated guaiacols** -- produced during pulp bleaching, dechlorinated by laccase from T. versicolor through demethylation and successive dechlorination steps
