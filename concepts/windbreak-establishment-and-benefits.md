...
### Predictable vs. Omnidirectional Winds

**On sites with predictable wind patterns** — revealed by tree flagging, derived from local knowledge, or indicated by wind records — designers can plan directional, patterned windbreaks of earthbank and trees aligned to the prevailing wind directions.

**On sites where severe winds may come from any direction** (as in some deserts), the strategy is to impose a **close rectangular or network pattern** of windbreaks. However the windbreaks are arranged, buildings, gardens, and animal shelters can still be arranged to face the sun and benefit from solar impact.

### Essential Windbreak Establishment Principles

- **Good species selection** for pioneers that are easily grown and establish quickly
- **Initial protection** of planting from mechanical or wind damage (bagging, fencing)
- **Periodic or trickle irrigation** to reduce desiccation during establishment
...
Even a 46–62 cm (18–24 inch) high "fence" or mound of earth will grow a sweet potato, strawberry, or cabbage in the lee. Hard-pruned canopies need not be barren — many dwarf fruit, vine, and flower crops will grow below windbreak trees if mulch and water are provided.
...
### 1. House Heating and Comfort

For glazed areas and hot water (flat plate) collectors, wind chill factors remove 60% of heat alone. Shelterbelts (including thick vine trellis) around a house can effect a **20–30% saving in heating fuels** in moderate to severe winters. In cold areas, earthbanks plus shelterbelt plus a sun-facing aspect is a critical design strategy.

In deserts, where advected (wind-carried) heat is the most severe effect on human comfort, shelterbelt trees serve to **reduce ground temperatures up to 15°C**.

### 2. Livestock Protection

Wind has devastating effects on livestock:

- **Blizzards** will kill livestock and newborn lambs
- Hardy adapted animals can **lose 30% of their bodyweight in 3 days** of blizzard
- Fence design must allow easy downwind escape to woodlots, sheltered valleys, or lower elevations — herds escaping blizzards will pile up against fences and smother in fenced corners

Less severe but economically significant effects include:

- **Sheep weight** in unsheltered fields in New Zealand is **15% less** than in sheltered areas
...
Snowdrift across highways is more effectively and permanently blocked by hedgerows of hardy *Caragana* and *Eleagnus*, which are estimated to be **50% cheaper than stout fences** and outlast them. Juniper in high country grows better in areas of snow drift, and swales at such places enable more snow melt, providing more available root moisture for trees in spring and summer.

Wind shear on exposed highways or at caravan parks can cause casualties and property damage, necessitating designed windfast median strips and highway shelterbelts in areas of known hazard.

### 4. Cropland and Orchard Protection

For croplands, a matrix of shelterbelt species 10–16 m in height and 33–66 m apart affords wind protection and gives the greatest yield increases while reducing wind damage to fruit and leaf. Specific crop responses include:

- **Citrus**: Culls as damaged are **50% of crop** in unsheltered areas versus **18.5%** in shelterbelt systems
- **Cotton**: Yields are **17.4% higher** within five times the height of the shelterbelt, falling to a 7.9% advantage at ten times the height
- **Bee-pollinated crops**: Much greater fruit or seed set due to calmer conditions for pollinators

Effects of shelterbelts are compound and include:

- More meltwater from snow
- Preservation of good tree shape, hence less pruning
- Reduced mechanical damage to fruit and foliage
