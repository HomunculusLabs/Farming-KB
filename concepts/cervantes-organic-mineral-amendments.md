...
long-term fertility. Cervantes details the key
organic mineral amendments used in cannabis
cultivation.

## Gypsum

Gypsum (hydrated calcium sulfate) is used to
lower the soil pH, and it improves drainage and
aeration. It is also used to hold or slow the
rapid decomposition of nitrogen. Gypsum is seldom
used indoors because of its slow action, but is
valuable for outdoor gardens with heavy clay soils.
It does not significantly raise pH like lime, making
it useful when you need calcium and sulfur without
...
Rock phosphate (hard) is a calcium or lime-based
...
Colloidal phosphate (powdered or soft phosphate)
is another form that is somewhat more available
than hard rock phosphate. Both forms are best
mixed into soil well before planting time.

## Greensand

Greensand (glauconite) is an iron-potassium
...
Granite dust or granite stone meal contains up to
5 percent potash and several trace elements.
Releasing nutrients slowly over several years,
granite dust is an inexpensive source of potash
and does not affect soil pH. Not recommended
indoors because it is too slow-acting.

## Potash Rock

Potash rock supplies up to 8 percent potassium
and may contain many trace elements. It releases
