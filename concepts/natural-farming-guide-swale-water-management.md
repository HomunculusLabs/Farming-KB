...
Water is a recurring and critical resource necessary for survival. All
water sources, whether from streams, valleys, roofs, or roads that collect
rainfall, can be diverted through various means to storage, irrigation
systems, and swales. The power of gravity moves water efficiently from
high elevations to where it is needed.

Production increases when irrigation is steady and the soil is healthy.
Roots can then penetrate deeper and get essential nutrients. The key is
to capture, store, and slowly release water across the landscape rather
than allowing it to rush away.

## What Is a Swale?

A swale is a long, shallow ditch about three to five feet across, which
serves to stop and channel the flow of water into the soil. Unlike a
regular ditch, which directs and carries water somewhere else, the swale
is made to help the water get absorbed directly into the soil.

Swales lie across the land, especially across a slope, and when the water
is forced into the soil, it can be soaked up by trees planted along the
...
directly behind the hump of dirt. In a wet climate the area between the
swales can be heavily planted, and in a dry climate only the edges of the
swales should be planted.

It can take three to ten years for the trees to fully mature and begin
their job of shading, mulching, and absorbing salts from the soil. This
is the most important step of the whole swale strategy. Trees will soak
up the water runoff and prevent waterlogging and evaporation, produce
valuable products and food, and improve the temperature and microclimate
of the land.
...
be used to direct water into a swale or to a pond or irrigation system.
