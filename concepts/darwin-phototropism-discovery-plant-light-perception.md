...
One of the most important implications of Darwin's experiment is the demonstration that perception and response are spatially separated in plants. The tip of the seedling perceives the light, but the bending occurs in the midsection, an inch or so below. This decoupling means that a signal must travel from the site of perception to the site of response, implying a rudimentary nervous-like communication system.
...
Red light activates phytochrome into its active form, while far-red light inactivates it. On a more philosophical level, the plant remembers the last colour it saw. This molecular memory allows plants to track the quality of light in their environment with remarkable precision, adjusting growth, development, and flowering accordingly.

## The Ecological Logic of Phytochrome

Ecologically, the phytochrome system makes profound sense. In nature, the last light any plant sees at the end of the day is far-red, and this signifies to the plant that it should "turn off." In the morning, it sees red light and it wakes up. In this way a plant measures how long ago it last saw red light and adjusts its growth accordingly. The phytochrome system thus functions as a biological clock calibrated by the spectral quality of light.

### Leaf-Based Perception

Surprisingly, the "eye" for photoperiodism is not in the tip of the plant as Darwin found for phototropism. Illuminating any single leaf is sufficient to regulate flowering in the entire plant. If all leaves are pruned, leaving only the stem and apex, the plant is blind to light flashes. Phytochrome in the leaves receives light cues and initiates a mobile signal that propagates throughout the plant.
