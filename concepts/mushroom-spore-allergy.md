...
Allergic reactions to Oyster spores include:
...
Workers who initially tolerate contact with Oyster spores often develop increased sensitivity with continued exposure. This progressive sensitization is a classic hallmark of allergic response -- the immune system becomes increasingly reactive with repeated antigen exposure. Unlike many allergies that diminish with avoidance, Oyster spore sensitivity tends to worsen over time without intervention.

### Mitigation

- Filtration masks (N95 or higher) help but do not entirely solve the problem

- Improved ventilation and air exchange in growing rooms reduces spore concentration
