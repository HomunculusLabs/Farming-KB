...
Jochen Gartz demonstrated that adding tryptamine hydrochloride directly to the mushroom-substrates|substrate increases total alkaloid production in [[growing-gourmet-tree-species-guide-mushroom-cultivation]] that favor overall metabolic activity may increase flux through the entire pathway
