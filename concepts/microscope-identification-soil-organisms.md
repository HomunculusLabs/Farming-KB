...
1. Collect soil from the root zone (0-6 inches depth)
2. Take a small amount of soil (about the size of a pea)
3. Place on a clean glass slide
4. Add a drop of distilled water
...
Assessment:
- High bacterial numbers: the field of view contains many tiny dots that appear to be in constant motion
- Low bacterial numbers: clear spaces between organisms
- Anaerobic indicator: if bacteria appear in chains or clusters without movement, conditions may be anaerobic
- Good tea: many tiny dots moving actively throughout the field of view
