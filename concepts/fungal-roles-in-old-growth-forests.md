---
title: Fungal Roles in Old-Growth Forests
created: 2026-04-13
updated: 2026-04-15
type: concept
tags: [mycology, fungi]
...
- Support heart-rot fungi that hollow the trunk, creating nesting cavities for birds and mammals
- Succession of fungal species follows wood moisture content changes as the snag deteriorates over decades
- Large diameter snags (which only exist in old-growth) provide unique substrate for wood-decay fungi adapted to slow, prolonged decomposition
...
- Fungal succession follows a predictable pattern: primary colonisers are followed by secondary decomposers, with community composition shifting over decades as wood chemistry changes
...
- Smaller diameter material decomposes faster but provides essential substrate for fungi that cannot compete on larger wood
- Contributes significantly to total decomposition flux due to high surface-area-to-volume ratio
- Supports a distinct assemblage of fungal species, including many ascomycetes that fruit as small, inconspicuous perithecia on branch surfaces

## Wood Decay Fungi in Old-Growth

### White-Rot Specialists
...
- **Lignin degradation**: White-rot fungi produce lignin peroxidases, manganese peroxidases, and laccases that completely break down lignin, the most recalcitrant component of wood. This enzymatic capability is rare in other organisms
...
- **Soil organic matter contribution**: The brown, modified lignin residues produced by brown-rot decay contribute to stable humus formation in forest soils
...
Heart-rot fungi decay the central heartwood of living trees without killing the tree:

- **Hollow tree formation**: Heart-rot fungi (Stereum, Phellinus, Laetiporus) slowly hollow living trees over decades or centuries. These hollow trees provide critical nesting habitat for cavity-nesting birds (woodpeckers, owls) and mammals (bats, squirrels, bears)
- **Living substrate**: Heart-rot fungi must cope with the living tree's chemical defences while accessing the nutrient-poor heartwood. This challenging niche supports specialist species not found elsewhere
- **Wind resistance paradox**: Hollow trees are more flexible and may actually be MORE resistant to windthrow than solid trees of similar size, because they absorb wind energy through flexibility rather than resisting it rigidly

## Mycorrhizal Networks

Old-growth forests support the most extensive and complex mycorrhizal networks on Earth:
...
## See Also
- [[fungal-ecology-forest-floor]] -- broader forest floor ecology
