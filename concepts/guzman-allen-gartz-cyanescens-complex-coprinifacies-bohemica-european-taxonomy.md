...
## The Original P. coprinifacies Problem

Psilocybe coprinifacies was first considered by Guzmán (1983) to be a
doubtful species owing to insufficient understanding and several documented
misidentifications. Despite this cautious assessment, several European
mycologists recognized the species from Czechoslovakian material:
Herink (1950), Pouzar (1953), Semerdzieva & Nerud (1973), Auert et al.
(1980), Wurst et al. (1984), and Semerdzieva et al. (1986). The persistence
of reports from Central Europe suggested that a genuine taxon existed
within the cyanescens morphological range.

Sebek (1983) then described P. bohemica based on specimens from the Czech
Republic that had previously been identified as P. coprinifacies. This
introduced a new name into the already confused picture. Krieglsteiner
(1984, 1986) subsequently argued that P. coprinifacies should be treated
as a synonym of P. cyanescens emend. Krieglsteiner. He further considered
P. bohemica, P. maire, and P. serbica to all be synonyms of
P. cyanescens, collapsing the entire European complex into a single
species.

## Contrasting Views on Species Delimitation

Not all European mycologists accepted Krieglsteiner's broad synonymy.
Moser & Horak maintained P. serbica as a distinct species from southeastern
Europe, while other researchers continued to recognize P. bohemica as
separate from P. cyanescens. The core disagreement hinged on whether
the observed morphological variation — in pileus color, stipe dimensions,
spore size, and habitat preferences — warranted recognition of multiple
species or represented infraspecific variation within a single widespread
taxon.
...
populations might represent an indigenous species complex that convergently
resembled the American taxon.
...
material identified as P. coprinifacies. These findings established that
regardless of the final taxonomic resolution, the fungi in this complex
...
and Smith (1958), Guzmán (1983), and Singer (1986) considered diagnostic
for neurotropic species within Psilocybe.

## Ecological and Geographic Distribution in Europe
...
[[copelandia-cyanescens]], sometimes growing in disturbed zones of temperate
regions, has been reported from the Valley of Mexico at 2,220 meters
altitude (observed by Guzmán and Lincoff, pers. comm.), as well as
from central Europe (Heim et al., 1966b, 1967) and even from Maui in
the Hawaiian Archipelago at 3,000 meters altitude (Merlin & Allen,
