...
## Tomato Production — Starting and Spacing

Tomato seedlings are germinated in mini-blocks on heat pads at 70
degrees Fahrenheit and moved to two-inch blocks after seven to eight
days. They remain on the heating pads for about ten more days before
being potted into their final five-inch square pots. Coleman notes
that tomatoes are the only crop for which he uses pots rather than
soil blocks, because the extra soil volume guarantees sturdy,
well-rooted plants.

Plants are set out 24 inches apart down the center of 30-inch-wide
...
Tomatoes are supported by plastic twine unrolling from small spools
attached to wire frames hanging from horizontal wires running the
length of the greenhouse. Plants are pruned to a single stem by
removing all suckers between the leaf branch and the main stem.
Commercial tomato trellis clips secure the stem to the twine at
approximately 12-inch intervals as the plant elongates.

Fruit clusters on beefsteak varieties are limited to four fruits, and
medium-sized varieties to five fruits, by pruning off the extras.
As the growing tips reach the support wire about 8 feet above
ground, the lower branches below the lowest fruit cluster are
removed. The twine is then unrolled a turn or two, the plant tops
are lowered about 12 inches, and the wire frames are slid along the
support wire. The bare stems end up lying along the ground while
the top 8 feet of each vine continues producing tomatoes. This
technique allows a spring-planted crop to remain in vigorous
production until late fall.

## Cucumber Culture and Succession

Greenhouse cucumbers are sown in succession at three-week intervals
from March 21 through June 21. Seeds are sown in three-inch soil
blocks with a cubic indentation filled with fine seed-starting mix.
Germination occurs on heating pads set at 85 degrees Fahrenheit.
Since greenhouse cucumber seed is expensive, optimizing germination
percentage is economically important.

Seedlings are transplanted to the greenhouse at two weeks of age.
Every sucker and female flower is removed until the plant reaches 3
feet tall, at which point the root system can support fruit
production. At the top of the support bar, one additional sucker is
allowed to grow, creating two stems per plant that trail back down.
One cucumber is left at each node on both vines. Cucumbers are
picked daily at optimal size. When the last cucumber at ground level
is harvested, the crop is pulled and replaced with celery transplants
for fall harvest.
