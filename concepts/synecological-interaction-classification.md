---
title: Synecological Interaction Classification
...
The physical placement of guild members matters because interactions operate across distance. Chemical messengers, [[root-exudates]], pollen, sound, and behavioral signals can all carry effects well beyond the visible canopy of a plant.

### Key Distance Factors

- **Allelopathic chemicals**: Walnut juglones can affect apples 10-15 meters away
- **Root interactions**: Legume nitrogen fixation benefits extend 1.5-2 meters into adjacent crops
- **Behavioral interactions**: Territorial birds may interact over distances of a kilometer or more
- **Chemical communication**: Mammals can detect scent markers across considerable distances

### Design Implications

For species with known positive interactions at specific distances, designers can use spiral or strip-planting arrangements to maximize edge interaction effects throughout a crop area. For example, knowing that legume-grain benefits extend 1.5-2 meters allows precise interplanting configurations that ensure every grain plant receives the nitrogen benefit.

Configuration in guild planning requires assessing the distance at which interaction effects occur across species boundaries, then arranging members to obtain maximum (+ +), (0 +), or (+ 0) effects while minimizing (−) interactions.

## Value-Based Matrix Analysis
