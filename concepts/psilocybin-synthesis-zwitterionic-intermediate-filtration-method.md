...
- **Yield**: **87.5%** from compound 8 (5.6 g from 10.5 g), giving a crystalline product
- **No chromatography**: The product crystallized directly upon concentration, requiring only filtration and washing

## Overall Yield and Scale

The complete synthesis from commercially available 4-hydroxyindole achieved:

- **Psilocin**: 87.5% yield (14.3 g from 17.6 g of intermediate)
- **Psilocybin**: greater than 72% overall yield from psilocin on gram scale
- **Combined scale**: multi-gram quantities of both compounds without any chromatographic purification

The overall yield from 4-hydroxyindole to psilocybin through the four-step sequence (acetylation, oxalylation/amidation, reduction, phosphorylation) exceeded **50%** on a practical scale.

## Melting Point and Spectroscopic Data

The synthesized psilocybin matched literature values:

- **Melting point**: 190-198°C (lit. 185-195°C and 210-212°C)
- **UV (MeOH)**: λmax at 221.0, 267.5, 278.5, and 290.0 nm
- **IR (KBr)**: characteristic peaks at 3266, 3034, 1620, 1580 cm⁻¹
- **HRMS**: m/z 285.0991 [M+H]+ (calcd 285.1004 for C₁₂H₁₈N₂O₄P)
