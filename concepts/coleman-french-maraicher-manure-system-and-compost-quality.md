...
Intensive year-round production required 100 to 400 tons of horse
manure per acre, depending on the number of hotbeds in use.

Decomposing manure served a dual purpose: generating heat under
hotbeds and filling walkways between glass-covered frames for
supplementary warmth.

Once the manure had lost its heat and broken down into crumbly
compost, it was shoveled out and used as a soil amendment.

This elegant closed-loop system extracted maximum value from every
load of manure brought onto the site.
...
Gressent connected compost use directly to pest resistance:
...
Manure was delivered to the beds in woven willow basket backpacks
called hottes. These featured an extension that arched up and
over the worker's head.

To deposit the load, the worker bent far forward and let the
manure tumble out over their head into the bed.
