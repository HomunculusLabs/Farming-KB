...
- **Suffolk** — Large, fast-growing, muscular. The most common commercial
  meat breed in the US.
- **Hampshire** — Similar to Suffolk, hardy, good mothers.
- **Katahdin** — Hair sheep (no shearing needed), parasite-resistant, excellent
  mothers. Ideal for homesteads not interested in wool production.
- **Dorper** — Hair sheep, fast-growing, docile. Crosses well with other
  breeds.
- **Texel** — Muscular, lean carcass, good for crossing.

### Wool Breeds
- **Merino** — Finest wool, excellent for spinning. Require more management
  to prevent fly strike in skin folds.
...
- **Columbia, Corriedale, Targhee** — Good wool and acceptable meat
  production.
- **Icelandic** — Primitive breed, dual-coated fleece, excellent meat, very
  hardy. Good for extensive systems.

### Dairy Breeds
- **East Friesian** — Highest milk production. Used for artisan cheese.
- **Lacaune** — French dairy breed, basis for Roquefort cheese production.
...
Wool sheep must be shorn annually, usually in spring before lambing.

- Hire a professional shearer or learn to shear yourself (steep learning curve).
- Sheep should be dry and off feed for 12-24 hours before shearing to reduce
  contamination.
- Skirt the fleece — remove belly, leg, and dirty wool. Keep the best
  portions separate.
- Store fleece in paper bags (not plastic) with moth deterrents (cedar,
  lavender, or traps).
- Wool quality factors: staple length, crimp, micron count (fineness), luster.
- Hair sheep (Katahdin, Dorper) shed naturally and require no shearing.
...
Sheep are less prone to escape than goats but still need good fencing.

- Woven wire (4x4 inch mesh, 4 ft minimum height) with electric offset wires
  is standard.
- Electric net fencing works well for rotational grazing. Moveable, effective
  predator deterrent when properly energized.
- See [[livestock-fencing-guide]] for specifications.
...
- Ewes in late gestation and early lactation need higher energy and protein
  — increase grain or feed better-quality hay. See [[livestock-feed-formulation]].
- Loose sheep mineral with selenium (critical in selenium-deficient areas).
- Fresh water always available — sheep drink 1-4 gallons daily depending on
  temperature and feed.

## Lambing

- Gestation: ~147 days (approximately 5 months).
- Breeding season: triggered by decreasing daylength. Most breeds cycle
  Aug-Dec.
- Prepare lambing area 2 weeks before first expected due date.
- Signs of lambing: ewe isolates, pawing, restlessness, udder fills,
  vulva swelling, discharge.
- Stages: (1) cervical dilation, (2) delivery (should be under 1 hour for
  each lamb), (3) placenta passes within 2-4 hours.
- Clear membranes from lamb's nose. Dip navel in iodine.
- Ensure colostrum intake within 2 hours — tube feed if lamb won't nurse.
- Hypothermia is a major lamb killer. Warm cold lambs with a heat lamp or
  warm water bath.

## Predators

Sheep are extremely vulnerable to predation. Protection is essential.

- **Guardian dogs** — Great Pyrenees, Anatolian Shepherd, Akbash. Most
  effective long-term solution. Raise with the flock from puppies.
- **Llamas and donkeys** — Single guard animals, effective against smaller
  predators (coyotes, dogs). Less effective against bears or wolves.
- **Electric fencing** — Predator deterrent when properly maintained. See
  [[livestock-fencing-guide]].
- **Locked shelter at night** — Confine sheep in secure buildings during high
  predator activity periods.
- **Lambing pens** — Especially vulnerable period. Provide extra protection.
- Major predators: coyotes, domestic dogs, wolves, mountain lions, bears,
  eagles (on lambs), foxes.

## Health Care

### Parasite Management
- Barber pole worm (Haemonchus contortus) is the primary threat.
- FAMACHA scoring, rotational grazing, and selective deworming are essential.
- Drench resistance is widespread — use fecal egg count reduction tests
