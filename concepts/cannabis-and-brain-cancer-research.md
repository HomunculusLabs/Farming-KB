---
title: Cannabis and Brain Cancer (Glioma/Glioblastoma)
created: 2026-04-19
updated: 2026-04-19
type: concept
...
- **2008–2010:** Spanish studies showed TIMP-1 down-regulation and MMP down-regulation may be hallmarks of cannabinoid-induced inhibition of glioma progression. A San Francisco study confirmed THC and CBD act synergistically to inhibit brain cancer cell growth by inducing reactive oxygen species to produce apoptosis.

### Study Summary

| Substance | Study Type | Year, Place, Key Results | CHI |
|-----------|-----------|--------------------------|-----|
| THC + CBD | Various pre-clinical + 9 patients | 2001–2010 — Multiple international teams: Tumor reduction, apoptosis, angiogenesis inhibition | 26 |

## Mechanisms of Action

Cannabinoids attack brain cancer through multiple independent pathways, which is particularly significant because tumors often develop resistance to single-mechanism therapies:

- **Apoptosis induction:** THC and CBD trigger programmed cell death in glioma cells through reactive oxygen species (ROS) generation and mitochondrial pathway activation. CBD selectively induces ROS-mediated stress in cancer cells while sparing healthy neurons.

- **Angiogenesis inhibition:** Cannabinoids suppress VEGF (vascular endothelial growth factor) and other pro-angiogenic factors, cutting off the tumor's blood supply. This mechanism was identified by Complutense University researchers in Madrid.

- **Cell cycle arrest:** THC down-regulates E2F1 and Cyclin A, key proteins that drive cell division. This arrests the cancer cell cycle, preventing proliferation.

- **Invasion and metastasis inhibition:** Down-regulation of TIMP-1 and matrix metalloproteinases (MMPs) reduces the tumor's ability to invade surrounding healthy brain tissue.

- **CB2 receptor-mediated effects:** CB2 receptors are upregulated in glioma cells compared to normal brain tissue, providing a degree of selectivity. JWH-133, a CB2-selective agonist, demonstrated significant anti-tumor effects without psychoactive side effects.

- **TRPV1 receptor activation:** CBD and other cannabinoids activate the TRPV1 (vanilloid) receptor, contributing to calcium influx and apoptosis in cancer cells.
...
# Cannabis for Brain Cancer (Glioma)

Brain cancer location and size largely determine survivability and the symptoms likely to develop. As tumors grow, impairment increases, potentially impacting the whole body and mind. Generally, the lower in the brain structure the tumor is, the poorer the survival outcome. The five-year survival rate for glioblastomas is approximately 2 percent.

## Evidence Base

The Cannabis Health Index (CHI) rates the evidence for cannabis in brain cancer at a CHI value of 26, based on 9 studies reviewed. This represents one of the strongest evidence bases among cancer-specific cannabis applications, with multiple mechanisms of action identified.

## Anti-Tumor Mechanisms

Starting in 2001, an international research team demonstrated that local injections of the synthetic cannabinoid JWH-133 (a potent CB2 receptor agonist) into mice with brain cancer cells considerably reduced the size of malignant tumors. By 2003, Italian studies suggested that non-psychoactive CBD produced significant anti-brain tumor activity both in vitro and in vivo.

CBD selectively produced oxidative stress in brain cancer cells, inducing apoptosis (programmed cell death) while leaving normal cells unaffected. This selectivity is crucial because it suggests cannabinoids can target cancer cells without harming healthy brain tissue.

## Anti-Angiogenesis

A 2004 Spanish experiment demonstrated that cannabinoids effectively inhibited a chemical signal needed for brain tumors to build their blood supply, an essential element for survival and proliferation. The Spanish researchers considered the blockade of this signal to be one of the most promising anti-tumor approaches available.

This anti-angiogenic mechanism means cannabinoids may starve brain tumors by preventing them from developing the new blood vessels they need to grow. Without a blood supply, tumor growth is restricted.

## Human Safety Data

In 2006, scientists from Madrid enlisted nine patients with brain cancers that had failed to respond to surgery or radiation. They concluded that THC could be safely injected into human brain tumors without causing any overt psychoactive effects. This is a critical finding because it demonstrates the feasibility of direct cannabinoid delivery to brain tumors in human patients.

## Cell Cycle Arrest

In 2008, a team of researchers from Israel discovered that E2F1 and Cyclin A, two proteins that promote cell cycle progression, were down-regulated under the influence of THC, leading to arrest of glioblastoma multiforme (brain cancer cells). This cell cycle arrest prevents cancer cells from dividing and proliferating.

## Invasion and Migration Inhibition

Two Spanish studies on mice and humans with recurring glioblastoma multiforme examined tissue inhibitors of metalloproteinases (TIMPs) and matrix metalloproteinase (MMP-2). TIMP-1 up-regulation is associated with high malignancy and negative prognosis. Scientists discovered that TIMP-1 down-regulation and MMP-2 down-regulation may be hallmarks of cannabinoid-induced inhibition of glioma progression.

This means cannabinoids may not only kill existing brain cancer cells but also prevent them from invading surrounding healthy brain tissue, a key factor in brain cancer mortality.
