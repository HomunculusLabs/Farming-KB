---
title: Fire as a Management Tool
created: 2026-04-26
aliases: [fire, prescribed burning, burning, fire ecology,
          controlled burn, grassland burning]
tags: [fire, prescribed-burning, brittle-environments, land-management,
      soil-exposure]
related: [savory-brittle-environments, savory-rest-as-management-tool,
...
pressure, rest, and animal impact.
...
Fire affects plants in diverse ways. Some sensitive perennial grasses
disappear when burned. The majority, at least as mature plants, thrive
with fire as it removes old material that would otherwise kill grasses
through slow accumulation and oxidation.

Some plants depend on periodic fire for survival. Many grass seeds have
awns that twist and drill into exposed soil when moistened. Since few
factors in nature except fire produce bare ground over vast areas, such
adaptations likely evolved in response to fire.

Woody plants show varied responses. Up to ninety-five percent of the
...
in shrub form where burning is prolific.

## The Prescribed Burning Debate

Savory recounts attending an American Soil Conservation Service training
...
This narrow focus is characteristic of fire management worldwide.
Proponents cite benefits to certain species; opponents cite damage to
others. Neither side evaluates fire in the context of the whole
ecosystem and its four foundation processes.

## Fire and Desertification

The reported increased flow over Victoria Falls in Africa since 1948
puzzled scientists. Savory attributes it to increased fire frequency
and decreased large game populations in the watershed, the only major
changes during that period. More water runs off because fire-exposed
soils absorb less, while simultaneously less plant cover transpires
moisture back into the atmosphere for future rainfall.

## Holistic Use of Fire

Fire, like any other tool, can only be judged in the context of
defined goals and the current state of the four ecosystem foundation
blocks. It should be evaluated through the testing guidelines before
use, and its application should be planned in conjunction with other
tools, especially animal impact, to mitigate soil exposure and
accelerate recovery.

The key is to use fire only when it passes the testing guidelines,
and always in combination with adequate follow-up disturbance to
prevent the soil exposure from causing long-term damage to water and
mineral cycles.
