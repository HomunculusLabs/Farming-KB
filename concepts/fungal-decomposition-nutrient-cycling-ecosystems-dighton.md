...
updated: 2026-04-21
type: concept
tags: [fungal-ecology, soil, nitrogen-cycling, ecosystem]
...
### Litter Input Across Ecosystems
Plant litter input varies enormously across ecosystem types (Dighton's Table 2.9):
- Tundra: 0.1-0.5 tonnes per hectare per year
- Temperate grassland: 2-10 t/ha/yr
- Temperate forest: 3-12 t/ha/yr
- Tropical forest: 400+ t/ha/yr (total biomass turnover including root litter)
...
During early stages of decomposition, fungi immobilize nutrients (particularly nitrogen and phosphorus) into their biomass. This immobilization can create temporary nutrient limitation for plant growth. Marumoto et al. (1982) showed decomposition of 14C- and 15N-labeled microbial cells in soil, demonstrating that nutrient release from microbial biomass is an important pathway for plant nutrition.

### Post-Harvest Residue Decomposition
In agricultural systems, the decomposition of post-harvest crop residues is critical for nutrient cycling. The rate of decomposition and nutrient release depends on:
- Residue C:N ratio (high ratios cause nitrogen immobilization)
- Residue lignin content
...
Landeweert et al. (2001) demonstrated that [[ectomycorrhizal-fungal-ecology]] mobilize nutrients from minerals, linking plants directly to rock-derived nutrients. Paris et al. (1996) showed in vitro weathering of phlogopite by ECM fungi. Mojallala and Weed (1978) documented weathering of micas by mycorrhizal soybean plants.

The capacity for rock weathering varies among mycorrhizal species and is influenced by interactions with mycorrhizasphere bacteria. Wallander and Wickman (1999) showed biotite and microcline as potassium sources for ECM and non-ECM pine seedlings.

## Wood Decomposition

Fungi are the dominant agents of wood decomposition, with two main decay types:
- **White rot** — simultaneous or selective lignin degradation (primarily basidiomycetes)
- **Brown rot** — cellulose degradation with lignin modification (primarily basidiomycetes)

Rayner and Boddy (1998) provided comprehensive treatment of fungal wood decomposition. Sinsabaugh et al. (1993) showed that wood decomposition nitrogen and phosphorus dynamics relate to extracellular enzyme activity. Lodge and Asbury (1988) demonstrated that basidiomycetes reduce organic matter export from forest slopes, effectively retaining nutrients within the forest ecosystem.

## Fungal Interactions During Decomposition

### Competition
Lockwood (1992) described exploitation competition among decomposer fungi. Wicklow (1992) described interference competition. These competitive interactions determine which species dominate at each stage of decomposition and influence overall decomposition rates.

### Enzyme Production
Linkins et al. (1984) examined factors affecting cellulase activity in terrestrial and aquatic ecosystems. Sinsabaugh and Liptak (1997) showed that the availability of inorganic nutrients has a negative feedback on enzyme production — fungi invest more in enzyme production when nutrients are scarce.

### Soil Aggregation
Fungi contribute to soil structure through:
- Physical binding of soil particles by hyphae (Tisdall and Oades, 1982; Tisdall, 1994)
- Production of glomalin — a glycoprotein from AM hyphae that stabilizes aggregates (Wright and Upadhyaya, 1996, 1998)
- Mycorrhizal interactions with soil aggregates (Miller and Jastrow, 1990)

## Significance

Understanding fungal decomposition processes is essential for:
- Predicting nutrient availability in agricultural systems
- Managing crop residue decomposition and nutrient cycling
- Understanding soil carbon storage and climate change feedbacks
- Designing sustainable forest management practices
