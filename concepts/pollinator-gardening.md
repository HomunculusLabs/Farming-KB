...
Small, often metallic-colored bees attracted to human sweat. Important pollinators of many wildflowers and some crops. Many species are ground-nesting.

### Ground-Nesting Bees
Approximately 70% of native bee species nest in bare, well-drained soil. They need exposed, undisturbed soil patches. Avoid heavy mulch in areas designated for ground-nesting bees.

## Butterfly Gardening

Butterflies need two types of plants: host plants for caterpillars and nectar plants for adults.
...
- Salvia (Salvia spp., especially red varieties)
...
Also provide:
- A water source (mister or shallow birdbath with rocks)
- Perches (thin branches or wires near feeders)
- Supplemental nectar feeders (1 part white sugar to 4 parts water, no dye)
...
### For Butterflies
- Include host plants in sheltered locations
- Provide flat rocks for basking
- Create windbreaks with shrubs or structures
- Leave some leaf litter for overwintering pupae
- Avoid raking all leaves in fall -- many species overwinter in leaf debris

### General Habitat Features
- Provide a shallow water source with landing rocks
- Create a diversity of flower heights and shapes
- Include some early and late bloomers for season-long support
- Eliminate or minimize pesticide use (including organic pesticides)
- Allow some "messy" areas -- perfection is the enemy of pollinators

## Seasonal Bloom Calendar

A successful pollinator garden provides continuous blooms from early spring through late fall:
...
- Coneflower, yarrow, bee balm
- Wild lupine, penstemon
- Chives, catmint
- Blackberry, raspberry blossoms
- Milkweed emerging (critical for monarch migration)
...
- Plant in clusters of 3-5 plants of the same species (more visible and accessible to pollinators)
- Aim for at least 3 species blooming at any given time
- Include native plants as the backbone -- they co-evolved with native pollinators
- Minimize hybridized double-flower varieties (often lack accessible nectar and pollen)
- Provide a mix of flower shapes to accommodate different tongue lengths
