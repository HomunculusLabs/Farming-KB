...
Powell's central claim is that psilocybin "temporarily dissolves the constraints" on normal consciousness, conferring "increased degrees of cognitive freedom." Normal consciousness is not the full range of possible consciousness but a constrained subset. The serotonergic raphe system acts as a filter that limits the information available to conscious awareness, functioning "like a balancing stick enabling us to walk the tightrope of normal perceptual awareness."

Consciousness expansion means accessing informational patterns that are normally suppressed. The result is not chaos but a richer, more comprehensive experience of reality. As Powell puts it, the net effect is "an increase in neuronal firing, a concurrent increase in consciousness (an increase in perceived reality), and the emergence of shamanic visions."
