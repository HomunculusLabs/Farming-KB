...
The nutrient medium is the foundation of successful tissue culture. The formulation of the agar medium determines whether explants produce shoots, roots, callus, or fail to develop at all. Cannabis tissue culture relies on both standardized plant tissue culture media and custom formulations optimized for the species' particular requirements.

### Murashige and Skoog (MS) Medium

The Murashige and Skoog (MS) medium, developed in 1962, is the most widely used basal medium in plant tissue culture and serves as the starting point for most cannabis tissue culture formulations. The full-strength MS medium contains:

- **Macronutrients** (mg/L): Ammonium nitrate (1,650), potassium nitrate (1,900), calcium chloride (440), magnesium sulfate (370), potassium dihydrogen phosphate (170). The high nitrate-to-ammonium ratio (approximately 2:1) supports vigorous shoot proliferation in most species.
- **Micronutrients** (mg/L): Manganese sulfate (22.3), zinc sulfate (8.6), boric acid (6.2), potassium iodide (0.83), sodium molybdate (0.25), copper sulfate (0.025), cobalt chloride (0.025).
- **Iron source**: Typically provided as Fe-EDTA (iron chelated with ethylenediaminetetraacetic acid) at 100 mg/L chelated iron, ensuring iron remains soluble and bioavailable at the medium's pH.
- **Vitamins** (mg/L): Thiamine (vitamin B1, 0.1), nicotinic acid (0.5), pyridoxine (vitamin B6, 0.5), myo-inositol (100). Glycine (2 mg/L) is included in the original formulation but is often omitted in modern variants.
