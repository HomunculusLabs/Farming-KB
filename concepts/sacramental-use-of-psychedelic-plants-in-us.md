---
title: Sacramental Use of Psychedelic Plants in the United States
created: 2026-04-28
tags:
  - religious-freedom
  - drug-policy
...
### Gray Areas and DEA Regulatory Changes

Regulations have significant gray areas: transportation by Canadian
First Nations through the US; blood quantum requirements (25% in Texas,
undefined elsewhere); use by state-recognized tribes lacking federal
status; use by non-natives married to Native Americans. These were
handled within the NAC case-by-case for decades without problems, and
the NAC maintains cooperative relations with the DEA.
...
or ethnic exclusionary rules and are open to all peoples.

### Uniao do Vegetal (UDV)

The US UDV branch has been in federal litigation seeking protection
...
The NAC is exclusively for Native Americans with recognized tribal
membership, while the santo daime and UDV are open to all
citizens. The NAC's protection rests on federal treaty obligations, not
general religious freedom. No claim by a non-Native group based on NAC
precedent has succeeded in federal court. Should the UDV prevail,
the US would face accepting a religion using a hallucinogenic as
sacrament that is open to all citizens, fundamentally different from the
NAC's ethnically limited exemption.

### Federal Versus State Tensions

The Oregon Board of Pharmacy exemption illustrates state-federal
tension. State authorities may recognize religious exemptions, but
federal law enforcement retains power to prosecute for Schedule I
possession, creating a precarious legal environment.

## International Context

Peru and Brazil have recognized the santo daime and UDV as bona
fide religions for more than 20 years. A 2001 Netherlands court case
recognized the Santo Daime as valid, potentially making religious
ayahuasca use permissible throughout the EU. Both religions have
quietly expanded into Europe, the US, and elsewhere.
