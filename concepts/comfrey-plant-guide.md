...
herb. (see [[valerian-growing-guide]]).
...
Russian comfrey (Bocking 14 is the most popular cultivar) is preferred for
homesteads because it is sterile and will not spread by seed, though it can
still spread vegetatively from root fragments. (see [[hawthorn-berry-guide]]).
...
- Potassium (K) -- very high concentration in leaves
- Calcium (Ca)
- Magnesium (Mg)
- Iron (Fe)
- Silica

This makes comfrey an excellent nutrient source for the rest of the garden.
Leaves can be cut several times per season and used as:
...
To make comfrey tea for use as a liquid fertilizer:

1. Fill a bucket or barrel roughly halfway with fresh comfrey leaves (wear
   gloves; the hairs can irritate skin).
2. Weight the leaves down with a rock or brick.
3. Cover with water (rainwater is ideal) and seal loosely.
4. Let steep for 2-4 weeks. The smell will be very strong.
5. Dilute the resulting dark liquid 1:10 to 1:15 with water.
6. Apply to garden plants as a potassium-rich foliar feed or soil drench.

Comfrey tea is especially beneficial for fruiting plants like tomatoes,
peppers, and fruit trees that have high potassium demands.
...
- Poultices for sprains, strains, and broken bones (historically called
  "knitbone")
- Salves for minor cuts, scrapes, and burns
- Compresses for bruises and insect bites

Important safety note: Comfrey contains pyrrolizidine alkaloids (PAs) which
are hepatotoxic. Internal use is generally discouraged by modern herbalists.
Limit external use to unbroken skin and short-term applications. Pregnant
and nursing women should avoid comfrey entirely. Some herbalists recommend
using only Bocking 14 or PA-free cultivars for medicinal preparations.

## Cultivation

### Site Selection
Comfrey tolerates a wide range of conditions but performs best in full sun
to partial shade. It adapts to most soil types but thrives in deep, moist,
fertile loams. Once established, it is extremely drought-tolerant due to its
deep root system.

### Propagation
Comfrey is most commonly propagated by root cuttings or crown divisions:
...
Seed is generally not recommended for Russian comfrey as it is sterile. Common
comfrey can be grown from seed but may self-seed aggressively.

### Planting
Space plants 2-3 feet apart. They will form large clumps over time. Plant
root cuttings or crowns in early spring as soon as the ground can be worked,
or in fall for establishment before winter.
...
Russian comfrey spreads only by root fragmentation. Any piece of root left
in the soil can regenerate. To prevent unwanted spread:
- Plant in dedicated beds or zones where spread is acceptable
- Avoid rototilling near comfrey patches
- Do not move soil containing comfrey root fragments to other areas
