---
title: Darwin Phototropism Experiments Plant Light Sensing
...
2. **Tip removed (decapitated)** - The seedling had its coleoptile tip
   pruned off. This plant went "blind" and did not bend toward the light,
   demonstrating that the tip was necessary for light detection.

3. **Tip covered with opaque (lightproof) cap** - A small cap that blocked
   all light was placed over the tip. The plant could not bend toward light,
   confirming that light must reach the tip for phototropism to occur.

4. **Tip covered with transparent glass cap** - A clear glass cap was placed
   over the tip. The plant continued to bend normally toward the light. This
   critical control proved that the cap itself did not physically interfere
   with bending -- it was the absence of light at the tip, not the presence
   of the cap, that prevented phototropism.

5. **Middle section covered with opaque tube** - A lightproof tube was
   placed around the middle of the seedling, below the tip. The plant bent
   normally toward the light, proving that the bending region does not need
   receive light directly.

## Significance and Interpretation

These results led Darwin to conclude that the "eyes" of the plant are
located at the shoot tip. The tip perceives light direction and somehow
transmits this information to the bending zone below, which responds by
differential cell elongation on the shaded versus illuminated side.

This discovery was revolutionary because it demonstrated that:
- Light sensing in plants is spatially separated from the response
- The plant uses a dedicated sensory organ (the tip) rather than
  whole-organism light detection through photosynthesis
- Information is transmitted from the sensing tissue to the responding
  tissue, implying some form of internal signaling
