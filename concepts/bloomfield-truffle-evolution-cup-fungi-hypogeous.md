...
The truffle evolutionary narrative illustrates several fundamental principles of [[fungal-adaptations-environmental-gradients]]. Fourth, the mycorrhizal lifestyle has provided a stable foundation upon which dramatic above-ground (or below-ground) innovations could be built. Fifth, the loss of one dispersal agent (dinosaurs) can drive the evolution of entirely new chemical strategies to recruit replacement dispersers (mammals).
