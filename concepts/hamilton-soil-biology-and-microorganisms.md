...
surface, mixed with organic matter to gradually convert it into productive
topsoil.

## The Role of Bacteria

Bacteria perform a number of vital functions in soil. They are the primary
agents responsible for the decay of animal and plant matter, converting
complex organic materials into forms that plants can use. Perhaps most
importantly, certain bacteria fix atmospheric nitrogen, converting it into
a form available to plants. In the compost heap, the species known as
Azotobacter is attracted by the conditions created during decomposition and
can "fix" nitrogen from the air, converting it into a plant-available form.

The composting process depends entirely on bacterial activity. Millions of
bacteria feed on fresh organic material, requiring nitrogen as fuel. If
green material is dug directly into soil, bacteria draw nitrogen from the
soil itself, leaving plants deficient. Proper composting allows these
bacteria to complete their work first, with Azotobacter adding nitrogen
back, so the finished compost actually contributes nitrogen rather than
depleting it.
