---
title: Carbon-to-Nitrogen Ratio and Compost Microbial Dominance
...
The optimal C:N ratio for efficient composting is approximately 25:1 to 30:1. At this ratio, decomposition proceeds rapidly and completely because microbial populations have balanced access to both energy (carbon) and building blocks (nitrogen):

- **Too much carbon** — nitrogen is quickly exhausted and decomposition slows dramatically
- **Too much nitrogen** — organisms consume nitrogen rapidly, and excess carbon is vented to the atmosphere as CO₂ or washed out of the pile with water
...
Brown materials are aged, woody, or dried organic matter high in carbon and lignin:
...
These materials contain difficult-to-digest lignin, cellulose, and tannin. Fungi possess the enzyme systems necessary to break down these recalcitrant compounds. Only after fungi have begun the decomposition process can bacteria attack the material.

### Green Materials (Support Bacteria)

Green materials are fresh, succulent organic matter high in nitrogen and simple sugars:
...
| Sawdust | 500:1 |
| Paper | 170:1 |
| Tree leaves | 40:1 to 80:1 |
| Grass clippings | 19:1 |
| Alfalfa meal | ~12:1 |

Grass clippings (19:1) and tree leaves (40–80:1) mixed together provide a near-ideal ratio for general composting.

## Recipes for Targeted Microbial Dominance

### Fungal Compost Recipe

For trees, shrubs, and most perennials (which prefer ammonium nitrogen from fungal-dominated soils):
...
## pH and Microbial Dominance

The microbial composition of compost also influences its pH:

- **Bacteria** tend to buffer compost pH around **7.0–7.5** (neutral to slightly alkaline)
- **Fungi** tend to buffer compost pH around **5.5–7.0** (slightly acidic)

Including some fungal material in all composts prevents them from becoming too alkaline. The more fungal material present, the lower the pH tends to be.
...
A minimum mass of approximately 3.5 feet square or round (1 cubic meter) is required for proper heat generation. Larger piles (up to about 6 feet wide and tall) are possible but create more work because the entire mass must be turned to maintain aeration. Beyond six feet, mechanical assistance becomes necessary.

### Moisture Management

Proper moisture content is critical throughout composting:

- **Too dry** — microbial activity ceases; organisms go dormant
- **Too wet** — anaerobic conditions develop; pile won't heat properly
- **Ideal** — squeezing a handful yields only a few drops of water
