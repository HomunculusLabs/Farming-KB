...
Bacteria are the most numerous organisms in soil and among the earth's primary decomposers, second only to [[teaming-with-microbes-soil-food-web-trophic-structure-and-succession]] is built.

## Ancient and abundant

Bacteria appeared at least 3 billion years ago, making them the earliest form of life on earth. They are prokaryotes — their DNA is contained in a single chromosome not enclosed in a nucleus. Their size is the main reason gardeners rarely consider them: they are too small to see in detail with standard 1000-power microscopes.

Three basic shapes are found in soil: coccus (spherical or oval), bacillus (rod-shaped), and spiral. All three are represented in garden soils and play roles in decomposition.

Under ideal laboratory conditions, one bacterium can produce 5 billion offspring in 12 hours. If all bacteria reproduced at this rate, it would take only a month to double the mass of our planet. In soil, however, reproduction is limited by natural conditions, predators (chiefly [[teaming-with-microbes-overview]] (genus Streptomyces) produce enzymes that include volatile chemicals giving soil its clean, fresh, earthy aroma — the smell of "good soil" that every gardener recognizes.
...
Bacterial slime raises soil pH, creating alkaline microenvironments. Nitrogen-fixing bacteria generally require pH above 7. In [[teaming-with-microbes-soil-ph-and-biology]] range preferred by many vegetables, where iron availability is naturally limited.
### Lytic Enzymes
