---
title: Microwave Surface Sterilization System Design Nasa Msap 2 45 Ghz Trace Water Steam
tags:
...
NASA's Lyndon B. Johnson Space Center developed a microwave-based surface sterilization system (MSC-22484) to solve a persistent problem in aerospace biology: the lack of a reliable means of sterilizing mating fixtures for accessing biologically sensitive systems, including Environmental Control and Life Support System (ECLSS) waters and flight experiments. The resulting [[aseptic-specimen-transfer-space-environment-microwave-sterilizable-access-port]] Port (MSAP) concept demonstrated that 2.45 GHz microwave irradiation, in the presence of trace water, can achieve complete surface sterilization of [[surface-sterilization-methods-comparison-complex-geometries-thermal-chemical-residue]] without the drawbacks of conventional sterilization methods.
...
A particularly significant finding was that microwave radiation at the parameters tested can penetrate elastomeric materials and sterilize fully enclosed systems. This means the system can be used to sterilize surfaces inside sealed containers, tubing, or other enclosed geometries that are inaccessible to [[microwave-versus-conventional-surface-sterilization-comparison]] methods. The microwaves pass through the elastomer barrier, couple with any trace water present on the interior surfaces, and produce the same flash-steam sterilization effect.
