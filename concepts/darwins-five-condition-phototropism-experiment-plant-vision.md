...
confirming that it was light perception at the tip (not the physical presence of the
tip tissue) that drove the bending response.

**Condition D (Tip covered with transparent glass cap):** The tip was covered with a
clear glass cap that allowed light to pass through. The seedling DID bend toward the
light. This condition ruled out a mechanical or pressure effect of the cap and
confirmed that light transmission to the tip was the relevant variable.

**Condition E (Middle section covered with opaque tube):** The bending region of the
stem was covered with a lightproof tube while the tip remained exposed. The seedling
DID bend toward the light. This proved that the bending region did not need to
directly perceive the light — it received its instructions from the tip.

## The Signal Transmission Concept

The five-condition design established a fundamental principle of plant physiology: the
tip of the shoot perceives light direction and sends a signal to the lower stem,
which responds by differential cell elongation (cells on the shaded side elongate more
than cells on the illuminated side, causing the plant to bend toward the light). This
tip-to-bend signal transmission was later identified as the plant hormone auxin
(indole-3-acetic acid), which redistributes to the shaded side of the stem and promotes
cell elongation there.

The signal transmission concept was revolutionary because it demonstrated that plants
possess a decentralized but coordinated information processing system. The "eye" at the
tip and the "muscle" in the stem are separated spatially but connected by a mobile
chemical signal — an architecture that parallels, in an abstract sense, the
eye-to-brain-to-muscle pathway in animals, albeit without any neural tissue.
...
Darwin's phototropism experiments directly led to the discovery of auxin by Frits
Went in the 1920s, who demonstrated that a chemical diffusing from the shoot tip
caused the bending response. The identification of phototropin as the blue-light
photoreceptor responsible for phototropism came over a century after Darwin's original
