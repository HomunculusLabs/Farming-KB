---
title: Biochar for Soil Remediation
created: 2026-04-17
updated: 2026-04-17
type: concept
...
The remediation potential of biochar arises from its unique physicochemical properties including high surface area, extensive microporosity, alkaline pH, abundant surface functional groups, and stable carbon matrix. These properties enable biochar to interact with and transform soil contaminants through multiple mechanisms simultaneously.
...
In some cases, biochar acts as an electron shuttle, facilitating electron transfer between microbial cells and electron acceptors or donors in the soil. This can enhance reductive dechlorination of chlorinated solvents and other reductive transformation processes. Biochar may also stimulate the production of fungal extracellular enzymes involved in organic pollutant degradation.

## Application Considerations

Biochar application rates for soil remediation typically range from 1% to 10% by weight (10 to 100 tonnes per hectare for the top 20 cm of soil). The optimal rate depends on the type and concentration of contaminants, soil properties, and the remediation objectives. Higher application rates generally provide greater contaminant immobilization but also increase costs.

Biochar particle size affects both handling characteristics and remediation performance. Fine particles (less than 2 mm) provide greater surface area per unit mass and more uniform distribution in soil, while coarse particles (2 to 10 mm) are easier to handle and provide better soil structure improvement.

The long-term stability of biochar in soil is one of its key advantages over other organic amendments. Biochar carbon can persist in soil for hundreds to thousands of years, providing long-term contaminant immobilization and carbon sequestration benefits. However, biochar properties do change over time through oxidation of surface groups, physical weathering, and incorporation into soil aggregates.
