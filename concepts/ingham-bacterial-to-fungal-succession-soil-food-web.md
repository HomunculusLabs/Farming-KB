...
3. **Protozoa arrive** — Flagellates, amoebae, and ciliates begin grazing on
   bacteria, creating the first predator-prey relationships. This grazing
   releases nutrients immobilized in bacterial biomass, making them available
   for plant uptake.

4. **Fungi appear** — Fungal hyphae begin colonizing the soil, initially as
...
- **Late successional plants** (perennials, trees, shrubs) require
  ...
  and the slower, more sustained nutrient release characteristic of fungal
  food webs.

Ingham's practical implication: if you want to grow early successional plants
(vegetables), your soil should be bacterial-dominated. If you want to grow late
successional plants (orchards, forests), you need fungal dominance. The soil
food web must match the desired plant community.

## Compost Tea and Succession Management

AACT can be formulated to either maintain or shift the successional position:
