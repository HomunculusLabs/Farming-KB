...
Lactic Acid Bacteria Serum (LABS) has been observed to increase trichome-to-calyx
ratio and terpene production in Cannabis when applied as a soil drench or foliar
spray. This article proposes a biochemical mechanism involving hexanoate, a
short-chain fatty acid byproduct of LAB fermentation of ruminant milk fats,
as a catalyst for increased cannabinoid and terpene biosynthesis.

## Background: Effective Microorganisms (EM)

The concept of Effective Microorganisms (EM/EM1) was introduced by T. Higa and
...
actinomycetes, and fermenting fungi. Higa later revised the mixture to include
only lactic acid bacteria, purple bacteria, and yeast.

## LAB Benefits in Agriculture
...
Hexanoyl-CoA, derived from hexanoate, serves as a primer for a polyketide
synthase (PKS) enzyme that forms olivetolic acid. The biochemical pathway:

- Hexanoate is formed via esterification of hexanoic acid
- Hexanoate stimulates hexanoyl-CoA production
- Hexanoyl-CoA feeds the PKS enzyme forming olivetolic acid
...
## Hexanoic Acid as Plant Defense Priming Agent

Beyond its role in cannabinoid biosynthesis, hexanoic acid (Hx) is a potent
...
This defense priming effect may independently contribute to increased trichome
production, as trichomes serve as a primary physical and chemical defense
structure in Cannabis.

## Hexanoic Acid Sources

Hexanoic acid (6:0) comprises 1-2% of total fatty acids in ruminant milk
triacylglycerols, esterified primarily to position 3. It is also found as a
minor component in certain seed oils rich in medium-chain saturated fatty
acids (coconut oil, palm kernel oil). Ruminant milk fat has unique composition
due to ruminal biohydrogenation effects and de novo fatty acid synthesis in
the mammary gland.

Odd-chain fatty acids (13:0 to 19:0) occur in appreciable amounts in
bacterial species and ruminant animal tissues, suggesting bacterial origins
contribute to the fatty acid diversity in ruminant milk used in LABS
production.

## Connecting LABS Application to Enhanced Biosynthesis

The proposed chain of causation:

1. LABS is produced using ruminant milk containing hexanoic acid
2. Microbial fermentation during LABS production generates or preserves
   hexanoate as a byproduct
3. Soil application of LABS delivers hexanoate to the root zone
4. Hexanoate is taken up by Cannabis roots and transported to trichomes
5. Increased hexanoyl-CoA availability stimulates olivetolic acid production
6. Greater precursor supply enhances cannabinoid and terpene biosynthesis
7. Simultaneous defense priming from hexanoic acid may boost trichome
   production as a defense response
