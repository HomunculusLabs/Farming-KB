...
- Hyphal penetration into rock cracks and pores
- Expansion as hyphae grow exerts pressure (up to several atmospheres)
- Turgor pressure-driven penetration of microfractures
...
### Silicate Minerals
- Feldspars (K-feldspar, plagioclase): potassium, calcium, sodium release
- Micas (biotite, muscovite): potassium, magnesium, iron release
- Quartz: slow weathering, accelerated by organic acids
- Pyroxenes and amphiboles: calcium, magnesium, iron release
...
- Weathering reaction: CaSiO3 + CO2 → CaCO3 + SiO2
- Enhanced weathering (by fungi or intentionally) is a proposed carbon removal strategy
...
Understanding the fundamental principles behind fungal mineral weathering provides a foundation for both practical application and continued scientific inquiry.
## See Also
