---
title: Symbiotic Fungi — Fungal Parasitism and Pathogenicity
created: 2026-04-26
updated: 2026-04-24
sources:
...
The term symbiosis (Greek: *sym*, "with"; *biosis*, "living") was first used in 1879 by the German mycologist Heinrich Anton de Bary, who defined it as "the living together of unlike organisms." In symbiosis, at least one member benefits from the relationship. The other member may be:

- **Injured** — parasitism association
- **Relatively unaffected** — commensalism association
- **Both benefiting** — mutualism

Many fungal-plant relationships exist along this continuum, and the boundary between mutualism and parasitism can be fluid depending on environmental conditions, host physiology, and fungal genotype.

## Types of Symbiotic Relationships

### Ectosymbiosis

Any symbiotic relationship in which the symbiont lives on the body surface of the host, including the inner surface of the digestive tract or ducts of exocrine glands. Examples include ectoparasites such as lice, commensal ectosymbionts such as barnacles on baleen whales, and mutualist ectosymbionts such as cleaner fish.

### Endosymbiosis

Any symbiotic relationship in which the symbiont lives within the tissues of the host, either intracellularly or extracellularly. Examples include nitrogen-fixing rhizobia in legume root nodules, *Frankia* in alder tree root nodules, single-celled algae inside reef-building corals, and bacterial endosymbionts providing essential nutrients to about 10-15% of insects.

## Fungal Pathogenicity Mechanisms

### Obligate Biotrophs

Some fungi are obligately biotrophic — they require living host tissue to complete their life cycle. Arbuscular mycorrhizal (AM) fungi are obligately biotrophic, as their survival depends on the presence of a living host. While AM fungi are mutualistic, the biotrophic lifestyle strategy is shared with many pathogenic fungi that maintain living host cells to extract nutrients. Because AM fungi are strictly biotrophic, understanding their biology requires studying them in association with living roots, which has limited biotechnological exploitation.
...
Mycorrhizal fungi provide significant protection against soilborne pathogens through multiple, often synergistic, mechanisms. In a natural ecosystem where phosphorus uptake is low, a major role of mycorrhizal fungi may be protection of the root system from endemic pathogens such as *Fusarium* spp.

### 1. Physical Barrier

Mycorrhizal fungi may change the susceptibility of roots — especially the mantle of the ectomycorrhiza — to infection by pathogens. The fungal sheath provides a physical barrier preventing direct pathogen access to root tissue. P. nicotianae hyphae were never observed in the same cells as those containing G. mosseae (Cordier et al. 1996).

### 2. Antibiotic Production

Some mycorrhizal fungi secrete antibiotics that help protect their host from invasion by parasitic fungi and bacteria. These antibiotic compounds can suppress pathogen growth in the rhizosphere.

### 3. Nutrient Competition

Mycorrhizal fungi compete with pathogens for nutrients, including production of siderophores that sequester iron. By depleting available nutrients, mycorrhizae limit the resources available for pathogen proliferation.

### 4. Induced Systemic Resistance (ISR)

Mycorrhizal colonisation induces plant defence pathways that provide systemic protection:

- **Constitutive synthesis** of beta-1,3-glucanase and new isoforms of beta-1,3-glucanase and chitinase within colonised roots
- **Cell wall modifications** including callose accumulation around cortical cells containing arbuscules
- **PR-1 protein accumulation** and cell wall thickenings rich in pectin, characteristic of ISR
- **Jasmonic acid (JA)** accumulation within mycorrhizal roots in a non-systemic manner; JA is essential for ISR and is involved in defence responses after biotic and abiotic stresses

The reduction in total infection loci in tomato plants inoculated with P. nicotianae suggests that pathogen proliferation is inhibited before it penetrates mycorrhizal roots within the soil.

### 5. Root Exudate Modification

Root exudates from mycorrhizal plants profoundly affect pathogen behaviour. In studies with transformed tomato root lines and G. intraradices:
...
- The soil microbial community that may include antagonistic bacteria

Many soil bacteria have been shown to act as biocontrol agents, and mycorrhizal establishment may enhance the efficacy of these already-present biocontrol agents. Understanding repercussions on soil microbial communities after mycorrhizal inoculation is essential for efficient use in agriculture.
