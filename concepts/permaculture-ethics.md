...
These ethics serve as a simple but powerful statement of guidance for everyday endeavours. They can be coupled with a determination toward self-reliance — to be neither employers nor employees, landlords nor tenants, but to be self-reliant as individuals and cooperate as groups.
...
## The Connection to Indigenous Wisdom

Mollison explicitly connects permaculture ethics to indigenous and tribal wisdom. He notes that the rules of necessitous and conservative use are essentially what tribal societies encoded as taboos — restrictions on hunting, gathering, or resource use that appeared irrational to outsiders but actually served to maintain the long-term productivity of the resource base.

This connection is important because it grounds permaculture ethics in thousands of years of human experience rather than in abstract moral theory. The ethics are not invented; they are recovered — distilled from the accumulated wisdom of cultures that lived sustainably for generations within their local ecosystems.

## Limits and Population

The third ethic — setting limits to population and consumption — is the most challenging and controversial. Mollison frames it not as authoritarian population control but as individual and collective self-governance: "By governing our own needs, we can set resources aside to further the above principles." The emphasis is on voluntary restraint and conscious consumption rather than external imposition.

This ethic recognizes that in a finite world, unlimited consumption by any individual, institution, or nation-state is inherently unsustainable and therefore unethical. The earth has limits, and ethical behaviour requires living within those limits while ensuring that enough resources are set aside for the continued health of natural systems and the needs of all people.
