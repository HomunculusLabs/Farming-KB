...
## Overview
Rock and mineral surfaces support complex and diverse fungal [[fungal-mineral-transformations-biogeochemical-cycles]] communities that play
critical roles in biogeochemical [[fungal-mineral-transformations-biogeochemical-cycles]] cycling, rock weathering, and soil formation. Modern
...
diversity — the "culturable minority." Modern PCR-based approaches reveal the
"uncultured majority" without culturing bias.
...
**Limitations**:
- Cannot generate direct sequence information — only community fingerprints.
...
### Fungal Community Profiles by Mineral Type
| Mineral Type | Average Ribotype Number |
|-------------|------------------------|
| K-feldspar | 25 |
| Granite | 23 |
| Muscovite | 23 |
