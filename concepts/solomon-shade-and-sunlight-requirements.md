...
Solomon notes that a pasture growing a mixture of grasses and clovers
demonstrates this principle: there is a thick, dense sward that
captures every bit of sunlight and converts it to biomass every day.
When the grass is removed and nothing is grazed there, the rapid growth
quickly forms a complete canopy again. Vegetables work the same way;
the more leaf area exposed to full sun, the more food the plant can
produce.

## Shade from Plant Canopy

Once vegetable plants grow large enough, their leaves strongly shade
the soil below. This natural canopy shade serves multiple purposes:
