---
title: Mycorrhizal Carbon Allocation
created: 2026-04-17
updated: 2026-04-17
type: concept
...
## Magnitude of Carbon Transfer

Plants may divert up to 80% or more of net energy fixed as sunlight to below-ground processes. A high proportion of this energy feeds mycorrhizal fungi and other soil organisms. This carbon is not lost to the plant; rather, soil organisms in the root zone greatly influence plant establishment through effects on nutrient cycling, pathogen suppression, soil aeration, and water uptake. The carbon allocated to mycorrhizal fungi represents a significant component of total ecosystem carbon flow.

## Carbon Flow Pathways

Carbon flows from atmosphere to green biomass through photosynthesis, then below-ground to roots and is transferred to specific molecules. In arbuscular mycorrhizal (AM) systems, carbon moves from the host plant through intraradical fungal structures to the extraradical mycelium (ERM). The pathway involves carbon fixation in leaves, translocation to roots via the phloem, transfer across the arbuscular interface, and transport through the ERM for fungal metabolism and growth.

## Signature Fatty Acid Analysis

The neutral lipid fatty acid (NLFA) 16:1omega5 is a useful biomarker for detecting and quantifying carbon flow to arbuscular mycorrhizal fungi in roots and soil. Since total 13C incorporation in AM fungal hyphae correlates with enrichment in NLFA 16:1omega5, it is possible to estimate carbon uptake in AM fungi by analyzing this compound. Neutral lipids comprise around 20% of the biomass of hyphae, vesicles, and spores of AM fungi, and serve as storage compounds.

## Carbon in Fungal Storage Structures

A large proportion of AM fungal carbon is contained in lipids within vesicles inside plant roots and in spores on the external mycelium, where they accumulate and may be stored for long periods. Higher 13C enrichment in lipids of the intraradical mycelia than in plant root lipids demonstrates that lipid metabolism is more active in the intraradical mycelia than in the plant. This lipid accumulation represents a significant carbon sink in terrestrial ecosystems.

## Stable Isotope Labelling Techniques

13C pulse-labelling combined with compound-specific isotope ratio mass spectrometry allows researchers to track carbon allocation from plants to AM fungi and other rhizosphere microorganisms. In monoxenic AM cultures, plates can be supplied with sterile filtered [13C]-D-glucose to trace carbon movement. In pot experiments, plants are enclosed in chambers and exposed to 13CO2, and the distribution of labelled carbon is tracked over time through different soil organism groups.

## Temporal Dynamics of Carbon Allocation

Timing is critical in carbon allocation studies because carbon is continually respired. In field-labelled AM fungal mycelium, labelled respiration ceased within seven days after pulse-labelling, indicating that only labelled stored material remained. Recently assimilated carbon in Plantago lanceolata appeared in extraradical AM fungal hyphae within a few days and remained largely there for at least 30 days. Carbon translocation between different parts of the mycelium occurs within approximately seven days.

## Carbon Allocation to Saprophytic Microorganisms

Carbon transferred to saprophytic microorganisms can be estimated using fatty acid biomarkers. By comparing the 13C enrichment in AM fungal signature fatty acids with those of saprophytic fungi (ergosterol and PLFA 18:2omega6,9) and bacteria (10 specific PLFAs), researchers can map the complete carbon flow through the rhizosphere food web. This approach reveals how mycorrhizal carbon supports broader soil microbial communities.

## Factors Affecting Carbon Allocation

Carbon allocation to mycorrhizal fungi is influenced by multiple factors including plant photosynthetic rate, soil nutrient availability (particularly phosphorus), fungal species identity, plant species, and environmental conditions such as light, temperature, and soil moisture. Under phosphorus limitation, plants typically allocate more carbon to AM fungi, while high soil phosphorus availability can reduce the mycorrhizal dependency and therefore the carbon drain on the host plant.
...
- Olsson PA (2009) Using stable carbon isotope labelling in signature fatty acids to track carbon allocation in arbuscular mycorrhiza. In: Varma A, Kharkwal AC (eds) Symbiotic Fungi, Soil Biology 18. Springer.
