...
accumulate contaminants, and presence across diverse habitats make them
practical organisms for monitoring ecological health and detecting
contamination events.

## Principles of Fungal Bioindication
...
## Heavy Metal Bioindication

Several fungal species demonstrate strong capacity for metal accumulation,
making them effective indicators of heavy metal pollution:
...
- Provides complementary data when used alongside the Ames test
- Shows positive results for all Ames-positive samples plus additional
  compounds

## Fungal Biosensors

Advances in multicolored fluorescent proteins from yeasts and fungi have
enabled new sensing systems for environmental pollutants. Whole cells can
be incorporated into biosensor arrays on silicon chips, optical fibers,
