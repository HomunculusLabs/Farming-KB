...
Vermicomposting -- raising earthworms to process organic waste into nutrient-rich castings -- can become a profitable homestead business. Worm castings (vermicast) are among the finest organic fertilizers available, and the worms themselves have multiple markets. (see [[comparison-black-soldier-fly-vs-vermicomposting]]).

## Getting Started

### Worm Species
- Red Wigglers (Eisenia fetida): the gold standard for vermicomposting. Hardy, prolific breeders, process waste rapidly. Thrive in 55-77F. Can eat half their body weight daily. (see [[vermicompost-production-systems-quality-standards]]).
...
### Starting Stock
Begin with 1-2 pounds of worms (roughly 1,000 worms per pound) for a small bin. Purchase from reputable breeders -- avoid worms collected from unknown sources. A healthy starting population will double in 60-90 days under ideal conditions.
...
### Phase 1: Hobby Scale (0-6 months)
1-2 bins processing household waste. No significant revenue yet. Focus on learning worm biology and bin management. Goal: establish breeding population and refine your process.

### Phase 2: Side Business (6-18 months)
...
- Composting worms: $30-50 per pound to home composters
- Reptile food: $20-30 per pound to pet stores
- Mail order: significant demand online with proper shipping (ventilated containers, ice packs in summer)

### Breeding Stock
Sell starter kits (bin + worms + instructions) to beginners. Packages at $50-150. Higher margin than selling worms alone.

## Cost Analysis

Startup costs for a small operation:
- Worms: $50-100 per pound
- Bins: $20-50 each (DIY bins from plastic totes: $10-15)
- Bedding: free (shredded cardboard, newspaper, leaves)
- Feedstock: free (food waste, manure)
- Harvesting equipment: $50-200 (screens, tumbler)

Operating costs are minimal -- worms are low-maintenance once established. Labor is the primary ongoing cost as you scale.

## Marketing Strategies

- Farmers markets: in-person sales build trust. Offer free samples.
- Online: Etsy, your own website, Craigslist, Facebook Marketplace
- Local garden centers: approach about carrying your product wholesale
- Social media: time-lapse videos of worm bins perform extremely well
- Workshops: teach vermicomposting classes ($25-50 per person) -- creates customers
- CSA add-ons: partner with vegetable CSAs to offer a vermicast upgrade
