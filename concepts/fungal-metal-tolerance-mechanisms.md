...
resisting toxic metal concentrations in contaminated environments.
These tolerance mechanisms are critical for fungal survival in
metal-polluted soils and are directly relevant to bioremediation
applications. Metal tolerance in fungi operates through both
constitutive (inherent) and adaptive (inducible) pathways, with
isolates from metal-contaminated soils consistently showing higher
tolerance than those from uncontaminated agricultural soils.

## Physiological Basis of Metal Tolerance

Fungi are dominant organisms in acidic soils where metal mobility is
increased. Their filamentous growth habit and high surface-area-to-mass
...
and can substitute for potassium in enzymes with deleterious results.

## Intracellular Detoxification Strategies
