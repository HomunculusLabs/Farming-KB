...
**Scientific:** "The placing together of plants having complementary physical demands."

**Living/spiritual:** "The growing together of all those elements and beings that encourage life and growth: the creation of a microcosm that includes vegetables, fruits, trees, bushes, wheat, flowers, weeds, birds, soil, microorganisms, water, nutrients, insects, toads, spiders, and chickens."

Companion planting is still an experimental field. The age of the plants involved, the percentage of each type, and their relative proximity can all be critical. It should be used with some caution and much observation.

## Categories of Companion Planting

### Health — Better Growth

- **Green beans and strawberries** thrive better together than separately.
- **Bibb lettuce and spinach** — grow one spinach plant for every four Bibb lettuce.
- **Onions, garlic, chives, and shallots** seriously inhibit peas and beans.
- **Bush beans and beets** — no particular advantage or disadvantage.
- **Pole beans and beets** — do not get along well.
- **Tomatoes** are narcissists — prefer to be grown alone in compost made from tomato plants.
...
### Nutrition — Companion Planting Over Time (Crop Rotation)

Agricultural recycling through three stages:

1. **Heavy feeders** — Most vegetables we eat (corn, tomatoes, squash, lettuce, cabbage). They take large amounts of nutrients, especially nitrogen.

2. **Heavy givers** — Nitrogen-fixing legumes (peas, beans, alfalfa, clover, vetch, fava beans). Fava beans also excrete substances that help eradicate tomato wilt organisms.

3. **Light feeders** — All root crops (to give the soil a rest). Note: potatoes consume large amounts of nitrogen despite being root crops — functionally a heavy feeder.

### Nutrition — Companion Planting in Space (Intercropping)

Different plant types can be grown in the same bed simultaneously. Example: corn (heavy feeder), bush beans (heavy giver), and beets (light feeder) intermingled.

**Spacing formula:** Add the two spacings together and divide by 2. For corn (15 inches) and beets (4 inches): (15 + 4) / 2 = 9.5 inches per plant.

**Easier approach:** Divide the planting bed into separate sections for each vegetable — heavy feeder, heavy giver, and light feeder sections within a bed. Roots extend 1 to 4 feet around each plant, so this is also companion planting in space.
