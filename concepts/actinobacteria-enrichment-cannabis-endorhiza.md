---
title: Actinobacteria Enrichment Cannabis Endorhiza
...
In the ternary plot analysis of the second experiment, Actinobacteria occupied
a position shifted toward the endorhiza vertex, indicating their preferential
representation within root tissues compared to the broader soil community.
This enrichment pattern mirrors that of the Proteobacteria and contrasts
sharply with Acidobacteria, which decline dramatically upon entry into the
endophytic compartment.

## Ecological Roles of Endophytic Actinobacteria

Actinobacteria are well-documented producers of bioactive secondary
metabolites. Within the endorhiza, they contribute several functions:

- **Antibiotic production**: Many Actinobacteria genera (particularly
