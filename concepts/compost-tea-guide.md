...
| Finely chopped oat straw | Fungi | Small handful |
| Soybean meal | Bacteria | 1 Tbsp |

### Water
- Dechlorinated: let tap water sit 24 hrs, aerate, or use well/rain water
- Chlorine and chloramines kill beneficial organisms
- Temperature: 65-75°F (18-24°C) — colder slows growth, hotter risks anaerobic

## Brewing Process

1. Fill brewer with dechlorinated water
2. Start air pump — water must be actively bubbling BEFORE adding anything
3. Add compost in mesh bag — do NOT squeeze the bag
4. Add food resources (molasses, kelp, fish hydrolysate)
5. Brew 24-36 hours. Bacterial teas peak at 18-24h; fungal teas benefit from 24-36h
6. Monitor DO: must stay above 6 ppm throughout. If DO drops below 5.5 ppm, increase aeration or reduce food
7. Use immediately after brewing — biology peaks then declines

## Application

### Soil Drench
- **Vegetables/annuals**: 20 gal/acre, every 10-14 days
...
- Start 2 weeks before bud break for trees
- Spray at dusk or early morning — UV kills microbes on leaf surfaces
- Drench foliage and stems thoroughly
- Do NOT spray when bees are pollinating

### Disease Response
- Apply immediately when disease detected
- Repeat every 3-5 days until controlled
- Then resume every 10-14 days maintenance schedule
...
Ingham recommends microscope assessment at 400x magnification:

| Organism | What to Look For | Desired Range |
|----------|-----------------|---------------|
| Total bacteria | Small rods, cocci, dots | 100-1000 µg/g |
| Active bacteria | Bright, moving | 10-150 µg/g |
| Total fungi | Hyphae (diameter >2.5µm = beneficial) | Varies by crop |
| Active fungi | Bright, branched hyphae | 10-200 µg/g |
