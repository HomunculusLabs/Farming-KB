...
Weeds are pioneer species adapted to disturbed soil. They are nature's first responders to bare ground, compaction, and nutrient imbalances. Observing which weeds dominate can reveal soil conditions:

| Dominant Weed | Soil Condition |
|---------------|---------------|
| Dandelion | Compacted soil, low calcium |
| Plantain | Compacted soil, low calcium and phosphorus |
| Lamb's quarter | Rich, high-nitrogen soil |
| Pigweed | Rich, cultivated soil |
| Purslane | Warm, moist, fertile soil |
| Bindweed | Compacted, low-phosphorus soil |
| Thistle | Compacted, poorly drained soil |
| Clover | Low-nitrogen soil |
| Nettle | Rich, moist, high-nitrogen soil |
| Sorrel | Acidic soil |

Weeds are indicators, not enemies. They tell you what the soil needs. See [[soil-food-web]] for soil assessment and improvement.

### The Weed Seed Bank

Soil contains a bank of dormant weed seeds that can persist for decades. Tilling brings buried seeds to the surface where light and temperature fluctuations trigger germination. This is why tilled soil always produces more weeds.

- **Seed longevity**: Some weed seeds remain viable for 5-40+ years (pigweed: 40 years, lambsquarter: 40 years, purslane: 40 years, bindweed: 50+ years)
- **Annual weeds**: Depend on seed production for survival. Preventing seed set is the most effective long-term control.
- **Perennial weeds**: Reproduce by seed and vegetative structures (rhizomes, taproots, stolons). Require different strategies than annual weeds.

## Manual Weed Control

### Hand Pulling

The simplest method. Most effective when weeds are small and the soil is moist.

- **Best for**: Annual weeds with shallow roots (chickweed, pigweed, lambsquarter)
- **Technique**: Grasp the weed at the base and pull steadily. For tap-rooted weeds (dandelion, plantain), use a dandelion fork or trowel to loosen the root before pulling.
- **Timing**: Weed after rain or irrigation when soil is soft. Pull before weeds set seed.
- **Tools**: Hori hori (soil knife), dandelion fork, trowel, gloves

### Hoeing

Effective for weeds in rows and pathways. Disturbs only the top inch of soil, minimizing new weed germination.

- **Best for**: Small annual weeds between crop rows
- **Types of hoes**:
  ...
  - **Wheel hoe**: Push-pull hoe mounted on wheels; efficient for larger gardens (see [[no-till-methods]])
...
- **Timing**: Flame weed before crop emergence (stale seedbed technique) or between crop rows with a shielded torch. Do not flame near dry mulch or flammable materials.
- **Safety**: Keep a fire extinguisher or water source nearby. Never flame in windy or extremely dry conditions. Check local regulations regarding open flames.
- **Effective against**: Pigweed, lambsquarter, purslane, chickweed, crabgrass, and other small annuals
- **Not effective against**: Established perennial weeds (bindweed, quackgrass, thistle)
...
- **In regenerative systems**: Tilling is avoided in favor of [[no-till-methods]]. If tilling is used for initial bed preparation, follow immediately with heavy mulching to suppress the germinated weeds.
...
Solarization uses the sun's heat to kill weed seeds, soil-borne pathogens, and nematodes by covering moist soil with clear plastic during hot weather.
...
| Temperature | Effect |
|------------|--------|
| 100°F (38°C) | Suppresses some weed seeds and soil pathogens |
| 110°F (43°C) | Kills many annual weed seeds and some soil-borne pathogens |
| 120°F (49°C) | Kills most weed seeds, soil-borne pathogens, and nematodes in the top 2-4 inches |
| 130°F+ (54°C+) | Kills virtually all weed seeds and soil organisms in the top 4-6 inches |
...
Sheet mulching smothers existing vegetation and weed seeds under multiple layers of organic material. It is the primary weed-control method in [[no-till-methods]] systems.
...
3. **Compost layer**: Spread 2-4 inches of compost or well-rotted manure over the cardboard.
4. **Mulch layer**: Add 4-8 inches of straw, leaves, or wood chips on top.
5. **Plant**: Cut holes through the mulch and cardboard to plant directly into the compost layer.

### Effectiveness

- Kills existing annual and perennial weeds by excluding light (takes 2-6 months for complete kill)
- Prevents new weed seed germination from the buried seed bank
- Builds soil as the layers decompose
...
- See [[no-till-methods]] for integrating sheet mulching into no-till systems
...
- See [[cover-crops-guide]] for selection and management
