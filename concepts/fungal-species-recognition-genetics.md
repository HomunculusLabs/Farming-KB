...
# Fungal Species Recognition and Genetics

Fungal species recognition encompasses both traditional phenotypic methods and modern molecular approaches. The application of phylogenetic species recognition (PSR) alongside biological species recognition (BSR) has revealed significant complexities in [[fungal-species-concept-and-taxonomy]], hybridization, and biogeography.
...
This tension between phenotypic and genotypic approaches is central to [[fungal-species-concept-and-taxonomy]] and has practical implications for ecological studies that depend on accurate species identification.

## Phylogenetic vs. Biological Species Recognition: Neurospora Case Study

A landmark study by Dettman et al. (2003b) compared PSR and BSR in the genus Neurospora using combined analysis of DNA sequences from four anonymous nuclear loci (TMI, DMG, TML and QMA loci, 2141 aligned nucleotides). Key findings:

- PSR and BSR were largely concordant, with most phylogenetic species corresponding to biological species.

- However, some strains originally identified by traditional mating tests to a species did not match phylogenetic identification, marked by asterisks in the study.

- The tree showed distinct clades for N. crassa, N. intermedia, N. discreta, and N. tetrasperma lineages.

- Branch support values were generated using both maximum parsimony bootstrap proportions and Bayesian posterior probabilities.

## Geographic Patterns and Reproductive Isolation

A critical finding was that hybrid mating success varied with geographic origin. Hybrid matings of sympatric Neurospora pairs were significantly less successful than those of allopatric pairs. This means species are kept reproductively isolated either by geographic distance in allopatry or by genetic reinforcement of species barriers in sympatry.

The inability to find natural hybrids implies that hybrid matings either do not occur or do not produce successful progeny under natural conditions. Selection against hybridization favors individuals that can recognize and abort hybrid matings, reinforcing reproductive isolation in sympatry over geologic time scales. These patterns have significant implications for understanding [[fungal-fungal-community-assembly]] across geographic regions.

## Implications for Disturbed Environments

When allopatric individuals are brought together over human time scales, unreinforced reproductive isolation can be overcome, particularly in disturbed agricultural settings that may be permissive to survival of hybrid progeny. This scenario may explain conflicting species concepts and reports of hybrid individuals from agricultural environments where [[entomopathogenic-fungal-diversity-cordyceps-insect-pathogens]] may undergo rapid evolution.

## DNA-Based Community Analysis

Traditional culture-based methods for assessing [[fungal-diversity-indices-community-analysis]] are now recognized as insufficient, as perhaps only 5% of environmental fungi can be cultivated (Hawksworth, 2001). Culture-independent molecular approaches have advanced understanding considerably:
...
Understanding fungal species boundaries has profound implications for [[fungal-wildlife-disease-conservation-biology]], biogeography, and applied mycology. The geographic pattern of reproductive isolation reinforcement in sympatry suggests that fungal communities in different geographic regions may have distinct evolutionary trajectories.

Molecular approaches continue to reveal hidden diversity and reshape understanding of [[fungi-in-the-environment-soil-fungal-community-structure]], particularly in understudied habitats like rocks, minerals, and extreme environments. Accurate species recognition is foundational for [[fungal-ecosystem-indicator-species]] and for assessing the impacts of environmental change on fungal biodiversity.

## DNA Barcoding Methods

### ITS Region (Internal Transcribed Spacer)
The ITS region, spanning ITS1, the 5.8S rRNA gene, and ITS2, was formally proposed as the universal fungal barcode by Schoch et al. (2012). The ITS region sits between the 18S (SSU) and 28S (LSU) ribosomal RNA genes and evolves rapidly enough to discriminate among most fungal species. ITS1 and ITS2 flanking regions accumulate mutations faster than the conserved 5.8S gene, providing species-level resolution. Standard primer pairs include ITS1/ITS4 (White et al., 1990) for the full region, and ITS1F/ITS2 (Gardes and Bruns, 1993) which are biased toward Basidiomycota and Ascomycota while excluding many Chytridiomycota and Glomeromycota. The ITS region is amplified and sequenced in a single PCR reaction, making it cost-effective for high-throughput applications. However, intragenomic variation (multiple ITS copies within a single genome) can complicate species delimitation, particularly in genera with large genomes like [[psilocybe-mushroom-species-guide]].
...
The SSU region is the most conserved of the ribosomal RNA genes and provides resolution primarily at the phylum to order level. While insufficient for species identification in most groups, SSU is valuable for broad-scale community surveys, for detecting novel deep-branching fungal lineages, and for identifying the major taxonomic groups present in environmental samples. SSU primers (e.g., NS1/NS8, FR1/FF390) have broad coverage across the fungal kingdom and are used in studies of [[biodiversity-fungi-soil-fungal-communities]] where the goal is community profiling rather than species identification. SSU is also used for detecting protozoan and metazoan contaminants in fungal cultures.

### RPB2 (RNA Polymerase II Second Largest Subunit)
RPB2 is a protein-coding gene that provides independent phylogenetic signal from ribosomal RNA genes. It has become the most widely used single-copy protein-coding marker for fungal phylogenetics at the species to genus level. RPB2 evolves at an intermediate rate between ITS and SSU, and its protein-coding nature means that synonymous and non-synonymous substitutions can be analysed separately, providing additional phylogenetic information. Multi-locus sequence typing (MLST) combining RPB2 with TEF1-alpha, beta-tubulin, and ITS has become the gold standard for species delimitation in many fungal genera. The primary limitation of RPB2 is difficulty of amplification -- the gene is approximately 1.2 kb and contains introns of variable length, requiring taxon-specific primers for many groups.

## Morphological vs. Molecular Identification

The tension between traditional morphological identification and modern molecular methods is central to [[fungal-species-concept-and-taxonomy]]. Morphological identification relies on macroscopic features (cap colour, size, shape, spore print colour, habitat) and microscopic features (basidium morphology, spore size and shape, cystidia, hyphal structure). This approach has served mycology for centuries and remains essential for field identification, ecological surveys, and the vast majority of practical mycological work.
...
Cryptic species are morphologically indistinguishable but genetically distinct lineages that do not interbreed. Molecular methods have revealed cryptic species throughout the fungal kingdom. In the genus [[psilocybe-mushroom-species-guide]], for example, what was once considered a single widespread species often proves to be a complex of several geographically restricted species with different psilocybin and psilocin profiles. Similarly, the medically important genus Candida contains numerous cryptic species with different antifungal susceptibility profiles, making molecular identification clinically essential.

The discovery of cryptic species has practical implications for [[fungal-ecosystem-indicator-species]], biosecurity, and conservation. If what appears to be a single widespread species is actually a complex of narrow endemics, each with different ecological requirements, then the conservation status of each cryptic species may be quite different from the apparent status of the morphospecies.
...
A herbarium voucher is a preserved physical specimen that serves as a permanent reference for a DNA sequence or species identification. Best practice in [[fungal-biodiversity-conservation-status]] and taxonomy requires that every DNA sequence be linked to a voucher specimen deposited in a recognised herbarium. Vouchers provide several critical functions: they allow future researchers to verify or re-examine the identification, they preserve morphological information that DNA alone cannot capture, and they serve as a physical record of biodiversity at a specific place and time.

For fungi, vouchers are typically dried fruiting bodies stored in sealed containers with silica gel, or preserved in liquid nitrogen for DNA-quality tissue. The voucher should include collection metadata: date, location (GPS coordinates), habitat, substrate, collector name, and any associated field notes. Voucher specimens should be deposited in a recognised herbarium (e.g., Kew, Geneva, Oslo, New York Botanical Garden) and assigned an accession number that is cited in any publications referencing the specimen. Without vouchers, DNA sequences become orphaned data that cannot be verified or re-interpreted as taxonomic understanding evolves.
