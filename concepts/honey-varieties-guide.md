...
A polyfloral blend from mixed meadow and pasture flowers. Color and flavor
vary by region and season — typically amber with a complex, robust taste.
Wildflower honey reflects the local ecosystem and changes year to year.
Popular at farmers markets for its local character.
...
- **Sourwood honey** — Appalachian specialty, light amber, anise-like flavor
- **Sage honey** — very light, slow to crystallize, mild peppery finish
...
Producing true monofloral honey requires strategic hive placement and timing:

1. Place hives in or adjacent to the target monoculture during peak bloom
2. Remove surplus frames before the target flow to make room
3. Harvest supers immediately after the target bloom ends
4. For subsequent flows, add fresh supers to avoid mixing

Pollen analysis is the definitive way to verify monofloral origin, though
taste, color, and region are practical indicators.

## Crystallization

All raw honey crystallizes over time. The rate depends on the ratio of
glucose to fructose — higher glucose means faster crystallization. Varieties
like tupelo and sage crystallize slowly, while clover and rapeseed
crystallize within weeks. Crystallized honey is not spoiled; gentle warming
in a water bath at 95F (35C) reliquefies it without degrading enzymes.

## Selecting Honey for Use

| Use Case | Recommended Variety |
|---|---|
| General sweetener | Clover, wildflower |
| Wound care | Manuka (UMF 10+) |
| Baking | Buckwheat, wildflower |
| Tea and beverages | Orange blossom, clover |
| Cheese pairing | Tupelo, orange blossom |
