...
When rain falls on the hard rock surface of the upper scarp, most water is shed as runoff. It follows gentle valleys behind the scarp and plunges as sudden waterfalls over the cliff ends of the wadis. Just before the water goes over the edge, turbulence scours out deep holes (scour holes) in the upper surface. Water may rush through the system in torrents for 3–4 days after rain, with discharge volume depending on the catchment area.

A curtain of water or rills may fall along the entire scarp face during rain. Over time, this cliff-base seepage undercuts the soft scarp material, enlarging the base caves. In incised sandstone valleys in semi-arid older landscapes, the profile is more complex — a succession of smaller scarps and caves in bedded sandstones or mudstones, with side valleys resembling box canyons and waterfalls appearing as cascades.

After heavy rain, water pours off cliffs and rushes as mixed mud-silt-stone torrents down the wadis. These floods can be devastating, causing fatalities among unwary campers and carrying away badly sited villages and houses. The iron-clad rules for settlement are to keep houses and roads well above valley floors, cut them into the pediment of the scarp itself, or site houses in the base caves of the cliffs.

## Reading Desert Landscape Mosaics

Occupied and fire-managed arid lands present a total mosaic of vegetation. To read such a landscape, a designer must note several key factors:

- **Process**: Whether wind, water, or infiltration is active locally.
- **Rock and Soil Type**: These determine local response to process and produce characteristic landforms.
- **Aspect**: Even slight shading by hills changes opportunities and promotes growth.
- **Fire Frequency**: And the time since the last fire event.
- **Date of Last Heavy Rain**: Rainfall exceeding 12 mm may trigger recruitment of specific age-groups of plants.

## Broader Desert Landform Context

In drylands, erosion landforms are more significant, conspicuous, and numerous in type than in humid areas. The major features include:

- **Mountains** with complex long valleys and sheer-sided gorges.
- **Inselbergs**: Isolated or grouped granitic domes rising steeply from the desert plain.
- **Scarp and Pediment** landscapes of fault-lines, mesas, and wadis (box canyons).
- **Badlands**: Complex eroded softer sediments on unconsolidated areas.
- **Gulches**: Sharp-sided, much-branched gullies on steep slopes.
- **Basin and Range** topography from series of folds, typical of the Great Basin deserts of North America.

True desert has the broad primary landscape pavement classification of **erg** (sandy desert), **hamada** (rock and boulder pavement), and **reg** (gravel surfaces). Erg is further divided into sandplains (near-level sand sheets) and various dune types. Desert landscapes are angular and actively eroding, in contrast to the softer, more rounded outlines of humid areas.
