...
Psilocybin (O-phosphoryl-4-hydroxy-N,N-dimethyltryptamine) has the molecular formula C₁₂H₁₇N₂O₄P, a molecular weight of 284.25 g/mol, and exists as a zwitterion at physiological pH. Its key pharmacokinetic-relevant properties include:
...
- **Primary enzyme**: Cytochrome P450 2D6 (CYP2D6) mediates psilocin hydroxylation to 4-hydroxy-indole-3-acetaldehyde, which is rapidly oxidized to 4-hydroxy-indole-3-acetic acid (4-HIAA)
- **Minor pathways**: CYP1A2, CYP2C19, and CYP3A4 contribute to psilocin oxidation at higher concentrations. Monoamine oxidase A (MAO-A) also oxidizes psilocin, though this pathway is quantitatively less significant than CYP2D6
- **CYP2D6 polymorphisms**: Poor metabolizers (approximately 5–10% of Caucasian populations) show 2–3 fold higher psilocin AUC (area under the curve), resulting in more intense and prolonged effects. Ultra-rapid metabolizers may experience attenuated effects

#### Phase II: Conjugation

- **Glucuronidation**: The predominant elimination pathway. Psilocin is conjugated to psilocin-O-glucuronide by UDP-glucuronosyltransferases (UGT1A9 and UGT1A10 are the primary isoforms). Glucuronidation occurs primarily in the liver, with minor intestinal contribution
- **Glucuronide properties**: Psilocin-O-glucuronide is pharmacologically inactive (does not activate 5-HT2A receptors), water-soluble, and readily excreted in urine
- **Sulfation**: Minor pathway via sulfotransferases (SULT1A1), producing psilocin-O-sulfate. This metabolite is also inactive

### Metabolic Interindividual Variability

The most significant source of interindividual variability in psilocybin pharmacokinetics is CYP2D6 polymorphism:

- **Poor metabolizers (PM)**: 5–10% of Caucasians, 1–3% of East Asians. Higher plasma psilocin concentrations, more intense subjective effects, longer duration. May require dose reduction
- **Intermediate metabolizers (IM)**: 10–15% of populations. Moderately reduced CYP2D6 activity
