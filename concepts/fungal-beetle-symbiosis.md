...
- **Cactophilic yeasts** associated with *Drosophila*: amelioration of nutritional resources in cactus tissues
...
### The *Pichia stipitis* Clade

Members of this clade have been isolated from multiple wood-boring beetle associations:
...
| *Candida ergatensis* | Cerambycidae in Spain and Peru (xylan hydrolysis capability) |

### Hindgut Compartmentalization

The passalid beetle hindgut is a highly structured microbial habitat:

- *P. stipitis*-like yeasts are positioned along a furrow extending the length of the posterior two-thirds of the hindgut
- The yeast has a unique **holdfast structure** — branched filaments that attach it to the gut cuticle
- This is one of the few yeasts known to possess such an attachment organ
- The anterior third of the hindgut has extreme expansion of internal surface area with hundreds of spines projecting into the lumen, covered by a morphologically diverse bacterial film
- The larval hindgut is much smaller and less differentiated, sparsely populated compared to adults — this may relate to the evolution of **parental care** (adults feed larvae a mixture of frass and chewed wood)

### Broader Hindgut Community

Beyond the *Pichia stipitis*-like yeasts, the *O. disjunctus* hindgut hosts:
- Eccrinid trichomycetes (reported for over 100 years)
- Diverse bacteria
- Amoeboid protists
- Parabasalids

The morphologically distinct compartments segregate several classes of microbes, hypothesized to have functions parallel to those in [[gadd-beetle-gut-fungal-symbiosis]].

## Comparison with Termite-Fungus Associations

The compartmentalized hindgut of passalid beetles shows structural parallels to termite gut systems:
...
### Host Specificity
Yeast–beetle specificity across broad geographical ranges and developmental stages suggests co-evolutionary relationships rather than repeated environmental acquisition. However, the question of whether yeasts have diverged many times with their hosts or are repeatedly acquired from habitat remains open.

### Implications for Beetle Radiation
Key questions about evolutionary dynamics:
- Do yeasts drive rapid radiation of beetle lineages by performing essential services?
- Or do beetle lineages diverge more rapidly when freed of gut yeasts?
- Could the yeast be the primary beneficiary, bathed in undigested nutrients?
