...
Typical degradation levels of 20-50% have been reported in nitrogen-
...
by successive reductive dechlorinations also yielding THB. The key
intermediate THB is also formed by dechlorination of tetrachloro-1,4-
hydroquinone (TCHQ) to trichlorohydroxyquinone by cell extracts of
P. chrysosporium.
...
degradation. Enhanced laccase production was observed in the presence of
2-chlorophenol, suggesting induction by chlorophenolic substrates.

### Field Studies and Soil Remediation
...
The degradation pathway for TCP by P. chrysosporium involves cycles of
peroxidase-catalyzed oxidative dechlorination reactions followed by
quinone reduction reactions. The key intermediate is 1,2,4,5-
tetrahydroxybenzene, which undergoes further degradation to carbon
dioxide. Notably, all three chlorines of TCP are removed prior to ring
cleavage, distinguishing this from some bacterial pathways where
dechlorination and ring cleavage may occur simultaneously.

2,4-Dichlorophenol (DCP), 2,4,5-trichlorophenol, and TCP were all
oxidized by P. chrysosporium to produce corresponding 1,4-benzoquinones.
Valli and Gold showed that DCP degradation involves LiP and MnP at
multiple stages in the pathway, not only during initial oxidation.
