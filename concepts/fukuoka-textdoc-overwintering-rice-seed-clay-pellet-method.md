...
Fukuoka notes that "nature can be a very cruel world" in this regard. However, the enormous quantity of grain that appears wasted serves a critical ecological purpose: providing food for insects and small animals during winter months. "Nature was not so indulgent as to leave enough grain lying around to feed people who just sit and do nothing."

## Modern Rice Cannot Return to Nature

A fundamental complication is that modern rice cultivars have been genetically improved over centuries. They are no longer natural and "can never return to nature." Modern varieties have been bred for traits that suit human cultivation — uniform germination, high yield, disease resistance under managed conditions — but have lost the hardiness that wild rice possessed for surviving natural conditions.

Fukuoka observes that "sowing today's improved seed by a method that approximates nature is unnatural in itself." These plants require some form of protection and human care. Yet using unnatural methods of protection only moves the rice further from nature and evokes "stronger natural repercussions."

The challenge was to find a way to protect seed that worked with nature rather than against it.

## First Solution: Synthetic Resin Coating
...
The clay pellet provides multiple forms of protection:

- **Physical barrier**: The hard clay shell prevents rodents from detecting the seed by smell and makes it difficult for them to access the grain inside
- **Moisture buffer**: Clay absorbs and releases moisture gradually, protecting the seed from both desiccation and waterlogging
- **Temperature moderation**: The clay layer insulates the seed from extreme temperature fluctuations
- **Weight**: Pellets are heavy enough to remain in place through winter rains and winds, preventing seed from washing away or being blown to unsuitable locations
- **Soil contact**: When spring arrives and rains soften the pellets, the clay breaks down and allows the seed to germinate in direct contact with the soil

### Advantages Over Synthetic Coating
