...
### Fruit Set
- **Thinning**: After fruit set (June drop), thin apples and pears: 1 fruit per cluster, 6 inches apart. This prevents biennial bearing and improves fruit size
- **Watering**: Water newly planted trees deeply
- **Pest control**: Check for sawfly larvae on gooseberries. Hand-pick or use approved spray
- **Soft fruit**: Net strawberries as fruit forms (bird protection)
