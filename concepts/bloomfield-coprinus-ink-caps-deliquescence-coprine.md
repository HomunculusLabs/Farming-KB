...
In addition to its aerodynamic function, the ubiquitous umbrella form of the mushroom is essential because it maintains a humid atmosphere around the hymenium while shielding the spores from rain. The combination of the bell shape and the rapid deliquescence makes C. comatus one of the most efficiently spore-dispersing mushrooms in the fungal kingdom.
...
The biochemical mechanism of autodigestion involves the controlled release of enzymes that dissolve the structural polysaccharides of the gill tissue. Unlike the rot caused by bacterial or fungal saprobes, deliquescence is orchestrated by the mushroom itself, triggered by a precise developmental clock. This programmed cell death is one of the most dramatic examples of developmental timing in the fungal kingdom.

## Coprine Toxicity (Coprinus atramentarius)

While the lawyer's wig is edible, the related Coprinus atramentarius contains a dangerous toxin called coprine. Fruiting bodies of C. atramentarius resemble those of C. comatus but are distinguishable to experienced foragers. The danger of C. atramentarius lies in its interaction with alcohol, making it one of the more insidious mushroom toxins because the symptoms manifest only when alcohol is consumed with or after the mushroom.

If alcohol is consumed when this mushroom is eaten, poisoning is evidenced by tingling in the arms and legs, nausea and vomiting, and palpitations associated with a racing heart. The mechanism involves the normal pathway of alcohol metabolism. Normally, the body converts alcohol (ethanol) to acetaldehyde and then metabolizes acetaldehyde into acetate.

Coprine blocks the second stage of this pathway, causing an abnormal accumulation of acetaldehyde in the bloodstream. The symptoms of coprine intoxication are identical to those experienced by individuals who consume alcohol while taking disulfiram (marketed as Antabuse), a prescription drug used to treat alcoholism by making drinking deeply unpleasant.

For some alcoholics, disulfiram is the only medication sufficiently powerful to subvert their relentless addiction, which provides a hint of the ghastliness of coprine intoxication. The severity of coprine poisoning underscores why foragers must exercise particular caution when identifying ink caps, as confusion between edible and toxic species can have serious consequences. Symptoms can persist for hours and may recur with subsequent alcohol consumption for several days after ingestion.

## Other Poisonous Ink Cap Species

Besides C. atramentarius, other members of the genus and related taxa have been associated with poisoning. The genus Coprinus has undergone taxonomic revision, and some species formerly placed in Coprinus have been reassigned to other genera. The broader group of ink-cap mushrooms includes species that vary widely in their edibility and toxicity, making generalizations about the group's safety unreliable.
