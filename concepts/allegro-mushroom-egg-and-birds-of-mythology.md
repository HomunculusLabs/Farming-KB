...
The mushroom's volva — the membrane surrounding the young fungus that remains as a cup at the base of the stem when torn apart — was of profound significance. It was the "womb" from which the phallic stem emerged, and its rounded shape suggested an egg. In Sumerian the same word GUG could mean both "egg" and "nest." When the egg or volva splits into two, one half is left in the ground, the other forced upwards by the expanding stem as a canopy towards the sky.
