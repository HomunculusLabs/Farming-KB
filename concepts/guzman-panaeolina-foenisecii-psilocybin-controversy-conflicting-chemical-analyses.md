...
of research, reveals fundamental challenges in the chemical analysis of fungi and
the reproducibility of psychoactive compound detection.

## The Haymaker's Mushroom

Panaeolina foenisecii (Pers.: Fr.) Maire is a small, brown agaric that fruits
...
These reports span more than two decades and come from independent laboratories
in Europe and North America, using different analytical methods. The consistency
of positive reports from multiple researchers would, under normal circumstances,
be considered strong evidence for the presence of the compound.

## The Case Against Psilocybin

Equally prominent researchers have found no psilocybin in P. foenisecii.
Mantle and Waight (1969) reported negative results. Ott and Guzmán (1976)
also failed to detect psilocybin. Beug and Bigwood (1982), using thin-layer
chromatography, could not find the compound. Stijve (1987) and Stijve et al.
(1984), working with the Nestlé Research Centre in Switzerland, reported
negative results using HPLC. Allen and Merlin (1992c) discussed doubts about
the psychoactive properties of this fungus based on their own analyses.

The quality of these negative reports is significant. Stijve's laboratory was
well-equipped for detecting trace alkaloids, and the use of HPLC (high-performance
liquid chromatography) provided a level of sensitivity and specificity that
earlier TLC-based studies could not match. The failure of such methods to detect
methods to detect psilocybin is strong evidence for its genuine absence in
those particular specimens and analytical conditions.
