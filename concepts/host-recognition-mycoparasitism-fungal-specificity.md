...
parasite to recognize, attach to, and penetrate a suitable
...
relationships between parasite and host, with the
parasite adapting to exploit specific host signaling
or defense pathways.

### Host Group Affiliations

Held's (1981) classification of Rozella species based
on host affiliations demonstrated that mycoparasites
often cluster their host ranges around phylogenetically
related host groups. Parasites of monocentric chytrids,
for instance, differ from those attacking polycentric
or filamentous hosts. This pattern suggests that host
cell wall chemistry, which is partly determined by
phylogeny, plays a major role in determining host range.

## Chemical Mediators of Recognition

### Trisporic Acid

In the Mucorales, the sexual pheromone trisporic acid
and its precursors mediate both mating-type recognition
and, in some cases, mycoparasitic interactions. Some
mycoparasitic mucoraleans exploit the trisporic acid
signaling system of their hosts to locate and recognize
suitable hosts. The parasite may produce trisporic acid
receptors that allow it to respond to host-produced
signals, effectively eavesdropping on the host's
