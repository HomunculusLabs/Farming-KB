...
### Defoliation Effects on Root Exudates
- Grazing reduces photosynthetic leaf area, which directly diminishes
  the quantity and quality of carbon compounds exuded by grass roots
  into the rhizosphere, altering the substrate available to both
  saprobic and mycorrhizal fungi.
- Moderate grazing can stimulate compensatory root exudation as plants
...
- Coprophilous (dung-inhabiting) fungi form a specialized succession
  on fresh herbivore dung, progressing through pioneer, secondary,
  and climax fungal species over 4-8 weeks as the substrate
  progressively decomposes.
- This dung fungal community includes both cosmopolitan species
  (Sporormiella, Saccobolus, Ascobolus) and species restricted to
  dung of specific herbivore groups, making spore analysis of
  sediment cores a valuable tool for reconstructing historical
  herbivore populations and grazing intensity.

### Soil Compaction and Physical Disturbance
- Trampling by large herbivores compacts surface soil layers, reducing
