---
title: Wood Decomposition by Fungi
created: 2026-04-19
updated: 2026-04-19
type: concept
tags: [mycology, fungi]
...
- **Cellulose** (40-50%) -- linear polymer of glucose with crystalline and amorphous regions
...
### White Rot Fungi
White rot basidiomycetes are the only organisms capable of substantial lignin degradation. They remove both lignin and cellulose, often simultaneously, leaving the wood bleached and fibrous. Key species include Phanerochaete chrysosporium, Trametes versicolor, Pleurotus ostreatus, and Bjerkandera adusta. Their [[lignin-degradation-mechanisms-wood-rot-fungi]] involve the [[fungal-ligninolytic-enzyme-systems-overview]].

### Brown Rot Fungi
Brown rot fungi primarily degrade cellulose and hemicellulose while leaving lignin largely intact. The wood becomes brown and crumbly as the carbohydrate components are removed. Brown rot fungi use a non-enzymatic Fenton reaction (H2O2 + Fe2+ produces hydroxyl radicals) to depolymerize cellulose before enzymatic attack. Key genera include Serpula, Postia, and Gloeophyllum.
...
2. **Enzyme secretion** -- once established, fungi secrete [[fungal-extracellular-enzymes]] tailored to their decay type
...
- **Wood species** -- heartwood of durable species (cedar, redwood, oak) contains extractives that resist fungal attack; sapwood is generally more susceptible
- **Moisture content** -- decay requires moisture above the fiber saturation point (approximately 25-30%); wood below 20% moisture is essentially immune to decay
- **Temperature** -- most decay fungi grow between 50-95F (10-35C); optimal around 75-85F (24-29C)
- **Oxygen** -- fungi are aerobic; waterlogged wood (anaerobic) resists decay
...
Wood decomposition by fungi:
- Releases nutrients locked in woody biomass back into the soil for plant uptake
- Drives the global carbon cycle (approximately 80 billion tons of carbon stored in forest biomass)
