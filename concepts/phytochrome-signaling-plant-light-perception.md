...
syndrome (SAS). When a plant detects a reduction in the red-to-far-red light
ratio — as occurs when neighboring vegetation filters or reflects light,
preferentially absorbing red photosynthetically active radiation while
transmitting far-red wavelengths — it initiates a suite of developmental
changes designed to outcompete neighbors for light. These include rapid stem
and petiole elongation, upward leaf orientation (hyponasty), reduced leaf
development, accelerated flowering, and reduced branching.
