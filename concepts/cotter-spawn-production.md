---
title: Spawn Production for accessible-mushroom-cultivation-for-disabilities
created: 2026-04-25
updated: 2026-05-09
type: concept
...
- Vulnerable to insect predation; avoid using outdoors where insects
  are present
- Rye grain is often preferred for its size, moisture retention, and
  nutrient profile
### Sawdust Spawn
The cheapest form of spawn and preferred by commercial growers for outdoor
applications:
- Made from hardwood sawdust supplemented with wheat or rice bran
  (~5% dry weight) for additional nitrogen
- Lower nutrition than grain but far less attractive to pests
- Ideal for outdoor log and stump inoculation
- Excellent for outdoor cultivation where insect pressure is a concern
- Can be sterilized or pasteurized depending on the application
- Provides slower but more sustained colonization of woody substrates
### Plug Spawn
5/16-inch birch dowels, typically 1 inch long, with grooves cut into them
for improved mycelium grip:
- Designed specifically for outdoor log and stump cultivation
- Inoculated by hammering into drilled holes (1-1.5 inches deep, using a
  5/16-inch bit)
- Sealed with food-grade wax after insertion to prevent drying and
  contamination
- Convenient for small-scale outdoor projects; easy to ship and store
- Slower to colonize than grain or sawdust spawn but very reliable
### Liquid Spawn
A newer approach gaining popularity among home cultivators:
