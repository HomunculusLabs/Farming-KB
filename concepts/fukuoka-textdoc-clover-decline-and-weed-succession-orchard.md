---
title: Clover Decline and Natural Weed Succession in Orchard Ground Cover
created: 2026-04-28
tags:
  - fukuoka
  - ground-cover
...
Masanobu Fukuoka observed that white clover (Trifolium repens), when established as a ground cover in citrus orchards, follows a predictable lifecycle of establishment, dominance, gradual decline, and replacement by a diverse community of weeds and vegetables. This natural succession process, rather than being a problem to be corrected, is an essential mechanism of soil enrichment and orchard health. Fukuoka's approach to ground cover management embraces succession as a positive force rather than fighting it with herbicides or repeated reseeding.
...
The contrast between Fukuoka's approach and conventional orchard soil management is stark. Conventional methods rely on chemical analysis to identify deficiencies (acidity, nutrient levels, micronutrient availability) and apply corrective amendments such as lime, phosphate, or micronutrient fertilizers. Fukuoka noted that even adjusting soil acidity is fraught with difficulty: applying lime to correct acidity can lead to manganese and zinc deficiency, while allowing alkalinity to develop creates its own set of problems. Each chemical correction risks creating a new imbalance that demands yet another correction.

Fukuoka's natural approach, using cover crops and weed succession, addresses soil health holistically:
