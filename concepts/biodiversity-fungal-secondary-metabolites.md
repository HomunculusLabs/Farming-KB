...
Polyketides are synthesized by polyketide synthase enzymes and include many
clinically important compounds. Non-ribosomal peptides are assembled by large
multienzyme complexes without messenger RNA templates, allowing incorporation
of non-proteinogenic amino acids that confer unique bioactivities. Terpenes,
derived from isoprenoid precursors, represent the largest class of natural
products and include compounds with potent biological activities.

## Ecological Functions

Fungi produce secondary metabolites as adaptations to their ecological niches.
These compounds function as chemical weapons in competition with other
microorganisms, as deterrents against herbivores, and as signaling molecules
in complex microbial communities. Foster (1949) argued that secondary
metabolites produced under high-nutrient isolation conditions are indicative of
stress, suggesting production is fundamentally a response to environmental
challenges.
