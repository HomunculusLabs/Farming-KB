---
title: Bill Mollison Permaculture A Designers Manual Climatic Factors In Design
source: bill-mollison-permaculture-a-designers-manual.md
source_author: Bill Mollison
category: permaculture
tags: [climate, weather, microclimate, solar-radiation, wind, precipitation, temperature]
mined: 2026-05-10
---
...
Chapter 5 of Mollison's manual establishes climate as the primary determinant of design strategy. Before any planting, earthworks, or structure is placed, the designer must thoroughly understand the climatic context of the site. Climate dictates what can grow, how water moves through the landscape, what structures are needed, and what strategies will succeed. Permaculture design works with climate rather than against it, using the patterns of sun, wind, rain, and temperature to inform every decision.

## Global Weather Systems

### The Engine of Climate

Global weather patterns are driven by differential solar heating of the Earth's surface. The equator receives more direct solar radiation than the poles, creating temperature gradients that drive atmospheric circulation:

- **Hadley cells** — warm air rises at the equator, moves poleward at altitude, cools and descends at approximately 30° latitude, creating the subtropical high-pressure zones and major deserts
- **Ferrel cells** — mid-latitude circulation driven by the interaction of Hadley and polar cells
- **Polar cells** — cold dense air descends at the poles and flows equatorward at the surface
...
Latitude fundamentally shapes the design approach:

- **Tropical (0-23.5°)** — minimal seasonal variation; design for year-round production, heavy rainfall, and intense sun
...
### Temperature Zones on Site

Every site has a temperature gradient influenced by topography, vegetation, and water:

- **Frost valleys** — cold air drains downhill and collects in low points; avoid for frost-sensitive species
- **Thermal belts** — the mid-slope position where cold air has drained past but warm rising air creates a local warm zone; premium site for houses and sensitive crops
- **Ridgetop exposure** — exposed to both wind and cold; suitable only for hardy species and wind generators
