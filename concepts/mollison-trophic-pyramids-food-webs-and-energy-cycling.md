...
A figure often used to explain how much of a food or forage is needed
to grow another animal is the trophic pyramid. While the pyramid is a
useful concept, it is very simplistic, and in all but laboratory
conditions or feed-lot situations, it is unrelated to field reality.

The pyramid is often used to support claims that we should all become
vegetarians or herbivores. This is perhaps not so far from the truth,
but there are real-world factors to consider that complicate this
simplistic model.
...
If a fish at level 4 of a trophic pyramid is a carp more than a year
or two old, it has probably reached full size, although it may
continue to live for another 80-100 years. The carp (at 80 years old
and 10 kg weight) has eaten enormous quantities of frogs and insects,
and has returned most digested material per year to the pond to grow
more herbage. In order to keep the system in growth, we must be able
to efficiently crop any level just before maturity is reached.
...
Deer, rabbits, sheep, and herbivorous fish are very useful to us, in
