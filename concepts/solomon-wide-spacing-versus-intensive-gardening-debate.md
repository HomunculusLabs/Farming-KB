...
The clover component is particularly valuable, as it fixes atmospheric nitrogen that becomes available to subsequent vegetable crops when the sod is turned under. The grass component contributes massive amounts of organic matter through root decay, improving soil structure and water-holding capacity more effectively than surface compost applications.

## Tools for Low-Input Row Gardening

Solomon's wide-spacing approach has direct implications for garden tool selection. Because the plants are arranged in conventional rows with generous spacing between them, standard long-handled tools become practical and efficient. He favors a digging fork over a spade for initial bed preparation, a sturdy hoe for weed control between rows, and a rake for seedbed finishing. These tools are inexpensive, durable, and require no fuel or electricity to operate.
