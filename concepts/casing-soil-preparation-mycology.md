---
title: Casing Soil Preparation Mycology
...
|-----------|-----------------|------|
| Peat      | 10              | Moisture retention, acidity |
| Vermiculite | 5             | Aeration, water buffering |
| Limestone (Marl) | 2        | pH buffering to 7.0–7.5 |

### Ingredient Notes

- **Peat**: Sphagnum peat moss is standard. Its natural acidity (pH 3.5–4.5) requires buffering with limestone
- **Vermiculite**: Expanded mica that absorbs and releases water. Grade 3 (horticultural) is appropriate
- **Limestone (Marl)**: Calcium carbonate source. Agricultural lime or crushed limestone works. Do not use hydrated lime as it raises pH too aggressively

## Preparation Steps

### 1. Dry Mixing

Combine all ingredients in their dry form in a large container. Mix thoroughly to ensure even distribution of the limestone throughout the peat-vermiculite matrix.

### 2. Hydration

While stirring continuously, add water gradually. The goal is maximum water retention without creating mud. Test by squeezing a handful:

- **Correct**: Holds shape when squeezed, releases only a few drops of water
- **Too dry**: Crumbles apart, no water released
- **Too wet**: Water streams out, muddy texture

If the casing becomes too wet, add more of the dry ingredient mix to absorb excess moisture.
