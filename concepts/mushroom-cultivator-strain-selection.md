---
title: Strain Selection and Development in The Mushroom Cultivator
created: 2026-04-21
updated: 2026-04-21
type: concept
tags: [gardening]
...
Strain selection is one of the most important skills in mushroom cultivation. Wild mushroom strains must be selectively developed through careful observation and propagation. The Mushroom Cultivator provides detailed guidance on identifying superior mycelial types, sectoring, strain preservation, and creating hybrid strains.
...
- Individual spores are isolated and germinated separately
- Used for studying mating characteristics and crossing monokaryotic strains
- More technically demanding; multispore germinations generally suffice for most cultivators
- Useful for controlled breeding programs and genetic studies
...
Rhizomorphic mycelia run faster, form more primordia, and yield more mushrooms than cottony mycelia. In a single wedge transfer producing both types, the strandy sector forms abundant primordia while the cottony sector does not -- a common event in agar culture.
...
3. **Limit mycelial expansion** -- only grow the amount needed for spawn production; return strain to storage when not in use. After many transfers, a sub-strain may be selected that distantly resembles the original
