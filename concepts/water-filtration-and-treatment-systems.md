---
title: Water Filtration and Treatment Systems
...
A range of treatment techniques can be applied depending on water quality and intended use. These methods are often combined in series for greater effectiveness:

- **Aeration** — Oxygenation achieved through wind action, mechanical devices, turbulence, trickle columns, vegetation, phytoplankton, or directly injected air. Aeration supports aerobic bacterial activity essential for breaking down organic matter.
- **Settling** — Spreading flow across still-water ponds or rush beds allows suspended particles to settle by gravity, reducing turbidity and suspended solids.
- **Skimming and Sieving** — Physical removal of floating debris and larger particulates before finer treatment stages.
- **Filtration** — Passage through sand beds, charcoal-fibre columns, natural soils, or aquatic plant root zones to remove fine particles and dissolved contaminants.
- **Coagulation and Flocculation** — Chemical coagulants such as lime, salt, or ferric sulphates cause fine particles to clump together. Organic alternatives include bacterial gels that achieve similar results without chemical inputs.
...
Trickle filters pass water through sand or gravel beds that support resident bacterial colonies. These bacteria metabolise surplus nutrients, particularly nitrogen compounds, effectively cleaning the water. Freshwater mussels perform a similar function in less polluted environments, filtering up to 100 litres per day individually. Mussels digest bacteria and deposit wastes in the mud base, but they are sensitive indicators: they die at pH 5.5 and are highly sensitive to pesticides such as Dieldrin.
...
The most effective approach combines multiple treatment stages in sequence:

1. **Trickle filters of loose pebbles** (2.5–10 cm) — initial biological treatment
2. **Bacterial surface layer** — nutrient removal by established microorganisms
3. **Sand filter** — physical filtration of fine particles
4. **Watercress bed** — additional biological polishing and nutrient uptake
5. **Active carbon column** — final chemical adsorption, composed of approximately 10% active carbon and 90% silicon dioxide (sourced from burnt rice, oat, or wheat husks)
