---
title: Fungal Biodiversity Estimation
...
- **Microscopic species**: Many fungi are found only by examining leaves, wood, soil, and other substrates under a microscope. They produce no visible structures and are effectively invisible to conventional survey methods.
- **Culturing requirements**: Some fungi can be detected only by isolating and culturing them until they sporulate, a process that requires specific media, temperatures, and expertise. Many fungi do not grow readily in culture or remain sterile when they do.
- **Pleomorphy**: Some fungi have more than one sporing stage in their life cycles (so-called pleomorphic fungi), and only one stage may be found at any given time. Historically, different stages were given separate scientific names, causing confusion.
- **Hidden lifestyles**: Many fungi live inside plant tissues (endophytes), within arthropod bodies, or as dormant resting spores in soil, making them invisible to standard collecting methods.
- **Isolation challenges**: Fungi isolated from soil may not have been actively growing there but present only as resting spores awaiting suitable substrata. Culture-dependent methods may significantly bias diversity estimates.

## Methods for Fungal Inventory
...
Environmental DNA (eDNA) metabarcoding has revolutionized our understanding of fungal diversity:

- High-throughput sequencing of fungal ITS (Internal Transcribed Spacer) regions from environmental samples (soil, water, air, plant tissue) can detect thousands of fungal taxa in a single sample.
- Studies have revealed that the vast majority of fungal DNA sequences recovered from the environment do not match any described species — they belong to the "dark taxa" of unknown fungi.
