...
1. In fall, when seed heads are fully developed and fall off easily

2. Use a canoe or plant within arm's reach of shore

3. Use a stick to tap seed heads into a basket

4. Lay out to dry in sun for at least one day

## Processing (Parching)

1. Parch in a cast iron pot over a wood fire

2. Stir continuously until seeds change from green to a darker color

3. Takes a couple of hours

4. Cook with 3 cups water for every 1 cup of rice

## Traditional Method

Native Americans traditionally harvested wild rice by canoe, using knocking sticks to thresh the ripe grain into the boat.
