...
**Sources:** Car exhausts (leaded petrol), lead paint, pipes, battery burning

**Worst cases:** Urban areas with older buildings, where lead can reach **1,100 ppm**. Lead is both taken up by vegetables and dusted onto their surfaces.
...
**Sources:** Historical orchard, canefield, and plantation use (banana, pineapple, cotton, tobacco)

**Key concern:** If you buy or inherit an old orchard or plantation, it is unlikely that any animal product (milk, eggs, meat) will be free of high biocide levels.
...
**Sources:** Orchard sprays (fungicides), historical pesticide applications

**Behavior in soils:**

- Copper and lead stay at or near the soil surface in high concentrations
- Arsenic may remain at the surface in clay soils or wash down to subsoil (50–60 cm deep) in acid sands
- Leaching from clays or organic profiles (10–20 cm) is unlikely
- Phosphate application may dislodge arsenic to deeper levels

**Toxicity concerns:**

- Copper in pasture plants under orchards can reach **50 ppm** (poisonous to sheep)
...
4. **Soil-plant-nutrient interactions are complex** — heavy use of macronutrient fertilizers can cause micronutrient deficiencies; nutrition is rarely considered in plant breeding programmes

### Individual Variation

People vary significantly in their ability to metabolize and tolerate foods:

- **Food allergies** are real and may arise from limited exposure to certain food groups in racial history
- **Body weight** affects dosage per kilogram — the same substance can have different metabolic effects on two people of equal weight depending on body composition
- **Testing for ill effects** can be done by eliminating foods experimentally and observing symptoms

### Practical Health Guidelines

The sane procedure:

1. Maintain basic hygiene (public, personal, domestic)
...
6. Maintain a positive, cheerful outlook

## Municipal Water Supply Concerns

Several substances may be added to town water supplies, including:

- **Chlorine** — forms carcinogenic chloroform
- **Fluorine**
