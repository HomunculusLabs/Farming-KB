---
title: PF TEK Low Humidity Symptoms and Remediation
tags: [pf-tek, humidity, troubleshooting, fruiting, terrarium, mycology]
date: 2026-04-28
updated: 2026-04-28
sources:
...
during the fruiting phase of PF TEK cultivation. The mushrooms need to bathe in a
...
This is NOT contamination. The white fuzzy growth on caps is perfectly good mycelium
and does not detract from the mushroom quality in any way. The mushroom is still
...
cap surface becomes dry enough to trigger aerial mycelium growth in an attempt to
...
The fruiting bodies may grow in twisted, bent, or otherwise abnormal patterns. Caps
may develop asymmetric shapes, and stems may curve or twist rather than growing
straight upward toward the light source.

These deformities result from the mushroom tissue drying out at the growing edges,
...
Increase both spraying frequency and volume. Ensure the terrarium lid is seating
properly with no air leaks that could allow humidity to escape. Check that all
inside surfaces are foggy or dripping with water after spraying, as these moist
surfaces contribute to ongoing humidity generation.

## Symptom 3: Convoluted Growth

### Appearance

Convoluted, twisted mushrooms with excessive undulation in the caps and stems
indicate moderate to severe humidity stress. The growing tissue is struggling to
expand evenly in a dry environment.

The cap margins may warp and curl in unusual directions, and the overall appearance
is one of developmental struggle rather than healthy, vigorous growth. This symptom
represents a more serious humidity deficiency than simple fuzziness or minor
deformities.

### Diagnosis

Convoluted growth can also be associated with abortive mushrooms, but when it appears
across multiple fruiting bodies simultaneously on different cakes, environmental
...
Review the entire humidification system comprehensively. Check spray bottle nozzle
performance to ensure it produces a fine, forceful mist. Verify the spray shield is
...
Withering mushrooms and primordia that dry out and shrivel represent the most severe
stage of humidity deficiency. At this point, the fruiting bodies are losing water
faster than they can absorb it from either the substrate or the air.
