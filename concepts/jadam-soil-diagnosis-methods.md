---
title: JADAM Soil Diagnosis Methods
created: 2026-04-18
updated: 2026-04-18
type: concept
tags: [jadam, soil, fertility, research-methods]
sources:
...
- Root cause: compacted layer traps water that evaporates, leaving salt behind

JADAM's diagnosis: if you can dig 15cm down and hit hardened soil, you have the compaction problem that causes salinization. Eliminate the compaction layer and salt accumulation stops naturally.

## The Winter Frost Test

After snowfall, dig beneath the snow in different areas:
- If soil beneath snow has not frozen: good soil health (microbial activity and organic matter generate heat and insulate)
- If soil is frozen solid: poor soil health, low organic matter, compacted

## Post-Rain Observation

After rainfall, observe how water behaves:
- Water soaks in quickly: good soil structure, no compaction
- Water pools or runs off: compacted layer present
- Water evaporates quickly leaving white residue: salt accumulation from compaction

## JADAM vs. Laboratory Testing

JADAM does not oppose soil testing but warns against over-reliance on lab results. Laboratory tests provide NPK numbers but miss the critical factors:
- Soil compaction depth and extent
- Microbial diversity and activity
- Root penetration capability
- Water infiltration rate
- Organic matter quality (not just quantity)

JADAM recommends using both observation methods and periodic lab tests, but prioritizing the physical compaction diagnosis as the single most important factor. No amount of fertilizer adjustment can compensate for roots that cannot reach their food.
