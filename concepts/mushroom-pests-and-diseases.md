...
### Verticillium (Dry Bubble / Fungal Disease)
The most common fungal disease parasitizing mushroom crops. Causes deformed caps, "hairy" stems, and split stems that open the mushroom to secondary infection. Sciarid flies spread Verticillium. Often appears alongside other diseases when environmental conditions are favorable. Control: strict hygiene, remove infected mushrooms before veil breaks, lower humidity.

### Other Notable Molds
| Mold | Common Name | Key Feature |
|---|---|---|
...
| Sepedonium | Yellow/White Mold | Heat-resistant spores; sweet nauseous odor |

## Bacterial Pathogens

### Pseudomonas tolaasii (Bacterial Blotch)
Causes brown, sunken lesions on mushroom caps. Thrives in wet conditions. Control: lower relative humidity, run casing drier than normal, remove infected mushrooms, improve air circulation. P. putida (a different species) actually stimulates primordia formation in some strains.

### Viral Disease (Die-Back / La France Disease)
Infrequent but devastating. Causes mycelium to lose vigor, produces small or deformed mushrooms. Spread via spores of diseased mushrooms, tools, and workers. Control: strict hygiene, 2% chlorine solution for cleaning, discard and begin anew with clean spawn. No cure once established.
...
**Control:** Pasteurization temperatures that exclude Phorid eggs/larvae, sealed growing rooms, same measures as sciarid control.

### Mites
Saprophytic mites feed on molds in compost — particularly Penicillium and Trichoderma. Red pigmy mites feed on Trichoderma spores and spread contamination. Can carry virus disease. Control: eliminate their food source (molds), proper composting, pasteurization.

### Nematodes
Microscopic roundworms — among the most numerous creatures on Earth (billions per acre of soil). Two types in mushroom culture:
...
5. **Biological controls** — Bt for gnat larvae, predatory mites, competitor exclusion through proper [[mushroom-substrates]] preparation
6. **Hygiene** — 2% chlorine solution for cleaning between crops, remove spent substrate promptly
7. **Know when to toss** — viral diseases and severe Trichoderma outbreaks warrant complete crop removal and room sterilization
