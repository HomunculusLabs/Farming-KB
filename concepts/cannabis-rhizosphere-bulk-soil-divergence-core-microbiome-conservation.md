---
title: "Cannabis Rhizosphere Bulk Soil Divergence Core Microbiome Conservation"
created: 2026-05-11
source: understanding-cultivar-specificity-cannabis-microbiome.md
tags: [cannabis, microbiome, rhizosphere, bulk-soil, core-microbiome, divergence, winston, microbial-ecology, root-exudates]
...
microbial communities, coupled with the persistence of a conserved core microbiome
across both compartments. This dual pattern — divergence in community structure
combined with conservation of key taxa — reveals how cannabis selectively shapes
its root-associated microbiome while maintaining access to the broader soil
microbial reservoir, with significant implications for understanding
plant-microbe coevolution in a crop species that has been subject to intense
artificial selection.

## Rhizosphere Enrichment as a Selective Filter

The rhizosphere — the narrow zone of soil directly influenced by root exudates
and root turnover — is consistently enriched in specific bacterial taxa relative
...
At lower taxonomic levels (genus, species, OTU), the core microbiome contracts
sharply, reflecting the increasing influence of cultivar-specific factors,
...
Winston et al. report higher beta-diversity (between-sample dissimilarity) in
bulk soil communities than in rhizosphere communities, a pattern that is
consistent across cultivars and sites. This finding indicates that the bulk soil
is a more heterogeneous and environmentally contingent environment than the
rhizosphere, which is shaped by the relatively uniform selective pressures
