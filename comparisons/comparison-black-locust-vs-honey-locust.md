...
the ground, making it valuable for furniture and fencing. Thornless
cultivars are available, though the thorns on wild types provide
protection against ring-barking by livestock.

Honey locust is ideally suited to silvopastoral systems where its pod
drop feeds grazing animals directly beneath its shade canopy. Its
tolerance of alkaline, acidic, and saline soils makes it adaptable to a
wide range of sites.

## Key Differences

| Aspect | Black Locust | Honey Locust |
|--------|-------------|--------------|
| Family | Fabaceae | Caesalpiniaceae |
| Height | Up to 25 m | 24-30 m |
| Primary yield | Timber, firewood, honey | Stock feed pods, shade |
| Pod production | Minimal | 9-60 t/ha/year |
| Timber quality | Extremely rot resistant | Very durable (100 yr ground) |
| Firewood quality | Exceptional, coal-like | Good |
| Honey production | Premier honey tree | Not noted for honey |
