...
- raw/hamilton-geoffhamilton-nick_-organic-gardening.md
...
| Dimension | Organic Nutrients | Synthetic Nutrients |
|-----------|------------------|-------------------|
...
For cannabis specifically, organic/living soil grows consistently produce:
- **Better terpene profiles**: Complex aromatic compounds develop more fully in biologically active soil
- **Smoother smoke**: No salt residues to flush
...
| Phase | Organic | Synthetic |
|-------|---------|-----------|
| Year 1 setup | $200-400 (amendments, inoculants, compost) | $100-200 (nutrient line, pH meter) |
| Per cycle (ongoing) | $20-50 (top-dress amendments, tea inputs) | $80-150 (bottled nutrients, pH adjusters) |
| Year 3+ | $10-30 (soil is established, minimal inputs) | $80-150 (ongoing, no reduction) |
| 5-year total | $400-800 | $600-1000+ |

Organic costs decrease as the living soil ecosystem matures. Synthetic costs remain constant or increase. The [[nutritive-cycle-theory]] and [[knf-preparations]] provide frameworks for reducing external inputs over time using on-farm materials.

### The Middle Ground: Hybrid Approach

Some growers use organic base soil with synthetic boosters during specific growth stages. This is practical but undermines soil biology over time. If going hybrid:
- Use synthetic only as foliar sprays (not soil drenches) to limit biological damage
...
1. Bypass soil biology (starving the food web)
2. Create nutrient runoff (polluting waterways)
3. Require fossil fuel inputs (manufacturing nitrogen uses the Haber-Bosch process)
4. Degrade soil structure over time (salt accumulation, reduced aggregation)

On a homestead where [[duck-keeping]], [[goat-keeping]], [[composting-systems]], and [[dynamic-accumulators]] provide on-farm fertility, synthetic nutrients are unnecessary.

## Verdict

For a regenerative homestead, organic nutrients are the clear choice. They build soil health, reduce costs over time, produce superior cannabis quality, and integrate with the closed-loop systems the homestead is designed around. Reserve synthetic nutrients for hydroponic systems or emergency correction of severe deficiencies where organic methods are too slow. In all other cases, feed the soil — the soil will feed the plants.
