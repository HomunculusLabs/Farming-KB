...
- Quick soil drench when brewing time is unavailable
- Emergency applications where full tea-making is impractical
- Situations where dormant organisms can activate in the soil environment
- Providing some biological inoculation along with nutrients
- When a faster application is needed than brewing allows
...
Compost leachate is the most passive liquid product derived from compost, created when water naturally percolates through compost.

### Production Method

- Water passes through compost passively via gravity, rainfall, or irrigation
- No active extraction or agitation occurs
- No nutrients are added to the water
- No aeration or brewing period is involved
- Process is entirely passive and unmanaged
