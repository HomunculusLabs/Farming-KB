...
Purple passion fruit tolerates cooler conditions than yellow, making the purple type suitable for slightly cooler subtropical margins. Freezing temperatures kill above-ground growth, though plants may regrow from the root crown.

## Soil Requirements

Dragon fruit tolerates poor, sandy, or rocky soils better than most fruit crops, owing to its cactus ancestry and efficient CAM (Crassulacean Acid Metabolism) photosynthesis. It is sensitive to waterlogging — root rot (*Phytophthora* spp.) is the most common cause of plant death in commercial plantings. Slightly acidic to neutral pH (5.5–7.0) is acceptable. Sandy loam with added organic matter and excellent drainage is ideal. Organic amendments (compost, aged manure) should be applied at planting and annually as a surface mulch.
...
Both crops require sturdy, long-lasting support structures. Dragon fruit is typically grown on single-post trellises (1.5–2.0 m tall) with a top ring or cross-arm, allowing branches to cascade over the sides for easy harvesting. Spacing is 2–3 m between posts within rows, 3–4 m between rows. Concrete or treated timber posts are preferred for durability.

Passion fruit requires a strong wire trellis system. A two-wire horizontal trellis at 1.8–2.0 m height is standard, with posts every 5–6 m. In-row spacing is 3–5 m. The vine must be trained up a bamboo stake or string to the wire in its first months, then guided along the top wire. Trellis construction costs are a significant establishment expense for both crops.

## Propagation Methods

Dragon fruit is almost exclusively propagated from stem cuttings (20–40 cm segments), which root readily in well-drained media within 2–4 weeks. Cuttings should be cured (dried 2–7 days in shade) before planting to prevent rot. Cuttings fruit faster than seedlings and maintain clonal characteristics of the parent. Seed propagation is used mainly in breeding programs but results in high genetic variability and delays fruiting by 2–3 additional years. Tissue culture is emerging for large-scale commercial propagation of disease-free planting material.
...
Dragon fruit requires moderate pruning: removing damaged, diseased, or overcrowded stems, and thinning to improve air circulation and light penetration. Post-harvest pruning of spent flowering branches encourages new growth. Old, unproductive stems should be removed to make room for vigorous young growth. Annual pruning sessions are typically sufficient. Pruning tools should be sanitized between plants to prevent disease transmission, especially for stem canker.
...
Dragon fruit is harvested when the fruit reaches full color development (7–10 days after flowering). Fruits do not ripen further after harvest, so timing is critical. They are cut from the stem with sharp secateurs, leaving a short stem stub. Post-harvest, fruits are sorted by size and color, then packed in single-layer cartons. Cold storage at 5–10 °C extends shelf life to 3–4 weeks. Bruising must be minimized during handling.

Passion fruit is harvested at the fully ripe stage (when it falls naturally or shows deep color and slight wrinkling). For fresh market, fruits are picked by hand at the "full color, slightly wrinkled" stage. For processing, fruits can be collected from the ground. Post-harvest losses are higher than dragon fruit due to rapid moisture loss and fungal rots. Cold storage at 6–8 °C with 85–90% relative humidity extends shelf life to 4–5 weeks.

## Nutritional Value of Fruit

Dragon fruit is low in calories (≈50 kcal/100 g) and notable for vitamin C (≈9 mg/100 g), magnesium (≈18 mg/100 g), and antioxidant compounds. Red-fleshed varieties contain betalains under study for anti-inflammatory properties. Its mild, subtly sweet flavor and striking appearance make it popular in fresh-cut fruit presentations and smoothie bowls.
