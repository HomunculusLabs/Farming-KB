...
| Feature | Living Fences | Hedgerows |
|---|---|---|
| **Primary purpose** | Livestock containment or exclusion | Ecological function, boundary marking, production |
| **Typical width** | 0.5–2 m | 3–10 m |
| **Structure** | Dense, single or double row of shrubs/trees | Multi-layered: canopy, shrub, ground flora |
| **Management** | Intensive pruning to maintain density | Moderate; selective pruning, periodic laying |
| **Species diversity** | Often 1–5 species (function-focused) | Often 10–30+ species (ecology-focused) |
| **Establishment time** | 2–5 years to effective barrier | 5–10+ years to full ecological maturity |
