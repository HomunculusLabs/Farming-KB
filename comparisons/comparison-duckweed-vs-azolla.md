...
- Lower protein content and yield than duckweed
- Sensitive to environmental stress (heat, light, pollution)
- Invasive potential in temperate waterways
- Labor-intensive inoculation and management in rice paddies

## When to Choose Duckweed

Choose duckweed when your priority is maximum protein yield per unit area, when growing on wastewater or nutrient-rich water, when ease of harvest and processing matters, or when integrating with aquaponics and fish farming systems. Duckweed is the more versatile and forgiving choice for smallholders and commercial operations alike.
...
Duckweed is cosmopolitan — species of *Lemna* and *Spirodela* are found on every continent except Antarctica. It grows year-round in tropical and subtropical zones and survives winters in temperate regions by forming dormant turions (dense, starch-rich fronds that sink to the bottom). Cold-hardy species like *Lemna minor* tolerate ice cover and resume growth at 6–10°C. This makes duckweed viable across a very wide geographic range with minimal seasonal interruption.

Azolla is more climate-sensitive. Most cultivated species are tropical to subtropical and die back below 5°C. *Azolla caroliniana* is the most cold-tolerant, surviving winters in USDA zone 6 by forming sporocarps, but growth ceases below 10°C and recovery in spring is slow. In temperate regions, Azolla typically requires greenhouse culture for year-round production. Its sensitivity to heat is also notable — sustained temperatures above 35°C cause frond necrosis and colony collapse, making it a poor fit for hot lowland tropics without shading.

## Summary

Duckweed and Azolla are complementary rather than competing technologies. In integrated farming systems, they can be grown sequentially or simultaneously — Azolla for nitrogen fixation and soil building, duckweed for protein production and nutrient recovery. The most productive systems use both: Azolla inoculated into rice paddies for nitrogen, and duckweed cultivated on the same water after rice harvest to capture residual nutrients for livestock feed.
