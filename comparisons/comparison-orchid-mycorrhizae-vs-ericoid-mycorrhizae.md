...
updated: 2026-05-03
sources:
  - Smith SE, Read DJ. "Mycorrhizal Symbiosis." 4th edition. Academic Press. 2008.
...
- **Rhizoscyphus ericae** aggregate (formerly *Pezizella ericae*)
- **Oidiodendron maius** — dominant in acidic, peaty soils
...
This is a remarkably narrow fungal partner range compared to the broad host range of arbuscular mycorrhizal fungi, and even compared to orchid mycorrhizal fungi. The ericoid fungal lineage has co-evolved with Ericaceae over tens of millions of years, resulting in a highly specialized partnership.
...
- **Intracellular only**: Unlike most other mycorrhizal types, orchid mycorrhizal colonization is strictly intracellular. Fungal hyphae do not grow between cells.
...
- **Extensive extraradical mycelium**: ErM fungi produce extensive external mycelial networks in the surrounding soil and organic matter, serving as the primary organ for nutrient acquisition.
...
| Aspect | Orchid Mycorrhizae | Ericoid Mycorrhizae |
|---|---|---|
| **Direction** | Primarily fungus → plant | Bidirectional; primarily plant → fungus |
| **Seedling stage** | Fungus provides ALL carbon | Plant provides carbon to fungus |
| **Adult stage** | Variable: mixotrophic to fully mycoheterotrophic | Plant provides carbon; fungus returns nutrients |
| **Mechanism** | Peloton digestion (lysigeny) | Active transport across living interfaces |

Orchid mycorrhizae are unique among all mycorrhizal types in that **carbon flows predominantly from fungus to plant**, especially during germination and in mycoheterotrophic species. In ericoid mycorrhizae, carbon flows from plant to fungus (as in all other mycorrhizal types), with the fungus returning mineral nutrients to the plant.

### Nitrogen and Phosphorus

| Aspect | Orchid Mycorrhizae | Ericoid Mycorrhizae |
|---|---|---|
| **Nitrogen source** | Fungal biomass (via peloton digestion) | Organic matter decomposition (proteolysis) |
| **Phosphorus source** | Fungal cytoplasm | Mineral and organic P from soil |
...
The most critical functional difference lies in nitrogen acquisition. ErM fungi are exceptional decomposers of complex organic nitrogen compounds (proteins, chitin, tannin-protein complexes) found in acidic, organic soils. They produce a suite of **proteolytic enzymes** (proteinases, peptidases) and **chitinases** that break down recalcitrant organic matter — a capacity that most other mycorrhizal fungi lack.
...
- **Geographic range**: Primarily boreal, temperate, and Southern Hemisphere regions with acidic, nutrient-poor soils
...
- **Ecosystem engineering**: ErM fungi contribute significantly to the nitrogen economy of heathland and boreal forest ecosystems, driving decomposition processes that shape soil chemistry

## Stress Tolerance and Environmental Adaptation

### Orchid Mycorrhizae

- **Establishment in low-light environments**: Mycoheterotrophic nutrition enables orchids to establish in deeply shaded understories where photosynthesis alone cannot support growth
- **Seed dispersal and colonization**: The tiny, wind-dispersed seeds of orchids are an evolutionary solution to reaching isolated habitats, with fungal partnerships enabling establishment in resource-poor microsites
- **Vulnerability**: High specificity to fungal partners makes many orchids vulnerable to habitat disturbance, which can disrupt the fungal networks essential for recruitment

### Ericoid Mycorrhizae

- **Tolerance of acidic soils**: ErM fungi and their Ericaceae hosts thrive in extremely acidic soils (pH 3.5–4.5) that are toxic to most plants due to aluminum and manganese availability
- **Organic matter decomposition**: The ability of ErM fungi to access nitrogen from complex organic matter gives Ericaceae a competitive advantage in organic, nutrient-poor soils
- **Heavy metal tolerance**: Some ErM fungi show tolerance to heavy metals, potentially contributing to Ericaceae success in contaminated environments
- **Fire adaptation**: Many ericoid plants are fire-adapted, and their fungal partners can survive fire events through soil-borne mycelial networks, facilitating post-fire regeneration
