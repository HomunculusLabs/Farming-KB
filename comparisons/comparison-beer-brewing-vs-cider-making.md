...
- **Sweets** (Golden Delicious, Gala) provide sugar and body, boosting the final alcohol content
- **Sharps** (Granny Smith) contribute acidity and brightness, balancing the sweetness
...
| Style variety | Very wide (ales, lagers, stouts, IPAs) | Narrower (dry, sweet, sparkling, still) |
| Typical ABV range | 3-12% | 4-8% |

## When to Choose Beer Brewing

Choose beer brewing when you want maximum creative control over flavor, aroma, and body. The vast combination of malts, hops, and yeast strains allows for an enormous range of styles, from light pilsners to heavy stouts to hop-forward IPAs. Beer is the better choice if you already grow or plan to grow grains and hops on your homestead. It also suits those who enjoy a more technical, hands-on process and are willing to invest in additional equipment.

Beer brewing is the right fit when:

- You want dozens of distinct style options and enjoy tinkering with recipes
- Your homestead produces or can produce grains and hops
- You are comfortable investing in specialized equipment upfront
- You enjoy learning a complex, multi-step process with room for mastery
- You want to brew year-round with shelf-stable ingredients

Extract brewing provides a gentler on-ramp before diving into the full all-grain experience. The learning curve is steeper, but each batch teaches you something new about the relationship between ingredients and process.

## When to Choose Cider Making

Choose cider making if you want a simpler, more approachable entry into fermentation. It requires minimal equipment and far fewer ingredients, making it possible to start with items already found in most kitchens. Cider is ideal if you have apple trees or access to affordable bulk apples, and it works well with wild fermentation for a truly low-input product.

Cider making is the right fit when:
