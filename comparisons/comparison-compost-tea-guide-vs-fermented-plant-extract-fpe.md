...
| Aspect | Compost Tea (AACT) | Fermented Plant Extract (FPJ/FFJ) |
|--------|-------------------|--------------------------------|
| Primary function | Deliver soil food web biology | Deliver plant nutrients, enzymes, hormones |
| Origin tradition | Soil food web science (Ingham) | Korean Natural Farming (Cho Han-kyu) |
| Key ingredient | Mature compost | Fresh plant material + brown sugar |
