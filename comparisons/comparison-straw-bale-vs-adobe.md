...
them depends primarily on climate, available materials, and whether insulation
or thermal mass is the priority for the building site.
...
where the flexibility of plastered straw bale walls accommodates movement better
than rigid adobe.

## When to Choose Adobe

Adobe construction excels in hot, dry climates with large day-to-night
temperature swings, where thermal mass provides natural air conditioning. It is
the natural choice in arid and semi-arid regions where clay soil is readily
available and straw may be scarce. Adobe buildings are virtually fireproof,
extremely durable when properly maintained, and require minimal energy inputs
for both construction and ongoing comfort. For homesteaders in the American
Southwest, Mediterranean climates, or any region where summer cooling is the
primary design challenge, adobe's thermal mass performance is unmatched.

## Hybrid Approaches

Some natural builders combine both methods, using adobe for south-facing walls
that benefit from thermal mass and solar heat absorption, and straw bale for
north-facing walls where insulation against cold is the priority. This strategic
placement leverages the strength of each material where it performs best.
Another hybrid approach uses adobe for the first story (thermal mass and ground
moisture resistance) and straw bale for a second story (lighter weight and
