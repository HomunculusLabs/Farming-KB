...
| Feature | *M. oleifera* | *M. stenopetala* |
|---|---|---|
| **Common name** | Drumstick tree, horseradish tree | African moringa, cabbage tree |
| **Native range** | Indian subcontinent | East Africa (Ethiopia, Kenya, Somalia) |
| **Mature height** | 8–12 m | 10–15 m |
...
*Moringa oleifera* dominates the global market. Dried leaf powder, capsules, tea, oil (ben oil), and fresh produce are widely available in health food stores, online retailers, and farmers' markets worldwide. A well-developed supply chain supports it.

*Moringa stenopetala* is primarily available in local Ethiopian and Kenyan markets as fresh or dried leaves. International supply is minimal — a handful of specialty importers offer dried leaf powder, but it remains a niche product with no established global trade infrastructure.

## Best Use Cases

### Choose *Moringa oleifera* when:
- You need maximum growth speed and leaf yield for commercial production
- Water purification is a primary goal
- You live in a warm tropical/subtropical lowland climate (no frost risk)
- You want widely available seed, products, and market access
- You plan intensive coppicing-based leaf harvest systems

### Choose *Moringa stenopetala* when:
- You farm in East African highlands or cooler subtropical zones (elevation 400–1,800 m)
- Milder leaf flavor is preferred for fresh eating and salads
- Higher calcium and iron content are nutritionally important
- You want a lower-input agroforestry component with natural shade provision
- You are working within Ethiopian/East African food systems and cultural contexts
