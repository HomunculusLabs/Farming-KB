...
efficiency under different environmental conditions, their biochemical machinery,
and the types of plants that employ them.

## Quick Comparison

| Feature | C3 | C4 | CAM |
|---|---|---|---|
| **First stable product** | 3-carbon (3-PGA) | 4-carbon (oxaloacetate) | 3-PGA (via C4 intermediate) |
| **Key CO₂ capture enzyme** | RuBisCO | PEP carboxylase | PEP carboxylase (night) |
| **CO₂ fixation location** | Mesophyll chloroplasts | Mesophyll → Bundle sheath | Mesophyll (night) → Same cells (day) |
| **Photorespiration** | Significant at high temps | Minimal | Minimal |
