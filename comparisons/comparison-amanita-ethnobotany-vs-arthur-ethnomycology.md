...
intoxication, an experience that would later prove central to interpretations of
mythological flying figures.
Arthur references the same Siberian material but frames it as the surviving
fragment of a once-universal entheogenic religion. For Arthur, Siberian shamanism
...
individually. The difficulty is that the same hermeneutic could apply equally to
dozens of other natural phenomena, and without an independent criterion for
...
Arthur's ethnomycology proceeds by assuming the centrality of psychoactive
mushrooms to human religious experience and then reading evidence to confirm that
assumption. The multidisciplinary toolkit — philology, archaeology, botany,
comparative religion, art history — builds an increasingly elaborate interpretive
framework that can accommodate any mythological or religious datum. This produces
a body of work that is internally coherent and richly detailed, but whose claims
often exceed what the cited evidence can independently support.
## Complementary Value
Despite their differences, these works serve complementary functions. The
ethnobotanical source provides a reliable foundation of documented practices,
pharmacological knowledge, and cultural contexts that grounds any serious inquiry
into *Amanita muscaria*. Arthur's work, while speculative, poses provocative
questions about the extent to which psychoactive substances may have shaped
religious symbolism that more cautious scholarship may be too quick to dismiss.
The most productive approach is to hold both in productive tension: using the
ethnobotanical record as a firm evidential base while remaining open to the
