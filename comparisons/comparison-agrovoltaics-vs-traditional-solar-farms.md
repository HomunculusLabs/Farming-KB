...
| Criterion | Agrovoltaics | Traditional Solar Farms |
|---|---|---|
| **Land use efficiency** | Very high — dual production per hectare | Moderate — single use per hectare |
| **Energy output per hectare** | 60–90% of traditional (due to panel spacing) | 100% baseline |
| **Total land productivity** | 60–180% of single-use (energy + crops) | 100% (energy only) |
| **Agricultural yield impact** | -5% to +30% depending on crop and design | N/A — no agriculture |
| **Water usage** | Reduced soil evaporation (10–30% savings) | No irrigation benefit |
