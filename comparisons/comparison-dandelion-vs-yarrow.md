...
control. Yarrow is drought-tolerant once established, thrives in poor
soils, and acts as a compost activator with its nutrient-rich foliage.

## Key Differences

| Aspect | Dandelion | Yarrow |
|--------|-----------|--------|
| Primary edible part | Leaves, flowers, roots | Leaves, flowers |
| Nutritional standout | Vitamin K, A, inulin | Moderate nutrients |
| Key medicinal action | Diuretic, liver tonic | Hemostatic, fever reducer |
| Soil function | Breaks compaction, mines Ca/K | Accumulates Cu, K, P |
...
forest understories, orchard guilds, and polyculture beds, yarrow
provides insectary services that dandelion cannot match.

Yarrow also excels in ornamental and meadow plantings. Its upright habit
and long bloom period (June through September) provide visual structure
and consistent color. For herbalists focused on wound care, fever
management, and women's health, yarrow's hemostatic and emmenagogue
properties make it indispensable. In drought-prone areas, yarrow's
superior water efficiency gives it a clear advantage over dandelion.

## Growing Both Together

Dandelion and yarrow complement each other well in a diverse polyculture.
