...
Key practical difference: antibiotics require sustained therapeutic concentrations above the minimum inhibitory concentration (MIC); phages need only an initial inoculum to reach a threshold, after which they self-propagate until the host bacteria are eliminated.
