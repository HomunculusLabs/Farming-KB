...
| Feature | Scented Geraniums | Edible Flowers (General) |
|---|---|---|
| **Primary value** | Aromatic foliage (leaves) | Visual and edible petals |
| **Plant lifespan** | Tender perennial (Zones 9–11) | Mixed: annuals and perennials |
| **Harvest window** | Year-round (indoors in winter) | Seasonal, often brief |
| **Flavor intensity** | Strong, concentrated in leaves | Delicate, often subtle |
