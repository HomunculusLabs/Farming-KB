...
The FAO's 2018 endorsement of agroecology as a guiding framework for the UN Decade of Family Farming marked a watershed moment, bringing the approach into mainstream policy discourse while triggering debates about whether institutional co-option would dilute its transformative agenda. The 2021 UN Food Systems Summit further polarized the community, with La Vía Campesina and allies boycotting the event on the grounds that corporate-dominated governance structures were incompatible with agroecology's democratic principles.
...
Agroecology's philosophical core rests on the premise that farms are ecosystems, not factories. Its principles derive from ecological science: nutrient cycling, biological interactions, population regulation, succession dynamics, and energy flow. The agroecological approach seeks to enhance these natural processes rather than replace them with external inputs. Key tenets include:
...
- **Soil as a living system**: Soil organic matter, microbial communities, and mycorrhizal networks are managed as productive infrastructure, not inert substrate.
