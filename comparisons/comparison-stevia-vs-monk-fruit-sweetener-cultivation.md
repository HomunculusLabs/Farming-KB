...
| Feature | Stevia (*Stevia rebaudiana*) | Monk Fruit (*Siraitia grosvenorii*) |
|---|---|---|
| **Family** | Asteraceae (sunflower/daisy family) | Cucurbitaceae (gourd/cucumber family) |
| **Genus** | *Stevia* | *Siraitia* |
| **Plant Form** | Herbaceous perennial shrub (~60–100 cm) | Perennial climbing vine (3–5 m) |
| **Leaf Arrangement** | Opposite, simple leaves | Palmately lobed leaves, tendrils present |
| **Flowers** | Small white tubular florets in cymes | Yellow, dioecious (separate male/female plants) |
| **Fruit** | Tiny achenes (~3 mm) | Round green-to-brown gourd (~5–7 cm diameter) |

Stevia is a relatively compact bushy plant in the daisy family, while monk fruit is a vigorous climbing vine in the gourd family that requires trellising or support structures, similar to cucumbers or melons.
...
**Stevia** prefers well-drained, sandy loam soils with a pH of 6.0–7.5. It is moderately tolerant of poor soils but performs best with moderate organic matter. Good drainage is critical — stevia roots are shallow and susceptible to rot in waterlogged conditions.

**Monk fruit** thrives in deep, humus-rich forest soils with pH 5.5–7.0, often on sloped terrain that ensures drainage. It requires significant organic matter and is adapted to the mineral-rich, slightly acidic soils of karst limestone regions in Guangxi.

### Water Needs

Stevia needs consistent but moderate moisture (~800–1,200 mm annually). It tolerates brief drought but yields decline significantly under water stress. Monk fruit requires substantially more water (~1,500–2,000 mm annually) and consistent humidity, making it a heavier water consumer.

## Propagation Methods

Both plants share similar propagation options:
...
| Stage | Stevia | Monk Fruit |
|---|---|---|
| **Establishment** | 6–8 weeks from cutting to field-ready transplant | 8–12 months from cutting to fruiting vine |
| **Time to First Harvest** | 3–4 months after transplanting (leaves) | 12–18 months after planting (first fruit crop) |
| **Productive Lifespan** | 2–3 years (productivity declines; typically replanted) | 3–5+ years in ideal conditions |
| **Harvest Window** | Just before flowering (glycoside content peaks) | Late summer to early autumn when fruits turn brown |

Stevia offers a much faster return on investment, with multiple leaf harvests per year possible in tropical climates (typically 2–4 cuttings annually). Monk fruit requires a longer lead time but produces a higher-value harvest per cycle.

## Yield

- **Stevia**: Dry leaf yields of 2,000–3,500 kg/ha (1,800–3,100 lbs/acre). Dried leaf contains 8–12% steviol glycosides by weight. High-rebaudioside-A varieties command premium prices.
- **Monk Fruit**: Fresh fruit yields of 10,000–15,000 kg/ha (8,900–13,400 lbs/acre) from mature vines. Approximately 100 kg of fresh fruit yields 1–1.5 kg of monk fruit extract (30–40% mogrosides).
...
| Feature | Steviol Glycosides | Mogrosides |
|---|---|---|
| **Key Compounds** | Rebaudioside A (Reb A), Stevioside, Reb D, Reb M | Mogroside V (primary), Mogroside IV |
| **Relative Sweetness** | Reb A: 250–300× sucrose; Reb M: 300–500× | Mogroside V: 250–300× sucrose |
| **Taste Profile** | Slight licorice/bitter aftertaste (Reb A); Reb M is cleaner | Clean, fruity taste; minimal aftertaste |
| **Caloric Content** | Zero (non-nutritive) | Zero (non-nutritive) |
| **Regulatory Status (US)** | GRAS (FDA, 2008) | GRAS (FDA, 2010) |

Both compounds are non-glycemic and safe for diabetics. Monk fruit mogrosides generally have a cleaner taste profile than steviol glycosides, which has driven premium pricing for monk fruit extract.

## Market and Economic Considerations

Monk fruit extract commands a significantly higher price than stevia leaf or extract, largely due to limited production geography and more complex supply chains. Stevia has broader global production and a more commoditized market. Key considerations:

- **Stevia**: Grown commercially on every inhabited continent. Lower barrier to entry. Global market valued at ~$800M+ (2025). Competitive pricing drives use in mass-market food products.
- **Monk Fruit**: >80% of global supply from Guangxi, China. Market valued at ~$300M+ (2025) but growing faster. Used in premium and "clean label" products. Supply chain vulnerability due to geographic concentration.
- **Small-scale viability**: Stevia is more accessible for small farmers due to lower capital requirements and faster returns. Monk fruit requires trellising infrastructure and a longer wait for first harvest.
...
**Stevia** adapts very well to greenhouse and indoor cultivation. It can be grown as a perennial in containers (minimum 20–30 cm pots) with good lighting (12+ hours of light, or supplemental grow lights). Hydroponic stevia production is commercially practiced and allows tight control over glycoside profiles. It is an excellent candidate for home greenhouse growers in temperate climates.

**Monk fruit** is challenging indoors due to its vine habit, large size, need for pollination (requiring both male and female plants or hand pollination), and high humidity demands. Greenhouse cultivation is theoretically possible but requires substantial infrastructure — tall trellising, humidity control, and pollinator management. It is not practical for most home growers.
