---
title: Lime Plaster vs Earthen (Clay) Plaster
tags:
  - natural-building
  - plaster
  - lime
...
| Feature | Lime Plaster | Earthen (Clay) Plaster |
|---|---|---|
| **Binder** | Hydrated or hydraulic lime | Clay soil |
| **Curing mechanism** | Carbonation (absorbs CO₂) | Evaporation (dries) |
| **Curing time** | 2–6 months for full strength | 1–14 days |
| **Water resistance** | Moderate to high (fully carbonated) | Low (not water-resistant) |
| **Breathability** | Moderate (vapor permeable) | Very high (extremely vapor permeable) |
| **Durability** | High; can last 100+ years | Moderate; may need periodic refresh |
| **Hardness** | Hard (approx. 3,000–5,000 psi) | Soft (approx. 300–800 psi) |
| **Mold resistance** | High (alkaline pH ~12.5) | Low to moderate (neutral pH) |
| **Cost (material)** | $10–35 per m² | $1–15 per m² |
| **Ease of repair** | Moderate (must match carbonation stage) | Very easy (just add water and clay) |
| **Safety during application** | Caustic (gloves, goggles required) | Non-caustic (gloves optional) |
| **Skill level** | Medium to high | Low to medium |
| **Exterior suitability** | All climates | Arid and temperate only |
| **Interior suitability** | All climates | All climates |
| **Freeze tolerance (curing)** | Must protect below 5°C | Less sensitive, but avoid freezing |
| **Embodied energy** | Moderate (kiln-fired) | Very low (unprocessed soil) |
| **Carbon impact** | Net carbon-negative over lifespan (absorbs CO₂) | Carbon-neutral |
| **Substrate compatibility** | Stone, masonry, earth, lath, cob | Cob, straw bale, light straw clay, earth |
| **Finish quality** | Smooth, luminous, can be burnished | Matte, warm, can be polished |
